...
{
	switch (Global_114370.f_10053.f_134)
	{
		case 0:
			Global_114370.f_10053.f_134 = 1;
			break;
	
		case 1:
			Global_114370.f_10053.f_134 = 2;
			GRAPHICS::SET_EXTRA_TCMODIFIER(func_4());
			AUDIO::PLAY_SOUND_FRONTEND(-1, "ON", "NOIR_FILTER_SOUNDS", true);
			break;
	
		case 2:
			Global_114370.f_10053.f_134 = 0;
			break;
	}
...
{
	return Global_114370.f_10053.f_133 == 127;
}
...
BOOL func_22(int iParam0) // Position - 0xA8A
{
	...
	bitsInRange = MISC::GET_BITS_IN_RANGE(Global_114370.f_10053.f_133, 0, num - 1);
...
struct<5> func_40(int iParam0) // Position - 0x1875
{
	...
	switch (iParam0)
	{
		...
		case 243:
			...
			unk.f_3 = func_41(&Global_4718592.f_235581[0 /*160*/]);
			unk.f_4 = unk.f_3;
			break;
	
		case 244:
			unk = { Global_4718592.f_235581[1 /*160*/].f_16 };
			unk.f_3 = func_41(&Global_4718592.f_235581[1 /*160*/]);
			unk.f_4 = unk.f_3;
			break;
	
		case 245:
			unk = { Global_4718592.f_235581[2 /*160*/].f_16 };
			unk.f_3 = func_41(&Global_4718592.f_235581[2 /*160*/]);
			unk.f_4 = unk.f_3;
			break;
	
		case 246:
			unk = { Global_4718592.f_235581[3 /*160*/].f_16 };
			unk.f_3 = func_41(&Global_4718592.f_235581[3 /*160*/]);
			unk.f_4 = unk.f_3;
			break;
	
		case 247:
			unk = { Global_4718592.f_235581[4 /*160*/].f_16 };
			unk.f_3 = func_41(&Global_4718592.f_235581[4 /*160*/]);
			unk.f_4 = unk.f_3;
			break;
...
var func_41(var uParam0) // Position - 0x4533
{
	return uParam0;
}
...
void func_45(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, float fParam4) // Position - 0x511F
{
...
BOOL _IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(char* message) // Position - 0x5487
{
...
BOOL func_53(Ped pedParam0, eScriptTaskHash esthParam1) // Position - 0x54B5
{
...
int func_65(eCharacter echParam0) // Position - 0x5764
{
...
BOOL _DOES_ENTITY_EXIST_AND_IS_ALIVE(Ped pedParam0) // Position - 0x57F8
{
	if (ENTITY::DOES_ENTITY_EXIST(pedParam0))
...
void func_69(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x5819
{
	if (bParam1)
	{
		MISC::SET_BIT(&(Global_114370.f_10053.f_133), iParam0);
	...
	{
		MISC::CLEAR_BIT(&(Global_114370.f_10053.f_133), iParam0);
	}
...
BOOL _IS_MISSION_REPEAT_ACTIVE(BOOL bExcludeBenchmark) // Position - 0x58A8
{
...
{
	return IS_BIT_SET(Global_114370.f_10053.f_133, iParam0);
}
...
BOOL func_79(Vector3 vParam0, var uParam1, var uParam2) // Position - 0x5B1A
{
	var screenX;
	var screenY;
...
void func_87(Hash hParam0) // Position - 0x5EEB
{
...
void func_88(var uParam0, Vector3 vParam1, var uParam2, var uParam3, float fParam4) // Position - 0x5F0B
{
...
BOOL func_89(Vector3 vParam0, var uParam1, var uParam2, Vector3 vParam3, var uParam4, var uParam5, int iParam6) // Position - 0x5F31
{
	return SYSTEM::VDIST(vParam0, vParam3) <= iParam6;
}

BOOL _IS_EXCLUSIVE_CONTENT_UNLOCKED() // Position - 0x5F48
{
	int profileSetting;
