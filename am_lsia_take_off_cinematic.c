...
BOOL func_70(var uParam0) // Position - 0x196F
{
	if (uParam0->f_20 == 0)
		return true;
...
Hash func_71() // Position - 0x19F0
{
	return ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID());
}

var func_72(BOOL bParam0, var uParam1, var uParam2) // Position - 0x1A00
{
	if (bParam0)
		return uParam1;
...
void func_73(var uParam0) // Position - 0x1A17
{
	func_61();
...
void func_74(var uParam0) // Position - 0x1A31
{
	func_169(uParam0);
...
void func_75(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x1AD8
{
	func_77();
	func_49(true);
	HUD::CLEAR_HELP(true);
...
void func_78(var uParam0) // Position - 0x1BCD
{
	var unk;
...
void func_79(Vehicle veParam0, var uParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x1CC8
{
	Hash entityModel;
	float num;
...
BOOL IS_GAMER_HANDLE_VALID(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12) // Position - 0x223F
{
	return NETWORK::NETWORK_IS_HANDLE_VALID(&uParam0, 13);
}

BOOL func_81(Vehicle veParam0) // Position - 0x224F
{
	Hash entityModel;
...
BOOL func_82(Hash hParam0) // Position - 0x2295
{
	switch (hParam0)
	{
		case joaat("brioso"):
...
BOOL func_83(Hash hParam0) // Position - 0x234B
{
	switch (hParam0)
	{
		case -1321131184:
...
BOOL func_84(Hash hParam0) // Position - 0x2379
{
	switch (hParam0)
	{
		case joaat("coureur"):
...
BOOL func_85(Hash hParam0) // Position - 0x23AE
{
	switch (hParam0)
	{
		case joaat("pounder2"):
...
void func_86(Vehicle veParam0) // Position - 0x24B5
{
	Hash entityModel;
...
void func_87(var uParam0, var uParam1, var uParam2) // Position - 0x2540
{
	Hash eventData;
...
int _GET_LOBBY_SCRIPT_EVENT_BITS(BOOL includeLocalPlayer, BOOL includeSpectators) // Position - 0x2581
{
	int address;
	int i;
	Player player;
...
BOOL func_89(int iParam0) // Position - 0x25E6
{
	int i;
...
BOOL func_90(int iParam0) // Position - 0x2621
{
	return func_91(iParam0, 6, true);
}

BOOL func_91(int iParam0, int iParam1, BOOL bParam2) // Position - 0x2631
{
	if (iParam0 == -1)
		return false;
...
int func_92(int iParam0, int iParam1) // Position - 0x2691
{
	Hash statHash;
	int outValue;
...
Hash func_93(int iParam0, int iParam1) // Position - 0x26C0
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(0, iParam0, func_94(iParam1));
}

int func_94(int iParam0) // Position - 0x26D5
{
	int num;
	int num2;
...
int func_95(int iParam0) // Position - 0x2709
{
	switch (iParam0)
	{
		case 0:
...
int func_96() // Position - 0x2AC0
{
	return Global_33298;
}

int func_97(int iParam0) // Position - 0x2ACB
{
	switch (iParam0)
	{
		case -1:
...
BOOL func_98() // Position - 0x2E0E
{
	return Global_101969.f_400 > 0;
}

int func_99(Vehicle veParam0, Any* panParam1) // Position - 0x2E1F
{
...
BOOL func_100(Vehicle veParam0) // Position - 0x2E9C
{
	int vehicleCrewEmblemRequestState;
	int networkTime;
	int num;
...
void func_101(Vehicle veParam0) // Position - 0x2F29
{
	int _int;
...
BOOL func_102(var uParam0, Player plParam1) // Position - 0x2F85
{
	func_106();
	...
	func_104(*uParam0, &Global_1946326, &(Global_1946326.f_1), &(Global_1946326.f_4), &(Global_1946326.f_7), &(Global_1946326.f_10));
	...
	{
		if (func_103(uParam0, plParam1, Global_1946326, Global_1946326.f_1, Global_1946326.f_4, Global_1946326.f_7, Global_1946326.f_10, 0, Global_1946326.f_13))
		{
			if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	...
	else
	{
		...
		if (Global_1946326.f_23 == 0 && func_103(uParam0, plParam1, Global_1946326, Global_1946326.f_1, Global_1946326.f_4, Global_1946326.f_7, Global_1946326.f_10, 0, Global_1946326.f_13) || Global_1946326.f_23 != 0 && Global_1946326.f_24 == 0 && func_103(uParam0, plParam1, Global_1946326, Global_1946326.f_14, Global_1946326.f_17, Global_1946326.f_20, Global_1946326.f_10, 1, Global_1946326.f_13) || Global_1946326.f_24 != 0)
		{
			if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
				Global_1577972 = NETWORK::GET_NETWORK_TIME();
			else
...
BOOL func_103(var uParam0, Player plParam1, int iParam2, Vector3 vParam3, var uParam4, var uParam5, Vector3 vParam6, var uParam7, var uParam8, Vector3 vParam9, var uParam10, var uParam11, float fParam12, int iParam13, int iParam14) // Position - 0x3230
{
...
int func_104(Vehicle veParam0, int iParam1, var uParam2, var uParam3, var uParam4, float fParam5) // Position - 0x3259
{
	if (!ENTITY::DOES_ENTITY_EXIST(veParam0) || !VEHICLE::IS_VEHICLE_DRIVEABLE(veParam0, false))
		return 0;
	...
	*iParam1 = ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(veParam0, "chassis_dummy");
	...
	if (!func_105(Global_1946352, 0f, 0f, 0f, false) && !func_105(Global_1946355, 0f, 0f, 0f, false) && !func_105(Global_1946358, 0f, 0f, 0f, false) && !(Global_1946361 == 0f))
	{
...
BOOL func_105(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, BOOL bParam6) // Position - 0x91B6
{
	if (bParam6)
...
BOOL func_107(Vehicle veParam0) // Position - 0x9276
{
	if (ENTITY::DOES_ENTITY_EXIST(veParam0) && VEHICLE::IS_VEHICLE_DRIVEABLE(veParam0, false))
...
BOOL func_108(Vehicle veParam0) // Position - 0x92AE
{
	int _int;
...
BOOL func_109(Vehicle veParam0, Any* panParam1) // Position - 0x92F6
{
	Player playerFromGamerHandle;
	BOOL flag;
	int num;
...
BOOL func_110(Vehicle veParam0) // Position - 0x9453
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		return true;
...
int func_111(Vehicle veParam0) // Position - 0x97AA
{
...
int func_112(Player plParam0) // Position - 0x97D6
{
...
int func_113(Player plParam0) // Position - 0x97F3
{
...
BOOL func_114(Player plParam0, BOOL bParam1) // Position - 0x9816
{
	if (func_11(plParam0))
...
int func_115(Player plParam0) // Position - 0x985A
{
	if (func_11(plParam0))
		if (func_114(plParam0, false))
...
BOOL func_117(BOOL bParam0) // Position - 0x9893
{
	return func_118(PLAYER::PLAYER_ID(), bParam0);
}

BOOL func_118(Player plParam0, BOOL bParam1) // Position - 0x98A5
{
	return func_119(plParam0, bParam1, 1);
}

BOOL func_119(Player plParam0, BOOL bParam1, int iParam2) // Position - 0x98B6
{
	Player player;
...
BOOL func_120(Player plParam0, int iParam1) // Position - 0x9912
{
	if (func_11(plParam0))
...
BOOL func_121(int iParam0, BOOL bParam1) // Position - 0x9961
{
	int num;
	int num2;
...
int func_122(int iParam0) // Position - 0x99BF
{
	return iParam0 % 32;
}

int func_123(int iParam0) // Position - 0x99CC
{
	int num;
...
int func_124(int iParam0) // Position - 0x99E3
{
	int num;
	int num2;
...
int func_125(int iParam0) // Position - 0x9A10
{
	return iParam0 / 32;
}

BOOL func_126(Player plParam0) // Position - 0x9A1D
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (func_127(plParam0) && Global_2658019[plParam0 /*467*/].f_324.f_11 == plParam0)
			return true;

	return false;
}

BOOL func_127(Player plParam0) // Position - 0x9A52
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2658019[plParam0 /*467*/].f_324.f_8 != -1)
				return func_128(Global_2658019[plParam0 /*467*/].f_324.f_8) == 22;

	return false;
}

int func_128(int iParam0) // Position - 0x9A99
{
	switch (iParam0)
	{
		case 0:
...
void func_129(Vehicle veParam0, int iParam1) // Position - 0x9FE8
{
	int num;
	int num2;
...
BOOL func_130(int iParam0, var uParam1) // Position - 0xA009
{
	*uParam1 = -1;
...
int func_131(int iParam0) // Position - 0xA2CB
{
	switch (iParam0)
	{
		case 0:
...
int func_132(int iParam0, int iParam1, int iParam2) // Position - 0xA369
{
	...
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS() && func_133() && Global_1576245)
...
struct<13> GET_LOCAL_GAMER_HANDLE() // Position - 0xA593
{
	var gamerHandle;
...
BOOL func_135(Vehicle veParam0) // Position - 0xA5A8
{
	switch (ENTITY::GET_ENTITY_MODEL(veParam0))
	{
		case joaat("deathbike2"):
...
BOOL func_136(int iParam0, var uParam1) // Position - 0xA5C9
{
	*uParam1 = -1f;
...
void func_137(Vehicle veParam0) // Position - 0xA8CA
{
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
...
void func_138(Vehicle veParam0) // Position - 0xA8FC
{
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		if (DECORATOR::DECOR_IS_REGISTERED_AS_TYPE("MLJ", BOOL))
			if (!DECORATOR::DECOR_EXIST_ON(veParam0, "MLJ"))
...
BOOL func_139(Hash hParam0) // Position - 0xA930
{
	switch (hParam0)
	{
		case 1484920335:
...
BOOL func_140(Hash hParam0) // Position - 0xA953
{
...
BOOL func_141(Hash hParam0) // Position - 0xB3FA
{
	switch (hParam0)
	{
		case joaat("deity"):
...
void func_142(Vehicle veParam0, var uParam1, BOOL bParam2, BOOL bParam3) // Position - 0xB489
{
	int num;
	int num2;
	int i;
...
BOOL func_143(Vehicle veParam0, float fParam1) // Position - 0xBBA8
{
	float entityCoords;
	var groundZ;
...
Hash func_144(BOOL bParam0) // Position - 0xBC19
{
	if (bParam0)
...
BOOL func_145() // Position - 0xBC33
{
	...
	if (func_149(7))
		if (func_147(Global_2672967.f_4.f_16) || func_146(Global_2672967.f_4.f_16))
			return false;

	return true;
}

BOOL func_146(int iParam0) // Position - 0xBCC2
{
	int num;
...
BOOL func_147(int iParam0) // Position - 0xBCE6
{
	int num;
...
BOOL func_148(int iParam0, int iParam1) // Position - 0xBD04
{
	return IS_BIT_SET(Global_1888882[iParam0 /*611*/].f_10.f_4, iParam1);
}

BOOL func_149(int iParam0) // Position - 0xBD1C
{
	return func_150(&(Global_2672967.f_194), iParam0);
}

BOOL func_150(var uParam0, int iParam1) // Position - 0xBD30
{
	int num;
	int num2;
	int num3;
...
int func_151(var uParam0, var uParam1, var uParam2) // Position - 0xBD53
{
	int i;
	int modType;
...
BOOL func_152(Vehicle veParam0) // Position - 0xBF51
{
	int i;
	int modType;
	Hash hashKey;
...
void func_153(var uParam0) // Position - 0xC02C
{
...
int func_154(Vehicle veParam0, int iParam1) // Position - 0xC097
{
	int value;
	int value2;
	float num;
...
int func_155(Vehicle veParam0, int iParam1) // Position - 0xC180
{
	int i;
...
BOOL func_156(Hash hParam0) // Position - 0xC1E2
{
...
BOOL func_157(Hash hParam0, int iParam1) // Position - 0xC20D
{
	switch (hParam0)
	{
		case joaat("faction2"):
...
BOOL func_158(Vehicle veParam0, int iParam1, int iParam2) // Position - 0xC5F3
{
...
BOOL func_159() // Position - 0xC617
{
	return true;
}

void func_160(Vehicle veParam0, int iParam1) // Position - 0xC624
{
	int vehicleMod;
...
BOOL func_161(int iParam0) // Position - 0xC69C
{
	switch (iParam0)
	{
		case joaat("granger"):
...
BOOL func_162() // Position - 0xC6BC
{
	return DLC::IS_DLC_PRESENT(joaat("mpindependence"));
}

BOOL func_163(Vehicle veParam0) // Position - 0xC6CD
{
	int _int;
...
int func_164(var uParam0) // Position - 0xC712
{
...
BOOL func_165(int iParam0) // Position - 0xC732
{
	switch (iParam0)
	{
		case 161:
...
int func_166(int iParam0) // Position - 0xC785
{
	switch (iParam0)
	{
		case 1:
...
BOOL func_167(Vehicle veParam0) // Position - 0xC835
{
...
BOOL _IS_PLAYER_IN_VEHICLE_SEAT(Player plParam0, int iParam1) // Position - 0xC8BC
{
...
void func_169(var uParam0) // Position - 0xC909
{
...
void func_170(var uParam0) // Position - 0xC957
{
...
Vector3 func_171(float fParam0, var uParam1, var uParam2) // Position - 0xCA11
{
	return -SYSTEM::SIN(fParam0.f_2) * SYSTEM::COS(fParam0), SYSTEM::COS(fParam0.f_2) * SYSTEM::COS(fParam0), SYSTEM::SIN(fParam0);
}

BOOL func_172(var uParam0) // Position - 0xCA3E
{
	Player player;
	...
	else
	{
		...
		func_173(uParam0->f_23, &Global_1879551[player /*55*/], false, -1);
	}
...
void func_173(Ped pedParam0, var uParam1, BOOL bParam2, int iParam3) // Position - 0xCB16
{
	var unk;
	int characterType;
	BOOL flag;
...
void func_174(Ped pedParam0, int iParam1, int iParam2) // Position - 0xCC7F
{
	switch (iParam1)
	{
		case 1310977332:
...
BOOL func_175(Ped pedParam0, const char* sParam1, int iParam2, int iParam3, Hash hParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7, BOOL bParam8) // Position - 0xDF56
{
	Hash entityModel;
	int num;
...
BOOL func_176(int iParam0, int iParam1) // Position - 0xE77C
{
	int num;
	int num2;
...
int func_177(int iParam0, int iParam1) // Position - 0xE7BB
{
	int num;
	int num2;
...
int func_178() // Position - 0xE801
{
	return Global_33299;
}

int func_179(int iParam0) // Position - 0xE80C
{
	int num;
	int num2;
...
char* func_180(int iParam0) // Position - 0xEBAD
{
	switch (iParam0)
	{
		case 0:
...
int func_181(Hash hParam0, const char* sParam1, int iParam2) // Position - 0xF1EA
{
	switch (iParam2)
	{
		case joaat("crewLogo"):
...
BOOL func_182(char* sParam0, int iParam1, int iParam2, Ped pedParam3, int iParam4) // Position - 0x1021C
{
	Hash entityModel;
	int num;
...
void func_183(char* sParam0, int iParam1, int iParam2, int iParam3) // Position - 0x13188
{
	int decorationIndex;
	int numTattooShopDlcItems;
	Hash outComponent;
...
BOOL func_184() // Position - 0x1321A
{
...
BOOL func_185() // Position - 0x1324C
{
	return true;
}

int func_186() // Position - 0x13255
{
	int outValue;
	int outValue2;
	Hash statHash;
...
BOOL _IS_EXCLUSIVE_CONTENT_UNLOCKED() // Position - 0x13444
{
	int profileSetting;
...
int func_189() // Position - 0x134FC
{
	return 1;
}

int func_190() // Position - 0x13505
{
	return 1;
}

void func_191(char* sParam0, int iParam1, Ped pedParam2, char* sParam3, char* sParam4, char* sParam5, char* sParam6, int iParam7, int iParam8, int iParam9) // Position - 0x1350E
{
	var unk;
...
BOOL func_192(Ped pedParam0, int iParam1) // Position - 0x137C3
{
...
Hash func_193(Hash hParam0, int iParam1, int iParam2, int iParam3) // Position - 0x13A83
{
	var outProp;
	int componentId;
	int num;
...
int func_194(Hash hParam0, int iParam1) // Position - 0x13B9D
{
	switch (hParam0)
	{
...
ePedComponentType func_195(int iParam0) // Position - 0x13F44
{
	switch (iParam0)
	{
		case 0:
...
int func_196(Hash hParam0) // Position - 0x13FF4
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
...
int func_197(Ped pedParam0, int iParam1, ePedComponentType epctParam2) // Position - 0x1405A
{
	int i;
	int j;
...
int func_198(Ped pedParam0, int iParam1) // Position - 0x140FB
{
...
int func_199(Ped pedParam0, int iParam1, int iParam2, int iParam3) // Position - 0x1415B
{
	ePedComponentType componentId;
...
int func_200(Ped pedParam0, ePedComponentType epctParam1) // Position - 0x141B2
{
	int pedPropIndex;
...
int func_201(Ped pedParam0, int iParam1, int iParam2, ePedComponentType epctParam3) // Position - 0x141F9
{
	Hash entityModel;
...
int func_202(Ped pedParam0, ePedComponentType epctParam1) // Position - 0x142F5
{
	Hash entityModel;
...
int func_203(Hash hParam0, Hash hParam1, int iParam2, int iParam3) // Position - 0x14433
{
	var outfit;
	int i;
	int num;
...
int func_204(Hash hParam0) // Position - 0x144EE
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
...
int func_205(ePedComponentType epctParam0) // Position - 0x1454D
{
	switch (epctParam0)
	{
		case PV_COMP_HEAD:
...
BOOL func_206(Ped pedParam0, int iParam1, int iParam2) // Position - 0x145D3
{
	Hash entityModel;
	int num;
	Hash hash;
	...
	entityModel = ENTITY::GET_ENTITY_MODEL(pedParam0);
	Global_79551[1 /*14*/] = { func_222(entityModel, iParam1, iParam2, -1) };
	hash = Global_2883588;
	...
	if (iParam1 == 12)
	{
			...
			if (unk[num2] != -99)
			{
				if (!func_206(pedParam0, num2, unk[num2]))
				{
					...
					if (num2 == 13)
					{
						...
						for (i = 0; i <= 8; i = i + 1)
						{
							if (!func_206(pedParam0, 14, unk18[i]))
							{
								for (j = 0; j <= 19; j = j + 1)
								{
									Global_79551[2 /*14*/] = { func_222(entityModel, 14, j, -1) };
								
									if (Global_79551[2 /*14*/].f_12 == i)
									{
										if (func_206(pedParam0, 14, j))
										{
											if (!func_210(entityModel, iParam2, 14, j, &unk, &Global_79551[2 /*14*/]))
											{
												Global_2883588 = hash;
												Global_2883589 = hash2;
												return false;
					...
					else
					{
						...
						Global_79551[2 /*14*/] = { func_222(entityModel, num2, num, -1) };
					
						if (!func_210(entityModel, iParam2, num2, num, &unk, &Global_79551[2 /*14*/]))
						{
							Global_2883588 = hash;
							Global_2883589 = hash2;
							return false;
		...
		{
			if (func_92(1759, Global_79548) != unk[10])
			{
				Global_2883588 = hash;
				Global_2883589 = hash2;
				return false;
	...
	{
		if (Global_79551[1 /*14*/].f_3 == PED::GET_PED_DRAWABLE_VARIATION(pedParam0, func_195(iParam1)) && Global_79551[1 /*14*/].f_4 == PED::GET_PED_TEXTURE_VARIATION(pedParam0, func_195(iParam1)))
			return true;
...
BOOL func_207(Hash hParam0, int iParam1, int iParam2, var uParam3) // Position - 0x14A2E
{
	Hash componentHash;
...
BOOL func_208(Hash hParam0, int iParam1, int iParam2, var uParam3) // Position - 0x14AD7
{
	Hash componentHash;
	int shopPedApparelVariantComponentCount;
	int i;
...
BOOL func_209(Hash hParam0, int iParam1, int iParam2, Hash hParam3) // Position - 0x14B7F
{
	switch (hParam0)
	{
		case joaat("MP_F_Freemode_01"):
...
BOOL func_210(Hash hParam0, int iParam1, int iParam2, int iParam3, var uParam4, int iParam5) // Position - 0x14BD2
{
	var unk;
	int i;
...
BOOL func_211(Hash hParam0, int iParam1, int iParam2, Hash hParam3) // Position - 0x151D6
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
...
BOOL func_212(Hash hParam0, int iParam1, int iParam2, Hash hParam3) // Position - 0x15453
{
	if (hParam0 == joaat("Player_Zero"))
	{
		if (iParam1 == 6)
...
BOOL func_213(Hash hParam0, int iParam1, int iParam2, Hash hParam3) // Position - 0x15878
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
...
BOOL func_214(Hash hParam0, int iParam1, int iParam2) // Position - 0x15B6B
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
...
struct<10> func_215(Hash hParam0, int iParam1) // Position - 0x15C04
{
	int i;
	var unk;
...
void func_216(var uParam0, Hash hParam1, int iParam2, int iParam3) // Position - 0x16533
{
	int num;
	Hash itemHash;
	Hash outPropVariant;
...
void func_217(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9) // Position - 0x1665D
{
	uParam0->[0] = iParam1;
	uParam0->[1] = iParam2;
	uParam0->[2] = iParam3;
...
struct<17> func_218(Hash hParam0, int iParam1) // Position - 0x166A5
{
	int i;
	var unk;
	...
	switch (hParam0)
	{
		case joaat("Player_Zero"):
			switch (iParam1)
			{
				...
				case 5:
					func_221(&unk, -99, -99, Global_114370.f_2367.f_539.f_196[0], Global_114370.f_2367.f_539.f_200[0], 6, 3, 0, 0, 0, -99, 0, 0, 3);
					break;
		...
		case joaat("Player_One"):
			switch (iParam1)
			{
				...
				case 2:
					func_221(&unk, -99, -99, Global_114370.f_2367.f_539.f_196[1], Global_114370.f_2367.f_539.f_200[1], 17, 2, 26, 0, 0, -99, 0, 45, 31);
					break;
		...
		case joaat("Player_Two"):
			switch (iParam1)
			{
				...
				case 4:
					func_221(&unk, -99, -99, Global_114370.f_2367.f_539.f_196[2], Global_114370.f_2367.f_539.f_200[2], 8, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
...
void func_219(var uParam0, Hash hParam1, int iParam2, int iParam3) // Position - 0x184EF
{
	int num;
	Hash outfit;
...
int func_220(int iParam0) // Position - 0x186D9
{
	switch (iParam0)
	{
		case 0:
...
void func_221(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Position - 0x18789
{
	uParam0->[0] = iParam1;
	uParam0->[2] = iParam2;
	uParam0->[3] = iParam3;
...
struct<14> func_222(Hash hParam0, int iParam1, int iParam2, Hash hParam3) // Position - 0x187FA
{
	func_268();
...
void func_223(int iParam0, int iParam1, Hash hParam2) // Position - 0x1883B
{
	switch (iParam0)
	{
		case 2:
...
void func_224(int iParam0) // Position - 0x18947
{
	BOOL flag;
	int num;
	var unk;
	...
	func_225(&Global_79551[0 /*14*/], num6, iParam0, &unk, num2, num3, num, flag, num4, num5, false);
	return;
}

void func_225(int iParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, BOOL bParam7, int iParam8, int iParam9, BOOL bParam10) // Position - 0x18B02
{
	int num;
	int num2;
	...
	*iParam0 = iParam9;
	...
	else
	{
		...
		if (iParam1 == 11 || iParam1 == 4 || iParam1 == 6 || iParam1 == 1 || iParam1 == 14 || iParam1 == 2 || iParam1 == 8 || iParam1 == 9 || iParam1 == 10 || iParam1 == 7 || iParam1 == 12)
		{
			...
			num = func_92(func_228(iParam1, iParam0->f_2), Global_79548);
		
			if (IS_BIT_SET(num, iParam0->f_1))
				MISC::SET_BIT(&(iParam0->f_6), 1);
		
			num = func_92(func_227(iParam1, iParam0->f_2), Global_79548);
...
BOOL func_226(int iParam0, int iParam1, var uParam2) // Position - 0x18EA4
{
	*uParam2 = 979;
...
int func_227(int iParam0, int iParam1) // Position - 0x192A9
{
	switch (iParam1)
	{
		case 0:
...
int func_228(int iParam0, int iParam1) // Position - 0x196A4
{
	switch (iParam1)
	{
		case 0:
...
BOOL func_229(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x19A9F
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
BOOL func_230(Hash hParam0, int iParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0x1A942
{
	int num;
	int num2;
	int num3;
...
BOOL func_231(Hash hParam0, int iParam1, var uParam2, var uParam3, BOOL bParam4, BOOL bParam5) // Position - 0x1A980
{
...
BOOL func_232(int iParam0) // Position - 0x1D634
{
	return Global_44392 == iParam0;
}

int func_233(int iParam0) // Position - 0x1D642
{
	switch (iParam0)
	{
		case -1:
...
void func_234(int iParam0, Hash hParam1) // Position - 0x1D716
{
	int num;
...
void func_235(int iParam0, int iParam1, int iParam2, Hash hParam3) // Position - 0x1D736
{
	int num;
	int num2;
	Hash outfit;
	...
	if (iParam0 == 12)
	{
		...
		if (outfitIndex >= 0)
		{
			...
			if (num3 > outfitIndex)
			{
				...
				func_225(&Global_79551[0 /*14*/], iParam0, iParam1, &(outfit.f_7), 0, 0, outfit.f_2, false, -1, 2, true);
				return;
			}
		}
	}
	...
	{
		func_225(&Global_79551[0 /*14*/], iParam0, iParam1, "NO_LABEL", 0, 0, 0, true, -1, 2, true);
	}
	else if (iParam0 == 14)
	{
		FILES::INIT_SHOP_PED_PROP(&outProp);
		...
		if (componentId >= 0)
		{
			...
			if (num5 > componentId)
			{
				...
				func_225(&Global_79551[0 /*14*/], iParam0, iParam1, &(outProp.f_9), outProp.f_3, outProp.f_4, outProp.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(outProp.f_1, joaat("OUTFIT_ONLY"), 0), num4, 2, outProp.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (hParam3 != -1 && Global_79749)
		{
			...
			func_225(&Global_79551[0 /*14*/], iParam0, iParam1, &(outComponent.f_9), outComponent.f_3, outComponent.f_4, outComponent.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(outComponent.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, outComponent.f_1 != 0);
			return;
		}
...
void func_236(int iParam0, Hash hParam1) // Position - 0x1D9BD
{
	BOOL flag;
	int num;
	var unk;
...
void func_237(int iParam0, Hash hParam1) // Position - 0x1DAC0
{
	BOOL flag;
	int num;
	var unk;
...
void func_238(int iParam0, Hash hParam1) // Position - 0x1DD9F
{
	BOOL flag;
	int value;
	var unk;
	...
	{
		func_225(&Global_79551[0 /*14*/], num5, iParam0, &unk, num, num2, value, flag, num3, num4, false);
	}

	return;
}

void func_239(int iParam0, Hash hParam1) // Position - 0x20B76
{
	BOOL flag;
	int num;
	var unk;
...
void func_240(int iParam0, Hash hParam1) // Position - 0x20C7B
{
	BOOL flag;
	int value;
	var unk;
...
void func_241(int iParam0, Hash hParam1) // Position - 0x21457
{
	BOOL flag;
	int value;
	var unk;
...
void func_242(int iParam0, Hash hParam1) // Position - 0x2173C
{
	BOOL flag;
	int value;
	var unk;
...
void func_243(int iParam0, Hash hParam1) // Position - 0x22D63
{
	BOOL flag;
	int value;
	var unk;
...
void func_244(int iParam0, Hash hParam1) // Position - 0x243C3
{
	BOOL flag;
	int num;
	var unk;
...
void func_245(int iParam0, Hash hParam1) // Position - 0x2451E
{
	BOOL flag;
	int num;
	var unk;
...
void func_246(int iParam0, Hash hParam1) // Position - 0x2479E
{
	BOOL flag;
	int value;
	var unk;
...
BOOL func_247(int iParam0, int iParam1) // Position - 0x25B40
{
	int num;
	int num2;

	if (func_249(iParam0) == 17296)
		return false;
...
int func_248(int iParam0, int iParam1) // Position - 0x25B6F
{
	int num;
...
int func_249(int iParam0) // Position - 0x25B87
{
	int num;
	int num2;
...
void func_250(int iParam0, Hash hParam1) // Position - 0x25F02
{
	BOOL flag;
	int value;
	var unk;
...
void func_251(int iParam0, Hash hParam1) // Position - 0x27667
{
	BOOL flag;
	int value;
	var unk;
...
void func_252(int iParam0, int iParam1, Hash hParam2) // Position - 0x28539
{
	switch (iParam0)
	{
		case 2:
...
void func_253(int iParam0) // Position - 0x28645
{
	BOOL flag;
	int num;
	var unk;
...
void func_254(int iParam0, Hash hParam1) // Position - 0x2880F
{
	int num;
...
void func_255(int iParam0, Hash hParam1) // Position - 0x2882F
{
	BOOL flag;
	int num;
	var unk;
...
void func_256(int iParam0, Hash hParam1) // Position - 0x28932
{
	BOOL flag;
	int num;
	var unk;
...
void func_257(int iParam0, Hash hParam1) // Position - 0x28BE3
{
	BOOL flag;
	int value;
	var unk;
...
void func_258(int iParam0, Hash hParam1) // Position - 0x2B9A2
{
	BOOL flag;
	int num;
	var unk;
...
void func_259(int iParam0, Hash hParam1) // Position - 0x2BAC3
{
	BOOL flag;
	int value;
	var unk;
...
void func_260(int iParam0, Hash hParam1) // Position - 0x2C3BD
{
	BOOL flag;
	int value;
	var unk;
...
void func_261(int iParam0, Hash hParam1) // Position - 0x2C674
{
	BOOL flag;
	int value;
	var unk;
...
void func_262(int iParam0, Hash hParam1) // Position - 0x2DCB1
{
	BOOL flag;
	int value;
	var unk;
...
void func_263(int iParam0, Hash hParam1) // Position - 0x2F2E4
{
	BOOL flag;
	int num;
	var unk;
...
void func_264(int iParam0, Hash hParam1) // Position - 0x2F43B
{
	BOOL flag;
	int num;
	var unk;
...
void func_265(int iParam0, Hash hParam1) // Position - 0x2F757
{
	BOOL flag;
	int value;
	var unk;
...
void func_266(int iParam0, Hash hParam1) // Position - 0x31C49
{
	BOOL flag;
	int value;
	var unk;
...
void func_267(int iParam0, Hash hParam1) // Position - 0x331D4
{
	BOOL flag;
	int value;
	var unk;
...
void func_268() // Position - 0x34090
{
...
BOOL func_269(Ped pedParam0) // Position - 0x34109
{
	int num;
...
int func_270(int iParam0) // Position - 0x34185
{
	if (func_271(true))
...
BOOL func_271(BOOL bParam0) // Position - 0x341BC
{
	if (func_275(bParam0) || func_273() || func_272(*Global_4718592.f_197275))
		return true;

	return false;
}

BOOL func_272(int iParam0) // Position - 0x341F0
{
	return iParam0 == 87;
}

BOOL func_273() // Position - 0x341FD
{
	return func_274(*Global_4718592.f_138116);
}

int func_274(int iParam0) // Position - 0x34213
{
	int i;
...
BOOL func_275(BOOL bParam0) // Position - 0x3424D
{
	if (bParam0)
		return IS_BIT_SET(*Global_4718592.f_190071, 12) && func_276();

	return IS_BIT_SET(*Global_4718592.f_190071, 12);
}

BOOL func_276() // Position - 0x34283
{
...
BOOL func_277(Ped pedParam0, BOOL bParam1) // Position - 0x342B1
{
	int pedDrawableVariation;
	int pedTextureVariation;
	int num;
			...
			switch (pedDrawableVariation)
			{
				...
				case 5:
					if (!bParam1)
					{
						...
						else if (func_118(PLAYER::PLAYER_ID(), true) && Global_1888882[PLAYER::PLAYER_ID() /*611*/].f_10.f_76.f_21 != 0)
						{
							return 1;
						}
					}
...
int func_278(Hash hParam0, int iParam1, int iParam2, int iParam3) // Position - 0x34AEB
{
	Hash componentHash;
...
int func_279(int iParam0, Hash hParam1) // Position - 0x3530B
{
...
int func_280(Ped pedParam0) // Position - 0x3532D
{
...
Player func_281() // Position - 0x35390
{
	Player player;
...
Player _GET_BOSS_OF_LOCAL_PLAYER() // Position - 0x353AE
{
	return Global_1888882[PLAYER::PLAYER_ID() /*611*/].f_10;
}

BOOL func_283(BOOL bParam0) // Position - 0x353C3
{
	return func_284(PLAYER::PLAYER_ID(), bParam0);
}

BOOL func_284(Player plParam0, BOOL bParam1) // Position - 0x353D5
{
	if (!func_11(plParam0))
		return false;
...
BOOL func_285(Player plParam0) // Position - 0x3540D
{
	if (func_11(plParam0))
		if (func_11(Global_1888882[plParam0 /*611*/].f_10))
...
BOOL func_287(Player plParam0, BOOL bParam1, BOOL bParam2) // Position - 0x35464
{
...
int func_288(var uParam0) // Position - 0x354BB
{
	return *uParam0;
}

void func_289() // Position - 0x354C6
{
...
void func_290(int iParam0) // Position - 0x35511
{
	if (func_46())
		return;
...
void func_291(BOOL bParam0) // Position - 0x35544
{
	if (bParam0)
		func_293();
...
void func_292(int iParam0, int iParam1) // Position - 0x35595
{
...
void func_293() // Position - 0x355CB
{
	Global_2740191.f_4672 = 0;
	return;
}

BOOL func_294() // Position - 0x355DB
{
...
BOOL _SHOULD_NETWORK_SCRIPT_TERMINATE() // Position - 0x355EF
{
...
Hash _GET_CURRENT_SESSION_TYPE_SCRIPT_HASH() // Position - 0x35673
{
	switch (func_96())
	{
		case 0:
...
Hash func_297() // Position - 0x356A6
{
...
BOOL func_298() // Position - 0x356CA
{
	return Global_2684748.f_700;
}

BOOL _DOES_EVENT_OF_TYPE_EXIST(int iParam0) // Position - 0x356D9
{
...
BOOL func_300() // Position - 0x356F0
{
	return Global_2696555;
}

BOOL func_301() // Position - 0x356FC
{
	return Global_2684748.f_695;
}

void func_302() // Position - 0x3570B
{
	SYSTEM::WAIT(0);
	return;
}

void func_303() // Position - 0x35718
{
	NETWORK::NETWORK_SET_THIS_SCRIPT_IS_NETWORK_SCRIPT(32, false, -1);
	func_306(&uLocal_122, joaat("nimbus"), "Plane_1");
	func_55(&uLocal_122, 1);
	func_304(&uLocal_122, -1249.1444f, -3200.4622f, 13.5621f, 1.8349f, -0.2505f, 59.0838f, "hs4_lsa_take_nimb2", 0, 0, 1, 0);
	return;
}

void func_304(var uParam0, float fParam1, float fParam2, float fParam3, float fParam4, float fParam5, float fParam6, char* sParam7, int iParam8, int iParam9, int iParam10, int iParam11) // Position - 0x35769
{
...
void func_305(var uParam0, char* sParam1, int iParam2, int iParam3, int iParam4) // Position - 0x35799
{
	uParam0->f_1 = sParam1;
	uParam0->f_2 = iParam3;
...
void func_306(var uParam0, int iParam1, char* sParam2) // Position - 0x357C6
{
