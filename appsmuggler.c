...
void main() // Position - 0x0
{
	...
	while (func_513())
	{
		...
		if (!IS_BIT_SET(iLocal_538, 5) && func_511())
		{
			func_509();
			func_486();
		}
	
		if (!IS_BIT_SET(iLocal_538, 8) && IS_BIT_SET(iLocal_538, 5))
			func_480();
		...
		if (!IS_BIT_SET(iLocal_538, 2))
		{
			func_6();
		}
		else if (!_STOPWATCH_IS_INITIALIZED(&uLocal_571))
		{
			_STOPWATCH_INITIALIZE(&uLocal_571, false, false);
		}
		else if (_STOPWATCH_HAS_TIME_PASSED(&uLocal_571, 200, false))
		{
			if (!Global_1946439.f_3952 && CAM::IS_SCREEN_FADED_OUT())
			{
				func_1(1);
				Global_1946293 = 1;
				func_527(0, true);
...
void func_6() // Position - 0x261
{
	...
	if (IS_BIT_SET(iLocal_538, 0))
	{
		if (GRAPHICS::IS_SCALEFORM_MOVIE_METHOD_RETURN_VALUE_READY(iLocal_1286))
		{
			scaleformMovieMethodReturnValueInt = GRAPHICS::GET_SCALEFORM_MOVIE_METHOD_RETURN_VALUE_INT(iLocal_1286);
			...
			switch (scaleformMovieMethodReturnValueInt)
			{
				...
				case 20:
				case 21:
					func_205(func_224(scaleformMovieMethodReturnValueInt), false);
					break;
				...
				case 29:
					...
					{
						iLocal_568 = 2;
						GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(iLocal_1285, "SHOW_SCREEN", 2f, -1082130432, -1082130432, -1082130432, -1082130432);
					}
					break;
				...
				case 9:
				case 10:
					func_7(func_224(scaleformMovieMethodReturnValueInt));
					break;
			}
...
{
	if (func_16(plParam0))
		if (func_16(Global_1888882[plParam0 /*611*/].f_10))
...
int func_45(Player plParam0) // Position - 0x124D
{
	int i;
	Player player;
...
BOOL func_46(Player plParam0) // Position - 0x12B9
{
	if (plParam0 == _INVALID_PLAYER_INDEX())
		return false;
...
int func_47() // Position - 0x1357
{
	return func_48() - 1;
}

int func_48() // Position - 0x1365
{
	return func_49(PLAYER::PLAYER_ID());
}

int func_49(Player plParam0) // Position - 0x1375
{
	Player player;

	player = Global_1888882[plParam0 /*611*/].f_10;

	if (func_16(player) && Global_1888882[player /*611*/].f_10.f_431 == 1)
		return 8;

	return 4;
}

BOOL func_50(Player plParam0) // Position - 0x13AE
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2658019[plParam0 /*467*/].f_324.f_8 != -1)
				return func_51(Global_2658019[plParam0 /*467*/].f_324.f_8) == 23;

	return false;
}

int func_51(int iParam0) // Position - 0x13F5
{
	switch (iParam0)
	{
		case 0:
...
BOOL _NETWORK_IS_PLAYER_VALID(Player player, BOOL bIsPlaying, BOOL bUnk) // Position - 0x1944
{
	Player player;
...
BOOL func_53(Player plParam0) // Position - 0x19A4
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
...
BOOL _IS_PLAYER_IN_ANIMAL_FORM(Player plParam0) // Position - 0x19C9
{
	Ped playerPed;
	Hash entityModel;
...
BOOL func_55(Player plParam0) // Position - 0x1A35
{
	Player player;
...
int func_56(int iParam0) // Position - 0x1A58
{
	switch (iParam0)
	{
		case 162:
...
int func_57(int iParam0) // Position - 0x1BAA
{
	return Global_1918514.f_11.f_147[func_58(iParam0)];
}

int func_58(int iParam0) // Position - 0x1BC2
{
	switch (iParam0)
	{
		case 148:
...
BOOL func_59(int iParam0, int iParam1, int iParam2, BOOL bParam3, BOOL bParam4) // Position - 0x21D9
{
...
BOOL func_60(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x2213
{
	return func_61(2, iParam0, false, bParam1, bParam2);
}

BOOL func_61(int iParam0, int iParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x2227
{
	int num;
	int num2;
...
int func_62(int iParam0) // Position - 0x22ED
{
	switch (iParam0)
	{
		case 0:
...
int func_63(int iParam0) // Position - 0x2327
{
	switch (iParam0)
	{
		case 0:
...
int func_64(int iParam0, BOOL bParam1) // Position - 0x236D
{
	Player player;
...
int func_65(int iParam0) // Position - 0x240A
{
	switch (iParam0)
	{
		case 0:
...
int func_66(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x244A
{
	return func_61(1, iParam0, false, bParam1, bParam2);
}

int func_67(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x245E
{
	return func_61(0, iParam0, false, bParam1, bParam2);
}

int func_68(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, Player plParam5) // Position - 0x2472
{
	switch (iParam0)
	{
		case 148:
...
int func_69(int iParam0, int iParam1, Player plParam2, int iParam3) // Position - 0x2745
{
	int num;
...
int func_70(int iParam0, Player plParam1) // Position - 0x2768
{
	switch (iParam0)
	{
		case 2:
...
int func_71(int iParam0, int iParam1, int iParam2) // Position - 0x2782
{
	switch (iParam0)
	{
		case 0:
...
int func_72(int iParam0, int iParam1, Player plParam2, int iParam3) // Position - 0x279C
{
	int num;
...
int func_73(int iParam0, Player plParam1) // Position - 0x27BF
{
	var unk;
...
Vector3 func_74(Player plParam0) // Position - 0x2926
{
	return Global_1888882[plParam0 /*611*/].f_10.f_308;
}

BOOL func_75(Player plParam0, BOOL bParam1) // Position - 0x293E
{
	if (!func_16(plParam0))
		return false;
	...
	return func_16(Global_1888882[plParam0 /*611*/].f_10);
}

int func_76(int iParam0, int iParam1, int iParam2) // Position - 0x2976
{
	switch (iParam0)
	{
		case 0:
...
int func_77(int iParam0, int iParam1, Player plParam2, int iParam3) // Position - 0x2BD9
{
	int num;
...
int func_78(int iParam0, Player plParam1) // Position - 0x2C06
{
	switch (iParam0)
	{
		case 14:
...
BOOL func_79(int iParam0) // Position - 0x2C58
{
	return false;
}

int func_80(int iParam0, int iParam1, int iParam2) // Position - 0x2C61
{
	switch (iParam0)
	{
		case 13:
...
int func_81(int iParam0) // Position - 0x2E10
{
	switch (iParam0)
	{
		case 0:
...
int func_82(int iParam0, int iParam1, int iParam2) // Position - 0x2E5C
{
	int num;
...
BOOL func_83(int iParam0) // Position - 0x2E80
{
	return true;
}

int func_84(int iParam0, int iParam1) // Position - 0x2E89
{
	switch (iParam0)
	{
		case 12:
...
int func_85(int iParam0, int iParam1) // Position - 0x2FD8
{
	int num;
...
int func_86(int iParam0, int iParam1) // Position - 0x306C
{
	int num;
	int num2;
	int num3;
...
int func_87(int iParam0) // Position - 0x3105
{
	switch (iParam0)
	{
		case 5:
...
int func_88(int iParam0, int iParam1) // Position - 0x3135
{
	if (func_92(iParam0))
	{
...
BOOL func_89(int iParam0) // Position - 0x3183
{
	switch (iParam0)
	{
		case 15:
...
Player _GET_BOSS_OF_LOCAL_PLAYER() // Position - 0x31D4
{
	return Global_1888882[PLAYER::PLAYER_ID() /*611*/].f_10;
}

BOOL func_92(int iParam0) // Position - 0x31E9
{
	switch (iParam0)
	{
		case 14:
...
int func_93(int iParam0, int iParam1) // Position - 0x323F
{
	switch (iParam0)
	{
		case 32:
...
int func_94(int iParam0, int iParam1, int iParam2, Player plParam3, int iParam4) // Position - 0x34D1
{
	int num;
...
BOOL func_95(int iParam0) // Position - 0x3524
{
	switch (iParam0)
	{
		case 2:
...
int func_96(int iParam0, int iParam1, Player plParam2, int iParam3, int iParam4) // Position - 0x354A
{
	int num;
...
int func_97(int iParam0) // Position - 0x35E6
{
	return 1;
}

int func_98(int iParam0) // Position - 0x35EF
{
	return 4;
}

BOOL func_99(int iParam0) // Position - 0x35F8
{
	switch (iParam0)
	{
		case 3:
...
int func_100(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x3636
{
	int num;
...
int func_101(int iParam0, int iParam1, int iParam2, Player plParam3, int iParam4) // Position - 0x36F1
{
	int num;
...
BOOL func_102(int iParam0) // Position - 0x3744
{
	switch (iParam0)
	{
		case 23:
...
int func_103(int iParam0, int iParam1, Player plParam2, int iParam3, int iParam4) // Position - 0x375E
{
	int num;
	int num2;
...
int func_104(int iParam0) // Position - 0x38DC
{
	switch (iParam0)
	{
		case 15:
...
int func_105(int iParam0) // Position - 0x38F6
{
	if (!func_110(iParam0))
	{
		if (func_111(iParam0))
...
BOOL func_106(int iParam0) // Position - 0x3950
{
	switch (iParam0)
	{
		case 12:
...
int func_107(Player plParam0) // Position - 0x396A
{
...
BOOL func_108(int iParam0) // Position - 0x39AC
{
	switch (iParam0)
	{
		case 26:
...
int func_109(int iParam0) // Position - 0x39C6
{
	if (iParam0 > 25)
		return 3;
	else if (iParam0 > 10)
...
BOOL func_110(int iParam0) // Position - 0x39E8
{
	switch (iParam0)
	{
		case 15:
...
BOOL func_111(int iParam0) // Position - 0x3A3E
{
...
int func_112(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x3A60
{
	switch (iParam0)
	{
		case 1:
...
int func_113(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x3B92
{
	int num;
...
BOOL func_114(int iParam0) // Position - 0x3BD8
{
	switch (iParam0)
	{
		case 0:
...
int func_115(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x3C1C
{
	int num;
...
BOOL func_116(int iParam0) // Position - 0x3CF9
{
	switch (iParam0)
	{
		case 14:
...
BOOL func_117(int iParam0) // Position - 0x3D31
{
	switch (iParam0)
	{
		case 0:
...
int func_118(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x3D93
{
	switch (iParam0)
	{
		case 0:
...
int func_119(int iParam0, int iParam1, int iParam2) // Position - 0x40DF
{
	int num;
...
int func_120(int iParam0, int iParam1) // Position - 0x4100
{
	switch (iParam0)
	{
		case 6:
...
int func_121(int iParam0) // Position - 0x42C0
{
	switch (iParam0)
	{
		case 0:
...
int func_122(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, Player plParam5) // Position - 0x4398
{
	switch (iParam0)
	{
		case 148:
...
int func_123(int iParam0, int iParam1, Player plParam2, BOOL bParam3, int iParam4, BOOL bParam5, BOOL bParam6) // Position - 0x4687
{
	int num;
...
int func_124(int iParam0, int iParam1) // Position - 0x46FD
{
	switch (iParam0)
	{
		case 2:
...
BOOL func_125(int iParam0, int iParam1) // Position - 0x4717
{
	return func_124(iParam0, iParam1) > 0;
}

int func_126(int iParam0, int iParam1, Player plParam2) // Position - 0x4729
{
	switch (iParam1)
	{
		case 2:
...
int func_127(int iParam0, int iParam1) // Position - 0x4743
{
	switch (iParam1)
	{
		case 0:
...
int func_128(int iParam0, int iParam1) // Position - 0x4777
{
	switch (iParam0)
	{
		case 2:
...
int func_129(int iParam0, int iParam1, Player plParam2, BOOL bParam3, int iParam4, BOOL bParam5, BOOL bParam6) // Position - 0x4791
{
	int num;
...
int func_130(int iParam0, int iParam1) // Position - 0x4B1C
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_131(int iParam0, int iParam1) // Position - 0x4BA2
{
	return func_130(iParam0, iParam1) > 0;
}

int func_132(int iParam0, int iParam1, Player plParam2) // Position - 0x4BB4
{
	var unk;
...
int func_133(int iParam0, int iParam1) // Position - 0x4C4C
{
	switch (iParam1)
	{
		case 96:
...
int func_134(int iParam0, int iParam1) // Position - 0x4F2B
{
	switch (iParam0)
	{
		case 53:
...
int func_135(int iParam0, int iParam1, Player plParam2, BOOL bParam3, int iParam4, BOOL bParam5, BOOL bParam6) // Position - 0x4F45
{
	int num;
...
int func_136(int iParam0, int iParam1) // Position - 0x5220
{
	switch (iParam0)
	{
		case 4:
...
BOOL func_137(int iParam0, int iParam1) // Position - 0x5257
{
	return func_136(iParam0, iParam1) > 0;
}

int func_138(int iParam0, int iParam1) // Position - 0x5269
{
	switch (iParam1)
	{
		case 6:
...
int func_139(int iParam0, int iParam1) // Position - 0x5293
{
	switch (iParam1)
	{
		case 46:
...
int func_140(int iParam0, int iParam1) // Position - 0x53C5
{
	switch (iParam0)
	{
		case 16:
...
int func_141(int iParam0) // Position - 0x53DF
{
	switch (iParam0)
	{
		case 0:
...
int func_142(int iParam0, int iParam1, int iParam2) // Position - 0x542B
{
	int num;
...
int func_143(int iParam0, int iParam1) // Position - 0x55CC
{
	int num;
...
int func_144(int iParam0, int iParam1, int iParam2, Player plParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0x5BB3
{
	int num;
...
int func_145(int iParam0) // Position - 0x5D29
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_146(int iParam0) // Position - 0x5D6D
{
	return func_145(iParam0) > 0;
}

int func_147(int iParam0, int iParam1) // Position - 0x5D7D
{
	return 2;
}

int func_148(int iParam0, int iParam1) // Position - 0x5D86
{
	switch (iParam1)
	{
		case 136:
...
int func_149(int iParam0, int iParam1) // Position - 0x5DCE
{
	BOOL flag;
...
BOOL func_150(int iParam0, int iParam1) // Position - 0x5E2D
{
	Hash statHash;
	int outValue;
...
Hash func_151(int iParam0, int iParam1) // Position - 0x5E5C
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(0, iParam0, func_152(iParam1));
}

int func_152(int iParam0) // Position - 0x5E71
{
	int num;
	int num2;
...
int func_153() // Position - 0x5EA5
{
	return Global_1574927;
}

int func_154(int iParam0, int iParam1, int iParam2, Player plParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0x5EB1
{
	int num;
...
int func_155(int iParam0) // Position - 0x6177
{
	switch (iParam0)
	{
		case 12:
...
BOOL func_156(int iParam0) // Position - 0x61E9
{
	return func_155(iParam0) > 0;
}

int func_157(int iParam0, int iParam1) // Position - 0x61F9
{
	switch (iParam0)
	{
		case 1:
...
int func_158(int iParam0, int iParam1) // Position - 0x62F1
{
	switch (iParam1)
	{
		case 0:
...
int func_159(int iParam0, int iParam1) // Position - 0x6691
{
	switch (iParam0)
	{
		case 1:
...
int func_160(int iParam0, int iParam1, int iParam2, BOOL bParam3, BOOL bParam4) // Position - 0x678A
{
	int num;
...
int func_161(int iParam0) // Position - 0x6B0D
{
	switch (iParam0)
	{
		case 1:
...
BOOL func_162(int iParam0) // Position - 0x6B81
{
	return func_161(iParam0) > 0;
}

int func_163(int iParam0, int iParam1) // Position - 0x6B91
{
	switch (iParam0)
	{
		case 2:
...
int func_164(int iParam0, int iParam1, int iParam2) // Position - 0x6BDD
{
	int num;
...
int func_165(int iParam0) // Position - 0x6EE6
{
	if (func_166(iParam0))
		return 2;
...
BOOL func_166(int iParam0) // Position - 0x6EFC
{
	switch (iParam0)
	{
		case 7:
...
int func_167(int iParam0, int iParam1, int iParam2) // Position - 0x6F46
{
	int num;
...
int func_168(int iParam0) // Position - 0x6F70
{
	switch (iParam0)
	{
		case 0:
...
int func_169(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x7049
{
	switch (iParam0)
	{
		case 148:
...
int func_170(int iParam0, int iParam1, BOOL bParam2, int iParam3) // Position - 0x7311
{
	int num;
...
int func_171(int iParam0, int iParam1) // Position - 0x734F
{
	if (func_125(iParam0, iParam1))
...
int func_172(int iParam0, int iParam1) // Position - 0x7377
{
	switch (iParam0)
	{
		case 2:
...
int func_173(int iParam0, int iParam1, BOOL bParam2, int iParam3) // Position - 0x7391
{
	int num;
...
int func_174(int iParam0, int iParam1) // Position - 0x771F
{
	if (func_131(iParam0, iParam1))
...
int func_175(int iParam0, int iParam1) // Position - 0x7747
{
	switch (iParam0)
	{
		case 0:
...
int func_176(int iParam0, int iParam1, BOOL bParam2, int iParam3) // Position - 0x77D5
{
	int num;
...
int func_177(int iParam0, int iParam1) // Position - 0x79F8
{
	if (func_137(iParam0, iParam1))
...
int func_178(int iParam0, int iParam1) // Position - 0x7A20
{
	switch (iParam0)
	{
		case 4:
...
int func_179(int iParam0, int iParam1) // Position - 0x7A57
{
	switch (iParam0)
	{
		case 0:
...
int func_180(int iParam0, int iParam1, int iParam2) // Position - 0x7AC8
{
	int num;
...
int func_183(int iParam0, int iParam1) // Position - 0x7C9D
{
	int num;
...
int func_184(int iParam0, int iParam1, int iParam2, BOOL bParam3) // Position - 0x828C
{
	int num;
...
int func_185(int iParam0, int iParam1) // Position - 0x838B
{
	if (func_146(iParam0))
...
int func_186(int iParam0, int iParam1) // Position - 0x83AF
{
	switch (iParam0)
	{
		case 0:
...
int func_187(int iParam0, int iParam1, int iParam2, BOOL bParam3) // Position - 0x83F5
{
	int num;
...
int func_188(int iParam0, int iParam1) // Position - 0x856F
{
	if (func_156(iParam0))
...
int func_189(int iParam0, int iParam1) // Position - 0x8593
{
	switch (iParam0)
	{
		case 11:
...
int func_190(int iParam0, int iParam1, int iParam2, BOOL bParam3) // Position - 0x860D
{
	int num;
...
int func_191(int iParam0) // Position - 0x8942
{
	if (func_162(iParam0))
...
int func_192(int iParam0) // Position - 0x8964
{
	switch (iParam0)
	{
		case 1:
...
int func_193(int iParam0, int iParam1, int iParam2) // Position - 0x89E0
{
	int num;
...
int func_194(int iParam0) // Position - 0x8CA8
{
	if (func_166(iParam0))
	{
		if (func_195(iParam0))
...
BOOL func_195(int iParam0) // Position - 0x8CCB
{
	switch (iParam0)
	{
		case 7:
...
int func_196(int iParam0) // Position - 0x8D15
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_197(Player plParam0, int iParam1, BOOL bParam2) // Position - 0x8DF7
{
	return func_21(plParam0, iParam1, bParam2) == -1;
}

BOOL func_198(int iParam0) // Position - 0x8E0B
{
	if (_STOPWATCH_IS_INITIALIZED(&Global_2710342[iParam0 /*2*/]) && _STOPWATCH_HAS_TIME_PASSED(&Global_2710342[iParam0 /*2*/], Global_2710342.f_17[iParam0], false))
	{
		_STOPWATCH_DESTROY(&Global_2710342[iParam0 /*2*/]);
		return false;
	}

	return _STOPWATCH_IS_INITIALIZED(&Global_2710342[iParam0 /*2*/]);
}

void _STOPWATCH_DESTROY(var uParam0) // Position - 0x8E5A
{
	uParam0->f_1 = 0;
	return;
}

void func_200(char* sParam0, char* sParam1, char* sParam2, char* sParam3, BOOL bParam4, BOOL bParam5, int iParam6, int iParam7, int iParam8, const char* sParam9, const char* sParam10) // Position - 0x8E67
{
	GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_1285, "SHOW_OVERLAY");
	func_202(sParam0);
...
void func_201(int iParam0) // Position - 0x8F17
{
	if (iLocal_569 != iParam0)
		iLocal_569 = iParam0;

	return;
}

void func_202(const char* sParam0) // Position - 0x8F2C
{
...
BOOL func_203(Player plParam0) // Position - 0x8F3E
{
	return 0 == func_107(plParam0);
}

BOOL _STAT_GET_PACKED_BOOL(int iParam0, int iParam1) // Position - 0x8F4E
{
	if (iParam1 == -1)
		iParam1 = func_153();
...
void func_205(int iParam0, BOOL bParam1) // Position - 0x8F6A
{
	int num;
	var unk;
	var unk5;
	...
	num = func_222(PLAYER::PLAYER_ID());

	if (iParam0 != 8)
		num = uLocal_746[func_221(iParam0)];
...
void _STAT_SET_PACKED_BOOL(int iParam0, BOOL bParam1, int iParam2) // Position - 0x9191
{
	if (iParam2 == -1)
		iParam2 = func_153();
...
void _DISPLAY_HELP_TEXT(char* text, int iParam1) // Position - 0x91AF
{
...
BOOL func_208(char* sParam0, int iParam1, const char* sParam2) // Position - 0x91C6
{
...
int func_209(int iParam0, int iParam1) // Position - 0x91E4
{
	float num;
	float value;
...
float func_210(int iParam0, int iParam1) // Position - 0x920D
{
	float num;
	float num2;
	int value;
...
int func_211(int iParam0, int iParam1) // Position - 0x9325
{
	return func_212(iParam0) * iParam1;
}

int func_212(int iParam0) // Position - 0x9336
{
	int value;
	...
	{
		case 8:
			value = Global_262145.f_22496;
			break;
	
		case 0:
			value = Global_262145.f_22497;
			break;
	
		case 1:
			value = Global_262145.f_22498;
			break;
	
		case 2:
			value = Global_262145.f_22499;
			break;
	
		case 3:
			value = Global_262145.f_22500;
			break;
	
		case 4:
			value = Global_262145.f_22501;
			break;
	
		case 5:
			value = Global_262145.f_22502;
			break;
	
		case 6:
			value = Global_262145.f_22503;
			break;
	
		case 7:
			value = Global_262145.f_22504;
			break;
	}

	if (func_213(PLAYER::PLAYER_ID()))
		value = SYSTEM::ROUND(SYSTEM::TO_FLOAT(value) * *Global_262145.f_37330);

	return value;
}

BOOL func_213(Player plParam0) // Position - 0x940E
{
	return func_214(plParam0, 2);
}

BOOL func_214(Player plParam0, int iParam1) // Position - 0x941D
{
	if (iParam1 != 0)
		if (plParam0 != _INVALID_PLAYER_INDEX())
...
int func_215() // Position - 0x9447
{
	int i;

	for (i = 0; i < 9; i = i + 1)
	{
		if (uLocal_746[i] > 0 && i != 0)
			return func_216(i);
	}
...
int func_216(int iParam0) // Position - 0x9481
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_217() // Position - 0x94EC
{
	return IS_BIT_SET(iLocal_538, 10);
}

BOOL func_218() // Position - 0x94FA
{
	if (_STOPWATCH_IS_INITIALIZED(&(Global_2710342.f_26)) && _STOPWATCH_HAS_TIME_PASSED(&(Global_2710342.f_26), Global_2710342.f_28, false))
	{
		_STOPWATCH_DESTROY(&(Global_2710342.f_26));
		return false;
	}

	return _STOPWATCH_IS_INITIALIZED(&(Global_2710342.f_26));
}

BOOL func_219(int iParam0) // Position - 0x953D
{
	switch (iParam0)
	{
		case 8:
	...
	return uLocal_746[func_221(iParam0)] > 0;
}

BOOL func_220(Player plParam0) // Position - 0x956F
{
	return func_222(plParam0) == 0;
}

int func_221(int iParam0) // Position - 0x957F
{
	switch (iParam0)
	{
		case 8:
...
int func_222(Player plParam0) // Position - 0x95EA
{
	if (plParam0 != _INVALID_PLAYER_INDEX() && func_223(plParam0))
		return Global_1845274[plParam0 /*877*/].f_260.f_298.f_3;

	return 0;
}

BOOL func_223(Player plParam0) // Position - 0x961C
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
...
int func_224(int iParam0) // Position - 0x9642
{
	switch (iParam0)
	{
		case 2:
...
void func_226() // Position - 0x97C5
{
	func_227(6117, -1);
	return;
}

void func_227(int iParam0, int iParam1) // Position - 0x97D5
{
	BOOL flag;

	flag = func_150(iParam0, func_152(iParam1));
	flag = flag + 1;
	func_228(iParam0, flag, iParam1, true);
	return;
}

void func_228(int iParam0, BOOL bParam1, int iParam2, BOOL bParam3) // Position - 0x97FC
{
	Hash statName;
...
void func_229(int iParam0, BOOL bParam1) // Position - 0x982A
{
	int randomIntInRange;

	randomIntInRange = func_255();

	if (randomIntInRange == 8 && func_254(iParam0))
	{
	...
	if (func_250(iParam0) && func_217() && randomIntInRange == 8)
		randomIntInRange = func_215();

	Global_1944173.f_53 = 0;

	if (func_249(PLAYER::PLAYER_ID()))
		MISC::SET_BIT(&Global_1985073, 16);
	else
		MISC::SET_BIT(&Global_1985073, 18);

	if (func_248(iParam0))
	{
		func_247(iParam0, 0, randomIntInRange);
	}
	else
	{
		func_246(0, randomIntInRange);
	...
	if (!func_230(PLAYER::PLAYER_ID(), false))
		func_1(1);
	else
		func_527(0, true);
...
BOOL func_230(Player plParam0, BOOL bParam1) // Position - 0x9905
{
	...
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2658019[plParam0 /*467*/].f_324.f_8 != -1 && Global_2658019[plParam0 /*467*/].f_324.f_11 != _INVALID_PLAYER_INDEX())
				return func_51(Global_2658019[plParam0 /*467*/].f_324.f_8) == 12;

	return false;
}

void func_231(int iParam0, int iParam1, int iParam2) // Position - 0x9993
{
	if (iParam1 != -1)
		func_251(iParam1);
...
void func_232(int iParam0, int iParam1) // Position - 0x99BA
{
	if (func_244() || !func_243(true) || func_44(iParam0) == 3)
	{
		if (!func_241(PLAYER::PLAYER_ID(), 0) && !func_241(PLAYER::PLAYER_ID(), 3))
		{
			func_240(iParam0);
			func_233(iParam0, _GET_LOBBY_SCRIPT_EVENT_BITS(true, true), func_236(), func_235(), func_234(), iParam1);
		}
	}
...
void func_233(int iParam0, int iParam1, int iParam2, var uParam3, var uParam4, int iParam5) // Position - 0x9A22
{
	Hash eventData;
...
var func_234() // Position - 0x9A6F
{
	return Global_2740191.f_5272.f_350;
}

int func_235() // Position - 0x9A81
{
	return Global_2740191.f_5272.f_349;
}

int func_236() // Position - 0x9A93
{
	return Global_2740191.f_5272.f_348;
}

int _GET_LOBBY_SCRIPT_EVENT_BITS(BOOL includeLocalPlayer, BOOL includeSpectators) // Position - 0x9AA5
{
	int address;
	int i;
	Player player;
...
BOOL func_238(Player plParam0, int iParam1) // Position - 0x9B0A
{
	BOOL flag;
...
int func_239(int iParam0, BOOL bParam1) // Position - 0x9B63
{
	int num;
	int num2;
...
void func_240(int iParam0) // Position - 0x9BA4
{
	Global_1888882[PLAYER::PLAYER_ID() /*611*/].f_10.f_32 = iParam0;
	return;
}

BOOL func_241(Player plParam0, int iParam1) // Position - 0x9BBD
{
	if (func_242(plParam0, false))
		return func_44(Global_1888882[plParam0 /*611*/].f_10.f_33) == iParam1;

	return false;
}

BOOL func_242(Player plParam0, BOOL bParam1) // Position - 0x9BE7
{
	if (func_16(plParam0))
...
BOOL func_243(BOOL bParam0) // Position - 0x9C2B
{
	return func_75(PLAYER::PLAYER_ID(), bParam0);
}

BOOL func_244() // Position - 0x9C3D
{
	return func_15(PLAYER::PLAYER_ID());
}

void func_245(int iParam0) // Position - 0x9C4D
{
...
void func_246(int iParam0, int iParam1) // Position - 0x9C70
{
	Global_1888882[PLAYER::PLAYER_ID() /*611*/].f_10.f_237 = iParam0;
	Global_1888882[PLAYER::PLAYER_ID() /*611*/].f_10.f_237.f_22 = iParam1;
	return;
}

void func_247(int iParam0, int iParam1, int iParam2) // Position - 0x9C9C
{
	int num;

	num = iParam2;
	iParam0 != 229 && iParam0 != 230;
	func_246(iParam1, num);
	func_232(iParam0, -1);
	return;
}

BOOL func_248(int iParam0) // Position - 0x9CC9
{
...
BOOL func_249(Player plParam0) // Position - 0x9CE9
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2658019[plParam0 /*467*/].f_324.f_8 != -1)
				return func_51(Global_2658019[plParam0 /*467*/].f_324.f_8) == 7;

	return false;
}

BOOL func_250(int iParam0) // Position - 0x9D2F
{
...
void func_251(int iParam0) // Position - 0x9D50
{
...
void func_252(int iParam0) // Position - 0x9D73
{
	MISC::CLEAR_BIT(&(Global_2740191.f_5272.f_51), iParam0);
	return;
}

void func_253(int iParam0) // Position - 0x9D8A
{
	MISC::SET_BIT(&(Global_2740191.f_5272.f_51), iParam0);
	return;
}

BOOL func_254(int iParam0) // Position - 0x9DA1
{
...
int func_255() // Position - 0x9DC2
{
	return iLocal_570;
}

void func_256() // Position - 0x9DCD
{
	func_227(6115, -1);
	return;
}

BOOL func_257(BOOL bParam0) // Position - 0x9DDD
{
	int num;
	...
	while (!func_258(&num, bParam0, false, 0))
	{
		func_445();
		SYSTEM::WAIT(0);
	}
...
BOOL func_258(var uParam0, BOOL bParam1, BOOL bParam2, int iParam3) // Position - 0x9E13
{
	int num;
	int num2;
	Hash hashKey;
	...
	switch (*uParam0)
	{
		case 0:
			...
			if (func_271(78225582, joaat("CATEGORY_INVENTORY_CONTRABAND_MISSION"), num, -1018905335, 1, num2, 1, 4, hashKey, 3))
				*uParam0 = 1;
			else
				*uParam0 = 3;
...
void func_259(int iParam0) // Position - 0x9F38
{
	Global_4538658 = iParam0;
	return;
}

int func_260(int iParam0) // Position - 0x9F46
{
...
int func_261(int iParam0) // Position - 0x9F6D
{
	if (iParam0 >= 0 && iParam0 < 15)
...
BOOL func_262(int iParam0) // Position - 0x9F96
{
	if (iParam0 >= 0 && iParam0 < 15)
...
void func_263(int iParam0) // Position - 0x9FC1
{
	BOOL flag;
...
void func_264(var uParam0) // Position - 0xA015
{
	uParam0->f_65 = 0;
...
BOOL func_266(int iParam0) // Position - 0xA160
{
	if (iParam0 >= 0 && iParam0 < 15)
...
BOOL func_267() // Position - 0xA18B
{
	...
	if (!flag)
	{
		...
		{
			if (func_270(Global_4537182[num /*84*/].f_65.f_6, Global_4537182[num /*84*/].f_65.f_4, Global_4537182[num /*84*/].f_65.f_1) == 1)
				Global_4538672 = 1;
	...
	if (transactionId != 2147483647)
	{
		if (flag || flag2 || NETSHOPPING::NET_GAMESERVER_CHECKOUT_START(transactionId))
		{
			...
			if (flag || flag2)
				func_268(Global_4537182[num /*84*/], num);
...
void func_268(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17, var uParam18, var uParam19, var uParam20, var uParam21, var uParam22, var uParam23, var uParam24, var uParam25, var uParam26, var uParam27, var uParam28, var uParam29, var uParam30, var uParam31, var uParam32, var uParam33, var uParam34, var uParam35, var uParam36, var uParam37, var uParam38, var uParam39, var uParam40, var uParam41, var uParam42, var uParam43, var uParam44, var uParam45, var uParam46, var uParam47, var uParam48, var uParam49, var uParam50, var uParam51, var uParam52, var uParam53, var uParam54, var uParam55, var uParam56, var uParam57, var uParam58, var uParam59, var uParam60, var uParam61, var uParam62, var uParam63, var uParam64, var uParam65, var uParam66, var uParam67, var uParam68, var uParam69, var uParam70, var uParam71, var uParam72, var uParam73, var uParam74, var uParam75, var uParam76, var uParam77, var uParam78, var uParam79, var uParam80, var uParam81, var uParam82, var uParam83, int iParam84) // Position - 0xA2EB
{
	...
	playerBits = func_269(eventData.f_1);
...
int func_269(Player plParam0) // Position - 0xA36E
{
	var address;
...
int func_270(int iParam0, int iParam1, int iParam2) // Position - 0xA389
{
...
BOOL func_271(int iParam0, Hash hParam1, Hash hParam2, Hash hParam3, int iParam4, int iParam5, int iParam6, int iParam7, Hash hParam8, int iParam9) // Position - 0xAA98
{
	BOOL flag;
	int num;
	Hash itemData;
	...
	if (num == -1)
		if (!func_273(&num, iParam0, hParam1, hParam3, iParam7, iParam9))
			return false;

	if (num != -1)
	{
		if (hParam8 != 0 && func_272(hParam1))
		{
			itemData = hParam8;
...
BOOL func_272(Hash hParam0) // Position - 0xABBA
{
	switch (hParam0)
	{
		case -221807075:
...
BOOL func_273(var uParam0, int iParam1, Hash hParam2, Hash hParam3, int iParam4, int iParam5) // Position - 0xAC49
{
	BOOL flag;
	int i;
	BOOL flag2;
	...
	*uParam0 = 0;
	...
	{
		*uParam0 = func_274(transactionId, iParam1, joaat("SERVICE_INVALID"), hParam3, hParam2, 0, true, iParam4, iParam5, 0, flag);
		return true;
	}
...
int func_274(int iParam0, int iParam1, int iParam2, Hash hParam3, Hash hParam4, int iParam5, BOOL bParam6, int iParam7, int iParam8, int iParam9, BOOL bParam10) // Position - 0xAD46
{
	int i;
	...
	for (i = 0; i < 15; i = i + 1)
	{
		if (Global_4537182[i /*84*/].f_65.f_2 == 0)
		{
			...
			if (iParam1 == joaat("NET_SHOP_TTYPE_SERVICE") && bParam10)
				func_268(Global_4537182[i /*84*/], i);
...
BOOL _NETSHOPPING_SHOULD_USE_TRANSACTION_SYSTEM() // Position - 0xAEBE
{
...
int func_277() // Position - 0xAED5
{
	return iLocal_569;
}

void func_278() // Position - 0xAEE0
{
	switch (func_277())
	{
		case 2:
...
void func_279() // Position - 0xB014
{
	GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_1285, "HIDE_OVERLAY");
	GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
	func_201(0);
	MISC::CLEAR_BIT(&iLocal_538, 1);
	return;
}

void func_280() // Position - 0xB039
{
	AUDIO::PLAY_SOUND_FRONTEND(-1, "Click_Link", "GTAO_SMG_Hangar_Computer_Sounds", true);
	return;
}

void func_281() // Position - 0xB04E
{
	if (func_282())
	{
		if (!IS_BIT_SET(iLocal_538, 0))
		{
			GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_1285, "GET_CURRENT_SELECTION");
			iLocal_1286 = GRAPHICS::END_SCALEFORM_MOVIE_METHOD_RETURN_VALUE();
...
void func_283() // Position - 0xB0A5
{
	if (iLocal_542 != func_322())
	{
		if (!_STOPWATCH_IS_INITIALIZED(&uLocal_579))
		{
			_STOPWATCH_INITIALIZE(&uLocal_579, false, false);
		}
		else if (_STOPWATCH_HAS_TIME_PASSED(&uLocal_579, 750, false))
		{
...
void func_285() // Position - 0xB13D
{
	if (func_218())
	{
		GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_1285, "UPDATE_SELL_COOLDOWN");
		GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(func_287(Global_2710342.f_26, Global_2710342.f_28));
		GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(func_286(Global_2710342.f_28));
		GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
	}
	else
	{
...
int func_286(int iParam0) // Position - 0xB19D
{
	return iParam0 / 1000;
}

int func_287(int iParam0, var uParam1, int iParam2) // Position - 0xB1AB
{
	int num;
...
void func_288() // Position - 0xB1D0
{
	int i;
	int num;
	int num2;

	GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_1285, "UPDATE_STEAL_COOLDOWN");
	...
	for (i = 1; i <= 8; i = i + 1)
	{
		...
		if (func_198(num))
			GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(func_287(Global_2710342[num2 /*2*/], Global_2710342.f_17[num2]));
		else
			GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(0);
	}
...
void func_289(int iParam0) // Position - 0xB234
{
	int value;
	int value2;
	int value3;
	...
	value = uLocal_746[iParam0];
	value2 = 50;
	value3 = func_211(func_216(iParam0), value);
	value4 = SYSTEM::ROUND(func_210(func_216(iParam0), value) * 100f);

	if ((float)value4 > 0f)
	{
		num = func_209(func_216(iParam0), value);
		value3 = value3 + num;
		MISC::SET_BIT(&iLocal_538, 14);
	}

	GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_1285, "ADD_CARGO");
...
void func_290() // Position - 0xB2C7
{
	...
	iLocal_542 = func_322();
	value7 = 50;
	value8 = iLocal_542 * func_212(8);
	value9 = func_294(value2, func_295());
	value10 = func_294(value3, func_293());
	value9 = func_292(value9, 0f, 100f);
	value10 = func_292(value10, 0f, 100f);

	if (func_291(iLocal_567))
		value = 1;

	if (func_217())
	{
		num = func_215();
		value8 = iLocal_542 * func_212(num);
		num2 = func_210(num, iLocal_542) * 100f;
	
		if (num2 > 0f)
		{
			num3 = func_209(num, iLocal_542);
			value8 = value8 + num3;
		}
	}

	GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_1285, "SET_STATS");
	...
	GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(iLocal_542);
...
BOOL func_291(int iParam0) // Position - 0xB3EE
{
	switch (iParam0)
	{
		case 4:
...
float func_292(float fParam0, float fParam1, float fParam2) // Position - 0xB414
{
	if (fParam0 > fParam2)
		return fParam2;
...
int func_293() // Position - 0xB43B
{
	return func_150(6117, -1);
}

float func_294(int iParam0, int iParam1) // Position - 0xB44B
{
	return (SYSTEM::TO_FLOAT(iParam0) / SYSTEM::TO_FLOAT(iParam1)) * 100f;
}

int func_295() // Position - 0xB466
{
	return func_150(6115, -1);
}

int func_296() // Position - 0xB476
{
	return func_150(6120, -1);
}

int func_297() // Position - 0xB486
{
	return func_150(6119, -1);
}

int func_298() // Position - 0xB496
{
	return func_150(6121, -1);
}

int func_299() // Position - 0xB4A6
{
	return func_150(6118, -1);
}

int func_300() // Position - 0xB4B6
{
	return func_150(6116, -1);
}

const char* func_301(Player plParam0) // Position - 0xB4C6
{
	const char* str;
	Player player;
	...
	if (!func_16(plParam0))
	{
		str = func_309(plParam0, false);
		return str;
	}

	if (plParam0 == PLAYER::PLAYER_ID())
	{
		str = func_308(&(Global_1888882[plParam0 /*611*/].f_10.f_105));
		return str;
	}
	...
	if (func_14(plParam0, 28) || func_14(PLAYER::PLAYER_ID(), 28) || func_305(plParam0) && !func_303(plParam0))
		return func_309(plParam0, false);
	...
	if (player != _INVALID_PLAYER_INDEX())
	{
		str = func_308(&(Global_1888882[player /*611*/].f_10.f_105));
...
BOOL IS_XBOX_PLATFORM() // Position - 0xB5FA
{
	return MISC::IS_DURANGO_VERSION() || MISC::IS_SCARLETT_VERSION();
}

BOOL func_303(Player plParam0) // Position - 0xB610
{
	var gamerHandle;
...
struct<13> GET_GAMER_HANDLE_PLAYER(Player plParam0) // Position - 0xB665
{
	var gamerHandle;
...
BOOL func_305(Player plParam0) // Position - 0xB67C
{
	var gamerHandle;
...
BOOL IS_GAMER_HANDLE_VALID(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12) // Position - 0xB736
{
	return NETWORK::NETWORK_IS_HANDLE_VALID(&uParam0, 13);
}

BOOL func_307(Any* panParam0) // Position - 0xB746
{
	int i;
...
const char* func_308(var uParam0) // Position - 0xB79A
{
	return uParam0;
}

const char* func_309(Player plParam0, BOOL bParam1) // Position - 0xB7A4
{
	if (!bParam1)
		if (func_311(plParam0, true))
			return func_310();

	return HUD::GET_FILENAME_FOR_AUDIO_CONVERSATION("GB_REST_ACC" /*An Organization*/);
}

const char* func_310() // Position - 0xB7CB
{
	return HUD::GET_FILENAME_FOR_AUDIO_CONVERSATION("GB_REST_ACCM" /*Motorcycle Club*/);
}

BOOL func_311(Player plParam0, BOOL bParam1) // Position - 0xB7DB
{
	return func_312(plParam0, bParam1, 1);
}

BOOL func_312(Player plParam0, BOOL bParam1, int iParam2) // Position - 0xB7EC
{
	Player player;
	...
	if (func_16(player) && Global_1888882[player /*611*/].f_10.f_431 == iParam2)
		return 1;

	return 0;
}

BOOL func_313() // Position - 0xB848
{
	int i;
	int num;
...
void func_314() // Position - 0xB885
{
	...
	{
		num = func_216(i);
		uLocal_746[i] = func_315(num);
	}

	return;
}

int func_315(int iParam0) // Position - 0xB8B5
{
	int i;
	int num;
	int num2;
	...
	for (i = 0; i < 50; i = i + 1)
	{
		num2 = func_317(_STAT_GET_PACKED_INT(func_319(i), -1));
	
		if (func_316(num2) == iParam0)
			num = num + 1;
	}
...
int func_316(int iParam0) // Position - 0xB912
{
	switch (iParam0)
	{
...
int func_317(BOOL bParam0) // Position - 0xB9C2
{
	switch (bParam0)
	{
		case 1:
...
int _STAT_GET_PACKED_INT(int iParam0, int iParam1) // Position - 0xBAB2
{
	if (iParam1 == -1)
		iParam1 = func_153();
...
int func_319(int iParam0) // Position - 0xBACE
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_320() // Position - 0xBD38
{
	return func_321() != 0;
}

int func_321() // Position - 0xBD46
{
	return Global_1845274[PLAYER::PLAYER_ID() /*877*/].f_260.f_298;
}

int func_322() // Position - 0xBD5F
{
	return func_222(PLAYER::PLAYER_ID());
}

void func_323() // Position - 0xBD6F
{
	if (_STOPWATCH_IS_INITIALIZED(&uLocal_575))
	{
		if (_STOPWATCH_HAS_TIME_PASSED(&uLocal_575, 1000, false))
		{
			func_288();
			func_285();
			_STOPWATCH_RESET(&uLocal_575, false, false);
		}
	}
	else
	{
...
void _STOPWATCH_RESET(var pStopwatch, BOOL useLocalTimer, BOOL useAccurateTime) // Position - 0xBDAC
{
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS() && !useLocalTimer)
		if (!useAccurateTime)
			*pStopwatch = NETWORK::GET_NETWORK_TIME();
...
void func_325() // Position - 0xBDE9
{
	Player player;

	plLocal_539 = plLocal_539 + 1;
	...
	if (NETWORK::NETWORK_IS_PLAYER_ACTIVE(player) && func_223(player) && !func_75(player, false) && !func_332())
		if (!func_331())
			func_328(player, plLocal_539);
	else if (func_331())
		func_326();

	if (IS_BIT_SET(iLocal_543, plLocal_539))
		if (!func_15(player) && func_331())
			func_326();
	else if (func_15(player) && func_331())
		func_326();

	return;
}

void func_326() // Position - 0xBE9A
{
	int i;
	int num;
	...
	if (num != -1 && num < 31)
	{
		GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_1285, "REMOVE_ACTIVE_ORGANISATION");
		GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_LITERAL_STRING(&uLocal_788[num /*16*/]);
		GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
		TEXT_LABEL_ASSIGN_STRING(&uLocal_788[num /*16*/], "", 64);
		MISC::CLEAR_BIT(&iLocal_543, plLocal_539);
		func_327(PLAYER::INT_TO_PLAYERINDEX(plLocal_539));
	}

	return;
}

void func_327(Player plParam0) // Position - 0xBF23
{
	int i;

	for (i = 0; i < 10; i = i + 1)
	{
		if (uLocal_555[i] == plParam0)
		{
			uLocal_544[i] = 0;
			uLocal_555[i] = -1;
			return;
...
void func_328(Player plParam0, Player plParam1) // Position - 0xBF5D
{
	int i;
	...
	if (func_15(plParam0))
	{
		...
		GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_1285, "ADD_ACTIVE_ORGANISATION");
		GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_LITERAL_STRING(func_330(plParam0));
		...
		GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
		playerName = func_330(plParam0);
		func_329(plParam0, func_32(plParam0));
		MISC::SET_BIT(&iLocal_543, plParam1);
	}
	else
	{
		GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_1285, "ADD_ACTIVE_ORGANISATION");
	...
	for (i = 0; i < 31; i = i + 1)
	{
		if (uLocal_756[i] == -1)
		{
			...
			TEXT_LABEL_ASSIGN_STRING(&uLocal_788[i /*16*/], playerName, 64);
			return;
		}
	}
...
void func_329(Player plParam0, int iParam1) // Position - 0xC0F1
{
	int i;
	...
	for (i = 0; i < 10; i = i + 1)
	{
		if (uLocal_555[i] == -1)
		{
			uLocal_544[i] = iParam1;
			uLocal_555[i] = plParam0;
			return;
		}
	}
...
const char* func_330(Player plParam0) // Position - 0xC12C
{
	Player player;
	const char* str;
...
BOOL func_332() // Position - 0xC1B2
{
	int i;

	for (i = 0; i < 10; i = i + 1)
	{
		if (uLocal_555[i] == plLocal_539)
			if (!func_15(PLAYER::INT_TO_PLAYERINDEX(plLocal_539)))
				return true;
			else
				return uLocal_544[i] != func_32(PLAYER::INT_TO_PLAYERINDEX(plLocal_539));
	}

	return false;
}

void func_333() // Position - 0xC207
{
	int controlValue;
	int controlValue2;
	int controlValue3;
	...
	else if (IS_BIT_SET(iLocal_538, 15))
	{
		func_339();
		return;
	}

	func_337(FRONTEND_CONTROL, INPUT_FRONTEND_LB, true);

	if (PAD::IS_CONTROL_JUST_PRESSED(FRONTEND_CONTROL, INPUT_FRONTEND_LB))
	{
		GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(iLocal_1285, "SET_INPUT_EVENT", SYSTEM::TO_FLOAT(205), -1082130432, -1082130432, -1082130432, -1082130432);
	...
	func_337(FRONTEND_CONTROL, INPUT_FRONTEND_RB, true);

	if (PAD::IS_CONTROL_JUST_PRESSED(FRONTEND_CONTROL, INPUT_FRONTEND_RB))
	{
		GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(iLocal_1285, "SET_INPUT_EVENT", SYSTEM::TO_FLOAT(206), -1082130432, -1082130432, -1082130432, -1082130432);
	...
	{
		func_337(FRONTEND_CONTROL, INPUT_FRONTEND_UP, true);
	
		if (PAD::IS_CONTROL_JUST_PRESSED(FRONTEND_CONTROL, INPUT_FRONTEND_UP))
			GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(iLocal_1285, "SET_INPUT_EVENT", SYSTEM::TO_FLOAT(301), -1082130432, -1082130432, -1082130432, -1082130432);
	
		func_337(FRONTEND_CONTROL, INPUT_FRONTEND_DOWN, true);
	
		if (PAD::IS_CONTROL_JUST_PRESSED(FRONTEND_CONTROL, INPUT_FRONTEND_DOWN))
			GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(iLocal_1285, "SET_INPUT_EVENT", SYSTEM::TO_FLOAT(300), -1082130432, -1082130432, -1082130432, -1082130432);
	
		if (PAD::IS_CONTROL_JUST_RELEASED(FRONTEND_CONTROL, INPUT_FRONTEND_DOWN))
			GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(iLocal_1285, "SET_INPUT_RELEASE_EVENT", SYSTEM::TO_FLOAT(300), -1082130432, -1082130432, -1082130432, -1082130432);
	
		if (PAD::IS_CONTROL_JUST_RELEASED(FRONTEND_CONTROL, INPUT_FRONTEND_UP))
			GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(iLocal_1285, "SET_INPUT_RELEASE_EVENT", SYSTEM::TO_FLOAT(301), -1082130432, -1082130432, -1082130432, -1082130432);
	}
	else
	{
		func_337(FRONTEND_CONTROL, INPUT_FRONTEND_UP, true);
		...
		if (PAD::IS_CONTROL_JUST_PRESSED(FRONTEND_CONTROL, INPUT_FRONTEND_UP))
			GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(iLocal_1285, "SET_INPUT_EVENT", SYSTEM::TO_FLOAT(188), -1082130432, -1082130432, -1082130432, -1082130432);
	
		func_337(FRONTEND_CONTROL, INPUT_FRONTEND_DOWN, true);
	
		if (PAD::IS_CONTROL_JUST_PRESSED(FRONTEND_CONTROL, INPUT_FRONTEND_DOWN))
			GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(iLocal_1285, "SET_INPUT_EVENT", SYSTEM::TO_FLOAT(187), -1082130432, -1082130432, -1082130432, -1082130432);
	}

	func_337(FRONTEND_CONTROL, INPUT_FRONTEND_LEFT, true);

	if (PAD::IS_CONTROL_JUST_PRESSED(FRONTEND_CONTROL, INPUT_FRONTEND_LEFT))
		GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(iLocal_1285, "SET_INPUT_EVENT", SYSTEM::TO_FLOAT(189), -1082130432, -1082130432, -1082130432, -1082130432);

	func_337(FRONTEND_CONTROL, INPUT_FRONTEND_RIGHT, true);

	if (PAD::IS_CONTROL_JUST_PRESSED(FRONTEND_CONTROL, INPUT_FRONTEND_RIGHT))
		GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(iLocal_1285, "SET_INPUT_EVENT", SYSTEM::TO_FLOAT(190), -1082130432, -1082130432, -1082130432, -1082130432);

	func_337(FRONTEND_CONTROL, INPUT_FRONTEND_ACCEPT, true);

	if (PAD::IS_CONTROL_JUST_PRESSED(FRONTEND_CONTROL, INPUT_FRONTEND_ACCEPT))
		GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(iLocal_1285, "SET_INPUT_EVENT", SYSTEM::TO_FLOAT(201), -1082130432, -1082130432, -1082130432, -1082130432);

	func_337(FRONTEND_CONTROL, INPUT_FRONTEND_CANCEL, true);

	if (PAD::IS_CONTROL_JUST_RELEASED(FRONTEND_CONTROL, INPUT_FRONTEND_CANCEL))
		func_335();

	func_337(FRONTEND_CONTROL, INPUT_FRONTEND_X, true);
	...
	if (PAD::IS_CONTROL_JUST_PRESSED(FRONTEND_CONTROL, INPUT_FRONTEND_X))
	{
		...
		{
			GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(iLocal_1285, "SET_INPUT_EVENT", SYSTEM::TO_FLOAT(203), -1082130432, -1082130432, -1082130432, -1082130432);
		}
	}

	func_337(FRONTEND_CONTROL, INPUT_FRONTEND_Y, true);

	if (PAD::IS_CONTROL_JUST_PRESSED(FRONTEND_CONTROL, INPUT_FRONTEND_Y))
		GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(iLocal_1285, "SET_INPUT_EVENT", SYSTEM::TO_FLOAT(204), -1082130432, -1082130432, -1082130432, -1082130432);

	if (PAD::IS_USING_CURSOR(FRONTEND_CONTROL))
	{
		GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_1285, "SET_MOUSE_INPUT");
		...
		GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
		func_337(FRONTEND_CONTROL, INPUT_CURSOR_ACCEPT, true);
	
		if (PAD::IS_CONTROL_JUST_PRESSED(FRONTEND_CONTROL, INPUT_CURSOR_ACCEPT))
			GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(iLocal_1285, "SET_INPUT_EVENT", SYSTEM::TO_FLOAT(201), -1082130432, -1082130432, -1082130432, -1082130432);
	
		func_337(FRONTEND_CONTROL, INPUT_CURSOR_CANCEL, true);
	...
	{
		func_337(FRONTEND_CONTROL, INPUT_FRONTEND_AXIS_X, true);
		func_337(FRONTEND_CONTROL, INPUT_FRONTEND_AXIS_Y, true);
		...
		if (controlValue != 127 || iLocal_1997 != 127 || controlValue2 != 127 || iLocal_1998 != 127)
		{
			GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_1285, "SET_ANALOG_STICK_INPUT");
			iLocal_1997 = controlValue;
			iLocal_1998 = controlValue2;
	...
	func_337(FRONTEND_CONTROL, INPUT_FRONTEND_RIGHT_AXIS_X, true);
	func_337(FRONTEND_CONTROL, INPUT_FRONTEND_RIGHT_AXIS_Y, true);
	...
	if (controlValue3 != 127 || iLocal_1999 != 127 || controlValue4 != 127 || iLocal_2000 != 127)
	{
		...
		GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_1285, "SET_ANALOG_STICK_INPUT");
		iLocal_1999 = controlValue3;
		iLocal_2000 = controlValue4;
...
BOOL func_334() // Position - 0xC76D
{
	if (func_277() == 6)
		return false;

	return iLocal_1287 != 0;
}

void func_335() // Position - 0xC786
{
	if (!func_511())
		func_527(0, true);
	...
	{
		iLocal_568 = 0;
		GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(iLocal_1285, "SHOW_SCREEN", 0f, -1082130432, -1082130432, -1082130432, -1082130432);
		AUDIO::PLAY_SOUND_FRONTEND(-1, "Show_Overview_Menu", "GTAO_SMG_Hangar_Computer_Sounds", true);
		return;
	}
	...
	if (func_336())
		...
		GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(iLocal_1285, "SET_INPUT_EVENT", SYSTEM::TO_FLOAT(202), -1082130432, -1082130432, -1082130432, -1082130432);

	AUDIO::PLAY_SOUND_FRONTEND(-1, "Click_Back", "GTAO_SMG_Hangar_Computer_Sounds", true);
	return;
}

BOOL func_336() // Position - 0xC831
{
	return IS_BIT_SET(iLocal_538, 1);
}

void func_337(eControlType ectParam0, eControlAction ecaParam1, BOOL bParam2) // Position - 0xC83E
{
	if (!func_338())
	{
...
BOOL func_338() // Position - 0xC860
{
	return HUD::GET_PAUSE_MENU_STATE() != 0;
}

void func_339() // Position - 0xC86E
{
	BOOL flag;
	int num;
	int num2;
	...
	if (PAD::IS_CONTROL_JUST_PRESSED(FRONTEND_CONTROL, INPUT_FRONTEND_ACCEPT))
	{
		...
		else
		{
			...
			func_441(571220422, Global_262145.f_15836, 0);
			MISC::CLEAR_BIT(&iLocal_538, 15);
		}
	}
	...
	if (flag)
	{
		...
		if (num == 2)
		{
			...
			func_344(15966, true);
			Global_1845274[PLAYER::PLAYER_ID() /*877*/].f_260.f_298.f_5 = 1;
			func_284();
			func_341(-457999121, 10, false);
			func_340();
		}
		else if (num == 3)
		{
...
void func_341(int iParam0, int iParam1, BOOL bParam2) // Position - 0xCA0C
{
	int num;

	if (func_343(iParam1, bParam2))
	{
		num = func_342();
...
BOOL func_343(int iParam0, BOOL bParam1) // Position - 0xCA6E
{
	if (Global_1575076)
		return false;
...
void func_344(int iParam0, BOOL bParam1) // Position - 0xCAF4
{
	BOOL flag;
	int num;
	...
	if (!func_408(num, bParam1 == _STAT_GET_PACKED_BOOL(iParam0, -1)))
	{
		flag = false;
	}
	else
	{
		num.f_1 = func_407(num);
	
		if (num.f_1 == 4)
			flag = false;
	
		if (flag && !func_405(iParam0, &num))
			flag = false;
	}
...
void func_345(var uParam0) // Position - 0xCB84
{
	uParam0->f_6 = func_389(*uParam0, uParam0->f_2);
	...
	if (uParam0->f_6 > uParam0->f_2.f_1)
	{
		...
		if (uParam0->f_2.f_1 == 0 && uParam0->f_6 > 0 && uParam0->f_2.f_2 > 1)
			func_381(uParam0->f_2);
	}

	if (uParam0->f_6 >= uParam0->f_2.f_2)
	{
		func_377(uParam0->f_2);
	
		if (func_369(*uParam0, uParam0->f_1, false, false))
		{
			func_355(*uParam0, uParam0->f_1);
			uParam0->f_7 = 1;
		
			if (!Global_2740191.f_7134.f_1 && func_407(*uParam0) >= uParam0->f_1)
			{
...
BOOL func_346(var uParam0) // Position - 0xCC68
{
	var unk;
	BOOL flag;
	...
	unk = 10;
	flag = false;
	func_350(*uParam0, uParam0->f_2, &unk, &flag);

	if (uParam0->f_6 <= uParam0->f_2.f_1)
		return false;

	if (!flag)
		if (func_349(&unk, uParam0->f_2.f_1, uParam0->f_6, &(uParam0->f_2.f_3)))
			if (func_347(*uParam0, uParam0->f_2, uParam0->f_2.f_3))
				return false;
		else
			return false;
...
BOOL func_347(var uParam0, var uParam1, var uParam2) // Position - 0xCCD8
{
	int num;

	num = func_348(uParam0, uParam1, uParam2);
...
int func_348(int iParam0, int iParam1, int iParam2) // Position - 0xCD00
{
	switch (iParam0)
	{
		case 18:
...
BOOL func_349(var uParam0, int iParam1, int iParam2, var uParam3) // Position - 0xCE19
{
	int num;
	int i;
...
void func_350(int iParam0, int iParam1, var uParam2, var uParam3) // Position - 0xCE6B
{
	int i;
	int j;
...
void func_351(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7) // Position - 0xE0E5
{
	int i;
...
int func_354(int iParam0) // Position - 0xE387
{
	switch (iParam0)
	{
		case 0:
...
void func_355(int iParam0, int iParam1) // Position - 0xE3D5
{
	int num;
	BOOL address;
	int offset;
	...
	offset = func_366(iParam0, iParam1);

	if (!IS_BIT_SET(address, offset))
	{
		func_359(iParam0, iParam1);
		MISC::SET_BIT(&address, offset);
		func_228(num, address, -1, true);
	}
...
void func_356(int iParam0, int iParam1) // Position - 0xE426
{
	int num;
	int offset;
...
int func_357(int iParam0) // Position - 0xE4E1
{
	return func_358(iParam0) / 8;
}

int func_358(int iParam0) // Position - 0xE4F2
{
	switch (iParam0)
	{
		case 2:
...
void func_359(int iParam0, int iParam1) // Position - 0xE670
{
	var entityCoords;
	int num;
	Hash hash;
	...
	num = func_364();
	hash = func_363();
	hash2 = func_362(iParam1);
	hash3 = func_360(iParam0);
	num2 = -1;
	unk_0x9C4B3BAF947660BB(entityCoords, num, hash, hash2, hash3, num2);
	return;
}

Hash func_360(int iParam0) // Position - 0xE6C3
{
	var unk;
...
char* AUDIO_SPEECH_GET_PARAM_STRING_FROM_ENUM(int iParam0) // Position - 0xE6E3
{
	switch (iParam0)
	{
		case 0:
...
Hash func_362(int iParam0) // Position - 0xE8B0
{
	switch (iParam0)
	{
		case 0:
...
Hash func_363() // Position - 0xE91C
{
	return MISC::GET_HASH_KEY("PROGRESS_HUB_TIER_COMPLETED");
}

int func_364() // Position - 0xE92C
{
	if (Global_1668418 == 0)
		func_365();
...
int func_366(int iParam0, int iParam1) // Position - 0xE973
{
	if (iParam1 == 4)
		iParam1 = 3;

	return (func_367(iParam0) * 4) + iParam1;
}

int func_367(int iParam0) // Position - 0xE98F
{
	return func_358(iParam0) % 8;
}

int func_368(int iParam0) // Position - 0xE9A0
{
	int num;
...
BOOL func_369(int iParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Position - 0xE9B6
{
	BOOL flag;
	int num;
	int num2;
	...
	num2 = func_375(iParam0, iParam1, 0);
	num3 = (num2 + func_372(iParam0, iParam1)) - 1;
	i = 0;
...
BOOL func_370(int iParam0, int iParam1) // Position - 0xEA53
{
	BOOL flag;
	BOOL flag2;

	flag = func_371(iParam0, iParam1);
	flag2 = func_389(iParam0, iParam1);
	return flag2 >= flag;
}

BOOL func_371(int iParam0, int iParam1) // Position - 0xEA74
{
	int i;
...
int func_372(int iParam0, int iParam1) // Position - 0xFBC1
{
	if (func_373(iParam0))
	{
		switch (iParam1)
...
BOOL func_373(int iParam0) // Position - 0xFC34
{
	int num;
...
int func_374(int iParam0) // Position - 0xFC5C
{
	switch (iParam0)
	{
		case 26:
...
int func_375(int iParam0, int iParam1, int iParam2) // Position - 0xFD62
{
	int num;
	int i;
	int num2;
...
int func_376(int iParam0) // Position - 0xFDCE
{
	if (func_373(iParam0))
		return 13;
...
void func_377(int iParam0) // Position - 0xFDE9
{
	int num;
	int num2;
	int offset;
...
int func_378(int iParam0) // Position - 0xFE27
{
	return iParam0 % 32;
}

int func_379(int iParam0) // Position - 0xFE34
{
	return iParam0 / 32;
}

int func_380(int iParam0) // Position - 0xFE41
{
	switch (iParam0)
	{
		case 16:
...
void func_381(var uParam0) // Position - 0x11078
{
	int num;
	int num2;
	int num3;
...
int func_382(int iParam0) // Position - 0x110B4
{
	switch (iParam0)
	{
		case 2:
...
void func_383(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7) // Position - 0x11C3F
{
	var entityCoords;
	int num;
	Hash hash;
	...
	num = func_364();
	hash = func_388(uParam0.f_6 >= uParam0.f_2.f_2);
	hash2 = func_384(uParam0, uParam0.f_1, uParam0.f_2);
	unk3 = uParam0.f_6;
...
Hash func_384(int iParam0, var uParam1, int iParam2) // Position - 0x11CA8
{
	var unk;
	...
	TEXT_LABEL_APPEND_STRING(&unk, func_387(uParam1), 64);
	TEXT_LABEL_APPEND_STRING(&unk, "_OBJ_", 64);
	TEXT_LABEL_APPEND_STRING(&unk, func_385((iParam2 - func_375(iParam0, uParam1, 0)) + 1), 64);
	return MISC::GET_HASH_KEY(&unk);
}

char* func_385(int iParam0) // Position - 0x11FA8
{
	var unk;
...
char* func_386(var uParam0) // Position - 0x11FC2
{
	return uParam0;
}

char* func_387(int iParam0) // Position - 0x11FCC
{
	switch (iParam0)
	{
		case 0:
...
Hash func_388(BOOL bParam0) // Position - 0x12020
{
	if (bParam0)
...
BOOL func_389(int iParam0, int iParam1) // Position - 0x12043
{
	int i;
	BOOL flag;
	BOOL flag2;
	...
	switch (iParam0)
	{
		case 9:
			switch (iParam1)
			{
				...
				case 77:
					flag = func_150(13040, -1);
					break;
			
				case 78:
					flag2 = func_150(13036, -1);
		...
		case 10:
			switch (iParam1)
			{
				...
				case 92:
					...
					{
						flag = flag + func_404(_STAT_GET_PACKED_BOOL(9547, -1));
						flag = flag + func_404(_STAT_GET_PACKED_BOOL(9548, -1));
		...
		case 0:
			switch (iParam1)
			{
				...
				case 6:
					...
					if (_STAT_GET_PACKED_BOOL(&func_338, -1))
						flag = flag + 1;
		...
		case 31:
			switch (iParam1)
			{
				...
				case 340:
					flag = func_399(40, -1) + func_399(41, -1);
					break;
		...
		case 3:
			switch (iParam1)
			{
				...
				case 27:
					...
					else if (func_389(3, 28) > false)
					{
						_STAT_SET_PACKED_BOOL(&func_268, true, -1);
						flag = true;
					}
					break;
		...
		case 33:
			switch (iParam1)
			{
				...
				case 365:
					flag = func_401(func_150(11964, -1));
					break;
		...
		case 14:
			switch (iParam1)
			{
				...
				case 140:
					if (func_390(128, -1) || func_390(129, -1) || func_390(130, -1))
						flag = true;
					break;
		...
		case 24:
			switch (iParam1)
			{
				case 267:
					...
					if (func_401(flag2) > true || IS_BIT_SET(flag2, 1))
						flag = true;
					break;
		...
		case 30:
			switch (iParam1)
			{
				...
				case 334:
					flag = flag + func_401(func_150(11929, -1));
					flag = flag + func_401(func_150(11966, -1));
					flag = flag + func_401(func_150(11967, -1));
					flag = flag + func_401(func_150(11968, -1));
					break;
		...
		case 32:
			switch (iParam1)
			{
				...
				case 348:
					flag = _STAT_GET_PACKED_BOOL(&func_270, -1) ? true : 0;
					break;
				...
				case 353:
					flag = _STAT_GET_PACKED_BOOL(&func_269, -1) ? true : 0;
					break;
...
BOOL func_390(int iParam0, int iParam1) // Position - 0x178D1
{
	Hash statHash;
	BOOL outValue;

	statHash = func_391(iParam0, iParam1);
...
Hash func_391(int iParam0, int iParam1) // Position - 0x178F5
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(10, iParam0, func_152(iParam1));
}

BOOL func_392() // Position - 0x1790B
{
	int num;
	BOOL flag;
...
void func_393(int iParam0, BOOL bParam1, int iParam2) // Position - 0x17952
{
	if (iParam2 == -1)
		iParam2 = func_153();
...
BOOL func_394() // Position - 0x1797A
{
	BOOL flag;
	BOOL flag2;
	...
	func_393(41244, flag, -1);
	func_228(11960, Global_2740191.f_6950.f_3, -1, true);
	return flag;
}

BOOL func_395() // Position - 0x179F3
{
	BOOL address;
	int i;
	Hash weaponHash;
	...
	func_393(41242, address, -1);
	return func_401(address);
}

int func_396(int iParam0) // Position - 0x17AE9
{
	iParam0 = iParam0 / 32;
...
Hash func_397(int iParam0) // Position - 0x17B5C
{
	switch (iParam0)
	{
		case 34:
...
var func_398(BOOL bParam0, var uParam1, var uParam2) // Position - 0x1819F
{
	if (bParam0)
		return uParam1;
...
BOOL func_399(int iParam0, int iParam1) // Position - 0x181B6
{
	Hash statHash;
	int outValue;
...
Hash func_400(int iParam0, int iParam1) // Position - 0x181DA
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(8, iParam0, func_152(iParam1));
}

BOOL func_401(BOOL bParam0) // Position - 0x181F0
{
	int num;
	BOOL flag;
...
void func_402(var uParam0, int iParam1) // Position - 0x18230
{
	*uParam0 = *uParam0 - *uParam0 && iParam1;
	return;
}

BOOL func_403() // Position - 0x18245
{
	int num;
	int num2;
	...
	func_393(41247, num2, -1);
	return num2;
}

int func_404(BOOL bParam0) // Position - 0x1848A
{
	if (bParam0)
		return 1;
...
BOOL func_405(int iParam0, var uParam1) // Position - 0x1849C
{
	int i;

	for (i = uParam1->f_1; i <= 4; i = i + 1)
	{
		uParam1->f_2 = func_406(iParam0, *uParam1, i);
	
		if (uParam1->f_2 != -1)
		{
			uParam1->f_2.f_2 = func_371(*uParam1, uParam1->f_2);
			uParam1->f_2.f_1 = func_389(*uParam1, uParam1->f_2);
...
int func_406(int iParam0, int iParam1, int iParam2) // Position - 0x18514
{
	switch (iParam1)
	{
		case 9:
		...
		case 0:
			switch (iParam2)
			{
				...
				case 2:
					if (func_404(_STAT_GET_PACKED_BOOL(51286, -1)) + func_404(_STAT_GET_PACKED_BOOL(51287, -1)) + func_404(_STAT_GET_PACKED_BOOL(51288, -1)) + func_404(_STAT_GET_PACKED_BOOL(51289, -1)) + func_404(_STAT_GET_PACKED_BOOL(51290, -1)) + func_404(_STAT_GET_PACKED_BOOL(51291, -1)) == 1)
						return 3;
...
int func_407(int iParam0) // Position - 0x1A5F8
{
	int num;
	int num2;
	int num3;
...
BOOL func_408(int iParam0, BOOL bParam1) // Position - 0x1A63E
{
	if (iParam0 == -1)
		return false;
...
int func_409(int iParam0) // Position - 0x1A65A
{
	switch (iParam0)
	{
		case 54653:
...
void func_410() // Position - 0x1B669
{
	if (_NETSHOPPING_SHOULD_USE_TRANSACTION_SYSTEM())
...
BOOL func_411(var uParam0, var uParam1) // Position - 0x1B690
{
	switch (*uParam0)
	{
		case 0:
			if (_NETSHOPPING_SHOULD_USE_TRANSACTION_SYSTEM())
			{
				if (func_258(uParam1, false, true, iLocal_567))
				{
					if (*uParam1 == 2)
					{
						*uParam1 = 0;
			...
			{
				MONEY::_NETWORK_SPENT_SKIP_CARGO_SOURCE_SETUP(Global_262145.f_15836, false, true, iLocal_567);
				*uParam0 = 1;
			}
			break;
	
		case 1:
			func_412(3, uParam1, false);
			return *uParam1 != 1;
	}
...
void func_412(int iParam0, var uParam1, BOOL bParam2) // Position - 0x1B705
{
	int num;
	int num2;
	int num3;
	...
	if (!_NETSHOPPING_SHOULD_USE_TRANSACTION_SYSTEM())
	{
		if (num >= iParam0)
		{
			...
			func_436(num2);
			Global_1845274[PLAYER::PLAYER_ID() /*877*/].f_260.f_298.f_3 = num2;
			func_393(18090, false, -1);
			func_433(iParam0, bParam2);
			*uParam1 = 2;
		}
		else
		{
	...
	{
		if (func_432(iParam0, uParam1))
		{
			if (*uParam1 == 2)
			{
				num3 = func_322() + iParam0;
				func_436(num3);
				Global_1845274[PLAYER::PLAYER_ID() /*877*/].f_260.f_298.f_3 = num3;
				*uParam1 = 2;
				func_433(iParam0, bParam2);
			}
			else if (*uParam1 == 3)
...
void func_413() // Position - 0x1B800
{
	BOOL flag;
	BOOL flag2;
	int num;
	...
	if (flag2 > flag)
	{
		for (i = 0; i < 50; i = i + 1)
		{
			for (j = 0; j < 4; j = j + 1)
			{
				if (i == _STAT_GET_PACKED_INT(func_430(j), -1))
				{
					if (_STAT_GET_PACKED_INT(func_319(i), -1) != 0)
					{
						func_393(func_319(i), false, -1);
						func_393(func_430(i), 100, -1);
						Global_1960192[i] = false;
						num = num + 1;
					}
				}
			}
	...
	else if (flag2 < flag)
	{
		...
		num3 = flag - flag2;
		num4 = func_429(randomIntInRange);
...
void func_414() // Position - 0x1B95C
{
	BOOL flag;
	int instance_id;
	int i;
	...
	{
		instance_id = Global_2658019[PLAYER::PLAYER_ID() /*467*/].f_324.f_9;
	...
	if (flag)
	{
		for (i = 0; i < NETWORK::NETWORK_GET_MAX_NUM_PARTICIPANTS(); i = i + 1)
		{
			if (NETWORK::NETWORK_IS_PARTICIPANT_ACTIVE(PLAYER::INT_TO_PARTICIPANTINDEX(i)))
			{
				...
				{
					if (func_416(playerIndex))
					{
						instance_id2 = Global_2658019[playerIndex /*467*/].f_324.f_9;
					
						if (NETWORK::NETWORK_GET_HOST_OF_SCRIPT("AM_MP_HANGAR", instance_id2, 0) == playerIndex)
						{
							if (Global_1960191 > 0)
							{
								if (!_STOPWATCH_IS_INITIALIZED(&Global_1960254))
								{
									func_415(playerIndex, &Global_1960192);
									_STOPWATCH_INITIALIZE(&Global_1960254, false, false);
									Global_1960191 = Global_1960191 - 1;
								}
							}
						}
					}
...
void func_415(Player plParam0, var uParam1) // Position - 0x1BA45
{
	Hash eventData;
	int i;
	...
	SCRIPT::_SEND_TU_SCRIPT_EVENT_NEW(1, &eventData, 54, func_269(plParam0), eventData);
	return;
}

BOOL func_416(Player plParam0) // Position - 0x1BA99
{
	if (func_320())
		if (plParam0 != _INVALID_PLAYER_INDEX())
			if (func_249(plParam0))
				return Global_2658019[plParam0 /*467*/].f_324.f_11 == PLAYER::PLAYER_ID();

	return false;
}

void func_417(int iParam0) // Position - 0x1BAD1
{
	int num;
	int num2;
	int num3;
	...
	if (func_427(num))
	{
		num2 = func_426(iParam0);
		num3 = func_419(num2, num);
		func_393(func_319(num), func_418(num3), -1);
		Global_1960192[num] = func_418(num3);
	}

	return;
}

BOOL func_418(int iParam0) // Position - 0x1BB1C
{
	switch (iParam0)
	{
		case joaat("sm_prop_smug_crate_l_medical"):
...
int func_419(int iParam0, int iParam1) // Position - 0x1BBD5
{
	var unk;
	var unk3;
	...
	if (iParam1 > 0)
	{
		func_425(&unk, iParam0);
		func_423(&unk3, iParam1);
	
		if (func_421(&unk, &unk3, iParam1))
			return func_420(unk);
	}
	else if (iParam1 == 0)
	{
...
int func_420(int iParam0, var uParam1) // Position - 0x1BC28
{
	switch (iParam0)
	{
		case 5:
...
BOOL func_421(var uParam0, var uParam1, int iParam2) // Position - 0x1BDD8
{
	int num;
	int i;
...
int func_422(var uParam0, int iParam1) // Position - 0x1BE49
{
	int i;
	int num;
	var unk;
...
void func_423(var uParam0, int iParam1) // Position - 0x1BE97
{
	int num;

	num = func_317(Global_1960192[iParam1]);
	*uParam0 = func_316(num);
	uParam0->f_1 = func_424(num);
	return;
}

int func_424(int iParam0) // Position - 0x1BEC0
{
	switch (iParam0)
	{
		case joaat("sm_prop_smug_crate_l_medical"):
...
void func_425(var uParam0, int iParam1) // Position - 0x1BF70
{
	int randomIntInRange;
...
int func_426(int iParam0) // Position - 0x1BF8B
{
	switch (iParam0)
	{
		case 5:
...
BOOL func_427(int iParam0) // Position - 0x1BFEB
{
	return iParam0 >= 0 && iParam0 < 50;
}

int func_428() // Position - 0x1C003
{
	int i;

	for (i = 0; i < 50; i = i + 1)
	{
		if (Global_1960192[i] == false)
			return i;
	}
...
int func_429(int iParam0) // Position - 0x1C030
{
	switch (iParam0)
	{
		case 0:
...
int func_430(int iParam0) // Position - 0x1C095
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_431() // Position - 0x1C0D7
{
	int i;
	int num;
...
BOOL func_432(int iParam0, var uParam1) // Position - 0x1C115
{
	Hash hash;
	...
	switch (*uParam1)
	{
		case 0:
			...
			if (func_271(78225582, joaat("CATEGORY_CONTRABAND_QNTY"), hash, -886368739, iParam0, 0, 1, 4, 0, 3))
				*uParam1 = 1;
			else
				*uParam1 = 3;
...
void func_433(int iParam0, BOOL bParam1) // Position - 0x1C1D5
{
	int address;
	int i;
	int j;
	...
	if (bParam1)
		func_434(address, &unk);

	func_414();
	return;
}

void func_434(int iParam0, var uParam1) // Position - 0x1C27C
{
	int i;
	int num;
	var text;
...
struct<4> func_435(int iParam0) // Position - 0x1C300
{
	var unk;
...
void func_436(int iParam0) // Position - 0x1C3B3
{
	func_437(6104, iParam0, -1);
...
void func_437(int iParam0, int iParam1, int iParam2) // Position - 0x1C3D6
{
	BOOL flag;
	int num;
	...
	if (*Global_262145.f_35149)
	{
		func_228(iParam0, iParam1, iParam2, true);
		return;
	}
	...
	if (!func_408(num, iParam1 == func_150(iParam0, -1)))
	{
		flag = false;
	}
	else
...
BOOL func_438(int iParam0, var uParam1) // Position - 0x1C46A
{
	int i;

	for (i = uParam1->f_1; i <= 4; i = i + 1)
	{
		uParam1->f_2 = func_439(iParam0, *uParam1, i);
...
int func_439(int iParam0, int iParam1, int iParam2) // Position - 0x1C4E2
{
	switch (iParam1)
	{
		case 9:
...
int func_440(int iParam0) // Position - 0x1D4CE
{
	switch (iParam0)
	{
		case 13035:
...
void func_441(int iParam0, Any anParam1, int iParam2) // Position - 0x1D90A
{
	if (!NETWORK::NETWORK_IS_ACTIVITY_SESSION() && NETWORK::IS_STORE_AVAILABLE_TO_USER())
	{
		func_442(iParam0, anParam1);
		Global_77026 = true;
...
void func_442(Hash hParam0, int iParam1) // Position - 0x1D936
{
...
void func_443() // Position - 0x1D94A
{
	if (Global_77024)
	{
		func_337(FRONTEND_CONTROL, INPUT_FRONTEND_ACCEPT, true);
		...
		if (PAD::IS_CONTROL_JUST_PRESSED(FRONTEND_CONTROL, INPUT_FRONTEND_ACCEPT) || PAD::IS_CONTROL_JUST_PRESSED(FRONTEND_CONTROL, INPUT_CURSOR_ACCEPT) && !HUD::IS_WARNING_MESSAGE_ACTIVE())
		{
			...
			func_444(Global_77027, Global_77028, 113158192, 1);
		...
		{
			AUDIO::PLAY_SOUND_FRONTEND(-1, "BACK", "HUD_FRONTEND_DEFAULT_SOUNDSET", true);
			func_444(Global_77027, Global_77028, 113158192, 0);
			Global_77024 = false;
			Global_77026 = false;
		}
	}
...
void func_444(Hash hParam0, int iParam1, int iParam2, int iParam3) // Position - 0x1DA1E
{
	var entityCoords;
...
void func_445() // Position - 0x1DA6D
{
	...
	func_337(FRONTEND_CONTROL, INPUT_FRONTEND_PAUSE, true);
	GRAPHICS::SET_SCRIPT_GFX_DRAW_ORDER(1);
	func_466(0f, 0f, 1f, 1f, 0, 0, 0, 255);
	GRAPHICS::SET_SCRIPT_GFX_DRAW_ORDER(1);
	GRAPHICS::DRAW_SCALEFORM_MOVIE_FULLSCREEN(iLocal_1285, 255, 255, 255, 255, 0);
	...
	if (func_334() && !HUD::IS_WARNING_MESSAGE_ACTIVE())
	{
		...
		func_465(1);
		func_464(1);
		func_458(&iLocal_1287, &uLocal_1988, &uLocal_1288, func_463(&uLocal_1288));
	}
...
void func_446(BOOL bParam0) // Position - 0x1DB33
{
	if (bParam0)
		func_448();
...
void func_447(int iParam0, int iParam1) // Position - 0x1DB84
{
...
void func_448() // Position - 0x1DBBA
{
	Global_2740191.f_4672 = 0;
	return;
}

void func_449(int iParam0) // Position - 0x1DBCA
{
	if (func_455())
		return;
...
void func_450(int iParam0) // Position - 0x1DBFD
{
	if (func_455())
		return;
...
BOOL func_451() // Position - 0x1DC87
{
...
void func_452(BOOL bParam0, BOOL bParam1) // Position - 0x1DCAE
{
	if (bParam0)
	{
		if (func_454(0))
...
BOOL func_453() // Position - 0x1DD22
{
	return IS_BIT_SET(Global_1960332, 5);
}

BOOL func_454(int iParam0) // Position - 0x1DD30
{
	if (iParam0 == 1)
...
BOOL func_455() // Position - 0x1DD87
{
	return IS_BIT_SET(Global_1960332, 19);
}

void func_456() // Position - 0x1DD96
{
...
void func_457() // Position - 0x1DDA6
{
	Global_24009.f_134 = 1;
	return;
}

void func_458(var uParam0, var uParam1, var uParam2, BOOL bParam3) // Position - 0x1DDB4
{
	int i;
			...
			for (i = 0; i < uParam2->f_693; i = i + 1)
			{
				if (IS_BIT_SET(uParam2->f_689, i))
				{
					...
					if (!IS_BIT_SET(uParam2->f_690, i))
					{
						...
						func_461(PAD::GET_CONTROL_INSTRUCTIONAL_BUTTONS_STRING(control, action, true));
					
						if (action2 < 365)
							func_461(PAD::GET_CONTROL_INSTRUCTIONAL_BUTTONS_STRING(control, action2, true));
					}
					else
					{
						control2 = uParam2->f_1[i /*57*/].f_54;
						controlGroup = uParam2->f_1[i /*57*/].f_55;
						func_461(PAD::GET_CONTROL_GROUP_INSTRUCTIONAL_BUTTONS_STRING(control2, controlGroup, true));
					}
				...
				else
				{
					GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(*uParam0, "SET_DATA_SLOT");
					GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(i);
					func_461(&uParam2->f_1[i /*57*/]);
				
					if (!MISC::IS_STRING_NULL_OR_EMPTY(&(uParam2->f_1[i /*57*/].f_16)))
						func_461(&(uParam2->f_1[i /*57*/].f_16));
...
void func_459() // Position - 0x1E15C
{
...
void func_460(int iParam0, var uParam1) // Position - 0x1E17A
{
	GRAPHICS::DRAW_SCALEFORM_MOVIE_FULLSCREEN(iParam0, uParam1->f_4, uParam1->f_5, uParam1->f_6, uParam1->f_7, 0);
	return;
}

void func_461(const char* sParam0) // Position - 0x1E199
{
	GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_PLAYER_NAME_STRING(sParam0);
	return;
}

void func_462(var uParam0) // Position - 0x1E1A7
{
	Global_1985670 = 0;
	uParam0->f_692 = 0;
	return;
...
BOOL func_463(var uParam0) // Position - 0x1E1BA
{
	return Global_1985670 || uParam0->f_692;
}

void func_464(int iParam0) // Position - 0x1E1D1
{
	Global_1577957 = iParam0;
	return;
}

void func_465(int iParam0) // Position - 0x1E1DF
{
	Global_1675455.f_1163 = iParam0;
	return;
}

void func_466(float fParam0, float fParam1, float fParam2, float fParam3, int iParam4, int iParam5, int iParam6, int iParam7) // Position - 0x1E1F0
{
	GRAPHICS::DRAW_RECT(fParam0 + (fParam2 * 0.5f), fParam1 + (fParam3 * 0.5f), fParam2, fParam3, iParam4, iParam5, iParam6, iParam7, false);
	return;
}

void func_467() // Position - 0x1E21F
{
	func_468(true);
...
void func_468(BOOL bParam0) // Position - 0x1E25B
{
	if (bParam0)
		if (func_469())
...
BOOL func_469() // Position - 0x1E280
{
	return IS_BIT_SET(Global_2684748.f_2, 11);
}

void func_470() // Position - 0x1E291
{
	char* entryHeader;
	char* entryLine1;
...
BOOL func_471() // Position - 0x1E34F
{
	return Global_1575076;
}

void func_472() // Position - 0x1E35B
{
	if (!IS_BIT_SET(iLocal_538, 9))
	{
		if (!func_336())
		{
			if (!func_511())
			{
				...
				if (!func_476(2) && !IS_BIT_SET(Global_1946287, 2) && IS_BIT_SET(iLocal_538, 13))
				{
...
void func_473(int iParam0) // Position - 0x1E3E8
{
	switch (iParam0)
	{
		case 0:
...
void func_474(int iParam0) // Position - 0x1E487
{
	int i;
	int num;
...
void _DISPLAY_HELP_TEXT_0(const char* text, int iParam1) // Position - 0x1E4BE
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_HELP(text);
	HUD::END_TEXT_COMMAND_DISPLAY_HELP(0, false, true, iParam1);
	return;
...
BOOL func_476(int iParam0) // Position - 0x1E4D5
{
	switch (iParam0)
	{
		case 0:
			return func_477(15967);
	
		case 1:
			return func_477(15970);
	
		case 2:
			return func_477(15973);
	
		case 3:
			return func_477(15976);
	
		case 4:
			return func_477(15979);
	
		case 5:
			return func_477(15982);
	
		case 6:
			return func_477(15985);
	
		case 7:
			return func_477(15988);
	
		case 8:
			return func_477(15991);
...
BOOL func_477(int iParam0) // Position - 0x1E575
{
	int i;
	int num;
...
void func_478() // Position - 0x1E5A6
{
	func_479(2, 203, "HAPP_SU_B", &uLocal_1288, true, 365);
	return;
}

void func_479(int iParam0, int iParam1, char* sParam2, var uParam3, BOOL bParam4, int iParam5) // Position - 0x1E5C0
{
	int offset;
...
void func_480() // Position - 0x1E63D
{
	var unk;
	int i;
	int num;
	...
	if (!IS_BIT_SET(iLocal_538, 7) && !_CONVERSATION_IS_DIALOGUE_IN_PROGRESS())
	{
		for (i = 0; i < num; i = i + 1)
		{
			num2 = i;
			...
			{
				unk = { func_483(num2) };
				iLocal_541 = func_482(num2);
				MISC::SET_BIT(&Global_1946287, i);
				func_473(num2);
				break;
			}
		}
	...
	if (!IS_BIT_SET(iLocal_538, 7) && !MISC::IS_STRING_NULL_OR_EMPTY(&unk))
	{
		_DISPLAY_HELP_TEXT_0(&unk, iLocal_541);
		MISC::SET_BIT(&iLocal_538, 7);
	}
	else if (IS_BIT_SET(iLocal_538, 7))
	{
		if (!_STOPWATCH_IS_INITIALIZED(&uLocal_577))
		{
			_STOPWATCH_INITIALIZE(&uLocal_577, false, false);
		}
		else if (_STOPWATCH_HAS_TIME_PASSED(&uLocal_577, iLocal_541, false))
		{
			MISC::CLEAR_BIT(&iLocal_538, 7);
			iLocal_541 = 0;
			_STOPWATCH_DESTROY(&uLocal_577);
		
			if (func_481())
				MISC::SET_BIT(&iLocal_538, 8);
		}
	}
...
BOOL func_481() // Position - 0x1E71D
{
	if (func_476(0) && func_476(1) && func_476(2) && func_476(3) && func_476(4) && func_476(6) && func_476(7) && func_476(8))
		return true;

	return false;
}

int func_482(int iParam0) // Position - 0x1E779
{
	switch (iParam0)
	{
		case 0:
...
struct<4> func_483(int iParam0) // Position - 0x1E7F5
{
	var unk;
...
BOOL func_484(int iParam0) // Position - 0x1E8A7
{
	int num;

	num = iParam0;

	if (!IS_BIT_SET(iLocal_538, 9) && iParam0 != 2)
		return false;

	switch (iParam0)
	{
		case 0:
			if (!func_476(iParam0) && !IS_BIT_SET(Global_1946287, num) && IS_BIT_SET(iLocal_538, 11))
				return true;
			break;
	
		case 1:
			if (!func_476(iParam0) && !IS_BIT_SET(Global_1946287, num) && IS_BIT_SET(iLocal_538, 12))
				return true;
			break;
	
		case 2:
			if (!func_476(iParam0) && !IS_BIT_SET(Global_1946287, num) && IS_BIT_SET(iLocal_538, 13))
				return true;
			break;
	
		case 3:
			if (!func_476(iParam0) && !IS_BIT_SET(Global_1946287, num) && IS_BIT_SET(iLocal_538, 9) && iLocal_568 == 0)
				return true;
			break;
	
		case 4:
			if (!func_476(iParam0) && !IS_BIT_SET(Global_1946287, num) && iLocal_568 == 1)
				return true;
			break;
	
		case 5:
			if (!func_476(iParam0) && !IS_BIT_SET(Global_1946287, num) && iLocal_568 == 1 && IS_BIT_SET(Global_1946287, 4) || func_476(4))
				return true;
			break;
	
		case 6:
			if (!func_476(iParam0) && !IS_BIT_SET(Global_1946287, num) && iLocal_568 == 2)
				return true;
			break;
	
		case 7:
			if (!func_476(iParam0) && !IS_BIT_SET(Global_1946287, num) && iLocal_568 == 2 && IS_BIT_SET(Global_1946287, 6) || func_476(6))
				return true;
			break;
	
		case 8:
			if (!func_476(iParam0) && !IS_BIT_SET(Global_1946287, num) && IS_BIT_SET(iLocal_538, 14) && iLocal_568 == 2 && IS_BIT_SET(Global_1946287, 6) || func_476(6) && IS_BIT_SET(Global_1946287, 7) || func_476(7))
				return true;
			break;
	}
...
BOOL _CONVERSATION_IS_DIALOGUE_IN_PROGRESS() // Position - 0x1EAE1
{
...
void func_486() // Position - 0x1EB03
{
	if (iLocal_540 != -1)
		func_487(iLocal_540);
...
void func_487(int iParam0) // Position - 0x1EB19
{
	if (_CONVERSATION_ADD_LINE(&uLocal_581, "SMGCAUD", func_508(iParam0), 8, 0, 0, 0))
		iLocal_540 = -1;

	return;
}

BOOL _CONVERSATION_ADD_LINE(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x1EB3E
{
	...
	Global_23599 = 0;
	Global_2883585 = 0;
	return func_489(sParam2, iParam3, false);
}

BOOL func_489(char* sParam0, int iParam1, BOOL bParam2) // Position - 0x1EB8C
{
	Global_22603 = 0;
...
void func_490() // Position - 0x1EE5A
{
	if (!func_491())
		return;
...
BOOL func_491() // Position - 0x1EE91
{
...
BOOL func_492(Player plParam0) // Position - 0x1EEF4
{
	return func_14(plParam0, 20);
}

void func_493() // Position - 0x1EF04
{
	int i;
...
void func_494() // Position - 0x1EF34
{
...
BOOL func_495() // Position - 0x1EFC9
{
	int num;
	int weaponHash;
...
void _UPDATE_CURRENT_PLAYER_CHARACTER() // Position - 0x1F062
{
	if (func_503(14))
	{
...
eCharacter _GET_CURRENT_PLAYER_CHARACTER() // Position - 0x1F104
{
	func_498();
	return Global_114370.f_2367.f_539.f_4321;
}

void func_498() // Position - 0x1F11D
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (_GET_CHARACTER_MODEL(Global_114370.f_2367.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_499(character) && !func_503(14) || Global_113318)
			{
				if (Global_114370.f_2367.f_539.f_4321 != character && func_499(Global_114370.f_2367.f_539.f_4321))
...
BOOL func_499(eCharacter echParam0) // Position - 0x1F21A
{
	return echParam0 < CHAR_MULTIPLAYER;
}

eCharacter _GET_PLAYER_CHARACTER_FROM_PED(Ped pedParam0) // Position - 0x1F226
{
	eCharacter i;
	Hash entityModel;
...
Hash _GET_CHARACTER_MODEL(eCharacter character) // Position - 0x1F263
{
	if (func_499(character))
		return func_502(character);
	else
...
Hash func_502(eCharacter echParam0) // Position - 0x1F288
{
	return Global_2241[echParam0 /*29*/];
}

BOOL func_503(int iParam0) // Position - 0x1F297
{
	return Global_44392 == iParam0;
}

void func_504() // Position - 0x1F2A5
{
	int i;
...
BOOL func_505(int iParam0, int iParam1) // Position - 0x1F2FB
{
	switch (iParam0)
	{
		case 5:
...
void func_506() // Position - 0x1F333
{
...
void func_507(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0x1F38A
{
...
char* func_508(int iParam0) // Position - 0x1F3E0
{
	switch (iParam0)
	{
		case 0:
...
void func_509() // Position - 0x1F41A
{
	BOOL flag;

	if (!IS_BIT_SET(iLocal_538, 4) && !_CONVERSATION_IS_DIALOGUE_IN_PROGRESS())
	{
		if (iLocal_568 == 0)
		{
	...
	else if (IS_BIT_SET(iLocal_538, 4))
	{
		if (!_STOPWATCH_IS_INITIALIZED(&uLocal_573))
		{
			_STOPWATCH_INITIALIZE(&uLocal_573, false, false);
		}
		else if (_STOPWATCH_HAS_TIME_PASSED(&uLocal_573, iLocal_541, false))
		{
			MISC::CLEAR_BIT(&iLocal_538, 4);
			iLocal_541 = 0;
...
BOOL func_510() // Position - 0x1F515
{
...
BOOL func_511() // Position - 0x1F547
{
	return _STAT_GET_PACKED_BOOL(15966, -1);
}

void func_512() // Position - 0x1F557
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		func_527(0, true);
	else if (func_338())
...
BOOL func_513() // Position - 0x1F592
{
	return Global_76855;
}

void func_514() // Position - 0x1F59E
{
	func_512();
	iLocal_1285 = GRAPHICS::REQUEST_SCALEFORM_MOVIE("HANGAR_CARGO");

	if (!func_511())
		iLocal_1287 = GRAPHICS::REQUEST_SCALEFORM_MOVIE_INSTANCE("INSTRUCTIONAL_BUTTONS");
	...
	func_515(314, true, -1, true);
	return;
}

void func_515(int iParam0, BOOL bParam1, int iParam2, BOOL bParam3) // Position - 0x1F681
{
	Hash statName;

	statName = func_516(iParam0, iParam2);
...
Hash func_516(int iParam0, int iParam1) // Position - 0x1F6A4
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(2, iParam0, func_152(iParam1));
}

int func_517(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x1F6B9
{
	int num;
...
void func_518() // Position - 0x1F6EC
{
	int i;
...
void func_519() // Position - 0x1F738
{
	if (func_510())
	{
		MISC::SET_BIT(&iLocal_538, 5);
	...
	else
	{
		...
		iLocal_541 = 800;
		func_521(true);
		_CONVERSATION_INITIALIZE_ACTOR(&uLocal_581, 2, 0, "NERVOUSRON", 0, 1);
	}

	return;
}

void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, Ped pedParam2, char* sParam3, int iParam4, int iParam5) // Position - 0x1F774
{
...
void func_521(BOOL bParam0) // Position - 0x1F80F
{
	if (bParam0)
		Global_1835553 = 1;
	else
...
void func_522(int iParam0) // Position - 0x1F829
{
...
void func_523() // Position - 0x1F843
{
	Global_1574756 = true;
...
void func_524(BOOL bParam0) // Position - 0x1F86C
{
	if (bParam0)
	{
		func_525();
...
void func_525() // Position - 0x1F8CF
{
...
BOOL func_526() // Position - 0x1F8F8
{
...
void func_527(int iParam0, BOOL bParam1) // Position - 0x1F926
{
...
void func_528() // Position - 0x1F993
{
	if (!Global_1574756)
		return;
...
void func_529() // Position - 0x1F9AA
{
