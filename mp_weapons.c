...
char* func_25(var uParam0) // Position - 0x26C1
{
	return uParam0;
}

int func_26(Hash hParam0, Any* panParam1) // Position - 0x26CB
{
	int i;
	int numDlcWeapons;
...
BOOL func_27(int iParam0, int iParam1) // Position - 0x2706
{
	int num;
	int num2;
	int num3;
...
int func_28(eControlAction ecaParam0) // Position - 0x2768
{
	return ecaParam0 % 32;
}

eControlAction func_29(int iParam0) // Position - 0x2775
{
	return func_30(iParam0);
}

int func_30(int iParam0) // Position - 0x2783
{
	switch (iParam0)
	{
		case joaat("WEAPON_UNARMED"):
...
int func_31(int iParam0, int iParam1) // Position - 0x2DD3
{
	int num;
...
BOOL func_32(int iParam0, int iParam1) // Position - 0x2DEB
{
	Hash statHash;
	int outValue;
...
Hash func_33(int iParam0, int iParam1) // Position - 0x2E1A
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(0, iParam0, func_34(iParam1));
}

int func_34(int iParam0) // Position - 0x2E2F
{
	int num;
	int num2;
...
int func_35(int iParam0) // Position - 0x2E63
{
	int num;
	int num2;
...
int func_36() // Position - 0x2F12
{
	return Global_33299;
}

int func_37(eControlAction ecaParam0) // Position - 0x2F1D
{
	return ecaParam0 / 32;
}

BOOL func_38(int iParam0, int iParam1) // Position - 0x2F2A
{
	Hash statHash;
	BOOL outValue;
...
Hash func_39(int iParam0, int iParam1) // Position - 0x2F4E
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(2, iParam0, func_34(iParam1));
}

int func_40(int iParam0) // Position - 0x2F63
{
	switch (iParam0)
	{
		case joaat("WEAPON_PISTOL"):
...
BOOL func_41() // Position - 0x356A
{
	return Global_1575067;
}

int func_42() // Position - 0x3576
{
...
var func_43(int iParam0) // Position - 0x3594
{
	return Global_1574538[iParam0];
}

var func_44() // Position - 0x35A4
{
	return func_43(func_213() + 1);
}

BOOL func_45(int iParam0) // Position - 0x35B6
{
	BOOL flag;
	int num;
	int num2;
...
int func_46(Player plParam0) // Position - 0x3634
{
	return Global_1845274[plParam0 /*877*/].f_198.f_6;
}

int func_47(Hash hParam0, var uParam1, int iParam2) // Position - 0x3649
{
	int num;
...
int func_48(Hash hParam0, int iParam1) // Position - 0x3746
{
	switch (iParam1)
	{
		case joaat("WEAPON_SMG_MK2"):
...
int func_49(Hash hParam0, var uParam1, int iParam2) // Position - 0x38A2
{
	int num;
...
int func_50(Hash hParam0, int iParam1) // Position - 0x3A59
{
	switch (iParam1)
	{
		case joaat("WEAPON_SMG_MK2"):
...
int func_51(Hash hParam0, var uParam1, int iParam2) // Position - 0x3B09
{
	int num;
...
int func_52(Hash hParam0, int iParam1) // Position - 0x3D4C
{
	switch (iParam1)
	{
		case joaat("WEAPON_PISTOL"):
...
BOOL func_53(Hash hParam0, Hash hParam1, int iParam2) // Position - 0x48F3
{
	int num;
...
eControlAction func_54(Hash hParam0, Hash hParam1) // Position - 0x4925
{
...
int func_56(Hash hParam0, Hash hParam1, int iParam2) // Position - 0x6F54
{
	int num;
...
int func_57(Hash hParam0, Hash hParam1) // Position - 0x6F6E
{
	eControlAction action;
	int num;
...
char* func_58(Hash hParam0, Hash hParam1) // Position - 0x70EB
{
	int dlcWeaponIndex;
	int i;
	var unk;
...
void func_59(Hash hParam0, Hash hParam1, BOOL bParam2) // Position - 0x7B37
{
	if (bParam2)
...
void func_60(Hash hParam0, Hash hParam1, BOOL bParam2) // Position - 0x7B72
{
	BOOL address;
	eControlAction action;
...
void func_61(int iParam0, BOOL bParam1, int iParam2, BOOL bParam3) // Position - 0x7BC8
{
	Hash statName;
...
int func_62(Hash hParam0, Hash hParam1) // Position - 0x7BF6
{
	eControlAction action;
	int num;
...
BOOL func_63(Hash hParam0, Hash hParam1, int iParam2) // Position - 0x7D79
{
	int num;
...
BOOL func_64(Hash hParam0, Hash hParam1, int iParam2) // Position - 0x7D93
{
	int num;
	eControlAction action;
...
void func_65(Hash hParam0, Hash hParam1, BOOL bParam2) // Position - 0x7DC5
{
	if (bParam2)
...
void func_66(Hash hParam0, Hash hParam1, BOOL bParam2) // Position - 0x7E00
{
	int address;
	eControlAction action;
...
void func_67(int iParam0, int iParam1, int iParam2) // Position - 0x7E55
{
	BOOL flag;
	int num;
...
void func_68(var uParam0) // Position - 0x7EE9
{
...
BOOL func_69(var uParam0) // Position - 0x7FCD
{
	var unk;
	BOOL flag;
...
BOOL func_70(var uParam0, var uParam1, var uParam2) // Position - 0x803F
{
	int num;
...
int func_71(int iParam0, int iParam1, int iParam2) // Position - 0x8067
{
	switch (iParam0)
	{
		case 18:
...
BOOL func_72(var uParam0, int iParam1, int iParam2, var uParam3) // Position - 0x8180
{
	int num;
	int i;
...
void func_73(int iParam0, int iParam1, var uParam2, var uParam3) // Position - 0x81D2
{
	int i;
	int j;
...
void func_74(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7) // Position - 0x944C
{
	int i;
...
void _STAT_SET_PACKED_BOOL(int iParam0, BOOL bParam1, int iParam2) // Position - 0x966E
{
	if (iParam2 == -1)
		iParam2 = func_213();
...
int func_78(int iParam0) // Position - 0x970C
{
	switch (iParam0)
	{
		case 0:
...
void func_79(int iParam0, int iParam1) // Position - 0x975A
{
	int num;
	BOOL address;
	int offset;
...
void func_80(int iParam0, int iParam1) // Position - 0x97AB
{
	int num;
	int offset;
...
int func_81(int iParam0) // Position - 0x9866
{
	return func_82(iParam0) / 8;
}

int func_82(int iParam0) // Position - 0x9877
{
	switch (iParam0)
	{
		case 2:
...
void func_83(int iParam0, int iParam1) // Position - 0x99F5
{
	var entityCoords;
	int num;
	Hash hash;
...
Hash func_84(int iParam0) // Position - 0x9A48
{
	var unk;
...
char* AUDIO_SPEECH_GET_PARAM_STRING_FROM_ENUM(int iParam0) // Position - 0x9A68
{
	switch (iParam0)
	{
		case 0:
...
Hash func_86(int iParam0) // Position - 0x9C35
{
	switch (iParam0)
	{
		case 0:
...
Hash func_87() // Position - 0x9CA1
{
	return MISC::GET_HASH_KEY("PROGRESS_HUB_TIER_COMPLETED");
}

int func_88() // Position - 0x9CB1
{
	if (Global_1668418 == 0)
		func_89();
...
BOOL _NETWORK_IS_PLAYER_VALID(Player player, BOOL bIsPlaying, BOOL bUnk) // Position - 0x9CF8
{
	Player player;
...
int func_91(int iParam0, int iParam1) // Position - 0x9D58
{
	if (iParam1 == 4)
		iParam1 = 3;
...
int func_92(int iParam0) // Position - 0x9D74
{
	return func_82(iParam0) % 8;
}

int func_93(int iParam0) // Position - 0x9D85
{
	int num;
...
BOOL func_94(int iParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Position - 0x9D9B
{
	BOOL flag;
	int num;
	int num2;
...
BOOL func_95(int iParam0, int iParam1) // Position - 0x9E38
{
	BOOL flag;
	BOOL flag2;
...
BOOL func_96(int iParam0, int iParam1) // Position - 0x9E59
{
	int i;
...
int func_97(int iParam0, int iParam1) // Position - 0xAFA6
{
	if (func_98(iParam0))
	{
		switch (iParam1)
...
BOOL func_98(int iParam0) // Position - 0xB019
{
	int num;
...
int func_99(int iParam0) // Position - 0xB041
{
	switch (iParam0)
	{
		case 26:
...
int func_100(int iParam0, int iParam1, int iParam2) // Position - 0xB147
{
	int num;
	int i;
	int num2;
...
int func_101(int iParam0) // Position - 0xB1B3
{
	if (func_98(iParam0))
		return 13;
...
void func_102(int iParam0) // Position - 0xB1CE
{
	int num;
	int num2;
	int offset;
...
int func_103(int iParam0) // Position - 0xB20C
{
	return iParam0 % 32;
}

int func_104(int iParam0) // Position - 0xB219
{
	return iParam0 / 32;
}

int func_105(int iParam0) // Position - 0xB226
{
	switch (iParam0)
	{
		case 16:
...
void func_106(var uParam0) // Position - 0xC2A7
{
	int num;
	int num2;
	int num3;
...
int func_107(int iParam0) // Position - 0xC2E3
{
	switch (iParam0)
	{
		case 2:
...
void func_108(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7) // Position - 0xCE6E
{
	var entityCoords;
	int num;
	Hash hash;
...
Hash func_109(int iParam0, var uParam1, int iParam2) // Position - 0xCED7
{
	var unk;
...
char* func_110(int iParam0) // Position - 0xD1D7
{
	var unk;
...
char* func_111(var uParam0) // Position - 0xD1F3
{
	return uParam0;
}

char* func_112(int iParam0) // Position - 0xD1FD
{
	switch (iParam0)
	{
		case 0:
...
Hash func_113(BOOL bParam0) // Position - 0xD251
{
	if (bParam0)
...
BOOL func_114(int iParam0, int iParam1) // Position - 0xD274
{
	int i;
	BOOL flag;
	BOOL flag2;
...
BOOL func_115(int iParam0, int iParam1) // Position - 0x12B02
{
	Hash statHash;
	BOOL outValue;
...
Hash func_116(int iParam0, int iParam1) // Position - 0x12B26
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(10, iParam0, func_34(iParam1));
}

BOOL func_117() // Position - 0x12B3C
{
	int num;
	BOOL flag;
...
void func_118(int iParam0, BOOL bParam1, int iParam2) // Position - 0x12B83
{
	if (iParam2 == -1)
		iParam2 = func_213();
...
BOOL func_119() // Position - 0x12BAB
{
	BOOL flag;
	BOOL flag2;
...
BOOL func_120() // Position - 0x12C24
{
	BOOL address;
	int i;
	Hash weaponHash;
...
int func_121(int iParam0) // Position - 0x12D1A
{
	iParam0 = iParam0 / 32;
...
Hash func_122(int iParam0) // Position - 0x12D8D
{
	switch (iParam0)
	{
		case 34:
...
var func_123(BOOL bParam0, var uParam1, var uParam2) // Position - 0x133CE
{
	if (bParam0)
		return uParam1;
...
BOOL func_124(int iParam0, int iParam1) // Position - 0x133E5
{
	Hash statHash;
	int outValue;
...
Hash func_125(int iParam0, int iParam1) // Position - 0x13409
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(8, iParam0, func_34(iParam1));
}

BOOL func_126(BOOL bParam0) // Position - 0x1341F
{
	int num;
	BOOL flag;
...
void func_127(var uParam0, int iParam1) // Position - 0x1345F
{
	*uParam0 = *uParam0 - *uParam0 && iParam1;
	return;
}

BOOL func_128() // Position - 0x13474
{
	int num;
	int num2;
...
int func_129(BOOL bParam0) // Position - 0x136B9
{
	if (bParam0)
		return 1;
...
int _STAT_GET_PACKED_INT(int iParam0, int iParam1) // Position - 0x136CB
{
	if (iParam1 == -1)
		iParam1 = func_213();
...
BOOL func_131(int iParam0, var uParam1) // Position - 0x136E7
{
	int i;
...
int func_132(int iParam0, int iParam1, int iParam2) // Position - 0x1375F
{
	switch (iParam1)
	{
		case 9:
...
int func_133(int iParam0) // Position - 0x1474E
{
	int num;
	int num2;
	int num3;
...
BOOL func_134(int iParam0, BOOL bParam1) // Position - 0x14794
{
	if (iParam0 == -1)
		return false;
...
int func_135(int iParam0) // Position - 0x147B0
{
	switch (iParam0)
	{
		case 13035:
...
int func_136(Hash hParam0, Hash hParam1) // Position - 0x14BEC
{
	eControlAction action;
	int num;
...
int func_137(Hash hParam0, Hash hParam1, int iParam2) // Position - 0x14D6C
{
	int num;
...
void func_138(Hash hParam0, Hash hParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x14D86
{
	if (bParam2)
	{
...
void func_139(Hash hParam0, Hash hParam1, BOOL bParam2) // Position - 0x14E0F
{
	if (bParam2)
...
void func_140(Hash hParam0, Hash hParam1, BOOL bParam2) // Position - 0x14E4A
{
	int address;
	eControlAction action;
...
int func_141(Hash hParam0, Hash hParam1) // Position - 0x14EA0
{
	eControlAction action;
	int num;
...
int func_142(Hash hParam0, Hash hParam1, int iParam2) // Position - 0x15023
{
	int num;
...
BOOL func_143(Hash hParam0, Hash hParam1, int iParam2) // Position - 0x1503D
{
	int num;
	eControlAction action;
...
void func_144(Hash hParam0, Hash hParam1, BOOL bParam2) // Position - 0x1506F
{
	eControlAction action;
...
int func_145(Hash hParam0, Hash hParam1) // Position - 0x150C8
{
	eControlAction action;
...
void func_146(int iParam0, char* sParam1, char* sParam2, char* sParam3, char* sParam4, int iParam5, int iParam6, int iParam7, const char* sParam8, int iParam9, int iParam10) // Position - 0x1519E
{
	int num;
...
int func_147(var uParam0) // Position - 0x1523A
{
	int num;
	int i;
...
char* func_148(Hash hParam0) // Position - 0x15269
{
	switch (hParam0)
	{
		case joaat("WEAPON_KNIFE"):
...
char* func_149(Hash hParam0) // Position - 0x1545C
{
	switch (hParam0)
	{
		case joaat("WEAPON_KNIFE"):
...
char* func_150(Hash hParam0, Hash hParam1) // Position - 0x1564F
{
	int dlcWeaponIndex;
	int i;
	var unk;
...
BOOL func_151(Hash hParam0, Hash hParam1) // Position - 0x15ED3
{
	int num;
	eControlAction action;
...
int func_152(Hash hParam0, Hash hParam1) // Position - 0x15EF8
{
	var unk;
...
void func_153(Hash hParam0, Hash hParam1, BOOL bParam2) // Position - 0x15F15
{
	int address;
	eControlAction action;
...
Hash func_154(Hash hParam0, int iParam1) // Position - 0x15F6B
{
	int num;
	int dlcWeaponIndex;
	int i;
...
BOOL func_155(int iParam0) // Position - 0x16CEC
{
	switch (iParam0)
	{
...
BOOL func_156(int iParam0, int iParam1, int iParam2) // Position - 0x16D8D
{
	int num;
	eControlAction action;
...
int func_157(int iParam0, int iParam1) // Position - 0x16DC1
{
	int num;
...
int func_158(int iParam0) // Position - 0x16DD9
{
	eControlAction action;
	int num;
...
BOOL func_159(Hash hParam0, int iParam1, int iParam2) // Position - 0x16EA3
{
	int num;
	int num2;
...
int func_160(int iParam0, int iParam1) // Position - 0x16F0D
{
	int num;
...
int func_161(int iParam0) // Position - 0x16F25
{
	int num;
	int num2;
...
int func_162(int iParam0) // Position - 0x16FD1
{
	switch (iParam0)
	{
		case joaat("WEAPON_UNARMED"):
...
BOOL func_163(Hash hParam0, Hash hParam1, int iParam2) // Position - 0x175E4
{
	int num;
	eControlAction action;
...
Hash func_164(Hash hParam0) // Position - 0x17616
{
	switch (hParam0)
	{
		case joaat("WEAPON_PISTOL_MK2"):
...
BOOL func_165(Hash hParam0) // Position - 0x176CE
{
	switch (hParam0)
	{
		case joaat("WEAPON_PISTOL_MK2"):
...
int func_166(var uParam0) // Position - 0x1772D
{
	return uParam0->f_281;
}

void func_167(var uParam0, var uParam1) // Position - 0x1773A
{
...
BOOL func_168(Hash hParam0, int iParam1) // Position - 0x184FA
{
...
int func_169(Hash hParam0) // Position - 0x18537
{
...
BOOL func_170(Hash hParam0) // Position - 0x1855B
{
	switch (hParam0)
	{
		case joaat("WEAPON_UNARMED"):
...
BOOL func_172() // Position - 0x18602
{
...
int _IS_EXCLUSIVE_CONTENT_UNLOCKED() // Position - 0x18634
{
	int profileSetting;
...
BOOL func_175(BOOL bParam0, BOOL bParam1) // Position - 0x186EC
{
	if (bParam0)
...
BOOL IS_PLAYSTATION_PLATFORM() // Position - 0x18755
{
	return MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION();
}

void func_177(Hash hParam0, var uParam1, int iParam2, int iParam3) // Position - 0x1876B
{
	var unk;
	var unk5;
	float num;
...
void func_178(int iParam0, var uParam1) // Position - 0x18A8C
{
	uParam1->f_276 = iParam0;
	return;
}

void func_179(int iParam0, Hash hParam1, var uParam2) // Position - 0x18A9B
{
	uParam2->f_85[iParam0] = hParam1;
	return;
}

void func_180(int iParam0, var uParam1, var uParam2) // Position - 0x18AAD
{
	uParam2->f_205[iParam0] = uParam1;
	return;
}

void func_181(int iParam0, var uParam1, var uParam2) // Position - 0x18ABF
{
	uParam2->f_155[iParam0] = uParam1;
	return;
}

void func_182(int iParam0, float fParam1, var uParam2) // Position - 0x18AD1
{
	uParam2->f_135[iParam0] = fParam1;
	return;
}

void func_183(int iParam0, int iParam1, var uParam2) // Position - 0x18AE3
{
	uParam2->f_125[iParam0] = iParam1;
	return;
}

void func_184(int iParam0, float fParam1, var uParam2) // Position - 0x18AF5
{
	uParam2->f_115[iParam0] = fParam1;
	return;
}

void func_185(int iParam0, int iParam1, var uParam2) // Position - 0x18B07
{
	uParam2->f_95[iParam0] = iParam1;
	return;
}

void func_186(int iParam0, int iParam1, var uParam2) // Position - 0x18B19
{
	uParam2->f_105[iParam0] = iParam1;
	return;
}

void func_187(int iParam0, var uParam1, var uParam2) // Position - 0x18B2B
{
	uParam2->f_215[iParam0] = uParam1;
	return;
}

void func_188(int iParam0, int iParam1, var uParam2) // Position - 0x18B3D
{
	uParam2->f_165[iParam0] = iParam1;
	return;
}

void func_189(int iParam0, var uParam1, var uParam2) // Position - 0x18B4F
{
	uParam2->f_235[iParam0] = uParam1;
	return;
}

void func_190(int iParam0, int iParam1, var uParam2) // Position - 0x18B61
{
	uParam2->f_175[iParam0] = iParam1;
	return;
}

void func_191(int iParam0, var uParam1, var uParam2) // Position - 0x18B73
{
	uParam2->f_225[iParam0] = uParam1;
	return;
}

void func_192(int iParam0, int iParam1, var uParam2) // Position - 0x18B85
{
	uParam2->f_185[iParam0] = iParam1;
	return;
}

void func_193(int iParam0, int iParam1, var uParam2) // Position - 0x18B97
{
	uParam2->f_195[iParam0] = iParam1;
	return;
}

void func_194(int iParam0, var uParam1, var uParam2) // Position - 0x18BA9
{
	uParam2->f_145[iParam0] = uParam1;
	return;
}

void func_195(int iParam0, char* sParam1, char* sParam2, var uParam3) // Position - 0x18BBB
{
...
int func_196(Hash hParam0) // Position - 0x18BDB
{
	switch (hParam0)
	{
		case joaat("WEAPON_PISTOL"):
...
BOOL func_197(Hash hParam0) // Position - 0x18D39
{
	switch (hParam0)
	{
		case joaat("COMPONENT_PISTOL_CLIP_02"):
...
int func_198(Hash hParam0) // Position - 0x18F03
{
	switch (hParam0)
	{
		case joaat("WEAPON_SMG"):
...
BOOL func_199(Hash hParam0) // Position - 0x18F90
{
	switch (hParam0)
	{
		case joaat("COMPONENT_ASSAULTRIFLE_CLIP_03"):
...
float func_200(int iParam0, int iParam1) // Position - 0x19008
{
	switch (iParam0)
	{
		case joaat("WEAPON_PISTOL"):
		...
		case joaat("WEAPON_AUTOSHOTGUN"):
			return SYSTEM::TO_FLOAT(func_32(13673, iParam1)) / SYSTEM::TO_FLOAT(func_32(&func_41, iParam1));
...
int func_201(int iParam0, int iParam1) // Position - 0x19DAC
{
	switch (iParam0)
	{
		case joaat("WEAPON_PISTOL"):
...
int func_202(int iParam0, int iParam1) // Position - 0x1A2DC
{
	switch (iParam0)
	{
		case joaat("WEAPON_PISTOL"):
		...
		case joaat("WEAPON_AUTOSHOTGUN"):
			return func_32(&func_41, iParam1);
...
int func_203(int iParam0, int iParam1) // Position - 0x1AA21
{
	switch (iParam0)
	{
		case joaat("WEAPON_PISTOL"):
...
float func_204(int iParam0) // Position - 0x1B166
{
	int num;
	int num2;
	float num3;
...
BOOL func_205(int iParam0, BOOL bParam1) // Position - 0x1B76D
{
	switch (iParam0)
	{
		case joaat("WEAPON_MOLOTOV"):
...
BOOL func_206(int iParam0) // Position - 0x1B7C5
{
	switch (iParam0)
	{
		case joaat("WEAPON_KNIFE"):
...
char* func_207(Hash hParam0, BOOL bParam1) // Position - 0x1B84B
{
	var unk;
	var unk40;
	var unk79;
...
BOOL _MPPLY_STAT_GET_BOOL(Hash hParam0) // Position - 0x1BE5E
{
	Hash statHash;
	BOOL outValue;
...
BOOL func_209(Hash hParam0) // Position - 0x1BE7C
{
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		if (func_210())
...
BOOL func_210() // Position - 0x1BEBE
{
	return func_212() || func_211();
}

int func_211() // Position - 0x1BED4
{
...
int func_213() // Position - 0x1BF30
{
	return Global_1574927;
}

BOOL func_214(int iParam0, int iParam1) // Position - 0x1BF3C
{
	switch (iParam0)
	{
		case 5:
...
void func_215() // Position - 0x1BF74
{
	func_216(0, -1, -1, 0, false);
	return;
}

void func_216(int iParam0, int iParam1, int iParam2, char* sParam3, BOOL bParam4) // Position - 0x1BF85
{
...
void func_217(var uParam0, var uParam1) // Position - 0x1BFE2
{
	int num;
	int num2;
	int num3;
...
BOOL func_218(eControlAction ecaParam0) // Position - 0x1C03A
{
	eControlAction action;
	int num;
	int offset;
...
void func_219() // Position - 0x1C0CE
{
	iLocal_64 = 0;
	iLocal_63 = 3;
...
BOOL func_220(int iParam0) // Position - 0x1CF0B
{
	int i;
...
void func_221(int iParam0, var uParam1) // Position - 0x1CF59
{
	uParam1->f_277 = iParam0;
	return;
}

void func_222() // Position - 0x1CF68
{
	func_219();
	func_223();
...
void func_223() // Position - 0x1CF87
{
	func_224(true);
	return;
}

void func_224(BOOL bParam0) // Position - 0x1CF94
{
	if (bParam0)
...
void func_225(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, BOOL bParam5) // Position - 0x1CFB8
{
...
void func_226(var uParam0) // Position - 0x1CFFB
{
	uParam0->f_284 = 1;
	return;
}

void func_227(var uParam0) // Position - 0x1D009
{
	uParam0->f_283 = 1;
	return;
}

void func_228(var uParam0) // Position - 0x1D017
{
	func_229(uParam0);
	uParam0->f_281 = 1;
	return;
...
void func_229(var uParam0) // Position - 0x1D02B
{
	*uParam0 = { Global_1671640 };
	return;
}

int func_230() // Position - 0x1D041
{
	return Global_33298;
}
