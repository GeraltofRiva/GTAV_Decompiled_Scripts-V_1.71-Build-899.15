...
void main() // Position - 0x0
{
	...
	while (!Global_64517)
	{
		if (Global_76618 > 0)
		{
			...
			else if (MISC::GET_GAME_TIMER() - Global_64551 > 1000)
				func_106();
		}
	...
	while (!flag2)
	{
		...
		if (Global_64517 && !Global_64524)
		{
			if (Global_64516 || bLocal_636)
			{
				Global_64521 = 0;
				...
				if (!(bLocal_635 == Global_64517))
				{
					...
					for (i = 0; i < Global_76618; i = i + 1)
					{
						if (Global_76619[i /*9*/] > 0)
							if (Global_64748[Global_76619[i /*9*/] /*13*/] == 4)
								if (!Global_64748[Global_76619[i /*9*/] /*13*/].f_7)
									if (Global_64748[Global_76619[i /*9*/] /*13*/].f_3)
										if (Global_76619[i /*9*/].f_1 == 0)
											Global_76619[i /*9*/].f_3 = 5;
					}
				
					flag3 = false;
				
					if (Global_80029 && !Global_64513 || Global_64525)
						flag3 = true;
					...
					if (Global_64526)
					{
						func_98(Global_64527);
						value = 2;
						func_97(&uLocal_43, "HISHPA", &Global_64538, 0);
					
						if (num == 69 || num == 70)
							func_96(&uLocal_43, 5, "ACTATAKE_AG", "", Global_114370.f_1.f_126[Global_64527 /*23*/], 0, 0, 0);
						else
							func_96(&uLocal_43, 5, "POTATAKE", "", Global_114370.f_1.f_126[Global_64527 /*23*/], 0, 0, 0);
					
						j = 0;
					
						for (j = 0; j < Global_98122[Global_64527 /*38*/].f_37; j = j + 1)
						{
							if (Global_98122[Global_64527 /*38*/].f_31[j] > 0)
								func_96(&uLocal_43, 5, AUDIO_SPEECH_GET_PARAM_STRING_FROM_ENUM_0(Global_98122[Global_64527 /*38*/].f_25[j]), "", -1 * Global_98122[Global_64527 /*38*/].f_31[j], 0, 0, 0);
						}
					
						if (Global_114370.f_1.f_126[Global_64527 /*23*/].f_2[0] > 0 || num == 74 || num == 75 || num == 69 || num == 70)
							func_96(&uLocal_43, 5, "ACTATAKE_M", "", Global_114370.f_1.f_126[Global_64527 /*23*/].f_2[0], 0, 0, 0);
					
						if (Global_114370.f_1.f_126[Global_64527 /*23*/].f_2[1] > 0 || num == 74 || num == 75)
							func_96(&uLocal_43, 5, "ACTATAKE_F", "", Global_114370.f_1.f_126[Global_64527 /*23*/].f_2[1], 0, 0, 0);
					
						if (Global_114370.f_1.f_126[Global_64527 /*23*/].f_2[2] > 0 || num == 74 || num == 75)
							func_96(&uLocal_43, 5, "ACTATAKE_T", "", Global_114370.f_1.f_126[Global_64527 /*23*/].f_2[2], 0, 0, 0);
					
						if (Global_98112.f_7 > 0)
							func_96(&uLocal_43, 5, "ACTATAKE_L", "", Global_98112.f_7, 0, 0, 0);
					
						num2 = func_93(func_94(Global_64527));
						num3 = 0;
						value2 = 0;
					
						for (j = 0; j < Global_97921[num2 /*19*/]; j = j + 1)
						{
							if (!func_92(Global_114370.f_1.f_12[num2 /*6*/][j]))
								num3 = num3 + Global_114370.f_1.f_126[Global_64527 /*23*/].f_17[j];
							else
								value2 = value2 + Global_114370.f_1.f_126[Global_64527 /*23*/].f_17[j];
						}
					...
					{
						func_97(&uLocal_43, "MISHPA", &Global_64538, 0);
					}
				...
				if (bLocal_637 && !Global_64524)
				{
					if (SCRIPT::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(joaat("appcamera")) > 0)
						func_58(0);
				
					if (Global_76618 > 0 || Global_64513)
					{
						if (Global_64543)
							GRAPHICS::SET_SCRIPT_GFX_DRAW_ORDER(7);
					
						if (flag && !Global_64513)
							Global_45356 = 1;
				...
				else
				{
					...
					if (func_105() || func_9() || Global_64524 || Global_80039 || Global_64525 || !bLocal_637)
					{
						Global_64513 = false;
						Global_64517 = false;
						bLocal_636 = false;
...
{
	Global_64542 = false;
	Global_64546 = func_7(joaat("SP0_SHOTS"));
	Global_64545 = func_7(joaat("SP0_HITS"));
	Global_64548 = func_7(joaat("SP1_SHOTS"));
	Global_64547 = func_7(joaat("SP1_HITS"));
	Global_64550 = func_7(joaat("SP2_SHOTS"));
	Global_64549 = func_7(joaat("SP2_HITS"));
	return;
}
...
float func_27(float fParam0) // Position - 0x234F
{
	return fParam0 * 0.00078125f;
}

void func_28(const char* sParam0, const char* sParam1, float fParam2, float fParam3, BOOL bParam4, int iParam5) // Position - 0x235F
{
...
void func_29(const char* sParam0, float fParam1, float fParam2, BOOL bParam3, BOOL bParam4, int iParam5) // Position - 0x238C
{
...
int func_30(int iParam0, BOOL bParam1, BOOL bParam2, var uParam3, var uParam4, BOOL bParam5) // Position - 0x23C9
{
	var textureDict;
	var textureName;
	int num;
...
float func_31(int iParam0) // Position - 0x24F5
{
	switch (iParam0)
	{
		case 34:
...
void func_32(BOOL bParam0, int* piParam1, int* piParam2, var uParam3) // Position - 0x25CF
{
	float num;
	float value;
	float aspectRatio;
...
BOOL func_33(int iParam0, int iParam1) // Position - 0x2657
{
	return SYSTEM::TO_FLOAT(iParam0) / SYSTEM::TO_FLOAT(iParam1) > 3.5f;
}

char* func_34(int iParam0, BOOL bParam1) // Position - 0x2672
{
	var unk;
	var txdName;
	var netHandle;
	...
	if (!MISC::IS_STRING_NULL_OR_EMPTY(&Global_24148.f_7696[iParam0 /*16*/]))
	{
		...
		{
			return func_35(&Global_24148.f_7696[iParam0 /*16*/]);
		}
	}
...
char* func_35(const char* sParam0) // Position - 0x2BA0
{
	return sParam0;
}

struct<13> GET_GAMER_HANDLE_PLAYER(Player plParam0) // Position - 0x2BAA
{
	var gamerHandle;
...
char* func_37(int iParam0) // Position - 0x2BC1
{
	var txdName;
	var netHandle;
	...
	if (!MISC::IS_STRING_NULL_OR_EMPTY(&Global_24148.f_6623[iParam0 /*16*/]))
	{
		...
		{
			return func_35(&Global_24148.f_6623[iParam0 /*16*/]);
		}
	}
...
void func_38(var uParam0, int iParam1, float fParam2, float fParam3, float fParam4, int iParam5) // Position - 0x2C36
{
	int r;
	int g;
	int b;
...
void func_39(int iParam0, int iParam1, float fParam2, float fParam3, const char* sParam4, int iParam5) // Position - 0x2EC6
{
	eHudColour hudColor;
...
float func_40(float fParam0) // Position - 0x328B
{
	return fParam0 * 0.025f;
}

float func_41(float fParam0) // Position - 0x329B
{
	return fParam0 * 0.0009259259f;
}

void func_42(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13, int iParam14, int iParam15, int iParam16, int iParam17) // Position - 0x32AB
{
	int num;
	int i;
...
void func_43(int iParam0, int iParam1) // Position - 0x3408
{
	MISC::SET_BIT(&Global_1675455.f_7064[iParam0], iParam1);
	return;
}

BOOL func_44(int iParam0, int iParam1) // Position - 0x3421
{
	return IS_BIT_SET(Global_1675455.f_7064[iParam0], iParam1);
}

float func_45(const char* sParam0, const char* sParam1) // Position - 0x3437
{
...
float func_46(const char* sParam0) // Position - 0x3452
{
	HUD::BEGIN_TEXT_COMMAND_GET_SCREEN_WIDTH_OF_DISPLAY_TEXT(sParam0);
	return HUD::END_TEXT_COMMAND_GET_SCREEN_WIDTH_OF_DISPLAY_TEXT(true) / 2f;
}

void func_47() // Position - 0x3467
{
...
void func_48(const char* sParam0) // Position - 0x348F
{
	GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_PLAYER_NAME_STRING(sParam0);
	return;
}

float func_49() // Position - 0x349D
{
	float num;
...
float func_50(float fParam0) // Position - 0x34B1
{
	return fParam0 * 0.0013888889f;
}

eCharacter _GET_PLAYER_CHARACTER_FROM_PED(Ped pedParam0) // Position - 0x34C1
{
	eCharacter i;
	Hash entityModel;
...
Hash _GET_CHARACTER_MODEL(eCharacter character) // Position - 0x34FE
{
...
Hash func_53(eCharacter echParam0) // Position - 0x3523
{
	return Global_2241[echParam0 /*29*/];
}

BOOL func_54(eCharacter echParam0) // Position - 0x3532
{
	return echParam0 < CHAR_MULTIPLAYER;
}

void func_55(int iParam0) // Position - 0x353E
{
	if (func_57())
		return;
...
BOOL func_56(int iParam0) // Position - 0x3571
{
	if (iParam0 == 1)
...
BOOL func_57() // Position - 0x35C8
{
	return IS_BIT_SET(Global_1960332, 19);
}

void func_58(int iParam0) // Position - 0x35D7
{
	if (func_57())
		return;
...
void func_60(BOOL bParam0, BOOL bParam1) // Position - 0x3688
{
	if (bParam0)
	{
		if (func_56(0))
...
BOOL func_61() // Position - 0x36FC
{
	return IS_BIT_SET(Global_1960332, 5);
}

BOOL func_62() // Position - 0x370A
{
	int i;
	...
	{
		if (Global_76619[i /*9*/] > 0)
			if (Global_64748[Global_76619[i /*9*/] /*13*/].f_7 == false)
				return 1;
	}
...
void func_63(BOOL bParam0) // Position - 0x374E
{
	char* audioName;
...
eCharacter _GET_CURRENT_PLAYER_CHARACTER() // Position - 0x37C1
{
	func_65();
	return Global_114370.f_2367.f_539.f_4321;
}

void func_65() // Position - 0x37DA
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (_GET_CHARACTER_MODEL(Global_114370.f_2367.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_54(character) && !func_66(14) || Global_113318)
			{
				if (Global_114370.f_2367.f_539.f_4321 != character && func_54(Global_114370.f_2367.f_539.f_4321))
...
BOOL func_66(int iParam0) // Position - 0x38D7
{
	return Global_44392 == iParam0;
}

int func_67(var uParam0, BOOL bParam1, int iParam2) // Position - 0x38E5
{
...
void func_68(var uParam0) // Position - 0x3A84
{
	GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(uParam0->f_4, "CLEAR_ALL");
	GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
...
void func_69(var uParam0) // Position - 0x3B48
{
	float screenWidthOfDisplayText;
	int num;
	int num2;
...
void func_70(var uParam0) // Position - 0x3C50
{
	uParam0->f_547 = 1f;
	uParam0->f_546 = 0;
	uParam0->f_572 = 0f;
...
void func_71() // Position - 0x3CCF
{
	...
	for (i = 0; i < Global_76618; i = i + 1)
	{
		num3 = Global_76619[i /*9*/];
		flag = !Global_64748[num3 /*13*/].f_7;
		flag2 = Global_64748[num3 /*13*/].f_8;
		unk = Global_64748[num3 /*13*/].f_12;
		unk2 = Global_64748[num3 /*13*/].f_9;
		flag3 = false;
		flag3 = false;
	
		if (func_76(num3, Global_76619[i /*9*/].f_1))
			flag3 = true;
	...
	{
		if (Global_76768 == false)
		{
			num6 = Global_76769;
		
			if (num6 == 90)
			{
				if (Global_114370.f_9089.f_99.f_205[func_75(0)] == 2)
				{
					num7.f_2.f_1 = 4;
					num7 = 716;
					STATS::LEADERBOARDS2_WRITE_DATA(&num7);
					STATS::LEADERBOARDS_WRITE_ADD_COLUMN(131, Global_76764, 0f);
					STATS::LEADERBOARDS_WRITE_ADD_COLUMN(162, Global_76765, 0f);
					STATS::LEADERBOARDS_WRITE_ADD_COLUMN(126, 1, 0f);
					STATS::LEADERBOARDS_WRITE_ADD_COLUMN(161, Global_76767, 0f);
			...
			Global_114370.f_9089.f_330[num6 /*6*/].f_4 = Global_76764;
		}
		else
		{
			func_72(Global_76769);
		}
	}
...
void func_72(int iParam0) // Position - 0x420B
{
	int num;
...
void func_73(int iParam0) // Position - 0x421B
{
	int num;
	var gamerHandle;
	var clanDesc;
...
int func_74(int iParam0) // Position - 0xB932
{
	int i;
	int num;
	...
	switch (iParam0)
	{
		...
		case 676:
			for (i = 0; i < 5; i = i + 1)
			{
				if (Global_114370.f_1.f_126[Global_64527 /*23*/].f_11[i] == 1)
					num = num + Global_114370.f_1.f_126[Global_64527 /*23*/].f_17[i];
			}
	...
	for (i = 0; i < Global_76618; i = i + 1)
	{
		if (Global_76619[i /*9*/] == iParam0)
			return Global_76619[i /*9*/].f_1;
	}

	return 0;
}

int func_75(int iParam0) // Position - 0xB9CC
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_76(int iParam0, int iParam1) // Position - 0xBA21
{
	if (iParam1 < 0)
		return false;

	switch (Global_64748[iParam0 /*13*/])
	{
		case 1:
		case 2:
		case 4:
	...
	if (iParam0 == 881 || iParam0 == 889 || iParam0 == 897 && Global_114370.f_24908[4 /*4*/] == _GET_CURRENT_PLAYER_CHARACTER())
		Global_64748[iParam0 /*13*/].f_2 = 0;

	if (Global_64748[iParam0 /*13*/].f_3)
		if (iParam1 < Global_64748[iParam0 /*13*/].f_2)
			return true;
	else if (iParam1 >= Global_64748[iParam0 /*13*/].f_2)
		return true;

	return false;
}

void func_77(var uParam0) // Position - 0xBAEB
{
	int i;
	int value;
	BOOL flag;
	...
	for (i = 0; i < Global_76618; i = i + 1)
	{
		...
		switch (Global_76619[i /*9*/])
		{
			...
			case 41:
			case 54:
				value = Global_76619[i /*9*/].f_1;
				break;
		}
	}

	Global_76767 = iLocal_625;
	value2 = func_83(uParam0, iLocal_625, iLocal_626, flag);

	if (_IS_MISSION_REPEAT_ACTIVE(false))
	{
		MISC::ADD_REPLAY_STAT_VALUE(Global_76769);
...
void func_78(float fParam0, BOOL bParam1) // Position - 0xBC5E
{
	float num;
	int num2;
	int num3;
	...
	if (Global_76768)
	{
		...
		if (num < 100f)
			if (fParam0 >= 100f)
				Global_114370.f_10020.f_22 = Global_114370.f_10020.f_22 + 1;
	
		if (fParam0 >= num)
			func_81(num2, fParam0, bParam1);
	}
	else if (Global_76769 == -1)
	{
	}
	else
	{
...
void func_79(int iParam0, float fParam1, BOOL bParam2) // Position - 0xBD0F
{
	if (bParam2)
		Global_114370.f_9089.f_330[iParam0 /*6*/].f_5 = 50f;
	else
		Global_114370.f_9089.f_330[iParam0 /*6*/].f_5 = fParam1;

	Global_33308 = 1;
	return;
}

float func_80(int iParam0) // Position - 0xBD4A
{
	return Global_114370.f_9089.f_330[iParam0 /*6*/].f_5;
}

void func_81(int iParam0, float fParam1, BOOL bParam2) // Position - 0xBD62
{
	if (bParam2)
		Global_114370.f_18578[iParam0 /*6*/].f_5 = 50f;
	else
		Global_114370.f_18578[iParam0 /*6*/].f_5 = fParam1;

	Global_33308 = 1;
	return;
}

float func_82(int iParam0) // Position - 0xBD97
{
	return Global_114370.f_18578[iParam0 /*6*/].f_5;
}

float func_83(var uParam0, int iParam1, int iParam2, BOOL bParam3) // Position - 0xBDAC
{
	float value;
	int num;
	int num2;
...
int func_84(int iParam0) // Position - 0xBE8E
{
	int num;
...
void func_85(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7) // Position - 0xBECA
{
...
int func_86(float fParam0) // Position - 0xBF0F
{
	if (fParam0 == 0f)
		return 0;
...
float func_87(int iParam0, int iParam1, BOOL bParam2) // Position - 0xBF44
{
	float num;
	float value;
...
BOOL func_88(var uParam0, int iParam1) // Position - 0xBFA3
{
	float num;
	float num2;
	int num3;
	...
	num3 = { Global_64748[Global_76619[iParam1 /*9*/] /*13*/] };

	if (num3 == 15)
		Global_76619[iParam1 /*9*/].f_1 = iLocal_633;

	if (num3 == 9)
		Global_76619[iParam1 /*9*/].f_2 = fLocal_632;

	if (num3 == 14)
		Global_76619[iParam1 /*9*/].f_1 = SYSTEM::FLOOR(Global_76619[iParam1 /*9*/].f_2);

	if (func_76(Global_76619[iParam1 /*9*/], Global_76619[iParam1 /*9*/].f_1))
		num = 1f;

	if (Global_76619[iParam1 /*9*/].f_3 != 0)
		num = 0f;

	if (!(num3.f_2 == 0))
	{
		num2 = SYSTEM::TO_FLOAT(SYSTEM::FLOOR((SYSTEM::TO_FLOAT(Global_76619[iParam1 /*9*/].f_1) / SYSTEM::TO_FLOAT(num3.f_2)) * 100f));
	...
	if (Global_76619[iParam1 /*9*/].f_3 == 0 || flag)
		if (num3.f_3)
			if (num4 > Global_76619[iParam1 /*9*/].f_1 || num4 < 0 || num4 == -1)
				func_90(Global_76619[iParam1 /*9*/].f_1, Global_76619[iParam1 /*9*/]);
		else if (Global_76619[iParam1 /*9*/].f_1 > num4 || num4 < 0 || num4 == -1)
			func_90(Global_76619[iParam1 /*9*/].f_1, Global_76619[iParam1 /*9*/]);

	num5 = Global_76619[iParam1 /*9*/].f_1;
	...
	str = AUDIO_SPEECH_GET_PARAM_STRING_FROM_ENUM(Global_76619[iParam1 /*9*/]);

	if (Global_76619[iParam1 /*9*/].f_3 != 0)
	{
		if (!_IS_MISSION_REPEAT_ACTIVE(false))
			func_90(-1, Global_76619[iParam1 /*9*/]);
	
		str2 = "MTPHPERRET" /*Checkpoint*/;
	
		switch (Global_76619[iParam1 /*9*/].f_3)
		{
			case 4:
		...
		if (iLocal_630 == Global_76619[iParam1 /*9*/].f_3)
			str2 = "";
	
		iLocal_630 = Global_76619[iParam1 /*9*/].f_3;
		func_96(uParam0, 8, str, str2, Global_76619[iParam1 /*9*/].f_1, 0, 3, 0);
	}
	else
	{
		iLocal_630 = 0;
		...
		{
			case 1:
				func_96(uParam0, 10, str, "", Global_76619[iParam1 /*9*/].f_1, 0, num6, 0);
				break;
		
			case 2:
				func_96(uParam0, 11, str, "", Global_76619[iParam1 /*9*/].f_1, 0, num6, 0);
				break;
		
			case 3:
				func_96(uParam0, 0, str, "", Global_76619[iParam1 /*9*/].f_1, 0, num6, 0);
				break;
			...
			case 5:
				func_96(uParam0, 13, str, "", SYSTEM::CEIL((SYSTEM::TO_FLOAT(Global_76619[iParam1 /*9*/].f_1) / SYSTEM::TO_FLOAT(num3.f_2)) * 100f), 0, num6, 0);
				break;
			...
			case 8:
				num7 = Global_76619[iParam1 /*9*/].f_1;
			...
			case 9:
				func_96(uParam0, 13, str, "", SYSTEM::ROUND(Global_76619[iParam1 /*9*/].f_2), 0, num6, 0);
				break;
		
			case 10:
			case 15:
			case 16:
				func_96(uParam0, 1, str, "", Global_76619[iParam1 /*9*/].f_1, 0, num6, 0);
				break;
		
			case 11:
				func_96(uParam0, 13, str, "", Global_76619[iParam1 /*9*/].f_1, 0, num6, 0);
				break;
		
			case 14:
				func_96(uParam0, 14, str, "", Global_76619[iParam1 /*9*/].f_1, 0, num6, 0);
				break;
		
			case 12:
			case 13:
				func_96(uParam0, 5, str, "", Global_76619[iParam1 /*9*/].f_1, 0, num6, 0);
				break;
...
char* AUDIO_SPEECH_GET_PARAM_STRING_FROM_ENUM(int iParam0) // Position - 0xC4A6
{
	switch (iParam0)
	{
		case 0:
...
void func_90(int iParam0, int iParam1) // Position - 0xD657
{
	Hash statName;
	int value;

	statName = Global_64748[iParam1 /*13*/].f_4;

	if (statName == 0)
		return;

	Global_64748[iParam1 /*13*/].f_1 = iParam0;
	value = iParam0 + 1;
	STATS::STAT_SET_INT(statName, value, true);

	if (_IS_MISSION_REPEAT_ACTIVE(false) && Global_64515)
	{
...
int func_91(Hash hParam0) // Position - 0xD6B0
{
	int outValue;
...
BOOL func_92(int iParam0) // Position - 0xD6D9
{
	return IS_BIT_SET(Global_114370.f_1.f_118, iParam0);
}

int func_93(int iParam0) // Position - 0xD6EC
{
...
int func_94(int iParam0) // Position - 0xD719
{
	int num;
...
char* AUDIO_SPEECH_GET_PARAM_STRING_FROM_ENUM_0(int iParam0) // Position - 0xD76A
{
	switch (iParam0)
	{
		case 1:
...
void func_96(var uParam0, int iParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6, int iParam7) // Position - 0xD7D8
{
	int num;
...
void func_97(var uParam0, char* sParam1, char* sParam2, int iParam3) // Position - 0xD84B
{
...
void func_98(int iParam0) // Position - 0xD86E
{
	int num;
	int num2;
	int i;
	...
	for (i = 0; i < Global_98122[iParam0 /*38*/].f_37; i = i + 1)
	{
		if (Global_98122[iParam0 /*38*/].f_31[i] > 0)
		{
			num3 = num3 + Global_98122[iParam0 /*38*/].f_31[i];
			Global_114370.f_1.f_126[iParam0 /*23*/].f_1 = Global_114370.f_1.f_126[iParam0 /*23*/].f_1 - Global_98122[iParam0 /*38*/].f_31[i];
		}
	}
	...
	for (i = 0; i < 5; i = i + 1)
	{
		...
		switch (Global_114370.f_1.f_126[iParam0 /*23*/].f_11[i])
		{
			...
			case 2:
			case 0:
				Global_114370.f_1.f_126[iParam0 /*23*/].f_17[i] = SYSTEM::CEIL(SYSTEM::TO_FLOAT(Global_97767[num5 /*5*/].f_1) * 0.01f * (float)Global_114370.f_1.f_126[iParam0 /*23*/].f_1);
				break;
		
			case 3:
				Global_114370.f_1.f_126[iParam0 /*23*/].f_17[i] = SYSTEM::CEIL(SYSTEM::TO_FLOAT(Global_97767[num5 /*5*/].f_1) * 0.015f * (float)Global_114370.f_1.f_126[iParam0 /*23*/].f_1);
				break;
		}
	}
	...
	switch (iParam0)
	{
		case 0:
			...
			Global_98112.f_7 = SYSTEM::CEIL(0.14f * (float)Global_114370.f_1.f_126[iParam0 /*23*/].f_1);
			num2 = num2 - Global_98112.f_7;
			Global_98112.f_6 = 14f;
		...
		case 2:
			...
			Global_98112.f_7 = SYSTEM::CEIL(0.12f * (float)Global_114370.f_1.f_126[iParam0 /*23*/].f_1);
			num2 = num2 - Global_98112.f_7;
			Global_98112.f_6 = 12f;
	...
	if (Global_98112.f_6 != -1f)
		Global_98112.f_6 = (SYSTEM::TO_FLOAT(Global_98112.f_7) / SYSTEM::TO_FLOAT(value)) * 100f;
...
void func_99(int iParam0, int iParam1, BOOL bParam2) // Position - 0xE16F
{
	int i;
...
void func_100(int iParam0, int iParam1, int iParam2) // Position - 0xE219
{
	int num;
	BOOL flag;
	int num2;
	...
	if (Global_98122[iParam0 /*38*/].f_37 == 5)
		flag = true;

	num2 = Global_98122[iParam0 /*38*/].f_37;
	i = 0;

	for (i = 0; i < num2; i = i + 1)
	{
		if (Global_98122[iParam0 /*38*/].f_25[i] == iParam1)
		{
			Global_98122[iParam0 /*38*/].f_25[i] = iParam1;
			Global_98122[iParam0 /*38*/].f_31[i] = num;
			return;
		}
	}
	...
	Global_98122[iParam0 /*38*/].f_25[Global_98122[iParam0 /*38*/].f_37] = iParam1;
	Global_98122[iParam0 /*38*/].f_31[Global_98122[iParam0 /*38*/].f_37] = num;
	Global_98122[iParam0 /*38*/].f_37 = Global_98122[iParam0 /*38*/].f_37 + 1;
	return;
}

BOOL _IS_MISSION_REPEAT_ACTIVE(BOOL bExcludeBenchmark) // Position - 0xE3D1
{
...
void func_102() // Position - 0xE3F9
{
	...
	{
		if (Global_76619[i /*9*/].f_1 == 0)
			if (Global_76619[i /*9*/].f_2 != 0f)
				Global_76619[i /*9*/].f_1 = SYSTEM::FLOOR(Global_76619[i /*9*/].f_2);
	
		num = Global_76619[i /*9*/];
	
		if (num > 0)
		{
			if (Global_64748[num /*13*/] == 9)
				Global_76619[i /*9*/].f_1 = SYSTEM::ROUND(fLocal_632);
		
			if (Global_64748[num /*13*/] == 15)
				Global_76619[i /*9*/].f_1 = iLocal_633;
		}
	}
...
void func_103() // Position - 0xE4A0
{
	...
	value = 0;
	value2 = 0;
	value = func_7(joaat("SP0_SHOTS")) - Global_64546;
	value2 = func_7(joaat("SP0_HITS")) - Global_64545;
	value = value + (func_7(joaat("SP1_SHOTS")) - Global_64548);
	value2 = value2 + (func_7(joaat("SP1_HITS")) - Global_64547);
	value = value + (func_7(joaat("SP2_SHOTS")) - Global_64550);
	value2 = value2 + (func_7(joaat("SP2_HITS")) - Global_64549);
	SYSTEM::WAIT(0);
	num = 100f;
...
void func_104(var uParam0) // Position - 0xE576
{
	func_70(uParam0);
	uParam0->f_574 = 0;
	uParam0->f_31 = 0;
...
void func_106() // Position - 0xE5BC
{
	int i;

	if (Global_33548 == 0 && !Global_33552)
		return;
	...
	for (i = 0; i < Global_76618; i = i + 1)
	{
		Global_76619[i /*9*/].f_3 = 4;
	}

	return;
}

void func_107() // Position - 0xE5FB
{
	BOOL flag;
	BOOL flag2;
	int i;
	...
	if (Global_64529 && PLAYER::IS_PLAYER_PLAYING(PLAYER::GET_PLAYER_INDEX()) && !CUTSCENE::IS_CUTSCENE_ACTIVE() && !HUD::IS_PAUSE_MENU_ACTIVE())
		Global_64529 = false;
	...
	for (i = 0; i < Global_76618; i = i + 1)
	{
		if (Global_76619[i /*9*/] >= 0)
		{
			num = Global_64748[Global_76619[i /*9*/] /*13*/];
		
			switch (num)
			{
				case 6:
					if (Global_76619[i /*9*/].f_6 != 0)
					{
						if (Global_76619[i /*9*/].f_7 == 1)
						{
							Global_76619[i /*9*/].f_8 = 0;
							Global_76619[i /*9*/].f_1 = 0;
							Global_76619[i /*9*/].f_7 = 0;
						}
						else if (ENTITY::DOES_ENTITY_EXIST(Global_76619[i /*9*/].f_6))
						{
							if (!ENTITY::IS_ENTITY_DEAD(Global_76619[i /*9*/].f_6, false))
							{
								iLocal_628 = Global_76619[i /*9*/].f_8;
								iLocal_627 = ENTITY::GET_ENTITY_HEALTH(Global_76619[i /*9*/].f_6);
								iLocal_629 = iLocal_628 - iLocal_627;
							
								if (iLocal_629 > 0)
								{
									Global_76619[i /*9*/].f_1 = Global_76619[i /*9*/].f_1 + iLocal_629;
								
									if (Global_76619[i /*9*/].f_1 < 0)
										Global_76619[i /*9*/].f_1 = Global_76619[i /*9*/].f_1 * -1;
								}
							
								Global_76619[i /*9*/].f_8 = iLocal_627;
							}
						}
						else
						{
							Global_76619[i /*9*/].f_6 = 0;
						}
					}
					break;
			
				case 1:
					Global_76619[i /*9*/].f_1 = Global_76619[i /*9*/].f_1 + iLocal_624;
					break;
				...
				case 4:
					if (Global_64531)
						if (Global_64533 == -1 || Global_76619[i /*9*/] == Global_64533)
							if (Global_76619[i /*9*/] == 339 || Global_76619[i /*9*/] == 179 || Global_76619[i /*9*/] == 342 || Global_76619[i /*9*/] == 234)
								Global_76619[i /*9*/].f_1 = Global_76619[i /*9*/].f_1 + SYSTEM::ROUND(MISC::GET_FRAME_TIME() * 1000f);
							else
								Global_76619[i /*9*/].f_1 = Global_76619[i /*9*/].f_1 + iLocal_624;
					break;
				...
				case 5:
					if (flag2)
					{
						if (Global_64535 == -1 || Global_64535 == Global_76619[i /*9*/])
						{
							if (!(Global_64534 == 0))
							{
								if (ENTITY::DOES_ENTITY_EXIST(Global_64534))
								{
									if (!ENTITY::IS_ENTITY_DEAD(Global_64534, false))
									{
										if (ENTITY::IS_ENTITY_A_VEHICLE(Global_64534))
										{
											entitySpeed = ENTITY::GET_ENTITY_SPEED(Global_64534);
										
											if (entitySpeed > Global_76619[i /*9*/].f_2)
												Global_76619[i /*9*/].f_2 = entitySpeed;
										}
									}
								}
							}
...
void func_108() // Position - 0xE9D6
{
	...
	if (Global_76814 == 0 && Global_76804 == 0 && Global_64682 == 0 && Global_64552 == 0 && !Global_76770)
		return;
	...
	if (Global_64552 > 0)
	{
		...
		for (i = 0; i < 64; i = i + 1)
		{
			...
			{
				if (!ENTITY::DOES_ENTITY_EXIST(Global_64553[i /*2*/]))
				{
					Global_64553[i /*2*/] = 0;
			...
			case EVENT_ENTITY_DESTROYED:
				...
				if (ENTITY::DOES_ENTITY_EXIST(eventData))
				{
					...
					if (Global_64682 > 0)
					{
						...
						for (j = 0; j < Global_64682; j = j + 1)
						{
							if (Global_64683[j /*2*/] == entityModel)
								num2 = num2 + Global_64683[j /*2*/].f_1;
						}
					}
						...
						if (ENTITY::IS_ENTITY_A_PED(pedSourceOfDeath) && PLAYER::GET_PLAYER_PED(PLAYER::GET_PLAYER_INDEX()) == ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(pedSourceOfDeath) || flag2)
						{
							if (ENTITY::IS_ENTITY_A_PED(pedSourceOfDeath))
							{
								...
								if (Global_64552 > 0)
								{
									...
									if (num3 != -1)
									{
										PED::GET_PED_LAST_DAMAGE_BONE(ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(Global_64553[num3 /*2*/]), &iLocal_631);
								...
								if (Global_76814 > 0)
								{
									...
									for (j = 0; j < Global_76814; j = j + 1)
									{
										if (Global_76805[j /*2*/] == pedCauseOfDeath)
											func_99(Global_76805[j /*2*/].f_1, 1, false);
									}
								}
							}
							...
							if (Global_76804 > 0)
							{
								...
								while (!flag)
								{
									if (Global_76771[j /*2*/] != 0)
									{
										if (ENTITY::DOES_ENTITY_EXIST(Global_76771[j /*2*/]))
										{
											if (ENTITY::IS_ENTITY_DEAD(Global_76771[j /*2*/], false))
											{
												if (Global_76771[j /*2*/] == eventData)
												{
													func_99(Global_76771[j /*2*/].f_1, 1, false);
													Global_76771[j /*2*/] = 0;
												}
											}
										}
								...
								if (Global_76804 > 0)
								{
									while (Global_76771[Global_76804 - 1 /*2*/] == 0 && Global_76804 > 1)
									{
										if (Global_76804 > 1)
...
void func_109(int iParam0) // Position - 0xEDDF
{
	int i;
	int num;
...
int func_112(Entity eParam0) // Position - 0xEED6
{
	int i;
		...
		if (MISC::GET_REPLAY_STAT_MISSION_ID() == 33)
		{
			if (MISC::GET_REPLAY_STAT_MISSION_TYPE() == 33)
			{
				...
				if ((replayStatCount - 4) % 3 == 0)
				{
					...
					Global_76768 = flag2;
					Global_76769 = replayStatAtIndex3;
		...
		if (MISC::GET_REPLAY_STAT_MISSION_ID() == 13)
		{
			if (MISC::GET_REPLAY_STAT_MISSION_TYPE() == 37)
			{
				...
				if (replayStatCount2 == 3)
				{
					...
					Global_114370.f_2356[replayStatAtIndex5 /*2*/] = replayStatAtIndex6;
					Global_114370.f_2356[replayStatAtIndex5 /*2*/].f_1 = replayStatAtIndex7;
					func_114();
				}
			}
		}
