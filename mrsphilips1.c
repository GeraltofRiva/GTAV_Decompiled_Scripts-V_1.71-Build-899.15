...
BOOL func_74(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x875E
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
BOOL func_75(int iParam0) // Position - 0x9601
{
	if (!IS_BIT_SET(Global_79551[1 /*14*/].f_6, 0))
		return false;
...
BOOL func_76(Ped pedParam0, Hash hParam1, var uParam2, int iParam3) // Position - 0x9649
{
	int num;
...
ePedComponentType func_77(int iParam0) // Position - 0x96F4
{
	switch (iParam0)
	{
		case 0:
...
struct<10> func_78(Hash hParam0, int iParam1) // Position - 0x97A4
{
	int i;
	var unk;
...
void func_79(var uParam0, Hash hParam1, int iParam2, int iParam3) // Position - 0xA0D3
{
	int num;
	Hash itemHash;
	Hash outPropVariant;
...
void func_80(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9) // Position - 0xA1FD
{
	uParam0->[0] = iParam1;
	uParam0->[1] = iParam2;
	uParam0->[2] = iParam3;
...
struct<17> func_81(Hash hParam0, int iParam1) // Position - 0xA245
{
	int i;
	var unk;
...
void func_82(var uParam0, Hash hParam1, int iParam2, int iParam3) // Position - 0xC08E
{
	int num;
	Hash outfit;
...
int func_83(int iParam0) // Position - 0xC278
{
	switch (iParam0)
	{
		case 0:
...
void func_84(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Position - 0xC328
{
	uParam0->[0] = iParam1;
	uParam0->[2] = iParam2;
	uParam0->[3] = iParam3;
...
struct<14> func_85(Hash hParam0, int iParam1, int iParam2, int iParam3) // Position - 0xC399
{
	func_149();
...
void func_86(int iParam0, int iParam1) // Position - 0xC3EB
{
	switch (iParam0)
	{
		case 0:
...
void func_87(int iParam0) // Position - 0xC4DB
{
	BOOL flag;
	int num;
	var unk;
...
void func_88(int iParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, BOOL bParam7, int iParam8, int iParam9, BOOL bParam10) // Position - 0xD708
{
	int num;
	int num2;
...
BOOL func_89(int iParam0, int iParam1, var uParam2) // Position - 0xDAA9
{
	*uParam2 = 979;
...
int func_90(int iParam0, int iParam1) // Position - 0xDEAE
{
	switch (iParam1)
	{
		case 0:
...
int func_91(int iParam0, int iParam1) // Position - 0xE2A9
{
	switch (iParam1)
	{
		case 0:
...
BOOL func_92(Hash hParam0, int iParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0xE6A4
{
	int num;
	int num2;
	int num3;
...
BOOL func_93(int iParam0) // Position - 0xE6E2
{
	return Global_44392 == iParam0;
}

int func_94(int iParam0) // Position - 0xE6F0
{
	switch (iParam0)
	{
		case -1:
...
void func_95(int iParam0, int iParam1, int iParam2, Hash hParam3) // Position - 0xE7C4
{
	int num;
	int num2;
	Hash outfit;
...
void func_96(int iParam0) // Position - 0xEA4A
{
	BOOL flag;
	int num;
	var unk;
...
void func_97(int iParam0) // Position - 0xEB97
{
	BOOL flag;
	int num;
	var unk;
...
void func_98(int iParam0) // Position - 0xF0A4
{
	BOOL flag;
	int num;
	var unk;
...
void func_99(int iParam0) // Position - 0xF118
{
	BOOL flag;
	int num;
	var unk;
...
void func_100(int iParam0) // Position - 0xF18B
{
	BOOL flag;
	int num;
	var unk;
...
void func_101(int iParam0) // Position - 0xF272
{
	BOOL flag;
	int num;
	var unk;
...
void func_102(int iParam0) // Position - 0xF5B4
{
	BOOL flag;
	int num;
	var unk;
...
void func_103(int iParam0) // Position - 0xF7BC
{
	BOOL flag;
	int num;
	var unk;
...
void func_104(int iParam0) // Position - 0xF9DC
{
	BOOL flag;
	int num;
	var unk;
...
void func_105(int iParam0) // Position - 0xFAE5
{
	BOOL flag;
	int num;
	var unk;
...
void func_106(int iParam0) // Position - 0x10478
{
	BOOL flag;
	int num;
	var unk;
...
void func_107(int iParam0) // Position - 0x10FD0
{
	if (iParam0 < 136)
		func_109(iParam0);
	else
...
void func_108(int iParam0) // Position - 0x11005
{
	BOOL flag;
	int num;
	var unk;
...
void func_109(int iParam0) // Position - 0x11C09
{
	BOOL flag;
	int num;
	var unk;
...
void func_110(int iParam0) // Position - 0x12B09
{
	BOOL flag;
	int num;
	var unk;
...
void func_111(int iParam0) // Position - 0x12C36
{
	BOOL flag;
	int num;
	var unk;
...
void func_112(int iParam0, int iParam1) // Position - 0x12D2D
{
	switch (iParam0)
	{
		case 0:
...
void func_113(int iParam0) // Position - 0x12E1D
{
	BOOL flag;
	int num;
	var unk;
...
void func_114(int iParam0) // Position - 0x142EC
{
	BOOL flag;
	int num;
	var unk;
...
void func_115(int iParam0) // Position - 0x14433
{
	BOOL flag;
	int num;
	var unk;
...
void func_116(int iParam0) // Position - 0x1493D
{
	BOOL flag;
	int num;
	var unk;
...
void func_117(int iParam0) // Position - 0x14FA6
{
	BOOL flag;
	int num;
	var unk;
...
void func_118(int iParam0) // Position - 0x15019
{
	BOOL flag;
	int num;
	var unk;
...
void func_119(int iParam0) // Position - 0x150E9
{
	BOOL flag;
	int num;
	var unk;
...
void func_120(int iParam0) // Position - 0x155E4
{
	BOOL flag;
	int num;
	var unk;
...
void func_121(int iParam0) // Position - 0x15775
{
	BOOL flag;
	int num;
	var unk;
...
void func_122(int iParam0) // Position - 0x15F64
{
	BOOL flag;
	int num;
	var unk;
...
void func_123(int iParam0) // Position - 0x1606D
{
	BOOL flag;
	int num;
	var unk;
...
void func_124(int iParam0) // Position - 0x16F90
{
	BOOL flag;
	int num;
	var unk;
...
void func_125(int iParam0) // Position - 0x17C3D
{
	if (iParam0 < 107)
		func_128(iParam0);
	else if (iParam0 < 227)
...
void func_126(int iParam0) // Position - 0x17C83
{
	BOOL flag;
	int num;
	var unk;
...
void func_127(int iParam0) // Position - 0x1872A
{
	BOOL flag;
	int num;
	var unk;
...
void func_128(int iParam0) // Position - 0x19518
{
	BOOL flag;
	int num;
	var unk;
...
void func_129(int iParam0) // Position - 0x1A157
{
	BOOL flag;
	int num;
	var unk;
...
void func_130(int iParam0) // Position - 0x1A3CF
{
	BOOL flag;
	int num;
	var unk;
...
void func_131(int iParam0, int iParam1) // Position - 0x1A50B
{
	switch (iParam0)
	{
		case 0:
...
void func_132(int iParam0) // Position - 0x1A5FB
{
	BOOL flag;
	int num;
	var unk;
...
void func_133(int iParam0) // Position - 0x1B359
{
	BOOL flag;
	int num;
	var unk;
...
void func_134(int iParam0) // Position - 0x1B4C8
{
	BOOL flag;
	int num;
	var unk;
...
void func_135(int iParam0) // Position - 0x1BA39
{
	BOOL flag;
	int num;
	var unk;
...
void func_136(int iParam0) // Position - 0x1BF61
{
	BOOL flag;
	int num;
	var unk;
...
void func_137(int iParam0) // Position - 0x1BFD4
{
	BOOL flag;
	int num;
	var unk;
	...
	if (Global_80023 != 6)
	{
		...
		else
		{
			...
			if (value < 9000 && !CAM::IS_SCREEN_FADED_OUT())
			{
				...
				text = { func_241(Global_80024, Global_80026, iParam10) };
				y == -0.014f;
...
{
	if (!func_253(0) || Global_80039 || Global_80027 == 1 || !CAM::IS_SCREEN_FADED_IN())
		return false;
...
{
	return func_255(iParam0, Global_44392);
}
...
int func_276() // Position - 0x28D76
{
	...
	num = func_277(&(Global_101917.f_3), false);
	num2 = 0;
...
BOOL func_280() // Position - 0x28E4A
{
	...
	if (Global_101917.f_11 == 5)
		if (func_275(&(Global_101917.f_3)) > -1)
			return true;
