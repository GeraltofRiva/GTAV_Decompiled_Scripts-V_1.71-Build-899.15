			...
			while (iLocal_167 == 0)
			{
				...
				if (HUD::HAS_MENU_LAYOUT_CHANGED_EVENT_OCCURRED())
				{
					...
					else
					{
						...
						{
							iLocal_171 = selectedItemUniqueId;
							func_1(&uLocal_173);
						}
					}
				}
...
int func_1(var uParam0) // Position - 0x18B
{
	...
	func_77(0, iLocal_171, false, true);
	func_76(1);
	num = 0;
...
{
	func_24(1, *uParam0, iLocal_166, *uParam0, sParam1, bParam2, 1);
	*uParam0 = *uParam0 + 1;
	return;
}
...
BOOL func_29(Player plParam0, int iParam1) // Position - 0x1F5C
{
	...
	return func_30(&(Global_1845274[plParam0 /*877*/].f_816), func_31(iParam1));
}
...
void func_43(var uParam0, int iParam1, BOOL bParam2) // Position - 0x22E6
{
	...
	if (!bParam2)
	{
		func_44(1, *uParam0, iLocal_166, *uParam0, "", iParam1);
		*uParam0 = *uParam0 + 1;
	}

	str = "PAUSEUNLRANK";
	func_44(1, *uParam0, iLocal_166, *uParam0, str, iParam1);
	*uParam0 = *uParam0 + 1;
	return;
}
...
void func_45(var uParam0, BOOL bParam1) // Position - 0x2384
{
	...
	func_24(1, *uParam0, iLocal_166, *uParam0, &unk, bParam1, 0);
	*uParam0 = *uParam0 + 1;
	return;
}
...
void func_53(var uParam0, int iParam1, int iParam2, BOOL bParam3) // Position - 0x27BB
{
	...
	if (*uParam0 > num)
	{
		...
		func_55(1, *uParam0, iLocal_166, *uParam0, &unk, "PM_UGEN_NUM" /*~1~/~1~*/, iParam1, iParam2);
		*uParam0 = *uParam0 + 1;
		return;
	}
	...
	if (num == *uParam0)
	{
		...
		if (!bParam3)
			...
			func_54(1, *uParam0, iLocal_166, *uParam0, &unk, "NUMBR" /*~1~*/, iParam1);
...
int func_72(Player plParam0, BOOL bParam1) // Position - 0x34B4
{
	bParam1;
	return func_73(plParam0);
}

int func_73(Player plParam0) // Position - 0x34C7
{
...
BOOL func_74(Player plParam0) // Position - 0x351E
{
	if (!func_75(plParam0))
		return false;
...
BOOL func_75(Player plParam0) // Position - 0x353D
{
	Player player;
...
void func_76(int iParam0) // Position - 0x355F
{
...
void func_77(int iParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Position - 0x357C
{
	if (iParam1 == -1)
		return;
...
void func_78() // Position - 0x35B4
{
	...
	func_76(0);
	iLocal_171 = 0;
	func_80(0, 0, iLocal_165, 0, true, "PM_UL_D0" /*General*/, false, 0, false);
	func_80(0, 1, iLocal_165, 1, true, "PM_UL_D1" /*Progress*/, false, 0, false);
	func_80(0, 2, iLocal_165, 2, true, "PM_UL_D2" /*Content*/, false, 0, false);
	func_2(0);
	func_79(2);
	func_79(3);
	func_79(4);
...
void func_79(int iParam0) // Position - 0x3640
{
	func_3(iParam0, false);
	return;
}

void func_80(int iParam0, int iParam1, int iParam2, int iParam3, BOOL bParam4, char* sParam5, BOOL bParam6, int iParam7, BOOL bParam8) // Position - 0x364F
{
	if (GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD_ON_FRONTEND("SET_DATA_SLOT"))
	{
		GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(iParam0);
...
BOOL func_82(eControlAction ecaParam0) // Position - 0x3770
{
	eControlAction action;
	int num;
	int offset;
	...
	if (PAD::IS_CONTROL_JUST_RELEASED(FRONTEND_CONTROL, ecaParam0) || PAD::IS_DISABLED_CONTROL_JUST_RELEASED(FRONTEND_CONTROL, ecaParam0) || func_83(ecaParam0, &(Global_1673898.f_1060), 1))
	{
...
BOOL func_83(eControlAction ecaParam0, var uParam1, int iParam2) // Position - 0x3804
{
	int num;
	int num2;
	int num3;
...
void func_84() // Position - 0x3967
{
	...
	if (!PAD::IS_USING_KEYBOARD_AND_MOUSE(FRONTEND_CONTROL))
	{
		...
		if (controlValue > 180)
		{
			if (_STOPWATCH_HAS_TIME_PASSED(&uLocal_168, iLocal_170, false))
			{
				if (bLocal_172)
				{
...
void _STOPWATCH_DESTROY(var uParam0) // Position - 0x3A24
{
	uParam0->f_1 = 0;
	return;
}

BOOL _STOPWATCH_HAS_TIME_PASSED(var pStopwatch, int millis, BOOL useLocalTimer) // Position - 0x3A31
{
	if (millis == -1)
		return true;
...
void _STOPWATCH_INITIALIZE(var pStopwatch, BOOL useLocalTimer, BOOL useAccurateTime) // Position - 0x3A8F
{
	if (pStopwatch->f_1 == 0)
	{
		if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS() && !useLocalTimer)
...
BOOL IS_PLAYSTATION_PLATFORM() // Position - 0x3AD4
{
	return MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION();
}

BOOL IS_XBOX_PLATFORM() // Position - 0x3AEA
{
