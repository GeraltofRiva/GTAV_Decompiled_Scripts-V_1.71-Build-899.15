	...
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2658019[plParam0 /*467*/].f_324.f_8 != -1)
				return func_84(Global_2658019[plParam0 /*467*/].f_324.f_8) == 15;
...
void _SET_PLAYER_CONTROL_EX(Player plParam0, BOOL bParam1, eSetPlayerControlFlags espcfParam2, BOOL bParam3) // Position - 0x2799
{
		...
		if (NETWORK::NETWORK_IS_PLAYER_ACTIVE(plParam0) && PLAYER::IS_PLAYER_PLAYING(plParam0) || bParam3 == true)
		{
			...
			else
			{
				if (!func_92(playerPed) && !ENTITY::IS_ENTITY_ATTACHED_TO_ANY_VEHICLE(playerPed))
				{
					...
					if (func_89(*Global_4718592.f_197275))
...
BOOL func_89(int iParam0) // Position - 0x2C4D
{
	return iParam0 == 17;
}

void func_90() // Position - 0x2C5A
{
	var unk;
...
BOOL func_92(Ped pedParam0) // Position - 0x2CE5
{
	int scriptTaskStatus;
...
void func_93(BOOL bParam0, Ped pedParam1, int iParam2) // Position - 0x2D16
{
	int num;
	eViewModeContext i;
...
void _MPPLY_STAT_SET_BOOL(Hash hParam0, BOOL bParam1) // Position - 0x2DE6
{
	Hash statName;
...
BOOL func_96(Player plParam0) // Position - 0x2E5A
{
...
BOOL func_97() // Position - 0x2E99
{
	return IS_BIT_SET(Global_2621446, 3);
}

BOOL func_98(Player plParam0, int iParam1) // Position - 0x2EA7
{
	BOOL flag;
...
int func_99(int iParam0, BOOL bParam1) // Position - 0x2F00
{
	int num;
	int num2;
...
int func_100() // Position - 0x2F41
{
	return Global_1574927;
}

BOOL func_101(Player plParam0) // Position - 0x2F4D
{
	Player player;
...
void func_104() // Position - 0x2FD1
{
	func_105(0, &uLocal_138, 0, 3);
	func_105(1, &uLocal_138, 1, 3);
	func_105(2, &uLocal_138, 2, 3);
	func_105(3, &uLocal_138, 3, 1);
	func_105(4, &uLocal_138, 4, 1);
	func_105(5, &uLocal_138, 5, 1);
	func_105(6, &uLocal_138, 6, 1);
	func_105(7, &uLocal_138, 7, 1);
	func_105(8, &uLocal_138, 8, 1);
	func_105(9, &uLocal_138, 9, 1);
	func_105(10, &uLocal_138, 10, 1);
	func_105(11, &uLocal_138, 11, 1);
	func_105(12, &uLocal_138, 12, 1);
	func_105(13, &uLocal_138, 13, 1);
	func_105(14, &uLocal_138, 14, 1);
	func_105(15, &uLocal_138, 15, 1);
	func_105(16, &uLocal_138, 16, 1);
	func_105(17, &uLocal_138, 17, 1);
	func_105(18, &uLocal_138, 18, 1);
	func_105(19, &uLocal_138, 19, 1);
	return;
}

void func_105(int iParam0, var uParam1, int iParam2, int iParam3) // Position - 0x30A5
{
	var unk;
	float num;
...
Vector3 func_106() // Position - 0x3136
{
	return 0.5f, -0.5f, 2f;
}

Vector3 func_107(float fParam0, var uParam1, var uParam2, float fParam3) // Position - 0x3149
{
	float num;
	float num2;
	float num3;
...
float func_108(int iParam0, float fParam1) // Position - 0x318D
{
	switch (iParam0)
	{
		case 1:
...
Vector3 func_109() // Position - 0x31C6
{
	return -0.5f, -0.5f, 0f;
}

void func_110(int iParam0, var uParam1, var uParam2) // Position - 0x31D9
{
	if (func_4())
	{
		switch (iParam0)
...
void func_111() // Position - 0x3799
{
	return;
}

int _NETWORK_ENSURE_SCRIPT_IS_NETWORKED(int iParam0, int iParam1, BOOL bNoTerminate) // Position - 0x37A1
{
	int i;
...
BOOL func_113(BOOL bParam0) // Position - 0x38B7
{
	bParam0;
	return Global_1575060;
}

int func_114() // Position - 0x38C8
{
	int unk;
