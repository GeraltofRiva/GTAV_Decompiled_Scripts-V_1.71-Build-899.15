...
{
	if (Global_1836646 == 0 || Global_1836646 == 2)
		iLocal_18 = 3;
...
void func_6() // Position - 0x25A
{
	...
	if (IS_BIT_SET(Global_1836641, 1))
		return;
	...
	if (func_7(&Global_1836642, iLocal_21))
	{
...
void func_12() // Position - 0xB95
{
	...
	while (iLocal_20 < 80)
	{
		if (func_7(&Global_1836642, iLocal_20))
		{
			iLocal_20 = iLocal_20 + 1;
		}
...
BOOL IS_GAMER_HANDLE_VALID(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12) // Position - 0x3A65
{
	return NETWORK::NETWORK_IS_HANDLE_VALID(&uParam0, 13);
}

BOOL func_18(Vehicle veParam0) // Position - 0x3A75
{
	Hash entityModel;
...
BOOL func_19(Hash hParam0) // Position - 0x3ABB
{
	switch (hParam0)
	{
		case joaat("brioso"):
...
BOOL func_20(Hash hParam0) // Position - 0x3B71
{
	switch (hParam0)
	{
		case -1321131184:
...
BOOL func_21(Hash hParam0) // Position - 0x3B9F
{
	switch (hParam0)
	{
		case joaat("coureur"):
...
BOOL func_22(Hash hParam0) // Position - 0x3BD4
{
	switch (hParam0)
	{
		case joaat("pounder2"):
...
void func_23(Vehicle veParam0) // Position - 0x3CDB
{
	Hash entityModel;
...
void func_24(var uParam0, var uParam1, var uParam2) // Position - 0x3D6A
{
	Hash eventData;
...
int _GET_LOBBY_SCRIPT_EVENT_BITS(BOOL includeLocalPlayer, BOOL includeSpectators) // Position - 0x3DAB
{
	int address;
	int i;
	Player player;
...
BOOL func_26(Player plParam0, int iParam1) // Position - 0x3E10
{
	BOOL flag;
...
int func_27(int iParam0, BOOL bParam1) // Position - 0x3E69
{
	int num;
	int num2;
...
int func_28() // Position - 0x3EAA
{
	return Global_1574927;
}

BOOL func_29(Player plParam0) // Position - 0x3EB6
{
	Player player;
...
BOOL _NETWORK_IS_PLAYER_VALID(Player player, BOOL bIsPlaying, BOOL bUnk) // Position - 0x3ED8
{
	Player player;
...
BOOL func_31(int iParam0) // Position - 0x3F38
{
	int i;
...
BOOL func_32(int iParam0) // Position - 0x3F73
{
	return func_33(iParam0, 6, true);
}

BOOL func_33(int iParam0, int iParam1, BOOL bParam2) // Position - 0x3F83
{
	if (iParam0 == -1)
		return false;
...
int func_34(int iParam0, int iParam1) // Position - 0x3FE3
{
	Hash statHash;
	int outValue;
...
Hash func_35(int iParam0, int iParam1) // Position - 0x4013
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(0, iParam0, func_36(iParam1));
}

int func_36(int iParam0) // Position - 0x4028
{
	int num;
	int num2;
...
int func_37(int iParam0) // Position - 0x405C
{
	switch (iParam0)
	{
		case 0:
...
int func_38() // Position - 0x4413
{
	return Global_33298;
}

int func_39(int iParam0) // Position - 0x441E
{
	switch (iParam0)
	{
		case -1:
...
BOOL func_40() // Position - 0x4761
{
	return Global_101969.f_400 > 0;
}

int func_41(Vehicle veParam0, Any* panParam1) // Position - 0x4772
{
...
BOOL func_42(Vehicle veParam0) // Position - 0x47EF
{
	int vehicleCrewEmblemRequestState;
	int networkTime;
	int num;
...
void func_43(Vehicle veParam0) // Position - 0x487C
{
	int _int;
...
BOOL func_44(var uParam0, Player plParam1) // Position - 0x48DC
{
	func_48();
	...
	func_46(*uParam0, &Global_1946326, &(Global_1946326.f_1), &(Global_1946326.f_4), &(Global_1946326.f_7), &(Global_1946326.f_10));
	...
	{
		if (func_45(uParam0, plParam1, Global_1946326, Global_1946326.f_1, Global_1946326.f_4, Global_1946326.f_7, Global_1946326.f_10, 0, Global_1946326.f_13))
		{
			if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	...
	else
	{
		...
		if (Global_1946326.f_23 == 0 && func_45(uParam0, plParam1, Global_1946326, Global_1946326.f_1, Global_1946326.f_4, Global_1946326.f_7, Global_1946326.f_10, 0, Global_1946326.f_13) || Global_1946326.f_23 != 0 && Global_1946326.f_24 == 0 && func_45(uParam0, plParam1, Global_1946326, Global_1946326.f_14, Global_1946326.f_17, Global_1946326.f_20, Global_1946326.f_10, 1, Global_1946326.f_13) || Global_1946326.f_24 != 0)
		{
			if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
				Global_1577972 = NETWORK::GET_NETWORK_TIME();
			else
...
BOOL func_45(var uParam0, Player plParam1, int iParam2, Vector3 vParam3, var uParam4, var uParam5, Vector3 vParam6, var uParam7, var uParam8, Vector3 vParam9, var uParam10, var uParam11, float fParam12, int iParam13, int iParam14) // Position - 0x4B87
{
...
int func_46(Vehicle veParam0, int iParam1, var uParam2, var uParam3, var uParam4, float fParam5) // Position - 0x4BB0
{
	if (!ENTITY::DOES_ENTITY_EXIST(veParam0) || !VEHICLE::IS_VEHICLE_DRIVEABLE(veParam0, false))
		return 0;
	...
	*iParam1 = ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(veParam0, "chassis_dummy");
	...
	if (!func_47(Global_1946352, 0f, 0f, 0f, false) && !func_47(Global_1946355, 0f, 0f, 0f, false) && !func_47(Global_1946358, 0f, 0f, 0f, false) && !(Global_1946361 == 0f))
	{
...
BOOL func_47(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, BOOL bParam6) // Position - 0xAB0E
{
	if (bParam6)
...
BOOL func_49(Vehicle veParam0) // Position - 0xABCE
{
	if (ENTITY::DOES_ENTITY_EXIST(veParam0) && VEHICLE::IS_VEHICLE_DRIVEABLE(veParam0, false))
...
BOOL func_50(Vehicle veParam0) // Position - 0xAC06
{
	int _int;
...
BOOL func_51(Vehicle veParam0, Any* panParam1) // Position - 0xAC51
{
	Player playerFromGamerHandle;
	BOOL flag;
	int num;
...
BOOL func_52(Vehicle veParam0) // Position - 0xADAE
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		return true;
...
int func_53(Vehicle veParam0) // Position - 0xB105
{
...
int func_54(Player plParam0) // Position - 0xB134
{
...
int func_55(Player plParam0) // Position - 0xB151
{
...
BOOL func_56(Player plParam0, BOOL bParam1) // Position - 0xB174
{
	if (func_29(plParam0))
...
int func_57(Player plParam0) // Position - 0xB1B8
{
	if (func_29(plParam0))
		if (func_56(plParam0, false))
...
BOOL func_59(BOOL bParam0) // Position - 0xB1F1
{
	return func_60(PLAYER::PLAYER_ID(), bParam0);
}

BOOL func_60(Player plParam0, BOOL bParam1) // Position - 0xB203
{
	return func_61(plParam0, bParam1, 1);
}

int func_61(Player plParam0, BOOL bParam1, int iParam2) // Position - 0xB214
{
	Player player;
	...
	if (func_29(player) && Global_1888882[player /*611*/].f_10.f_431 == iParam2)
		return 1;

	return 0;
}

BOOL func_62(Player plParam0, int iParam1) // Position - 0xB270
{
	if (func_29(plParam0))
		if (func_29(Global_1888882[plParam0 /*611*/].f_10))
...
BOOL func_63(int iParam0, BOOL bParam1) // Position - 0xB2BF
{
	int num;
	int num2;
...
int func_64(int iParam0) // Position - 0xB31D
{
	return iParam0 % 32;
}

int func_65(int iParam0) // Position - 0xB32A
{
	int num;
...
int func_66(int iParam0) // Position - 0xB341
{
	int num;
	int num2;
...
int func_67(int iParam0) // Position - 0xB36E
{
	return iParam0 / 32;
}

BOOL func_68(Player plParam0) // Position - 0xB37B
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (func_69(plParam0) && Global_2658019[plParam0 /*467*/].f_324.f_11 == plParam0)
			return true;

	return false;
}

BOOL func_69(Player plParam0) // Position - 0xB3B0
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2658019[plParam0 /*467*/].f_324.f_8 != -1)
				return func_70(Global_2658019[plParam0 /*467*/].f_324.f_8) == 22;

	return false;
}

int func_70(int iParam0) // Position - 0xB3F7
{
	switch (iParam0)
	{
		case 0:
...
void func_71(Vehicle veParam0, int iParam1) // Position - 0xB946
{
	int num;
	int num2;
...
BOOL func_72(int iParam0, var uParam1) // Position - 0xB967
{
	*uParam1 = -1;
...
int func_73(int iParam0) // Position - 0xBC29
{
	switch (iParam0)
	{
		case 0:
...
int func_74(int iParam0, int iParam1, int iParam2) // Position - 0xBCC7
{
	...
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS() && func_75() && Global_1576245)
...
struct<13> GET_LOCAL_GAMER_HANDLE() // Position - 0xBEF1
{
	var gamerHandle;
...
BOOL func_77(Vehicle veParam0) // Position - 0xBF06
{
	switch (ENTITY::GET_ENTITY_MODEL(veParam0))
	{
		case joaat("deathbike2"):
...
BOOL func_78(int iParam0, var uParam1) // Position - 0xBF27
{
	*uParam1 = -1f;
...
void func_79(Vehicle veParam0) // Position - 0xC2F6
{
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
...
void func_80(Vehicle veParam0) // Position - 0xC32B
{
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		if (DECORATOR::DECOR_IS_REGISTERED_AS_TYPE("MLJ", BOOL))
			if (!DECORATOR::DECOR_EXIST_ON(veParam0, "MLJ"))
...
BOOL func_81(Hash hParam0) // Position - 0xC362
{
	switch (hParam0)
	{
		case 1484920335:
...
BOOL func_82(Hash hParam0) // Position - 0xC385
{
...
BOOL func_83(Hash hParam0) // Position - 0xCE2C
{
	switch (hParam0)
	{
		case joaat("deity"):
...
void func_84(Vehicle veParam0, var uParam1, BOOL bParam2, BOOL bParam3) // Position - 0xCEBB
{
	int num;
	int num2;
	int i;
...
BOOL func_85(Vehicle veParam0, float fParam1) // Position - 0xD5DC
{
	float entityCoords;
	var groundZ;
...
Hash func_86(BOOL bParam0) // Position - 0xD64D
{
	if (bParam0)
...
BOOL func_87() // Position - 0xD667
{
	...
	if (func_91(7))
		if (func_89(Global_2672967.f_4.f_16) || func_88(Global_2672967.f_4.f_16))
			return false;

	return true;
}

BOOL func_88(int iParam0) // Position - 0xD6F6
{
	int num;
...
BOOL func_89(int iParam0) // Position - 0xD71A
{
	int num;
...
BOOL func_90(int iParam0, int iParam1) // Position - 0xD738
{
	return IS_BIT_SET(Global_1888882[iParam0 /*611*/].f_10.f_4, iParam1);
}

BOOL func_91(int iParam0) // Position - 0xD750
{
	return func_92(&(Global_2672967.f_194), iParam0);
}

BOOL func_92(var uParam0, int iParam1) // Position - 0xD764
{
	int num;
	int num2;
	int num3;
...
int func_93(var uParam0, var uParam1, var uParam2) // Position - 0xD787
{
	int i;
	int modType;
...
BOOL func_94(Vehicle veParam0) // Position - 0xD985
{
	int i;
	int modType;
	Hash hashKey;
...
void func_95(var uParam0) // Position - 0xDA61
{
...
int func_96(Vehicle veParam0, int iParam1) // Position - 0xDACC
{
	int value;
	int value2;
	float num;
...
int func_97(Vehicle veParam0, int iParam1) // Position - 0xDBB5
{
	int i;
...
BOOL func_98(Hash hParam0) // Position - 0xDC17
{
...
BOOL func_99(Hash hParam0, int iParam1) // Position - 0xDC42
{
	switch (hParam0)
	{
		case joaat("faction2"):
...
BOOL func_100(Vehicle veParam0, int iParam1, int iParam2) // Position - 0xE028
{
...
BOOL func_101() // Position - 0xE04C
{
	return true;
}

void func_102(Vehicle veParam0, int iParam1) // Position - 0xE059
{
	int vehicleMod;
...
BOOL func_103(int iParam0) // Position - 0xE0D1
{
	switch (iParam0)
	{
		case joaat("granger"):
...
BOOL func_104() // Position - 0xE0F1
{
	return DLC::IS_DLC_PRESENT(joaat("mpindependence"));
}

BOOL func_105(Vehicle veParam0) // Position - 0xE102
{
	int _int;
...
int func_106(var uParam0) // Position - 0xE14A
{
...
BOOL func_107(int iParam0) // Position - 0xE16A
{
	switch (iParam0)
	{
		case 161:
...
int func_108(int iParam0) // Position - 0xE1BD
{
	switch (iParam0)
	{
		case 1:
...
BOOL func_109(Vehicle veParam0) // Position - 0xE26D
{
...
BOOL _IS_PLAYER_IN_VEHICLE_SEAT(Player plParam0, int iParam1) // Position - 0xE2F4
{
...
Player _INVALID_PLAYER_INDEX() // Position - 0xE341
{
	return -1;
}

BOOL func_112(var uParam0, int iParam1) // Position - 0xE34A
{
	if (iParam1 == 0)
	{
		*uParam0 = 2;
...
void func_113() // Position - 0xF44A
{
	if (SCRIPT::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(joaat("fm_mission_creator")) == 0 || Global_1836646 == 0)
		iLocal_18 = 3;
