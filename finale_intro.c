...
void func_2(BOOL bParam0, BOOL bParam1) // Position - 0x8E
{
	...
	if (bParam0)
	{
		if (_IS_MISSION_REPEAT_ACTIVE(false) && Global_80015.f_1 == 1 && func_4(Global_80015))
		{
		}
		else
		{
		...
		if (Global_114370.f_2367.f_539.f_2407[0 /*295*/][echParam1 /*98*/] == model)
		{
			...
			if (STREAMING::HAS_MODEL_LOADED(Global_114370.f_2367.f_539.f_2407[0 /*295*/][echParam1 /*98*/]))
			{
				*uParam0 = VEHICLE::CREATE_VEHICLE(Global_114370.f_2367.f_539.f_2407[0 /*295*/][echParam1 /*98*/], fParam2, fParam5, false, false, false);
				...
				func_87(uParam0, &(Global_114370.f_2367.f_539.f_2407[0 /*295*/][echParam1 /*98*/].f_31), &(Global_114370.f_2367.f_539.f_2407[0 /*295*/][echParam1 /*98*/].f_81));
		...
		else if (Global_114370.f_2367.f_539.f_2407[1 /*295*/][echParam1 /*98*/] == model)
		{
			...
			if (STREAMING::HAS_MODEL_LOADED(Global_114370.f_2367.f_539.f_2407[1 /*295*/][echParam1 /*98*/]))
			{
				*uParam0 = VEHICLE::CREATE_VEHICLE(Global_114370.f_2367.f_539.f_2407[1 /*295*/][echParam1 /*98*/], fParam2, fParam5, false, false, false);
				...
				func_87(uParam0, &(Global_114370.f_2367.f_539.f_2407[1 /*295*/][echParam1 /*98*/].f_31), &(Global_114370.f_2367.f_539.f_2407[1 /*295*/][echParam1 /*98*/].f_81));
				VEHICLE::SET_VEHICLE_ENVEFF_SCALE(*uParam0, model.f_96);
...
void func_9(eCharacter echParam0, var uParam1, int iParam2, BOOL bParam3) // Position - 0x12D9
{
	...
	if (func_99(echParam0) && ENTITY::DOES_ENTITY_EXIST(*uParam1) && VEHICLE::IS_VEHICLE_DRIVEABLE(*uParam1, false))
	{
		...
		{
			func_13(uParam1, &(Global_114370.f_2367.f_539.f_2407[iParam2 /*295*/][echParam0 /*98*/].f_31), &(Global_114370.f_2367.f_539.f_2407[iParam2 /*295*/][echParam0 /*98*/].f_81));
			...
			if (bParam3)
			{
				...
				Global_114370.f_20122[echParam0 /*43*/].f_31 = func_12(*uParam1);
				...
				func_10(Global_114370.f_2367.f_539.f_2407[iParam2 /*295*/][echParam0 /*98*/].f_5, Global_114370.f_2367.f_539.f_2407[iParam2 /*295*/][echParam0 /*98*/].f_7, num, true, &(Global_114370.f_20122[echParam0 /*43*/].f_1));
				...
				func_10(Global_114370.f_2367.f_539.f_2407[iParam2 /*295*/][echParam0 /*98*/].f_6, -1, num, false, &(Global_114370.f_20122[echParam0 /*43*/].f_2));
			}
		}
	}
	...
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2658019[plParam0 /*467*/].f_324.f_8 != -1)
				return func_17(Global_2658019[plParam0 /*467*/].f_324.f_8) == 32;
...
BOOL _NETWORK_IS_PLAYER_VALID(Player player, BOOL bIsPlaying, BOOL bUnk) // Position - 0x3E22
{
	Player player;
...
Player _INVALID_PLAYER_INDEX() // Position - 0x3E82
{
	return -1;
}

BOOL func_20(Hash hParam0) // Position - 0x3E8B
{
...
BOOL func_21(Player plParam0) // Position - 0x3EA2
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2658019[plParam0 /*467*/].f_324.f_8 != -1)
				return func_17(Global_2658019[plParam0 /*467*/].f_324.f_8) == 11;

	return false;
}

BOOL func_22(Hash hParam0) // Position - 0x3EE9
{
...
BOOL func_23(Vehicle veParam0) // Position - 0x3F2B
{
	switch (ENTITY::GET_ENTITY_MODEL(veParam0))
	{
...
BOOL func_24(Player plParam0) // Position - 0x3FF3
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2658019[plParam0 /*467*/].f_324.f_8 != -1)
				return func_17(Global_2658019[plParam0 /*467*/].f_324.f_8) == 26;

	return false;
}

BOOL func_25(Player plParam0) // Position - 0x403C
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2658019[plParam0 /*467*/].f_324.f_8 != -1)
				return func_17(Global_2658019[plParam0 /*467*/].f_324.f_8) == 13;

	return false;
}

BOOL func_26(Player plParam0) // Position - 0x4083
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2658019[plParam0 /*467*/].f_324.f_8 != -1)
				return func_17(Global_2658019[plParam0 /*467*/].f_324.f_8) == 7;

	return false;
}

BOOL func_27(Hash hParam0) // Position - 0x40C9
{
	BOOL flag;
...
Hash func_28(BOOL bParam0) // Position - 0x415A
{
	if (bParam0)
...
BOOL func_29(Player plParam0) // Position - 0x4174
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
...
BOOL func_30(Vehicle veParam0) // Position - 0x419A
{
...
BOOL func_31(Vehicle veParam0) // Position - 0x41C9
{
...
BOOL func_32(Vehicle veParam0) // Position - 0x4331
{
	Hash entityModel;
...
BOOL func_33(Hash hParam0) // Position - 0x43AE
{
	switch (hParam0)
	{
		case joaat("mule"):
...
BOOL func_34(Player plParam0) // Position - 0x440A
{
	if (plParam0 == _INVALID_PLAYER_INDEX())
		return false;

	if (func_57(plParam0) && Global_2658019[plParam0 /*467*/].f_324.f_11 == plParam0)
		return true;

	return false;
}

BOOL func_35(Vehicle veParam0, BOOL bParam1) // Position - 0x4443
{
	switch (ENTITY::GET_ENTITY_MODEL(veParam0))
	{
...
int func_36(Vehicle veParam0) // Position - 0x449E
{
	int i;
...
BOOL func_37(Hash hParam0, int iParam1) // Position - 0x44D7
{
	if (iParam1 == 0)
...
BOOL func_47(Vehicle veParam0) // Position - 0x4DC4
{
	if (PLAYER::PLAYER_ID() != _INVALID_PLAYER_INDEX())
	{
		...
		if (func_51(PLAYER::PLAYER_ID(), true, false) && Global_1845274[PLAYER::PLAYER_ID() /*877*/].f_260.f_36 > 0 || IS_BIT_SET(Global_1845274[PLAYER::PLAYER_ID() /*877*/].f_260.f_34, 14) || IS_BIT_SET(Global_1845274[PLAYER::PLAYER_ID() /*877*/].f_260.f_34, 11))
			return false;
			...
			if (DECORATOR::DECOR_EXIST_ON(veParam0, "Player_Vehicle"))
				if (DECORATOR::DECOR_GET_INT(veParam0, "Player_Vehicle") == NETWORK::NETWORK_HASH_FROM_PLAYER_HANDLE(PLAYER::PLAYER_ID()))
					if (func_49() != -1 && func_49() < 547)
						if (!func_48(veParam0) || ENTITY::GET_ENTITY_MODEL(veParam0) != Global_1586547[func_49() /*143*/].f_66)
							return true;
...
BOOL func_48(Vehicle veParam0) // Position - 0x4ED2
{
...
int func_49() // Position - 0x4EEB
{
	return Global_2359296[func_50() /*5571*/].f_681.f_2;
}

int func_50() // Position - 0x4F03
{
	int num;
...
BOOL func_51(Player plParam0, BOOL bParam1, BOOL bParam2) // Position - 0x4F10
{
	if (plParam0 == _INVALID_PLAYER_INDEX())
		return false;
...
BOOL func_52(Player plParam0) // Position - 0x4F74
{
...
BOOL func_53() // Position - 0x4FA5
{
	return func_54() != -1;
}

int func_54() // Position - 0x4FB3
{
	return Global_2658019[PLAYER::PLAYER_ID() /*467*/].f_324.f_8;
}

BOOL func_55(Player plParam0) // Position - 0x4FCB
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2658019[plParam0 /*467*/].f_324.f_8 != -1 && Global_2658019[plParam0 /*467*/].f_324.f_11 != _INVALID_PLAYER_INDEX())
				return func_17(Global_2658019[plParam0 /*467*/].f_324.f_8) == 5;

	return false;
}

BOOL func_56(Player plParam0) // Position - 0x502A
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2658019[plParam0 /*467*/].f_324.f_8 != -1 && Global_2658019[plParam0 /*467*/].f_324.f_11 != _INVALID_PLAYER_INDEX())
				return func_17(Global_2658019[plParam0 /*467*/].f_324.f_8) == 8;

	return false;
}

BOOL func_57(Player plParam0) // Position - 0x508A
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2658019[plParam0 /*467*/].f_324.f_8 != -1)
				return func_17(Global_2658019[plParam0 /*467*/].f_324.f_8) == 9;

	return false;
}

BOOL func_58(Hash hParam0, BOOL bParam1, var uParam2) // Position - 0x50D1
{
	BOOL flag;
...
BOOL func_59(Hash hParam0) // Position - 0x54C2
{
	switch (hParam0)
	{
		case joaat("towtruck"):
...
void func_60(Vehicle veParam0, eCharacter echParam1) // Position - 0x54F7
{
	...
	func_61(veParam0, &(Global_114370.f_32754.f_5510));
	return;
}

void func_61(Vehicle veParam0, var uParam1) // Position - 0x56F9
{
	int i;
...
int func_62(int iParam0) // Position - 0x59A4
{
	switch (iParam0)
	{
		case 1:
...
BOOL func_63(int iParam0) // Position - 0x5A54
{
	switch (iParam0)
	{
		case joaat("granger"):
...
void func_64(var uParam0) // Position - 0x5A74
{
	int i;
...
BOOL func_65(Vehicle veParam0) // Position - 0x5B25
{
...
BOOL func_66(Hash hParam0) // Position - 0x5C02
{
	if (hParam0 == 0)
		return false;
...
BOOL func_67(Hash hParam0, BOOL bParam1, int iParam2) // Position - 0x5DC0
{
	int i;
	Hash outData;
...
BOOL func_68(Hash hParam0) // Position - 0x5F45
{
	int num;
	var unk;
	var name;
...
BOOL _NETSHOPPING_SHOULD_USE_TRANSACTION_SYSTEM() // Position - 0x6011
{
...
BOOL func_70(Hash hParam0, int iParam1) // Position - 0x6028
{
	int cloudTimeAsInt;
	int num;
	int i;
...
BOOL IS_PLAYSTATION_PLATFORM() // Position - 0x6255
{
	return MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION();
}

BOOL IS_XBOX_PLATFORM() // Position - 0x626B
{
	return MISC::IS_DURANGO_VERSION() || MISC::IS_SCARLETT_VERSION();
}

BOOL func_73() // Position - 0x6281
{
	return false;
}

BOOL func_74() // Position - 0x628A
{
	return true;
}

BOOL func_75() // Position - 0x6293
{
	return true;
}

BOOL func_76() // Position - 0x629C
{
...
BOOL _IS_EXCLUSIVE_CONTENT_UNLOCKED() // Position - 0x62B5
{
	int profileSetting;
...
BOOL func_78(Vehicle veParam0) // Position - 0x636D
{
	Hash entityModel;
...
BOOL func_79(Vehicle veParam0) // Position - 0x63B4
{
	int i;
...
BOOL func_80(Vehicle veParam0) // Position - 0x6430
{
	int i;
...
eCharacter func_81(Vehicle veParam0) // Position - 0x6518
{
	int i;
...
BOOL func_82(Vehicle veParam0, eCharacter echParam1, BOOL bParam2) // Position - 0x657B
{
	int i;
	var garageName;
	int num;
...
BOOL func_83(eCharacter echParam0, int iParam1, char* sParam2, var uParam3) // Position - 0x65E9
{
...
void func_84(Vehicle veParam0, eCharacter echParam1) // Position - 0x66C2
{
	int i;
...
void func_85(var uParam0) // Position - 0x6744
{
	if (!func_86(*uParam0))
...
BOOL func_86(Vehicle veParam0) // Position - 0x676F
{
	return VEHICLE::IS_VEHICLE_EXTRA_TURNED_ON(veParam0, 5);
}

int func_87(var uParam0, var uParam1, var uParam2) // Position - 0x677E
{
	int i;
	int modType;
...
BOOL func_88(Vehicle veParam0) // Position - 0x697C
{
	int i;
	int modType;
	Hash hashKey;
...
void func_89(var uParam0) // Position - 0x6A58
{
...
int func_90(Vehicle veParam0, int iParam1) // Position - 0x6AC3
{
	int value;
	int value2;
	float num;
...
int func_91(Vehicle veParam0, int iParam1) // Position - 0x6BAC
{
	int i;
...
BOOL func_92(Hash hParam0) // Position - 0x6C0E
{
...
BOOL func_93(Vehicle veParam0) // Position - 0x6C39
{
	Hash entityModel;
...
BOOL func_94(Hash hParam0) // Position - 0x6C7F
{
	switch (hParam0)
	{
		case joaat("brioso"):
...
BOOL func_95(Vehicle veParam0, int iParam1, int iParam2) // Position - 0x6D35
{
...
BOOL func_96() // Position - 0x6D59
{
	return true;
}

BOOL func_97(var uParam0, var uParam1) // Position - 0x6D66
{
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
	}
...
void func_98(eCharacter echParam0, var uParam1, int iParam2) // Position - 0x6DA7
{
	int num;
...
BOOL func_99(eCharacter echParam0) // Position - 0x7003
{
	return echParam0 < CHAR_MULTIPLAYER;
}

BOOL func_100(eCharacter echParam0, int iParam1, float fParam2, float fParam3, float fParam4, float fParam5) // Position - 0x700F
{
	int i;
	Hash hash;
	Hash hash2;
	...
	if (hash2 != 0)
	{
		...
		{
			if (ENTITY::DOES_ENTITY_EXIST(Global_99223[i]) && VEHICLE::IS_VEHICLE_DRIVEABLE(Global_99223[i], false))
				if (ENTITY::GET_ENTITY_MODEL(Global_99223[i]) == hash2 && Global_99233[i] == echParam0)
					if (fParam5 == -1f || MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(Global_99223[i], false), fParam2, true) <= fParam5)
						return true;
		}
	}
...
void func_101(float fParam0, float fParam1, float fParam2, float fParam3, float fParam4, float fParam5, float fParam6, float fParam7, float fParam8, float fParam9, float fParam10, BOOL bParam11, BOOL bParam12, BOOL bParam13, BOOL bParam14, BOOL bParam15) // Position - 0x70D4
{
	func_102(fParam0, fParam3, fParam6, fParam7, fParam10, 0f, 0f, 0f, bParam11, bParam12, bParam13, bParam14, bParam15);
	return;
}

void func_102(Vector3 vParam0, var uParam1, var uParam2, Vector3 vParam3, var uParam4, var uParam5, float fParam6, Vector3 vParam7, var uParam8, var uParam9, float fParam10, float fParam11, float fParam12, float fParam13, BOOL bParam14, BOOL bParam15, BOOL bParam16, BOOL bParam17, BOOL bParam18) // Position - 0x70FD
{
	Vehicle playersLastVehicle;
	BOOL flag;
	BOOL flag2;
...
BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0x74F3
{
...
eCharacter _GET_CURRENT_PLAYER_CHARACTER() // Position - 0x751D
{
	func_105();
	return Global_114370.f_2367.f_539.f_4321;
}

void func_105() // Position - 0x7536
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (_GET_CHARACTER_MODEL(Global_114370.f_2367.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_99(character) && !func_106(14) || Global_113318)
			{
				if (Global_114370.f_2367.f_539.f_4321 != character && func_99(Global_114370.f_2367.f_539.f_4321))
...
BOOL func_106(int iParam0) // Position - 0x7633
{
	return Global_44392 == iParam0;
}

eCharacter _GET_PLAYER_CHARACTER_FROM_PED(Ped pedParam0) // Position - 0x7641
{
	eCharacter i;
	Hash entityModel;
...
Hash _GET_CHARACTER_MODEL(eCharacter character) // Position - 0x767E
{
...
Hash func_109(eCharacter echParam0) // Position - 0x76A3
{
	return Global_2241[echParam0 /*29*/];
}

BOOL func_110(Vehicle veParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, float fParam7) // Position - 0x76B2
{
	float num;
	var unk3;
	var unk6;
...
BOOL func_111(float fParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, float fParam9, var uParam10, var uParam11) // Position - 0x79A8
{
	float num;
	float num2;
	float num3;
...
Vector3 func_112(float fParam0, var uParam1, var uParam2) // Position - 0x7A5C
{
	float num;
	float num2;
...
void func_113(Vehicle veParam0) // Position - 0x7A9B
{
	if (ENTITY::DOES_ENTITY_EXIST(veParam0))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(veParam0, false))
...
void func_114(float fParam0, float fParam1, float fParam2, float fParam3, float fParam4, float fParam5, float fParam6, float fParam7, float fParam8, float fParam9, float fParam10, var uParam11, var uParam12, var uParam13, BOOL bParam14, BOOL bParam15, BOOL bParam16, BOOL bParam17, BOOL bParam18) // Position - 0x7B00
{
	func_102(fParam0, fParam3, fParam6, fParam7, fParam10, uParam11, bParam14, bParam15, bParam16, bParam17, bParam18);
	return;
}

BOOL func_115(var uParam0, var uParam1, var uParam2, int iParam3) // Position - 0x7B2A
{
	return func_116(Global_104929.f_2890.f_12.f_66, uParam0, iParam3);
}

BOOL func_116(Hash hParam0, float fParam1, var uParam2, var uParam3, int iParam4) // Position - 0x7B47
{
	var minimum;
	float maximum;
...
Vector3 func_117() // Position - 0x7BB1
{
	return 2.55f, 5.665f, 2.55f;
}

void func_118(float fParam0, float fParam1, float fParam2, float fParam3, BOOL bParam4) // Position - 0x7BC8
{
	int i;

	for (i = 0; i < 68; i = i + 1)
	{
		if (func_126(&Global_78558.f_555[0 /*21*/], i))
...
void func_119(int iParam0) // Position - 0x7C18
{
	BOOL flag;
	...
	if (func_126(&Global_78558.f_555[0 /*21*/], iParam0))
	{
		...
		{
			if (iParam0 == 24 && func_125(iParam0, 0) && Global_79467.f_66 == 0 && Global_114370.f_32754.f_1958[Global_78558.f_555[0 /*21*/].f_14] != 0 && Global_114370.f_32754.f_1958[Global_78558.f_555[0 /*21*/].f_14] > 3 && !func_123(0, Global_78558.f_555[0 /*21*/].f_12) || !func_123(1, Global_78558.f_555[0 /*21*/].f_12))
			{
				func_122(&Global_114370.f_32754.f_69[Global_78558.f_555[0 /*21*/].f_14 /*78*/], &Global_79467);
...
void func_120(int iParam0, BOOL bParam1) // Position - 0x7D87
{
	if (iParam0 == -1)
		return;
...
void func_121(int iParam0, int iParam1, BOOL bParam2) // Position - 0x7DE4
{
	if (iParam0 == -1)
		return;
...
void func_122(var uParam0, var uParam1) // Position - 0x7E1F
{
...
BOOL func_123(int iParam0, int iParam1) // Position - 0x7EEB
{
	int num;
	...
	if (iParam0 < 0 || iParam0 >= func_124(&Global_114370.f_32754.f_5038[num /*157*/]))
		return false;

	return func_67(Global_114370.f_32754.f_5038[num /*157*/][iParam0 /*78*/].f_66, false, -1);
}

int func_124(var uParam0) // Position - 0x7F5E
{
	return *uParam0;
}

BOOL func_125(int iParam0, int iParam1) // Position - 0x7F69
{
	if (iParam0 == -1)
		return false;
...
BOOL func_126(var uParam0, int iParam1) // Position - 0x7F89
{
	BOOL num;
	int num2;
...
void func_146(int iParam0) // Position - 0xA913
{
	...
	func_147(&Global_79551[0 /*14*/], num6, iParam0, &unk, num2, num3, num, flag, num4, num5, false);
	return;
}
	...
	*iParam0 = iParam9;
	...
	else
	{
		...
		if (iParam1 == 11 || iParam1 == 4 || iParam1 == 6 || iParam1 == 1 || iParam1 == 14 || iParam1 == 2 || iParam1 == 8 || iParam1 == 9 || iParam1 == 10 || iParam1 == 7 || iParam1 == 12)
		{
			...
			num = func_150(func_154(iParam1, iParam0->f_2), Global_79548);
		
			if (IS_BIT_SET(num, iParam0->f_1))
				MISC::SET_BIT(&(iParam0->f_6), 1);
		
			num = func_150(func_149(iParam1, iParam0->f_2), Global_79548);
...
int func_158(int iParam0) // Position - 0x1075E
{
	switch (iParam0)
	{
		case -1:
...
void func_159(int iParam0, int iParam1, int iParam2, Hash hParam3) // Position - 0x10832
{
	int num;
	int num2;
	Hash outfit;
	...
	if (iParam0 == 12)
	{
		...
		if (outfitIndex >= 0)
		{
			...
			if (num3 > outfitIndex)
			{
				...
				func_147(&Global_79551[0 /*14*/], iParam0, iParam1, &(outfit.f_7), 0, 0, outfit.f_2, false, -1, 2, true);
				return;
			}
		}
	}
	...
	{
		func_147(&Global_79551[0 /*14*/], iParam0, iParam1, "NO_LABEL", 0, 0, 0, true, -1, 2, true);
	}
	else if (iParam0 == 14)
	{
		...
		if (componentId >= 0)
		{
			...
			if (num5 > componentId)
			{
				...
				func_147(&Global_79551[0 /*14*/], iParam0, iParam1, &(outProp.f_9), outProp.f_3, outProp.f_4, outProp.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(outProp.f_1, joaat("OUTFIT_ONLY"), 0), num4, 2, outProp.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (hParam3 != -1 && Global_79749)
		{
			...
			func_147(&Global_79551[0 /*14*/], iParam0, iParam1, &(outComponent.f_9), outComponent.f_3, outComponent.f_4, outComponent.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(outComponent.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, outComponent.f_1 != 0);
			return;
		}
...
void func_160(int iParam0) // Position - 0x10AB9
{
	BOOL flag;
	int num;
	var unk;
...
void func_161(int iParam0) // Position - 0x10C10
{
	BOOL flag;
	int num;
	var unk;
...
void func_162(int iParam0) // Position - 0x1111E
{
	BOOL flag;
	int num;
	var unk;
...
void func_163(int iParam0) // Position - 0x11193
{
	BOOL flag;
	int num;
	var unk;
...
void func_164(int iParam0) // Position - 0x11207
{
	BOOL flag;
	int num;
	var unk;
...
void func_165(int iParam0) // Position - 0x112EE
{
	BOOL flag;
	int num;
	var unk;
...
void func_166(int iParam0) // Position - 0x11651
{
	BOOL flag;
	int num;
	var unk;
...
void func_167(int iParam0) // Position - 0x11862
{
	BOOL flag;
	int num;
	var unk;
...
void func_168(int iParam0) // Position - 0x11A92
{
	BOOL flag;
	int num;
	var unk;
...
void func_169(int iParam0) // Position - 0x11BA2
{
	BOOL flag;
	int num;
	var unk;
...
void func_170(int iParam0) // Position - 0x12541
{
	BOOL flag;
	int num;
	var unk;
...
void func_171(int iParam0) // Position - 0x130B4
{
	if (iParam0 < 136)
		func_173(iParam0);
	else
...
void func_172(int iParam0) // Position - 0x130E9
{
	BOOL flag;
	int num;
	var unk;
...
void func_173(int iParam0) // Position - 0x13CED
{
	BOOL flag;
	int num;
	var unk;
...
BOOL func_226(int iParam0) // Position - 0x22EFB
{
	...
	func_227(&(Global_114370.f_2367.f_539), num2);
...
void func_227(var uParam0, int iParam1) // Position - 0x2300B
{
	...
	for (i = 0; i < 3; i = i + 1)
	{
		...
		else
		{
			...
			if (!func_229(Global_114370.f_18537[i], &unk, &num2))
			{
