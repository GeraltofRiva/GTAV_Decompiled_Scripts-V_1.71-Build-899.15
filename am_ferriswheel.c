...
int func_3() // Position - 0x4B5
{
	...
	for (i = 0; i < 16; i = i + 1)
	{
		...
		if (iLocal_1140.f_36[i /*10*/].f_6 >= Global_2748590)
			return i;
	}

	if (iLocal_1140.f_36[0 /*10*/].f_6 >= Global_2748590)
		return 0;
	else
		return 1;
	...
	switch (uLocal_1404[NETWORK::PARTICIPANT_ID_TO_INT() /*5*/].f_1)
	{
		case 0:
			...
			else
			{
				if (IS_BIT_SET(iLocal_1140.f_2, 0))
					if (iLocal_1140.f_262 != -1)
						if (Global_2748590 != iLocal_1140.f_36[iLocal_1140.f_197[iLocal_1140.f_262 /*2*/] /*10*/].f_6)
							func_153();
				else
					func_153();
				...
				if (IS_BIT_SET(iLocal_1140.f_3[NETWORK::PARTICIPANT_ID_TO_INT()], 0))
				{
					...
					{
						if (Global_2748590 != iLocal_1140.f_36[uLocal_1404[NETWORK::PARTICIPANT_ID_TO_INT() /*5*/].f_3 /*10*/].f_6)
						{
				...
				else if (!IS_BIT_SET(uLocal_1404[NETWORK::PARTICIPANT_ID_TO_INT() /*5*/].f_2, 8))
				{
					...
					{
						if (!func_141() && !Global_2635523.f_3254 && func_140(10000))
						{
							if (!IS_BIT_SET(uLocal_1404[NETWORK::PARTICIPANT_ID_TO_INT() /*5*/].f_2, 0))
							{
		...
		case 1:
			...
			else
			{
				...
				if (!Global_2635523.f_3254 && func_140(10000))
				{
					if (iLocal_1140.f_262 != -1)
					{
...
void func_39() // Position - 0x57C8
{
	...
	MISC::CLEAR_BIT(&(Global_1845274[PLAYER::PLAYER_ID() /*877*/].f_876), 14);
...
BOOL func_44(Object obParam0) // Position - 0x5A11
{
...
void _STOPWATCH_RESET(var pStopwatch, BOOL useLocalTimer, BOOL useAccurateTime) // Position - 0x5C6D
{
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS() && !useLocalTimer)
		if (!useAccurateTime)
			*pStopwatch = NETWORK::GET_NETWORK_TIME();
...
void _SET_PLAYER_CONTROL_EX(Player plParam0, BOOL bParam1, eSetPlayerControlFlags espcfParam2, BOOL bParam3) // Position - 0x5D78
{
		...
		if (NETWORK::NETWORK_IS_PLAYER_ACTIVE(plParam0) && PLAYER::IS_PLAYER_PLAYING(plParam0) || bParam3 == true)
		{
			...
			else
			{
				if (!func_58(playerPed) && !ENTITY::IS_ENTITY_ATTACHED_TO_ANY_VEHICLE(playerPed))
				{
					...
					if (func_55(*Global_4718592.f_197275))
...
BOOL func_55(int iParam0) // Position - 0x622C
{
	return iParam0 == 17;
}

void func_56() // Position - 0x6239
{
	var unk;
...
BOOL func_58(Ped pedParam0) // Position - 0x62C4
{
...
void func_59(BOOL bParam0, Ped pedParam1, int iParam2) // Position - 0x62F5
{
	int num;
	eViewModeContext i;
...
void _MPPLY_STAT_SET_BOOL(Hash hParam0, BOOL bParam1) // Position - 0x63C5
{
	Hash statName;
...
BOOL func_62(Player plParam0) // Position - 0x6439
{
...
BOOL func_63() // Position - 0x6478
{
	return IS_BIT_SET(Global_2621446, 3);
}

BOOL func_64(Player plParam0, int iParam1) // Position - 0x6486
{
	BOOL flag;
...
int func_65(int iParam0, BOOL bParam1) // Position - 0x64DF
{
	int num;
	int num2;
...
int func_66() // Position - 0x6520
{
	return Global_1574927;
}

BOOL func_67(Player plParam0) // Position - 0x652C
{
	int num;
...
void func_70(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, float fParam5) // Position - 0x6945
{
	Hash eventData;
...
void func_72() // Position - 0x69AB
{
	if (!_IS_FMMC_ACTIVE() && !func_73() && Global_2685689)
		Global_4718592.f_138116 = 0;

	return;
}

BOOL func_73() // Position - 0x69D9
{
	return Global_2684748.f_693;
}

void func_74() // Position - 0x69E8
{
	Global_2684748.f_758 = 1;
	return;
}

BOOL func_75() // Position - 0x69F8
{
	return Global_2684748.f_737;
}

BOOL func_76() // Position - 0x6A07
{
	return IS_BIT_SET(Global_2684748.f_2, 11);
}

BOOL func_77(int iParam0, var uParam1, int iParam2, BOOL bParam3) // Position - 0x6A18
{
	if (iParam2 == -1)
		return true;
...
void func_80(int iParam0) // Position - 0x6AA7
{
	Hash eventData;
...
int _GET_PARTICIPANTS_SCRIPT_EVENT_BITS(BOOL includeLocalPlayer) // Position - 0x6AD5
{
	int address;
	int i;
	Player playerIndex;
...
void func_82(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0x6B32
{
...
void func_83(var uParam0, BOOL bParam1) // Position - 0x6BCC
{
	if (CAM::DOES_CAM_EXIST(*uParam0))
	{
...
void func_84(int iParam0) // Position - 0x6BFF
{
	int i;
...
void func_88(var uParam0) // Position - 0x6D88
{
...
void func_89(var uParam0) // Position - 0x6DAF
{
	if (CAM::DOES_CAM_EXIST(uParam0->f_10))
	{
...
void func_90(var uParam0, var uParam1, BOOL bParam2, BOOL bParam3, int iParam4, int iParam5) // Position - 0x6DD7
{
	Vector3 vector;
	float fieldOfView;
...
BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0x6EF2
{
...
void func_92(var uParam0, float fParam1, float fParam2, float fParam3, float fParam4, float fParam5, float fParam6, int iParam7, int iParam8) // Position - 0x6F1C
{
	func_93(uParam0);
...
void func_93(var uParam0) // Position - 0x6F59
{
	*uParam0 = 0;
...
void func_96(var uParam0, var uParam1, var uParam2, BOOL bParam3) // Position - 0x7181
{
	int i;
...
void func_98(int iParam0, var uParam1) // Position - 0x7547
{
	GRAPHICS::DRAW_SCALEFORM_MOVIE_FULLSCREEN(iParam0, uParam1->f_4, uParam1->f_5, uParam1->f_6, uParam1->f_7, 0);
	return;
}

void func_99(const char* sParam0) // Position - 0x7566
{
...
void func_100(const char* sParam0) // Position - 0x7578
{
	GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_PLAYER_NAME_STRING(sParam0);
	return;
}

void func_101(var uParam0) // Position - 0x7586
{
	Global_1985670 = 0;
	uParam0->f_692 = 0;
	return;
...
BOOL func_102(var uParam0) // Position - 0x7599
{
	return Global_1985670 || uParam0->f_692;
}

void func_103(int iParam0) // Position - 0x75B0
{
	Global_1577957 = iParam0;
	return;
}

void func_104(int iParam0) // Position - 0x75BE
{
	Global_1675455.f_1163 = iParam0;
	return;
}

void func_105(const char* sParam0, char* sParam1, var uParam2, char* sParam3) // Position - 0x75CF
{
	int num;
...
void func_106(var uParam0) // Position - 0x761F
{
	func_107(uParam0);
	uParam0->f_692 = 1;
	return;
...
void func_107(var uParam0) // Position - 0x7633
{
	int i;
...
struct<9> func_108() // Position - 0x7721
{
	float num;
...
void func_109(var uParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, float fParam5, BOOL bParam6, int iParam7, BOOL bParam8) // Position - 0x7765
{
	var unk;
...
float func_110(float fParam0, float fParam1, float fParam2) // Position - 0x7CB9
{
	if (fParam0 > fParam2)
		return fParam2;
...
int func_111(int iParam0, int iParam1, int iParam2) // Position - 0x7CE0
{
	if (iParam0 > iParam2)
		return iParam2;
...
void func_112(var uParam0, var uParam1, var uParam2, var uParam3, BOOL bParam4, BOOL bParam5) // Position - 0x7D05
{
...
void func_113(var uParam0) // Position - 0x7E09
{
	float num;
	float num2;
	float num3;
...
void func_114(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, int iParam8) // Position - 0x8040
{
	var unk;
...
void func_115(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, int iParam5) // Position - 0x8063
{
	float num;
...
int func_117(var uParam0, BOOL bParam1, int iParam2) // Position - 0x81CB
{
	if (!(uParam0->f_1 == 1))
		return 0;
...
void func_118(var uParam0, BOOL bParam1) // Position - 0x82B0
{
	*uParam0 = 1;
	uParam0->f_1 = 1;
...
void func_119(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, float fParam7, var uParam8, var uParam9, int iParam10, int iParam11, int iParam12, int iParam13, int iParam14, BOOL bParam15) // Position - 0x82DD
{
	uParam0->f_1 = { uParam1 };
	uParam0->f_4 = { uParam4 };
	uParam0->f_7 = fParam7;
...
void func_120() // Position - 0x83D5
{
	int num;

	if (func_138(true) >= Global_262145.f_8418 || MONEY::NETWORK_CAN_SPEND_MONEY(Global_262145.f_8418, false, false, true, -1, 0))
	{
		if (_NETSHOPPING_SHOULD_USE_TRANSACTION_SYSTEM())
		{
			_NETSHOPPING_PROCESS_TRANSACTION(joaat("SERVICE_SPEND_FAIRGROUND"), Global_262145.f_8418, &num, false, true, false);
			Global_4537182[num /*84*/].f_1 = 2;
		}
		else
		{
...
void func_121(BOOL bParam0, int iParam1, int iParam2) // Position - 0x847A
{
...
BOOL func_123() // Position - 0x8575
{
	return Global_2697069;
}

BOOL func_124() // Position - 0x8581
{
	return Global_2698022;
}

void func_125(int iParam0, int iParam1, int iParam2) // Position - 0x858D
{
...
void _NETSHOPPING_PROCESS_TRANSACTION(Hash hParam0, int iParam1, var uParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5) // Position - 0x85B0
{
	int num;
...
int func_127(var uParam0, int iParam1, Hash hParam2, Hash hParam3, Hash hParam4, int iParam5, int iParam6, int iParam7) // Position - 0x8F47
{
	BOOL flag;
	BOOL flag2;
	int i;
...
void func_128(int iParam0, Hash hParam1, int iParam2, int iParam3, int iParam4) // Position - 0x90F4
{
	switch (hParam1)
	{
		case joaat("SERVICE_SPEND_BETTING"):
...
void func_129(int iParam0) // Position - 0x912C
{
	BOOL flag;
	...
	if (iParam0 != -1)
	{
		...
		func_130(&Global_4537182[iParam0 /*84*/]);
	}

	return;
}

void func_130(var uParam0) // Position - 0x9180
{
	uParam0->f_65 = 0;
...
void func_131(var uParam0) // Position - 0x928B
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
BOOL func_132(int iParam0) // Position - 0x92D3
{
...
void func_133(int iParam0, Hash hParam1) // Position - 0x92FE
{
...
int func_134(int iParam0, int iParam1, Hash hParam2, Hash hParam3, Hash hParam4, int iParam5, BOOL bParam6, int iParam7, int iParam8, int iParam9, BOOL bParam10) // Position - 0x9312
{
	int i;
	...
	for (i = 0; i < 15; i = i + 1)
	{
		if (Global_4537182[i /*84*/].f_65.f_2 == 0)
		{
			...
			if (iParam1 == joaat("NET_SHOP_TTYPE_SERVICE") && bParam10)
				func_135(Global_4537182[i /*84*/], i);
...
int func_136(int iParam0) // Position - 0x94D2
{
	int address;
...
BOOL _NETSHOPPING_SHOULD_USE_TRANSACTION_SYSTEM() // Position - 0x94ED
{
	if (MISC::IS_PC_VERSION())
...
int func_138(BOOL bParam0) // Position - 0x9504
{
	int vcBankBalance;
...
void func_139(char* sParam0, int iParam1, int iParam2) // Position - 0x9523
{
...
BOOL func_140(int iParam0) // Position - 0x9540
{
...
BOOL func_141() // Position - 0x9581
{
	return func_143() || func_178() || func_142() == 2 || func_142() == 16;
}

int func_142() // Position - 0x95B0
{
	return Global_1057440;
}

BOOL func_143() // Position - 0x95BC
{
	return IS_BIT_SET(Global_2684748, 5);
}

BOOL _IS_PLAYER_IN_ANIMAL_FORM(Player plParam0) // Position - 0x95CA
{
	Ped playerPed;
	Hash entityModel;
...
BOOL func_145(Ped pedParam0) // Position - 0x9636
{
...
BOOL func_146(Player plParam0, int iParam1) // Position - 0x966E
{
	return IS_BIT_SET(Global_2658019[plParam0 /*467*/].f_221, iParam1);
}

BOOL func_147(Player plParam0) // Position - 0x9684
{
...
BOOL func_148(Player plParam0) // Position - 0x96A7
{
	Player player;
...
BOOL func_149(Player plParam0, int iParam1) // Position - 0x96C5
{
	return IS_BIT_SET(Global_1888882[plParam0 /*611*/].f_10.f_4, iParam1);
}

BOOL func_150(Player plParam0) // Position - 0x96DD
{
	Player player;
...
BOOL func_151(int iParam0) // Position - 0x9700
{
	if (iParam0 == 1)
...
void _DISPLAY_HELP_TEXT(char* text, int iParam1) // Position - 0x9757
{
...
void func_153() // Position - 0x976E
{
	...
	if (iLocal_1140.f_262 != -1 && IS_BIT_SET(iLocal_1140.f_2, 0) && Global_2748590 < iLocal_1140.f_36[iLocal_1140.f_197[iLocal_1140.f_262 /*2*/] /*10*/].f_6 && Global_2748590 + (fLocal_306 * num) > iLocal_1140.f_36[iLocal_1140.f_197[iLocal_1140.f_262 /*2*/] /*10*/].f_6)
		Global_2748590 = iLocal_1140.f_36[iLocal_1140.f_197[iLocal_1140.f_262 /*2*/] /*10*/].f_6;
	else
		Global_2748590 = Global_2748590 + (fLocal_306 * num);

	if (Global_2748590 >= 360f)
		Global_2748590 = Global_2748590 - 360f;

	if (func_44(obLocal_305))
	{
		ENTITY::SET_ENTITY_COORDS(obLocal_305, uLocal_307, true, false, false, true);
		ENTITY::SET_ENTITY_ROTATION(obLocal_305, -Global_2748590 - (360f / 16f), 0f, 0f, 2, true);
...
void func_154(var uParam0) // Position - 0x98D2
{
	Vector3 vector;
...
BOOL _DOES_ENTITY_EXIST_AND_IS_ALIVE(Ped pedParam0) // Position - 0x9929
{
...
Vector3 func_156(int iParam0) // Position - 0x994A
{
	float value;
...
void func_158(int iParam0) // Position - 0x9A02
{
	Hash eventData;
...
void func_159(int iParam0) // Position - 0x9A30
{
	Hash eventData;
...
void func_160() // Position - 0x9A5E
{
	...
	ENTITY::SET_ENTITY_COORDS(obLocal_305, uLocal_307, true, false, false, true);
	ENTITY::SET_ENTITY_ROTATION(obLocal_305, Global_2748590, 0f, 0f, 2, true);
	ENTITY::FREEZE_ENTITY_POSITION(obLocal_305, true);
...
void func_161(var uParam0, int iParam1) // Position - 0x9B09
{
	uParam0->f_5 = iParam1;
...
int func_162() // Position - 0x9B42
{
	return iLocal_1140.f_1;
}

int func_163(int iParam0) // Position - 0x9B4F
{
	return uLocal_1404[iParam0 /*5*/];
}

void func_164() // Position - 0x9B5E
{
	int i;
...
void func_165(int iParam0) // Position - 0x9C46
{
	struct<4> eventData;
...
void func_166(int iParam0) // Position - 0x9CAE
{
	struct<5> eventData;
...
void func_167(int iParam0) // Position - 0x9DD9
{
	struct<4> eventData;
...
void func_168(int iParam0) // Position - 0x9E2E
{
	struct<3> eventData;
	BOOL flag;
...
void func_169(int iParam0, BOOL bParam1) // Position - 0x9E74
{
	Hash eventData;
...
void func_170(int iParam0) // Position - 0x9EA8
{
	struct<3> eventData;
...
void func_171(int iParam0) // Position - 0x9ED3
{
	Hash eventData;

	eventData = 1123248983;
	eventData.f_1 = PLAYER::PLAYER_ID();
	eventData.f_3 = Global_2748590;
...
void func_172(int iParam0) // Position - 0x9F09
{
	struct<4> eventData;

	if (SCRIPT::GET_EVENT_DATA(SCRIPT_EVENT_QUEUE_NETWORK, iParam0, &eventData, 4))
		Global_2748590 = eventData.f_3;

	return;
}

void func_173(int iParam0) // Position - 0x9F29
{
	struct<3> eventData;
	Ped playerPed;
...
void func_174(int iParam0) // Position - 0x9F67
{
	struct<8> eventData;
	Ped playerPed;
...
void func_175(int iParam0) // Position - 0x9FD9
{
	struct<3> eventData;
...
int func_177() // Position - 0xA063
{
	return Global_1574634.f_18;
}

BOOL func_178() // Position - 0xA071
{
...
BOOL func_179() // Position - 0xA0A3
{
	return IS_BIT_SET(Global_2684748, 1);
}

BOOL func_180() // Position - 0xA0B1
{
	return IS_BIT_SET(Global_2684748, 2);
}

BOOL func_181() // Position - 0xA0BF
{
	return IS_BIT_SET(Global_2684748, 20);
}

BOOL func_182() // Position - 0xA0CE
{
	return Global_2684748.f_700;
}

BOOL _IS_FMMC_ACTIVE() // Position - 0xA0DD
{
	return Global_1845274[PLAYER::PLAYER_ID() /*877*/].f_185 != 0;
}

BOOL _SHOULD_NETWORK_SCRIPT_TERMINATE() // Position - 0xA0F4
{
...
Hash _GET_CURRENT_SESSION_TYPE_SCRIPT_HASH() // Position - 0xA178
{
	switch (func_28())
	{
		case 0:
...
BOOL _DOES_EVENT_OF_TYPE_EXIST(int iParam0) // Position - 0xA1CF
{
...
BOOL func_188() // Position - 0xA1E6
{
	return Global_2696555;
}

BOOL func_189() // Position - 0xA1F2
{
	return Global_2684748.f_695;
}

void func_190() // Position - 0xA201
{
	SYSTEM::WAIT(0);
	return;
}

void func_191() // Position - 0xA20E
{
	!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false);
	return;
}

void func_192() // Position - 0xA223
{
	func_198();
	func_196(false);
	func_83(&uLocal_393, false);
...
void func_193(var uParam0) // Position - 0xA2F0
{
	int i;
...
int func_194(var uParam0, int iParam1) // Position - 0xA315
{
...
void func_195(var uParam0) // Position - 0xA505
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
void func_196(BOOL bParam0) // Position - 0xA52A
{
	if (bParam0)
	{
		func_197();
...
void func_199(Object* pobParam0) // Position - 0xA639
{
...
void func_200(var uParam0) // Position - 0xA664
{
...
BOOL func_201(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17, var uParam18, var uParam19, var uParam20) // Position - 0xA693
{
...
void func_202(int iParam0) // Position - 0xA6E5
{
	Hash eventData;
...
int _NETWORK_ENSURE_SCRIPT_IS_NETWORKED(int iParam0, int iParam1, BOOL bNoTerminate) // Position - 0xA71B
{
	int i;
...
BOOL func_204(BOOL bParam0) // Position - 0xA831
{
	bParam0;
	return Global_1575060;
}

void func_205() // Position - 0xA842
{
	SCRIPT::TERMINATE_THIS_THREAD();
	return;
}

void func_206(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17, var uParam18, var uParam19, var uParam20, var uParam21) // Position - 0xA84E
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		func_205();
...
int func_207(int iParam0) // Position - 0xA86D
{
	switch (iParam0)
	{
		case 3:
...
int func_208(int iParam0) // Position - 0xB02B
{
	switch (iParam0)
	{
		case 150:
...
int func_209(int iParam0, BOOL bParam1) // Position - 0xB3B5
{
	switch (iParam0)
	{
		case 237:
