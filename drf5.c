...
void main() // Position - 0x0
{
	...
	MISC::SET_BIT(&(Global_114370.f_10020.f_25), 6);
...
void func_6(int iParam0) // Position - 0x1A37
{
	...
	else if (IS_BIT_SET(Global_114370.f_20568.f_471, iParam0) || IS_BIT_SET(Global_2359296[func_8() /*5571*/].f_681.f_10, iParam0))
	{
		flag = true;
		MISC::CLEAR_BIT(&(Global_114370.f_20568.f_471), iParam0);
...
void func_46() // Position - 0x27E9
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (_GET_CHARACTER_MODEL(Global_114370.f_2367.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_47(character) && !func_38(14) || Global_113318)
			{
...
void func_98() // Position - 0x3ECE
{
	func_99();
	return;
}

void func_99() // Position - 0x3EDA
{
	Global_21468 = 0;
	func_100();
	return;
...
BOOL func_101(int iParam0, Ped pedParam1, var uParam2) // Position - 0x3F0B
{
	int num;
	var animDict;
	var animDictionary;
...
struct<4> func_117(var uParam0, var uParam1, int iParam2, BOOL bParam3) // Position - 0x4681
{
	...
	if (bParam3)
		func_118(&(Global_114370.f_19965), num, true);
...
int func_121(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4) // Position - 0x47DF
{
	...
	if (iParam0 > 0 && iParam0 < 13 && !func_123(&(Global_114370.f_19965), iParam0))
		unk[iParam0] = 0;
	else if (iParam1 > 0 && iParam1 < 13 && !func_123(&(Global_114370.f_19965), iParam1))
		unk[iParam1] = 0;
	else if (iParam2 > 0 && iParam2 < 13 && !func_123(&(Global_114370.f_19965), iParam2))
		unk[iParam2] = 0;
	else if (iParam3 > 0 && iParam3 < 13 && !func_123(&(Global_114370.f_19965), iParam3))
		unk[iParam3] = 0;
	else if (iParam4 > 0 && iParam4 < 13 && !func_123(&(Global_114370.f_19965), iParam4))
		unk[iParam4] = 0;
...
void func_160(int iParam0) // Position - 0x62BB
{
	...
	func_161(&Global_79551[0 /*14*/], num6, iParam0, &unk, num2, num3, num, flag, num4, num5, false);
	return;
}
	...
	*iParam0 = iParam9;
	...
	else
	{
		...
		if (iParam1 == 11 || iParam1 == 4 || iParam1 == 6 || iParam1 == 1 || iParam1 == 14 || iParam1 == 2 || iParam1 == 8 || iParam1 == 9 || iParam1 == 10 || iParam1 == 7 || iParam1 == 12)
		{
			...
			num = func_22(func_164(iParam1, iParam0->f_2), Global_79548);
		
			if (IS_BIT_SET(num, iParam0->f_1))
				MISC::SET_BIT(&(iParam0->f_6), 1);
		
			num = func_22(func_163(iParam1, iParam0->f_2), Global_79548);
...
int func_168(int iParam0) // Position - 0xC012
{
	switch (iParam0)
	{
		case -1:
...
void func_169(int iParam0, int iParam1, int iParam2, Hash hParam3) // Position - 0xC0E6
{
	int num;
	int num2;
	Hash outfit;
	...
	if (iParam0 == 12)
	{
		...
		if (outfitIndex >= 0)
		{
			...
			if (num3 > outfitIndex)
			{
				...
				func_161(&Global_79551[0 /*14*/], iParam0, iParam1, &(outfit.f_7), 0, 0, outfit.f_2, false, -1, 2, true);
				return;
			}
		}
	}
	...
	{
		func_161(&Global_79551[0 /*14*/], iParam0, iParam1, "NO_LABEL", 0, 0, 0, true, -1, 2, true);
	}
	else if (iParam0 == 14)
	{
		...
		if (componentId >= 0)
		{
			...
			if (num5 > componentId)
			{
				...
				func_161(&Global_79551[0 /*14*/], iParam0, iParam1, &(outProp.f_9), outProp.f_3, outProp.f_4, outProp.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(outProp.f_1, joaat("OUTFIT_ONLY"), 0), num4, 2, outProp.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (hParam3 != -1 && Global_79749)
		{
			...
			func_161(&Global_79551[0 /*14*/], iParam0, iParam1, &(outComponent.f_9), outComponent.f_3, outComponent.f_4, outComponent.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(outComponent.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, outComponent.f_1 != 0);
			return;
		}
...
void func_170(int iParam0) // Position - 0xC36D
{
	BOOL flag;
	int num;
	var unk;
...
void func_171(int iParam0) // Position - 0xC4C4
{
	BOOL flag;
	int num;
	var unk;
...
void func_172(int iParam0) // Position - 0xC9D2
{
	BOOL flag;
	int num;
	var unk;
...
void func_173(int iParam0) // Position - 0xCA47
{
	BOOL flag;
	int num;
	var unk;
...
void func_174(int iParam0) // Position - 0xCABB
{
	BOOL flag;
	int num;
	var unk;
...
void func_175(int iParam0) // Position - 0xCBA2
{
	BOOL flag;
	int num;
	var unk;
...
void func_176(int iParam0) // Position - 0xCF05
{
	BOOL flag;
	int num;
	var unk;
...
void func_177(int iParam0) // Position - 0xD116
{
	BOOL flag;
	int num;
	var unk;
...
void func_178(int iParam0) // Position - 0xD346
{
	BOOL flag;
	int num;
	var unk;
...
void func_179(int iParam0) // Position - 0xD456
{
	BOOL flag;
	int num;
	var unk;
...
void func_180(int iParam0) // Position - 0xDDF5
{
	BOOL flag;
	int num;
	var unk;
...
void func_181(int iParam0) // Position - 0xE968
{
	if (iParam0 < 136)
		func_183(iParam0);
	else
...
void func_182(int iParam0) // Position - 0xE99D
{
	BOOL flag;
	int num;
	var unk;
...
void func_183(int iParam0) // Position - 0xF5A1
{
	BOOL flag;
	int num;
	var unk;
...
void func_184(int iParam0) // Position - 0x104B1
{
	BOOL flag;
	int num;
	var unk;
...
void func_185(int iParam0) // Position - 0x105DE
{
	BOOL flag;
	int num;
	var unk;
...
void func_186(int iParam0, int iParam1) // Position - 0x106DC
{
	switch (iParam0)
	{
		case 0:
...
void func_187(int iParam0) // Position - 0x107CC
{
	BOOL flag;
	int num;
	var unk;
...
void func_188(int iParam0) // Position - 0x11CBD
{
	BOOL flag;
	int num;
	var unk;
...
void func_189(int iParam0) // Position - 0x11E0E
{
	BOOL flag;
	int num;
	var unk;
...
void func_190(int iParam0) // Position - 0x12319
{
	BOOL flag;
	int num;
	var unk;
...
void func_191(int iParam0) // Position - 0x12987
{
	BOOL flag;
	int num;
	var unk;
...
void func_192(int iParam0) // Position - 0x129FB
{
	BOOL flag;
	int num;
	var unk;
...
void func_193(int iParam0) // Position - 0x12ACB
{
	BOOL flag;
	int num;
	var unk;
...
void func_194(int iParam0) // Position - 0x12FFB
{
	BOOL flag;
	int num;
	var unk;
...
void func_195(int iParam0) // Position - 0x13192
{
	BOOL flag;
	int num;
	var unk;
...
void func_196(int iParam0) // Position - 0x13990
{
	BOOL flag;
	int num;
	var unk;
...
void func_197(int iParam0) // Position - 0x13AA0
{
	BOOL flag;
	int num;
	var unk;
...
void func_198(int iParam0) // Position - 0x149CD
{
	BOOL flag;
	int num;
	var unk;
...
void func_199(int iParam0) // Position - 0x1568A
{
	if (iParam0 < 107)
		func_202(iParam0);
	else if (iParam0 < 227)
...
void func_200(int iParam0) // Position - 0x156D0
{
	BOOL flag;
	int num;
	var unk;
...
void func_201(int iParam0) // Position - 0x16175
{
	BOOL flag;
	int num;
	var unk;
...
void func_202(int iParam0) // Position - 0x16F64
{
	BOOL flag;
	int num;
	var unk;
...
void func_203(int iParam0) // Position - 0x17BAD
{
	BOOL flag;
	int num;
	var unk;
...
void func_204(int iParam0) // Position - 0x17E26
{
	BOOL flag;
	int num;
	var unk;
...
void func_205(int iParam0, int iParam1) // Position - 0x17F6C
{
	switch (iParam0)
	{
		case 0:
...
void func_206(int iParam0) // Position - 0x1805D
{
	BOOL flag;
	int num;
	var unk;
...
void func_207(int iParam0) // Position - 0x18DE7
{
	BOOL flag;
	int num;
	var unk;
...
void func_208(int iParam0) // Position - 0x18F61
{
	BOOL flag;
	int num;
	var unk;
...
void func_209(int iParam0) // Position - 0x194D8
{
	BOOL flag;
	int num;
	var unk;
...
void func_210(int iParam0) // Position - 0x19A02
{
	BOOL flag;
	int num;
	var unk;
...
void func_211(int iParam0) // Position - 0x19A76
{
	BOOL flag;
	int num;
	var unk;
...
void func_212(int iParam0) // Position - 0x19B46
{
	BOOL flag;
	int num;
	var unk;
...
void func_213(int iParam0) // Position - 0x1A01E
{
	BOOL flag;
	int num;
	var unk;
...
void func_214(int iParam0) // Position - 0x1A287
{
	BOOL flag;
	int num;
	var unk;
...
void func_215(int iParam0) // Position - 0x1A55D
{
	BOOL flag;
	int num;
	var unk;
...
void func_216(int iParam0) // Position - 0x1A726
{
	BOOL flag;
	int num;
	var unk;
...
void func_217(int iParam0) // Position - 0x1B27A
{
	BOOL flag;
	int num;
	var unk;
...
void func_218(int iParam0) // Position - 0x1BEC4
{
	if (iParam0 < 60)
		func_220(iParam0);
	else
...
void func_219(int iParam0) // Position - 0x1BEF9
{
	BOOL flag;
	int num;
	var unk;
...
struct<4> func_234(int iParam0, BOOL bParam1, BOOL bParam2, var uParam3) // Position - 0x1E52E
{
	...
	if (!func_239(&(Global_114370.f_19965), 8) && bParam1 && iParam0 != 4 && func_237(3) > 0 && MISC::GET_RANDOM_FLOAT_IN_RANGE(0, 1065353216) < 0.75f)
	{
		num = 8;
		*uParam3 = 4;
	}
	...
	{
		if (!func_239(&(Global_114370.f_19965), 1) && func_237(5) > 0)
		{
			MISC::SET_BIT(&address, 1);
			num2 = num2 + 1;
		}
	
		if (!func_239(&(Global_114370.f_19965), 2) && func_237(7) >= 2)
		{
			MISC::SET_BIT(&address, 2);
			num2 = num2 + 1;
		}
	
		if (!func_239(&(Global_114370.f_19965), 3) && func_237(8) > 0 || func_237(9) > 0 && func_237(7) > 0 && bParam1 && iParam0 != 4)
		{
			MISC::SET_BIT(&address, 3);
			num2 = num2 + 1;
		}
	
		if (!func_239(&(Global_114370.f_19965), 4) && func_237(1) > 0 && func_237(1) < 3)
		{
			MISC::SET_BIT(&address, 4);
			num2 = num2 + 1;
		}
	
		if (!func_239(&(Global_114370.f_19965), 5) && func_237(1) >= 3)
		{
			MISC::SET_BIT(&address, 5);
			num2 = num2 + 1;
		}
	
		if (!func_239(&(Global_114370.f_19965), 6) && func_237(0) > 0)
		{
			MISC::SET_BIT(&address, 6);
			num2 = num2 + 1;
		}
	
		if (!func_239(&(Global_114370.f_19965), 7))
		{
			MISC::SET_BIT(&address, 7);
			num2 = num2 + 1;
		}
	
		if (!func_239(&(Global_114370.f_19965), 8) && bParam1 && func_237(3) > 0 && iParam0 != 4)
		{
			MISC::SET_BIT(&address, 8);
			num2 = num2 + 1;
		}
	
		if (!func_239(&(Global_114370.f_19965), 9))
		{
			MISC::SET_BIT(&address, 9);
			num2 = num2 + 1;
		}
	
		if (!func_239(&(Global_114370.f_19965), 10))
		{
			MISC::SET_BIT(&address, 10);
			num2 = num2 + 1;
		}
	
		if (!func_239(&(Global_114370.f_19965), 11))
		{
	...
	if (bParam2)
		func_235(&(Global_114370.f_19965), num, true);
...
int func_236(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4) // Position - 0x1E8C7
{
	...
	if (iParam0 > 0 && iParam0 < 12 && !func_239(&(Global_114370.f_19965), iParam0))
	{
		unk[iParam0] = 0;
		flag = true;
	}

	if (iParam1 > 0 && iParam1 < 12 && !func_239(&(Global_114370.f_19965), iParam1))
	{
		unk[iParam1] = 0;
		flag = true;
	}

	if (iParam2 > 0 && iParam2 < 12 && !func_239(&(Global_114370.f_19965), iParam2))
	{
		unk[iParam2] = 0;
		flag = true;
	}

	if (iParam3 > 0 && iParam3 < 12 && !func_239(&(Global_114370.f_19965), iParam3))
	{
		unk[iParam3] = 0;
		flag = true;
	}

	if (iParam4 > 0 && iParam4 < 12 && !func_239(&(Global_114370.f_19965), iParam4))
	{
		unk[iParam4] = 0;
		flag = true;
	}
...
int func_237(int iParam0) // Position - 0x1EA92
{
	...
	{
		case 0:
			return func_238(&Global_98360, 1);
	
		case 1:
			return func_238(&Global_98362, 3);
	
		case 2:
			return func_238(&Global_98366, 1);
	
		case 3:
			return func_238(&Global_98368, 1);
	
		case 4:
			return func_238(&Global_98370, 1);
	
		case 5:
			return func_238(&Global_98372, 1);
	
		case 6:
			return func_238(&Global_98374, 1);
	
		case 7:
			return func_238(&Global_98376, 2);
	
		case 8:
			return func_238(&Global_98379, 1);
	
		case 9:
			return func_238(&Global_98381, 1);
	}
...
BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0x21BB5
{
...
var func_250(var uParam0) // Position - 0x21BDF
{
	return uParam0;
}

struct<6> func_251(int iParam0, BOOL bParam1) // Position - 0x21BE9
{
	var unk;
...
BOOL func_252(var uParam0) // Position - 0x2279F
{
...
BOOL func_253(var uParam0) // Position - 0x227D1
{
	int i;
...
void func_254(int* piParam0) // Position - 0x22818
{
	if (!func_82(piParam0))
		func_127(piParam0);
...
void func_255() // Position - 0x22830
{
	Global_24009.f_5 = 1;
	return;
}

void func_256(var uParam0, Hash hParam1, Hash hParam2, Hash hParam3, Hash hParam4, Hash hParam5, int iParam6) // Position - 0x2283E
{
...
void func_257() // Position - 0x228BE
{
...
void func_258(var uParam0) // Position - 0x228D6
{
	int i;
...
int func_259(var uParam0, Hash hParam1) // Position - 0x22906
{
	int i;
	int num;
...
int func_260(var uParam0) // Position - 0x22963
{
	int i;
...
BOOL func_261() // Position - 0x2298F
{
	int weaponHash;
...
void func_262(char* sParam0, int iParam1) // Position - 0x229F6
{
	switch (iParam1)
	{
		case 0:
...
int func_263() // Position - 0x22AD9
{
	return 4;
}

void func_264(var uParam0, Vehicle* pveParam1, Cam caParam2, int iParam3) // Position - 0x22AE2
{
	HUD::DISPLAY_HUD(true);
	HUD::DISPLAY_RADAR(true);
	func_268();
...
void func_265() // Position - 0x22BBC
{
	int i;
...
void func_266() // Position - 0x22BFA
{
	int num;
	int i;
	...
	for (i = 0; i < 10; i = i + 1)
	{
		...
		{
			case 0:
				func_267(&Global_98360, 1);
				break;
		
			case 1:
				func_267(&Global_98362, 3);
				break;
		
			case 2:
				func_267(&Global_98366, 1);
				break;
		
			case 3:
				func_267(&Global_98368, 1);
				break;
		
			case 4:
				func_267(&Global_98370, 1);
				break;
		
			case 5:
				func_267(&Global_98372, 1);
				break;
		
			case 6:
				func_267(&Global_98374, 1);
				break;
		
			case 7:
				func_267(&Global_98376, 2);
				break;
		
			case 8:
				func_267(&Global_98379, 1);
				break;
		
			case 9:
				func_267(&Global_98381, 1);
				break;
		}
	}
...
void func_267(var uParam0, int iParam1) // Position - 0x22CD4
{
	int i;
...
void func_268() // Position - 0x22CF6
{
	Global_21468 = 0;
	func_77();
	return;
...
void func_269() // Position - 0x22D06
{
	int num;
...
void func_270() // Position - 0x22D77
{
	Global_101952 = 1;
...
BOOL func_271(int iParam0) // Position - 0x22E64
{
	int num;
	int num2;
	...
	func_272(&(Global_114370.f_2367.f_539), num2);
...
void func_272(var uParam0, int iParam1) // Position - 0x22F74
{
	int i;
	int num;
	var unk;
	...
	for (i = 0; i < 3; i = i + 1)
	{
		...
		else
		{
			...
			if (!func_274(Global_114370.f_18537[i], &unk, &num2))
			{
...
void func_273(var uParam0) // Position - 0x2313A
{
	*uParam0 = -15;
	return;
}

BOOL func_274(int iParam0, var uParam1, var uParam2) // Position - 0x23148
{
	switch (iParam0)
	{
		case 11:
...
void func_275(int iParam0, BOOL bParam1) // Position - 0x23AB7
{
	if (bParam1)
...
BOOL func_277() // Position - 0x23B27
{
...
BOOL _IS_MISSION_REPEAT_ACTIVE(BOOL bExcludeBenchmark) // Position - 0x23B65
{
...
void func_279(BOOL bParam0, BOOL bParam1) // Position - 0x23B8D
{
	int num;
	int num2;
	var unk;
	...
	if (bParam0)
	{
		if (_IS_MISSION_REPEAT_ACTIVE(false) && Global_80015.f_1 == 1 && func_280(Global_80015))
		{
		}
		else
		{
...
BOOL func_280(int iParam0) // Position - 0x23C5D
{
	switch (iParam0)
	{
		case 71:
...
void func_281(int iParam0, int iParam1) // Position - 0x23C9B
{
	if (iParam0 == 146 || iParam0 == -1)
		return;
...
void func_282() // Position - 0x23CE0
{
	Global_24009.f_5 = 0;
	return;
}

var func_283(BOOL bParam0, var uParam1, var uParam2) // Position - 0x23CEE
{
	if (bParam0)
		return uParam1;
...
BOOL _GET_RANDOM_BOOL() // Position - 0x23D05
{
