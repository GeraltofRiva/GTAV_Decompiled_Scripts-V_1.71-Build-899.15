...
void main() // Position - 0x0
{
	...
	fLocal_190 = 100f;
	fLocal_204 = 0.5f;
	TEXT_LABEL_ASSIGN_STRING(&uLocal_212, "CELL_37" /*Quick Join*/, 16);
	TEXT_LABEL_ASSIGN_STRING(&uLocal_216, "CELL_249" /*Are you sure?*/, 16);
	TEXT_LABEL_ASSIGN_STRING(&uLocal_220, "CELL_206" /*BACK*/, 16);
	TEXT_LABEL_ASSIGN_STRING(&uLocal_224, "CELL_212" /*YES*/, 16);
	TEXT_LABEL_ASSIGN_STRING(&uLocal_228, "CELL_213" /*NO*/, 16);
	TEXT_LABEL_ASSIGN_STRING(&uLocal_232, "", 24);
	iLocal_239 = 6;
	iLocal_252 = -1;
	MISC::NETWORK_SET_SCRIPT_IS_SAFE_FOR_NETWORK_GAME();
	iLocal_240 = func_413(&uLocal_311, 0);
	iLocal_240 > 0;
	func_412();
	func_411(&uLocal_317);
	...
	Global_2685690.f_1.f_2802 = 0;
	Global_1979530.f_5 = 0;
			...
			switch (iLocal_210)
			{
				case 0:
					switch (iLocal_310)
					{
						...
						case 1:
							if (func_348(FRONTEND_CONTROL, Global_21209, 0))
								if (func_347())
									func_408();
...
void func_2() // Position - 0x2B4
{
	...
	if (iLocal_313 == 0)
		if (func_348(FRONTEND_CONTROL, Global_21208, 0))
			iLocal_313 = 1;
	else if (func_195(FRONTEND_CONTROL, Global_21208) && !bLocal_241)
		func_3();
...
void func_3() // Position - 0x380
{
	...
	if (func_175(iLocal_211))
	{
			...
			case 0:
				switch (uLocal_261[iLocal_251])
				{
					...
					case 6:
						...
						{
							num = func_169(num3);
							num2 = func_167(Global_262145.f_4731[num3 /*51*/][num], true);
					...
					case 8:
						...
						{
							num = func_169(num3);
							num2 = func_167(Global_262145.f_4731[num3 /*51*/][num], false);
		...
		if (iLocal_211 == 1 && uLocal_284[iLocal_251] == 0 || iLocal_211 == 1 && uLocal_284[iLocal_251] == 1 && !Global_262145.f_4368)
		{
			if (iLocal_252 == 0 && bLocal_243)
			{
				func_135();
				func_132(false, 32);
			}
			else if (iLocal_252 == 2 || iLocal_252 == 1 && bLocal_243 == false)
			{
				func_131();
			}
		}
		else if (iLocal_252 == 0 && bLocal_243)
		{
			func_135();
			func_132(false, 32);
		}
		...
		else if (Global_262145.f_4366 == 0 && iLocal_244 == 0)
		{
			if (iLocal_252 == 1 && bLocal_243 || iLocal_252 == 0 && !bLocal_243)
			{
				func_153(1);
				func_152(0);
			}
		...
		if (NETWORK::NETWORK_IS_PLAYER_ACTIVE(plParam0) && PLAYER::IS_PLAYER_PLAYING(plParam0) || bParam3 == true)
		{
			...
			else
			{
				if (!func_13(playerPed) && !ENTITY::IS_ENTITY_ATTACHED_TO_ANY_VEHICLE(playerPed))
				{
					...
					if (func_10(*Global_4718592.f_197275))
...
Vector3 func_27(Player plParam0) // Position - 0x1A28
{
	...
	if (HUD::DOES_BLIP_EXIST(Global_2647055[plParam0]))
		vector = { func_103(Global_2647055[plParam0]) };
	else if (HUD::DOES_BLIP_EXIST(Global_2647055.f_33[plParam0]) && !(plParam0 == Global_2672967))
		vector = { func_103(Global_2647055.f_33[plParam0]) };
...
Vector3 func_28(Player plParam0) // Position - 0x1A9C
{
	...
	{
		vector = { func_99(func_100(Global_1845274[PLAYER::PLAYER_ID() /*877*/].f_260.f_36)) };
...
Vector3 func_33(Player plParam0) // Position - 0x1D3D
{
		...
		if (player != _INVALID_PLAYER_INDEX())
		{
			if (!func_92(player))
			{
				if (ENTITY::DOES_ENTITY_EXIST(Global_2672967.f_264[player /*3*/][1]))
					...
					return Global_2658019[func_93(plParam0) /*467*/].f_324.f_13;
			}
			else
			{
				num = func_89(player);
		...
		if (player5 != _INVALID_PLAYER_INDEX())
		{
			if (!func_73(player5) && !func_72(player5))
			{
				if (ENTITY::DOES_ENTITY_EXIST(Global_2672967.f_361[player5]))
					...
					return Global_2658019[func_74(plParam0) /*467*/].f_324.f_21;
			}
	...
	else if (func_53(plParam0, false))
	{
		...
		if (player8 != _INVALID_PLAYER_INDEX())
		{
			...
			{
				return Global_1888882[func_52(plParam0) /*611*/].f_593;
			}
		}
	}
	...
	if (func_66(plParam0))
		return func_60(Global_2658019[plParam0 /*467*/].f_324.f_8);
	...
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2658019[plParam0 /*467*/].f_324.f_8 != -1)
				return func_36(Global_2658019[plParam0 /*467*/].f_324.f_8) == 19;
...
BOOL func_37(Player plParam0) // Position - 0x294C
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2658019[plParam0 /*467*/].f_324.f_8 != -1)
				return func_36(Global_2658019[plParam0 /*467*/].f_324.f_8) == 15;

	return false;
}

BOOL func_38(Player plParam0) // Position - 0x2993
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2658019[plParam0 /*467*/].f_324.f_8 != -1)
				return func_36(Global_2658019[plParam0 /*467*/].f_324.f_8) == 16;

	return false;
}

BOOL func_39(Player plParam0) // Position - 0x29DA
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2658019[plParam0 /*467*/].f_324.f_8 != -1)
				return func_36(Global_2658019[plParam0 /*467*/].f_324.f_8) == 14;

	return false;
}

Player func_40(Player plParam0) // Position - 0x2A21
{
	int num;
...
Player func_41(Player plParam0) // Position - 0x2AB0
{
	if (func_22(plParam0))
...
BOOL func_42(Player plParam0, BOOL bParam1) // Position - 0x2AD3
{
	if (!func_22(plParam0))
		return false;
	...
	return func_22(Global_1888882[plParam0 /*611*/].f_10);
}

BOOL func_43(Player plParam0) // Position - 0x2B0B
{
	if (func_22(plParam0))
		if (func_22(Global_1888882[plParam0 /*611*/].f_10))
			return Global_1888882[plParam0 /*611*/].f_10 == plParam0;

	return false;
}

int func_44(Player plParam0) // Position - 0x2B40
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
...
BOOL func_45(Player plParam0) // Position - 0x2BAF
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2658019[plParam0 /*467*/].f_324.f_8 != -1)
				return func_36(Global_2658019[plParam0 /*467*/].f_324.f_8) == 20;
...
BOOL func_46(Player plParam0) // Position - 0x2C46
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2658019[plParam0 /*467*/].f_324.f_8 != -1)
				return func_36(Global_2658019[plParam0 /*467*/].f_324.f_8) == 13;

	return false;
}

int func_47(Player plParam0) // Position - 0x2C8D
{
	int num;
...
int func_48(int iParam0) // Position - 0x2CB6
{
	switch (iParam0)
	{
		case 1:
...
int func_49(Player plParam0) // Position - 0x2CD1
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
...
BOOL func_50(Player plParam0) // Position - 0x2CF5
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
...
BOOL func_51(Player plParam0) // Position - 0x2D1B
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
...
Player func_52(Player plParam0) // Position - 0x2D40
{
	if (plParam0 == _INVALID_PLAYER_INDEX())
		return plParam0;
...
BOOL func_53(Player plParam0, BOOL bParam1) // Position - 0x2D64
{
	...
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2658019[plParam0 /*467*/].f_324.f_8 != -1 && Global_2658019[plParam0 /*467*/].f_324.f_11 != _INVALID_PLAYER_INDEX())
				return func_36(Global_2658019[plParam0 /*467*/].f_324.f_8) == 12;

	return false;
}

int func_54(Player plParam0) // Position - 0x2DF2
{
	int num;
...
int func_55(int iParam0) // Position - 0x2E1B
{
	switch (iParam0)
	{
		case 1:
...
int func_56(Player plParam0) // Position - 0x2E99
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
...
BOOL func_57(Player plParam0) // Position - 0x2EBD
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
...
BOOL func_58(Player plParam0) // Position - 0x2EE6
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (func_59(plParam0) && Global_2658019[plParam0 /*467*/].f_324.f_11 == plParam0)
			return true;

	return false;
}

BOOL func_59(Player plParam0) // Position - 0x2F1B
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2658019[plParam0 /*467*/].f_324.f_8 != -1)
				return func_36(Global_2658019[plParam0 /*467*/].f_324.f_8) == 11;

	return false;
}

Vector3 func_60(int iParam0) // Position - 0x2F62
{
	switch (iParam0)
	{
		case 102:
...
int func_61(Player plParam0) // Position - 0x306E
{
	int num;
...
int func_62(int iParam0) // Position - 0x3097
{
	switch (iParam0)
	{
		case 1:
...
int func_63(Player plParam0) // Position - 0x3115
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
...
BOOL func_64(Player plParam0) // Position - 0x3139
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
...
BOOL func_65(Player plParam0) // Position - 0x315F
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (func_66(plParam0) && Global_2658019[plParam0 /*467*/].f_324.f_11 == plParam0)
			return true;

	return false;
}

BOOL func_66(Player plParam0) // Position - 0x3194
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2658019[plParam0 /*467*/].f_324.f_8 != -1)
...
BOOL func_67(Player plParam0) // Position - 0x31DB
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2658019[plParam0 /*467*/].f_324.f_8 != -1)
				return func_36(Global_2658019[plParam0 /*467*/].f_324.f_8) == 10;

	return false;
}

int func_68(Player plParam0) // Position - 0x3222
{
	int num;
...
int func_69(int iParam0) // Position - 0x3251
{
	switch (iParam0)
	{
		case 1:
...
int func_70(Player plParam0) // Position - 0x32A7
{
	if (plParam0 == _INVALID_PLAYER_INDEX())
		return 0;
...
BOOL func_71(Player plParam0) // Position - 0x32CB
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
...
BOOL func_72(Player plParam0) // Position - 0x32F1
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
...
BOOL func_73(Player plParam0) // Position - 0x3317
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
...
Player func_74(Player plParam0) // Position - 0x333C
{
	if (plParam0 == _INVALID_PLAYER_INDEX())
		return plParam0;
...
BOOL func_75(Player plParam0) // Position - 0x3360
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2658019[plParam0 /*467*/].f_324.f_8 != -1 && Global_2658019[plParam0 /*467*/].f_324.f_11 != _INVALID_PLAYER_INDEX())
				return func_36(Global_2658019[plParam0 /*467*/].f_324.f_8) == 8;

	return false;
}

int func_76(Player plParam0) // Position - 0x33C0
{
	int num;
...
int func_77(int iParam0) // Position - 0x33EF
{
	switch (iParam0)
	{
		case 1:
...
int func_78(Player plParam0) // Position - 0x347D
{
	if (plParam0 == _INVALID_PLAYER_INDEX())
		return 0;
...
BOOL func_79(Player plParam0) // Position - 0x34A1
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
...
BOOL func_81(Player plParam0) // Position - 0x34ED
{
	if (plParam0 == _INVALID_PLAYER_INDEX())
		return false;

	if (func_82(plParam0) && Global_2658019[plParam0 /*467*/].f_324.f_11 == plParam0)
		return true;

	return false;
}

BOOL func_82(Player plParam0) // Position - 0x3526
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2658019[plParam0 /*467*/].f_324.f_8 != -1)
				return func_36(Global_2658019[plParam0 /*467*/].f_324.f_8) == 9;

	return false;
}

BOOL func_83(Player plParam0) // Position - 0x356D
{
	if (plParam0 == _INVALID_PLAYER_INDEX())
		return false;

	if (func_84(plParam0) && Global_2658019[plParam0 /*467*/].f_324.f_11 == plParam0)
		return true;

	return false;
}

BOOL func_84(Player plParam0) // Position - 0x35A6
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2658019[plParam0 /*467*/].f_324.f_8 != -1)
				return func_36(Global_2658019[plParam0 /*467*/].f_324.f_8) == 4;

	return false;
}

BOOL func_85(Player plParam0) // Position - 0x35EC
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2658019[plParam0 /*467*/].f_324.f_8 != -1)
				return func_36(Global_2658019[plParam0 /*467*/].f_324.f_8) == 6;

	return false;
}

BOOL func_86(Player plParam0) // Position - 0x3632
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
...
Player func_87(Player plParam0) // Position - 0x3658
{
	if (plParam0 == _INVALID_PLAYER_INDEX())
		return plParam0;
...
BOOL func_88(Player plParam0) // Position - 0x367C
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2658019[plParam0 /*467*/].f_324.f_8 != -1 && Global_2658019[plParam0 /*467*/].f_324.f_11 != _INVALID_PLAYER_INDEX())
				return func_36(Global_2658019[plParam0 /*467*/].f_324.f_8) == 25;

	return false;
}

int func_89(Player plParam0) // Position - 0x36DC
{
	int num;
...
int func_90(int iParam0) // Position - 0x370B
{
	switch (iParam0)
	{
		case 1:
...
int func_91(Player plParam0) // Position - 0x38DB
{
	if (plParam0 == _INVALID_PLAYER_INDEX())
		return 0;
...
BOOL func_92(Player plParam0) // Position - 0x3901
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
...
Player func_93(Player plParam0) // Position - 0x3924
{
	if (plParam0 == _INVALID_PLAYER_INDEX())
		return plParam0;
...
BOOL func_94(Player plParam0) // Position - 0x3948
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2658019[plParam0 /*467*/].f_324.f_8 != -1 && Global_2658019[plParam0 /*467*/].f_324.f_11 != _INVALID_PLAYER_INDEX())
				return func_36(Global_2658019[plParam0 /*467*/].f_324.f_8) == 5;

	return false;
}

BOOL func_95(Player plParam0) // Position - 0x39A7
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
...
void func_96(var uParam0, var uParam1, var uParam2, var uParam3) // Position - 0x3A0D
{
	int num;
	int num2;
...
BOOL func_97(Vector3 vParam0, var uParam1, var uParam2, int iParam3, int iParam4) // Position - 0x3B51
{
	int i;
	var unk;
	var unk11;
...
Vector3 _GET_PLAYER_COORDS(Player plParam0) // Position - 0x3EA5
{
	return ENTITY::GET_ENTITY_COORDS(PLAYER::GET_PLAYER_PED(plParam0), false);
}

Vector3 func_99(int iParam0) // Position - 0x3EB8
{
	var unk;
...
int func_108(var uParam0, int iParam1, Hash hParam2, Hash hParam3, Hash hParam4, int iParam5, int iParam6, int iParam7) // Position - 0x58B4
{
	BOOL flag;
	BOOL flag2;
	int i;
...
void func_109(int iParam0, Hash hParam1, int iParam2, int iParam3, int iParam4) // Position - 0x5A61
{
	switch (hParam1)
	{
		case joaat("SERVICE_SPEND_BETTING"):
...
void func_110(int iParam0) // Position - 0x5A99
{
	BOOL flag;
...
void func_111(var uParam0) // Position - 0x5AED
{
	uParam0->f_65 = 0;
...
void func_112(var uParam0) // Position - 0x5BF4
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
BOOL func_113(int iParam0) // Position - 0x5C3C
{
...
void func_114(int iParam0, Hash hParam1) // Position - 0x5C67
{
...
int func_115(int iParam0, int iParam1, Hash hParam2, Hash hParam3, Hash hParam4, int iParam5, BOOL bParam6, int iParam7, int iParam8, int iParam9, BOOL bParam10) // Position - 0x5C7B
{
	int i;
	...
	for (i = 0; i < 15; i = i + 1)
	{
		if (Global_4537182[i /*84*/].f_65.f_2 == 0)
		{
			...
			if (iParam1 == joaat("NET_SHOP_TTYPE_SERVICE") && bParam10)
				func_116(Global_4537182[i /*84*/], i);
...
int func_117(Player plParam0) // Position - 0x5E3B
{
	var address;
...
BOOL _NETSHOPPING_SHOULD_USE_TRANSACTION_SYSTEM() // Position - 0x5E56
{
...
void func_119(int iParam0, int iParam1, int iParam2, float fParam3) // Position - 0x5E6D
{
	int num;
	int num2;
	float num3;
...
void func_120(int iParam0, BOOL bParam1) // Position - 0x5EF0
{
	bParam1;
	iParam0 = iParam0;
	return;
...
struct<13> GET_GAMER_HANDLE_PLAYER(Player plParam0) // Position - 0x5F01
{
	var gamerHandle;
...
int func_122(int iParam0) // Position - 0x5F18
{
	int num;
...
int func_123(int iParam0) // Position - 0x5F42
{
	switch (iParam0)
	{
		case 1:
...
BOOL func_124() // Position - 0x6154
{
	return IS_BIT_SET(func_125(6427, -1), 19);
}

BOOL func_125(int iParam0, int iParam1) // Position - 0x6167
{
	Hash statHash;
	int outValue;
...
Hash func_126(int iParam0, int iParam1) // Position - 0x6196
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(0, iParam0, func_127(iParam1));
}

int func_127(int iParam0) // Position - 0x61AB
{
	int num;
	int num2;
...
int func_128(int iParam0) // Position - 0x61DF
{
	switch (iParam0)
	{
		case 1:
...
void func_129(int iParam0) // Position - 0x6549
{
	Global_1057440 = iParam0;
	return;
}

BOOL func_130() // Position - 0x6557
{
	return Global_1575041 == 10;
}

void func_131() // Position - 0x6566
{
	MISC::SET_BIT(&(Global_2684748.f_2), 26);
	return;
}

void func_132(BOOL bParam0, int iParam1) // Position - 0x657A
{
	int i;
	var gamerHandle;
	Player player;

	Global_2685690.f_3924 = 0;

	for (i = 0; i < 32; i = i + 1)
	{
		Global_2685690.f_3924.f_1[i /*13*/] = { gamerHandle };
	}

	Global_2685690.f_3924.f_1[0 /*13*/] = { GET_GAMER_HANDLE_PLAYER(PLAYER::PLAYER_ID()) };
	Global_2685690.f_3924 = 1;

	for (i = 0; i < 32; i = i + 1)
	{
		player = PLAYER::INT_TO_PLAYERINDEX(i);
	
		if (NETWORK::NETWORK_IS_PLAYER_ACTIVE(player) && player != PLAYER::PLAYER_ID() && Global_2685690.f_3924 < iParam1)
		{
			...
			if (bParam0 || NETWORK::NETWORK_IS_FRIEND(&gamerHandle) && i < 32)
			{
				...
				{
					Global_2685690.f_3924.f_1[Global_2685690.f_3924 /*13*/] = { gamerHandle };
					Global_2685690.f_3924 = Global_2685690.f_3924 + 1;
				}
			}
		}
	}
...
BOOL func_133(Player plParam0) // Position - 0x6671
{
...
BOOL func_134(Player plParam0) // Position - 0x6694
{
	return Global_1845274[plParam0 /*877*/].f_185 != 0;
}

void func_135() // Position - 0x66A9
{
	MISC::SET_BIT(&(Global_2684748.f_2), 9);
	return;
}

void func_136() // Position - 0x66BD
{
...
void func_139() // Position - 0x673D
{
	MISC::SET_BIT(&(Global_2684748.f_3), 5);
	return;
}

void func_140() // Position - 0x6750
{
	MISC::SET_BIT(&(Global_2684748.f_3), 14);
	return;
}

void func_141() // Position - 0x6764
{
	MISC::SET_BIT(&(Global_2684748.f_3), 17);
	return;
}

void func_142() // Position - 0x6778
{
	MISC::SET_BIT(&(Global_2684748.f_2), 21);
	return;
}

Hash func_143(BOOL bParam0) // Position - 0x678C
{
	var string2;
	...
	if (Global_262145.f_9103 == *Global_4718592.f_138116)
		return Global_262145.f_9105;

	return *Global_4718592.f_138116;
}

struct<6> func_144() // Position - 0x67F3
{
	var unk;
	int contentIdIndex;
	BOOL contentId;
...
void func_145(int iParam0) // Position - 0x688D
{
	Global_2685690.f_6519 = iParam0;
	return;
}

int func_146(BOOL bParam0) // Position - 0x689E
{
...
int func_147(BOOL bParam0) // Position - 0x68D6
{
	int num;
	BOOL flag;
...
void func_148(int iParam0, BOOL bParam1, int iParam2, BOOL bParam3) // Position - 0x691A
{
	Hash statName;
...
int _GET_RANDOM_BOOL() // Position - 0x6948
{
...
void func_150() // Position - 0x6966
{
	MISC::SET_BIT(&(Global_2684748.f_3), 6);
	return;
}

void func_151() // Position - 0x6979
{
	MISC::SET_BIT(&(Global_2684748.f_3), 9);
	return;
}

void func_152(int iParam0) // Position - 0x698D
{
	if (iParam0 == -1)
...
void func_153(int iParam0) // Position - 0x69B7
{
	func_154();
...
void func_154() // Position - 0x69FC
{
	MISC::SET_BIT(&(Global_1845274[PLAYER::PLAYER_ID() /*877*/].f_36.f_18), 5);
	return;
}

void func_155() // Position - 0x6A18
{
	MISC::SET_BIT(&(Global_2684748.f_3), 12);
	return;
}

void func_156() // Position - 0x6A2C
{
	MISC::SET_BIT(&(Global_2684748.f_3), 3);
	return;
}

int func_157() // Position - 0x6A3F
{
	return func_158(2);
}

int func_158(int iParam0) // Position - 0x6A4C
{
	int i;
...
Hash func_159(int iParam0) // Position - 0x6A7D
{
	if (iParam0 > 50)
		iParam0 = 0;
...
int func_162(int iParam0) // Position - 0x6AE4
{
	int i;
...
void func_163() // Position - 0x6B15
{
	MISC::SET_BIT(&(Global_2684748.f_3), 2);
	return;
}

void func_164(var uParam0) // Position - 0x6B28
{
	Global_2684748.f_42 = uParam0;
	return;
}

void func_165(char* sParam0) // Position - 0x6B38
{
...
BOOL func_166() // Position - 0x6B5C
{
	return IS_BIT_SET(Global_2685690.f_1.f_2809, 5);
}

int func_167(Hash hParam0, BOOL bParam1) // Position - 0x6B6F
{
	int num;
...
Hash func_168(int iParam0, int iParam1) // Position - 0x6B9C
{
...
BOOL func_171(int iParam0) // Position - 0x6C23
{
	BOOL flag;

	if (iParam0 != -1 && Global_262145.f_6951[iParam0] == 129 && Global_1836912.f_37[iParam0] != -1)
	{
...
BOOL func_172() // Position - 0x6C76
{
	return IS_BIT_SET(func_125(2482, -1), 1);
}

int func_173() // Position - 0x6C88
{
	return func_158(129);
}

void func_174() // Position - 0x6C96
{
	char* str;
...
BOOL func_175(int iParam0) // Position - 0x6CA9
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_177() // Position - 0x6DE6
{
	return Global_1575076;
}

BOOL func_178(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x6DF2
{
	int num;
	int num2;
...
BOOL func_180() // Position - 0x6FD0
{
	return Global_1575078;
}

BOOL func_181(Player plParam0, int iParam1) // Position - 0x6FDC
{
	if (!func_185())
		return false;
	...
	return func_182(&(Global_1845274[plParam0 /*877*/].f_816), func_183(iParam1));
}

BOOL func_182(var uParam0, int iParam1) // Position - 0x701C
{
	int num;
	int num2;
	int num3;
...
int func_183(int iParam0) // Position - 0x703F
{
	switch (iParam0)
	{
		case 86:
...
BOOL func_187(int iParam0, int iParam1) // Position - 0x7293
{
	Hash statHash;
	BOOL outValue;
...
Hash func_188(int iParam0, int iParam1) // Position - 0x72B7
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(2, iParam0, func_127(iParam1));
}

BOOL func_189(BOOL bParam0) // Position - 0x72CC
{
	if (bParam0)
		return func_192();
...
BOOL func_190(int iParam0) // Position - 0x72E8
{
	return iParam0 > 0 && iParam0 < 6;
}

int func_191() // Position - 0x72FD
{
	return Global_1908496[PLAYER::PLAYER_ID() /*313*/].f_273;
}

BOOL func_192() // Position - 0x7313
{
	return func_187(526, -1) || unk_0xB233964AC562A357() && func_194() != 0 && !func_193(0);
}

BOOL func_193(int iParam0) // Position - 0x7343
{
	int num;

	num = func_125(15548, -1);
	return IS_BIT_SET(num, iParam0);
}

int func_194() // Position - 0x735A
{
	return unk_0xA0A0D77ECEDD4136();
}

BOOL func_195(eControlType ectParam0, eControlAction ecaParam1) // Position - 0x7366
{
...
void func_196() // Position - 0x73C1
{
	...
	if (func_209(PLAYER::PLAYER_ID()))
	{
		...
		{
			if (func_202(true))
				TEXT_LABEL_ASSIGN_STRING(&uLocal_232, "PHINVQUITBBB" /*You will be given a Bad Sport increase for leaving during Club Work, are you sure?*/, 24);
			else
				TEXT_LABEL_ASSIGN_STRING(&uLocal_232, "PHINVQUITBB" /*You will be given a Bad Sport increase for leaving during CEO business, are you sure?*/, 24);
	...
	{
		TEXT_LABEL_ASSIGN_STRING(&uLocal_232, "PHINVQUITB" /*You will be given a Bad Sport increase for leaving during a Freemode Event, are you sure?*/, 24);
		flag = true;
	}

	if (func_198())
	{
		TEXT_LABEL_ASSIGN_STRING(&uLocal_232, "PHINVQUIT" /*You will be removed from the Event, are you sure?*/, 24);
		flag = true;
	}

	flag;
	_DISPLAY_HELP_TEXT(&uLocal_232, -1);
	return;
}

void _DISPLAY_HELP_TEXT(char* text, int iParam1) // Position - 0x7438
{
...
BOOL func_199(Player plParam0, int iParam1) // Position - 0x7479
{
...
BOOL func_200(Player plParam0) // Position - 0x7499
{
	Player player;
...
BOOL func_201(Player plParam0) // Position - 0x74BC
{
...
BOOL func_202(BOOL bParam0) // Position - 0x74DF
{
	return func_203(PLAYER::PLAYER_ID(), bParam0);
}

BOOL func_203(Player plParam0, BOOL bParam1) // Position - 0x74F1
{
	return func_204(plParam0, bParam1, 1);
}

int func_204(Player plParam0, BOOL bParam1, int iParam2) // Position - 0x7502
{
	Player player;
	...
	if (func_22(player) && Global_1888882[player /*611*/].f_10.f_431 == iParam2)
		return 1;

	return 0;
}

BOOL func_205(Player plParam0, int iParam1) // Position - 0x755E
{
	if (func_22(plParam0))
		if (func_22(Global_1888882[plParam0 /*611*/].f_10))
...
BOOL func_206(int iParam0) // Position - 0x75AD
{
	switch (iParam0)
	{
		case 318:
...
int func_207(Player plParam0) // Position - 0x75CD
{
	if (func_22(plParam0))
...
BOOL func_208(Player plParam0, BOOL bParam1) // Position - 0x75F9
{
	if (func_22(plParam0))
...
BOOL func_209(Player plParam0) // Position - 0x763D
{
	Player player;
...
BOOL func_210(Player plParam0, int iParam1) // Position - 0x765B
{
	return IS_BIT_SET(Global_1888882[plParam0 /*611*/].f_10.f_4, iParam1);
}

void func_211() // Position - 0x7673
{
	if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), false))
...
void func_212() // Position - 0x7694
{
	int value;
	BOOL flag;

	bLocal_241 = false;
	func_230(Global_21220, "SET_DATA_SLOT_EMPTY", 18f, -1082130432, -1082130432, -1082130432, -1082130432);
	func_229(Global_21220, "SET_DATA_SLOT", 18f, 0f, 0f, -1f, -1f, "CELL_208" /*Call*/, 0, 0, 0, 0);
	flag = true;

	if (iLocal_211 == 1 && uLocal_284[iLocal_251] == 0 && !Global_262145.f_4368)
	{
		if (bLocal_243)
		{
	...
	else
	{
		...
		if (Global_262145.f_4366 == 0)
		{
			...
			if (iLocal_211 == 0 && uLocal_261[iLocal_251] == 21)
			{
				if (Global_1836912.f_36 == -2)
				{
					GRAPHICS::BEGIN_TEXT_COMMAND_SCALEFORM_STRING("CELL_JIPPRP" /*You don't own a Personal Vehicle.*/);
					flag = false;
				}
				else if (Global_1836912.f_36 == -3)
				{
					GRAPHICS::BEGIN_TEXT_COMMAND_SCALEFORM_STRING("CELL_JIPPRV" /*You don't own the ~a~.*/);
					HUD::ADD_TEXT_COMPONENT_SUBSTRING_TEXT_LABEL(VEHICLE::GET_DISPLAY_NAME_FROM_VEHICLE_MODEL(Global_1836912.f_88));
					flag = false;
				}
				else if (Global_1836912.f_36 == 0)
				{
					GRAPHICS::BEGIN_TEXT_COMMAND_SCALEFORM_STRING("CELL_JIPPRC" /*You don't own a vehicle in the ~a~ class.*/);
					HUD::ADD_TEXT_COMPONENT_SUBSTRING_TEXT_LABEL(AUDIO_SPEECH_GET_PARAM_STRING_FROM_ENUM(func_228()));
					flag = false;
				}
				else if (Global_1836912.f_36 == -4)
				{
				...
				else if (func_222())
				{
					...
					HUD::ADD_TEXT_COMPONENT_SUBSTRING_TIME((Global_1836912.f_4 - NETWORK::GET_CLOUD_TIME_AS_INT()) * 1000, 14);
					flag = false;
				}
				else
				{
	...
	func_230(Global_21220, "DISPLAY_VIEW", 18f, -1082130432, -1082130432, -1082130432, -1082130432);

	if (iLocal_211 == 1)
	{
		if (uLocal_284[iLocal_251] == 2 && !func_221())
		{
			if (!IS_BIT_SET(Global_2740191.f_1880, 30))
			{
				...
				MISC::SET_BIT(&(Global_2740191.f_1880), 30);
			}
		}
		else if (uLocal_284[iLocal_251] == 3 && !func_219())
		{
			if (!IS_BIT_SET(Global_2740191.f_1880, 31))
			{
				...
				MISC::SET_BIT(&(Global_2740191.f_1880), 31);
			}
		}
		else if (uLocal_284[iLocal_251] == 0 && !Global_262145.f_4368)
		{
			func_216(&uLocal_212);
		}
	}
	...
	if (flag)
		func_213(13, &uLocal_224, 1, "", 4, &uLocal_220, &uLocal_317);
	else
		func_213(1, "", 1, "", 4, &uLocal_220, &uLocal_317);

	return;
}

void func_213(int iParam0, char* sParam1, int iParam2, char* sParam3, int iParam4, char* sParam5, int* piParam6) // Position - 0x7AAB
{
...
void func_214(int iParam0, int iParam1, char* sParam2, int iParam3, int* piParam4, int iParam5) // Position - 0x7ADB
{
	if (iParam1 == 1)
	{
		func_229(Global_21220, "SET_SOFT_KEYS", SYSTEM::TO_FLOAT(iParam0), 0f, SYSTEM::TO_FLOAT(iParam1), -1f, -1f, 0, 0, 0, 0, 0);
	...
	if (Global_21227)
	{
		func_229(Global_21220, "SET_SOFT_KEYS", SYSTEM::TO_FLOAT(iParam0), 1f, SYSTEM::TO_FLOAT(iParam1), -1f, -1f, sParam2, 0, 0, 0, 0);
		MISC::SET_BIT(piParam4, iParam3);
		func_215(iParam5, true);
		return;
	}

	func_229(Global_21220, "SET_SOFT_KEYS", SYSTEM::TO_FLOAT(iParam0), 1f, SYSTEM::TO_FLOAT(iParam1), -1f, -1f, 0, 0, 0, 0, 0);
	MISC::SET_BIT(piParam4, iParam3);
	func_215(iParam5, true);
	return;
}

void func_215(int iParam0, BOOL bParam1) // Position - 0x7B80
{
	if (iParam0 == -1)
		return;
...
void func_216(char* sParam0) // Position - 0x7BAB
{
	func_217(Global_21220, "SET_HEADER", sParam0, 0, 0, 0, 0);
	return;
}

void func_217(int iParam0, char* sParam1, const char* sParam2, const char* sParam3, const char* sParam4, const char* sParam5, const char* sParam6) // Position - 0x7BC4
{
...
void func_218(const char* sParam0) // Position - 0x7C1F
{
...
BOOL func_219() // Position - 0x7C31
{
	return NETWORK::GET_CLOUD_TIME_AS_INT() >= _MPPLY_STAT_GET_INT(joaat("MPPLY_H4_COOLDOWN"));
}

int _MPPLY_STAT_GET_INT(Hash hParam0) // Position - 0x7C47
{
	Hash statHash;
	int outValue;
...
BOOL func_221() // Position - 0x7C65
{
	return NETWORK::GET_CLOUD_TIME_AS_INT() >= _MPPLY_STAT_GET_INT(joaat("MPPLY_H3_COOLDOWN"));
}

BOOL func_222() // Position - 0x7C7B
{
	func_223();
	return NETWORK::GET_CLOUD_TIME_AS_INT() < Global_1836912.f_4;
}

void func_223() // Position - 0x7C92
{
	if (Global_1836912.f_4 == -1)
		Global_1836912.f_4 = _MPPLY_STAT_GET_INT(joaat("MPPLY_LAST_PROF_RACE_WON"));

	return;
}

int func_224() // Position - 0x7CB3
{
	return Global_262145.f_6947;
}

BOOL func_225() // Position - 0x7CC2
{
	int num;
...
int func_226(BOOL bParam0) // Position - 0x7CF1
{
	int vcBankBalance;
...
char* AUDIO_SPEECH_GET_PARAM_STRING_FROM_ENUM(int iParam0) // Position - 0x7D10
{
	switch (iParam0)
	{
		case 0:
...
int func_228() // Position - 0x7E75
{
	if (Global_1836912.f_62[func_157()] != -1)
		return Global_262145.f_6156[Global_1836912.f_62[func_157()]];

	return -1;
}

void func_229(int iParam0, char* sParam1, float fParam2, float fParam3, float fParam4, float fParam5, float fParam6, char* sParam7, const char* sParam8, const char* sParam9, const char* sParam10, const char* sParam11) // Position - 0x7EA6
{
	GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iParam0, sParam1);
...
void func_230(int iParam0, char* sParam1, float fParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x7F59
{
	GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iParam0, sParam1);
	GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(SYSTEM::ROUND(fParam2));
...
BOOL func_232() // Position - 0x808C
{
	if (iLocal_211 == 1)
		if (iLocal_251 > -1 && iLocal_251 < 4 && uLocal_289[iLocal_251] == 3)
			return true;

	return false;
}

BOOL func_233() // Position - 0x80BD
{
	if (iLocal_211 == 1)
		if (iLocal_251 > -1 && iLocal_251 < 4 && uLocal_289[iLocal_251] == 2)
			return true;

	return false;
}

BOOL func_234() // Position - 0x80EE
{
	if (iLocal_211 == 2)
		if (iLocal_251 > -1 && iLocal_251 < 6 && uLocal_289[iLocal_251] == 1)
			return true;

	return false;
}

BOOL func_235() // Position - 0x811F
{
	if (iLocal_211 == 2)
		if (iLocal_251 > -1 && iLocal_251 < 6 && uLocal_289[iLocal_251] == 2)
			return true;

	return false;
}

BOOL func_236() // Position - 0x8150
{
	if (iLocal_211 == 2)
		if (iLocal_251 > -1 && iLocal_251 < 6 && uLocal_289[iLocal_251] == 3)
			return true;

	return false;
}

BOOL func_237() // Position - 0x8181
{
	if (iLocal_211 == 2)
		if (iLocal_251 > -1 && iLocal_251 < 6 && uLocal_289[iLocal_251] == 4)
			return true;

	return false;
}

BOOL func_238() // Position - 0x81B2
{
	if (iLocal_211 == 0)
		if (iLocal_251 > -1 && iLocal_251 < 22 && uLocal_261[iLocal_251] == 21)
			return true;

	return false;
}

void func_239() // Position - 0x81E5
{
	if (MISC::IS_STRING_NULL_OR_EMPTY(&uLocal_232))
		return;

	if (!_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(&uLocal_232))
	{
		TEXT_LABEL_ASSIGN_STRING(&uLocal_232, "", 24);
		return;
	}
...
BOOL _IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(const char* message) // Position - 0x8219
{
	HUD::BEGIN_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(message);
	return HUD::END_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(0);
}

void func_241(int iParam0) // Position - 0x822C
{
	if (func_246())
		return;
...
void func_243(BOOL bParam0, BOOL bParam1) // Position - 0x82DD
{
	if (bParam0)
	{
		if (func_244(0))
...
BOOL func_244(int iParam0) // Position - 0x8351
{
	if (iParam0 == 1)
		if (Global_21239.f_1 > 3)
...
BOOL func_245() // Position - 0x83A8
{
	return IS_BIT_SET(Global_1960332, 5);
}

BOOL func_246() // Position - 0x83B6
{
	return IS_BIT_SET(Global_1960332, 19);
}

BOOL func_247() // Position - 0x83C5
{
	return Global_1573860[0 /*4*/] > 0;
}

void func_248() // Position - 0x83D6
{
	func_250();
	...
	if (iLocal_240 == 0 && iLocal_315 > 0 && !bLocal_241)
	{
		if (func_348(FRONTEND_CONTROL, Global_21208, 0))
		{
			Global_21217 = 1;
			...
			while (!GRAPHICS::IS_SCALEFORM_MOVIE_METHOD_RETURN_VALUE_READY(iLocal_314))
			{
				SYSTEM::WAIT(0);
			}
		
			iLocal_252 = GRAPHICS::GET_SCALEFORM_MOVIE_METHOD_RETURN_VALUE_INT(iLocal_314);
			iLocal_210 = 3;
			Global_21239.f_1 = 8;
		
			if (iLocal_211 == 2 && uLocal_289[iLocal_251] == 4 || iLocal_211 == 2 && uLocal_289[iLocal_251] == 3)
				func_3();
			else
				func_249();
	...
	else if (func_348(FRONTEND_CONTROL, Global_21208, 0) && !bLocal_241)
	{
		Global_21217 = 1;
		func_211();
	}
...
void func_249() // Position - 0x8508
{
	if (iLocal_211 == 1 && uLocal_284[iLocal_251] == 0)
		func_216("JIPMP_HEISTT" /*Quick Heist*/);
	else
		func_216(&uLocal_212);

	func_230(Global_21220, "SET_DATA_SLOT_EMPTY", SYSTEM::TO_FLOAT(13), -1082130432, -1082130432, -1082130432, -1082130432);
	func_229(Global_21220, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(13), SYSTEM::TO_FLOAT(0), SYSTEM::TO_FLOAT(12), -1f, -1f, &uLocal_216, 0, 0, 0, 0);
	func_230(Global_21220, "DISPLAY_VIEW", SYSTEM::TO_FLOAT(13), -1082130432, -1082130432, -1082130432, -1082130432);
	func_213(13, &uLocal_224, 1, "", 14, &uLocal_228, &uLocal_317);
	return;
}

void func_250() // Position - 0x85B5
{
	if (bLocal_242)
	...
	if (bLocal_242 == false)
	{
		if (func_348(FRONTEND_CONTROL, Global_21215, 0))
		{
			if (iLocal_238 > 0)
				iLocal_238 = iLocal_238 - 1;
		...
		if (func_348(FRONTEND_CONTROL, Global_21216, 0))
		{
			iLocal_238 = iLocal_238 + 1;
...
void func_251() // Position - 0x867A
{
	func_230(Global_21220, "SET_INPUT_EVENT", SYSTEM::TO_FLOAT(3), -1082130432, -1082130432, -1082130432, -1082130432);
	AUDIO::PLAY_SOUND_FRONTEND(-1, "Menu_Navigate", &Global_21228, true);
	func_252();
	return;
}

void func_252() // Position - 0x86B7
{
	if (func_138())
		if (Global_21466 == 0)
...
void func_253() // Position - 0x86DA
{
	func_230(Global_21220, "SET_INPUT_EVENT", SYSTEM::TO_FLOAT(1), -1082130432, -1082130432, -1082130432, -1082130432);
	AUDIO::PLAY_SOUND_FRONTEND(-1, "Menu_Navigate", &Global_21228, true);
	func_254();
	return;
}

void func_254() // Position - 0x8717
{
	if (func_138())
		if (Global_21466 == 0)
			MOBILE::CELL_SET_INPUT(1);
...
void func_255() // Position - 0x873A
{
	int num;

	func_250();

	if (iLocal_240 == 0 && iLocal_315 > 0)
	{
		if (func_348(FRONTEND_CONTROL, Global_21208, 0))
		{
			Global_21217 = 1;
			...
			iLocal_251 = GRAPHICS::GET_SCALEFORM_MOVIE_METHOD_RETURN_VALUE_INT(iLocal_314);
			...
			if (iLocal_251 > -1 && iLocal_251 < num)
			{
				if (Global_21239.f_1 > 3)
					Global_21239.f_1 = 8;
	...
	else if (func_348(FRONTEND_CONTROL, Global_21208, 0))
	{
		Global_21217 = 1;
		func_211();
	}
...
void func_257() // Position - 0x8858
{
	if (func_258(bLocal_243))
	{
		iLocal_210 = 1;
		func_212();
	}
...
BOOL func_258(BOOL bParam0) // Position - 0x8881
{
	if (func_130() || func_177())
		return false;

	if (bParam0 == false && Global_262145.f_4366 == 1 || iLocal_244 == 1)
		return false;

	return true;
}

void func_259() // Position - 0x88C2
{
	func_250();
	...
	if (iLocal_240 == 0 && iLocal_315 > 0)
	{
		if (func_348(FRONTEND_CONTROL, Global_21208, 0))
		{
			...
			iLocal_250 = GRAPHICS::GET_SCALEFORM_MOVIE_METHOD_RETURN_VALUE_INT(iLocal_314);
		
			if (iLocal_250 > -1 && iLocal_250 < 7)
			{
				if (Global_21239.f_1 > 3)
					Global_21239.f_1 = 8;
			
				iLocal_211 = uLocal_253[iLocal_250];
				bLocal_243 = func_231();
...
void func_260(int iParam0) // Position - 0x89E0
{
	...
	func_262(iParam0);
	func_230(Global_21220, "DISPLAY_VIEW", 18f, -1082130432, -1082130432, -1082130432, -1082130432);
	func_216(AUDIO_SPEECH_GET_PARAM_STRING_FROM_ENUM_0(iParam0));
...
char* AUDIO_SPEECH_GET_PARAM_STRING_FROM_ENUM_0(int iParam0) // Position - 0x8AA4
{
	switch (iParam0)
	{
		case 0:
...
void func_262(int iParam0) // Position - 0x8B11
{
	int i;

	iLocal_316 = 0;

	if (iLocal_240 == 0 && func_176())
	{
		switch (iParam0)
		{
			case 0:
...
void func_263(int iParam0, var uParam1, int iParam2) // Position - 0x8C53
{
	GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(Global_21220, "SET_DATA_SLOT");
	GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(18);
	...
	GRAPHICS::END_TEXT_COMMAND_SCALEFORM_STRING();
	GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
	uParam1->[iLocal_316] = iParam2;
	iLocal_316 = iLocal_316 + 1;
	return;
}

char* func_264(int iParam0, int iParam1) // Position - 0x8C9D
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_266(int iParam0, int iParam1) // Position - 0x8FD5
{
	int num;
	...
	switch (iParam0)
	{
		case 0:
			switch (iParam1)
			{
				...
				case 6:
					...
					if (func_130() || func_177() || num == -1 || Global_1836912.f_37[num] == -1)
						return false;
					else
				...
				case 5:
					...
					if (func_130() || func_177() || num == -1 || Global_1836912.f_37[num] == -1 || !*Global_262145.f_34723)
						return false;
					else
						return func_178(2, false, false) || func_178(0, false, false);
					break;
				...
				case 8:
					...
					if (func_130() || func_177() || num == -1 || Global_1836912.f_37[num] == -1 || !_STAT_GET_PACKED_BOOL(7330, -1))
						return false;
					else
				...
				case 9:
					...
					if (func_130() || func_177() || num == -1 || Global_1836912.f_37[num] == -1 || !func_345(PLAYER::PLAYER_ID()))
						return false;
					else
						return func_178(2, false, false);
					break;
				...
				case 10:
					...
					if (func_130() || func_177() || num == -1 || Global_1836912.f_37[num] == -1 || !func_345(PLAYER::PLAYER_ID()) || !func_343())
						return false;
					else
						return func_178(2, false, false);
					break;
				...
				case 2:
					...
					if (func_130() || func_177() || num == -1 || Global_1836912.f_37[num] == -1 || !*Global_262145.f_36070)
						return false;
					else
						return func_178(2, false, false) || func_178(0, false, false);
					break;
				...
				case 0:
					...
					if (func_130() || func_177() || num == -1 || Global_1836912.f_37[num] == -1 || !func_342())
						return false;
					else
						return func_178(2, false, false) || func_178(0, false, false);
					break;
				...
				case 20:
					if (func_130() || func_177() || func_162(202) == -1 || Global_1836912.f_37[num] == -1)
						return false;
					else
						return func_178(2, false, false);
					break;
				...
				case 21:
					if (func_130() || func_177() || !Global_262145.f_7034 || func_157() == -1 || Global_262145.f_6951[func_157()] != 2 || Global_1836912.f_36 == -1)
						return false;
					else
						return func_178(2, false, false);
					break;
		...
		case 2:
			switch (iParam1)
			{
				...
				case 5:
					if (func_130() || !func_339() || func_177() || Global_262145.f_12659)
						return false;
					else
						return func_268(0) > 0 || func_267();
					break;
...
BOOL func_267() // Position - 0x9BB6
{
	return func_125(2934, -1) > false;
}

int func_268(int iParam0) // Position - 0x9BC8
{
	int num;

	if (Global_1941321[iParam0 /*8*/] == -1)
	{
		num = func_125(func_338(iParam0), -1);
...
void func_269(int iParam0, int iParam1) // Position - 0x9C0B
{
	Global_1941321[iParam0 /*8*/] = iParam1;
	func_270(func_338(iParam0), iParam1, -1);
	return;
}

void func_270(int iParam0, int iParam1, int iParam2) // Position - 0x9C2A
{
	BOOL flag;
	int num;
	...
	{
		func_148(iParam0, iParam1, iParam2, true);
		return;
	}
	...
	if (!func_336(num, iParam1 == func_125(iParam0, -1)))
	{
		flag = false;
	}
	else
...
void func_271(var uParam0) // Position - 0x9CBE
{
	...
	if (uParam0->f_6 >= uParam0->f_2.f_2)
	{
		...
		if (func_296(*uParam0, uParam0->f_1, false, false))
		{
			...
			if (!Global_2740191.f_7134.f_1 && func_335(*uParam0) >= uParam0->f_1)
			{
...
BOOL func_272(var uParam0) // Position - 0x9DA2
{
	var unk;
	BOOL flag;
...
BOOL func_273(var uParam0, var uParam1, var uParam2) // Position - 0x9E12
{
	int num;
...
int func_274(int iParam0, int iParam1, int iParam2) // Position - 0x9E3A
{
	switch (iParam0)
	{
		case 18:
...
BOOL func_275(var uParam0, int iParam1, int iParam2, var uParam3) // Position - 0x9F53
{
	int num;
	int i;
...
void func_276(int iParam0, int iParam1, var uParam2, var uParam3) // Position - 0x9FA5
{
	int i;
	int j;
...
void func_277(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7) // Position - 0xB21F
{
	int i;
...
void _STAT_SET_PACKED_BOOL(int iParam0, BOOL bParam1, int iParam2) // Position - 0xB441
{
	if (iParam2 == -1)
		iParam2 = func_21();
...
int func_281(int iParam0) // Position - 0xB4DF
{
	switch (iParam0)
	{
		case 0:
...
void func_282(int iParam0, int iParam1) // Position - 0xB52D
{
	int num;
	BOOL address;
	int offset;
...
void func_283(int iParam0, int iParam1) // Position - 0xB57E
{
	int num;
	int offset;
...
int func_284(int iParam0) // Position - 0xB639
{
	return func_285(iParam0) / 8;
}

int func_285(int iParam0) // Position - 0xB64A
{
	switch (iParam0)
	{
		case 2:
...
void func_286(int iParam0, int iParam1) // Position - 0xB7C8
{
	var entityCoords;
	int num;
	Hash hash;
...
Hash func_287(int iParam0) // Position - 0xB81B
{
	var unk;
...
char* AUDIO_SPEECH_GET_PARAM_STRING_FROM_ENUM_0_0(int iParam0) // Position - 0xB83B
{
	switch (iParam0)
	{
		case 0:
...
Hash func_289(int iParam0) // Position - 0xBA08
{
	switch (iParam0)
	{
		case 0:
...
Hash func_290() // Position - 0xBA74
{
	return MISC::GET_HASH_KEY("PROGRESS_HUB_TIER_COMPLETED");
}

int func_291() // Position - 0xBA84
{
	if (Global_1668418 == 0)
		func_292();
...
int func_293(int iParam0, int iParam1) // Position - 0xBACB
{
	if (iParam1 == 4)
		iParam1 = 3;
...
int func_294(int iParam0) // Position - 0xBAE7
{
	return func_285(iParam0) % 8;
}

int func_295(int iParam0) // Position - 0xBAF8
{
	int num;
...
BOOL func_296(int iParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Position - 0xBB0E
{
	BOOL flag;
	int num;
	int num2;
...
BOOL func_297(int iParam0, int iParam1) // Position - 0xBBAB
{
	BOOL flag;
	BOOL flag2;
...
BOOL func_298(int iParam0, int iParam1) // Position - 0xBBCC
{
	int i;
...
int func_299(int iParam0, int iParam1) // Position - 0xCD1A
{
	if (func_300(iParam0))
	{
		switch (iParam1)
...
BOOL func_300(int iParam0) // Position - 0xCD8D
{
	int num;
...
int func_301(int iParam0) // Position - 0xCDB5
{
	switch (iParam0)
	{
		case 26:
...
int func_302(int iParam0, int iParam1, int iParam2) // Position - 0xCEBB
{
	int num;
	int i;
	int num2;
...
int func_303(int iParam0) // Position - 0xCF27
{
	if (func_300(iParam0))
		return 13;
...
void func_304(int iParam0) // Position - 0xCF42
{
	int num;
	int num2;
	int offset;
...
int func_305(int iParam0) // Position - 0xCF80
{
	return iParam0 % 32;
}

int func_306(int iParam0) // Position - 0xCF8D
{
	return iParam0 / 32;
}

int func_307(int iParam0) // Position - 0xCF9A
{
	switch (iParam0)
	{
		case 16:
...
void func_308(var uParam0) // Position - 0xE019
{
	int num;
	int num2;
	int num3;
...
int func_309(int iParam0) // Position - 0xE055
{
	switch (iParam0)
	{
		case 2:
...
void func_310(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7) // Position - 0xEBE0
{
	var entityCoords;
	int num;
	Hash hash;
...
Hash func_311(int iParam0, var uParam1, int iParam2) // Position - 0xEC49
{
	var unk;
...
char* func_312(int iParam0) // Position - 0xEF49
{
	var unk;
...
char* func_313(var uParam0) // Position - 0xEF64
{
	return uParam0;
}

char* func_314(int iParam0) // Position - 0xEF6E
{
	switch (iParam0)
	{
		case 0:
...
Hash func_315(BOOL bParam0) // Position - 0xEFC2
{
	if (bParam0)
...
BOOL func_316(int iParam0, int iParam1) // Position - 0xEFE5
{
	int i;
	BOOL flag;
	BOOL flag2;
	...
	switch (iParam0)
	{
		...
		case 15:
			switch (iParam1)
			{
				...
				case 161:
					flag = SYSTEM::FLOOR(SYSTEM::TO_FLOAT(func_125(12025, -1) / 60));
					break;
		...
		case 30:
			switch (iParam1)
			{
				...
				case 334:
					flag = flag + func_328(func_125(&func_56, -1));
...
BOOL func_317(int iParam0, int iParam1) // Position - 0x14876
{
	Hash statHash;
	BOOL outValue;
...
Hash func_318(int iParam0, int iParam1) // Position - 0x1489A
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(10, iParam0, func_127(iParam1));
}

BOOL func_319() // Position - 0x148B0
{
	int num;
	BOOL flag;
...
void func_320(int iParam0, BOOL bParam1, int iParam2) // Position - 0x148F7
{
	if (iParam2 == -1)
		iParam2 = func_21();
...
BOOL func_321() // Position - 0x1491F
{
	BOOL flag;
	BOOL flag2;
	...
	func_148(11960, Global_2740191.f_6950.f_3, -1, true);
	return flag;
}

BOOL func_322() // Position - 0x14998
{
	BOOL address;
	int i;
	Hash weaponHash;
...
int func_323(int iParam0) // Position - 0x14A8E
{
	iParam0 = iParam0 / 32;
...
Hash func_324(int iParam0) // Position - 0x14B01
{
	switch (iParam0)
	{
		case 34:
...
var func_325(BOOL bParam0, var uParam1, var uParam2) // Position - 0x15142
{
	if (bParam0)
		return uParam1;
...
BOOL func_326(int iParam0, int iParam1) // Position - 0x15159
{
	Hash statHash;
	int outValue;
...
Hash func_327(int iParam0, int iParam1) // Position - 0x1517D
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(8, iParam0, func_127(iParam1));
}

BOOL func_328(BOOL bParam0) // Position - 0x15193
{
	int num;
	BOOL flag;
...
void func_329(var uParam0, int iParam1) // Position - 0x151D3
{
	*uParam0 = *uParam0 - *uParam0 && iParam1;
	return;
}

BOOL func_330() // Position - 0x151E8
{
	int num;
	int num2;
...
int func_331(BOOL bParam0) // Position - 0x1542D
{
	if (bParam0)
		return 1;
...
int _STAT_GET_PACKED_INT(int iParam0, int iParam1) // Position - 0x1543F
{
	if (iParam1 == -1)
		iParam1 = func_21();
...
BOOL func_333(int iParam0, var uParam1) // Position - 0x1545B
{
	int i;
...
int func_334(int iParam0, int iParam1, int iParam2) // Position - 0x154D3
{
	switch (iParam1)
	{
		case 9:
...
int func_335(int iParam0) // Position - 0x164BF
{
	int num;
	int num2;
	int num3;
...
BOOL func_336(int iParam0, BOOL bParam1) // Position - 0x16505
{
	if (iParam0 == -1)
		return false;
...
int func_337(int iParam0) // Position - 0x16521
{
	switch (iParam0)
	{
		case 13035:
...
int func_338(int iParam0) // Position - 0x1695D
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_339() // Position - 0x1697B
{
...
BOOL func_340() // Position - 0x169A2
{
	return Global_1835485.f_6;
}

BOOL func_341() // Position - 0x169B0
{
	return func_43(PLAYER::PLAYER_ID());
}

BOOL func_342() // Position - 0x169C0
{
	return *Global_262145.f_36040 != -1;
}

BOOL func_343() // Position - 0x169D4
{
	return _STAT_GET_PACKED_BOOL(func_344(6), -1);
}

int func_344(int iParam0) // Position - 0x169E6
{
	switch (iParam0)
	{
		case 1:
...
BOOL func_345(Player plParam0) // Position - 0x17D88
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
	{
...
BOOL _STAT_GET_PACKED_BOOL(int iParam0, int iParam1) // Position - 0x17DCB
{
	if (iParam1 == -1)
		iParam1 = func_21();
...
BOOL func_347() // Position - 0x17DE7
{
...
BOOL func_348(eControlType ectParam0, eControlAction ecaParam1, int iParam2) // Position - 0x17E10
{
...
void func_349() // Position - 0x17E82
{
	if (!(Global_21239.f_1 == 7))
		if (Global_21239.f_1 > 3)
			Global_21239.f_1 = 7;
...
void func_350() // Position - 0x17F40
{
	int i;
	...
	if (iLocal_240 == 0 && func_176())
	{
		for (i = 0; i < 7; i = i + 1)
		{
			if (func_175(i))
			{
				...
				GRAPHICS::END_TEXT_COMMAND_SCALEFORM_STRING();
				GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
				uLocal_253[iLocal_315] = i;
				iLocal_315 = iLocal_315 + 1;
			}
		}
	}
	else
...
void func_351(BOOL bParam0) // Position - 0x1800B
{
...
void func_352() // Position - 0x18037
{
	MISC::CLEAR_BIT(&(Global_2684748.f_2), 11);
	return;
}

void func_353(BOOL bParam0) // Position - 0x1804B
{
	if (bParam0)
	{
		func_354();
...
void func_354() // Position - 0x180AE
{
...
BOOL func_355() // Position - 0x180D7
{
	if (func_357(935, &(iLocal_245.f_1), &(iLocal_245.f_2), &(iLocal_245.f_4), &(Global_2685690.f_1.f_2807)))
	{
		if (iLocal_245.f_4)
		{
			return true;
		...
		else
		{
			...
			iLocal_245.f_3 = iLocal_245.f_3 + 1;
			iLocal_245.f_1 = 0;
			iLocal_245.f_2 = 0;
		}
	}
...
void func_356(int iParam0) // Position - 0x18134
{
	Global_2685690.f_1.f_2807 = iParam0;
	return;
}

BOOL func_357(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4) // Position - 0x18147
{
	int num;
	int num2;
	var unk69;
...
void func_358(var uParam0, var uParam1, var uParam2) // Position - 0x1833F
{
	*uParam0 = 0;
	*uParam1 = 0;
...
void _STOPWATCH_DESTROY(var uParam0) // Position - 0x1836B
{
	uParam0->f_1 = 0;
	return;
}

void func_360(var uParam0, var uParam1) // Position - 0x18378
{
	*uParam0 = *uParam1;
...
BOOL func_361(var uParam0, var uParam1, Any* panParam2, Any* panParam3) // Position - 0x18393
{
	switch (*uParam0)
	{
		case 0:
...
void func_362(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17, var uParam18, var uParam19, var uParam20, var uParam21, var uParam22, var uParam23, var uParam24, var uParam25, var uParam26, var uParam27, var uParam28, var uParam29, var uParam30, var uParam31, var uParam32, var uParam33, var uParam34, var uParam35, var uParam36, var uParam37, var uParam38, var uParam39, var uParam40, var uParam41, var uParam42, var uParam43, var uParam44, var uParam45, var uParam46, var uParam47, var uParam48, var uParam49, var uParam50, var uParam51, var uParam52, var uParam53, var uParam54, var uParam55, var uParam56, var uParam57, var uParam58, var uParam59, var uParam60, var uParam61, var uParam62, var uParam63, var uParam64, var uParam65, var uParam66, var uParam67, var uParam68) // Position - 0x18447
{
	Global_2097152 = true;
...
void _STOPWATCH_RESET(var pStopwatch, BOOL useLocalTimer, BOOL useAccurateTime) // Position - 0x18472
{
...
BOOL func_364() // Position - 0x184AF
{
...
BOOL func_365() // Position - 0x184CD
{
	return func_366(PLAYER::PLAYER_ID());
}

BOOL func_366(Player plParam0) // Position - 0x184DD
{
...
int func_367(Player plParam0) // Position - 0x1853D
{
	return Global_1845274[plParam0 /*877*/].f_185;
}

BOOL func_368() // Position - 0x18550
{
...
void func_369() // Position - 0x18572
{
...
BOOL _STOPWATCH_HAS_TIME_PASSED(var pStopwatch, int millis, BOOL useLocalTimer) // Position - 0x185AD
{
	if (millis == -1)
		return true;
...
void _STOPWATCH_INITIALIZE(var pStopwatch, BOOL useLocalTimer, BOOL useAccurateTime) // Position - 0x1860B
{
	if (pStopwatch->f_1 == 0)
	{
		if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS() && !useLocalTimer)
...
BOOL func_372() // Position - 0x18650
{
	Player player;
...
int func_373(int iParam0) // Position - 0x186A2
{
	switch (iParam0)
	{
		case 931:
...
BOOL func_374(Ped pedParam0) // Position - 0x18726
{
	if (pedParam0 == 0)
		return false;
...
int func_375(Ped pedParam0) // Position - 0x18747
{
	int i;
...
void func_376() // Position - 0x18790
{
	Global_1048576.f_10 = 0;
	return;
}

void func_377() // Position - 0x1879F
{
	var unk;
	var unk2;
	var unk3;
...
void func_378() // Position - 0x18AD6
{
	if (!_IS_FMMC_ACTIVE() && !func_409() && Global_2685689)
		Global_4718592.f_138116 = 0;

	return;
}

BOOL _IS_FMMC_ACTIVE() // Position - 0x18B04
{
	return Global_1845274[PLAYER::PLAYER_ID() /*877*/].f_185 != 0;
}

void func_380() // Position - 0x18B1B
{
	MISC::SET_BIT(&(Global_2684748.f_2), 12);
	return;
}

void func_381() // Position - 0x18B2F
{
	Global_1057440 = -1;
	return;
}

BOOL func_382() // Position - 0x18B3C
{
	if (Global_1985001)
		return true;
...
int func_383() // Position - 0x18BDB
{
	return Global_1057440;
}

void func_384(BOOL bParam0) // Position - 0x18BE7
{
	BOOL flag;
...
void func_385(int iParam0) // Position - 0x18C7A
{
	Global_2684748.f_894 = iParam0;
	return;
}

void func_386() // Position - 0x18C8B
{
	Global_2684748.f_9 = -1;
	return;
}

BOOL func_387() // Position - 0x18C9A
{
	return Global_2684748.f_739;
}

void func_388() // Position - 0x18CA9
{
	Global_2684748.f_42 = func_389();
	return;
}

int func_389() // Position - 0x18CBB
{
	if (Global_2692869)
		return 32;
...
void func_390() // Position - 0x18CD6
{
	Global_2684748.f_737 = 0;
	return;
}

void func_391() // Position - 0x18CE6
{
	Global_2684748.f_719 = 0;
	return;
}

void func_392() // Position - 0x18CF6
{
	MISC::CLEAR_BIT(&(Global_1845274[PLAYER::PLAYER_ID() /*877*/].f_36.f_18), 15);
	return;
}

void func_393() // Position - 0x18D13
{
...
void func_394() // Position - 0x18D29
{
	MISC::CLEAR_BIT(&Global_2684748, 7);
	return;
}

void func_395() // Position - 0x18D3A
{
	MISC::CLEAR_BIT(&Global_2684748, 6);
	return;
}

void func_396() // Position - 0x18D4B
{
	Global_2684748 = 0;
...
void func_397(BOOL bParam0) // Position - 0x18D66
{
	int i;
	var unk;
	int j;
...
void func_398() // Position - 0x18E62
{
	Global_2680869.f_32 = 0;
	return;
}

void func_399() // Position - 0x18E71
{
	var unk;
	int i;
...
BOOL func_404() // Position - 0x18F5A
{
	return IS_BIT_SET(Global_2684748, 1);
}

BOOL func_405() // Position - 0x18F68
{
	return IS_BIT_SET(Global_2684748, 2);
}

BOOL func_406() // Position - 0x18F76
{
	return IS_BIT_SET(Global_2684748, 20);
}

BOOL func_407() // Position - 0x18F85
{
	return Global_2684748.f_700;
}

void func_408() // Position - 0x18F94
{
	func_239();
...
BOOL func_409() // Position - 0x18FA4
{
	return Global_2684748.f_693;
}

BOOL func_410() // Position - 0x18FB3
{
	return IS_BIT_SET(Global_2684748.f_2, 11);
}

void func_411(var uParam0) // Position - 0x18FC4
{
	*uParam0 = 0;
	return;
}

void func_412() // Position - 0x18FD0
{
	Global_2685690.f_1.f_2807 = 0;
	return;
}

int func_413(var uParam0, int iParam1) // Position - 0x18FE2
{
	int num;
	int num2;
	...
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		if (PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0)
			if (NETWORK::NETWORK_IS_SIGNED_ONLINE())
				if (!MONEY::NETWORK_CAN_SPEND_MONEY(func_440(iParam1, num, false, -1) + func_122(20), false, false, true, -1, 0))
					return 1;
		...
		if (Global_1845274[PLAYER::PLAYER_ID() /*877*/] == 14 || Global_1845274[PLAYER::PLAYER_ID() /*877*/] == 15 || Global_1845274[PLAYER::PLAYER_ID() /*877*/] == 13 || Global_1845274[PLAYER::PLAYER_ID() /*877*/] == 6 || Global_1845274[PLAYER::PLAYER_ID() /*877*/] == 5 || Global_1845274[PLAYER::PLAYER_ID() /*877*/] == 32 || func_433() || IS_BIT_SET(Global_1845274[PLAYER::PLAYER_ID() /*877*/].f_876, 6) || func_428(PLAYER::PLAYER_PED_ID(), joaat("MP_GAR_SIMEON"), false, uParam0, 0, 500, true, false) || func_427(PLAYER::PLAYER_ID(), 0) || func_424(PLAYER::PLAYER_ID(), true, false) || Global_1845274[PLAYER::PLAYER_ID() /*877*/] == 148)
			return 9;
		...
		if (Global_1837006 && HUD::IS_HOVERING_OVER_MISSION_CREATOR_BLIP() && HUD::IS_PAUSE_MENU_ACTIVE())
		{
			if (Global_1836912.f_36 == -2 || Global_1836912.f_36 == -3 || Global_1836912.f_36 == 0)
				return 60;
...
BOOL func_414(int iParam0, int iParam1) // Position - 0x19313
{
	int profileSetting;
	int profileSetting2;
...
int func_415(int iParam0) // Position - 0x1933C
{
	int num;
...
BOOL func_416(int iParam0) // Position - 0x1939F
{
	if (Global_1574612)
		return true;
...
int func_417(int iParam0, int iParam1, int iParam2) // Position - 0x193D0
{
	int num;
	int i;
	int num2;
...
BOOL func_418(int iParam0) // Position - 0x19464
{
	return Global_1575117[iParam0 + 1];
}

int func_419(int iParam0) // Position - 0x19476
{
	if (iParam0 == 8)
		return 1;
...
int func_420(int iParam0) // Position - 0x19495
{
...
BOOL func_421() // Position - 0x194B1
{
...
var func_422(int iParam0) // Position - 0x194CF
{
	return Global_1574538[iParam0];
}

var func_423() // Position - 0x194DF
{
	return func_422(func_21() + 1);
}

BOOL func_424(Player plParam0, BOOL bParam1, BOOL bParam2) // Position - 0x194F1
{
	if (bParam1)
...
BOOL func_425(Player plParam0) // Position - 0x19523
{
	return func_426(plParam0);
}

BOOL func_426(Player plParam0) // Position - 0x19531
{
	return IS_BIT_SET(Global_1845274[plParam0 /*877*/].f_11.f_1, 0);
}

BOOL func_427(Player plParam0, int iParam1) // Position - 0x19548
{
	return IS_BIT_SET(Global_2658019[plParam0 /*467*/].f_221, iParam1);
}

BOOL func_428(Ped pedParam0, Hash hParam1, BOOL bParam2, var uParam3, int iParam4, int iParam5, BOOL bParam6, BOOL bParam7) // Position - 0x1955E
{
...
BOOL func_429(Ped pedParam0, Hash hParam1, int iParam2) // Position - 0x19B61
{
	if (hParam1 != -1)
...
Vector3 func_430(int iParam0) // Position - 0x19B8D
{
	switch (iParam0)
	{
...
void func_431(var uParam0, int iParam1) // Position - 0x19C41
{
	switch (iParam1)
	{
		case 0:
...
BOOL _STOPWATCH_IS_INITIALIZED(var uParam0) // Position - 0x1A1B9
{
	return uParam0->f_1;
}

BOOL func_433() // Position - 0x1A1C5
{
...
BOOL func_434() // Position - 0x1A25F
{
	int num;
...
BOOL func_437() // Position - 0x1A2F0
{
	return IS_BIT_SET(Global_2740191.f_1865, 3);
}

BOOL func_438(Player plParam0) // Position - 0x1A301
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		return IS_BIT_SET(Global_2658019[plParam0 /*467*/].f_324.f_7, 14);

	return false;
}

BOOL func_439() // Position - 0x1A327
{
	return Global_101969.f_400 > 0;
}

int func_440(int iParam0, int iParam1, BOOL bParam2, int iParam3) // Position - 0x1A338
{
	...
	switch (iParam0)
	{
		...
		case 2:
			...
			{
				switch (*Global_4718592.f_128052)
				{
					case 4:
					case 5:
...
BOOL func_441() // Position - 0x1A4AF
{
