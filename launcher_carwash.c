...
void main() // Position - 0x0
{
	...
	while (true)
	{
		...
		if (func_70(PLAYER::PLAYER_PED_ID(), unk, false) > 100f + 20f)
			func_80();
		...
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
		{
			...
			flag = func_66(vehiclePedIsIn) || func_65(vehiclePedIsIn);
	...
	switch (uParam1->f_13)
	{
		case 0:
			...
			if (func_50(uParam1->f_16))
			{
				for (i = 0; i < *uParam0; i = i + 1)
				{
					if (func_47(&uParam0->[i /*24*/]) && uParam0->[i /*24*/])
					{
						uParam1->f_12 = i;
		...
		case 2:
			...
			if (func_22(&uParam0->[uParam1->f_12 /*24*/]) || uParam0->[i /*24*/].f_8 == 0)
			{
				func_46(uParam1, 0);
				return false;
			}
...
int func_2(Vehicle veParam0, float fParam1, int iParam2, int iParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0x90A
{
...
void func_3(Vehicle veParam0) // Position - 0x961
{
	if (!ENTITY::IS_ENTITY_DEAD(veParam0, false))
...
BOOL func_5(Player plParam0) // Position - 0xADE
{
	return func_6(plParam0, 1);
}

BOOL func_6(Player plParam0, int iParam1) // Position - 0xAED
{
	if (iParam1 != 0)
...
Player _INVALID_PLAYER_INDEX() // Position - 0xB17
{
	return -1;
}

int _GET_VEHICLE_SEAT_PED_IS_IN(Ped ped, BOOL includeLastVehicle) // Position - 0xB20
{
	Vehicle vehiclePedIsIn;
...
BOOL func_9(BOOL bParam0) // Position - 0xBA5
{
	if (bParam0)
		if (func_11())
			return true;
...
BOOL func_10(int iParam0) // Position - 0xBCB
{
	return Global_44392 == iParam0;
}

BOOL func_11() // Position - 0xBD9
{
	if (Global_113312)
		return true;
...
void func_12() // Position - 0xC0B
{
	Global_24009.f_6 = 1;
	return;
}

BOOL func_13(var uParam0) // Position - 0xC19
{
	var entityRotation;
	Ped vehiclePedIsIn;
	Ped ped;
	...
	if (func_14(uParam0->f_12, entityRotation) > SYSTEM::COS(uParam0->f_15))
		return 1;

	return 0;
}

float func_14(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5) // Position - 0xCC2
{
	return (fParam0 * uParam3) + (fParam0.f_1 * uParam3.f_1);
}

BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0xCD9
{
...
int func_17(var uParam0, const char* sParam1, int iParam2) // Position - 0xD3D
{
...
void func_18(const char* sParam0, int iParam1) // Position - 0xD89
{
...
BOOL func_19(var uParam0) // Position - 0xDA5
{
...
BOOL _IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(const char* message) // Position - 0xDFF
{
	HUD::BEGIN_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(message);
	return HUD::END_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(0);
}

BOOL func_21(const char* sParam0, int iParam1) // Position - 0xE12
{
...
BOOL func_22(var uParam0) // Position - 0xE2B
{
	var unk;
	...
	if (uParam0->f_11 == 0)
		return !func_25(PLAYER::PLAYER_PED_ID(), uParam0->f_1, uParam0->f_10 + 2f, true);

	unk = { func_23(uParam0->f_16, 2f) };
	return !ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), unk[0 /*3*/], unk[1 /*3*/], unk.f_7, false, true, 0);
}

struct<8> func_23(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, float fParam8) // Position - 0xECF
{
	var unk;
	var unk9;

	unk = 2;
	unk9 = { func_24(uParam0[1 /*3*/] - uParam0[0 /*3*/]) * { fParam8, fParam8, fParam8 } };
...
Vector3 func_24(float fParam0, var uParam1, var uParam2) // Position - 0xF31
{
	float num;
	float num2;
...
BOOL func_25(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, float fParam4, BOOL bParam5) // Position - 0xF70
{
	return SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(pedParam0, bParam5), vParam1) <= fParam4 * fParam4;
}

int func_26(var uParam0, const char* sParam1) // Position - 0xF8E
{
	if (MISC::IS_STRING_NULL_OR_EMPTY(sParam1))
		return 0;
...
void func_27(const char* sParam0) // Position - 0xFD7
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_HELP(sParam0);
	HUD::END_TEXT_COMMAND_DISPLAY_HELP(0, true, true, -1);
	return;
...
void func_28(var uParam0) // Position - 0xFED
{
	if (func_19(uParam0))
		HUD::CLEAR_HELP(true);
...
BOOL func_29() // Position - 0x101A
{
	...
	if (func_33(vehiclePedIsIn))
		return true;

	if (func_30(vehiclePedIsIn, 3))
		return true;

	return !VEHICLE::IS_VEHICLE_DRIVEABLE(vehiclePedIsIn, false);
}

BOOL func_30(Vehicle veParam0, int iParam1) // Position - 0x106E
{
	int num;
...
BOOL func_31(Vehicle veParam0) // Position - 0x110A
{
...
BOOL _DOES_ENTITY_EXIST_AND_IS_ALIVE(Vehicle veParam0) // Position - 0x1134
{
...
BOOL func_33(Vehicle veParam0) // Position - 0x1155
{
	if (ENTITY::DOES_ENTITY_EXIST(veParam0))
		if (ENTITY::IS_ENTITY_DEAD(veParam0, false))
			return true;
...
int func_35(int iParam0) // Position - 0x11E6
{
	return Global_61697[iParam0];
}

eCharacter _GET_CURRENT_PLAYER_CHARACTER() // Position - 0x11F5
{
	func_37();
	return Global_114370.f_2367.f_539.f_4321;
}

void func_37() // Position - 0x120E
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (_GET_CHARACTER_MODEL(Global_114370.f_2367.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_38(character) && !func_10(14) || Global_113318)
			{
...
BOOL func_38(eCharacter echParam0) // Position - 0x130B
{
	return echParam0 < CHAR_MULTIPLAYER;
}

eCharacter _GET_PLAYER_CHARACTER_FROM_PED(Ped pedParam0) // Position - 0x1317
{
	eCharacter i;
	Hash entityModel;
...
Hash _GET_CHARACTER_MODEL(eCharacter character) // Position - 0x1354
{
...
Hash func_41(eCharacter echParam0) // Position - 0x1379
{
	return Global_2241[echParam0 /*29*/];
}

int func_42(Player plParam0) // Position - 0x1388
{
	int num;
...
int func_43(Player plParam0) // Position - 0x139A
{
	if (plParam0 > -1)
...
BOOL func_44(Player plParam0) // Position - 0x13DD
{
	if (!func_45(plParam0))
		return false;
...
BOOL func_45(Player plParam0) // Position - 0x13FC
{
	Player player;
...
void func_46(var uParam0, int iParam1) // Position - 0x141E
{
...
BOOL func_47(var uParam0) // Position - 0x1432
{
	func_79(PLAYER::PLAYER_PED_ID());
	...
	return func_25(PLAYER::PLAYER_PED_ID(), uParam0->f_1, uParam0->f_10, true);
}

BOOL func_48() // Position - 0x14EB
{
	return MISC::GET_GAME_TIMER() <= Global_24148.f_6481 + 100;
}

BOOL func_49(BOOL bParam0) // Position - 0x1500
{
	if (bParam0)
...
BOOL func_50(int iParam0) // Position - 0x1529
{
	if (iParam0 == 0)
		if (func_57())
			return false;

	if (HUD::IS_PAUSE_MENU_ACTIVE() || PLAYER::IS_SYSTEM_UI_BEING_DISPLAYED() || func_48() || Global_64517 || func_49(false) || func_56(0) || func_55() || func_51(PLAYER::PLAYER_ID()))
		return false;

	return true;
}

BOOL func_51(Player plParam0) // Position - 0x1599
{
	if (func_54(plParam0))
		return true;
...
BOOL func_52(Player plParam0) // Position - 0x15BC
{
	Player player;
...
BOOL func_53(Player plParam0, int iParam1) // Position - 0x15DA
{
	return IS_BIT_SET(Global_1888882[plParam0 /*611*/].f_10.f_4, iParam1);
}

BOOL func_54(Player plParam0) // Position - 0x15F2
{
	Player player;
...
BOOL func_56(int iParam0) // Position - 0x1637
{
	if (iParam0 == 1)
...
void func_58(var uParam0) // Position - 0x16A3
{
	if (uParam0->f_11 == 1)
...
void func_59(var uParam0, var uParam1, var uParam2, var uParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8) // Position - 0x16D8
{
	int i;
	float num;
	float num2;
...
void func_60(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4) // Position - 0x178D
{
	func_61(uParam0->[0 /*3*/], uParam0->[1 /*3*/], uParam0->f_7, iParam1, iParam2, iParam3, iParam4);
	return;
}

void func_61(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, int iParam7, int iParam8, int iParam9, int iParam10) // Position - 0x17B3
{
	var unk;
	var unk4;
	float num;
	...
	unk = { func_24(uParam3 - uParam0) };
	unk4 = { func_62(unk, 0f, 0f, 1f) };
	num = fParam6 / 2f;
	unk13 = 8;
	unk7 = { uParam0 };
	unk10 = { uParam3 };
...
Vector3 func_62(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5) // Position - 0x19C3
{
...
void func_63(int iParam0) // Position - 0x19FC
{
	int shapeTestResult;
	Entity entityHit;
	var endCoords;
	...
	if (!func_47(&iLocal_38[iParam0 /*24*/]))
	{
...
void func_64(BOOL bParam0) // Position - 0x1AED
{
	bParam0;
	return;
}

int func_65(Vehicle veParam0) // Position - 0x1AFA
{
...
int func_66(Vehicle veParam0) // Position - 0x1B65
{
	var minimum;
	float maximum;
...
BOOL func_67(Vehicle veParam0) // Position - 0x1CF6
{
	Hash entityModel;

	entityModel = ENTITY::GET_ENTITY_MODEL(veParam0);

	if (func_68(entityModel))
		return true;
...
BOOL func_68(Hash hParam0) // Position - 0x1F55
{
...
BOOL func_69(Vehicle veParam0, BOOL bParam1) // Position - 0x2196
{
	if (Global_79768)
...
float func_70(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0x21E7
{
...
void func_71() // Position - 0x2221
{
	func_77(&iLocal_38[0 /*24*/], 1, "Carwash1", func_78(156), 15, "", 0, 4f);
	func_77(&iLocal_38[1 /*24*/], 1, "Carwash2", func_78(157), 15, "", 0, 4f);
	func_75(&iLocal_38[0 /*24*/], -1f, 0f, 0f, 360f);
	func_75(&iLocal_38[1 /*24*/], 0f, -1f, 0f, 360f);
	func_72(&uLocal_87, 0);
...
void func_72(var uParam0, int iParam1) // Position - 0x22AF
{
...
BOOL IS_XBOX_PLATFORM() // Position - 0x2343
{
	return MISC::IS_DURANGO_VERSION() || MISC::IS_SCARLETT_VERSION();
}

BOOL IS_PLAYSTATION_PLATFORM() // Position - 0x2359
{
	return MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION();
}

void func_75(var uParam0, float fParam1, float fParam2, float fParam3, float fParam4) // Position - 0x236F
{
...
float func_76(float fParam0, float fParam1, float fParam2) // Position - 0x2398
{
	if (fParam0 > fParam2)
		return fParam2;
...
void func_77(var uParam0, int iParam1, char* sParam2, var uParam3, var uParam4, var uParam5, int iParam6, char* sParam7, int iParam8, float fParam9) // Position - 0x23BF
{
	uParam0->f_5 = sParam2;
	uParam0->f_1 = { uParam3 };
	uParam0->f_4 = sParam7;
...
Vector3 func_78(int iParam0) // Position - 0x2434
{
	int num;
...
BOOL func_79(Vehicle veParam0) // Position - 0x244C
{
	if (!ENTITY::DOES_ENTITY_EXIST(veParam0))
		return false;
...
void func_81(var uParam0) // Position - 0x2482
{
	int i;
	...
	for (i = 0; i < *uParam0; i = i + 1)
	{
		func_82(&uParam0->[i /*24*/]);
	}

	return;
}

void func_82(var uParam0) // Position - 0x24AB
{
	*uParam0 = 0;
	return;
}
