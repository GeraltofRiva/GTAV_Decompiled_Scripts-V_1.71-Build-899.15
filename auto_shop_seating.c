...
void func_104(int iParam0, var uParam1, int iParam2, int iParam3) // Position - 0x3025
{
	var unk;
	float num;
...
Vector3 func_105() // Position - 0x3105
{
	return 0.5f, -0.5f, 2f;
}

Vector3 func_106() // Position - 0x3118
{
	return -0.5f, -0.5f, 0f;
}

Vector3 func_107() // Position - 0x312B
{
	return 1f, -0.5f, 2f;
}

Vector3 func_108(float fParam0, var uParam1, var uParam2, float fParam3) // Position - 0x313A
{
	float num;
	float num2;
	float num3;
...
float func_109(int iParam0, float fParam1) // Position - 0x317E
{
	switch (iParam0)
	{
		case 1:
...
Vector3 func_110() // Position - 0x31B7
{
	return -1f, -0.5f, 0f;
}

void func_111(int iParam0, var uParam1, var uParam2) // Position - 0x31C6
{
	if (func_29())
	{
		switch (iParam0)
...
void func_112() // Position - 0x334E
{
	return;
}

int _NETWORK_ENSURE_SCRIPT_IS_NETWORKED(int iParam0, int iParam1, BOOL bNoTerminate) // Position - 0x3356
{
	int i;
...
BOOL func_114(BOOL bParam0) // Position - 0x346C
{
	bParam0;
