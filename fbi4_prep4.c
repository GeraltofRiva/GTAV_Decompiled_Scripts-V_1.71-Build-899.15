...
void main() // Position - 0x0
{
	...
	{
		Global_114370.f_2367.f_539.f_2395[0] = -99;
		Global_114370.f_2367.f_539.f_2395[1] = -99;
		Global_114370.f_2367.f_539.f_2395[2] = -99;
		func_268();
	}
...
void func_23() // Position - 0x129C
{
	switch (iLocal_79)
	{
		...
		case 2:
			if (MISC::GET_GAME_TIMER() - iLocal_202 > 2000)
			{
				...
				if (func_44(&uLocal_380, &uLocal_376, &uLocal_211))
				{
					...
					if (Global_114370.f_2367.f_539.f_2395[0] == 38 && Global_114370.f_2367.f_539.f_2395[1] == 33 && Global_114370.f_2367.f_539.f_2395[2] == 54)
						func_42(821);
		...
		case 3:
			Global_114370.f_2367.f_539.f_2395[0] = 38;
			Global_114370.f_2367.f_539.f_2395[1] = 33;
			Global_114370.f_2367.f_539.f_2395[2] = 54;
			func_24(1, 1, 1);
			iLocal_79 = 2;
			break;
	}
...
void func_40(BOOL bParam0, BOOL bParam1) // Position - 0x18E8
{
	...
	if (bParam0)
	{
		if (_IS_MISSION_REPEAT_ACTIVE(false) && Global_80015.f_1 == 1 && func_41(Global_80015))
		{
		}
		else
		{
...
Ped func_58(eCharacter echParam0) // Position - 0x21E2
{
	...
	return Global_99370[func_59(echParam0)];
}
		...
		if (Global_114370.f_2367.f_539.f_2407[0 /*295*/][echParam1 /*98*/] == model)
		{
			...
			if (STREAMING::HAS_MODEL_LOADED(Global_114370.f_2367.f_539.f_2407[0 /*295*/][echParam1 /*98*/]))
			{
				*uParam0 = VEHICLE::CREATE_VEHICLE(Global_114370.f_2367.f_539.f_2407[0 /*295*/][echParam1 /*98*/], vParam2, fParam5, false, false, false);
				...
				func_195(uParam0, &(Global_114370.f_2367.f_539.f_2407[0 /*295*/][echParam1 /*98*/].f_31), &(Global_114370.f_2367.f_539.f_2407[0 /*295*/][echParam1 /*98*/].f_81));
		...
		else if (Global_114370.f_2367.f_539.f_2407[1 /*295*/][echParam1 /*98*/] == model)
		{
			...
			if (STREAMING::HAS_MODEL_LOADED(Global_114370.f_2367.f_539.f_2407[1 /*295*/][echParam1 /*98*/]))
			{
				*uParam0 = VEHICLE::CREATE_VEHICLE(Global_114370.f_2367.f_539.f_2407[1 /*295*/][echParam1 /*98*/], vParam2, fParam5, false, false, false);
				...
				func_195(uParam0, &(Global_114370.f_2367.f_539.f_2407[1 /*295*/][echParam1 /*98*/].f_31), &(Global_114370.f_2367.f_539.f_2407[1 /*295*/][echParam1 /*98*/].f_81));
				VEHICLE::SET_VEHICLE_ENVEFF_SCALE(*uParam0, model.f_96);
...
void func_118(eCharacter echParam0, var uParam1, int iParam2, BOOL bParam3) // Position - 0x4951
{
	...
	if (func_14(echParam0) && ENTITY::DOES_ENTITY_EXIST(*uParam1) && VEHICLE::IS_VEHICLE_DRIVEABLE(*uParam1, false))
	{
		...
		{
			func_122(uParam1, &(Global_114370.f_2367.f_539.f_2407[iParam2 /*295*/][echParam0 /*98*/].f_31), &(Global_114370.f_2367.f_539.f_2407[iParam2 /*295*/][echParam0 /*98*/].f_81));
			...
			if (bParam3)
			{
				...
				Global_114370.f_20122[echParam0 /*43*/].f_31 = func_121(*uParam1);
				...
				func_119(Global_114370.f_2367.f_539.f_2407[iParam2 /*295*/][echParam0 /*98*/].f_5, Global_114370.f_2367.f_539.f_2407[iParam2 /*295*/][echParam0 /*98*/].f_7, num, true, &(Global_114370.f_20122[echParam0 /*43*/].f_1));
				...
				func_119(Global_114370.f_2367.f_539.f_2407[iParam2 /*295*/][echParam0 /*98*/].f_6, -1, num, false, &(Global_114370.f_20122[echParam0 /*43*/].f_2));
			}
		}
	}
	...
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2658019[plParam0 /*467*/].f_324.f_8 != -1)
				return func_126(Global_2658019[plParam0 /*467*/].f_324.f_8) == 32;
...
BOOL _NETWORK_IS_PLAYER_VALID(Player player, BOOL bIsPlaying, BOOL bUnk) // Position - 0x74C9
{
	Player player;
...
BOOL func_128(Hash hParam0) // Position - 0x7529
{
...
BOOL func_129(Player plParam0) // Position - 0x7540
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2658019[plParam0 /*467*/].f_324.f_8 != -1)
				return func_126(Global_2658019[plParam0 /*467*/].f_324.f_8) == 11;

	return false;
}

BOOL func_130(Hash hParam0) // Position - 0x7587
{
...
BOOL func_131(Vehicle veParam0) // Position - 0x75C9
{
	switch (ENTITY::GET_ENTITY_MODEL(veParam0))
	{
...
BOOL func_132(Player plParam0) // Position - 0x7691
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2658019[plParam0 /*467*/].f_324.f_8 != -1)
				return func_126(Global_2658019[plParam0 /*467*/].f_324.f_8) == 26;

	return false;
}

BOOL func_133(Player plParam0) // Position - 0x76D8
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2658019[plParam0 /*467*/].f_324.f_8 != -1)
				return func_126(Global_2658019[plParam0 /*467*/].f_324.f_8) == 13;

	return false;
}

BOOL func_134(Player plParam0) // Position - 0x771F
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2658019[plParam0 /*467*/].f_324.f_8 != -1)
				return func_126(Global_2658019[plParam0 /*467*/].f_324.f_8) == 7;

	return false;
}

BOOL func_135(Hash hParam0) // Position - 0x7765
{
	BOOL flag;
...
Hash func_136(BOOL bParam0) // Position - 0x77F6
{
	if (bParam0)
...
BOOL func_137(Player plParam0) // Position - 0x7810
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
...
BOOL func_138(Vehicle veParam0) // Position - 0x7836
{
...
BOOL func_139(Vehicle veParam0) // Position - 0x7865
{
...
BOOL func_140(Vehicle veParam0) // Position - 0x79CD
{
	Hash entityModel;
...
BOOL func_141(Hash hParam0) // Position - 0x7A4A
{
	switch (hParam0)
	{
		case joaat("mule"):
...
BOOL func_142(Player plParam0) // Position - 0x7AA6
{
	if (plParam0 == _INVALID_PLAYER_INDEX())
		return false;

	if (func_165(plParam0) && Global_2658019[plParam0 /*467*/].f_324.f_11 == plParam0)
		return true;

	return false;
}

BOOL func_143(Vehicle veParam0, BOOL bParam1) // Position - 0x7ADF
{
	switch (ENTITY::GET_ENTITY_MODEL(veParam0))
	{
...
int func_144(Vehicle veParam0) // Position - 0x7B3A
{
	int i;
...
BOOL func_145(Hash hParam0, int iParam1) // Position - 0x7B73
{
	if (iParam1 == 0)
...
BOOL func_155(Vehicle veParam0) // Position - 0x8464
{
	if (PLAYER::PLAYER_ID() != _INVALID_PLAYER_INDEX())
	{
		...
		if (func_159(PLAYER::PLAYER_ID(), true, false) && Global_1845274[PLAYER::PLAYER_ID() /*877*/].f_260.f_36 > 0 || IS_BIT_SET(Global_1845274[PLAYER::PLAYER_ID() /*877*/].f_260.f_34, 14) || IS_BIT_SET(Global_1845274[PLAYER::PLAYER_ID() /*877*/].f_260.f_34, 11))
			return false;
			...
			if (DECORATOR::DECOR_EXIST_ON(veParam0, "Player_Vehicle"))
				if (DECORATOR::DECOR_GET_INT(veParam0, "Player_Vehicle") == NETWORK::NETWORK_HASH_FROM_PLAYER_HANDLE(PLAYER::PLAYER_ID()))
					if (func_157() != -1 && func_157() < 547)
						if (!func_156(veParam0) || ENTITY::GET_ENTITY_MODEL(veParam0) != Global_1586547[func_157() /*143*/].f_66)
							return true;
...
BOOL func_156(Vehicle veParam0) // Position - 0x8572
{
...
int func_157() // Position - 0x858B
{
	return Global_2359296[func_158() /*5571*/].f_681.f_2;
}

int func_158() // Position - 0x85A3
{
	int num;
...
BOOL func_159(Player plParam0, BOOL bParam1, BOOL bParam2) // Position - 0x85B0
{
	if (plParam0 == _INVALID_PLAYER_INDEX())
		return false;
...
BOOL func_160(Player plParam0) // Position - 0x8614
{
...
BOOL func_161() // Position - 0x8645
{
	return func_162() != -1;
}

int func_162() // Position - 0x8653
{
	return Global_2658019[PLAYER::PLAYER_ID() /*467*/].f_324.f_8;
}

BOOL func_163(Player plParam0) // Position - 0x866B
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2658019[plParam0 /*467*/].f_324.f_8 != -1 && Global_2658019[plParam0 /*467*/].f_324.f_11 != _INVALID_PLAYER_INDEX())
				return func_126(Global_2658019[plParam0 /*467*/].f_324.f_8) == 5;

	return false;
}

BOOL func_164(Player plParam0) // Position - 0x86CA
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2658019[plParam0 /*467*/].f_324.f_8 != -1 && Global_2658019[plParam0 /*467*/].f_324.f_11 != _INVALID_PLAYER_INDEX())
				return func_126(Global_2658019[plParam0 /*467*/].f_324.f_8) == 8;

	return false;
}

BOOL func_165(Player plParam0) // Position - 0x872A
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2658019[plParam0 /*467*/].f_324.f_8 != -1)
				return func_126(Global_2658019[plParam0 /*467*/].f_324.f_8) == 9;

	return false;
}

BOOL func_166(Hash hParam0, BOOL bParam1, var uParam2) // Position - 0x8771
{
	BOOL flag;
...
BOOL func_167(Hash hParam0) // Position - 0x8B62
{
	switch (hParam0)
	{
		case joaat("towtruck"):
...
void func_168(Vehicle veParam0, eCharacter echParam1) // Position - 0x8B97
{
	...
	func_169(veParam0, &(Global_114370.f_32754.f_5510));
	return;
}

void func_169(Vehicle veParam0, var uParam1) // Position - 0x8D99
{
	int i;
...
int func_170(int iParam0) // Position - 0x9044
{
	switch (iParam0)
	{
		case 1:
...
BOOL func_171(int iParam0) // Position - 0x90F4
{
	switch (iParam0)
	{
		case joaat("granger"):
...
void func_172(var uParam0) // Position - 0x9114
{
	int i;
...
BOOL func_173(Vehicle veParam0) // Position - 0x91C4
{
...
BOOL func_174(Hash hParam0) // Position - 0x92A1
{
	if (hParam0 == 0)
		return false;
...
BOOL func_175(Hash hParam0, BOOL bParam1, int iParam2) // Position - 0x945F
{
	int i;
	Hash outData;
...
BOOL func_176(Hash hParam0) // Position - 0x95E4
{
	int num;
	var unk;
	var name;
...
BOOL _NETSHOPPING_SHOULD_USE_TRANSACTION_SYSTEM() // Position - 0x96B0
{
	if (MISC::IS_PC_VERSION())
...
BOOL func_178(Hash hParam0, int iParam1) // Position - 0x96C7
{
	int cloudTimeAsInt;
	int num;
	int i;
...
BOOL IS_PLAYSTATION_PLATFORM() // Position - 0x98F4
{
	return MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION();
}

BOOL IS_XBOX_PLATFORM() // Position - 0x990A
{
	return MISC::IS_DURANGO_VERSION() || MISC::IS_SCARLETT_VERSION();
}

BOOL func_181() // Position - 0x9920
{
	return false;
}

BOOL func_182() // Position - 0x9929
{
	return true;
}

BOOL func_183() // Position - 0x9932
{
	return true;
}

BOOL func_184() // Position - 0x993B
{
...
BOOL _IS_EXCLUSIVE_CONTENT_UNLOCKED() // Position - 0x9954
{
	int profileSetting;
...
BOOL func_186(Vehicle veParam0) // Position - 0x9A0C
{
	Hash entityModel;
...
BOOL func_187(Vehicle veParam0) // Position - 0x9A53
{
	int i;
...
BOOL func_188(Vehicle veParam0) // Position - 0x9ACF
{
	int i;
...
eCharacter func_189(Vehicle veParam0) // Position - 0x9BB7
{
	int i;
...
BOOL func_190(Vehicle veParam0, int iParam1, BOOL bParam2) // Position - 0x9C1A
{
	int i;
	var garageName;
	int num;
...
BOOL func_191(int iParam0, int iParam1, char* sParam2, var uParam3) // Position - 0x9C88
{
...
void func_192(Vehicle veParam0, eCharacter echParam1) // Position - 0x9D60
{
	int i;
...
void func_193(var uParam0) // Position - 0x9DE2
{
	if (!func_194(*uParam0))
...
BOOL func_194(Vehicle veParam0) // Position - 0x9E0D
{
	return VEHICLE::IS_VEHICLE_EXTRA_TURNED_ON(veParam0, 5);
}

int func_195(var uParam0, var uParam1, var uParam2) // Position - 0x9E1C
{
	int i;
	int modType;
...
BOOL func_196(Vehicle veParam0) // Position - 0xA01A
{
	int i;
	int modType;
	Hash hashKey;
...
void func_197(var uParam0) // Position - 0xA0F6
{
...
int func_198(Vehicle veParam0, int iParam1) // Position - 0xA161
{
	int value;
	int value2;
	float num;
...
int func_199(Vehicle veParam0, int iParam1) // Position - 0xA24A
{
	int i;
...
BOOL func_200(Hash hParam0) // Position - 0xA2AC
{
...
BOOL func_201(Vehicle veParam0) // Position - 0xA2D7
{
	Hash entityModel;
...
BOOL func_202(Hash hParam0) // Position - 0xA31D
{
	switch (hParam0)
	{
		case joaat("brioso"):
...
BOOL func_203(Vehicle veParam0, int iParam1, int iParam2) // Position - 0xA3D3
{
...
BOOL func_204() // Position - 0xA3F7
{
	return true;
}

BOOL func_205(var uParam0, var uParam1) // Position - 0xA404
{
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
	}
...
void func_206(eCharacter echParam0, var uParam1, int iParam2) // Position - 0xA445
{
	int num;
...
void func_207(eCharacter echParam0, int iParam1) // Position - 0xA6A1
{
	int i;
	...
	for (i = 0; i < 9; i = i + 1)
	{
		if (ENTITY::DOES_ENTITY_EXIST(Global_99223[i]))
		{
			...
			{
				if (iParam1 == 0 || ENTITY::GET_ENTITY_MODEL(Global_99223[i]) == func_208(echParam0, iParam1))
				{
...
Hash func_208(eCharacter echParam0, int iParam1) // Position - 0xA73F
{
	int num;
...
void func_209(Vector3 vParam0, var uParam1, var uParam2, float fParam3, BOOL bParam4) // Position - 0xA781
{
	int i;

	for (i = 0; i < 68; i = i + 1)
	{
		if (func_217(&Global_78558.f_555[0 /*21*/], i))
...
void func_210(int iParam0) // Position - 0xA7D1
{
	BOOL flag;
	...
	if (func_217(&Global_78558.f_555[0 /*21*/], iParam0))
	{
		...
		{
			if (iParam0 == 24 && func_216(iParam0, 0) && Global_79467.f_66 == 0 && Global_114370.f_32754.f_1958[Global_78558.f_555[0 /*21*/].f_14] != 0 && Global_114370.f_32754.f_1958[Global_78558.f_555[0 /*21*/].f_14] > 3 && !func_214(0, Global_78558.f_555[0 /*21*/].f_12) || !func_214(1, Global_78558.f_555[0 /*21*/].f_12))
			{
				func_213(&Global_114370.f_32754.f_69[Global_78558.f_555[0 /*21*/].f_14 /*78*/], &Global_79467);
...
void func_211(int iParam0, BOOL bParam1) // Position - 0xA940
{
	if (iParam0 == -1)
		return;
...
void func_212(int iParam0, int iParam1, BOOL bParam2) // Position - 0xA99D
{
	if (iParam0 == -1)
		return;
...
void func_213(var uParam0, var uParam1) // Position - 0xA9D8
{
...
BOOL func_214(int iParam0, int iParam1) // Position - 0xAAA4
{
	int num;
	...
	if (iParam0 < 0 || iParam0 >= func_215(&Global_114370.f_32754.f_5038[num /*157*/]))
		return false;

	return func_175(Global_114370.f_32754.f_5038[num /*157*/][iParam0 /*78*/].f_66, false, -1);
}

int func_215(var uParam0) // Position - 0xAB17
{
	return *uParam0;
}

BOOL func_216(int iParam0, int iParam1) // Position - 0xAB22
{
	if (iParam0 == -1)
		return false;
...
BOOL func_217(var uParam0, int iParam1) // Position - 0xAB42
{
	BOOL num;
	int num2;
	...
	*uParam0 = { 0f, 0f, 0f };
	...
	if (IS_BIT_SET(uParam0->f_9, 10))
	{
		...
		if (!func_218(Global_114370.f_32754.f_1864[uParam0->f_14 /*3*/], 0f, 0f, 0f, false))
	...
	{
		if (!func_218(Global_114370.f_2367.f_539.f_3588[1 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, false))
		{
	...
	{
		if (!func_218(Global_114370.f_2367.f_539.f_3588[0 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, false))
		{
...
BOOL func_218(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, BOOL bParam6) // Position - 0xC231
{
	if (bParam6)
...
Vehicle func_219(var uParam0, var uParam1, var uParam2, float fParam3) // Position - 0xC278
{
	return func_220(&(Global_107913.f_2890), uParam0, fParam3, false);
}

Vehicle func_220(var uParam0, float fParam1, var uParam2, var uParam3, float fParam4, BOOL bParam5) // Position - 0xC292
{
	Vehicle vehicle;
...
int func_221(Vehicle veParam0) // Position - 0xC544
{
	int i;
	var colorPrimary;
	var colorSecondary;
...
BOOL func_222(Vehicle veParam0, var uParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0xC607
{
	Hash entityModel;
	var sizeAndVehs;
	...
	{
		case joaat("cargobob"):
			if (func_223(veParam0, Global_78558.f_139[38], false))
			{
				func_210(38);
				return true;
			}
		...
		case joaat("firetruk"):
			if (func_223(veParam0, Global_78558.f_139[43], true))
			{
				func_210(43);
				return true;
			}
...
BOOL func_223(Vehicle veParam0, Vehicle veParam1, BOOL bParam2) // Position - 0xC80F
{
	var colorPrimary;
	var colorSecondary;
	var colorPrimary2;
...
void func_224(Vehicle veParam0, var uParam1, BOOL bParam2, BOOL bParam3) // Position - 0xC870
{
	int num;
	int num2;
	int i;
...
BOOL func_225(Vehicle veParam0, float fParam1) // Position - 0xCF91
{
	float entityCoords;
	var groundZ;
...
BOOL func_226() // Position - 0xD002
{
	...
	if (func_229(7))
		if (func_228(Global_2672967.f_4.f_16) || func_227(Global_2672967.f_4.f_16))
			return false;

	return true;
}

BOOL func_227(int iParam0) // Position - 0xD091
{
	int num;
...
BOOL func_228(int iParam0) // Position - 0xD0B5
{
	int num;
...
BOOL func_229(int iParam0) // Position - 0xD0D3
{
	return func_230(&(Global_2672967.f_194), iParam0);
}

BOOL func_230(var uParam0, int iParam1) // Position - 0xD0E7
{
	int num;
	int num2;
	int num3;
...
void func_231(Vehicle veParam0, int iParam1) // Position - 0xD10A
{
	int vehicleMod;
...
BOOL func_232() // Position - 0xD182
{
	return DLC::IS_DLC_PRESENT(joaat("mpindependence"));
}

BOOL func_233(Vehicle veParam0) // Position - 0xD193
{
	int _int;
...
int func_234(var uParam0) // Position - 0xD1DB
{
...
BOOL func_235(int iParam0) // Position - 0xD1FB
{
	switch (iParam0)
	{
		case 161:
...
BOOL func_236(Vehicle veParam0) // Position - 0xD24E
{
...
int func_237(Vehicle veParam0) // Position - 0xD2D5
{
...
int func_238(Player plParam0) // Position - 0xD304
{
...
int func_239(Player plParam0) // Position - 0xD321
{
...
BOOL func_240(Player plParam0, BOOL bParam1) // Position - 0xD344
{
	if (func_33(plParam0))
...
int func_241(Player plParam0) // Position - 0xD388
{
	if (func_33(plParam0))
		if (func_240(plParam0, false))
...
BOOL _IS_PLAYER_IN_VEHICLE_SEAT(Player plParam0, int iParam1) // Position - 0xD3B4
{
...
BOOL func_243(var uParam0) // Position - 0xD401
{
	if (func_244(uParam0))
	{
...
BOOL func_244(var uParam0) // Position - 0xD436
{
...
BOOL func_245() // Position - 0xD496
{
	return func_243(&(Global_107913.f_2890));
}

void func_246() // Position - 0xD4A9
{
	func_247(&(Global_107913.f_2890));
	return;
}

void func_247(var uParam0) // Position - 0xD4BC
{
	if (func_244(uParam0))
...
BOOL func_248(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0xD4DA
{
	...
	if (iParam2 == 0 && func_250(Global_107913.f_2890.f_12.f_66))
		return false;
...
BOOL func_250(Hash hParam0) // Position - 0xD5DD
{
	switch (hParam0)
	{
		case joaat("police"):
...
BOOL func_251() // Position - 0xD68B
{
	return func_244(&(Global_107913.f_2890));
}

void func_252(int iParam0) // Position - 0xD69E
{
	Global_97747 = 0;
...
void func_253(int iParam0) // Position - 0xD72C
{
	MISC::SET_BIT(&Global_97747, iParam0);
	return;
}

void func_254() // Position - 0xD73E
{
...
BOOL func_256(BOOL bParam0, int iParam1) // Position - 0xD837
{
	int num;
...
int func_257(int iParam0, int iParam1) // Position - 0xD883
{
	int num;
...
int func_258(int iParam0) // Position - 0xD898
{
	return Global_61697[iParam0];
}

BOOL func_259(int iParam0) // Position - 0xD8A7
{
	return func_89(iParam0, 1, true);
}

void func_260(int iParam0) // Position - 0xD8B7
{
	HUD::CLEAR_PRINTS();
	func_261();
...
void func_263() // Position - 0xD96E
{
	if (func_265())
	{
		...
		{
			case CHAR_MICHAEL:
				if (Global_114370.f_2367.f_539.f_2395[0] == -99)
					func_264(uLocal_206[0], uLocal_206[1], uLocal_206[2]);
				else if (Global_114370.f_2367.f_539.f_2395[1] == -99)
					func_264(uLocal_206[1], uLocal_206[0], uLocal_206[2]);
				else if (Global_114370.f_2367.f_539.f_2395[2] == -99)
					func_264(uLocal_206[2], uLocal_206[1], uLocal_206[0]);
				break;
		
			case CHAR_FRANKLIN:
				if (Global_114370.f_2367.f_539.f_2395[1] == -99)
					func_264(uLocal_206[1], uLocal_206[0], uLocal_206[2]);
				else if (Global_114370.f_2367.f_539.f_2395[0] == -99)
					func_264(uLocal_206[0], uLocal_206[1], uLocal_206[2]);
				else if (Global_114370.f_2367.f_539.f_2395[2] == -99)
					func_264(uLocal_206[2], uLocal_206[1], uLocal_206[0]);
				break;
			...
			case CHAR_TREVOR:
				if (Global_114370.f_2367.f_539.f_2395[2] == -99)
					func_264(uLocal_206[2], uLocal_206[1], uLocal_206[0]);
				else if (Global_114370.f_2367.f_539.f_2395[0] == -99)
					func_264(uLocal_206[0], uLocal_206[1], uLocal_206[2]);
				else if (Global_114370.f_2367.f_539.f_2395[1] == -99)
...
void func_264(const char* sParam0, const char* sParam1, const char* sParam2) // Position - 0xDB24
{
...
BOOL func_265() // Position - 0xDB60
{
	return MISC::GET_GAME_TIMER() <= Global_24148.f_6481 + 100;
}

int func_266() // Position - 0xDB75
{
	int num;
	int i;
	...
	for (i = 0; i <= 2; i = i + 1)
	{
		if (Global_114370.f_2367.f_539.f_2395[i] != -99)
			num = num + 1;
	}
...
BOOL func_267(Ped pedParam0) // Position - 0xDBB1
{
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(pedParam0))
...
void func_269(eCharacter echParam0, int iParam1, int iParam2, BOOL bParam3, BOOL bParam4) // Position - 0xDC21
{
	int outValue;
	Hash statHash;
...
int func_270(int iParam0, int iParam1, int iParam2, int iParam3, BOOL bParam4) // Position - 0xDCF3
{
	float num;
	int num2;
	int num3;
...
void func_271(BOOL bParam0) // Position - 0xE2F2
{
	int i;
	int j;
...
void func_272(int iParam0) // Position - 0xE574
{
	int value;
...
void func_273(int iParam0) // Position - 0xE5CE
{
	int num;
	BOOL flag;
	var txdName;
	...
	else if (IS_BIT_SET(Global_114370.f_20568.f_471, iParam0) || IS_BIT_SET(Global_2359296[func_158() /*5571*/].f_681.f_10, iParam0))
	{
		flag = true;
		MISC::CLEAR_BIT(&(Global_114370.f_20568.f_471), iParam0);
...
char* AUDIO_SPEECH_GET_PARAM_STRING_FROM_ENUM(int iParam0) // Position - 0xE799
{
	switch (iParam0)
	{
		case 0:
...
void _MPPLY_STAT_SET_INT(Hash hParam0, int iParam1) // Position - 0xE8CB
{
	Hash statName;
...
int _MPPLY_STAT_GET_INT(Hash hParam0) // Position - 0xE8E7
{
	Hash statHash;
	int outValue;
...
Hash func_277(int iParam0) // Position - 0xE905
{
	switch (iParam0)
	{
		case 38:
...
BOOL func_278(int iParam0) // Position - 0xE927
{
	switch (iParam0)
	{
		case 38:
...
int func_279(int iParam0) // Position - 0xE944
{
	switch (iParam0)
	{
		case 18:
...
BOOL func_280(int iParam0) // Position - 0xEA49
{
	switch (iParam0)
	{
		case 18:
...
void func_281(int iParam0, int iParam1, int iParam2, BOOL bParam3) // Position - 0xEAD8
{
	Hash statName;
...
void _STAT_SET_PACKED_BOOL(int iParam0, BOOL bParam1, int iParam2) // Position - 0xEB06
{
	if (iParam2 == -1)
		iParam2 = func_32();
...
void func_283(int iParam0) // Position - 0xEB24
{
	func_302(93, iParam0);
	func_302(29, iParam0);
	func_302(30, iParam0);
...
BOOL func_284(int iParam0) // Position - 0xEB44
{
	int cloudTimeAsInt;
	int num;
	int cloudTimeAsInt2;
...
BOOL _STAT_GET_PACKED_BOOL(int iParam0, int iParam1) // Position - 0xED4F
{
	if (iParam1 == -1)
		iParam1 = func_32();
...
int func_286(BOOL bParam0) // Position - 0xED6B
{
	var outValue;
	int value;
	int outValue2;
...
int func_287(int iParam0, int iParam1) // Position - 0xEE22
{
	if (iParam0 >= 78)
		return 0;
...
int func_288(int iParam0, int iParam1) // Position - 0xEE3D
{
	...
	if (func_298(&Global_4546910))
	{
		if (func_296(&Global_4546910, iParam0))
			return 0;
	
		if (func_289(&Global_4546910, iParam0))
			return 1;
	}
	else
	{
...
BOOL func_289(var uParam0, int iParam1) // Position - 0xEEDA
{
	int i;
	var unk;
...
int func_290(var uParam0, int iParam1) // Position - 0xEF8B
{
	int i;
...
BOOL func_291(var uParam0, int iParam1) // Position - 0xF006
{
	return uParam0->[iParam1] == 78;
}

void func_292(var uParam0) // Position - 0xF017
{
	int i;
	...
	func_294(uParam0, Global_4546909 - 0.5f);
	return;
}

void func_293(var uParam0, int iParam1) // Position - 0xF04B
{
	uParam0->[iParam1] = 78;
	return;
}

void func_294(var uParam0, int iParam1) // Position - 0xF05B
{
	if (iParam1 == 0f)
		uParam0->f_80 = 0f;
	else
...
float func_295(var uParam0) // Position - 0xF078
{
	return uParam0->f_80;
}

BOOL func_296(var uParam0, int iParam1) // Position - 0xF084
{
	return func_297(uParam0, iParam1) != -1;
}

int func_297(var uParam0, int iParam1) // Position - 0xF096
{
	int i;
...
BOOL func_298(var uParam0) // Position - 0xF0C3
{
	return uParam0->f_79 == 1;
}

BOOL func_299(int iParam0) // Position - 0xF0D1
{
	switch (iParam0)
	{
		case 60:
...
BOOL func_300(int iParam0, int iParam1) // Position - 0xF121
{
...
void func_301(Hash hParam0, int iParam1) // Position - 0xF172
{
	int outValue;
...
void func_302(int iParam0, int iParam1) // Position - 0xF195
{
	int outValue;
...
int func_304(eCharacter echParam0) // Position - 0xF267
{
	return Global_2241[echParam0 /*29*/].f_17;
}

BOOL _IS_MISSION_REPEAT_ACTIVE(BOOL bExcludeBenchmark) // Position - 0xF278
{
...
void func_306(float fParam0, float fParam1, float fParam2, float fParam3, int iParam4, int iParam5) // Position - 0xF2A0
{
	if (_IS_MISSION_REPLAY_IN_PROGRESS())
	{
...
BOOL _IS_MISSION_REPLAY_IN_PROGRESS() // Position - 0xF335
{
...
int func_309(int iParam0, int iParam1, int iParam2, BOOL bParam3) // Position - 0xF6A9
{
	Global_79551[1 /*14*/] = { func_311(iParam0, iParam1, iParam2, -1) };

	if (IS_BIT_SET(Global_79551[1 /*14*/].f_6, 0) && !IS_BIT_SET(Global_79551[1 /*14*/].f_6, 6))
	{
		if (bParam3)
			func_310(iParam1, Global_79551[1 /*14*/].f_5, Global_79551[1 /*14*/].f_2, 0, Global_79551[1 /*14*/].f_1, 1, 0);
		else
			func_310(iParam1, Global_79551[1 /*14*/].f_5, Global_79551[1 /*14*/].f_2, 0, Global_79551[1 /*14*/].f_1, 0, 1);
...
BOOL func_310(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0xF73F
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
struct<14> func_311(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x105E3
{
	func_376();
...
void func_312(int iParam0, int iParam1) // Position - 0x10635
{
	switch (iParam0)
	{
		case 0:
...
void func_313(int iParam0) // Position - 0x10725
{
	BOOL flag;
	int num;
	var unk;
	...
	func_314(&Global_79551[0 /*14*/], num6, iParam0, &unk, num2, num3, num, flag, num4, num5, false);
	return;
}

void func_314(int iParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, BOOL bParam7, int iParam8, int iParam9, BOOL bParam10) // Position - 0x1199C
{
	int num;
	int num2;
	...
	*iParam0 = iParam9;
	...
	else
	{
		...
		if (iParam1 == 11 || iParam1 == 4 || iParam1 == 6 || iParam1 == 1 || iParam1 == 14 || iParam1 == 2 || iParam1 == 8 || iParam1 == 9 || iParam1 == 10 || iParam1 == 7 || iParam1 == 12)
		{
			...
			num = func_90(func_317(iParam1, iParam0->f_2), Global_79548);
		
			if (IS_BIT_SET(num, iParam0->f_1))
				MISC::SET_BIT(&(iParam0->f_6), 1);
		
			num = func_90(func_316(iParam1, iParam0->f_2), Global_79548);
...
BOOL func_315(int iParam0, int iParam1, var uParam2) // Position - 0x11D3E
{
	*uParam2 = 979;
...
int func_316(int iParam0, int iParam1) // Position - 0x12143
{
	switch (iParam1)
	{
		case 0:
...
int func_317(int iParam0, int iParam1) // Position - 0x1253E
{
	switch (iParam1)
	{
		case 0:
...
BOOL func_318(Hash hParam0, int iParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0x12939
{
	int num;
	int num2;
	int num3;
...
BOOL func_319(Hash hParam0, int iParam1, var uParam2, var uParam3, BOOL bParam4, BOOL bParam5) // Position - 0x12977
{
...
int func_320(int iParam0) // Position - 0x15634
{
	switch (iParam0)
	{
		case -1:
...
void func_321(int iParam0, int iParam1, int iParam2, Hash hParam3) // Position - 0x15708
{
	int num;
	int num2;
	Hash outfit;
	...
	if (iParam0 == 12)
	{
		...
		if (outfitIndex >= 0)
		{
			...
			if (num3 > outfitIndex)
			{
				...
				func_314(&Global_79551[0 /*14*/], iParam0, iParam1, &(outfit.f_7), 0, 0, outfit.f_2, false, -1, 2, true);
				return;
			}
		}
	}
	...
	{
		func_314(&Global_79551[0 /*14*/], iParam0, iParam1, "NO_LABEL", 0, 0, 0, true, -1, 2, true);
	}
	else if (iParam0 == 14)
	{
		...
		if (componentId >= 0)
		{
			...
			if (num5 > componentId)
			{
				...
				func_314(&Global_79551[0 /*14*/], iParam0, iParam1, &(outProp.f_9), outProp.f_3, outProp.f_4, outProp.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(outProp.f_1, joaat("OUTFIT_ONLY"), 0), num4, 2, outProp.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (hParam3 != -1 && Global_79749)
		{
			...
			func_314(&Global_79551[0 /*14*/], iParam0, iParam1, &(outComponent.f_9), outComponent.f_3, outComponent.f_4, outComponent.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(outComponent.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, outComponent.f_1 != 0);
			return;
		}
...
int func_322(int iParam0) // Position - 0x1598F
{
	switch (iParam0)
	{
		case 0:
...
void func_323(int iParam0) // Position - 0x15A3F
{
	BOOL flag;
	int num;
	var unk;
...
void func_324(int iParam0) // Position - 0x15B96
{
	BOOL flag;
	int num;
	var unk;
...
void func_325(int iParam0) // Position - 0x160A4
{
	BOOL flag;
	int num;
	var unk;
...
void func_326(int iParam0) // Position - 0x16119
{
	BOOL flag;
	int num;
	var unk;
...
void func_327(int iParam0) // Position - 0x1618D
{
	BOOL flag;
	int num;
	var unk;
...
void func_328(int iParam0) // Position - 0x16274
{
	BOOL flag;
	int num;
	var unk;
...
void func_329(int iParam0) // Position - 0x165D7
{
	BOOL flag;
	int num;
	var unk;
...
void func_330(int iParam0) // Position - 0x167E8
{
	BOOL flag;
	int num;
	var unk;
...
void func_331(int iParam0) // Position - 0x16A18
{
	BOOL flag;
	int num;
	var unk;
...
void func_332(int iParam0) // Position - 0x16B28
{
	BOOL flag;
	int num;
	var unk;
...
void func_333(int iParam0) // Position - 0x174C7
{
	BOOL flag;
	int num;
	var unk;
...
void func_334(int iParam0) // Position - 0x1803B
{
	if (iParam0 < 136)
		func_336(iParam0);
	else
...
void func_335(int iParam0) // Position - 0x18070
{
	BOOL flag;
	int num;
	var unk;
...
void func_336(int iParam0) // Position - 0x18C74
{
	BOOL flag;
	int num;
	var unk;
...
void func_337(int iParam0) // Position - 0x19B82
{
	BOOL flag;
	int num;
	var unk;
...
void func_338(int iParam0) // Position - 0x19CAF
{
	BOOL flag;
	int num;
	var unk;
...
void func_339(int iParam0, int iParam1) // Position - 0x19DAD
{
	switch (iParam0)
	{
		case 0:
...
void func_340(int iParam0) // Position - 0x19E9D
{
	BOOL flag;
	int num;
	var unk;
...
void func_341(int iParam0) // Position - 0x1B38E
{
	BOOL flag;
	int num;
	var unk;
...
void func_342(int iParam0) // Position - 0x1B4DF
{
	BOOL flag;
	int num;
	var unk;
...
void func_343(int iParam0) // Position - 0x1B9EA
{
	BOOL flag;
	int num;
	var unk;
...
void func_344(int iParam0) // Position - 0x1C05A
{
	BOOL flag;
	int num;
	var unk;
...
void func_345(int iParam0) // Position - 0x1C0CE
{
	BOOL flag;
	int num;
	var unk;
...
void func_346(int iParam0) // Position - 0x1C19E
{
	BOOL flag;
	int num;
	var unk;
...
void func_347(int iParam0) // Position - 0x1C6CE
{
	BOOL flag;
	int num;
	var unk;
...
void func_348(int iParam0) // Position - 0x1C865
{
	BOOL flag;
	int num;
	var unk;
...
void func_349(int iParam0) // Position - 0x1D063
{
	BOOL flag;
	int num;
	var unk;
...
void func_350(int iParam0) // Position - 0x1D173
{
	BOOL flag;
	int num;
	var unk;
...
void func_351(int iParam0) // Position - 0x1E09E
{
	BOOL flag;
	int num;
	var unk;
...
void func_352(int iParam0) // Position - 0x1ED5B
{
	if (iParam0 < 107)
		func_355(iParam0);
	else if (iParam0 < 227)
...
void func_353(int iParam0) // Position - 0x1EDA1
{
	BOOL flag;
	int num;
	var unk;
...
void func_354(int iParam0) // Position - 0x1F846
{
	BOOL flag;
	int num;
	var unk;
...
void func_355(int iParam0) // Position - 0x20636
{
	BOOL flag;
	int num;
	var unk;
...
void func_356(int iParam0) // Position - 0x2127F
{
	BOOL flag;
	int num;
	var unk;
...
void func_357(int iParam0) // Position - 0x214F8
{
	BOOL flag;
	int num;
	var unk;
...
void func_358(int iParam0, int iParam1) // Position - 0x2163E
{
	switch (iParam0)
	{
		case 0:
...
void func_359(int iParam0) // Position - 0x2172E
{
	BOOL flag;
	int num;
	var unk;
...
void func_360(int iParam0) // Position - 0x224B8
{
	BOOL flag;
	int num;
	var unk;
...
void func_361(int iParam0) // Position - 0x22632
{
	BOOL flag;
	int num;
	var unk;
...
void func_362(int iParam0) // Position - 0x22BA9
{
	BOOL flag;
	int num;
	var unk;
...
void func_363(int iParam0) // Position - 0x230D3
{
	BOOL flag;
	int num;
	var unk;
...
void func_364(int iParam0) // Position - 0x23147
{
	BOOL flag;
	int num;
	var unk;
...
void func_365(int iParam0) // Position - 0x23217
{
	BOOL flag;
	int num;
	var unk;
...
void func_366(int iParam0) // Position - 0x236EF
{
	BOOL flag;
	int num;
	var unk;
...
void func_367(int iParam0) // Position - 0x23958
{
	BOOL flag;
	int num;
	var unk;
...
void func_368(int iParam0) // Position - 0x23C2E
{
	BOOL flag;
	int num;
	var unk;
...
void func_369(int iParam0) // Position - 0x23DF7
{
	BOOL flag;
	int num;
	var unk;
...
void func_370(int iParam0) // Position - 0x24B2D
{
	BOOL flag;
	int num;
	var unk;
...
void func_371(int iParam0) // Position - 0x25777
{
	if (iParam0 < 60)
		func_373(iParam0);
	else
...
void func_372(int iParam0) // Position - 0x257AC
{
	BOOL flag;
	int num;
	var unk;
...
void func_373(int iParam0) // Position - 0x2654C
{
	BOOL flag;
	int num;
	var unk;
...
void func_374(int iParam0) // Position - 0x26BD8
{
	BOOL flag;
	int num;
	var unk;
...
void func_375(int iParam0) // Position - 0x26CBF
{
	BOOL flag;
	int num;
	var unk;
...
void func_376() // Position - 0x26DBD
{
...
void func_377() // Position - 0x26E36
{
	func_386();
	func_385();
	func_378();
...
void func_378() // Position - 0x26E4A
{
	var unk;
...
void func_379(var uParam0, int iParam1) // Position - 0x26EB7
{
	int i;
...
void func_380(var uParam0, var uParam1, float fParam2) // Position - 0x26EFB
{
	int num;
	int num2;
	int num3;
...
BOOL func_381(var uParam0, float fParam1, var uParam2, var uParam3) // Position - 0x27008
{
	BOOL flag;
	int num;
	int num2;
...
void func_382(var uParam0) // Position - 0x270C4
{
	int i;
	float num;
...
void func_383(var uParam0, var uParam1, var uParam2, var uParam3) // Position - 0x27164
{
	uParam0->f_51 == 0;
	uParam0->f_46 >= 15;
...
void func_384(var uParam0) // Position - 0x27195
{
	uParam0->f_51;
	uParam0->f_46 = 0;
...
void func_385() // Position - 0x271BC
{
...
void func_386() // Position - 0x271DC
{
	return;
}

void func_387() // Position - 0x271E4
{
	func_398(true);
	func_397();
	func_388(false);
...
void func_388(BOOL bParam0) // Position - 0x271FE
{
	bParam0;
	func_396(true, 1, 1);
	PLAYER::SET_PLAYER_CONTROL(PLAYER::PLAYER_ID(), true, 0);
...
void func_389() // Position - 0x27269
{
	return;
}

void func_390() // Position - 0x27271
{
	Global_21468 = 0;
	func_391();
	return;
...
void func_391() // Position - 0x27281
{
	AUDIO::RESTART_SCRIPTED_CONVERSATION();
	Global_23613 = 0;
...
void func_392() // Position - 0x272A2
{
	return;
}

void func_393() // Position - 0x272AA
{
	return;
}

void func_394() // Position - 0x272B2
{
	return;
}

void func_395() // Position - 0x272BA
{
	return;
}

void func_396(BOOL bParam0, int iParam1, int iParam2) // Position - 0x272C2
{
...
void func_397() // Position - 0x27321
{
	Global_97747 = 0;
	return;
}

void func_398(BOOL bParam0) // Position - 0x2732E
{
...
void func_399() // Position - 0x27375
{
	int num;
...
BOOL func_400() // Position - 0x273E6
{
	if (Global_101917 == 13 || Global_101917 == 10 || Global_101917 == 11 || Global_101917 == 12)
		return false;
...
void func_401() // Position - 0x27424
{
	Global_114370.f_2367.f_539.f_2395[0] = -99;
	Global_114370.f_2367.f_539.f_2395[1] = -99;
	Global_114370.f_2367.f_539.f_2395[2] = -99;
