	...
	if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(83))
	{
		...
		if (num != -1)
		{
			if (Global_113457[num /*10*/].f_9 != -1)
			{
				...
				func_304(&(Global_113457[num /*10*/].f_9));
			}
		}
...
BOOL IS_RC_FINE_AND_IN_RANGE(Any* panParam0, BOOL bParam1) // Position - 0xE3CB
{
	...
	if (func_263(*panParam0) || func_261(*panParam0) || Global_80014 == 1)
		return true;
...
{
	if (func_262() && Global_101917.f_11 == 6 && iParam0 == func_179(&(Global_101917.f_3), 0))
		return true;
