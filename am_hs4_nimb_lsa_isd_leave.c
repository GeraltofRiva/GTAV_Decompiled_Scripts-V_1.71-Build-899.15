...
BOOL func_72(var uParam0) // Position - 0x1A3F
{
	if (uParam0->f_20 == 0)
		return true;
...
Hash func_73() // Position - 0x1AC0
{
	return ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID());
}

var func_74(BOOL bParam0, var uParam1, var uParam2) // Position - 0x1AD0
{
	if (bParam0)
		return uParam1;
...
void func_75(var uParam0) // Position - 0x1AE7
{
	func_63();
...
void func_76(var uParam0) // Position - 0x1B01
{
	func_171(uParam0);
	...
	{
		_STOPWATCH_HAS_TIME_PASSED(&(uParam0->f_18), Global_262145.f_30268, false);
		return;
	}
...
void func_77(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x1BA8
{
	func_79();
	func_49(true);
	HUD::CLEAR_HELP(true);
...
void func_80(var uParam0) // Position - 0x1C9D
{
	var unk;
...
void func_81(Vehicle veParam0, var uParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x1D98
{
	Hash entityModel;
	float num;
	...
	if (ENTITY::DOES_ENTITY_EXIST(veParam0) && VEHICLE::IS_VEHICLE_DRIVEABLE(veParam0, false))
	{
		if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS() && NETWORK::NETWORK_HAS_CONTROL_OF_ENTITY(veParam0) || !NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		{
			...
			if (ENTITY::GET_ENTITY_MODEL(veParam0) == 858355070)
				unk_0xDD8A2D3337F04196(veParam0, 0);
...
BOOL IS_GAMER_HANDLE_VALID(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12) // Position - 0x230F
{
	return NETWORK::NETWORK_IS_HANDLE_VALID(&uParam0, 13);
}

BOOL func_83(Vehicle veParam0) // Position - 0x231F
{
	Hash entityModel;
...
BOOL func_84(Hash hParam0) // Position - 0x2365
{
	switch (hParam0)
	{
		case joaat("brioso"):
...
BOOL func_85(Hash hParam0) // Position - 0x241B
{
	switch (hParam0)
	{
		case -1321131184:
...
BOOL func_86(Hash hParam0) // Position - 0x2449
{
	switch (hParam0)
	{
		case joaat("coureur"):
...
BOOL func_87(Hash hParam0) // Position - 0x247E
{
	switch (hParam0)
	{
		case joaat("pounder2"):
...
void func_88(Vehicle veParam0) // Position - 0x2585
{
	Hash entityModel;
...
void func_89(var uParam0, var uParam1, var uParam2) // Position - 0x2610
{
	Hash eventData;
...
int _GET_LOBBY_SCRIPT_EVENT_BITS(BOOL includeLocalPlayer, BOOL includeSpectators) // Position - 0x2651
{
	int address;
	int i;
	Player player;
...
BOOL func_91(int iParam0) // Position - 0x26B6
{
	int i;
...
BOOL func_92(int iParam0) // Position - 0x26F1
{
	return func_93(iParam0, 6, true);
}

BOOL func_93(int iParam0, int iParam1, BOOL bParam2) // Position - 0x2701
{
	if (iParam0 == -1)
		return false;
...
int func_94(int iParam0, int iParam1) // Position - 0x2761
{
	Hash statHash;
	int outValue;
...
Hash func_95(int iParam0, int iParam1) // Position - 0x2790
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(0, iParam0, func_96(iParam1));
}

int func_96(int iParam0) // Position - 0x27A5
{
	int num;
	int num2;
...
int func_97(int iParam0) // Position - 0x27D9
{
	switch (iParam0)
	{
		case 0:
...
int func_98() // Position - 0x2B90
{
	return Global_33298;
}

int func_99(int iParam0) // Position - 0x2B9B
{
	switch (iParam0)
	{
		case -1:
...
BOOL func_100() // Position - 0x2EDE
{
	return Global_101969.f_400 > 0;
}

int func_101(Vehicle veParam0, Any* panParam1) // Position - 0x2EEF
{
...
BOOL func_102(Vehicle veParam0) // Position - 0x2F6C
{
	int vehicleCrewEmblemRequestState;
	int networkTime;
	int num;
...
void func_103(Vehicle veParam0) // Position - 0x2FF9
{
	int _int;
...
BOOL func_104(var uParam0, Player plParam1) // Position - 0x3055
{
	func_108();
	...
	func_106(*uParam0, &Global_1946326, &(Global_1946326.f_1), &(Global_1946326.f_4), &(Global_1946326.f_7), &(Global_1946326.f_10));
	...
	{
		if (func_105(uParam0, plParam1, Global_1946326, Global_1946326.f_1, Global_1946326.f_4, Global_1946326.f_7, Global_1946326.f_10, 0, Global_1946326.f_13))
		{
			if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	...
	else
	{
		...
		if (Global_1946326.f_23 == 0 && func_105(uParam0, plParam1, Global_1946326, Global_1946326.f_1, Global_1946326.f_4, Global_1946326.f_7, Global_1946326.f_10, 0, Global_1946326.f_13) || Global_1946326.f_23 != 0 && Global_1946326.f_24 == 0 && func_105(uParam0, plParam1, Global_1946326, Global_1946326.f_14, Global_1946326.f_17, Global_1946326.f_20, Global_1946326.f_10, 1, Global_1946326.f_13) || Global_1946326.f_24 != 0)
		{
			if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
				Global_1577972 = NETWORK::GET_NETWORK_TIME();
			else
...
BOOL func_105(var uParam0, Player plParam1, int iParam2, Vector3 vParam3, var uParam4, var uParam5, Vector3 vParam6, var uParam7, var uParam8, Vector3 vParam9, var uParam10, var uParam11, float fParam12, int iParam13, int iParam14) // Position - 0x3300
{
...
int func_106(Vehicle veParam0, int iParam1, var uParam2, var uParam3, var uParam4, float fParam5) // Position - 0x3329
{
	if (!ENTITY::DOES_ENTITY_EXIST(veParam0) || !VEHICLE::IS_VEHICLE_DRIVEABLE(veParam0, false))
		return 0;
	...
	*iParam1 = ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(veParam0, "chassis_dummy");
	...
	if (!func_107(Global_1946352, 0f, 0f, 0f, false) && !func_107(Global_1946355, 0f, 0f, 0f, false) && !func_107(Global_1946358, 0f, 0f, 0f, false) && !(Global_1946361 == 0f))
	{
...
BOOL func_107(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, BOOL bParam6) // Position - 0x9285
{
	if (bParam6)
...
BOOL func_109(Vehicle veParam0) // Position - 0x9345
{
	if (ENTITY::DOES_ENTITY_EXIST(veParam0) && VEHICLE::IS_VEHICLE_DRIVEABLE(veParam0, false))
...
BOOL func_110(Vehicle veParam0) // Position - 0x937D
{
	int _int;
...
BOOL func_111(Vehicle veParam0, Any* panParam1) // Position - 0x93C5
{
	Player playerFromGamerHandle;
	BOOL flag;
	int num;
...
BOOL func_112(Vehicle veParam0) // Position - 0x9522
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		return true;
...
int func_113(Vehicle veParam0) // Position - 0x9879
{
...
int func_114(Player plParam0) // Position - 0x98A5
{
...
int func_115(Player plParam0) // Position - 0x98C2
{
...
BOOL func_116(Player plParam0, BOOL bParam1) // Position - 0x98E5
{
	if (func_11(plParam0))
...
int func_117(Player plParam0) // Position - 0x9929
{
	if (func_11(plParam0))
		if (func_116(plParam0, false))
...
BOOL func_119(BOOL bParam0) // Position - 0x9962
{
	return func_120(PLAYER::PLAYER_ID(), bParam0);
}

BOOL func_120(Player plParam0, BOOL bParam1) // Position - 0x9974
{
	return func_121(plParam0, bParam1, 1);
}

BOOL func_121(Player plParam0, BOOL bParam1, int iParam2) // Position - 0x9985
{
	Player player;
...
BOOL func_122(Player plParam0, int iParam1) // Position - 0x99E1
{
	if (func_11(plParam0))
...
BOOL func_123(int iParam0, BOOL bParam1) // Position - 0x9A30
{
	int num;
	int num2;
...
int func_124(int iParam0) // Position - 0x9A8E
{
	return iParam0 % 32;
}

int func_125(int iParam0) // Position - 0x9A9B
{
	int num;
...
int func_126(int iParam0) // Position - 0x9AB2
{
	int num;
	int num2;
...
int func_127(int iParam0) // Position - 0x9ADF
{
	return iParam0 / 32;
}

BOOL func_128(Player plParam0) // Position - 0x9AEC
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (func_129(plParam0) && Global_2658019[plParam0 /*467*/].f_324.f_11 == plParam0)
			return true;

	return false;
}

BOOL func_129(Player plParam0) // Position - 0x9B21
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2658019[plParam0 /*467*/].f_324.f_8 != -1)
				return func_130(Global_2658019[plParam0 /*467*/].f_324.f_8) == 22;

	return false;
}

int func_130(int iParam0) // Position - 0x9B68
{
	switch (iParam0)
	{
		case 0:
...
void func_131(Vehicle veParam0, int iParam1) // Position - 0xA0B7
{
	int num;
	int num2;
...
BOOL func_132(int iParam0, var uParam1) // Position - 0xA0D8
{
	*uParam1 = -1;
...
int func_133(int iParam0) // Position - 0xA39A
{
	switch (iParam0)
	{
		case 0:
...
int func_134(int iParam0, int iParam1, int iParam2) // Position - 0xA438
{
	...
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS() && func_135() && Global_1576245)
...
struct<13> GET_LOCAL_GAMER_HANDLE() // Position - 0xA662
{
	var gamerHandle;
...
BOOL func_137(Vehicle veParam0) // Position - 0xA677
{
	switch (ENTITY::GET_ENTITY_MODEL(veParam0))
	{
		case joaat("deathbike2"):
...
BOOL func_138(int iParam0, var uParam1) // Position - 0xA698
{
	*uParam1 = -1f;
...
void func_139(Vehicle veParam0) // Position - 0xA999
{
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
...
void func_140(Vehicle veParam0) // Position - 0xA9CB
{
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		if (DECORATOR::DECOR_IS_REGISTERED_AS_TYPE("MLJ", BOOL))
			if (!DECORATOR::DECOR_EXIST_ON(veParam0, "MLJ"))
...
BOOL func_141(Hash hParam0) // Position - 0xA9FF
{
	switch (hParam0)
	{
		case 1484920335:
...
BOOL func_142(Hash hParam0) // Position - 0xAA22
{
...
BOOL func_143(Hash hParam0) // Position - 0xB4C9
{
	switch (hParam0)
	{
		case joaat("deity"):
...
void func_144(Vehicle veParam0, var uParam1, BOOL bParam2, BOOL bParam3) // Position - 0xB558
{
	int num;
	int num2;
	int i;
...
BOOL func_145(Vehicle veParam0, float fParam1) // Position - 0xBC77
{
	float entityCoords;
	var groundZ;
...
Hash func_146(BOOL bParam0) // Position - 0xBCE8
{
	if (bParam0)
...
BOOL func_147() // Position - 0xBD02
{
	...
	if (func_151(7))
		if (func_149(Global_2672967.f_4.f_16) || func_148(Global_2672967.f_4.f_16))
			return false;

	return true;
}

BOOL func_148(int iParam0) // Position - 0xBD91
{
	int num;
...
BOOL func_149(int iParam0) // Position - 0xBDB5
{
	int num;
...
BOOL func_150(int iParam0, int iParam1) // Position - 0xBDD3
{
	return IS_BIT_SET(Global_1888882[iParam0 /*611*/].f_10.f_4, iParam1);
}

BOOL func_151(int iParam0) // Position - 0xBDEB
{
	return func_152(&(Global_2672967.f_194), iParam0);
}

BOOL func_152(var uParam0, int iParam1) // Position - 0xBDFF
{
	int num;
	int num2;
	int num3;
...
int func_153(var uParam0, var uParam1, var uParam2) // Position - 0xBE22
{
	int i;
	int modType;
...
BOOL func_154(Vehicle veParam0) // Position - 0xC022
{
	int i;
	int modType;
	Hash hashKey;
...
void func_155(var uParam0) // Position - 0xC0FC
{
...
int func_156(Vehicle veParam0, int iParam1) // Position - 0xC167
{
	int value;
	int value2;
	float num;
...
int func_157(Vehicle veParam0, int iParam1) // Position - 0xC250
{
	int i;
...
BOOL func_158(Hash hParam0) // Position - 0xC2B2
{
...
BOOL func_159(Hash hParam0, int iParam1) // Position - 0xC2DD
{
	switch (hParam0)
	{
		case joaat("faction2"):
...
BOOL func_160(Vehicle veParam0, int iParam1, int iParam2) // Position - 0xC6C3
{
...
BOOL func_161() // Position - 0xC6E7
{
	return true;
}

void func_162(Vehicle veParam0, int iParam1) // Position - 0xC6F4
{
	int vehicleMod;
...
BOOL func_163(int iParam0) // Position - 0xC76C
{
	switch (iParam0)
	{
		case joaat("granger"):
...
BOOL func_164() // Position - 0xC78C
{
	return DLC::IS_DLC_PRESENT(joaat("mpindependence"));
}

BOOL func_165(Vehicle veParam0) // Position - 0xC79D
{
	int _int;
...
int func_166(var uParam0) // Position - 0xC7E2
{
...
BOOL func_167(int iParam0) // Position - 0xC802
{
	switch (iParam0)
	{
		case 161:
...
int func_168(int iParam0) // Position - 0xC855
{
	switch (iParam0)
	{
		case 1:
...
BOOL func_169(Vehicle veParam0) // Position - 0xC905
{
...
BOOL _IS_PLAYER_IN_VEHICLE_SEAT(Player plParam0, int iParam1) // Position - 0xC98C
{
...
void func_171(var uParam0) // Position - 0xC9D9
{
...
void func_172(var uParam0) // Position - 0xCA27
{
	...
	if (!STREAMING::IS_NEW_LOAD_SCENE_ACTIVE() || !STREAMING::IS_NEW_LOAD_SCENE_LOADED())
		if (!_STOPWATCH_HAS_TIME_PASSED(&(uParam0->f_18), Global_262145.f_30268, false))
			return;
	else
		STREAMING::NEW_LOAD_SCENE_STOP();
...
Vector3 func_173(float fParam0, var uParam1, var uParam2) // Position - 0xCAE1
{
	return -SYSTEM::SIN(fParam0.f_2) * SYSTEM::COS(fParam0), SYSTEM::COS(fParam0.f_2) * SYSTEM::COS(fParam0), SYSTEM::SIN(fParam0);
}

BOOL func_174(var uParam0) // Position - 0xCB0E
{
	Player player;
	...
	else
	{
		...
		func_175(uParam0->f_23, &Global_1879551[player /*55*/], false, -1);
	}
...
void func_175(Ped pedParam0, var uParam1, BOOL bParam2, int iParam3) // Position - 0xCBE6
{
	var unk;
	int characterType;
	BOOL flag;
...
void func_176(Ped pedParam0, int iParam1, int iParam2) // Position - 0xCD4F
{
	switch (iParam1)
	{
		case 1310977332:
...
BOOL func_177(Ped pedParam0, const char* sParam1, int iParam2, int iParam3, Hash hParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7, BOOL bParam8) // Position - 0xE026
{
	Hash entityModel;
	int num;
...
BOOL func_178(int iParam0, int iParam1) // Position - 0xE84C
{
	int num;
	int num2;
...
int func_179(int iParam0, int iParam1) // Position - 0xE88B
{
	int num;
	int num2;
...
int func_180() // Position - 0xE8D1
{
	return Global_33299;
}

int func_181(int iParam0) // Position - 0xE8DC
{
	int num;
	int num2;
...
char* func_182(int iParam0) // Position - 0xEC7D
{
	switch (iParam0)
	{
		case 0:
...
int func_183(Hash hParam0, const char* sParam1, int iParam2) // Position - 0xF2BE
{
	switch (iParam2)
	{
		case joaat("crewLogo"):
...
BOOL func_184(char* sParam0, int iParam1, int iParam2, Ped pedParam3, int iParam4) // Position - 0x102F2
{
	Hash entityModel;
	int num;
...
void func_185(char* sParam0, int iParam1, int iParam2, int iParam3) // Position - 0x1325E
{
	int decorationIndex;
	int numTattooShopDlcItems;
	Hash outComponent;
...
BOOL func_186() // Position - 0x132F0
{
...
BOOL func_187() // Position - 0x13322
{
	return true;
}

int func_188() // Position - 0x1332B
{
	int outValue;
	int outValue2;
	Hash statHash;
...
BOOL _IS_EXCLUSIVE_CONTENT_UNLOCKED() // Position - 0x1351A
{
	int profileSetting;
...
int func_191() // Position - 0x135D2
{
	return 1;
}

int func_192() // Position - 0x135DB
{
	return 1;
}

void func_193(char* sParam0, int iParam1, Ped pedParam2, char* sParam3, char* sParam4, char* sParam5, char* sParam6, int iParam7, int iParam8, int iParam9) // Position - 0x135E4
{
	var unk;
...
BOOL func_194(Ped pedParam0, int iParam1) // Position - 0x13899
{
...
Hash func_195(Hash hParam0, int iParam1, int iParam2, int iParam3) // Position - 0x13B59
{
	var outProp;
	int componentId;
	int num;
...
int func_196(Hash hParam0, int iParam1) // Position - 0x13C73
{
	switch (hParam0)
	{
...
ePedComponentType func_197(int iParam0) // Position - 0x1401C
{
	switch (iParam0)
	{
		case 0:
...
int func_198(Hash hParam0) // Position - 0x140CC
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
...
int func_199(Ped pedParam0, int iParam1, ePedComponentType epctParam2) // Position - 0x1412D
{
	int i;
	int j;
...
int func_200(Ped pedParam0, int iParam1) // Position - 0x141CE
{
...
int func_201(Ped pedParam0, int iParam1, int iParam2, int iParam3) // Position - 0x1422E
{
	ePedComponentType componentId;
...
int func_202(Ped pedParam0, ePedComponentType epctParam1) // Position - 0x14285
{
	int pedPropIndex;
...
int func_203(Ped pedParam0, int iParam1, int iParam2, ePedComponentType epctParam3) // Position - 0x142CC
{
	Hash entityModel;
...
int func_204(Ped pedParam0, ePedComponentType epctParam1) // Position - 0x143C8
{
	Hash entityModel;
...
int func_205(Hash hParam0, Hash hParam1, int iParam2, int iParam3) // Position - 0x14506
{
	var outfit;
	int i;
	int num;
...
int func_206(Hash hParam0) // Position - 0x145C1
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
...
int func_207(ePedComponentType epctParam0) // Position - 0x14620
{
	switch (epctParam0)
	{
		case PV_COMP_HEAD:
...
BOOL func_208(Ped pedParam0, int iParam1, int iParam2) // Position - 0x146A6
{
	Hash entityModel;
	int num;
	Hash hash;
	...
	entityModel = ENTITY::GET_ENTITY_MODEL(pedParam0);
	Global_79551[1 /*14*/] = { func_224(entityModel, iParam1, iParam2, -1) };
	hash = Global_2883588;
	...
	if (iParam1 == 12)
	{
			...
			if (unk[num2] != -99)
			{
				if (!func_208(pedParam0, num2, unk[num2]))
				{
					...
					if (num2 == 13)
					{
						...
						for (i = 0; i <= 8; i = i + 1)
						{
							if (!func_208(pedParam0, 14, unk18[i]))
							{
								for (j = 0; j <= 19; j = j + 1)
								{
									Global_79551[2 /*14*/] = { func_224(entityModel, 14, j, -1) };
								
									if (Global_79551[2 /*14*/].f_12 == i)
									{
										if (func_208(pedParam0, 14, j))
										{
											if (!func_212(entityModel, iParam2, 14, j, &unk, &Global_79551[2 /*14*/]))
											{
												Global_2883588 = hash;
												Global_2883589 = hash2;
												return false;
					...
					else
					{
						...
						Global_79551[2 /*14*/] = { func_224(entityModel, num2, num, -1) };
					
						if (!func_212(entityModel, iParam2, num2, num, &unk, &Global_79551[2 /*14*/]))
						{
							Global_2883588 = hash;
							Global_2883589 = hash2;
							return false;
		...
		{
			if (func_94(1759, Global_79548) != unk[10])
			{
				Global_2883588 = hash;
				Global_2883589 = hash2;
				return false;
	...
	else if (iParam1 == 14)
	{
		...
		if (Global_79551[1 /*14*/].f_12 == PV_COMP_HEAD && IS_BIT_SET(Global_79551[1 /*14*/].f_6, 6) && FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Global_2883588, joaat("HELMET"), 1) && FILES::GET_SHOP_PED_APPAREL_VARIANT_PROP_COUNT(Global_2883588) > 0)
		{
			...
			for (m = 0; m < shopPedApparelVariantPropCount; m = m + 1)
			{
				...
				if (nameHash != 0 && nameHash != joaat("0"))
				{
					...
					if (outProp.f_3 == PED::GET_PED_PROP_INDEX(pedParam0, Global_79551[1 /*14*/].f_12, 1) && outProp.f_4 == PED::GET_PED_PROP_TEXTURE_INDEX(pedParam0, Global_79551[1 /*14*/].f_12))
						return true;
				}
			}
		}
	...
	{
		if (Global_79551[1 /*14*/].f_3 == PED::GET_PED_DRAWABLE_VARIATION(pedParam0, func_197(iParam1)) && Global_79551[1 /*14*/].f_4 == PED::GET_PED_TEXTURE_VARIATION(pedParam0, func_197(iParam1)))
			return true;
	
		if (iParam1 == 4)
		{
			Global_79550 = Global_79550 + 1;
...
BOOL func_209(Hash hParam0, int iParam1, int iParam2, var uParam3) // Position - 0x14B01
{
	Hash componentHash;
...
BOOL func_210(Hash hParam0, int iParam1, int iParam2, var uParam3) // Position - 0x14BAA
{
	Hash componentHash;
	int shopPedApparelVariantComponentCount;
	int i;
...
BOOL func_211(Hash hParam0, int iParam1, int iParam2, Hash hParam3) // Position - 0x14C52
{
	switch (hParam0)
	{
		case joaat("MP_F_Freemode_01"):
...
BOOL func_212(Hash hParam0, int iParam1, int iParam2, int iParam3, var uParam4, int iParam5) // Position - 0x14CA5
{
	var unk;
	int i;
...
BOOL func_213(Hash hParam0, int iParam1, int iParam2, Hash hParam3) // Position - 0x152A9
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
...
BOOL func_214(Hash hParam0, int iParam1, int iParam2, Hash hParam3) // Position - 0x15526
{
	if (hParam0 == joaat("Player_Zero"))
	{
		if (iParam1 == 6)
...
BOOL func_215(Hash hParam0, int iParam1, int iParam2, Hash hParam3) // Position - 0x1594B
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
...
BOOL func_216(Hash hParam0, int iParam1, int iParam2) // Position - 0x15C3E
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
...
struct<10> func_217(Hash hParam0, int iParam1) // Position - 0x15CD7
{
	int i;
	var unk;
...
void func_218(var uParam0, Hash hParam1, int iParam2, int iParam3) // Position - 0x16606
{
	int num;
	Hash itemHash;
	Hash outPropVariant;
...
void func_219(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9) // Position - 0x16730
{
	uParam0->[0] = iParam1;
	uParam0->[1] = iParam2;
	uParam0->[2] = iParam3;
...
struct<17> func_220(Hash hParam0, int iParam1) // Position - 0x16778
{
	int i;
	var unk;
	...
	switch (hParam0)
	{
		case joaat("Player_Zero"):
			switch (iParam1)
			{
				...
				case 5:
					func_223(&unk, -99, -99, Global_114370.f_2367.f_539.f_196[0], Global_114370.f_2367.f_539.f_200[0], 6, 3, 0, 0, 0, -99, 0, 0, 3);
					break;
		...
		case joaat("Player_One"):
			switch (iParam1)
			{
				...
				case 2:
					func_223(&unk, -99, -99, Global_114370.f_2367.f_539.f_196[1], Global_114370.f_2367.f_539.f_200[1], 17, 2, 26, 0, 0, -99, 0, 45, 31);
					break;
		...
		case joaat("Player_Two"):
			switch (iParam1)
			{
				...
				case 4:
					func_223(&unk, -99, -99, Global_114370.f_2367.f_539.f_196[2], Global_114370.f_2367.f_539.f_200[2], 8, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
...
void func_221(var uParam0, Hash hParam1, int iParam2, int iParam3) // Position - 0x185C1
{
	int num;
	Hash outfit;
...
int func_222(int iParam0) // Position - 0x187AB
{
	switch (iParam0)
	{
		case 0:
...
void func_223(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Position - 0x1885B
{
	uParam0->[0] = iParam1;
	uParam0->[2] = iParam2;
	uParam0->[3] = iParam3;
...
struct<14> func_224(Hash hParam0, int iParam1, int iParam2, Hash hParam3) // Position - 0x188CC
{
	func_270();
...
void func_225(int iParam0, int iParam1, Hash hParam2) // Position - 0x1890D
{
	switch (iParam0)
	{
		case 2:
...
void func_226(int iParam0) // Position - 0x18A19
{
	BOOL flag;
	int num;
	var unk;
	...
	func_227(&Global_79551[0 /*14*/], num6, iParam0, &unk, num2, num3, num, flag, num4, num5, false);
	return;
}

void func_227(int iParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, BOOL bParam7, int iParam8, int iParam9, BOOL bParam10) // Position - 0x18BD4
{
	int num;
	int num2;
	...
	*iParam0 = iParam9;
	...
	else
	{
		...
		if (iParam1 == 11 || iParam1 == 4 || iParam1 == 6 || iParam1 == 1 || iParam1 == 14 || iParam1 == 2 || iParam1 == 8 || iParam1 == 9 || iParam1 == 10 || iParam1 == 7 || iParam1 == 12)
		{
			...
			num = func_94(func_230(iParam1, iParam0->f_2), Global_79548);
		
			if (IS_BIT_SET(num, iParam0->f_1))
				MISC::SET_BIT(&(iParam0->f_6), 1);
		
			num = func_94(func_229(iParam1, iParam0->f_2), Global_79548);
...
BOOL func_228(int iParam0, int iParam1, var uParam2) // Position - 0x18F76
{
	*uParam2 = 979;
...
int func_229(int iParam0, int iParam1) // Position - 0x1937B
{
	switch (iParam1)
	{
		case 0:
...
int func_230(int iParam0, int iParam1) // Position - 0x19776
{
	switch (iParam1)
	{
		case 0:
...
BOOL func_231(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x19B71
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
BOOL func_232(Hash hParam0, int iParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0x1AA14
{
	int num;
	int num2;
	int num3;
...
BOOL func_233(Hash hParam0, int iParam1, var uParam2, var uParam3, BOOL bParam4, BOOL bParam5) // Position - 0x1AA52
{
...
BOOL func_234(int iParam0) // Position - 0x1D6B3
{
	return Global_44392 == iParam0;
}

int func_235(int iParam0) // Position - 0x1D6C1
{
	switch (iParam0)
	{
		case -1:
...
void func_236(int iParam0, Hash hParam1) // Position - 0x1D795
{
	int num;
...
void func_237(int iParam0, int iParam1, int iParam2, Hash hParam3) // Position - 0x1D7B5
{
	int num;
	int num2;
	Hash outfit;
	...
	if (iParam0 == 12)
	{
		...
		if (outfitIndex >= 0)
		{
			...
			if (num3 > outfitIndex)
			{
				...
				func_227(&Global_79551[0 /*14*/], iParam0, iParam1, &(outfit.f_7), 0, 0, outfit.f_2, false, -1, 2, true);
				return;
			}
		}
	}
	...
	{
		func_227(&Global_79551[0 /*14*/], iParam0, iParam1, "NO_LABEL", 0, 0, 0, true, -1, 2, true);
	}
	else if (iParam0 == 14)
	{
		FILES::INIT_SHOP_PED_PROP(&outProp);
		...
		if (componentId >= 0)
		{
			...
			if (num5 > componentId)
			{
				...
				func_227(&Global_79551[0 /*14*/], iParam0, iParam1, &(outProp.f_9), outProp.f_3, outProp.f_4, outProp.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(outProp.f_1, joaat("OUTFIT_ONLY"), 0), num4, 2, outProp.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (hParam3 != -1 && Global_79749)
		{
			...
			func_227(&Global_79551[0 /*14*/], iParam0, iParam1, &(outComponent.f_9), outComponent.f_3, outComponent.f_4, outComponent.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(outComponent.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, outComponent.f_1 != 0);
			return;
		}
...
void func_238(int iParam0, Hash hParam1) // Position - 0x1DA3C
{
	BOOL flag;
	int num;
	var unk;
...
void func_239(int iParam0, Hash hParam1) // Position - 0x1DB3F
{
	BOOL flag;
	int num;
	var unk;
...
void func_240(int iParam0, Hash hParam1) // Position - 0x1DE1E
{
	BOOL flag;
	int value;
	var unk;
	...
	{
		func_227(&Global_79551[0 /*14*/], num5, iParam0, &unk, num, num2, value, flag, num3, num4, false);
	}

	return;
}

void func_241(int iParam0, Hash hParam1) // Position - 0x20D94
{
	BOOL flag;
	int num;
	var unk;
...
void func_242(int iParam0, Hash hParam1) // Position - 0x20E99
{
	BOOL flag;
	int value;
	var unk;
...
void func_243(int iParam0, Hash hParam1) // Position - 0x21675
{
	BOOL flag;
	int value;
	var unk;
...
void func_244(int iParam0, Hash hParam1) // Position - 0x2195A
{
	BOOL flag;
	int value;
	var unk;
...
void func_245(int iParam0, Hash hParam1) // Position - 0x22F81
{
	BOOL flag;
	int value;
	var unk;
...
void func_246(int iParam0, Hash hParam1) // Position - 0x245E2
{
	BOOL flag;
	int num;
	var unk;
...
void func_247(int iParam0, Hash hParam1) // Position - 0x2473D
{
	BOOL flag;
	int num;
	var unk;
...
void func_248(int iParam0, Hash hParam1) // Position - 0x249BD
{
	BOOL flag;
	int value;
	var unk;
...
BOOL func_249(int iParam0, int iParam1) // Position - 0x25D5F
{
	int num;
	int num2;

	if (func_251(iParam0) == 17296)
		return false;
...
int func_250(int iParam0, int iParam1) // Position - 0x25D8E
{
	int num;
...
int func_251(int iParam0) // Position - 0x25DA6
{
	int num;
	int num2;
...
void func_252(int iParam0, Hash hParam1) // Position - 0x26121
{
	BOOL flag;
	int value;
	var unk;
...
void func_253(int iParam0, Hash hParam1) // Position - 0x27886
{
	BOOL flag;
	int value;
	var unk;
...
void func_254(int iParam0, int iParam1, Hash hParam2) // Position - 0x28758
{
	switch (iParam0)
	{
		case 2:
...
void func_255(int iParam0) // Position - 0x28864
{
	BOOL flag;
	int num;
	var unk;
...
void func_256(int iParam0, Hash hParam1) // Position - 0x28A2E
{
	int num;
...
void func_257(int iParam0, Hash hParam1) // Position - 0x28A4E
{
	BOOL flag;
	int num;
	var unk;
...
void func_258(int iParam0, Hash hParam1) // Position - 0x28B51
{
	BOOL flag;
	int num;
	var unk;
...
void func_259(int iParam0, Hash hParam1) // Position - 0x28E02
{
	BOOL flag;
	int value;
	var unk;
...
void func_260(int iParam0, Hash hParam1) // Position - 0x2BBC1
{
	BOOL flag;
	int num;
	var unk;
...
void func_261(int iParam0, Hash hParam1) // Position - 0x2BCE2
{
	BOOL flag;
	int value;
	var unk;
...
void func_262(int iParam0, Hash hParam1) // Position - 0x2C5DB
{
	BOOL flag;
	int value;
	var unk;
...
void func_263(int iParam0, Hash hParam1) // Position - 0x2C892
{
	BOOL flag;
	int value;
	var unk;
...
void func_264(int iParam0, Hash hParam1) // Position - 0x2DECF
{
	BOOL flag;
	int value;
	var unk;
...
void func_265(int iParam0, Hash hParam1) // Position - 0x2F502
{
	BOOL flag;
	int num;
	var unk;
...
void func_266(int iParam0, Hash hParam1) // Position - 0x2F659
{
	BOOL flag;
	int num;
	var unk;
...
void func_267(int iParam0, Hash hParam1) // Position - 0x2F975
{
	BOOL flag;
	int value;
	var unk;
...
void func_268(int iParam0, Hash hParam1) // Position - 0x31E68
{
	BOOL flag;
	int value;
	var unk;
...
void func_269(int iParam0, Hash hParam1) // Position - 0x333F3
{
	BOOL flag;
	int value;
	var unk;
...
void func_270() // Position - 0x342AE
{
...
BOOL func_271(Ped pedParam0) // Position - 0x34327
{
	int num;

	if (NETWORK::NETWORK_IS_ACTIVITY_SESSION())
	{
		num = Global_1845274[PLAYER::PLAYER_ID() /*877*/].f_97.f_28;
...
int func_272(int iParam0) // Position - 0x343A3
{
	if (func_273(true))
		return Global_1685540;

	if (iParam0 <= -1 || iParam0 >= 4)
		return -1;

	return Global_2685690.f_6477[iParam0];
}

BOOL func_273(BOOL bParam0) // Position - 0x343DA
{
	if (func_277(bParam0) || func_275() || func_274(*Global_4718592.f_197275))
		return true;

	return false;
}

BOOL func_274(int iParam0) // Position - 0x3440E
{
	return iParam0 == 87;
}

BOOL func_275() // Position - 0x3441B
{
	return func_276(*Global_4718592.f_138116);
}

int func_276(int iParam0) // Position - 0x34431
{
	int i;
...
BOOL func_277(BOOL bParam0) // Position - 0x3446B
{
	if (bParam0)
		return IS_BIT_SET(*Global_4718592.f_190071, 12) && func_278();

	return IS_BIT_SET(*Global_4718592.f_190071, 12);
}

BOOL func_278() // Position - 0x344A1
{
...
BOOL func_279(Ped pedParam0, BOOL bParam1) // Position - 0x344CF
{
	int pedDrawableVariation;
	int pedTextureVariation;
	int num;
			...
			switch (pedDrawableVariation)
			{
				...
				case 5:
					if (!bParam1)
					{
						...
						else if (func_120(PLAYER::PLAYER_ID(), true) && Global_1888882[PLAYER::PLAYER_ID() /*611*/].f_10.f_76.f_21 != 0)
						{
							return 1;
						}
					}
...
int func_280(Hash hParam0, int iParam1, int iParam2, int iParam3) // Position - 0x34D09
{
	Hash componentHash;
...
int func_281(int iParam0, Hash hParam1) // Position - 0x35529
{
...
int func_282(Ped pedParam0) // Position - 0x3554B
{
...
Player func_283() // Position - 0x355AE
{
	Player player;
...
Player _GET_BOSS_OF_LOCAL_PLAYER() // Position - 0x355CC
{
	return Global_1888882[PLAYER::PLAYER_ID() /*611*/].f_10;
}

BOOL func_285(BOOL bParam0) // Position - 0x355E1
{
	return func_286(PLAYER::PLAYER_ID(), bParam0);
}

BOOL func_286(Player plParam0, BOOL bParam1) // Position - 0x355F3
{
	if (!func_11(plParam0))
		return false;
...
BOOL func_287(Player plParam0) // Position - 0x3562B
{
	if (func_11(plParam0))
		if (func_11(Global_1888882[plParam0 /*611*/].f_10))
...
BOOL func_289(Player plParam0, BOOL bParam1, BOOL bParam2) // Position - 0x35682
{
...
int func_290(var uParam0) // Position - 0x356D9
{
	return *uParam0;
}

void func_291() // Position - 0x356E4
{
...
void func_292(int iParam0) // Position - 0x3572F
{
	if (func_46())
		return;
...
void func_293(BOOL bParam0) // Position - 0x35762
{
	if (bParam0)
		func_295();
...
void func_294(int iParam0, int iParam1) // Position - 0x357B3
{
	MISC::SET_BIT(&(Global_1673898.f_&_NETWORK_IS_PLAYER_VALID), iParam0);
...
void func_295() // Position - 0x357E9
{
	Global_2740191.f_4672 = 0;
	return;
}

BOOL func_296() // Position - 0x357F9
{
...
BOOL _SHOULD_NETWORK_SCRIPT_TERMINATE() // Position - 0x3580D
{
...
Hash _GET_CURRENT_SESSION_TYPE_SCRIPT_HASH() // Position - 0x35891
{
	switch (func_98())
	{
		case 0:
...
Hash func_299() // Position - 0x358C4
{
...
BOOL func_300() // Position - 0x358E8
{
	return Global_2684748.f_700;
}

BOOL _DOES_EVENT_OF_TYPE_EXIST(int iParam0) // Position - 0x358F7
{
...
BOOL func_302() // Position - 0x3590E
{
	return Global_2696555;
}

BOOL func_303() // Position - 0x3591A
{
	return Global_2684748.f_695;
}

void func_304() // Position - 0x35929
{
	SYSTEM::WAIT(0);
	return;
}

void func_305() // Position - 0x35936
{
	NETWORK::NETWORK_SET_THIS_SCRIPT_IS_NETWORK_SCRIPT(32, false, -1);
	func_313(&uLocal_122, joaat("nimbus"), "Plane_1");
	func_55(&uLocal_122, 1);
	func_311(&uLocal_122, -1640.5961f, -3127.1133f, 14.5828f, -2.3352f, 0.0001f, 145.7214f, "HS4_NIMB_LSA_ISD", 0, 1, 1023, 0);
...
void func_306() // Position - 0x359BE
{
...
void func_307() // Position - 0x359FD
{
	Global_79740 = 0;
	Global_79741 = -1;
	Global_79742 = -1;
...
BOOL func_308() // Position - 0x35A23
{
	return func_309(PLAYER::PLAYER_PED_ID());
}

BOOL func_309(Ped pedParam0) // Position - 0x35A33
{
	int pedDrawableVariation;
...
void _STAT_SET_PACKED_BOOL(int iParam0, BOOL bParam1, int iParam2) // Position - 0x35B03
{
	if (iParam2 == -1)
		iParam2 = func_10();
...
void func_311(var uParam0, float fParam1, float fParam2, float fParam3, float fParam4, float fParam5, float fParam6, char* sParam7, int iParam8, int iParam9, int iParam10, int iParam11) // Position - 0x35B21
{
...
void func_312(var uParam0, char* sParam1, int iParam2, int iParam3, int iParam4) // Position - 0x35B51
{
	uParam0->f_1 = sParam1;
	uParam0->f_2 = iParam3;
...
void func_313(var uParam0, int iParam1, char* sParam2) // Position - 0x35B7E
{
