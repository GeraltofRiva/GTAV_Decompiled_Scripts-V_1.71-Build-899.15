	...
	while (true)
	{
		...
		if (ENTITY::DOES_ENTITY_EXIST(pedLocal_84) && !ENTITY::IS_ENTITY_DEAD(pedLocal_84, false))
		{
			...
			switch (iLocal_94)
			{
				...
				case 3:
					...
					if (!_CAN_ENTER_FREEROAM_STATE(iLocal_99))
					{
						if (!func_184(iLocal_93, 8))
						{
							...
							if (MISC::ARE_STRINGS_EQUAL(&(Global_101917.f_3), &uLocal_68))
							{
								uLocal_68 = { uLocal_52 };
								flag2 = false;
							}
					...
					if (fLocal_109 > fLocal_101 * fLocal_101 && !Global_101951)
					{
						if (iLocal_104 != 263)
						{
					...
					else
					{
						...
						if (!func_169(3) && !Global_101951)
						{
							if (func_184(iLocal_93, 2097152))
							{
								if (!func_184(iLocal_93, 1) || !ENTITY::DOES_ENTITY_EXIST(func_168()) && !Global_101951)
								{
									func_177(10);
									break;
								}
				...
				case 6:
					if (func_184(Global_113018, 262144))
					{
						func_190(&Global_113018, 262144);
						func_17();
					}
					...
					if (!SCRIPT::IS_THREAD_ACTIVE(iLocal_51))
					{
						...
						if (iLocal_98 != -1)
						{
							if (func_184(Global_113018, 0))
							{
								STATS::PLAYSTATS_MISSION_CHECKPOINT(func_21(iLocal_98), 0, Global_101954, 0);
								func_7(func_21(iLocal_98), 0, Global_101954, true, false);
							}
							else
							{
								STATS::PLAYSTATS_MISSION_CHECKPOINT(func_21(iLocal_98), 0, Global_101954, 0);
								func_7(func_21(iLocal_98), 0, Global_101954, false, false);
							}
						}
...
void func_59(int iParam0) // Position - 0x2938
{
	...
	func_60(&Global_79551[0 /*14*/], num6, iParam0, &unk, num2, num3, num, flag, num4, num5, false);
	return;
}
	...
	*iParam0 = iParam9;
	...
	else
	{
		...
		if (iParam1 == 11 || iParam1 == 4 || iParam1 == 6 || iParam1 == 1 || iParam1 == 14 || iParam1 == 2 || iParam1 == 8 || iParam1 == 9 || iParam1 == 10 || iParam1 == 7 || iParam1 == 12)
		{
			...
			num = func_63(func_67(iParam1, iParam0->f_2), Global_79548);
		
			if (IS_BIT_SET(num, iParam0->f_1))
				MISC::SET_BIT(&(iParam0->f_6), 1);
		
			num = func_63(func_62(iParam1, iParam0->f_2), Global_79548);
...
void func_71(int iParam0, int iParam1, int iParam2, Hash hParam3) // Position - 0x875E
{
	int num;
	int num2;
	Hash outfit;
	...
	if (iParam0 == 12)
	{
		...
		if (outfitIndex >= 0)
		{
			...
			if (num3 > outfitIndex)
			{
				...
				func_60(&Global_79551[0 /*14*/], iParam0, iParam1, &(outfit.f_7), 0, 0, outfit.f_2, false, -1, 2, true);
				return;
			}
		}
	}
	...
	{
		func_60(&Global_79551[0 /*14*/], iParam0, iParam1, "NO_LABEL", 0, 0, 0, true, -1, 2, true);
	}
	else if (iParam0 == 14)
	{
		...
		if (componentId >= 0)
		{
			...
			if (num5 > componentId)
			{
				...
				func_60(&Global_79551[0 /*14*/], iParam0, iParam1, &(outProp.f_9), outProp.f_3, outProp.f_4, outProp.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(outProp.f_1, joaat("OUTFIT_ONLY"), 0), num4, 2, outProp.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (hParam3 != -1 && Global_79749)
		{
			...
			func_60(&Global_79551[0 /*14*/], iParam0, iParam1, &(outComponent.f_9), outComponent.f_3, outComponent.f_4, outComponent.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(outComponent.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, outComponent.f_1 != 0);
			return;
		}
...
void func_72(int iParam0) // Position - 0x89E4
{
	BOOL flag;
	int num;
	var unk;
...
void func_73(int iParam0) // Position - 0x8B31
{
	BOOL flag;
	int num;
	var unk;
...
void func_74(int iParam0) // Position - 0x903E
{
	BOOL flag;
	int num;
	var unk;
...
void func_75(int iParam0) // Position - 0x90B2
{
	BOOL flag;
	int num;
	var unk;
...
void func_76(int iParam0) // Position - 0x9125
{
	BOOL flag;
	int num;
	var unk;
...
void func_77(int iParam0) // Position - 0x920C
{
	BOOL flag;
	int num;
	var unk;
...
void func_78(int iParam0) // Position - 0x954E
{
	BOOL flag;
	int num;
	var unk;
...
void func_79(int iParam0) // Position - 0x9756
{
	BOOL flag;
	int num;
	var unk;
...
void func_80(int iParam0) // Position - 0x9976
{
	BOOL flag;
	int num;
	var unk;
...
void func_81(int iParam0) // Position - 0x9A7F
{
	BOOL flag;
	int num;
	var unk;
...
void func_82(int iParam0) // Position - 0xA411
{
	BOOL flag;
	int num;
	var unk;
...
void func_83(int iParam0) // Position - 0xAF69
{
	if (iParam0 < 136)
		func_85(iParam0);
	else
...
void func_84(int iParam0) // Position - 0xAF9E
{
	BOOL flag;
	int num;
	var unk;
...
void func_85(int iParam0) // Position - 0xBBA2
{
	BOOL flag;
	int num;
	var unk;
...
void func_86(int iParam0) // Position - 0xCAA3
{
	BOOL flag;
	int num;
	var unk;
...
void func_87(int iParam0) // Position - 0xCBD0
{
	BOOL flag;
	int num;
	var unk;
...
void func_88(int iParam0, int iParam1) // Position - 0xCCC7
{
	switch (iParam0)
	{
		case 0:
...
void func_89(int iParam0) // Position - 0xCDB7
{
	BOOL flag;
	int num;
	var unk;
...
void func_90(int iParam0) // Position - 0xE284
{
	BOOL flag;
	int num;
	var unk;
...
void func_91(int iParam0) // Position - 0xE3CB
{
	BOOL flag;
	int num;
	var unk;
...
void func_92(int iParam0) // Position - 0xE8D5
{
	BOOL flag;
	int num;
	var unk;
...
void func_93(int iParam0) // Position - 0xEF3E
{
	BOOL flag;
	int num;
	var unk;
...
void func_94(int iParam0) // Position - 0xEFB1
{
	BOOL flag;
	int num;
	var unk;
...
void func_95(int iParam0) // Position - 0xF081
{
	BOOL flag;
	int num;
	var unk;
...
void func_96(int iParam0) // Position - 0xF57C
{
	BOOL flag;
	int num;
	var unk;
...
void func_97(int iParam0) // Position - 0xF70D
{
	BOOL flag;
	int num;
	var unk;
...
void func_98(int iParam0) // Position - 0xFEFC
{
	BOOL flag;
	int num;
	var unk;
...
void func_99(int iParam0) // Position - 0x10007
{
	BOOL flag;
	int num;
	var unk;
...
void func_100(int iParam0) // Position - 0x10F2A
{
	BOOL flag;
	int num;
	var unk;
...
void func_101(int iParam0) // Position - 0x11BD7
{
	if (iParam0 < 107)
		func_104(iParam0);
	else if (iParam0 < 227)
...
void func_102(int iParam0) // Position - 0x11C1D
{
	BOOL flag;
	int num;
	var unk;
...
void func_103(int iParam0) // Position - 0x126C1
{
	BOOL flag;
	int num;
	var unk;
...
void func_104(int iParam0) // Position - 0x134AF
{
	BOOL flag;
	int num;
	var unk;
...
void func_105(int iParam0) // Position - 0x140EF
{
	BOOL flag;
	int num;
	var unk;
...
void func_106(int iParam0) // Position - 0x14367
{
	BOOL flag;
	int num;
	var unk;
...
void func_107(int iParam0, int iParam1) // Position - 0x144A3
{
	switch (iParam0)
	{
		case 0:
...
void func_108(int iParam0) // Position - 0x14593
{
	BOOL flag;
	int num;
	var unk;
...
void func_109(int iParam0) // Position - 0x152F1
{
	BOOL flag;
	int num;
	var unk;
...
void func_110(int iParam0) // Position - 0x15460
{
	BOOL flag;
	int num;
	var unk;
...
void func_111(int iParam0) // Position - 0x159D1
{
	BOOL flag;
	int num;
	var unk;
...
void func_112(int iParam0) // Position - 0x15EF9
{
	BOOL flag;
	int num;
	var unk;
...
void func_113(int iParam0) // Position - 0x15F6C
{
	BOOL flag;
	int num;
	var unk;
...
void func_114(int iParam0) // Position - 0x1603C
{
	BOOL flag;
	int num;
	var unk;
...
void func_115(int iParam0) // Position - 0x164EC
{
	BOOL flag;
	int num;
	var unk;
...
void func_116(int iParam0) // Position - 0x16747
{
	BOOL flag;
	int num;
	var unk;
...
void func_117(int iParam0) // Position - 0x16A07
{
	BOOL flag;
	int num;
	var unk;
...
void func_118(int iParam0) // Position - 0x16BC2
{
	BOOL flag;
	int num;
	var unk;
...
void func_119(int iParam0) // Position - 0x17708
{
	BOOL flag;
	int num;
	var unk;
...
void func_120(int iParam0) // Position - 0x1833A
{
	if (iParam0 < 60)
		func_122(iParam0);
	else
...
void func_121(int iParam0) // Position - 0x1836F
{
	BOOL flag;
	int num;
	var unk;
...
void func_122(int iParam0) // Position - 0x19102
{
	BOOL flag;
	int num;
	var unk;
...
void func_123(int iParam0) // Position - 0x19784
{
	BOOL flag;
	int num;
	var unk;
...
void func_124(int iParam0) // Position - 0x1986A
{
	BOOL flag;
	int num;
	var unk;
...
void func_125() // Position - 0x19961
{
...
int func_126(ePedComponentType epctParam0) // Position - 0x199D9
{
	switch (epctParam0)
	{
		case 0:
...
struct<17> func_127(Hash hParam0, int iParam1) // Position - 0x19A89
{
	int i;
	var unk;
...
void func_128(var uParam0, Hash hParam1, int iParam2, int iParam3) // Position - 0x1B8D1
{
	int num;
	Hash outfit;
...
void func_129(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Position - 0x1BABB
{
	uParam0->[0] = iParam1;
	uParam0->[2] = iParam2;
	uParam0->[3] = iParam3;
...
void func_130(BOOL bParam0) // Position - 0x1BB2C
{
	Global_113456 = Global_113456 || bParam0;
	return;
}

BOOL func_131(BOOL bParam0) // Position - 0x1BB3F
{
	return Global_113456 && bParam0 != false;
}

void func_132(int iParam0) // Position - 0x1BB50
{
	if (iLocal_94 < 5)
	{
		if (iParam0 != 263)
...
BOOL func_133() // Position - 0x1BB93
{
	if (func_171(6) || func_171(7))
		return true;
...
eCharacter _GET_PLAYER_CHARACTER_FROM_PED(Ped pedParam0) // Position - 0x1BBB3
{
	eCharacter i;
	Hash entityModel;
...
Hash _GET_CHARACTER_MODEL(eCharacter character) // Position - 0x1BBF0
{
...
Hash func_136(eCharacter echParam0) // Position - 0x1BC15
{
	return Global_2241[echParam0 /*29*/];
}

BOOL func_137(eCharacter echParam0) // Position - 0x1BC24
{
	return echParam0 < CHAR_MULTIPLAYER;
}

BOOL func_138(int iParam0, BOOL bParam1) // Position - 0x1BC30
{
	int num;
...
int func_139(int iParam0) // Position - 0x1BCE8
{
	int i;
...
void _CONTEXT_REMOVE_HELP_TEXT(var uParam0) // Position - 0x1BD23
{
	int num;
...
void _CONTEXT_ADD_HELP_TEXT(var uParam0, int iParam1, char* sParam2, int iParam3, const char* sParam4, int iParam5, int iParam6) // Position - 0x1BD7A
{
	int i;
...
BOOL func_142(var uParam0) // Position - 0x1BEA5
{
	return true;
}

Vector3 func_143(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6) // Position - 0x1BEAE
{
	return ({ 1f - fParam6, 1f - fParam6, 1f - fParam6 } * uParam0) + ({ fParam6, fParam6, fParam6 } * uParam3);
}

BOOL func_144() // Position - 0x1BEC9
{
	return Global_76855;
}

BOOL func_145(int iParam0) // Position - 0x1BED5
{
	if (iParam0 == 1)
...
BOOL func_146(int iParam0, int iParam1) // Position - 0x1BF2C
{
	switch (iParam0)
	{
		case 5:
...
BOOL func_147() // Position - 0x1BF64
{
	return MISC::GET_GAME_TIMER() <= Global_24148.f_6481 + 100;
}

BOOL func_148() // Position - 0x1BF79
{
...
BOOL func_149(BOOL bParam0) // Position - 0x1BF93
{
	if (bParam0)
...
BOOL func_150() // Position - 0x1BFBC
{
	if (func_171(6) || func_171(7))
	{
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_164() || Global_113417 || Global_33301 || func_163() || func_146(8, -1) || func_162() || func_161() || func_160() || func_148() || Global_114370.f_7692.f_919[character] == 5)
							return false;
						break;
				
					case 1:
						if (PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_164() || Global_33301 || func_163() || func_146(8, -1) || func_160() || func_162() || func_161() || func_148() || Global_114370.f_7692.f_919[character] == 5)
							return false;
						break;
				
					case 2:
						if (!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_164() || Global_113417 || Global_33301 || func_163() || func_146(8, -1) || func_160() || func_162() || func_161() || func_148() || Global_114370.f_7692.f_919[character] == 5 || Global_44939 != -1)
							return false;
						break;
				
					case 3:
						if (PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_164() || Global_113417 || Global_33301 || func_163() || func_146(8, -1) || func_162() || func_161() || func_148() || Global_114370.f_7692.f_919[character] == 5)
							return false;
						break;
				
					case 4:
						if (func_164() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0 || func_146(8, -1) || func_148() || func_159() || Global_114370.f_7692.f_919[character] == 5)
							return false;
						break;
					...
					case 6:
						if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
							if (PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0 || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || func_164() || Global_33301 || func_163() || func_146(8, -1) || func_161() || func_160() || func_148() || Global_114370.f_7692.f_919[character] == 5)
								return false;
						break;
				
					case 7:
						if (PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID()) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || !CAM::IS_SCREEN_FADED_IN() || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_164() || func_161() || Global_113417 || Global_33301 || func_163() || Global_45607 || func_146(8, -1) || func_160() || func_159() || func_148() || Global_114370.f_7692.f_919[character] == 5)
							return false;
						break;
				
					case 8:
						if (PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID()) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || !CAM::IS_SCREEN_FADED_IN() || PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), true) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_SWIMMING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || func_164() || Global_113417 || Global_33301 || func_163() || func_146(8, -1) || func_160() || func_159() || func_162() || func_161() || func_148())
							return false;
						break;
				}
			}
...
void func_166() // Position - 0x1CB03
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (_GET_CHARACTER_MODEL(Global_114370.f_2367.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_137(character) && !func_171(14) || Global_113318)
			{
				if (Global_114370.f_2367.f_539.f_4321 != character && func_137(Global_114370.f_2367.f_539.f_4321))
...
{
	return func_183(iParam0, Global_44392);
}
