...
void func_302() // Position - 0x3563F
{
	...
	func_303(&uLocal_122, 3967.4226f, -4685.0845f, 11.7691f, -1.6326f, 0.4627f, -70.7491f, "HS4_NIMB_LSA_ISD_REPEAT", 1, 1, 3, 0);
	return;
}

void func_303(var uParam0, float fParam1, float fParam2, float fParam3, float fParam4, float fParam5, float fParam6, char* sParam7, int iParam8, int iParam9, int iParam10, int iParam11) // Position - 0x35689
{
...
void func_304(var uParam0, char* sParam1, int iParam2, int iParam3, int iParam4) // Position - 0x356B9
{
	uParam0->f_1 = sParam1;
	uParam0->f_2 = iParam3;
...
void func_305(var uParam0, int iParam1, char* sParam2) // Position - 0x356E6
{
