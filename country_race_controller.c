...
void func_6(int iParam0) // Position - 0x321
{
	...
	{
		case 0:
			Global_114370.f_25077 = 1;
			Global_114370.f_25077.f_3 = 1;
			break;
	
		case 1:
			Global_114370.f_25077 = 2;
			Global_114370.f_25077.f_4 = 1;
			break;
	
		case 2:
			Global_114370.f_25077 = 3;
			Global_114370.f_25077.f_5 = 1;
			break;
	
		case 3:
			Global_114370.f_25077 = 4;
			Global_114370.f_25077.f_6 = 1;
			break;
	
		case 4:
			Global_114370.f_25077 = 0;
			Global_114370.f_25077.f_7 = 1;
			break;
	}
...
void func_8() // Position - 0x3ED
{
	...
	TEXT_LABEL_APPEND_INT(&unk, Global_114370.f_25077 + 1, 16);
...
{
	return func_20(iParam0, Global_44392);
}
...
BOOL func_40(Vehicle veParam0) // Position - 0x150A
{
...
BOOL func_43() // Position - 0x15CB
{
	...
	else
	{
		if (SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), func_60()) > 90000f)
		{
			...
			if (Global_114370.f_25077.f_9)
				Global_114370.f_25077.f_9 = 0;
		
			if (Global_114370.f_25077.f_8)
				Global_114370.f_25077.f_8 = 0;
		}
...
void func_44(BOOL bParam0) // Position - 0x176B
{
...
void func_45(Ped pedParam0) // Position - 0x1881
{
...
float func_46() // Position - 0x19C1
{
	return 294.2507f;
}

Vector3 func_47() // Position - 0x19CE
{
	return 1965.2484f, 3114.886f, 46.1663f;
}

float func_48() // Position - 0x19E5
{
	return 194.8257f;
}

Vector3 func_49() // Position - 0x19F2
{
	return 1964.0383f, 3114.6345f, 46.1319f;
}

Hash func_50() // Position - 0x1A09
{
	switch (Global_114370.f_25077)
	{
		case 0:
...
void func_51() // Position - 0x1A77
{
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(pedLocal_156))
	{
		if (!PED::IS_PED_FLEEING(pedLocal_156) && !PED::IS_PED_IN_COMBAT(pedLocal_156, 0) && !PED::IS_PED_RAGDOLL(pedLocal_156))
		{
			...
			if (func_52(veLocal_155) || Global_114370.f_25077.f_9)
			{
...
BOOL func_52(Vehicle veParam0) // Position - 0x1B2B
{
...
BOOL func_53(Ped pedParam0, eScriptTaskHash esthParam1, BOOL bParam2) // Position - 0x1B9E
{
...
float func_55(Vehicle veParam0, Vector3 vParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0x1C88
{
...
BOOL _IS_EXCLUSIVE_CONTENT_UNLOCKED() // Position - 0x1D60
{
	int profileSetting;
...
BOOL func_58(int iParam0) // Position - 0x1E18
{
	int i;
...
BOOL func_59(int iParam0, int iParam1) // Position - 0x1E80
{
	BOOL flag;
...
Vector3 func_60() // Position - 0x1ECA
{
	return 1967.042f, 3116.0051f, 45.8901f;
}

BOOL _DOES_ENTITY_EXIST_AND_IS_ALIVE(Ped pedParam0) // Position - 0x1EE1
{
...
void func_62(BOOL bParam0) // Position - 0x1F02
{
	var unk;
