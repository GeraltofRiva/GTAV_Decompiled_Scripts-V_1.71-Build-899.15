...
void main() // Position - 0x0
{
	...
	while (true)
	{
		...
		func_327(&Global_1931229);
	
		switch (func_326(NETWORK::PARTICIPANT_ID_TO_INT()))
		{
			case 0:
				if (func_325() == 2)
					uLocal_176[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/] = 2;
				else if (func_325() == 6)
					uLocal_176[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/] = 5;
				break;
			...
			case 2:
				if (func_325() == 2)
				{
					...
					else if (HUD::DOES_BLIP_EXIST(Global_1931229))
					{
						func_12();
						HUD::SET_BLIP_ROUTE(Global_1931229, false);
						HUD::REMOVE_BLIP(&Global_1931229);
					
						if (IS_BIT_SET(iLocal_445, 3))
							CUTSCENE::REMOVE_CUTSCENE();
					
						MISC::SET_BIT(&(uLocal_176[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_2), 0);
					}
				
					if (func_8(PLAYER::PLAYER_ID()))
					{
						uLocal_176[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/] = 3;
			...
			case 5:
				func_6(&(iLocal_96.f_3));
			
				if (func_5(&(iLocal_96.f_3)))
					uLocal_176[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/] = 6;
				break;
...
void func_3() // Position - 0x22D
{
	...
	if (NETWORK::NETWORK_IS_HOST_OF_THIS_SCRIPT())
	{
		if (plLocal_175 == 0)
		{
			MISC::CLEAR_BIT(&iLocal_445, 0);
			MISC::SET_BIT(&iLocal_445, 1);
		
			if (iLocal_96.f_2 != -1)
				if (!NETWORK::NETWORK_IS_PARTICIPANT_ACTIVE(PLAYER::INT_TO_PARTICIPANTINDEX(iLocal_96.f_2)))
					iLocal_96.f_2 = -1;
		}
		...
		if (NETWORK::NETWORK_IS_PARTICIPANT_ACTIVE(player))
		{
			...
			if (!IS_BIT_SET(uLocal_176[plLocal_175 /*3*/].f_2, 0))
				MISC::CLEAR_BIT(&iLocal_445, 1);
		
			if (_NETWORK_IS_PLAYER_VALID(playerIndex, false, true))
			{
				if (IS_BIT_SET(uLocal_176[plLocal_175 /*3*/].f_2, 1))
				{
					MISC::SET_BIT(&iLocal_445, 12);
				
					if (iLocal_96.f_2 == -1)
						if (iLocal_96.f_2 != plLocal_175)
							iLocal_96.f_2 = plLocal_175;
				}
				else if (iLocal_96.f_2 == plLocal_175)
				{
					iLocal_96.f_2 = -1;
				}
			}
		...
		plLocal_175 = plLocal_175 + 1;
	
		if (plLocal_175 == 32)
		{
			if (IS_BIT_SET(iLocal_445, 1))
...
void func_19() // Position - 0x833
{
	...
	switch (uLocal_176[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_1)
	{
		case 0:
						...
						if (!func_322())
							if (!func_320())
								if (PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) == 0)
									if (!func_319(0))
										if (!func_316(PLAYER::PLAYER_ID(), true, false))
											if (!func_315())
												func_314() == 0;
		
			if (!IS_BIT_SET(iLocal_445, 5))
			{
				if (func_316(PLAYER::PLAYER_ID(), true, false) || func_315() || func_314() > 0 || func_313() || func_308() || func_307() || func_278(false) || func_277(PLAYER::PLAYER_ID(), 21) || func_277(PLAYER::PLAYER_ID(), 25))
				{
					MISC::SET_BIT(&iLocal_445, 5);
					func_12();
				
					if (HUD::DOES_BLIP_EXIST(Global_1931229))
					{
						HUD::SET_BLIP_ROUTE(Global_1931229, false);
						HUD::REMOVE_BLIP(&Global_1931229);
					}
				...
				else
				{
					if (HUD::DOES_BLIP_EXIST(Global_1931229))
					{
						if (!IS_BIT_SET(iLocal_445, 14))
						{
							if (iLocal_96.f_2 != -1)
							{
								if (iLocal_96.f_2 != NETWORK::PARTICIPANT_ID_TO_INT())
								{
									HUD::SET_BLIP_COLOUR(Global_1931229, 39);
									HUD::SET_BLIP_SCALE(Global_1931229, 0.7f);
									MISC::SET_BIT(&iLocal_445, 14);
								}
							}
						}
						else if (iLocal_96.f_2 == -1 || iLocal_96.f_2 == NETWORK::PARTICIPANT_ID_TO_INT())
						{
							HUD::SET_BLIP_COLOUR(Global_1931229, 0);
							HUD::SET_BLIP_SCALE(Global_1931229, 1f);
							MISC::CLEAR_BIT(&iLocal_445, 14);
						}
					}
				
					if (IS_BIT_SET(iLocal_445, 8))
						MISC::CLEAR_BIT(&iLocal_445, 8);
				
					if (func_276())
					{
						if (PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) == 0)
						{
							if (bLocal_443 && CUTSCENE::HAS_CUTSCENE_LOADED() || !bLocal_443)
							{
								if (!IS_BIT_SET(uLocal_176[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_2, 1))
									MISC::SET_BIT(&(uLocal_176[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_2), 1);
								...
								if (IS_BIT_SET(uLocal_176[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_2, 1))
								{
									if (iLocal_96.f_2 == NETWORK::PARTICIPANT_ID_TO_INT())
									{
										...
										MISC::SET_BIT(&iLocal_445, 25);
										MISC::CLEAR_AREA(1274.854f, -1721.1538f, 53.6808f, 2f, true, false, false, true);
									
										if (bLocal_444)
										{
											func_272();
											iLocal_453 = GRAPHICS::REQUEST_SCALEFORM_MOVIE("SECURITY_CAM");
										}
									
										uLocal_176[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_1 = 1;
									}
									else if (iLocal_96.f_2 != -1)
									{
					...
					else
					{
						...
						{
							if (func_266(false, true, true, true))
							{
								if (!func_313())
								{
									...
									if (!HUD::DOES_BLIP_EXIST(Global_1931229))
									{
										Global_1931229 = HUD::ADD_BLIP_FOR_COORD(Global_1931230);
										HUD::SET_BLIP_SPRITE(Global_1931229, BLIP_LESTER_FAMILY);
										HUD::SET_BLIP_FLASHES(Global_1931229, true);
										HUD::SET_BLIP_FLASH_TIMER(Global_1931229, 7000);
									}
								
									MISC::SET_BIT(&iLocal_445, 2);
									MISC::SET_BIT(&iLocal_445, 9);
								}
							}
						}
					
						if (IS_BIT_SET(uLocal_176[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_2, 1))
							MISC::CLEAR_BIT(&(uLocal_176[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_2), 1);
					
						if (IS_BIT_SET(iLocal_445, 13))
							MISC::CLEAR_BIT(&iLocal_445, 13);
					}
				}
			}
			else if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				if (PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID()))
				{
					...
					{
						if (!func_316(PLAYER::PLAYER_ID(), true, false) && !func_315() && func_314() == 0 && !func_313() && !func_308() && !func_278(false) && !func_277(PLAYER::PLAYER_ID(), 21) && !func_277(PLAYER::PLAYER_ID(), 25))
						{
							if (!_STOPWATCH_IS_INITIALIZED(&uLocal_448))
							{
								_STOPWATCH_INITIALIZE(&uLocal_448, false, false);
							}
							else if (_STOPWATCH_HAS_TIME_PASSED(&uLocal_448, 10, false))
							{
								MISC::CLEAR_BIT(&iLocal_445, 5);
								MISC::CLEAR_BIT(&iLocal_445, 2);
								MISC::CLEAR_BIT(&iLocal_445, 3);
								MISC::CLEAR_BIT(&iLocal_445, 8);
								_STOPWATCH_DESTROY(&uLocal_448);
		...
		case 1:
			if (bLocal_443)
				if (func_260())
					uLocal_176[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_1 = 2;
			else if (func_220())
				uLocal_176[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_1 = 2;
			break;
		...
		case 2:
			if (func_165())
				uLocal_176[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_1 = 3;
			break;
	
		case 3:
			if (!IS_BIT_SET(uLocal_176[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_2, 0))
				MISC::SET_BIT(&(uLocal_176[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_2), 0);
			break;
	}
...
void func_20(BOOL bParam0) // Position - 0xD84
{
	...
	num = func_148(PLAYER::PLAYER_ID(), bParam0);
	num2 = func_145(num, bParam0);
...
int func_44(int iParam0) // Position - 0x1BEF
{
	...
	{
		num = func_163(func_115(iParam0), -1);
...
void func_45(int iParam0, int iParam1) // Position - 0x1C32
{
	...
	func_46(func_115(iParam0), iParam1, -1);
	return;
}
...
void func_46(int iParam0, int iParam1, int iParam2) // Position - 0x1C51
{
	...
	{
		func_161(iParam0, iParam1, iParam2, true);
		return;
	}
	...
	if (!func_113(num, iParam1 == func_163(iParam0, -1)))
	{
		flag = false;
	}
	else
...
void func_47(var uParam0) // Position - 0x1CE5
{
	...
	if (uParam0->f_6 >= uParam0->f_2.f_2)
	{
		...
		if (func_73(*uParam0, uParam0->f_1, false, false))
		{
			...
			if (!Global_2740191.f_7134.f_1 && func_112(*uParam0) >= uParam0->f_1)
			{
...
void func_54(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7) // Position - 0x3262
{
	int i;
...
void _STAT_SET_PACKED_BOOL(int iParam0, BOOL bParam1, int iParam2) // Position - 0x347E
{
	if (iParam2 == -1)
		iParam2 = func_34();
...
int func_58(int iParam0) // Position - 0x351C
{
	switch (iParam0)
	{
		case 0:
...
void func_59(int iParam0, int iParam1) // Position - 0x356A
{
	int num;
	BOOL address;
	int offset;
...
void func_60(int iParam0, int iParam1) // Position - 0x35BB
{
	int num;
	int offset;
...
int func_61(int iParam0) // Position - 0x3676
{
	return func_62(iParam0) / 8;
}

int func_62(int iParam0) // Position - 0x3687
{
	switch (iParam0)
	{
		case 2:
...
void func_63(int iParam0, int iParam1) // Position - 0x3805
{
	var entityCoords;
	int num;
	Hash hash;
...
Hash func_64(int iParam0) // Position - 0x3858
{
	var unk;
...
char* func_65(int iParam0) // Position - 0x3877
{
	switch (iParam0)
	{
		case 0:
...
Hash func_66(int iParam0) // Position - 0x3A3E
{
	switch (iParam0)
	{
		case 0:
...
Hash func_67() // Position - 0x3AAA
{
	return MISC::GET_HASH_KEY("PROGRESS_HUB_TIER_COMPLETED");
}

int func_68() // Position - 0x3ABA
{
	if (Global_1668418 == 0)
		func_69();
...
int func_70(int iParam0, int iParam1) // Position - 0x3B01
{
	if (iParam1 == 4)
		iParam1 = 3;
...
int func_71(int iParam0) // Position - 0x3B1D
{
	return func_62(iParam0) % 8;
}

int func_72(int iParam0) // Position - 0x3B2E
{
	int num;
...
BOOL func_73(int iParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Position - 0x3B44
{
	BOOL flag;
	int num;
	int num2;
...
BOOL func_74(int iParam0, int iParam1) // Position - 0x3BE1
{
	BOOL flag;
	BOOL flag2;
...
BOOL func_75(int iParam0, int iParam1) // Position - 0x3C02
{
	int i;
...
int func_76(int iParam0, int iParam1) // Position - 0x4D9E
{
	if (func_77(iParam0))
	{
		switch (iParam1)
...
BOOL func_77(int iParam0) // Position - 0x4E11
{
	int num;
...
int func_78(int iParam0) // Position - 0x4E39
{
	switch (iParam0)
	{
		case 26:
...
int func_79(int iParam0, int iParam1, int iParam2) // Position - 0x4F3F
{
	int num;
	int i;
	int num2;
...
int func_80(int iParam0) // Position - 0x4FAB
{
	if (func_77(iParam0))
		return 13;
...
void func_81(int iParam0) // Position - 0x4FC6
{
	int num;
	int num2;
	int offset;
...
int func_82(int iParam0) // Position - 0x5004
{
	return iParam0 % 32;
}

int func_83(int iParam0) // Position - 0x5011
{
	return iParam0 / 32;
}

int func_84(int iParam0) // Position - 0x501E
{
	switch (iParam0)
	{
		case 16:
...
void func_85(var uParam0) // Position - 0x609D
{
	int num;
	int num2;
	int num3;
...
int func_86(int iParam0) // Position - 0x60D9
{
	switch (iParam0)
	{
		case 2:
...
void func_87(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7) // Position - 0x6C64
{
	var entityCoords;
	int num;
	Hash hash;
...
Hash func_88(int iParam0, var uParam1, int iParam2) // Position - 0x6CCD
{
	var unk;
...
char* func_89(int iParam0) // Position - 0x6FCC
{
	var unk;
...
char* func_90(var uParam0) // Position - 0x6FE7
{
	return uParam0;
}

char* func_91(int iParam0) // Position - 0x6FF1
{
	switch (iParam0)
	{
		case 0:
...
Hash func_92(BOOL bParam0) // Position - 0x7045
{
	if (bParam0)
...
BOOL func_93(int iParam0, int iParam1) // Position - 0x7068
{
	int i;
	BOOL flag;
	BOOL flag2;
	...
	switch (iParam0)
	{
		...
		case 15:
			switch (iParam1)
			{
				...
				case 161:
					flag = SYSTEM::FLOOR(SYSTEM::TO_FLOAT(func_163(12025, -1) / 60));
					break;
...
BOOL func_94(int iParam0, int iParam1) // Position - 0xC8F6
{
	Hash statHash;
	BOOL outValue;
...
Hash func_95(int iParam0, int iParam1) // Position - 0xC91A
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(10, iParam0, func_33(iParam1));
}

BOOL func_96() // Position - 0xC930
{
	int num;
	BOOL flag;
...
void func_97(int iParam0, BOOL bParam1, int iParam2) // Position - 0xC977
{
	if (iParam2 == -1)
		iParam2 = func_34();
...
BOOL func_98() // Position - 0xC99F
{
	...
	func_161(11960, Global_2740191.f_6950.f_3, -1, true);
	return flag;
}

BOOL func_99() // Position - 0xCA18
{
	BOOL address;
	int i;
	Hash weaponHash;
...
int func_100(int iParam0) // Position - 0xCB0E
{
	iParam0 = iParam0 / 32;
...
Hash func_101(int iParam0) // Position - 0xCB81
{
	switch (iParam0)
	{
		case 34:
...
var func_102(BOOL bParam0, var uParam1, var uParam2) // Position - 0xD1C2
{
	if (bParam0)
		return uParam1;
...
BOOL func_103(int iParam0, int iParam1) // Position - 0xD1D9
{
	Hash statHash;
	int outValue;
...
Hash func_104(int iParam0, int iParam1) // Position - 0xD1FD
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(8, iParam0, func_33(iParam1));
}

BOOL func_105(BOOL bParam0) // Position - 0xD213
{
	int num;
	BOOL flag;
...
void func_106(var uParam0, int iParam1) // Position - 0xD253
{
	*uParam0 = *uParam0 - *uParam0 && iParam1;
	return;
}

BOOL func_107() // Position - 0xD268
{
	int num;
	int num2;
	...
	func_97(41247, num2, -1);
	return num2;
}

int func_108(BOOL bParam0) // Position - 0xD4AD
{
	if (bParam0)
		return 1;
...
int _STAT_GET_PACKED_INT(int iParam0, int iParam1) // Position - 0xD4BF
{
	if (iParam1 == -1)
		iParam1 = func_34();
...
BOOL func_110(int iParam0, var uParam1) // Position - 0xD4DB
{
	int i;
...
int func_111(int iParam0, int iParam1, int iParam2) // Position - 0xD553
{
	switch (iParam1)
	{
		case 9:
...
int func_112(int iParam0) // Position - 0xE53F
{
	int num;
	int num2;
	int num3;
...
BOOL func_113(int iParam0, BOOL bParam1) // Position - 0xE585
{
	if (iParam0 == -1)
		return false;
...
int func_114(int iParam0) // Position - 0xE5A1
{
	switch (iParam0)
	{
		case 13035:
...
int func_115(int iParam0) // Position - 0xE9DD
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_116(BOOL bParam0) // Position - 0xE9FB
{
	int num;
...
void func_117(BOOL bParam0, BOOL bParam1) // Position - 0xEA55
{
	BOOL flag;
...
BOOL func_118(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0xEB06
{
	int num;
	int num2;
...
BOOL func_120(Player plParam0, int iParam1) // Position - 0xECE4
{
	if (!func_40())
		return false;
	...
	return func_121(&(Global_1845274[plParam0 /*877*/].f_816), func_122(iParam1));
}

BOOL func_121(var uParam0, int iParam1) // Position - 0xED24
{
	int num;
	int num2;
	int num3;
...
int func_122(int iParam0) // Position - 0xED47
{
	switch (iParam0)
	{
		case 86:
...
BOOL func_123() // Position - 0xEF33
{
	return IS_BIT_SET(Global_1845274[PLAYER::PLAYER_ID() /*877*/].f_144, 3);
}

BOOL func_124(BOOL bParam0) // Position - 0xEF4A
{
	if (bParam0)
		return func_127();
...
BOOL func_125(int iParam0) // Position - 0xEF66
{
	return iParam0 > 0 && iParam0 < 6;
}

int func_126() // Position - 0xEF7B
{
	return Global_1908496[PLAYER::PLAYER_ID() /*313*/].f_273;
}

BOOL func_127() // Position - 0xEF91
{
	return func_39(526, -1) || unk_0xB233964AC562A357() && func_129() != 0 && !func_128(0);
}

BOOL func_128(int iParam0) // Position - 0xEFC1
{
	int num;

	num = func_163(15548, -1);
	return IS_BIT_SET(num, iParam0);
}

int func_129() // Position - 0xEFD8
{
	return unk_0xA0A0D77ECEDD4136();
}

void func_130(int iParam0, BOOL bParam1) // Position - 0xEFE4
{
	int offset;
	int num;
...
void func_132(BOOL bParam0) // Position - 0xF0AF
{
	if (bParam0)
	{
...
void func_133(Player plParam0, int iParam1) // Position - 0xF116
{
	func_134(&(Global_1845274[plParam0 /*877*/].f_816), func_122(iParam1));
	return;
}

int func_134(var uParam0, int iParam1) // Position - 0xF135
{
	int num;
	int num2;
	int offset;
...
BOOL func_138(int iParam0) // Position - 0xF211
{
	if (func_139())
		return true;
...
BOOL func_139() // Position - 0xF22C
{
	return func_140() != -1;
}

int func_140() // Position - 0xF23A
{
	return Global_2684748.f_767;
}

BOOL func_141(int iParam0) // Position - 0xF249
{
	int num;
	int num2;
	...
	switch (iParam0)
	{
		...
		case 130:
			num2 = iParam0;
			num2 = num2 % 32;
			num = func_163(func_142(iParam0), -1);
...
int func_142(int iParam0) // Position - 0xF477
{
	int num;
...
int func_143(int iParam0) // Position - 0xF544
{
	if (func_36())
		return 1;
...
BOOL func_144(int iParam0) // Position - 0xF822
{
	if (Global_1574612)
		return true;
...
int func_145(int iParam0, BOOL bParam1) // Position - 0xF853
{
	bParam1;
	return func_146(iParam0, 0);
}

int func_146(int iParam0, int iParam1) // Position - 0xF867
{
	int i;
	int value;
	int value2;
...
int func_147(int iParam0) // Position - 0xF922
{
	int num;
	int num2;
...
int func_148(Player plParam0, BOOL bParam1) // Position - 0xFE66
{
	bParam1;
	return func_149(plParam0);
}

int func_149(Player plParam0) // Position - 0xFE79
{
...
BOOL func_150(Player plParam0) // Position - 0xFED0
{
...
BOOL func_151(Player plParam0) // Position - 0xFEEF
{
	Player player;
...
void func_153() // Position - 0xFF41
{
	if (!func_160(1, -1))
		func_158(1, -1);

	if (func_313() && func_25() == 0)
	{
	}
	else
	{
...
var func_155(int iParam0) // Position - 0xFFC9
{
	return Global_1574538[iParam0];
}

var func_156() // Position - 0xFFD9
{
	return func_155(func_34() + 1);
}

BOOL func_157(int iParam0) // Position - 0xFFEB
{
	return Global_1931465.f_16[iParam0 /*44*/].f_3;
}

void func_158(int iParam0, int iParam1) // Position - 0xFFFF
{
	int profileSetting;
	int profileSetting2;
...
int func_159(int iParam0) // Position - 0x100E1
{
	int num;
...
BOOL func_160(int iParam0, int iParam1) // Position - 0x10144
{
	int profileSetting;
	int profileSetting2;
...
void func_161(int iParam0, BOOL bParam1, int iParam2, BOOL bParam3) // Position - 0x1016D
{
	Hash statName;
...
Hash func_162(int iParam0, int iParam1) // Position - 0x1019B
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(0, iParam0, func_33(iParam1));
}

BOOL func_163(int iParam0, int iParam1) // Position - 0x101B0
{
	Hash statHash;
	int outValue;
...
BOOL func_164() // Position - 0x101DF
{
	if (IS_BIT_SET(uLocal_176[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_2, 0))
		return true;
...
BOOL func_165() // Position - 0x101FB
{
	switch (iLocal_273)
	{
		case 0:
			if (!IS_BIT_SET(iLocal_445, 18))
			{
				if (!PED::IS_PED_INJURED(pedLocal_274))
				{
					blLocal_447 = HUD::ADD_BLIP_FOR_ENTITY(pedLocal_274);
					HUD::SET_BLIP_AS_FRIENDLY(blLocal_447, true);
					HUD::SET_BLIP_NAME_FROM_TEXT_FILE(blLocal_447, "FM_LEST_BLP" /*Lester*/);
					func_214("FM_LEST_GTL" /*~s~Go to ~b~Lester.*/, false);
					MISC::SET_BIT(&iLocal_445, 18);
				}
			}
		
			if (!IS_BIT_SET(iLocal_445, 20))
			{
				if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
				{
					if (!PED::IS_PED_INJURED(pedLocal_274))
					{
						...
						{
							iLocal_277 = PED::CREATE_SYNCHRONIZED_SCENE(1276.39f, -1712.845f, 54.372f, 0f, 0f, -155.52f, 2);
							TASK::TASK_SYNCHRONIZED_SCENE(pedLocal_274, iLocal_277, "missfinale_c2leadinoutfin_c_int", "_LEADIN_ACTION_LESTER", 1000f, -8f, 5, 16, 1148846080, 0);
							ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(pedLocal_276, iLocal_277, "_LEADIN_ACTION_WCHAIR", "missfinale_c2leadinoutfin_c_int", 1000f, 8f, 4, 1148846080);
							MISC::SET_BIT(&iLocal_445, 20);
						}
					}
				}
			}
			...
			if (!IS_BIT_SET(iLocal_445, 3))
			{
				CUTSCENE::REQUEST_CUTSCENE(sLocal_446, 8);
				MISC::SET_BIT(&iLocal_445, 3);
			}
			else if (!IS_BIT_SET(iLocal_445, 10))
			{
				if (CUTSCENE::CAN_REQUEST_ASSETS_FOR_CUTSCENE_ENTITY())
				{
					CUTSCENE::SET_CUTSCENE_ENTITY_STREAMING_FLAGS("MP_1", 0, 1);
					MISC::SET_BIT(&iLocal_445, 10);
				}
			}
		...
		case 4:
			...
			else if (CUTSCENE::HAS_CUTSCENE_FINISHED())
			{
				...
				if (IS_BIT_SET(iLocal_445, 25))
					PLAYER::SET_PLAYER_INVINCIBLE(PLAYER::PLAYER_ID(), false);
			
				if (inLocal_450 != 0)
					INTERIOR::UNPIN_INTERIOR(inLocal_450);
	...
	if (!IS_BIT_SET(iLocal_445, 11))
	{
		if (CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("MP_1", 0))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				MISC::SET_BIT(&iLocal_445, 11);
			}
		}
	}

	if (!IS_BIT_SET(iLocal_445, 26))
	{
		if (iLocal_273 > 2)
		{
			if (CUTSCENE::CAN_SET_EXIT_STATE_FOR_CAMERA(false))
			{
				if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
				{
					...
					CAM::SET_GAMEPLAY_CAM_RELATIVE_HEADING(0f);
					CAM::SET_GAMEPLAY_CAM_RELATIVE_PITCH(0f, 1065353216);
					MISC::SET_BIT(&iLocal_445, 26);
				}
			}
		}
	}

	if (IS_BIT_SET(iLocal_445, 19))
	{
...
void func_166() // Position - 0x105C9
{
	int num;

	num = func_167(53);
	Global_2645394[num /*83*/] = 53;
	TEXT_LABEL_ASSIGN_STRING(&Global_2645394[num /*83*/].f_18[0 /*16*/], "-StraightIntoFreemode", 64);
	return;
}

int func_167(int iParam0) // Position - 0x105F6
{
	int num;
	int i;
...
void func_168(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x10643
{
	func_193();
	...
	if (func_313() == false && func_179() == false && bParam1 && !func_177(PLAYER::PLAYER_ID()) && !STREAMING::IS_NEW_LOAD_SCENE_ACTIVE() && func_175())
...
void func_169() // Position - 0x10715
{
	int i;
	Player player;
...
void func_170(Player plParam0) // Position - 0x10838
{
...
BOOL func_171(Player plParam0, int iParam1) // Position - 0x10907
{
	BOOL flag;
...
int func_172(int iParam0, BOOL bParam1) // Position - 0x10960
{
	int num;
	int num2;
...
void _STOPWATCH_RESET(var pStopwatch, BOOL useLocalTimer, BOOL useAccurateTime) // Position - 0x109A1
{
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS() && !useLocalTimer)
		if (!useAccurateTime)
			*pStopwatch = NETWORK::GET_NETWORK_TIME();
...
BOOL func_174() // Position - 0x109DE
{
...
BOOL func_175() // Position - 0x109FC
{
	if (func_176() == 0)
		return true;
...
int func_176() // Position - 0x10A11
{
	return Global_1574634.f_18;
}

BOOL func_177(Player plParam0) // Position - 0x10A1F
{
...
BOOL func_178() // Position - 0x10A5E
{
	return IS_BIT_SET(Global_2621446, 3);
}

BOOL func_179() // Position - 0x10A6C
{
	return IS_BIT_SET(Global_2684748, 7);
}

void func_180() // Position - 0x10A7A
{
	Global_24009.f_5 = 0;
	return;
}

void func_181(int iParam0) // Position - 0x10A88
{
	Global_2740191.f_4671 = iParam0;
	return;
}

void func_182(int iParam0, BOOL bParam1, int iParam2) // Position - 0x10A99
{
	switch (iParam0)
	{
		case 5:
...
void func_183() // Position - 0x10AE8
{
	func_181(1);
	func_182(4, 0, -1);
	func_182(6, false, -1);
...
void func_184(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0x10B3F
{
	if (bParam0)
	{
...
BOOL func_185() // Position - 0x10C8E
{
	return IS_BIT_SET(Global_1845274[PLAYER::PLAYER_ID() /*877*/].f_36.f_18, 14);
}

int func_186(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x10CA8
{
	int num;
...
BOOL func_187() // Position - 0x10CDB
{
...
void func_188() // Position - 0x10D02
{
	func_189(false);
	return;
}

void func_189(BOOL bParam0) // Position - 0x10D0F
{
	if (bParam0)
	{
		func_190();
...
void func_190() // Position - 0x10D72
{
...
void func_191(BOOL bParam0) // Position - 0x10D9B
{
	int i;
...
void func_192(int iParam0) // Position - 0x10DC9
{
...
void func_193() // Position - 0x10E33
{
	if (!Global_1574756)
		return;
...
void func_194() // Position - 0x10E4A
{
...
void func_195() // Position - 0x10E69
{
	if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
...
void func_196() // Position - 0x10E9F
{
	Ped entity;

	if (HUD::DOES_BLIP_EXIST(blLocal_447))
		HUD::REMOVE_BLIP(&blLocal_447);
...
Hash func_197(eCharacter echParam0) // Position - 0x10F01
{
...
Hash func_198(eCharacter echParam0) // Position - 0x10F27
{
	return Global_2241[echParam0 /*29*/];
}

BOOL func_199(eCharacter echParam0) // Position - 0x10F36
{
	return echParam0 < CHAR_MULTIPLAYER;
}

void func_200(int iParam0) // Position - 0x10F42
{
	if (func_203())
		return;
...
void func_201(BOOL bParam0, BOOL bParam1) // Position - 0x10FCC
{
	if (bParam0)
	{
		if (func_319(0))
...
BOOL func_202() // Position - 0x11040
{
	return IS_BIT_SET(Global_1960332, 5);
}

BOOL func_203() // Position - 0x1104E
{
	return IS_BIT_SET(Global_1960332, 19);
}

void _SET_PLAYER_CONTROL_EX(Player plParam0, BOOL bParam1, eSetPlayerControlFlags espcfParam2, BOOL bParam3) // Position - 0x1105D
{
		...
		if (NETWORK::NETWORK_IS_PLAYER_ACTIVE(plParam0) && PLAYER::IS_PLAYER_PLAYING(plParam0) || bParam3 == true)
		{
			...
			else
			{
				if (!func_208(playerPed) && !ENTITY::IS_ENTITY_ATTACHED_TO_ANY_VEHICLE(playerPed))
				{
					...
					if (func_205(*Global_4718592.f_197275))
...
BOOL func_205(int iParam0) // Position - 0x11511
{
	return iParam0 == 17;
}

void func_206() // Position - 0x1151E
{
	var unk;
...
void func_207() // Position - 0x1156B
{
...
BOOL func_208(Ped pedParam0) // Position - 0x115A9
{
...
void func_209(BOOL bParam0, Ped pedParam1, int iParam2) // Position - 0x115DA
{
	int num;
	eViewModeContext i;
...
void _MPPLY_STAT_SET_BOOL(Hash hParam0, BOOL bParam1) // Position - 0x116AA
{
	Hash statName;
...
void func_211() // Position - 0x116C6
{
	eViewModeContext i;
...
BOOL func_212() // Position - 0x1171E
{
...
void func_213(int iParam0) // Position - 0x1174F
{
	if (iParam0 == 1)
...
void func_214(char* sParam0, BOOL bParam1) // Position - 0x11772
{
...
void func_215() // Position - 0x117DD
{
	MISC::SET_BIT(&(Global_1574766.f_59), 1);
	return;
}

void func_216(BOOL bParam0) // Position - 0x117F0
{
	if (bParam0)
	{
...
void func_217() // Position - 0x11816
{
...
BOOL func_218(char* sParam0) // Position - 0x1183B
{
	if (!func_18())
		return false;
...
BOOL func_219(char* sParam0) // Position - 0x1187F
{
	if (!func_18())
		return false;
...
BOOL func_220() // Position - 0x118B1
{
	switch (iLocal_452)
	{
		case 0:
			...
			if (GRAPHICS::HAS_SCALEFORM_MOVIE_LOADED(iLocal_453) && func_272())
			{
				func_253();
				func_252();
				func_249(false, false, true, false, true, true, false);
				...
				func_246(true, true, false, true);
			
				if (!PED::IS_PED_INJURED(pedLocal_275))
				{
					MISC::CLEAR_AREA(1273.8845f, -1718.0037f, 53.7715f, 3f, true, false, false, false);
					TASK::CLEAR_PED_TASKS_IMMEDIATELY(pedLocal_275);
					ENTITY::SET_ENTITY_COORDS(pedLocal_275, 1275.2563f, -1722.3683f, 53.655f, true, false, false, true);
					ENTITY::SET_ENTITY_HEADING(pedLocal_275, 12.6638f);
					PED::FORCE_PED_MOTION_STATE(pedLocal_275, joaat("MotionState_Walk"), false, 0, false);
					PED::FORCE_PED_AI_AND_ANIMATION_UPDATE(PLAYER::PLAYER_PED_ID(), false, false);
					WEAPON::SET_CURRENT_PED_WEAPON(pedLocal_275, joaat("WEAPON_UNARMED"), true);
				}
			
				caLocal_454 = CAM::CREATE_CAM("DEFAULT_SCRIPTED_CAMERA", false);
				CAM::SET_CAM_ACTIVE(caLocal_454, true);
				CAM::SET_CAM_PARAMS(caLocal_454, 1276.4088f, -1719.9183f, 56.1054f, -29.932f, 0f, 137.9132f, 50f, 0, 1, 1, 2);
				CAM::RENDER_SCRIPT_CAMS(true, false, 3000, true, false, 0);
				GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_453, "SET_DETAILS");
				func_245("FM_LEST_CAM" /*~s~CAM: 02*/);
				GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
				GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_453, "SET_LOCATION");
				func_245("FM_LEST_CAM2" /*~s~FRONT DOOR*/);
				GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
			
				if (GRAPHICS::GET_TIMECYCLE_MODIFIER_INDEX() == -1)
					GRAPHICS::SET_TIMECYCLE_MODIFIER("scanline_cam");
			
				MISC::SET_BIT(&iLocal_445, 15);
				_STOPWATCH_INITIALIZE(&uLocal_455, false, false);
		...
		case 1:
			if (!PED::IS_PED_INJURED(pedLocal_275))
			{
				if (!IS_BIT_SET(iLocal_445, 21))
				{
					if (_STOPWATCH_HAS_TIME_PASSED(&uLocal_455, 1000, false))
					{
						TASK::TASK_LOOK_AT_COORD(pedLocal_275, 1276.4088f, -1719.9183f, 56.1054f, -1, 0, 2);
						MISC::SET_BIT(&iLocal_445, 21);
					}
				}
			}
		
			if (_STOPWATCH_HAS_TIME_PASSED(&uLocal_455, 1500, false))
			{
				if (IS_BIT_SET(iLocal_445, 17))
				{
					if (!PED::IS_PED_INJURED(pedLocal_275))
					{
						if (!PED::IS_PED_INJURED(pedLocal_274))
						{
							if (_CONVERSATION_ADD_LINE(&uLocal_278, "FM_1AU", "FM_LESTCUT", 7, 0, 0, 0))
							{
								_STOPWATCH_DESTROY(&uLocal_455);
								_STOPWATCH_INITIALIZE(&uLocal_455, false, false);
								iLocal_452 = iLocal_452 + 1;
							}
						}
					}
				}
		...
		case 2:
			if (!PED::IS_PED_INJURED(pedLocal_275))
			{
				if (!_CONVERSATION_IS_DIALOGUE_IN_PROGRESS())
				{
					PED::SET_PED_CONFIG_FLAG(pedLocal_275, 104, true);
					MISC::SET_BIT(&iLocal_445, 22);
					TASK::TASK_CLEAR_LOOK_AT(pedLocal_275);
					TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(pedLocal_275, 1273.5762f, -1718.4594f, 53.7715f, 1f, 20000, 1048576000, 0, 1193033728);
					_STOPWATCH_DESTROY(&uLocal_455);
					_STOPWATCH_INITIALIZE(&uLocal_455, false, false);
					iLocal_452 = iLocal_452 + 1;
				}
		...
		case 3:
			if (!PED::IS_PED_INJURED(pedLocal_275))
			{
				if (_STOPWATCH_HAS_TIME_PASSED(&uLocal_455, 5000, false) || ENTITY::IS_ENTITY_IN_ANGLED_AREA(pedLocal_275, 1275.1378f, -1718.4255f, 53.729942f, 1272.4507f, -1719.6267f, 55.45897f, 1.5625f, false, true, 0))
				{
					if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
					{
	...
	if (IS_BIT_SET(iLocal_445, 15))
	{
		if (GRAPHICS::HAS_SCALEFORM_MOVIE_LOADED(iLocal_453))
		{
			GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_453, "SET_TIME");
			...
			if (CLOCK::GET_CLOCK_HOURS() >= 0 && CLOCK::GET_CLOCK_HOURS() < 12)
				func_245("FM_LEST_AM" /*~s~AM*/);
			else
				func_245("FM_LEST_PM" /*~s~PM*/);
	...
	if (IS_BIT_SET(iLocal_445, 22))
	{
		if (!PED::IS_PED_INJURED(pedLocal_275))
		{
			PED::SET_PED_CONFIG_FLAG(pedLocal_275, 104, true);
			PED::SET_PED_RESET_FLAG(pedLocal_275, 60, true);
			PED::SET_PED_RESET_FLAG(pedLocal_275, 342, true);
			PED::SET_PED_RESET_FLAG(pedLocal_275, 348, true);
		}
	}

	if (IS_BIT_SET(iLocal_445, 23))
		if (func_221())
			MISC::CLEAR_BIT(&iLocal_445, 23);

	return false;
}

BOOL func_221() // Position - 0x11DE8
{
	BOOL flag;
	...
	if (!ENTITY::DOES_ENTITY_EXIST(pedLocal_274))
	{
		...
		{
			if (func_223(&pedLocal_274, CHAR_LESTER, 1276.39f, -1712.845f, 54.372f, 338.0729f, true))
			{
				PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(pedLocal_274, true);
				ENTITY::SET_ENTITY_INVINCIBLE(pedLocal_274, true, 0);
				_CONVERSATION_INITIALIZE_ACTOR(&uLocal_278, 8, pedLocal_274, "Lester", 0, 1);
				PED::SET_PED_PROP_INDEX(pedLocal_274, 1, 0, 0, false, 1);
			}
		}
	}
	...
	if (!ENTITY::DOES_ENTITY_EXIST(pedLocal_276))
		if (STREAMING::HAS_MODEL_LOADED(joaat("prop_wheelchair_01_s")))
			pedLocal_276 = OBJECT::CREATE_OBJECT(joaat("prop_wheelchair_01_s"), 1276.39f, -1712.845f, 54.372f, false, false, false);

	if (!ENTITY::DOES_ENTITY_EXIST(pedLocal_274))
		return false;

	if (!PED::IS_PED_INJURED(pedLocal_274))
		if (!PED::HAVE_ALL_STREAMING_REQUESTS_COMPLETED(pedLocal_274))
			return false;
	...
	{
		iLocal_277 = PED::CREATE_SYNCHRONIZED_SCENE(1276.39f, -1712.845f, 54.372f, 0f, 0f, -155.52f, 2);
		TASK::TASK_SYNCHRONIZED_SCENE(pedLocal_274, iLocal_277, "missfinale_c2leadinoutfin_c_int", "_LEADIN_LOOP1_LESTER", 1000f, -8f, 5, 0, 1148846080, 0);
		ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(pedLocal_276, iLocal_277, "_LEADIN_LOOP1_WCHAIR", "missfinale_c2leadinoutfin_c_int", 1000f, -8f, 4, 1148846080);
...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, Ped pedParam2, char* sParam3, int iParam4, int iParam5) // Position - 0x11F76
{
...
BOOL func_223(Ped* ppedParam0, eCharacter echParam1, float fParam2, float fParam3, float fParam4, float fParam5, BOOL bParam6) // Position - 0x12011
{
	Hash model;
...
int func_224(var uParam0, eCharacter echParam1) // Position - 0x1209F
{
	int num;
...
void func_225() // Position - 0x120E5
{
	Ped ped;

	if (CAM::DOES_CAM_EXIST(caLocal_454))
	{
		CAM::SET_CAM_ACTIVE(caLocal_454, false);
		CAM::DESTROY_CAM(caLocal_454, false);
	}

	MISC::CLEAR_BIT(&iLocal_445, 15);
	CAM::RENDER_SCRIPT_CAMS(false, false, 3000, true, false, 0);

	if (ENTITY::DOES_ENTITY_EXIST(pedLocal_275))
	{
		ped = pedLocal_275;
...
BOOL _CONVERSATION_ADD_LINE(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x1213C
{
...
BOOL func_227(char* sParam0, int iParam1, BOOL bParam2) // Position - 0x1218A
{
	Global_22603 = 0;
...
void func_228() // Position - 0x12458
{
	if (!func_229())
		return;
...
BOOL func_229() // Position - 0x1248F
{
...
BOOL func_230(Player plParam0) // Position - 0x124F2
{
	return func_10(plParam0, 20);
}

Player _INVALID_PLAYER_INDEX() // Position - 0x12502
{
	return -1;
}

void func_232() // Position - 0x1250B
{
	int i;
...
void func_233() // Position - 0x1253C
{
...
BOOL func_234() // Position - 0x125D1
{
	int num;
	int weaponHash;
...
void _UPDATE_CURRENT_PLAYER_CHARACTER() // Position - 0x1266A
{
	if (func_240(14))
	{
...
eCharacter _GET_CURRENT_PLAYER_CHARACTER() // Position - 0x1270C
{
	func_237();
	return Global_114370.f_2367.f_539.f_4321;
}

void func_237() // Position - 0x12725
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (_GET_CHARACTER_MODEL(Global_114370.f_2367.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_199(character) && !func_240(14) || Global_113318)
			{
				if (Global_114370.f_2367.f_539.f_4321 != character && func_199(Global_114370.f_2367.f_539.f_4321))
...
eCharacter _GET_PLAYER_CHARACTER_FROM_PED(Ped pedParam0) // Position - 0x12822
{
	eCharacter i;
	Hash entityModel;
...
Hash _GET_CHARACTER_MODEL(eCharacter character) // Position - 0x1285F
{
...
BOOL func_240(int iParam0) // Position - 0x12884
{
	return Global_44392 == iParam0;
}

void func_241() // Position - 0x12892
{
	int i;
...
BOOL func_242(int iParam0, int iParam1) // Position - 0x128E9
{
	switch (iParam0)
	{
		case 5:
...
void func_243() // Position - 0x12921
{
...
void func_244(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0x12978
{
...
void func_245(char* sParam0) // Position - 0x129CE
{
...
void func_246(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x129E0
{
	func_248();
	func_191(true);
	HUD::CLEAR_HELP(true);
...
void func_247() // Position - 0x12A55
{
	func_181(0);
	func_182(4, true, -1);
	func_182(6, true, -1);
...
void func_248() // Position - 0x12AAC
{
	Global_1574756 = true;
...
void func_249(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0x12AD5
{
...
void func_250() // Position - 0x12B64
{
	Global_24009.f_5 = 1;
	return;
}

void func_251() // Position - 0x12B72
{
	func_200(0);
	func_189(true);
	return;
...
void func_252() // Position - 0x12B84
{
	Global_2672967.f_1023.f_9 = 1;
	return;
}

void func_253() // Position - 0x12B96
{
...
void func_254() // Position - 0x12BB7
{
	if (!_IS_FMMC_ACTIVE() && !func_255() && Global_2685689)
		Global_4718592.f_138116 = 0;

	return;
}

BOOL func_255() // Position - 0x12BE5
{
	return Global_2684748.f_693;
}

BOOL _IS_FMMC_ACTIVE() // Position - 0x12BF4
{
	return Global_1845274[PLAYER::PLAYER_ID() /*877*/].f_185 != 0;
}

void func_257() // Position - 0x12C0B
{
	Global_2684748.f_758 = 1;
	return;
}

BOOL func_258() // Position - 0x12C1B
{
	return Global_2684748.f_737;
}

BOOL func_259() // Position - 0x12C2A
{
	return IS_BIT_SET(Global_2684748.f_2, 11);
}

BOOL func_260() // Position - 0x12C3B
{
	switch (iLocal_273)
	{
		case 0:
...
void _STOPWATCH_DESTROY(var uParam0) // Position - 0x12D5C
{
	uParam0->f_1 = 0;
	return;
}

BOOL _STOPWATCH_HAS_TIME_PASSED(var pStopwatch, int millis, BOOL useLocalTimer) // Position - 0x12D69
{
	if (millis == -1)
		return true;
...
BOOL _STOPWATCH_IS_INITIALIZED(var uParam0) // Position - 0x12DC7
{
	return uParam0->f_1;
}

BOOL _IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(char* message) // Position - 0x12DD3
{
	HUD::BEGIN_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(message);
	return HUD::END_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(0);
}

void _DISPLAY_HELP_TEXT(char* text, int iParam1) // Position - 0x12DE6
{
...
BOOL func_266(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x12DFD
{
...
BOOL func_267() // Position - 0x12EF6
{
	return Global_2708776;
}

BOOL func_268() // Position - 0x12F02
{
	return Global_2684748.f_850;
}

BOOL func_269() // Position - 0x12F11
{
	return Global_2672967.f_2914.f_582;
}

BOOL func_270(Player plParam0) // Position - 0x12F23
{
...
BOOL func_271() // Position - 0x12F3F
{
	return MISC::GET_GAME_TIMER() <= Global_24148.f_6481 + 100;
}

BOOL func_272() // Position - 0x12F54
{
	Hash entityModel;
	...
	if (!ENTITY::DOES_ENTITY_EXIST(pedLocal_275))
	{
		if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
		{
			...
			pedLocal_275 = PED::CREATE_PED(PED_TYPE_CIVMALE, entityModel, 1273.8271f, -1717.8727f, 53.7715f, 19.2225f, false, false);
			ENTITY::SET_ENTITY_INVINCIBLE(pedLocal_275, true, 0);
			PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(pedLocal_275, true);
			PED::CLONE_PED_TO_TARGET(PLAYER::PLAYER_PED_ID(), pedLocal_275);
		}
	}
	...
	if (!PED::IS_PED_INJURED(pedLocal_275))
		if (!PED::HAVE_ALL_STREAMING_REQUESTS_COMPLETED(pedLocal_275))
			return false;

	return true;
}

void func_273() // Position - 0x12FE3
{
...
void func_274(int iParam0, int iParam1) // Position - 0x13016
{
	int profileSetting;
	int profileSetting2;
...
void func_275(int iParam0, BOOL bParam1) // Position - 0x130A7
{
	if (bParam1)
...
BOOL func_276() // Position - 0x13104
{
	Ped ped;
...
BOOL func_277(Player plParam0, int iParam1) // Position - 0x1319B
{
	return IS_BIT_SET(Global_2658019[plParam0 /*467*/].f_221, iParam1);
}

BOOL func_278(BOOL bParam0) // Position - 0x131B1
{
	Player player;

	player = PLAYER::PLAYER_ID();

	if (func_305(player) || func_304(player) || func_303(player) || func_302(player) || func_301(player) || func_300(player) || func_299(player) || func_298(player) || func_297(player) || func_294(player) && func_293(player) || func_292(player) || func_291(player) || func_290(player) || func_289(player) || func_288(player) || func_287(player) || func_286(player) || func_285(player))
		return true;

	if (bParam0)
		if (func_284(player))
			return true;
	else if (func_279(player))
		return true;

	return false;
}

BOOL func_279(Player plParam0) // Position - 0x132C6
{
	if (func_284(plParam0) || func_283(plParam0) || func_282(plParam0) || _IS_PLAYER_IN_MUSIC_LOCKER(plParam0))
		return true;

	return false;
}

BOOL _IS_PLAYER_IN_MUSIC_LOCKER(Player plParam0) // Position - 0x13300
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2658019[plParam0 /*467*/].f_324.f_8 != -1)
				return func_281(Global_2658019[plParam0 /*467*/].f_324.f_8) == 19;

	return false;
}

int func_281(int iParam0) // Position - 0x13347
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_282(Player plParam0) // Position - 0x13896
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2658019[plParam0 /*467*/].f_324.f_8 != -1)
				return func_281(Global_2658019[plParam0 /*467*/].f_324.f_8) == 15;

	return false;
}

BOOL func_283(Player plParam0) // Position - 0x138DD
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2658019[plParam0 /*467*/].f_324.f_8 != -1)
				return func_281(Global_2658019[plParam0 /*467*/].f_324.f_8) == 16;

	return false;
}

BOOL func_284(Player plParam0) // Position - 0x13924
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2658019[plParam0 /*467*/].f_324.f_8 != -1)
				return func_281(Global_2658019[plParam0 /*467*/].f_324.f_8) == 14;

	return false;
}

BOOL func_285(Player plParam0) // Position - 0x1396B
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2658019[plParam0 /*467*/].f_324.f_8 != -1)
				return func_281(Global_2658019[plParam0 /*467*/].f_324.f_8) == 34;

	return false;
}

BOOL func_286(Player plParam0) // Position - 0x139B2
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2658019[plParam0 /*467*/].f_324.f_8 != -1)
				return func_281(Global_2658019[plParam0 /*467*/].f_324.f_8) == 33;

	return false;
}

BOOL func_287(Player plParam0) // Position - 0x139F9
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2658019[plParam0 /*467*/].f_324.f_8 != -1)
				return func_281(Global_2658019[plParam0 /*467*/].f_324.f_8) == 32;

	return false;
}

BOOL func_288(Player plParam0) // Position - 0x13A40
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2658019[plParam0 /*467*/].f_324.f_8 != -1)
				return func_281(Global_2658019[plParam0 /*467*/].f_324.f_8) == 31;

	return false;
}

BOOL func_289(Player plParam0) // Position - 0x13A87
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			return Global_2658019[plParam0 /*467*/].f_324.f_8 == 161;

	return false;
}

BOOL func_290(Player plParam0) // Position - 0x13AB8
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
...
BOOL func_291(Player plParam0) // Position - 0x13AE9
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2658019[plParam0 /*467*/].f_324.f_8 != -1)
				return func_281(Global_2658019[plParam0 /*467*/].f_324.f_8) == 29;

	return false;
}

BOOL func_292(Player plParam0) // Position - 0x13B30
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2658019[plParam0 /*467*/].f_324.f_8 != -1)
				return func_281(Global_2658019[plParam0 /*467*/].f_324.f_8) == 28;

	return false;
}

BOOL func_293(Player plParam0) // Position - 0x13B77
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
...
BOOL func_294(Player plParam0) // Position - 0x13B9D
{
	if (func_296(plParam0) && func_295(plParam0) == plParam0)
		return true;

	return false;
}

Player func_295(Player plParam0) // Position - 0x13BC1
{
	if (plParam0 == _INVALID_PLAYER_INDEX())
		return plParam0;
...
BOOL func_296(Player plParam0) // Position - 0x13BE5
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2658019[plParam0 /*467*/].f_324.f_8 != -1 && Global_2658019[plParam0 /*467*/].f_324.f_11 != _INVALID_PLAYER_INDEX())
				return func_281(Global_2658019[plParam0 /*467*/].f_324.f_8) == 25;

	return false;
}

BOOL func_297(Player plParam0) // Position - 0x13C45
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2658019[plParam0 /*467*/].f_324.f_8 != -1)
				return func_281(Global_2658019[plParam0 /*467*/].f_324.f_8) == 26;

	return false;
}

BOOL func_298(Player plParam0) // Position - 0x13C8C
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2658019[plParam0 /*467*/].f_324.f_8 != -1)
				return func_281(Global_2658019[plParam0 /*467*/].f_324.f_8) == 21;

	return false;
}

BOOL func_299(Player plParam0) // Position - 0x13CD3
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2658019[plParam0 /*467*/].f_324.f_8 != -1)
				return func_281(Global_2658019[plParam0 /*467*/].f_324.f_8) == 24;

	return false;
}

BOOL func_300(Player plParam0) // Position - 0x13D1A
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2658019[plParam0 /*467*/].f_324.f_8 != -1)
				return func_281(Global_2658019[plParam0 /*467*/].f_324.f_8) == 22;

	return false;
}

BOOL func_301(Player plParam0) // Position - 0x13D61
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2658019[plParam0 /*467*/].f_324.f_8 != -1)
				return func_281(Global_2658019[plParam0 /*467*/].f_324.f_8) == 23;

	return false;
}

BOOL func_302(Player plParam0) // Position - 0x13DA8
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2658019[plParam0 /*467*/].f_324.f_8 != -1)
				return func_281(Global_2658019[plParam0 /*467*/].f_324.f_8) == 11;

	return false;
}

BOOL func_303(Player plParam0) // Position - 0x13DEF
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2658019[plParam0 /*467*/].f_324.f_8 != -1)
				return func_281(Global_2658019[plParam0 /*467*/].f_324.f_8) == 17;

	return false;
}

BOOL func_304(Player plParam0) // Position - 0x13E36
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2658019[plParam0 /*467*/].f_324.f_8 != -1 && Global_2658019[plParam0 /*467*/].f_324.f_11 != _INVALID_PLAYER_INDEX())
				return func_281(Global_2658019[plParam0 /*467*/].f_324.f_8) == 20;

	return false;
}

BOOL func_305(Player plParam0) // Position - 0x13E96
{
	return func_306(&(Global_2658019[plParam0 /*467*/].f_446), 0);
}

BOOL func_306(var uParam0, int iParam1) // Position - 0x13EAF
{
	return IS_BIT_SET(*uParam0, iParam1);
}

BOOL func_307() // Position - 0x13EBD
{
	return Global_1943987;
}

BOOL func_308() // Position - 0x13EC9
{
	return false;
}

BOOL func_309(int iParam0) // Position - 0x13EE3
{
	BOOL flag;
	...
	if (iParam0 >= 0 && iParam0 <= 16 && func_311())
		return true;
	else if (iParam0 >= 17 && iParam0 <= 31 && func_310())
		return true;
...
BOOL func_310() // Position - 0x13F7D
{
	return IS_BIT_SET(func_163(2482, -1), 2);
}

BOOL func_311() // Position - 0x13F8F
{
	return IS_BIT_SET(func_163(2482, -1), 1);
}

BOOL func_312(Player plParam0) // Position - 0x13FA1
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
...
BOOL func_313() // Position - 0x13FC7
{
	return Global_1575088;
}

int func_314() // Position - 0x13FD3
{
	return Global_1845274[PLAYER::PLAYER_ID() /*877*/].f_186;
}

BOOL func_315() // Position - 0x13FE8
{
	return IS_BIT_SET(Global_1845274[PLAYER::PLAYER_ID() /*877*/].f_36.f_18, 0);
}

BOOL func_316(Player plParam0, BOOL bParam1, BOOL bParam2) // Position - 0x14003
{
	if (bParam1)
...
BOOL func_317(Player plParam0) // Position - 0x14035
{
	return func_318(plParam0);
}

BOOL func_318(Player plParam0) // Position - 0x14043
{
	return IS_BIT_SET(Global_1845274[plParam0 /*877*/].f_11.f_1, 0);
}

BOOL func_319(int iParam0) // Position - 0x1405A
{
	if (iParam0 == 1)
		if (Global_21239.f_1 > 3)
...
BOOL func_320() // Position - 0x140B1
{
	return func_321();
}

BOOL func_321() // Position - 0x140BD
{
	return Global_1668469.f_40 == 3;
}

BOOL func_322() // Position - 0x140CD
{
	if (Global_22602 == 4)
		if (AUDIO::IS_MOBILE_PHONE_CALL_ONGOING())
			return true;
...
BOOL _CONVERSATION_IS_DIALOGUE_IN_PROGRESS() // Position - 0x140F2
{
...
BOOL func_324(Player plParam0) // Position - 0x14114
{
	if (func_36())
		return true;
...
int func_325() // Position - 0x14140
{
	return iLocal_96;
}

int func_326(int iParam0) // Position - 0x1414A
{
	return uLocal_176[iParam0 /*3*/];
}

void func_327(Blip blParam0) // Position - 0x14158
{
	if (func_329(true))
	{
	...
	else if (HUD::DOES_BLIP_EXIST(*blParam0) && HUD::IS_BLIP_SHORT_RANGE(*blParam0) && !func_328())
	{
...
BOOL func_328() // Position - 0x141CA
{
	return false;
}

BOOL func_329(BOOL bParam0) // Position - 0x141D3
{
	return func_330(PLAYER::PLAYER_ID(), bParam0);
}

BOOL func_330(Player plParam0, BOOL bParam1) // Position - 0x141E5
{
	if (!func_151(plParam0))
		return false;

	if (!bParam1)
		if (func_331(plParam0))
			return false;

	return func_151(Global_1888882[plParam0 /*611*/].f_10);
}

BOOL func_331(Player plParam0) // Position - 0x1421D
{
	if (func_151(plParam0))
		if (func_151(Global_1888882[plParam0 /*611*/].f_10))
			return Global_1888882[plParam0 /*611*/].f_10 == plParam0;

	return false;
}

void func_332() // Position - 0x14252
{
	Entity entity;
...
void func_333() // Position - 0x14347
{
	SCRIPT::TERMINATE_THIS_THREAD();
	return;
}

void func_334() // Position - 0x14353
{
	Global_2672967.f_1023.f_9 = 0;
	return;
}

BOOL func_335() // Position - 0x14365
{
	return Global_2672967.f_1023.f_9;
}

BOOL _SHOULD_NETWORK_SCRIPT_TERMINATE() // Position - 0x14376
{
...
Hash _GET_CURRENT_SESSION_TYPE_SCRIPT_HASH() // Position - 0x143FA
{
	switch (func_25())
	{
		case 0:
...
Hash func_338() // Position - 0x1442D
{
...
BOOL func_339() // Position - 0x14451
{
	return Global_2684748.f_700;
}

BOOL _DOES_EVENT_OF_TYPE_EXIST(int iParam0) // Position - 0x14460
{
...
BOOL func_341() // Position - 0x14477
{
	return Global_2696555;
}

BOOL func_342() // Position - 0x14483
{
	return Global_2684748.f_695;
}

void func_343() // Position - 0x14492
{
	SYSTEM::WAIT(0);
	return;
}

void func_344(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17, var uParam18, var uParam19, var uParam20) // Position - 0x1449F
{
	func_348(func_349(uParam0), uParam0);
	_NETWORK_ENSURE_SCRIPT_IS_NETWORKED(0, -1, false);
	NETWORK::NETWORK_REGISTER_HOST_BROADCAST_VARIABLES(&iLocal_96, 79, 0);
...
BOOL func_345() // Position - 0x144E1
{
	var unk;
...
int _NETWORK_ENSURE_SCRIPT_IS_NETWORKED(int iParam0, int iParam1, BOOL bNoTerminate) // Position - 0x1453F
{
	int i;
...
BOOL func_347(BOOL bParam0) // Position - 0x14655
{
	bParam0;
	return Global_1575060;
}

void func_348(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17, var uParam18, var uParam19, var uParam20, var uParam21) // Position - 0x14666
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		func_333();
...
int func_349(int iParam0) // Position - 0x14685
{
	switch (iParam0)
	{
		case 3:
	...
	switch (func_350(func_351(iParam0, true)))
	{
		case 0:
			return 8;
...
int func_350(int iParam0) // Position - 0x14E43
{
	switch (iParam0)
	{
		case 150:
...
int func_351(int iParam0, BOOL bParam1) // Position - 0x151CD
{
	switch (iParam0)
	{
		case 237:
