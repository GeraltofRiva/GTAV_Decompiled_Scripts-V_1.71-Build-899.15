...
void func_10() // Position - 0x3DF
{
	...
	if (func_18() == 0)
	{
		if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), false))
		{
			...
			fLocal_21 == fLocal_21;
			func_14(Global_21220, "DISPLAY_VIEW", 23f, SYSTEM::TO_FLOAT(1), -1082130432, -1082130432, -1082130432);
		}
	}
...
float func_11(int iParam0) // Position - 0x68E
{
	...
	fLocal_24 = SYSTEM::COS((3.14159f / 180f) * uLocal_18) * (Global_4546799[iParam0 /*3*/].f_1 - uLocal_18.f_1);
...
{
	fLocal_27 = SYSTEM::SQRT(SYSTEM::VDIST2(Global_4546799[iParam0 /*3*/], uLocal_18));
...
{
	fLocal_26 = SYSTEM::SQRT(((Global_4546799[iParam0 /*3*/] - uLocal_18) * (Global_4546799[iParam0 /*3*/] - uLocal_18)) + ((Global_4546799[iParam0 /*3*/].f_1 - uLocal_18.f_1) * (Global_4546799[iParam0 /*3*/].f_1 - uLocal_18.f_1)));
	return fLocal_26;
}
...
float func_15() // Position - 0x7C1
{
	...
	fLocal_24 = SYSTEM::COS((3.14159f / 180f) * uLocal_18) * (Global_23709.f_1 - uLocal_18.f_1);
	fLocal_25 = MISC::ATAN2(fLocal_23, fLocal_24);
...
{
	fLocal_27 = SYSTEM::SQRT(SYSTEM::VDIST2(Global_23709, uLocal_18));
...
{
	fLocal_26 = SYSTEM::SQRT(((Global_23709 - uLocal_18) * (Global_23709 - uLocal_18)) + ((Global_23709.f_1 - uLocal_18.f_1) * (Global_23709.f_1 - uLocal_18.f_1)));
	return fLocal_26;
}
