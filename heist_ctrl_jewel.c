...
void main() // Position - 0x0
{
	...
	func_245(3);
	func_234(&(uLocal_44.f_1), func_244(Global_97921[1 /*19*/], Global_97921[2 /*19*/]));
...
void func_100() // Position - 0x3E21
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (_GET_CHARACTER_MODEL(Global_114370.f_2367.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_101(character) && !func_230(14) || Global_113318)
			{
...
void func_153() // Position - 0x7153
{
	...
	if (func_232(18))
	{
		...
		else if (MISC::GET_GAME_TIMER() > iLocal_41 || _IS_MISSION_REPEAT_ACTIVE(false))
		{
			...
			func_192(&(Global_114370.f_2367.f_539), 86);
			func_162(&(Global_114370.f_2367.f_539), 86);
			func_161(&iLocal_43);
...
int func_163(var uParam0, int iParam1, int iParam2) // Position - 0x7C82
{
	...
	{
		if (!func_179(Global_100356[iParam2 /*3*/], 0f, 0f, 0f, false))
		{
			unk.f_11 = 12;
			unk.f_31 = 49;
			unk.f_81 = 2;
...
int func_166(int iParam0, var uParam1, int iParam2) // Position - 0xB6A9
{
	...
	if (!func_167(Global_101321[iParam0 /*98*/], false, -1))
	{
		func_165(iParam0, uParam1, iParam2);
		uParam1->f_91 = iParam2;
		return 1;
...
void func_192(var uParam0, int iParam1) // Position - 0xCDAD
{
	...
	for (i = 0; i < 3; i = i + 1)
	{
		...
		else
		{
			...
			if (!func_180(Global_114370.f_18537[i], &unk, &num2))
			{
			...
			if (IS_BIT_SET(iLocal_39, 2))
			{
				switch (iLocal_40)
				{
					case 0:
						...
						{
							if (!ENTITY::IS_ENTITY_DEAD(Global_98389.f_9[0], false))
							{
								pedLocal_727 = Global_98389.f_9[0];
								ENTITY::SET_ENTITY_AS_MISSION_ENTITY(pedLocal_727, false, true);
							}
						}
					
						if (ENTITY::DOES_ENTITY_EXIST(Global_98389[0]))
							if (!ENTITY::IS_ENTITY_DEAD(Global_98389[0], false))
								veLocal_729 = Global_98389[0];
