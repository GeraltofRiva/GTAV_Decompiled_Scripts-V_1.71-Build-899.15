...
void main() // Position - 0x0
{
	...
	while (true)
	{
		...
		if (func_71(PLAYER::PLAYER_PED_ID(), unk, false) > 100f + 20f)
			func_81();
	...
	switch (uParam1->f_13)
	{
		case 0:
			...
			if (func_48(uParam1->f_16))
			{
				for (i = 0; i < *uParam0; i = i + 1)
				{
					if (func_45(&uParam0->[i /*24*/]) && uParam0->[i /*24*/])
					{
						uParam1->f_12 = i;
		...
		case 2:
			...
			if (func_20(&uParam0->[uParam1->f_12 /*24*/]) || uParam0->[i /*24*/].f_8 == 0)
			{
				func_44(uParam1, 0);
				return false;
			}
...
int func_2(Vehicle veParam0, float fParam1, int iParam2, int iParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0xA15
{
...
void func_3(Vehicle veParam0) // Position - 0xA6C
{
	if (!ENTITY::IS_ENTITY_DEAD(veParam0, false))
...
BOOL func_5(Player plParam0) // Position - 0xBE9
{
	return func_6(plParam0, 1);
}

BOOL func_6(Player plParam0, int iParam1) // Position - 0xBF8
{
	if (iParam1 != 0)
...
Player _INVALID_PLAYER_INDEX() // Position - 0xC22
{
	return -1;
}

int _GET_VEHICLE_SEAT_PED_IS_IN(Ped ped, BOOL includeLastVehicle) // Position - 0xC2B
{
...
BOOL func_9(BOOL bParam0) // Position - 0xCB0
{
	if (bParam0)
		if (func_10())
			return true;
...
void func_11() // Position - 0xD08
{
	Global_24009.f_6 = 1;
	return;
}

BOOL func_12(var uParam0) // Position - 0xD16
{
	var entityRotation;
	Ped vehiclePedIsIn;
	Ped ped;
...
float func_13(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5) // Position - 0xDBF
{
	return (fParam0 * uParam3) + (fParam0.f_1 * uParam3.f_1);
}

BOOL func_14() // Position - 0xDD6
{
	Vehicle vehiclePedIsIn;
...
int func_15(var uParam0, const char* sParam1, int iParam2) // Position - 0xE10
{
...
void func_16(const char* sParam0, int iParam1) // Position - 0xE5C
{
...
BOOL func_17(var uParam0) // Position - 0xE78
{
...
BOOL _IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(const char* message) // Position - 0xED2
{
	HUD::BEGIN_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(message);
	return HUD::END_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(0);
}

BOOL func_19(const char* sParam0, int iParam1) // Position - 0xEE5
{
...
BOOL func_20(var uParam0) // Position - 0xEFE
{
	var unk;
	...
	if (uParam0->f_11 == 0)
		return !func_23(PLAYER::PLAYER_PED_ID(), uParam0->f_1, uParam0->f_10 + 2f, true);

	unk = { func_21(uParam0->f_16, 2f) };
	return !ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), unk[0 /*3*/], unk[1 /*3*/], unk.f_7, false, true, 0);
}

struct<8> func_21(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, float fParam8) // Position - 0xFA2
{
	var unk;
	var unk9;

	unk = 2;
	unk9 = { func_22(uParam0[1 /*3*/] - uParam0[0 /*3*/]) * { fParam8, fParam8, fParam8 } };
...
Vector3 func_22(float fParam0, var uParam1, var uParam2) // Position - 0x1004
{
	float num;
	float num2;
...
BOOL func_23(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, float fParam4, BOOL bParam5) // Position - 0x1043
{
	return SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(pedParam0, bParam5), vParam1) <= fParam4 * fParam4;
}

int func_24(var uParam0, const char* sParam1) // Position - 0x1061
{
	if (MISC::IS_STRING_NULL_OR_EMPTY(sParam1))
		return 0;
...
void func_25(const char* sParam0) // Position - 0x10AA
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_HELP(sParam0);
	HUD::END_TEXT_COMMAND_DISPLAY_HELP(0, true, true, -1);
	return;
...
void func_26(var uParam0) // Position - 0x10C0
{
	if (func_17(uParam0))
		HUD::CLEAR_HELP(true);
...
BOOL func_27() // Position - 0x10ED
{
	...
	if (func_31(vehiclePedIsIn))
		return true;

	if (func_28(vehiclePedIsIn, 3))
		return true;

	return !VEHICLE::IS_VEHICLE_DRIVEABLE(vehiclePedIsIn, false);
}

BOOL func_28(Vehicle veParam0, int iParam1) // Position - 0x1141
{
	int num;
...
BOOL func_29(Vehicle veParam0) // Position - 0x11DD
{
...
BOOL _DOES_ENTITY_EXIST_AND_IS_ALIVE(Vehicle veParam0) // Position - 0x1207
{
...
BOOL func_31(Vehicle veParam0) // Position - 0x1228
{
	if (ENTITY::DOES_ENTITY_EXIST(veParam0))
		if (ENTITY::IS_ENTITY_DEAD(veParam0, false))
			return true;
...
int func_33(int iParam0) // Position - 0x12B9
{
	return Global_61697[iParam0];
}

eCharacter _GET_CURRENT_PLAYER_CHARACTER() // Position - 0x12C8
{
	func_35();
	return Global_114370.f_2367.f_539.f_4321;
}

void func_35() // Position - 0x12E1
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (_GET_CHARACTER_MODEL(Global_114370.f_2367.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_36(character) && !func_70(14) || Global_113318)
			{
...
BOOL func_36(eCharacter echParam0) // Position - 0x13DE
{
	return echParam0 < CHAR_MULTIPLAYER;
}

eCharacter _GET_PLAYER_CHARACTER_FROM_PED(Ped pedParam0) // Position - 0x13EA
{
	eCharacter i;
	Hash entityModel;
...
Hash _GET_CHARACTER_MODEL(eCharacter character) // Position - 0x1427
{
...
Hash func_39(eCharacter echParam0) // Position - 0x144C
{
	return Global_2241[echParam0 /*29*/];
}

int func_40(Player plParam0) // Position - 0x145B
{
	int num;
...
int func_41(Player plParam0) // Position - 0x146D
{
	if (plParam0 > -1)
		if (plParam0 == PLAYER::PLAYER_ID())
			return MONEY::NETWORK_GET_VC_WALLET_BALANCE(-1);
		else if (func_42(plParam0))
...
BOOL func_42(Player plParam0) // Position - 0x14B0
{
	if (!func_43(plParam0))
		return false;
...
BOOL func_43(Player plParam0) // Position - 0x14CF
{
	Player player;
...
void func_44(var uParam0, int iParam1) // Position - 0x14F1
{
...
BOOL func_45(var uParam0) // Position - 0x1505
{
	func_72(PLAYER::PLAYER_PED_ID());
	...
	return func_23(PLAYER::PLAYER_PED_ID(), uParam0->f_1, uParam0->f_10, true);
}

BOOL func_46() // Position - 0x15BE
{
	return MISC::GET_GAME_TIMER() <= Global_24148.f_6481 + 100;
}

BOOL func_47(BOOL bParam0) // Position - 0x15D3
{
	if (bParam0)
...
BOOL func_48(int iParam0) // Position - 0x15FC
{
	if (iParam0 == 0)
		if (func_69())
			return false;

	if (HUD::IS_PAUSE_MENU_ACTIVE() || PLAYER::IS_SYSTEM_UI_BEING_DISPLAYED() || func_46() || Global_64517 || func_47(false) || func_54(0) || func_53() || func_49(PLAYER::PLAYER_ID()))
		return false;

	return true;
}

BOOL func_49(Player plParam0) // Position - 0x166C
{
	if (func_52(plParam0))
		return true;
...
BOOL func_50(Player plParam0) // Position - 0x168F
{
	Player player;
...
BOOL func_51(Player plParam0, int iParam1) // Position - 0x16AD
{
	return IS_BIT_SET(Global_1888882[plParam0 /*611*/].f_10.f_4, iParam1);
}

BOOL func_52(Player plParam0) // Position - 0x16C5
{
	Player player;
...
BOOL func_54(int iParam0) // Position - 0x170A
{
	if (iParam0 == 1)
...
void func_55(var uParam0) // Position - 0x1761
{
	if (uParam0->f_11 == 1)
...
void func_56(var uParam0, var uParam1, var uParam2, var uParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8) // Position - 0x1796
{
	int i;
	float num;
	float num2;
...
void func_57(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4) // Position - 0x184B
{
	func_58(uParam0->[0 /*3*/], uParam0->[1 /*3*/], uParam0->f_7, iParam1, iParam2, iParam3, iParam4);
	return;
}

void func_58(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, int iParam7, int iParam8, int iParam9, int iParam10) // Position - 0x1871
{
	var unk;
	var unk4;
	float num;
...
Vector3 func_59(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5) // Position - 0x1A81
{
...
void func_60(int iParam0, int iParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0x1ABA
{
	if (iParam0 != 198)
	{
		if (Global_79768)
...
void func_61(int iParam0, int iParam1) // Position - 0x1B12
{
	switch (iParam0)
	{
		case 12:
...
void func_62(int iParam0, BOOL bParam1) // Position - 0x1BF1
{
	if (bParam1)
...
BOOL func_63(int iParam0, BOOL bParam1, int iParam2, BOOL bParam3) // Position - 0x1C1A
{
	BOOL flag;
	int num;
	int num2;
...
int func_65() // Position - 0x25AF
{
	return Global_33299;
}

int func_66() // Position - 0x25BA
{
	return Global_33298;
}

int func_67(var uParam0, int iParam1) // Position - 0x25C5
{
	int i;
...
int func_68(int iParam0) // Position - 0x5E04
{
	if (iParam0 != 198)
		if (Global_79768)
...
BOOL func_70(int iParam0) // Position - 0x5E4F
{
	return Global_44392 == iParam0;
}

float func_71(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0x5E5D
{
...
BOOL func_72(Vehicle veParam0) // Position - 0x5E97
{
	if (!ENTITY::DOES_ENTITY_EXIST(veParam0))
		return false;
...
void func_73() // Position - 0x5EB5
{
	if (func_70(14))
	{
		func_79(&uLocal_97[0 /*24*/], 0, "Bigwheel", func_80(158), 0, "", 0, 6.2f);
		func_74(&uLocal_72[0 /*24*/], 0, "Rollercoaster", -1651.6411f, -1134.325f, 21.903982f, -1640.9845f, -1121.5903f, 16.503132f, 6.75f, 0, "", 0);
	}
	else
	{
		func_79(&uLocal_97[0 /*24*/], 0, "Bigwheel", func_80(158), 8, "", 0, 6.2f);
		func_74(&uLocal_72[0 /*24*/], 0, "Rollercoaster", -1651.6411f, -1134.325f, 21.903982f, -1640.9845f, -1121.5903f, 16.503132f, 6.75f, 15, "", 0);
	}
...
void func_74(var uParam0, int iParam1, char* sParam2, float fParam3, float fParam4, float fParam5, float fParam6, float fParam7, float fParam8, float fParam9, int iParam10, char* sParam11, int iParam12) // Position - 0x5FC7
{
	uParam0->f_5 = sParam2;
...
Vector3 func_75(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7) // Position - 0x6030
{
	return func_76(uParam0[0 /*3*/], uParam0[1 /*3*/], 0.5f, true);
}

Vector3 func_76(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, BOOL bParam7) // Position - 0x6050
{
	if (bParam7)
...
float func_77(float fParam0, float fParam1, float fParam2) // Position - 0x6079
{
	if (fParam0 > fParam2)
		return fParam2;
...
void func_78(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, float fParam7) // Position - 0x60A0
{
	uParam0->[0 /*3*/] = { uParam1 };
	uParam0->[1 /*3*/] = { uParam4 };
	uParam0->f_7 = fParam7;
...
void func_79(var uParam0, int iParam1, char* sParam2, var uParam3, var uParam4, var uParam5, int iParam6, char* sParam7, int iParam8, float fParam9) // Position - 0x60C4
{
	uParam0->f_5 = sParam2;
	uParam0->f_1 = { uParam3 };
	uParam0->f_4 = sParam7;
...
Vector3 func_80(int iParam0) // Position - 0x6139
{
	int num;
...
void func_81() // Position - 0x6151
{
	func_82(&uLocal_97[0 /*24*/]);
	func_82(&uLocal_72[0 /*24*/]);
	func_26(&sLocal_38);
	func_26(&sLocal_55);
	SCRIPT::TERMINATE_THIS_THREAD();
	return;
...
void func_82(var uParam0) // Position - 0x617B
{
	*uParam0 = 0;
	return;
}

BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0x6187
{
