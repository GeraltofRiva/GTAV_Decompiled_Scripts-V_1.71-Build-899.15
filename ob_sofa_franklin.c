...
void func_23(int iParam0) // Position - 0x2240
{
	if (iParam0 != -1)
	{
		...
		if (Global_33359[iParam0 /*11*/].f_2 && Global_33359[iParam0 /*11*/].f_7 == 0)
...
void func_24(Ped pedParam0, Cam caParam1, int iParam2, int iParam3, int iParam4) // Position - 0x2288
{
	...
	if (!func_41(pedParam0))
	{
		...
		if (num3 == -1)
		{
			...
			if (!(num4 == -1))
				Global_45393[num4 /*5*/].f_4 = Global_45393[num4 /*5*/].f_4 + iParam2;
		}
	}
	else
	{
		...
		if (num5 == -1)
		{
			...
			if (!(num6 == -1))
				Global_45393[num6 /*5*/].f_4 = Global_45393[num6 /*5*/].f_4 + iParam2;
		}
	
		if (Global_45574 == 0 || Global_45574 <= MISC::GET_GAME_TIMER())
		{
			func_36(num2, num2, 0.3f, func_37(), caParam1, false);
		}
		else
		{
			Global_45574 = Global_45574 + num2;
			func_31(pedParam0, num2);
		}
	}

	Global_45580 = 0.25f;
	TEXT_LABEL_ASSIGN_STRING(&Global_45581, func_30(iParam3), 16);
...
void func_26(int iParam0, int iParam1, int iParam2, Ped pedParam3, int iParam4, int iParam5) // Position - 0x2416
{
	...
	Global_45474[num /*6*/].f_3 = pedParam3;
...
void func_31(Ped pedParam0, int iParam1) // Position - 0x255D
{
	...
	if (num == -1)
	{
		...
		if (!(num2 == -1))
		{
			Global_45362[num2 /*6*/].f_3 = Global_45362[num2 /*6*/].f_3 + iParam1;
			Global_45362[num2 /*6*/].f_2 = Global_45362[num2 /*6*/].f_2 + iParam1;
		}
...
void func_36(int iParam0, int iParam1, float fParam2, float fParam3, Cam caParam4, BOOL bParam5) // Position - 0x2694
{
	...
	if (!CAM::IS_CINEMATIC_CAM_SHAKING())
		CAM::SHAKE_CINEMATIC_CAM("DRUNK_SHAKE", fParam3 * Global_45571);

	if (CAM::DOES_CAM_EXIST(caParam4))
	{
		CAM::SHAKE_CAM(caParam4, "DRUNK_SHAKE", fParam3);
		Global_45573 = caParam4;
	}
	else
	{
		Global_45573 = 0;
	...
	Global_45574 = gameTimer + iParam0;

	if (bParam5)
		if (iParam0 == -1)
			Global_45574 = -1;

	Global_45575 = iParam1;
	Global_45576 = fParam2;
	Global_45578 = fParam3;
	Global_45577 = fParam3;
	return;
}
	...
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
		if (!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false) && !FIRE::IS_ENTITY_ON_FIRE(PLAYER::PLAYER_PED_ID()) && PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID()))
		{
			if (!FIRE::IS_EXPLOSION_IN_SPHERE(-1, vParam0, 2f))
			{
				...
				{
					if (Global_98820 && Global_98821 || func_93())
						return false;
...
void func_103() // Position - 0x4BA4
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (_GET_CHARACTER_MODEL(Global_114370.f_2367.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_104(character) && !func_16(14) || Global_113318)
			{
...
{
	return func_112(iParam0, Global_44392);
}
