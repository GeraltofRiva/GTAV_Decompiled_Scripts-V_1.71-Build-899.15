	...
	while (flag2)
	{
		if (ENTITY::DOES_ENTITY_EXIST(obLocal_149))
		{
			if (bLocal_140)
				if (!func_379(PLAYER::PLAYER_ID()))
					if (!_STOPWATCH_IS_INITIALIZED(&uLocal_143))
						_STOPWATCH_INITIALIZE(&uLocal_143, true, false);
			...
			if (Global_1946293 && func_376(PLAYER::PLAYER_ID()) || func_375(PLAYER::PLAYER_ID()))
			{
				...
				else if (_STOPWATCH_HAS_TIME_PASSED(&uLocal_147, 10000, false))
				{
				...
				if (!flag3 && !Global_33569 && !func_359(0) && !PED::IS_PED_IN_COVER(PLAYER::PLAYER_PED_ID(), false) && !func_358() && ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), vector, vector2, false, true, 1) && INTERIOR::GET_ROOM_KEY_FROM_ENTITY(PLAYER::PLAYER_PED_ID()) == INTERIOR::GET_ROOM_KEY_FROM_ENTITY(obLocal_149) && !IS_BIT_SET(Global_2621446, 15) && !func_357() && !(Global_79768 && func_356()) && !(!Global_79768 && func_355()) && !(Global_79768 && IS_BIT_SET(Global_4718592.f_15, 24) && NETWORK::NETWORK_IS_ACTIVITY_SESSION()) && !(Global_79768 && func_354() && func_353()) && !(Global_79768 && func_352(PLAYER::PLAYER_ID()) == 5) && !NETWORK::NETWORK_IS_IN_MP_CUTSCENE() && !Global_78526 && !func_349() && !func_348() && flag5 && !func_345() && !func_344())
				{
					if (!func_343(Global_1845274[PLAYER::PLAYER_ID() /*877*/].f_260.f_36) && !func_342(Global_1845274[PLAYER::PLAYER_ID() /*877*/].f_260.f_36, -1) && !func_341(PLAYER::PLAYER_ID()))
					{
						if (bLocal_141 != flag4)
						{
							...
							{
								if (iLocal_138 != -1)
									_CONTEXT_REMOVE_HELP_TEXT(&iLocal_138);
					...
					if (iLocal_138 != -1 && func_315(iLocal_138, true) && !TASK::IS_PED_RUNNING(PLAYER::PLAYER_PED_ID()) && func_314())
					{
						...
						if (!flag)
						{
							...
							if (func_313() || func_312() || func_311())
							{
								_STOPWATCH_RESET(&uLocal_145, false, false);
							
								while (!_STOPWATCH_HAS_TIME_PASSED(&uLocal_145, 500, false))
								{
									func_367(0);
									SYSTEM::WAIT(0);
								}
	...
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2658019[plParam0 /*467*/].f_324.f_8 != -1)
				return func_12(Global_2658019[plParam0 /*467*/].f_324.f_8) == 13;
...
BOOL _NETWORK_IS_PLAYER_VALID(Player player, BOOL bIsPlaying, BOOL bUnk) // Position - 0x10AF
{
	Player player;
...
Player _INVALID_PLAYER_INDEX() // Position - 0x110F
{
	return -1;
}

BOOL _SHOULD_NETWORK_SCRIPT_TERMINATE() // Position - 0x1118
{
	if (Global_1575060 == 0)
		if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
			return true;
...
Hash _GET_CURRENT_SESSION_TYPE_SCRIPT_HASH() // Position - 0x119C
{
	switch (func_18())
	{
		case 0:
...
int func_18() // Position - 0x11F3
{
	return Global_33298;
}

BOOL func_19() // Position - 0x11FE
{
	return Global_2684748.f_700;
}

BOOL _DOES_EVENT_OF_TYPE_EXIST(int iParam0) // Position - 0x120D
{
...
BOOL func_21() // Position - 0x1224
{
	return Global_2696555;
}

BOOL func_22() // Position - 0x1230
{
	return Global_2684748.f_695;
}

BOOL func_23() // Position - 0x123F
{
	return Global_76855;
}

void _STOPWATCH_RESET(var pStopwatch, BOOL useLocalTimer, BOOL useAccurateTime) // Position - 0x124B
{
...
BOOL func_27() // Position - 0x12D7
{
	return Global_2684748.f_693;
}

BOOL _IS_FMMC_ACTIVE() // Position - 0x12E6
{
	return Global_1845274[PLAYER::PLAYER_ID() /*877*/].f_185 != 0;
}

void func_29() // Position - 0x12FD
{
	Global_2684748.f_758 = 1;
	return;
}

BOOL func_30() // Position - 0x130D
{
	return Global_2684748.f_737;
}

BOOL func_31() // Position - 0x131C
{
	return IS_BIT_SET(Global_2684748.f_2, 11);
}

void func_32(int iParam0, int iParam1) // Position - 0x132D
{
	BOOL flag;
	BOOL flag2;
	BOOL flag3;
...
void func_33(int iParam0, BOOL bParam1) // Position - 0x150D
{
...
void func_34(BOOL bParam0, int iParam1, int iParam2) // Position - 0x155C
{
	var unk;
...
int _SEND_TEXT_MESSAGE_FROM_CHARACTER_2(eCharacter echParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, BOOL bParam7, int iParam8, int iParam9) // Position - 0x15F8
{
	int num;
	char* str;
	int num2;
...
struct<4> _GET_CHARACTER_NAME(eCharacter character) // Position - 0x1687
{
	return Global_2241[character /*29*/].f_3;
}

int func_37(eCharacter echParam0, char* sParam1, int iParam2, int iParam3, char* sParam4, char* sParam5, int iParam6, int iParam7, int iParam8, int iParam9, BOOL bParam10, int iParam11, int iParam12, int iParam13, char* sParam14, char* sParam15, int iParam16) // Position - 0x169A
{
	int num;
	int num2;
	...
	if (!Global_21462 && !IS_BIT_SET(Global_9077, 9))
	{
		if (Global_21239.f_1 == 6)
		{
			...
			func_43(1);
			func_47(Global_21220, "DISPLAY_VIEW", 1f, SYSTEM::TO_FLOAT(Global_21219), -1082130432, -1082130432, -1082130432);
		}
	}
...
void func_38(eCharacter echParam0, char* sParam1, BOOL bParam2, var uParam3) // Position - 0x1B7D
{
...
BOOL func_40(Player plParam0) // Position - 0x1C7B
{
	return func_41(plParam0, 20);
}

BOOL func_41(Player plParam0, int iParam1) // Position - 0x1C8B
{
	return IS_BIT_SET(Global_1888882[plParam0 /*611*/].f_10.f_4, iParam1);
}

var func_42(Player plParam0) // Position - 0x1CA3
{
	return Global_1845274[plParam0 /*877*/].f_198.f_6;
}

void func_43(int iParam0) // Position - 0x1CB8
{
	int i;
	int num;
	int value;
				...
				if (iParam0 == Global_9082[num /*15*/].f_11)
				{
					if (i == Global_9082[num /*15*/].f_4)
					{
						if (Global_9676[i] == 0)
						{
							...
							if (Global_2696550)
								if (num == 14)
									func_44(Global_21220, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(i), SYSTEM::TO_FLOAT(Global_9082[num /*15*/].f_10), SYSTEM::TO_FLOAT(Global_23665), -1f, &Global_9082[num /*15*/], 0, 0, 0, 0);
					...
					if (i == Global_9082[num /*15*/].f_4)
					{
						if (Global_9676[i] == 0)
						{
							...
							if (num == 1)
							{
								...
								func_44(Global_21220, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(i), SYSTEM::TO_FLOAT(Global_9082[num /*15*/].f_10), SYSTEM::TO_FLOAT(Global_23671), -1f, &Global_9082[num /*15*/], 0, 0, 0, 0);
							}
							else if (num == 7)
							{
								if (Global_79768)
								{
									...
									func_44(Global_21220, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(i), SYSTEM::TO_FLOAT(Global_9082[num /*15*/].f_10), SYSTEM::TO_FLOAT(value2), -1f, &Global_9082[num /*15*/], 0, 0, 0, 0);
								}
								else
								{
									switch (Global_21239)
									...
									func_44(Global_21220, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(i), SYSTEM::TO_FLOAT(Global_9082[num /*15*/].f_10), SYSTEM::TO_FLOAT(value3), -1f, &Global_9082[num /*15*/], 0, 0, 0, 0);
								}
							}
							else if (num == 14)
							{
							...
							else if (Global_9082[num /*15*/].f_10 == 57 && num == 25)
							{
								...
								func_44(Global_21220, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(i), SYSTEM::TO_FLOAT(Global_9082[num /*15*/].f_10), SYSTEM::TO_FLOAT(value6), -1f, &Global_9082[num /*15*/], 0, 0, 0, 0);
							}
							else
							{
								func_44(Global_21220, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(i), SYSTEM::TO_FLOAT(Global_9082[num /*15*/].f_10), SYSTEM::TO_FLOAT(0), -1f, &Global_9082[num /*15*/], 0, 0, 0, 0);
							}
...
void func_44(int iParam0, char* sParam1, float fParam2, float fParam3, float fParam4, float fParam5, float fParam6, const char* sParam7, const char* sParam8, const char* sParam9, const char* sParam10, const char* sParam11) // Position - 0x223F
{
...
void func_45(const char* sParam0) // Position - 0x22F2
{
...
void func_47(int iParam0, char* sParam1, float fParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x2327
{
	GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iParam0, sParam1);
	GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(SYSTEM::ROUND(fParam2));
...
BOOL func_48() // Position - 0x238A
{
	return Global_1575088;
}

void func_49(int iParam0) // Position - 0x2396
{
	var unk;
	var unk2;
...
void func_50(int iParam0) // Position - 0x23B5
{
	int clockSeconds;
	int clockMinutes;
	int clockHours;
...
BOOL func_52(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, int iParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11) // Position - 0x2512
{
	int num;
	int num2;
	int num3;
...
void _UPDATE_CURRENT_PLAYER_CHARACTER() // Position - 0x2765
{
	if (func_381(14))
	{
		if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), false))
...
eCharacter _GET_CURRENT_PLAYER_CHARACTER() // Position - 0x2807
{
	func_56();
	return Global_114370.f_2367.f_539.f_4321;
}

void func_56() // Position - 0x2820
{
	eCharacter character;
...
BOOL func_57(eCharacter echParam0) // Position - 0x291D
{
	return echParam0 < CHAR_MULTIPLAYER;
}

eCharacter _GET_PLAYER_CHARACTER_FROM_PED(Ped pedParam0) // Position - 0x2929
{
	eCharacter i;
	Hash entityModel;
...
Hash _GET_CHARACTER_MODEL(eCharacter character) // Position - 0x2966
{
...
Hash func_60(eCharacter echParam0) // Position - 0x298B
{
	return Global_2241[echParam0 /*29*/];
}

void func_61() // Position - 0x299A
{
...
int _THEFEED_SHOW_MESSAGE(char* sParam0, BOOL bParam1) // Position - 0x29DE
{
	int num;
	int num2;
...
void func_63(int iParam0, char* sParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, char* sParam9, char* sParam10, char* sParam11) // Position - 0x2A16
{
	int num;
...
int func_64(int iParam0) // Position - 0x2B1E
{
	int i;
...
void func_65(int iParam0) // Position - 0x2B80
{
	int i;
...
BOOL func_66(Player plParam0, int iParam1) // Position - 0x2BB9
{
	BOOL flag;
...
int func_67(int iParam0, BOOL bParam1) // Position - 0x2C12
{
	int num;
	int num2;
...
int func_68() // Position - 0x2C53
{
	return Global_1574927;
}

BOOL func_69(Player plParam0) // Position - 0x2C5F
{
	Player player;
...
BOOL IS_ROCKSTAR_DEV() // Position - 0x2C81
{
	return DLC::IS_DLC_PRESENT(-1762644250);
}

BOOL func_71() // Position - 0x2C92
{
	return func_72(PLAYER::PLAYER_ID());
}

BOOL func_72(Player plParam0) // Position - 0x2CA2
{
	return func_73(plParam0, 1);
}

BOOL func_73(Player plParam0, int iParam1) // Position - 0x2CB1
{
	if (func_69(plParam0))
		if (func_69(Global_1888882[plParam0 /*611*/].f_10))
...
BOOL func_74(Player plParam0) // Position - 0x2D00
{
	if (plParam0 == _INVALID_PLAYER_INDEX())
		return false;
...
BOOL func_75(Player plParam0) // Position - 0x2D68
{
	Player player;
...
BOOL func_77(Player plParam0) // Position - 0x2DB7
{
	int num;
...
int func_78(Player plParam0, Player plParam1, BOOL bParam2) // Position - 0x2E14
{
	var unk;
	...
	else if (func_305(plParam0, true))
	{
		return 0;
	}
...
BOOL IS_GAMER_HANDLE_VALID(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12) // Position - 0x2F48
{
	return NETWORK::NETWORK_IS_HANDLE_VALID(&uParam0, 13);
}

struct<13> GET_GAMER_HANDLE_PLAYER(Player plParam0) // Position - 0x2F58
{
	var gamerHandle;
...
BOOL func_81(Player plParam0) // Position - 0x2F6F
{
	if (func_89(plParam0))
		return true;
...
BOOL func_82(Player plParam0) // Position - 0x2F92
{
...
BOOL func_83(Player plParam0, int iParam1, int iParam2) // Position - 0x2FAC
{
	Player player;
...
int func_84(Player plParam0) // Position - 0x2FEA
{
...
BOOL func_85(Player plParam0, BOOL bParam1) // Position - 0x300D
{
	if (func_69(plParam0))
...
Player func_86(Player plParam0) // Position - 0x3051
{
	return Global_1888882[plParam0 /*611*/].f_10.f_35;
}

int func_87(Player plParam0) // Position - 0x3066
{
...
BOOL func_88(Player plParam0, BOOL bParam1) // Position - 0x3089
{
	if (func_69(plParam0))
...
BOOL func_89(Player plParam0) // Position - 0x30CD
{
...
int func_90(Player plParam0) // Position - 0x30E6
{
	if (func_69(plParam0))
		if (func_85(plParam0, false))
...
BOOL func_91(Player plParam0) // Position - 0x3112
{
	return func_92(func_93(plParam0));
}

BOOL func_92(int iParam0) // Position - 0x3124
{
	return iParam0 > 0 && iParam0 < 6;
}

int func_93(Player plParam0) // Position - 0x3139
{
...
BOOL func_95() // Position - 0x318C
{
	return IS_BIT_SET(Global_2621446, 3);
}

BOOL func_96(Player plParam0) // Position - 0x319A
{
	Player player;
...
BOOL func_97(Player plParam0, BOOL bParam1) // Position - 0x31BD
{
	return func_98(plParam0, bParam1, 1);
}

int func_98(Player plParam0, BOOL bParam1, int iParam2) // Position - 0x31CE
{
	Player player;
	...
	if (func_69(player) && Global_1888882[player /*611*/].f_10.f_431 == iParam2)
		return 1;

	return 0;
}

BOOL func_99(Player plParam0, Player plParam1, BOOL bParam2) // Position - 0x322A
{
	if (func_69(plParam1))
	{
		if (!bParam2)
...
BOOL func_100(Player plParam0, Player plParam1) // Position - 0x3274
{
...
BOOL func_101(Player plParam0) // Position - 0x32B9
{
	return func_41(plParam0, 30);
}

BOOL func_102(Player plParam0) // Position - 0x32C9
{
...
int func_103(Player plParam0) // Position - 0x32FD
{
	return Global_1888882[plParam0 /*611*/].f_10.f_23;
}

BOOL func_104(Player plParam0, int iParam1) // Position - 0x3312
{
	return IS_BIT_SET(Global_1888882[plParam0 /*611*/].f_10.f_5, iParam1);
}

BOOL func_105(BOOL bParam0) // Position - 0x332A
{
	return func_97(PLAYER::PLAYER_ID(), bParam0);
}

BOOL func_106() // Position - 0x333C
{
	int i;
	var string2;
	var string1;
...
struct<16> func_107(int iParam0) // Position - 0x3396
{
	return Global_2685690.f_3081.f_18[iParam0 /*16*/];
}

int func_108(int iParam0) // Position - 0x33AE
{
	switch (iParam0)
	{
		case 0:
...
void func_109(Hash hParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, int iParam15) // Position - 0x3404
{
	hParam0 = -642704387;
...
int _GET_LOBBY_SCRIPT_EVENT_BITS(BOOL includeLocalPlayer, BOOL includeSpectators) // Position - 0x3433
{
	int address;
	int i;
	Player player;
...
BOOL func_111(Player plParam0) // Position - 0x3498
{
	if (!func_69(plParam0))
		return false;
...
void func_112(int iParam0) // Position - 0x34BF
{
	int num;
	int offset;
...
BOOL IS_PLAYSTATION_PLATFORM() // Position - 0x3625
{
	return MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION();
}

BOOL IS_XBOX_PLATFORM() // Position - 0x363B
{
	return MISC::IS_DURANGO_VERSION() || MISC::IS_SCARLETT_VERSION();
}

void func_119(const char* sParam0, int iParam1, BOOL bParam2) // Position - 0x3651
{
	if (bParam2)
	{
...
void func_120(const char* sParam0, BOOL bParam1) // Position - 0x3721
{
	var unk;
...
void func_121(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, int iParam17) // Position - 0x37EC
{
	BOOL flag;
	int num;
	int num2;
...
int func_122(Player plParam0) // Position - 0x3856
{
	if (plParam0 == _INVALID_PLAYER_INDEX())
		return -1;
...
int func_123(Player plParam0) // Position - 0x387B
{
	if (plParam0 == _INVALID_PLAYER_INDEX())
		return -1;
...
Player _GET_BOSS_OF_LOCAL_PLAYER() // Position - 0x38A0
{
	return Global_1888882[PLAYER::PLAYER_ID() /*611*/].f_10;
}

BOOL func_125(BOOL bParam0) // Position - 0x38B5
{
	return func_305(PLAYER::PLAYER_ID(), bParam0);
}

void func_126(const char* sParam0, BOOL bParam1) // Position - 0x38C7
{
	var unk;
...
void func_127(int iParam0, const char* sParam1) // Position - 0x3963
{
	Global_1985671[iParam0] = MISC::GET_HASH_KEY(sParam1);
	return;
}

void func_128(int iParam0, int iParam1, const char* sParam2, int iParam3, BOOL bParam4) // Position - 0x3979
{
	Hash statName;
	Hash statName2;
	var value;
...
Hash func_129(int iParam0, int iParam1) // Position - 0x3A0C
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(3, iParam0, func_130(iParam1));
}

int func_130(int iParam0) // Position - 0x3A21
{
	int num;
	int num2;
...
const char* func_131(Player plParam0, BOOL bParam1) // Position - 0x3A55
{
	if (!bParam1)
		if (func_97(plParam0, true))
			return func_132();
...
const char* func_132() // Position - 0x3A7C
{
	return HUD::GET_FILENAME_FOR_AUDIO_CONVERSATION("GB_REST_ACCM" /*Motorcycle Club*/);
}

struct<16> func_133(int iParam0, int iParam1, int iParam2) // Position - 0x3A8C
{
	Hash statHash;
	Hash statHash2;
	var unk;
...
BOOL func_134(int iParam0) // Position - 0x3AC9
{
	int num;
...
BOOL func_135(int iParam0, int iParam1) // Position - 0x3AE0
{
	Hash statHash;
	int outValue;
...
Hash func_136(int iParam0, int iParam1) // Position - 0x3B0F
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(0, iParam0, func_130(iParam1));
}

BOOL func_137(BOOL bParam0) // Position - 0x3B24
{
	if (bParam0)
		return func_139();
...
Hash func_142(int iParam0, int iParam1) // Position - 0x3BB6
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(2, iParam0, func_130(iParam1));
}

void func_143() // Position - 0x3BCB
{
	int i;
...
void func_144(var uParam0, int iParam1) // Position - 0x3C16
{
	func_145(uParam0, iParam1);
	return;
}

void func_145(var uParam0, int iParam1) // Position - 0x3C26
{
	*uParam0 = *uParam0 || iParam1;
	return;
}

BOOL func_146(int iParam0) // Position - 0x3C37
{
	return Global_2672967.f_2590[0 /*80*/].f_1 == iParam0;
}

void func_147(BOOL bParam0, BOOL bParam1, int iParam2, int iParam3) // Position - 0x3C4E
{
	var userID;
	int cloudTimeAsInt;
	int num;
...
void func_148(int iParam0, BOOL bParam1) // Position - 0x3F44
{
	BOOL flag;
	int num;
...
void func_149(var uParam0) // Position - 0x3FD4
{
...
BOOL func_150(var uParam0) // Position - 0x40BA
{
	var unk;
	BOOL flag;
...
BOOL func_151(var uParam0, var uParam1, var uParam2) // Position - 0x412A
{
	int num;
...
int func_152(int iParam0, int iParam1, int iParam2) // Position - 0x4152
{
	switch (iParam0)
	{
		case 18:
...
BOOL func_153(var uParam0, int iParam1, int iParam2, var uParam3) // Position - 0x426B
{
	int num;
	int i;
...
void func_154(int iParam0, int iParam1, var uParam2, var uParam3) // Position - 0x42BD
{
	int i;
	int j;
...
void func_155(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7) // Position - 0x5537
{
	int i;
...
int func_158(int iParam0) // Position - 0x57D9
{
	switch (iParam0)
	{
		case 0:
...
void func_159(int iParam0, int iParam1) // Position - 0x5827
{
	int num;
	BOOL address;
	int offset;
...
void func_160(int iParam0, int iParam1) // Position - 0x5878
{
	int num;
	int offset;
...
int func_161(int iParam0) // Position - 0x5933
{
	return func_162(iParam0) / 8;
}

int func_162(int iParam0) // Position - 0x5944
{
	switch (iParam0)
	{
		case 2:
...
void func_163(int iParam0, int iParam1) // Position - 0x5AC2
{
	var entityCoords;
	int num;
	Hash hash;
...
Hash func_164(int iParam0) // Position - 0x5B15
{
	var unk;
...
char* AUDIO_SPEECH_GET_PARAM_STRING_FROM_ENUM(int iParam0) // Position - 0x5B35
{
	switch (iParam0)
	{
		case 0:
...
Hash func_166(int iParam0) // Position - 0x5D02
{
	switch (iParam0)
	{
		case 0:
...
Hash func_167() // Position - 0x5D6E
{
	return MISC::GET_HASH_KEY("PROGRESS_HUB_TIER_COMPLETED");
}

int func_168() // Position - 0x5D7E
{
	if (Global_1668418 == 0)
		func_169();
...
int func_170(int iParam0, int iParam1) // Position - 0x5DC5
{
	if (iParam1 == 4)
		iParam1 = 3;
...
int func_171(int iParam0) // Position - 0x5DE1
{
	return func_162(iParam0) % 8;
}

int func_172(int iParam0) // Position - 0x5DF2
{
	int num;
...
BOOL func_173(int iParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Position - 0x5E08
{
	BOOL flag;
	int num;
	int num2;
...
BOOL func_174(int iParam0, int iParam1) // Position - 0x5EA5
{
	BOOL flag;
	BOOL flag2;

	flag = func_175(iParam0, iParam1);
	flag2 = func_193(iParam0, iParam1);
	return flag2 >= flag;
}

BOOL func_175(int iParam0, int iParam1) // Position - 0x5EC6
{
	int i;
...
int func_176(int iParam0, int iParam1) // Position - 0x7013
{
	if (func_177(iParam0))
	{
		switch (iParam1)
...
BOOL func_177(int iParam0) // Position - 0x7086
{
	int num;
...
int func_178(int iParam0) // Position - 0x70AE
{
	switch (iParam0)
	{
		case 26:
...
int func_179(int iParam0, int iParam1, int iParam2) // Position - 0x71B4
{
	int num;
	int i;
	int num2;
...
int func_180(int iParam0) // Position - 0x7220
{
	if (func_177(iParam0))
		return 13;
...
void func_181(int iParam0) // Position - 0x723B
{
	int num;
	int num2;
	int offset;
...
int func_182(int iParam0) // Position - 0x7279
{
	return iParam0 % 32;
}

int func_183(int iParam0) // Position - 0x7286
{
	return iParam0 / 32;
}

int func_184(int iParam0) // Position - 0x7293
{
	switch (iParam0)
	{
		case 16:
...
void func_185(var uParam0) // Position - 0x8314
{
	int num;
	int num2;
	int num3;
...
int func_186(int iParam0) // Position - 0x8350
{
	switch (iParam0)
	{
		case 2:
...
void func_187(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7) // Position - 0x8EDB
{
	var entityCoords;
	int num;
	Hash hash;
...
Hash func_188(int iParam0, var uParam1, int iParam2) // Position - 0x8F44
{
	var unk;
...
char* func_189(int iParam0) // Position - 0x9244
{
	var unk;
...
char* func_190(var uParam0) // Position - 0x925F
{
	return uParam0;
}

char* func_191(int iParam0) // Position - 0x9269
{
	switch (iParam0)
	{
		case 0:
...
Hash func_192(BOOL bParam0) // Position - 0x92BD
{
	if (bParam0)
...
BOOL func_193(int iParam0, int iParam1) // Position - 0x92E0
{
	int i;
	BOOL flag;
	BOOL flag2;
	...
	switch (iParam0)
	{
		case 9:
			switch (iParam1)
			{
				...
				case 77:
					flag = func_135(13040, -1);
					break;
			
				case 78:
					flag2 = func_135(13036, -1);
		...
		case 10:
			switch (iParam1)
			{
				...
				case 92:
					...
					{
						flag = flag + func_208(_STAT_GET_PACKED_BOOL(9547, -1));
						flag = flag + func_208(_STAT_GET_PACKED_BOOL(9548, -1));
		...
		case 31:
			switch (iParam1)
			{
				...
				case 340:
					flag = func_203(40, -1) + func_203(41, -1);
					break;
		...
		case 33:
			switch (iParam1)
			{
				...
				case 365:
					flag = func_205(func_135(11964, -1));
					break;
		...
		case 24:
			switch (iParam1)
			{
				case 267:
					...
					if (func_205(flag2) > true || IS_BIT_SET(flag2, 1))
						flag = true;
					break;
		...
		case 30:
			switch (iParam1)
			{
				...
				case 334:
					flag = flag + func_205(func_135(11929, -1));
					flag = flag + func_205(func_135(11966, -1));
					flag = flag + func_205(func_135(11967, -1));
					flag = flag + func_205(func_135(11968, -1));
					break;
...
BOOL func_194(int iParam0, int iParam1) // Position - 0xEB6C
{
	Hash statHash;
	BOOL outValue;
...
Hash func_195(int iParam0, int iParam1) // Position - 0xEB90
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(10, iParam0, func_130(iParam1));
}

BOOL func_196() // Position - 0xEBA6
{
	int num;
	BOOL flag;
...
void func_197(int iParam0, BOOL bParam1, int iParam2) // Position - 0xEBED
{
	if (iParam2 == -1)
		iParam2 = func_68();
...
int func_200(int iParam0) // Position - 0xED84
{
	iParam0 = iParam0 / 32;
...
Hash func_201(int iParam0) // Position - 0xEDF7
{
	switch (iParam0)
	{
		case 34:
...
var func_202(BOOL bParam0, var uParam1, var uParam2) // Position - 0xF438
{
	if (bParam0)
		return uParam1;
...
BOOL func_203(int iParam0, int iParam1) // Position - 0xF44F
{
	Hash statHash;
	int outValue;
...
Hash func_204(int iParam0, int iParam1) // Position - 0xF473
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(8, iParam0, func_130(iParam1));
}

BOOL func_205(BOOL bParam0) // Position - 0xF489
{
	int num;
	BOOL flag;
...
void func_206(var uParam0, int iParam1) // Position - 0xF4C9
{
	*uParam0 = *uParam0 - *uParam0 && iParam1;
	return;
}

BOOL func_207() // Position - 0xF4DE
{
	int num;
	int num2;
...
int func_208(BOOL bParam0) // Position - 0xF723
{
	if (bParam0)
		return 1;
...
int _STAT_GET_PACKED_INT(int iParam0, int iParam1) // Position - 0xF735
{
	if (iParam1 == -1)
		iParam1 = func_68();
...
BOOL func_210(int iParam0, var uParam1) // Position - 0xF751
{
	int i;
...
int func_211(int iParam0, int iParam1, int iParam2) // Position - 0xF7C9
{
	switch (iParam1)
	{
		case 9:
...
int func_212(int iParam0) // Position - 0x11907
{
	int num;
	int num2;
	int num3;
...
BOOL func_213(int iParam0, BOOL bParam1) // Position - 0x1194D
{
	if (iParam0 == -1)
		return false;
...
int func_214(int iParam0) // Position - 0x11969
{
	switch (iParam0)
	{
		case 54653:
...
void _STAT_SET_PACKED_BOOL(int iParam0, BOOL bParam1, int iParam2) // Position - 0x12978
{
	if (iParam2 == -1)
		iParam2 = func_68();
...
BOOL _STAT_GET_PACKED_BOOL(int iParam0, int iParam1) // Position - 0x12996
{
	if (iParam1 == -1)
		iParam1 = func_68();
...
void func_219(eCharacter echParam0, eCharacter echParam1, BOOL bParam2) // Position - 0x129EA
{
	int num;
...
void func_220() // Position - 0x12B68
{
	var txdName;
	var subject;
...
int func_221(eCharacter echParam0, int iParam1) // Position - 0x12BE3
{
...
int func_222(eCharacter echParam0, int iParam1) // Position - 0x12C0D
{
	if (iParam1 < 0 || iParam1 > 4)
		return 0;
...
void func_223(eCharacter echParam0, int iParam1, int iParam2) // Position - 0x12C37
{
	if (iParam1 < 0 || iParam1 > 4)
		return;
...
void func_224(eCharacter echParam0, int iParam1, int iParam2) // Position - 0x12C7C
{
	if (iParam1 < 0 || iParam1 > 4)
		return;
...
BOOL func_225(int iParam0, int iParam1) // Position - 0x12CC1
{
...
void func_226() // Position - 0x12CDD
{
	BOOL flag;
...
void func_227() // Position - 0x12D73
{
	Global_1048576.f_10 = 0;
	return;
}

void func_228() // Position - 0x12D82
{
	var unk;
	var unk2;
	var unk3;
...
void func_229() // Position - 0x130B9
{
	MISC::SET_BIT(&(Global_2684748.f_2), 12);
	return;
}

void func_230() // Position - 0x130CD
{
	Global_1057440 = -1;
	return;
}

BOOL func_231() // Position - 0x130DA
{
	switch (func_232())
	{
		case 21:
...
int func_232() // Position - 0x131B1
{
	return Global_1057440;
}

void func_233(BOOL bParam0) // Position - 0x131BD
{
	BOOL flag;
...
void func_234(int iParam0) // Position - 0x13250
{
	Global_2684748.f_894 = iParam0;
	return;
}

void func_235(int iParam0) // Position - 0x13261
{
	if (iParam0 == -1)
...
void func_236() // Position - 0x1328B
{
	Global_2684748.f_9 = -1;
	return;
}

BOOL func_237() // Position - 0x1329A
{
	return Global_2684748.f_739;
}

void func_238() // Position - 0x132A9
{
	Global_2684748.f_42 = func_239();
	return;
}

int func_239() // Position - 0x132BB
{
	if (Global_2692869)
		return 32;
...
void func_240() // Position - 0x132D6
{
	Global_2684748.f_737 = 0;
	return;
}

void func_241() // Position - 0x132E6
{
	Global_2684748.f_719 = 0;
	return;
}

void func_242() // Position - 0x132F6
{
	MISC::CLEAR_BIT(&(Global_1845274[PLAYER::PLAYER_ID() /*877*/].f_36.f_18), 15);
	return;
}

void func_243() // Position - 0x13313
{
...
void func_244() // Position - 0x13329
{
	MISC::SET_BIT(&(Global_2684748.f_3), 2);
	return;
}

void func_245() // Position - 0x1333C
{
	MISC::CLEAR_BIT(&Global_2684748, 7);
	return;
}

void func_246() // Position - 0x1334D
{
	MISC::CLEAR_BIT(&Global_2684748, 6);
	return;
}

void func_247() // Position - 0x1335E
{
	Global_2684748 = 0;
...
void func_248(BOOL bParam0) // Position - 0x13379
{
	int i;
	var unk;
	int j;
...
void func_249() // Position - 0x13475
{
	Global_2680869.f_32 = 0;
	return;
}

void func_250() // Position - 0x13484
{
	var unk;
	int i;
...
BOOL func_256() // Position - 0x13581
{
	return IS_BIT_SET(Global_2684748, 1);
}

BOOL func_257() // Position - 0x1358F
{
	return IS_BIT_SET(Global_2684748, 2);
}

BOOL func_258() // Position - 0x1359D
{
	return IS_BIT_SET(Global_2684748, 20);
}

BOOL func_259() // Position - 0x135AC
{
	return IS_BIT_SET(Global_2685690.f_1.f_2810, 3);
}

void func_260() // Position - 0x135BF
{
...
void func_261() // Position - 0x135E0
{
	var unk;
...
void func_262() // Position - 0x13634
{
	var unk;
...
void func_263(int iParam0, BOOL bParam1, int iParam2, BOOL bParam3) // Position - 0x13688
{
	Hash statName;
...
void func_264(int iParam0) // Position - 0x136B6
{
...
void func_265() // Position - 0x136E0
{
	int i;
...
BOOL func_266() // Position - 0x13741
{
	return Global_2684748.f_742;
}

void func_267(int iParam0) // Position - 0x13750
{
	int num;
	int offset;
...
BOOL func_268(int iParam0) // Position - 0x13779
{
	int num;
	int num2;
...
void func_269(int iParam0, int iParam1, BOOL bParam2) // Position - 0x1379F
{
	if (func_276())
	{
		if (iParam1 == 1)
...
BOOL func_270(Player plParam0) // Position - 0x13869
{
...
BOOL func_271(Player plParam0, BOOL bParam1, BOOL bParam2) // Position - 0x1388E
{
	if (bParam1)
...
BOOL func_272(Player plParam0) // Position - 0x138C0
{
	return func_273(plParam0);
}

BOOL func_273(Player plParam0) // Position - 0x138CE
{
	return IS_BIT_SET(Global_1845274[plParam0 /*877*/].f_11.f_1, 0);
}

BOOL func_274() // Position - 0x138E5
{
	return Global_2684748.f_846;
}

void func_275(BOOL bParam0) // Position - 0x138F4
{
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		if (!func_276())
...
BOOL func_276() // Position - 0x139ED
{
	return Global_1574582;
}

void func_277() // Position - 0x139F9
{
	int i;
	Player player;
...
void func_278(Player plParam0) // Position - 0x13A3B
{
	Ped playerPed;
...
void func_279(BOOL bParam0, Player plParam1) // Position - 0x13A9D
{
		...
		if (ENTITY::DOES_ENTITY_EXIST(playerPed) && !ENTITY::IS_ENTITY_DEAD(playerPed, false))
		{
			if (PED::IS_PED_IN_ANY_VEHICLE(playerPed, false))
			{
				...
				if (ENTITY::DOES_ENTITY_EXIST(vehiclePedIsIn) && ENTITY::IS_ENTITY_A_VEHICLE(vehiclePedIsIn) && !ENTITY::IS_ENTITY_DEAD(vehiclePedIsIn, false))
				{
					...
					if (func_99(plParam1, _GET_BOSS_OF_LOCAL_PLAYER(), true))
					{
						...
						{
							num = func_280(_GET_BOSS_OF_LOCAL_PLAYER(), plParam1);
			...
			else if (!bParam0)
			{
				if (func_99(plParam1, _GET_BOSS_OF_LOCAL_PLAYER(), true))
				{
					...
					{
						num2 = func_280(_GET_BOSS_OF_LOCAL_PLAYER(), plParam1);
...
int func_280(Player plParam0, Player plParam1) // Position - 0x13C3E
{
	int i;

	if (func_362(plParam0))
	{
		if (func_99(plParam1, plParam0, false) || func_282(plParam1, plParam0))
		{
			for (i = 0; i < 7; i = i + 1)
			{
				if (func_281(plParam0, i) == plParam1)
					return i;
			}
		}
	}
...
Player func_281(Player plParam0, int iParam1) // Position - 0x13C94
{
	if (func_362(plParam0))
...
BOOL func_282(Player plParam0, Player plParam1) // Position - 0x13CD0
{
	if (plParam1 != _INVALID_PLAYER_INDEX())
...
void func_283(int iParam0) // Position - 0x13D09
{
	if (!func_296())
		return;
...
int func_284(Player plParam0) // Position - 0x13D51
{
...
int func_285(Player plParam0) // Position - 0x13D72
{
	return Global_1888882[plParam0 /*611*/].f_10.f_1;
}

void func_286() // Position - 0x13D87
{
...
void func_287(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15) // Position - 0x13DB8
{
	Global_2685690.f_3081.f_2 = { uParam0 };
	return;
}

void func_288(var uParam0, var uParam1) // Position - 0x13DD1
{
...
void func_289(BOOL bParam0) // Position - 0x13E01
{
	func_290(204, bParam0, -1, true);
	return;
}

void func_290(int iParam0, BOOL bParam1, int iParam2, BOOL bParam3) // Position - 0x13E13
{
	Hash statName;
...
void func_291(BOOL bParam0) // Position - 0x13E36
{
	if (bParam0)
	{
		if (func_293(4))
...
void func_292(BOOL bParam0) // Position - 0x13E9E
{
	func_290(432, bParam0, -1, true);
	return;
}

BOOL func_293(int iParam0) // Position - 0x13EB1
{
	return IS_BIT_SET(Global_2740191.f_5272.f_51, iParam0);
}

struct<16> func_294(int iParam0) // Position - 0x13EC5
{
	var unk;
...
const char* func_295(int iParam0) // Position - 0x13F08
{
	switch (iParam0)
	{
		case 1:
...
BOOL func_296() // Position - 0x13F2C
{
...
var func_297(int iParam0) // Position - 0x13F4A
{
	return Global_1574538[iParam0];
}

var func_298() // Position - 0x13F5A
{
	return func_297(func_68() + 1);
}

BOOL func_299(Player plParam0) // Position - 0x13F6C
{
	return func_300(plParam0) > 0;
}

int func_300(Player plParam0) // Position - 0x13F7C
{
	int num;
	int num2;
...
var func_301() // Position - 0x13FD1
{
	return Global_262145.f_15362;
}

int _MPPLY_STAT_GET_INT(Hash hParam0) // Position - 0x13FE0
{
	Hash statHash;
	int outValue;
...
int func_303() // Position - 0x13FFE
{
	return Global_262145.f_12825;
}

int func_304() // Position - 0x1400F
{
	int i;
	int num;
	Player player;
...
BOOL func_305(Player plParam0, BOOL bParam1) // Position - 0x1404C
{
	if (!func_69(plParam0))
		return false;
	...
	return func_69(Global_1888882[plParam0 /*611*/].f_10);
}

void func_306() // Position - 0x14084
{
	var unk;
	...
	if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
		...
		if (func_10(0, &unk))
		{
			while (!flag)
			{
				...
				else if (_STOPWATCH_HAS_TIME_PASSED(&uLocal_145, 4000, false))
					flag = true;
...
void func_307(Object obParam0) // Position - 0x141D5
{
	var animDict;
	var animDict2;
	var animDict3;
...
BOOL func_308(Ped pedParam0, eScriptTaskHash esthParam1) // Position - 0x1471F
{
...
BOOL func_309(Ped pedParam0) // Position - 0x14752
{
...
BOOL func_310(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, BOOL bParam7) // Position - 0x14772
{
	if (fParam6 < 0f)
		fParam6 = 0f;
...
BOOL func_311() // Position - 0x147ED
{
...
BOOL func_312() // Position - 0x14813
{
...
BOOL func_313() // Position - 0x1484A
{
...
BOOL func_314() // Position - 0x14881
{
...
BOOL func_315(int iParam0, BOOL bParam1) // Position - 0x148D0
{
	int num;
...
int func_316(int iParam0) // Position - 0x14988
{
	int i;
...
void func_317(BOOL bParam0) // Position - 0x149C3
{
...
BOOL func_318() // Position - 0x14A03
{
	return Global_1946439.f_760;
}

void func_319(BOOL bParam0) // Position - 0x14A12
{
	if (func_341(PLAYER::PLAYER_ID()) && func_327(PLAYER::PLAYER_ID()) == func_326(PLAYER::PLAYER_ID()) && !NETWORK::NETWORK_IS_PLAYER_IN_MP_CUTSCENE(PLAYER::PLAYER_ID()) && !func_318() && !Global_1946293)
	{
		...
		else if (_STOPWATCH_IS_INITIALIZED(&uLocal_143) && _STOPWATCH_HAS_TIME_PASSED(&uLocal_143, 10000, true) || !bLocal_140)
		{
...
BOOL func_320(Player plParam0) // Position - 0x14B87
{
	return func_321(func_90(plParam0));
}

BOOL func_321(int iParam0) // Position - 0x14B99
{
	switch (iParam0)
	{
		case 178:
...
void func_322(char* sParam0) // Position - 0x14BB9
{
...
BOOL func_323() // Position - 0x14BCF
{
	if (Global_1946298)
		return false;
...
BOOL func_324() // Position - 0x14BE6
{
	if (func_325())
		return 1;
...
BOOL func_325() // Position - 0x14C00
{
	return Global_1575041 == 10;
}

int func_326(Player plParam0) // Position - 0x14C0F
{
	if (plParam0 == _INVALID_PLAYER_INDEX())
		return 0;
...
int func_327(Player plParam0) // Position - 0x14C32
{
	if (func_341(plParam0))
		return func_328(Global_2658019[plParam0 /*467*/].f_324.f_8);

	return 0;
}

int func_328(int iParam0) // Position - 0x14C59
{
	switch (iParam0)
	{
		case 60:
...
void func_329(BOOL bParam0) // Position - 0x14CEE
{
	if (func_340(PLAYER::PLAYER_ID()) || func_312() && !NETWORK::NETWORK_IS_PLAYER_IN_MP_CUTSCENE(PLAYER::PLAYER_ID()) && !func_318() && !Global_1946293 && func_360(ENTITY::GET_ENTITY_HEADING(PLAYER::PLAYER_PED_ID()), ENTITY::GET_ENTITY_HEADING(obLocal_149), 90f))
	{
		...
		{
			if (_STOPWATCH_IS_INITIALIZED(&uLocal_143) && _STOPWATCH_HAS_TIME_PASSED(&uLocal_143, 10000, true) || !bLocal_140)
			{
...
BOOL func_330(Player plParam0) // Position - 0x14E5D
{
	return func_331(func_90(plParam0));
}

BOOL func_331(int iParam0) // Position - 0x14E6F
{
	switch (iParam0)
	{
		case 190:
...
BOOL func_332() // Position - 0x14E95
{
	if (ENTITY::DOES_ENTITY_EXIST(obLocal_149))
	{
...
BOOL func_333(Player plParam0) // Position - 0x14ED3
{
...
BOOL func_334(Player plParam0) // Position - 0x14EF6
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2658019[plParam0 /*467*/].f_324.f_8 != -1 && Global_2658019[plParam0 /*467*/].f_324.f_11 != _INVALID_PLAYER_INDEX())
				return func_12(Global_2658019[plParam0 /*467*/].f_324.f_8) == 25;

	return false;
}

void func_335(BOOL bParam0) // Position - 0x14F56
{
...
void _CONTEXT_ADD_HELP_TEXT(var uParam0, int iParam1, char* sParam2, int iParam3, const char* sParam4, int iParam5, int iParam6) // Position - 0x150B1
{
	int i;
...
BOOL func_337() // Position - 0x151DC
{
...
BOOL _IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(char* message) // Position - 0x15280
{
	HUD::BEGIN_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(message);
	return HUD::END_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(0);
}

void _CONTEXT_REMOVE_HELP_TEXT(var uParam0) // Position - 0x15293
{
	int num;
...
BOOL func_340(Player plParam0) // Position - 0x152EA
{
...
BOOL func_341(Player plParam0) // Position - 0x15323
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2658019[plParam0 /*467*/].f_324.f_8 != -1)
				return func_12(Global_2658019[plParam0 /*467*/].f_324.f_8) == 1;

	return false;
}

BOOL func_342(int iParam0, int iParam1) // Position - 0x15369
{
	if (iParam1 == -1)
	{
		switch (iParam0)
...
BOOL func_343(int iParam0) // Position - 0x15446
{
	switch (iParam0)
	{
		case 87:
...
BOOL func_344() // Position - 0x15475
{
	return Global_78544;
}

BOOL func_345() // Position - 0x15481
{
...
int func_346(int iParam0) // Position - 0x155AF
{
	int i;
...
int func_347(int iParam0) // Position - 0x155DA
{
	if (iParam0 != -1)
...
BOOL func_348() // Position - 0x155F9
{
	return IS_BIT_SET(Global_1946439.f_11, 1);
}

BOOL func_349() // Position - 0x15609
{
...
BOOL func_350(Ped pedParam0, float fParam1, float fParam2, float fParam3, float fParam4, BOOL bParam5) // Position - 0x15646
{
	return SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(pedParam0, bParam5), fParam1) <= fParam4 * fParam4;
}

int func_351(Player plParam0) // Position - 0x15664
{
	Player player;
...
int func_352(Player plParam0) // Position - 0x15683
{
...
BOOL func_353() // Position - 0x156A0
{
	return func_362(PLAYER::PLAYER_ID());
}

BOOL func_354() // Position - 0x156B0
{
	return Global_1845274[PLAYER::PLAYER_ID() /*877*/] == 148;
}

BOOL func_355() // Position - 0x156C6
{
	return Global_76856;
}

BOOL func_356() // Position - 0x156D2
{
	return Global_1931786;
}

BOOL func_357() // Position - 0x156DE
{
...
BOOL func_358() // Position - 0x1570C
{
...
BOOL func_359(int iParam0) // Position - 0x15726
{
	if (iParam0 == 1)
...
BOOL func_360(float fParam0, float fParam1, float fParam2) // Position - 0x1577D
{
	float num;
	float num2;
...
BOOL func_361() // Position - 0x157F2
{
	if (ENTITY::DOES_ENTITY_EXIST(obLocal_149))
...
BOOL func_362(Player plParam0) // Position - 0x15813
{
	if (func_69(plParam0))
		if (func_69(Global_1888882[plParam0 /*611*/].f_10))
...
BOOL func_363() // Position - 0x15848
{
...
BOOL func_364() // Position - 0x1586B
{
...
BOOL func_365(Player plParam0) // Position - 0x1588E
{
	if (func_342(Global_1845274[plParam0 /*877*/].f_260.f_36, -1))
		return 1;
...
BOOL func_366() // Position - 0x158B1
{
	if (ENTITY::DOES_ENTITY_EXIST(obLocal_149))
...
void func_367(int iParam0) // Position - 0x158E4
{
	if (func_372())
		return;
...
void func_368(int iParam0) // Position - 0x15917
{
	if (func_372())
		return;
...
BOOL func_369() // Position - 0x159A1
{
...
void func_370(BOOL bParam0, BOOL bParam1) // Position - 0x159C8
{
	if (bParam0)
	{
		if (func_359(0))
...
BOOL func_371() // Position - 0x15A3C
{
	return IS_BIT_SET(Global_1960332, 5);
}

BOOL func_372() // Position - 0x15A4A
{
	return IS_BIT_SET(Global_1960332, 19);
}

void _STOPWATCH_DESTROY(var uParam0) // Position - 0x15A59
{
	uParam0->f_1 = 0;
	return;
}

BOOL _STOPWATCH_HAS_TIME_PASSED(var pStopwatch, int millis, BOOL useLocalTimer) // Position - 0x15A66
{
	if (millis == -1)
		return true;
...
BOOL func_375(Player plParam0) // Position - 0x15AC4
{
	int num;
	...
	if (plParam0 != _INVALID_PLAYER_INDEX())
	{
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
		{
			if (Global_2658019[plParam0 /*467*/].f_324.f_8 != -1)
			{
				num = func_12(Global_2658019[plParam0 /*467*/].f_324.f_8);
				return num == 2 || num == 25;
			}
		}
	}
...
BOOL func_376(Player plParam0) // Position - 0x15B19
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2658019[plParam0 /*467*/].f_324.f_8 != -1)
				return func_12(Global_2658019[plParam0 /*467*/].f_324.f_8) == 0;

	return false;
}

void _STOPWATCH_INITIALIZE(var pStopwatch, BOOL useLocalTimer, BOOL useAccurateTime) // Position - 0x15B5F
{
	if (pStopwatch->f_1 == 0)
	{
		if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS() && !useLocalTimer)
...
BOOL _STOPWATCH_IS_INITIALIZED(var uParam0) // Position - 0x15BA4
{
	return uParam0->f_1;
}

BOOL func_379(Player plParam0) // Position - 0x15BB0
{
	return func_380(func_90(plParam0));
}

BOOL func_380(int iParam0) // Position - 0x15BC2
{
	switch (iParam0)
	{
		case 167:
...
BOOL func_381(int iParam0) // Position - 0x15BE8
{
	return Global_44392 == iParam0;
}

void func_382() // Position - 0x15BF6
{
	if (iLocal_138 != -1)
		_CONTEXT_REMOVE_HELP_TEXT(&iLocal_138);
