...
void func_56(BOOL bParam0) // Position - 0x15AA
{
	int i;
	int num;
	int offset;
...
BOOL _STOPWATCH_HAS_TIME_PASSED(var pStopwatch, int millis, BOOL useLocalTimer) // Position - 0x16EC
{
	if (millis == -1)
		return true;
...
void _STOPWATCH_INITIALIZE(var pStopwatch, BOOL useLocalTimer, BOOL useAccurateTime) // Position - 0x174A
{
	if (pStopwatch->f_1 == 0)
	{
		if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS() && !useLocalTimer)
...
BOOL _STOPWATCH_IS_INITIALIZED(var uParam0) // Position - 0x178F
{
	return uParam0->f_1;
}

void func_60() // Position - 0x179B
{
	return;
}

void func_61(int iParam0, int iParam1, int iParam2, int iParam3, BOOL bParam4) // Position - 0x17A3
{
	int i;
...
void func_62(BOOL bParam0) // Position - 0x18AE
{
	Global_2697069 = bParam0;
	return;
}

void func_63(var uParam0, int iParam1, BOOL bParam2, int iParam3) // Position - 0x18BC
{
	Any* fileDict;
	Any* dict;
	Any* dict2;
...
struct<13> GET_GAMER_HANDLE_PLAYER(Player plParam0) // Position - 0x1AC2
{
	var gamerHandle;
...
BOOL func_65(const char* sParam0) // Position - 0x1AD9
{
	var gamerHandle2;
	var gamerHandle1;
...
struct<13> GET_GAMER_HANDLE_USER(const char* sParam0) // Position - 0x1B09
{
	var gamerHandle;
...
BOOL func_67(int iParam0, BOOL bParam1, const char* sParam2, int iParam3) // Position - 0x1B20
{
	var unk;
	var unk14;
	...
	if (!Global_1984998)
		return func_69(&unk, &unk14, iParam0, bParam1);
...
BOOL IS_GAMER_HANDLE_VALID(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12) // Position - 0x1B85
{
	return NETWORK::NETWORK_IS_HANDLE_VALID(&uParam0, 13);
}

BOOL func_69(Any* panParam0, Any* panParam1, int iParam2, BOOL bParam3) // Position - 0x1B95
{
	if (iParam2 == 0)
		if (bParam3)
...
BOOL IS_XBOX_PLATFORM() // Position - 0x1CC6
{
	return MISC::IS_DURANGO_VERSION() || MISC::IS_SCARLETT_VERSION();
}

BOOL func_71(int iParam0) // Position - 0x1CDC
{
	switch (iParam0)
	{
		case 1:
...
BOOL func_72(int iParam0) // Position - 0x1D14
{
...
BOOL func_73() // Position - 0x1D59
{
	return false;
}

BOOL IS_ROCKSTAR_DEV() // Position - 0x1D69
{
	return DLC::IS_DLC_PRESENT(-1762644250);
}

void func_75(var uParam0, var uParam1, BOOL bParam2, int iParam3) // Position - 0x1D7A
{
	BOOL _bool;
	BOOL _bool2;
	Any* fileDict;
...
void func_76(var uParam0, var uParam1, BOOL bParam2, int iParam3) // Position - 0x1EE9
{
	BOOL _bool;
	BOOL _bool2;
	Any* fileDict;
...
void func_77(var uParam0, BOOL bParam1) // Position - 0x2033
{
	Any* fileDict;
	Any* dict;
	int dict2;
	...
	else if (DATAFILE::DATADICT_GET_TYPE(dict2, "cam") == 6)
	{
		...
		if (DATAFILE::DATADICT_GET_TYPE(dict3, "x") == 2)
			Global_1011388.f_33[num /*95*/].f_65 = SYSTEM::TO_FLOAT(DATAFILE::DATADICT_GET_INT(dict3, "x"));
		else
			Global_1011388.f_33[num /*95*/].f_65 = DATAFILE::DATADICT_GET_FLOAT(dict3, "x");
	
		if (DATAFILE::DATADICT_GET_TYPE(dict3, "y") == 2)
			Global_1011388.f_33[num /*95*/].f_65.f_1 = SYSTEM::TO_FLOAT(DATAFILE::DATADICT_GET_INT(dict3, "y"));
		else
			Global_1011388.f_33[num /*95*/].f_65.f_1 = DATAFILE::DATADICT_GET_FLOAT(dict3, "y");
	
		if (DATAFILE::DATADICT_GET_TYPE(dict3, "z") == 2)
			Global_1011388.f_33[num /*95*/].f_65.f_2 = SYSTEM::TO_FLOAT(DATAFILE::DATADICT_GET_INT(dict3, "z"));
		else
	...
	if (_IS_NULL_VECTOR(Global_1011388.f_33[num /*95*/].f_62))
		MISC::CLEAR_BIT(&(Global_1011388.f_33[num /*95*/].f_82), 13);
...
BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0x27FD
{
...
void func_79(Hash hParam0, int iParam1, int* piParam2, Hash hParam3) // Position - 0x2827
{
	if (func_113(hParam0))
...
BOOL func_80(Hash hParam0) // Position - 0x2ACE
{
	return hParam0 == 17;
}

BOOL func_81(Hash hParam0) // Position - 0x2ADB
{
	return hParam0 == 16;
}

BOOL func_82(Hash hParam0) // Position - 0x2AE8
{
	return hParam0 == 15;
}

BOOL func_83(Hash hParam0) // Position - 0x2AF5
{
	return hParam0 == 14;
}

BOOL func_84(Hash hParam0) // Position - 0x2B02
{
	return hParam0 == 13;
}

BOOL func_85(Hash hParam0) // Position - 0x2B0F
{
	return hParam0 == 12;
}

BOOL func_86(Hash hParam0) // Position - 0x2B1C
{
	return hParam0 == 11;
}

BOOL func_87(Hash hParam0) // Position - 0x2B29
{
	return hParam0 == 9;
}

BOOL func_88(Hash hParam0) // Position - 0x2B36
{
	return hParam0 == 1 || hParam0 == 67;
}

BOOL func_89(Hash hParam0) // Position - 0x2B4D
{
	return hParam0 == 6;
}

BOOL func_90(Hash hParam0) // Position - 0x2B59
{
	return hParam0 == 4;
}

BOOL func_91(Hash hParam0) // Position - 0x2B65
{
	return hParam0 == 2;
}

BOOL func_92(Hash hParam0) // Position - 0x2B71
{
	return hParam0 == 8 || hParam0 == 91;
}

BOOL func_93(Hash hParam0) // Position - 0x2B89
{
	int i;
...
BOOL func_94(Hash hParam0) // Position - 0x2BD6
{
	return hParam0 == 3;
}

BOOL func_95(Hash hParam0) // Position - 0x2BE2
{
	int i;
...
BOOL func_96(Hash hParam0) // Position - 0x2C2F
{
	int i;
...
BOOL func_97(Hash hParam0) // Position - 0x2C7C
{
	int i;
...
BOOL func_98(Hash hParam0) // Position - 0x2CC9
{
	int i;
...
BOOL func_99(Hash hParam0) // Position - 0x2D16
{
	int i;
...
BOOL func_100(Hash hParam0) // Position - 0x2D63
{
	int i;
...
BOOL func_101(Hash hParam0) // Position - 0x2DB0
{
	int i;
...
BOOL func_102(Hash hParam0) // Position - 0x2DFD
{
	int i;
...
BOOL func_103(Hash hParam0) // Position - 0x2E4A
{
	int i;
...
BOOL func_104(Hash hParam0) // Position - 0x2E97
{
	int i;
...
BOOL func_105(Hash hParam0) // Position - 0x2EE4
{
	int i;
...
BOOL func_106(Hash hParam0) // Position - 0x2F31
{
	int i;
...
BOOL func_107(Hash hParam0) // Position - 0x2F7E
{
	int i;
...
BOOL func_108(Hash hParam0, BOOL bParam1, BOOL bParam2) // Position - 0x2FCB
{
	int i;
...
BOOL func_109(int iParam0, BOOL bParam1) // Position - 0x3037
{
	if (iParam0 == 93)
		if (bParam1)
...
BOOL func_110(Hash hParam0) // Position - 0x3063
{
	int i;
...
BOOL func_111(Hash hParam0) // Position - 0x30AF
{
...
BOOL func_112(Hash hParam0) // Position - 0x311C
{
...
BOOL func_113(Hash hParam0) // Position - 0x3189
{
...
void func_114(int iParam0, int iParam1, int iParam2) // Position - 0x3216
{
	if (iParam0 == 1)
		if (*iParam2 < 2)
			*iParam2 = 2;
...
int func_115(int iParam0) // Position - 0x324C
{
...
int func_116() // Position - 0x3272
{
	return Global_33298;
}

int func_117(float fParam0, int iParam1) // Position - 0x327D
{
	int num;
...
Vector3 func_119(int iParam0) // Position - 0x32C3
{
	float _float;
...
Vector3 func_120(int iParam0, char* sParam1) // Position - 0x3341
{
	float vector;
	Any* dict;
...
Vector3 func_121(int iParam0) // Position - 0x3404
{
	Vector3 vector;
...
Vector3 func_122(var uParam0, var uParam1, var uParam2) // Position - 0x3502
{
...
BOOL func_123(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, float fParam6, BOOL bParam7) // Position - 0x353C
{
	if (fParam6 < 0f)
		fParam6 = 0f;
...
BOOL func_124(Hash hParam0) // Position - 0x35B7
{
	int i;
	int j;
...
BOOL func_125(Hash hParam0) // Position - 0x361C
{
	int i;
...
BOOL func_126(Hash hParam0) // Position - 0x366B
{
	int i;
...
BOOL func_127(Player plParam0) // Position - 0x369B
{
	return Global_2658019[plParam0 /*467*/].f_275;
}

BOOL func_128(Hash hParam0) // Position - 0x36AF
{
	int i;
...
Hash func_129(int iParam0) // Position - 0x36D9
{
	return Global_262145.f_28802[iParam0];
}

int func_130() // Position - 0x36EC
{
...
int func_131(Hash hParam0) // Position - 0x370E
{
	int i;
...
BOOL func_132(Hash hParam0) // Position - 0x3751
{
	int i;
...
BOOL func_133(Hash hParam0) // Position - 0x3794
{
	int i;
...
BOOL func_134(Hash hParam0) // Position - 0x37D7
{
...
BOOL func_135(Hash hParam0) // Position - 0x38AD
{
	int i;
...
BOOL func_136(Hash hParam0) // Position - 0x38EB
{
	int i;
...
Hash func_137(int iParam0) // Position - 0x391F
{
	if (iParam0 != -1)
...
BOOL func_138(Hash hParam0) // Position - 0x393E
{
	int i;
...
Hash func_139(int iParam0) // Position - 0x3972
{
	if (iParam0 != -1)
...
BOOL func_140(Hash hParam0) // Position - 0x3991
{
	int i;
...
Hash func_141(int iParam0) // Position - 0x39C5
{
	if (iParam0 != -1)
...
BOOL func_142(Hash hParam0) // Position - 0x39E4
{
	int i;
...
Hash func_143(int iParam0) // Position - 0x3A0F
{
	if (iParam0 != -1)
...
BOOL func_144(Hash hParam0) // Position - 0x3A2E
{
	int i;
...
Hash func_145(int iParam0) // Position - 0x3A62
{
	if (iParam0 != -1)
...
BOOL func_146(Hash hParam0) // Position - 0x3A81
{
	int i;
...
Hash func_147(int iParam0) // Position - 0x3AB5
{
	if (iParam0 != -1)
...
BOOL func_148(Hash hParam0) // Position - 0x3AD4
{
	int i;
...
BOOL func_149(Hash hParam0) // Position - 0x3B0D
{
	int i;
...
BOOL func_150(Hash hParam0) // Position - 0x3B3C
{
	int i;
...
BOOL func_151(Hash hParam0) // Position - 0x3B76
{
	int i;
...
BOOL func_152(Hash hParam0) // Position - 0x3BA5
{
	int i;
...
BOOL func_153(Hash hParam0) // Position - 0x3BD5
{
	int i;
...
int func_154(Hash hParam0) // Position - 0x3C0F
{
	int i;
...
int func_155(Hash hParam0) // Position - 0x3C49
{
	int i;
...
void func_156(var uParam0, int iParam1, int iParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5) // Position - 0x3C83
{
	int value;
	int offset;
	int num;
	...
	if (iParam1 != 0 && iParam1 != 1)
	{
		...
		if (!func_67(uParam0->f_23, uParam0->f_24, NETWORK::UGC_GET_CONTENT_USER_ID(uParam0->f_6), NETWORK::UGC_GET_CONTENT_CATEGORY(uParam0->f_6)))
		{
			if (bParam5 && IS_XBOX_PLATFORM() || unk_0xE2BCD0EFAE90D1F4())
			{
				offset = value % 32;
...
void func_157(var uParam0, int iParam1, int iParam2) // Position - 0x3ED7
{
	if (iParam1 == 0 || iParam1 == 1)
...
void func_158(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15) // Position - 0x3F6A
{
	int num;
...
int func_159(int iParam0) // Position - 0x3FE6
{
	int num;
	int i;
...
void func_160(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15) // Position - 0x4034
{
	int num;
...
void func_161(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15) // Position - 0x40B0
{
	int num;
...
void func_162(var uParam0, int iParam1) // Position - 0x412C
{
	if (iParam1 == 0 || iParam1 == 1)
	{
		if (NETWORK::UGC_GET_CONTENT_IS_VERIFIED(uParam0->f_6))
...
void func_163(int iParam0, int iParam1) // Position - 0x41A0
{
...
int func_164(int iParam0, int iParam1, int iParam2, BOOL bParam3) // Position - 0x42F1
{
	int num;
	int address;
...
void func_165(int iParam0, int iParam1, int iParam2, BOOL bParam3) // Position - 0x4377
{
	Hash statName;
...
BOOL func_166(int iParam0, int iParam1, var uParam2) // Position - 0x43A5
{
	*uParam2 = 979;
...
struct<14> func_167(int iParam0, int iParam1, int iParam2, Hash hParam3) // Position - 0x47AA
{
	func_210();
...
void func_168(int iParam0, int iParam1, Hash hParam2) // Position - 0x47EB
{
	switch (iParam0)
	{
		case 2:
...
void func_169(int iParam0) // Position - 0x48F7
{
	BOOL flag;
	int num;
	var unk;
...
void func_170(int iParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, BOOL bParam7, int iParam8, int iParam9, BOOL bParam10) // Position - 0x4AB2
{
	int num;
	int num2;
	...
	*iParam0 = iParam9;
	...
	else
	{
		...
		if (iParam1 == 11 || iParam1 == 4 || iParam1 == 6 || iParam1 == 1 || iParam1 == 14 || iParam1 == 2 || iParam1 == 8 || iParam1 == 9 || iParam1 == 10 || iParam1 == 7 || iParam1 == 12)
		{
			...
			num = func_18(func_172(iParam1, iParam0->f_2), Global_79548);
		
			if (IS_BIT_SET(num, iParam0->f_1))
				MISC::SET_BIT(&(iParam0->f_6), 1);
		
			num = func_18(func_171(iParam1, iParam0->f_2), Global_79548);
...
int func_171(int iParam0, int iParam1) // Position - 0x4E53
{
	switch (iParam1)
	{
		case 0:
...
int func_172(int iParam0, int iParam1) // Position - 0x524E
{
	switch (iParam1)
	{
		case 0:
...
BOOL func_173(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x5649
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
BOOL func_174(Hash hParam0, int iParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0x64EC
{
	int num;
	int num2;
	int num3;
...
BOOL func_175(Hash hParam0, int iParam1, var uParam2, var uParam3, BOOL bParam4, BOOL bParam5) // Position - 0x652A
{
...
BOOL func_176(int iParam0) // Position - 0x9340
{
	return Global_44392 == iParam0;
}

int func_177(int iParam0) // Position - 0x934E
{
	switch (iParam0)
	{
		case -1:
...
void func_178(int iParam0, Hash hParam1) // Position - 0x9422
{
	int num;
...
void func_179(int iParam0, int iParam1, int iParam2, Hash hParam3) // Position - 0x9442
{
	int num;
	int num2;
	Hash outfit;
	...
	else if (iParam0 == 14)
	{
		...
		if (componentId >= 0)
		{
			...
			if (num5 > componentId)
			{
				...
				func_170(&Global_79551[0 /*14*/], iParam0, iParam1, &(outProp.f_9), outProp.f_3, outProp.f_4, outProp.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(outProp.f_1, joaat("OUTFIT_ONLY"), 0), num4, 2, outProp.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (hParam3 != -1 && Global_79749)
		{
			...
			func_170(&Global_79551[0 /*14*/], iParam0, iParam1, &(outComponent.f_9), outComponent.f_3, outComponent.f_4, outComponent.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(outComponent.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, outComponent.f_1 != 0);
			return;
		}
...
int func_180(int iParam0) // Position - 0x96C8
{
	switch (iParam0)
	{
		case 0:
...
void func_181(int iParam0, Hash hParam1) // Position - 0x9778
{
	BOOL flag;
	int num;
	var unk;
...
void func_182(int iParam0, Hash hParam1) // Position - 0x987B
{
	BOOL flag;
	int num;
	var unk;
...
void func_183(int iParam0, Hash hParam1) // Position - 0x9B5A
{
	BOOL flag;
	int value;
	var unk;
...
void func_184(int iParam0, Hash hParam1) // Position - 0xC930
{
	BOOL flag;
	int num;
	var unk;
...
void func_185(int iParam0, Hash hParam1) // Position - 0xCA35
{
	BOOL flag;
	int value;
	var unk;
...
void func_186(int iParam0, Hash hParam1) // Position - 0xD211
{
	BOOL flag;
	int value;
	var unk;
...
void func_187(int iParam0, Hash hParam1) // Position - 0xD4F6
{
	BOOL flag;
	int value;
	var unk;
...
void func_188(int iParam0, Hash hParam1) // Position - 0xEB1D
{
	BOOL flag;
	int value;
	var unk;
...
void func_189(int iParam0, Hash hParam1) // Position - 0x1017D
{
	BOOL flag;
	int num;
	var unk;
...
void func_190(int iParam0, Hash hParam1) // Position - 0x102D8
{
	BOOL flag;
	int num;
	var unk;
...
void func_191(int iParam0, Hash hParam1) // Position - 0x10558
{
	BOOL flag;
	int value;
	var unk;
...
void func_192(int iParam0, Hash hParam1) // Position - 0x118FA
{
	BOOL flag;
	int value;
	var unk;
...
void func_193(int iParam0, Hash hParam1) // Position - 0x1305F
{
	BOOL flag;
	int value;
	var unk;
...
void func_194(int iParam0, int iParam1, Hash hParam2) // Position - 0x13F30
{
	switch (iParam0)
	{
		case 2:
...
void func_195(int iParam0) // Position - 0x1403F
{
	BOOL flag;
	int num;
	var unk;
...
void func_196(int iParam0, Hash hParam1) // Position - 0x14209
{
	int num;
...
void func_197(int iParam0, Hash hParam1) // Position - 0x14229
{
	BOOL flag;
	int num;
	var unk;
...
void func_198(int iParam0, Hash hParam1) // Position - 0x1432C
{
	BOOL flag;
	int num;
	var unk;
...
void func_199(int iParam0, Hash hParam1) // Position - 0x145DD
{
	BOOL flag;
	int value;
	var unk;
...
void func_200(int iParam0, Hash hParam1) // Position - 0x1739C
{
	BOOL flag;
	int num;
	var unk;
...
void func_201(int iParam0, Hash hParam1) // Position - 0x174BD
{
	BOOL flag;
	int value;
	var unk;
...
void func_202(int iParam0, Hash hParam1) // Position - 0x17DB5
{
	BOOL flag;
	int value;
	var unk;
...
void func_203(int iParam0, Hash hParam1) // Position - 0x1806D
{
	BOOL flag;
	int value;
	var unk;
...
void func_204(int iParam0, Hash hParam1) // Position - 0x196AA
{
	BOOL flag;
	int value;
	var unk;
...
void func_205(int iParam0, Hash hParam1) // Position - 0x1ACDD
{
	BOOL flag;
	int num;
	var unk;
...
void func_206(int iParam0, Hash hParam1) // Position - 0x1AE34
{
	BOOL flag;
	int num;
	var unk;
...
void func_207(int iParam0, Hash hParam1) // Position - 0x1B150
{
	BOOL flag;
	int value;
	var unk;
...
void func_208(int iParam0, Hash hParam1) // Position - 0x1D643
{
	BOOL flag;
	int value;
	var unk;
...
void func_209(int iParam0, Hash hParam1) // Position - 0x1EBCE
{
	BOOL flag;
	int value;
	var unk;
...
void func_210() // Position - 0x1FA88
{
...
BOOL func_211() // Position - 0x1FB00
{
	return func_212(PLAYER::PLAYER_ID());
}

BOOL func_212(Player plParam0) // Position - 0x1FB10
{
...
void func_213(int iParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, int iParam5) // Position - 0x1FB2F
{
	if (bParam4 || bParam1)
...
void func_214(int iParam0, BOOL bParam1, int iParam2) // Position - 0x1FC80
{
	if (bParam1)
	{
...
void func_215(int iParam0, BOOL bParam1) // Position - 0x1FCEF
{
	int num;
	int i;
...
void func_216(int iParam0, BOOL bParam1, int iParam2) // Position - 0x1FD69
{
	int address;
	int num;
	int num2;
...
int func_217(int iParam0) // Position - 0x1FDCF
{
	int num;
	int num2;
...
int func_218() // Position - 0x20170
{
	return Global_33299;
}

int func_219(int iParam0) // Position - 0x2017B
{
	return iParam0 / 32;
}

BOOL func_220(BOOL bParam0) // Position - 0x20188
{
	bParam0;
	return Global_1575060;
}

int func_221(int iParam0) // Position - 0x20199
{
	return iParam0 % 32;
}

int func_222(int iParam0, int iParam1) // Position - 0x201A6
{
	int num;
	int num2;
...
BOOL func_223(int iParam0, int iParam1) // Position - 0x201EC
{
	int num;
	int num2;
...
void func_224(int iParam0, int iParam1, int iParam2) // Position - 0x2022B
{
	int num;
...
void func_225(int iParam0, BOOL bParam1, int iParam2) // Position - 0x20253
{
	if (bParam1)
		if (!func_229(iParam0))
...
void func_226(int iParam0, BOOL bParam1, int iParam2) // Position - 0x20288
{
	int address;
	int num;
...
int func_227(int iParam0) // Position - 0x202D4
{
	int num;
	int num2;
...
int func_228(int iParam0) // Position - 0x2064F
{
	int num;

	num = func_18(func_227(iParam0), -1);
	return num;
}

BOOL func_229(int iParam0) // Position - 0x20666
{
	int num;
	int num2;
	...
	num2 = iParam0;
	return IS_BIT_SET(num, func_221(num2));
}

void func_230(int iParam0, BOOL bParam1) // Position - 0x20683
{
	int num;
...
void func_231(int iParam0, char* sParam1, char* sParam2, char* sParam3, char* sParam4, int iParam5, int iParam6, int iParam7, const char* sParam8, int iParam9, int iParam10) // Position - 0x206D2
{
	int num;
...
int func_232(var uParam0) // Position - 0x2076E
{
	int num;
	int i;
...
char* func_233(int iParam0, int iParam1) // Position - 0x2079D
{
	char* str;
...
char* func_234(int iParam0, int iParam1) // Position - 0x20882
{
	char* str;
...
char* func_235(int iParam0, int iParam1) // Position - 0x20D2E
{
	char* str;
...
char* func_236(int iParam0, int iParam1) // Position - 0x211DA
{
	char* str;
...
BOOL func_237(int iParam0) // Position - 0x21696
{
	int num;
	int num2;
...
int func_238(int iParam0) // Position - 0x216B3
{
	var unk;

	unk = Global_2751338.f_1032[func_219(iParam0)];
	return unk;
}

void func_239(int iParam0, BOOL bParam1, int iParam2) // Position - 0x216CE
{
	int address;
	int num;
...
int func_240(int iParam0, int iParam1) // Position - 0x2172A
{
	int num;

	num = func_18(func_241(iParam0), iParam1);
	return num;
}

int func_241(int iParam0) // Position - 0x21742
{
	int num;
	int num2;
...
void func_242(int iParam0, int iParam1) // Position - 0x21ABD
{
	int num;
...
void _STAT_SET_PACKED_BOOL(int iParam0, BOOL bParam1, int iParam2) // Position - 0x21AE4
{
	if (iParam2 == -1)
		iParam2 = func_21();
...
BOOL _STAT_GET_PACKED_BOOL(int iParam0, int iParam1) // Position - 0x21B02
{
	if (iParam1 == -1)
		iParam1 = func_21();
...
BOOL func_245(int iParam0, int iParam1) // Position - 0x21B1E
{
	int num;
	int num2;
...
BOOL func_246(var uParam0, char* sParam1, int iParam2, BOOL bParam3, int iParam4, BOOL bParam5) // Position - 0x21B4D
{
	var unk;
	Any* fileDict;
	Any* dict;
	...
	*sParam1 = { unk };
	...
	if (_IS_NULL_VECTOR(sParam1->f_62))
	{
		MISC::CLEAR_BIT(&(sParam1->f_82), 13);
		return false;
	}
...
BOOL func_247(var uParam0, var uParam1, var uParam2) // Position - 0x2203C
{
...
BOOL func_248(Vector3 vParam0, var uParam1, var uParam2) // Position - 0x220A2
{
	int i;
...
BOOL func_249(Vector3 vParam0, var uParam1, var uParam2, int iParam3, float fParam4) // Position - 0x22230
{
	int i;
	var unk;
	var unk11;
...
void func_250(var uParam0, var uParam1, BOOL bParam2, int iParam3, int iParam4) // Position - 0x22584
{
	Any* fileDict;
	Any* dict;
	int dict2;
...
void func_251(int iParam0, int iParam1, int iParam2, BOOL bParam3) // Position - 0x22AA3
{
	Hash hash;
	...
	if (func_28())
	{
		if (iParam0 == 0)
			if (iParam1 != 6 && iParam1 != 5 && iParam1 != 4 && iParam1 != 9)
				if (func_256(PLAYER::PLAYER_ID()) < iParam2)
					return;
	
		hash = func_255(iParam0, iParam1, bParam3);
...
void func_252(Hash hParam0, int iParam1) // Position - 0x22B07
{
	int num;
...
void _MPPLY_STAT_SET_INT(Hash hParam0, int iParam1) // Position - 0x22B26
{
	Hash statName;
...
int _MPPLY_STAT_GET_INT(Hash hParam0) // Position - 0x22B42
{
	Hash statHash;
	int outValue;
...
Hash func_255(int iParam0, int iParam1, BOOL bParam2) // Position - 0x22B60
{
	switch (iParam0)
	{
		case 2:
...
int func_256(Player plParam0) // Position - 0x22CC1
{
	int num;
	...
	return func_257(num, 0);
}

int func_257(int iParam0, int iParam1) // Position - 0x22CE2
{
	int i;
	int value;
	int value2;
	...
	for (i = 0; i <= 100; i = i + 1)
	{
		...
		if (func_258(num) == iParam0)
		{
			value = num;
			value2 = num;
		}
		else if (func_258(num) < iParam0)
		{
			if (value2 == num)
				value2 = value2 + 1;
			else
...
int func_258(int iParam0) // Position - 0x22D9D
{
	int num;
	int num2;
...
int func_259(Player plParam0) // Position - 0x232E1
{
...
BOOL func_260(Player plParam0) // Position - 0x23338
{
...
BOOL func_261(Player plParam0) // Position - 0x23357
{
	Player player;
...
void func_262(int iParam0, int iParam1, BOOL bParam2, int iParam3, BOOL bParam4) // Position - 0x23379
{
	Hash hash;
	...
	if (iParam0 == 0)
		if (iParam1 != 6 && iParam1 != 5 && iParam1 != 4 && iParam1 != 9)
			if (func_256(PLAYER::PLAYER_ID()) < iParam3)
				return;
	else if (iParam0 == 2)
		if (iParam3 >= 9999)
			return;

	hash = func_263(iParam0, iParam1, bParam4);
...
Hash func_263(int iParam0, int iParam1, BOOL bParam2) // Position - 0x233FE
{
	switch (iParam0)
	{
		case 2:
	...
	if (Global_794954.f_4[uParam0->f_8 /*95*/].f_71 == 6 && !bParam1)
	{
		if (Global_1014403.f_684 < 85)
		{
			...
			if (DATAFILE::DATADICT_GET_TYPE(dict2, "rad") == 2)
				Global_1014403.f_512[Global_1014403.f_684] = SYSTEM::TO_FLOAT(DATAFILE::DATADICT_GET_INT(dict2, "rad"));
			else
...
void func_267(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x242B8
{
	var unk;
	Hash hash;

	if (!func_269(iParam0, iParam1, iParam2, &unk, iParam3))
		return;
...
Hash func_268(int iParam0) // Position - 0x242ED
{
	switch (iParam0)
	{
		case 12:
...
BOOL func_269(int iParam0, int iParam1, int iParam2, var uParam3, int iParam4) // Position - 0x2435F
{
	int num;
	...
	if (func_256(PLAYER::PLAYER_ID()) < iParam4)
		return false;
...
int func_270(int iParam0) // Position - 0x243B1
{
	int num;
...
int func_271(int iParam0) // Position - 0x24437
{
	int i;
	int num;
...
int func_272(int iParam0) // Position - 0x2447E
{
	switch (iParam0)
	{
		case 86:
...
int func_273(int iParam0) // Position - 0x2472A
{
	int num;
	int num2;
...
int func_274(int iParam0) // Position - 0x24740
{
	switch (iParam0)
	{
		case 0:
...
void func_275(int iParam0, int iParam1, int iParam2, int iParam3, BOOL bParam4) // Position - 0x24953
{
	var unk;
	Hash hash;
...
Hash func_276(int iParam0) // Position - 0x24991
{
	switch (iParam0)
	{
		case 12:
...
BOOL func_277(Hash hParam0, Hash hParam1) // Position - 0x24A03
{
	if (hParam1 > 0)
		return true;
...
BOOL func_278(Hash hParam0) // Position - 0x24B15
{
	return hParam0 == 65;
}

BOOL func_279(Hash hParam0) // Position - 0x24B22
{
	return hParam0 == 57;
}

void func_280(Hash hParam0, int iParam1) // Position - 0x24B2F
{
	int i;
...
Vector3 func_281(int iParam0, int iParam1) // Position - 0x24C87
{
	switch (iParam0)
	{
		case 0:
...
Vector3 func_282(int iParam0, int iParam1) // Position - 0x24D64
{
	switch (iParam0)
	{
		case 0:
...
Vector3 func_283(int iParam0, int iParam1) // Position - 0x24E55
{
	switch (iParam0)
	{
		case 0:
...
int func_290(Hash hParam0) // Position - 0x24FFD
{
	int i;
...
int func_291(Hash hParam0) // Position - 0x25040
{
	int i;
	int j;
...
int func_292(Hash hParam0, BOOL bParam1) // Position - 0x250A6
{
	int i;
	int j;
...
void func_293(int iParam0) // Position - 0x252C3
{
...
BOOL func_294(Hash hParam0) // Position - 0x25379
{
	int i;
...
Hash func_295(int iParam0) // Position - 0x253A3
{
	switch (iParam0)
	{
		case 0:
...
const char* func_296() // Position - 0x2540B
{
	return HUD::GET_FILENAME_FOR_AUDIO_CONVERSATION("CREATOR_RSC" /*Rockstar*/);
}

void func_297(BOOL bParam0) // Position - 0x2541B
{
	_MPPLY_STAT_SET_BOOL(joaat("MPPLY_BIG_FEED_INIT"), bParam0);
	return;
}

void _MPPLY_STAT_SET_BOOL(Hash hParam0, BOOL bParam1) // Position - 0x2542E
{
	Hash statName;
...
void func_299(BOOL bParam0) // Position - 0x2544A
{
	if (!func_28())
		return;
...
void func_300() // Position - 0x25681
{
	int i;
...
void func_301() // Position - 0x256CD
{
	int i;
	int j;
...
BOOL func_302(const char* sParam0) // Position - 0x2571C
{
...
BOOL func_303(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, Any* panParam5, int iParam6, int iParam7, int iParam8, BOOL bParam9) // Position - 0x25836
{
	switch (iParam0)
	{
		case 0:
...
int func_304(Player plParam0) // Position - 0x25A5D
{
	var gamerHandle;
	int clanDesc;
...
char* func_305(int iParam0) // Position - 0x25A8A
{
	switch (iParam0)
	{
		case 0:
...
void func_306(var uParam0) // Position - 0x25ADE
{
	Any* fileDict;
	Any* array;
	int i;
...
void func_307() // Position - 0x25B7D
{
	int i;
...
void func_308(var uParam0) // Position - 0x25BF0
{
	int i;
...
void func_309(int iParam0, BOOL bParam1, BOOL bParam2, int iParam3) // Position - 0x25C5B
{
	int i;
	var unk;
...
void func_310(int iParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, int iParam4, BOOL bParam5) // Position - 0x25CAA
{
	int i;
	var unk;
...
void func_311(var uParam0, BOOL bParam1, BOOL bParam2, int iParam3) // Position - 0x25D72
{
	int i;
	var unk;
...
void func_312(BOOL bParam0, BOOL bParam1, int iParam2) // Position - 0x25DC8
{
	int num;
	int i;
	var unk;
...
void func_313() // Position - 0x25E4B
{
	if (func_345())
		NETWORK::UGC_CLEAR_OFFLINE_QUERY();
	else
...
void func_314() // Position - 0x25E65
{
	if (DATAFILE::DATAFILE_GET_FILE_DICT(0) != 0)
		DATAFILE::DATAFILE_DELETE(0);
...
void _STOPWATCH_DESTROY(var uParam0) // Position - 0x25E7B
{
	uParam0->f_1 = 0;
	return;
}

void func_316() // Position - 0x25E88
{
	int i;
...
BOOL func_317() // Position - 0x25EBB
{
	if (!func_318())
		return true;
...
BOOL func_318() // Position - 0x25ED0
{
	if (func_319())
		return false;
...
BOOL func_319() // Position - 0x25EF0
{
	return Global_2697069;
}

BOOL func_320(var uParam0) // Position - 0x25EFC
{
	var gamerHandle;
	Any* fileDict;
	int _int;
...
void func_321(var uParam0) // Position - 0x25FCF
{
	var unk;
...
void func_322(int iParam0, int iParam1) // Position - 0x25FDF
{
	Hash hash;
	Hash statName;
...
struct<13> GET_LOCAL_GAMER_HANDLE() // Position - 0x25FFF
{
	var gamerHandle;
...
void func_324(int iParam0, var uParam1) // Position - 0x26014
{
	int i;
	int j;
	var unk;
...
BOOL func_325(float fParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5, int iParam6) // Position - 0x26109
{
...
BOOL func_326(var uParam0, int iParam1, int iParam2, BOOL bParam3) // Position - 0x2615C
{
	var unk;
...
BOOL func_327() // Position - 0x2617A
{
	BOOL num;
	int profileSetting;
	int profileSetting2;
...
void func_328(int iParam0, int iParam1) // Position - 0x26206
{
	int i;
	int j;
	var unk;
...
BOOL func_329(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0x262C6
{
	int num;
...
BOOL func_330() // Position - 0x262F6
{
	return Global_1835485.f_2;
}

BOOL func_331(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0x26304
{
	int num;
...
void func_332() // Position - 0x26334
{
	Global_1835485.f_7 = 0;
	return;
}

void func_333() // Position - 0x26343
{
	Global_1835485.f_7 = 1;
	return;
}

BOOL func_334() // Position - 0x26352
{
	return Global_1835485.f_7;
}

BOOL func_335() // Position - 0x26360
{
	return Global_1835485.f_9;
}

BOOL func_336(var uParam0) // Position - 0x2636E
{
	int i;
	...
	switch (uParam0->f_3)
	{
		...
		case 26:
			if (func_337(uParam0) || _STOPWATCH_HAS_TIME_PASSED(&(uParam0->f_33), 45000, false))
			{
...
BOOL func_337(var uParam0) // Position - 0x266D8
{
	int i;
	BOOL flag;
	const char* text;
...
const char* func_338(int iParam0, int iParam1) // Position - 0x26824
{
	if (iParam0 == -1)
		return func_339();
...
const char* func_339() // Position - 0x26844
{
	return HUD::GET_FILENAME_FOR_AUDIO_CONVERSATION("CREATOR_NO_T" /*No translation.*/);
}

BOOL func_340(int iParam0, int iParam1) // Position - 0x26854
{
	if (*iParam1 != iParam0)
	{
		if (*iParam1 != 0)
...
void func_341(var uParam0) // Position - 0x268FF
{
	Any* fileDict;
	Any* dict;
	int dict2;
...
void _STOPWATCH_RESET(var pStopwatch, BOOL useLocalTimer, BOOL useAccurateTime) // Position - 0x26EEC
{
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS() && !useLocalTimer)
		if (!useAccurateTime)
			*pStopwatch = NETWORK::GET_NETWORK_TIME();
...
struct<6> func_343(int iParam0) // Position - 0x26F29
{
	var unk;
...
void func_344() // Position - 0x27118
{
	var unk;
	int i;
...
BOOL func_345() // Position - 0x2715D
{
	return Global_1835485.f_6;
}

BOOL func_346(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0x2716B
{
	int num;
...
int func_347(int iParam0) // Position - 0x27199
{
...
BOOL IS_PLAYSTATION_PLATFORM() // Position - 0x2726A
{
	return MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION();
}

int func_350(int iParam0) // Position - 0x27280
{
	if (MISC::IS_PS3_VERSION() || IS_PLAYSTATION_PLATFORM() && iParam0 == 0)
...
void func_351() // Position - 0x272D9
{
	Global_2693808.f_3 = 1;
	return;
}

BOOL func_352() // Position - 0x272E8
{
...
BOOL func_353() // Position - 0x27343
{
	return Global_2693808.f_3;
}

BOOL func_354() // Position - 0x27351
{
...
void func_355() // Position - 0x27367
{
	Global_2693808.f_4 = 1;
	return;
}

void func_356() // Position - 0x27376
{
...
void func_357(int iParam0) // Position - 0x273A9
{
	Global_1574546 = iParam0;
	return;
}

void func_358() // Position - 0x273B7
{
	Global_1835485.f_12 = 1;
	return;
}

BOOL func_359() // Position - 0x273C6
{
	return Global_2693808.f_6;
}

void func_360() // Position - 0x273D4
{
	Global_2693808.f_5 = 0;
	return;
}

BOOL func_361() // Position - 0x273E3
{
