...
void main() // Position - 0x0
{
	...
	while (true)
	{
		...
		if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS() || _SHOULD_NETWORK_SCRIPT_TERMINATE() || Global_1579741 == 0 || func_28())
			func_25();
...
{
	return !Global_1579737 && NETWORK::NETWORK_IS_ACTIVITY_SESSION();
}
