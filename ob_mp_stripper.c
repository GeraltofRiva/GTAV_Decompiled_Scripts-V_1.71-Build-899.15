...
void main() // Position - 0x0
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(eScriptParam_0))
	{
		...
		uLocal_314 = Global_1845274[PLAYER::PLAYER_ID() /*877*/].f_260.f_36;
		func_73(&Global_1569868, uLocal_314);
		uLocal_376 = { Global_1569868.f_146.f_82[5 /*102*/] };
		fLocal_379 = Global_1569868.f_146.f_82[5 /*102*/].f_3;
	
		if (fLocal_379 < 0f)
			fLocal_379 = fLocal_379 + 360f;
	
		uLocal_386 = { Global_1569868.f_146.f_82[5 /*102*/].f_16 };
		fLocal_389 = Global_1569868.f_146.f_82[5 /*102*/].f_19.f_2;
		uLocal_380 = { Global_1569868.f_146.f_82[5 /*102*/].f_7 };
		uLocal_383 = { Global_1569868.f_146.f_82[5 /*102*/].f_10 };
	}
...
void func_2() // Position - 0xCE5
{
	...
	if (player > -1 && player != _INVALID_PLAYER_INDEX())
	{
		for (i = 0; i < 33; i = i + 1)
		{
			if (Global_1845274[PLAYER::PLAYER_ID() /*877*/].f_260.f_36 == Global_1845274[player /*877*/].f_260[i])
			{
				if (func_9(i) != -1)
				{
...
{
	return IS_BIT_SET(Global_1673898.f_241.f_136[func_15(9) /*33*/][plParam0], func_14(9));
}
		...
		if (NETWORK::NETWORK_IS_PLAYER_ACTIVE(plParam0) && PLAYER::IS_PLAYER_PLAYING(plParam0) || bParam3 == true)
		{
			...
			else
			{
				if (!func_38(playerPed) && !ENTITY::IS_ENTITY_ATTACHED_TO_ANY_VEHICLE(playerPed))
				{
					...
					if (func_35(*Global_4718592.f_197275))
	...
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
		if (!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false) && !FIRE::IS_ENTITY_ON_FIRE(PLAYER::PLAYER_PED_ID()) && PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID()))
		{
			if (!FIRE::IS_EXPLOSION_IN_SPHERE(-1, vParam0, 2f))
			{
				...
				{
					if (Global_98820 && Global_98821 || func_60())
						return false;
...
{
	return func_96(iParam0, Global_44392);
}
