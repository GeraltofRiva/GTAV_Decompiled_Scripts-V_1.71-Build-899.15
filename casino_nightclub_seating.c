	...
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2658019[plParam0 /*467*/].f_324.f_8 != -1)
				return func_82(Global_2658019[plParam0 /*467*/].f_324.f_8) == 19;
...
void func_84() // Position - 0x26FA
{
	SCRIPT::TERMINATE_THIS_THREAD();
	return;
}

void func_85(var uParam0) // Position - 0x2706
{
	int localSceneFromNetworkId;
...
void _SET_PLAYER_CONTROL_EX(Player plParam0, BOOL bParam1, eSetPlayerControlFlags espcfParam2, BOOL bParam3) // Position - 0x2765
{
...
BOOL func_87(int iParam0) // Position - 0x2C19
{
	return iParam0 == 17;
}

void func_88() // Position - 0x2C26
{
	var unk;
...
BOOL func_90(Ped pedParam0) // Position - 0x2CB1
{
	int scriptTaskStatus;
...
void func_91(BOOL bParam0, Ped pedParam1, int iParam2) // Position - 0x2CE2
{
	int num;
	eViewModeContext i;
...
void _MPPLY_STAT_SET_BOOL(Hash hParam0, BOOL bParam1) // Position - 0x2DB2
{
	Hash statName;
...
BOOL func_94(Player plParam0) // Position - 0x2E26
{
...
BOOL func_95() // Position - 0x2E65
{
	return IS_BIT_SET(Global_2621446, 3);
}

BOOL func_96(Player plParam0, int iParam1) // Position - 0x2E73
{
	BOOL flag;
...
int func_97(int iParam0, BOOL bParam1) // Position - 0x2ECC
{
	int num;
	int num2;
...
int func_98() // Position - 0x2F0D
{
	return Global_1574927;
}

BOOL func_99(Player plParam0) // Position - 0x2F19
{
	Player player;
...
void func_103(int iParam0, var uParam1, int iParam2, int iParam3) // Position - 0x3016
{
	var unk;
	float num;
...
Vector3 func_104() // Position - 0x30A7
{
	return 0.5f, -0.5f, 2f;
}

Vector3 func_105(float fParam0, var uParam1, var uParam2, float fParam3) // Position - 0x30BA
{
	float num;
	float num2;
	float num3;
...
float func_106(int iParam0, float fParam1) // Position - 0x30FE
{
	switch (iParam0)
	{
		case 1:
...
Vector3 func_107() // Position - 0x3137
{
	return -0.5f, -0.5f, 0f;
}

void func_108(int iParam0, var uParam1, var uParam2) // Position - 0x314A
{
	if (func_4())
	{
		switch (iParam0)
...
void func_109() // Position - 0x349A
{
	return;
}

int _NETWORK_ENSURE_SCRIPT_IS_NETWORKED(int iParam0, int iParam1, BOOL bNoTerminate) // Position - 0x34A2
{
	int i;
...
BOOL func_111(BOOL bParam0) // Position - 0x35B8
{
	bParam0;
