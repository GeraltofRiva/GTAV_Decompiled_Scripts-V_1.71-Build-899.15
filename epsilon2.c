...
void func_8() // Position - 0x971
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (_GET_CHARACTER_MODEL(Global_114370.f_2367.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_9(character) && !func_13(14) || Global_113318)
			{
...
void func_17(int iParam0, var uParam1) // Position - 0xD97
{
	...
	switch (iParam0)
	{
		...
		case 71:
		case 72:
			if (!func_18(iParam0) && SCRIPT::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(Global_92680[26 /*34*/].f_6) == 0)
			{
				Global_114370.f_7265[iParam0] = 1;
				OBJECT::DOOR_SYSTEM_SET_DOOR_STATE(uParam1->f_5, Global_114370.f_7265[iParam0], true, true);
			}
...
BOOL func_35(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9) // Position - 0x46C5
{
	...
	else
	{
		...
		num2 = 0;
		func_41(&num2);
		num3 = func_40(unk10, Global_114370.f_7692.f_765[num2 /*10*/]);
	
		if (num3 == 2)
		{
			func_38(Global_114370.f_7692.f_765[num2 /*10*/]);
		...
		else if (num3 == 1)
		{
			...
			{
				if (!func_36(Global_114370.f_7692.f_765[num2 /*10*/]))
				{
					Global_114370.f_7692.f_765[num2 /*10*/] = { unk10 };
					func_37(&unk10);
					return true;
...
void func_41(var uParam0) // Position - 0x4999
{
	...
	*uParam0 = 0;
	...
	{
		if (func_40(Global_114370.f_7692.f_765[i /*10*/], Global_114370.f_7692.f_765[*uParam0 /*10*/]) == 0)
			*uParam0 = i;
	}
...
int func_63(Ped pedParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Position - 0x5280
{
	...
	if (iParam5 == 0)
	{
		Global_79551[1 /*14*/] = { func_115(entityModel, iParam1, iParam2, -1) };
	...
	if (iParam1 == 12)
	{
		...
		for (i = 0; i <= 14; i = i + 1)
		{
			if (unk[i] != -99)
			{
				Global_79551[1 /*14*/] = { func_115(entityModel, i, unk[i], -1) };
				...
				if (IS_BIT_SET(Global_79551[1 /*14*/].f_6, 0))
				{
					if (i == 13)
					{
						...
						for (j = 0; j <= 8; j = j + 1)
						{
							Global_79551[1 /*14*/] = { func_115(entityModel, 14, unk18[j], -1) };
							func_83(pedParam0, Global_79551[1 /*14*/].f_12, Global_79551[1 /*14*/].f_3, Global_79551[1 /*14*/].f_4);
							func_106(14);
					...
					else if (i != 14 && i != 12)
					{
						...
						if (iParam4 == -1)
							PED::SET_PED_COMPONENT_VARIATION(pedParam0, func_73(i), Global_79551[1 /*14*/].f_3, Global_79551[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(pedParam0, func_73(i)));
						else
							PED::SET_PED_COMPONENT_VARIATION(pedParam0, func_73(i), Global_79551[1 /*14*/].f_3, Global_79551[1 /*14*/].f_4, iParam4);
			...
			{
				Global_79551[1 /*14*/] = { func_115(entityModel, i, func_72(pedParam0, i, PV_COMP_INVALID), -1) };
	...
	else if (iParam1 == 13)
	{
		...
		for (j = 0; j <= 8; j = j + 1)
		{
			Global_79551[1 /*14*/] = { func_115(entityModel, 14, unk59[j], -1) };
			func_83(pedParam0, Global_79551[1 /*14*/].f_12, Global_79551[1 /*14*/].f_3, Global_79551[1 /*14*/].f_4);
			func_106(14);
	...
	{
		if (iParam4 == -1)
			PED::SET_PED_COMPONENT_VARIATION(pedParam0, func_73(iParam1), Global_79551[1 /*14*/].f_3, Global_79551[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(pedParam0, func_73(iParam1)));
		else
			PED::SET_PED_COMPONENT_VARIATION(pedParam0, func_73(iParam1), Global_79551[1 /*14*/].f_3, Global_79551[1 /*14*/].f_4, iParam4);
...
BOOL func_64(Ped pedParam0, Hash hParam1, var uParam2) // Position - 0x5A91
{
	...
	{
		if (!func_179(pedParam0, Global_114370.f_2367.f_539[num /*65*/].f_64, Global_114370.f_2367.f_539[num /*65*/].f_63))
		{
...
{
	Global_79551[1 /*14*/] = { func_115(hParam0, iParam1, iParam2, -1) };
...
BOOL func_71(Ped pedParam0, Hash hParam1, var uParam2, int iParam3) // Position - 0x639A
{
	...
	{
		if (!func_179(pedParam0, Global_114370.f_2367.f_539[num /*65*/].f_61, Global_114370.f_2367.f_539[num /*65*/].f_60) || iParam3 == 1)
		{
	...
	switch (hParam0)
	{
		case joaat("Player_Zero"):
			switch (iParam1)
			{
				...
				case 5:
					func_99(&unk, -99, -99, Global_114370.f_2367.f_539.f_196[0], Global_114370.f_2367.f_539.f_200[0], 6, 3, 0, 0, 0, -99, 0, 0, 3);
					break;
		...
		case joaat("Player_One"):
			switch (iParam1)
			{
				...
				case 2:
					func_99(&unk, -99, -99, Global_114370.f_2367.f_539.f_196[1], Global_114370.f_2367.f_539.f_200[1], 17, 2, 26, 0, 0, -99, 0, 45, 31);
					break;
		...
		case joaat("Player_Two"):
			switch (iParam1)
			{
				...
				case 4:
					func_99(&unk, -99, -99, Global_114370.f_2367.f_539.f_196[2], Global_114370.f_2367.f_539.f_200[2], 8, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
...
void func_106(int iParam0) // Position - 0xC1F4
{
	if (IS_BIT_SET(Global_79551[1 /*14*/].f_6, 1) && !IS_BIT_SET(Global_79551[1 /*14*/].f_6, 6))
		func_113(iParam0, Global_79551[1 /*14*/].f_5, Global_79551[1 /*14*/].f_2, 2, Global_79551[1 /*14*/].f_1, 1, 0);
...
BOOL func_113(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0xEFED
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
BOOL func_114(int iParam0) // Position - 0xFE90
{
	if (!IS_BIT_SET(Global_79551[1 /*14*/].f_6, 0))
		return false;
...
struct<14> func_115(Hash hParam0, int iParam1, int iParam2, int iParam3) // Position - 0xFED8
{
	func_178();
...
void func_116(int iParam0, int iParam1) // Position - 0xFF2A
{
	switch (iParam0)
	{
		case 0:
...
void func_117(int iParam0) // Position - 0x1001C
{
	BOOL flag;
	int num;
	var unk;
	...
	func_118(&Global_79551[0 /*14*/], num6, iParam0, &unk, num2, num3, num, flag, num4, num5, false);
	return;
}

void func_118(int iParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, BOOL bParam7, int iParam8, int iParam9, BOOL bParam10) // Position - 0x1124B
{
	int num;
	int num2;
	...
	*iParam0 = iParam9;
	...
	else
	{
		...
		if (iParam1 == 11 || iParam1 == 4 || iParam1 == 6 || iParam1 == 1 || iParam1 == 14 || iParam1 == 2 || iParam1 == 8 || iParam1 == 9 || iParam1 == 10 || iParam1 == 7 || iParam1 == 12)
		{
			...
			num = func_111(func_121(iParam1, iParam0->f_2), Global_79548);
		
			if (IS_BIT_SET(num, iParam0->f_1))
				MISC::SET_BIT(&(iParam0->f_6), 1);
		
			num = func_111(func_120(iParam1, iParam0->f_2), Global_79548);
			...
			{
				num = func_111(num2, Global_79548);
...
BOOL func_119(int iParam0, int iParam1, var uParam2) // Position - 0x115EC
{
	*uParam2 = 979;
...
int func_120(int iParam0, int iParam1) // Position - 0x119F1
{
	switch (iParam1)
	{
		case 0:
...
int func_121(int iParam0, int iParam1) // Position - 0x11DEC
{
	switch (iParam1)
	{
		case 0:
...
BOOL func_122(Hash hParam0, int iParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0x121E7
{
	int num;
	int num2;
	int num3;
...
int func_123(int iParam0) // Position - 0x12225
{
	switch (iParam0)
	{
		case -1:
...
void func_124(int iParam0, int iParam1, int iParam2, Hash hParam3) // Position - 0x122F9
{
	int num;
	int num2;
	Hash outfit;
	...
	if (iParam0 == 12)
	{
		...
		if (outfitIndex >= 0)
		{
			...
			if (num3 > outfitIndex)
			{
				...
				func_118(&Global_79551[0 /*14*/], iParam0, iParam1, &(outfit.f_7), 0, 0, outfit.f_2, false, -1, 2, true);
				return;
			}
		}
	}
	...
	{
		func_118(&Global_79551[0 /*14*/], iParam0, iParam1, "NO_LABEL", 0, 0, 0, true, -1, 2, true);
	}
	else if (iParam0 == 14)
	{
		FILES::INIT_SHOP_PED_PROP(&outProp);
		...
		if (componentId >= 0)
		{
			...
			if (num5 > componentId)
			{
				...
				func_118(&Global_79551[0 /*14*/], iParam0, iParam1, &(outProp.f_9), outProp.f_3, outProp.f_4, outProp.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(outProp.f_1, joaat("OUTFIT_ONLY"), 0), num4, 2, outProp.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (hParam3 != -1 && Global_79749)
		{
			...
			func_118(&Global_79551[0 /*14*/], iParam0, iParam1, &(outComponent.f_9), outComponent.f_3, outComponent.f_4, outComponent.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(outComponent.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, outComponent.f_1 != 0);
			return;
		}
...
void func_125(int iParam0) // Position - 0x1257F
{
	BOOL flag;
	int num;
	var unk;
...
void func_126(int iParam0) // Position - 0x126CC
{
	BOOL flag;
	int num;
	var unk;
...
void func_127(int iParam0) // Position - 0x12BD9
{
	BOOL flag;
	int num;
	var unk;
...
void func_128(int iParam0) // Position - 0x12C4D
{
	BOOL flag;
	int num;
	var unk;
...
void func_129(int iParam0) // Position - 0x12CC0
{
	BOOL flag;
	int num;
	var unk;
...
void func_130(int iParam0) // Position - 0x12DA7
{
	BOOL flag;
	int num;
	var unk;
...
void func_131(int iParam0) // Position - 0x130E9
{
	BOOL flag;
	int num;
	var unk;
...
void func_132(int iParam0) // Position - 0x132F1
{
	BOOL flag;
	int num;
	var unk;
...
void func_133(int iParam0) // Position - 0x13511
{
	BOOL flag;
	int num;
	var unk;
...
void func_134(int iParam0) // Position - 0x1361A
{
	BOOL flag;
	int num;
	var unk;
...
void func_135(int iParam0) // Position - 0x13FAC
{
	BOOL flag;
	int num;
	var unk;
...
BOOL func_179(Ped pedParam0, int iParam1, int iParam2) // Position - 0x235E4
{
			...
			if (unk[i] != -99 && i != 12 && i != 14)
			{
				if (!func_179(pedParam0, i, unk[i]))
				{
					if (i == 13)
					{
						...
						for (j = 0; j <= 8; j = j + 1)
						{
							if (!func_179(pedParam0, 14, unk18[j]))
							{
								for (k = 0; k <= 19; k = k + 1)
								{
									Global_79551[2 /*14*/] = { func_115(entityModel, 14, k, -1) };
								
									if (Global_79551[2 /*14*/].f_12 == j)
										if (func_179(pedParam0, 14, k))
											if (!func_69(entityModel, iParam2, 14, k, &unk, &Global_79551[2 /*14*/]))
												return false;
								}
							}
						}
					...
					else
					{
						...
						Global_79551[2 /*14*/] = { func_115(entityModel, i, num, -1) };
					
						if (!func_69(entityModel, iParam2, i, num, &unk, &Global_79551[2 /*14*/]))
							return false;
					}
				}
			}
	...
	else if (Global_79551[1 /*14*/].f_3 == PED::GET_PED_DRAWABLE_VARIATION(pedParam0, func_73(iParam1)) && Global_79551[1 /*14*/].f_4 == PED::GET_PED_TEXTURE_VARIATION(pedParam0, func_73(iParam1)))
	{
		return true;
	}
	...
	if (Global_80023 != 6)
	{
		...
		else
		{
			...
			if (value < 9000 && !CAM::IS_SCREEN_FADED_OUT())
			{
				...
				text = { func_226(Global_80024, Global_80026, iParam10) };
				y == -0.014f;
...
{
	if (!func_238(0) || Global_80039 || Global_80027 == 1 || !CAM::IS_SCREEN_FADED_IN())
		return false;
...
{
	return func_240(iParam0, Global_44392);
}
...
struct<5> func_249(int iParam0) // Position - 0x272CB
{
	...
	switch (iParam0)
	{
		...
		case 243:
			...
			unk.f_3 = func_250(&Global_4718592.f_235581[0 /*160*/]);
			unk.f_4 = unk.f_3;
			break;
	
		case 244:
			unk = { Global_4718592.f_235581[1 /*160*/].f_16 };
			unk.f_3 = func_250(&Global_4718592.f_235581[1 /*160*/]);
			unk.f_4 = unk.f_3;
			break;
	
		case 245:
			unk = { Global_4718592.f_235581[2 /*160*/].f_16 };
			unk.f_3 = func_250(&Global_4718592.f_235581[2 /*160*/]);
			unk.f_4 = unk.f_3;
			break;
	
		case 246:
			unk = { Global_4718592.f_235581[3 /*160*/].f_16 };
			unk.f_3 = func_250(&Global_4718592.f_235581[3 /*160*/]);
			unk.f_4 = unk.f_3;
			break;
	
		case 247:
			unk = { Global_4718592.f_235581[4 /*160*/].f_16 };
			unk.f_3 = func_250(&Global_4718592.f_235581[4 /*160*/]);
			unk.f_4 = unk.f_3;
			break;
...
var func_250(var uParam0) // Position - 0x2A23D
{
	return uParam0;
}
...
BOOL _IS_MISSION_REPLAY_IN_PROGRESS() // Position - 0x2AE42
{
...
int func_256(int iParam0, int iParam1, int iParam2, char* sParam3) // Position - 0x2AF88
{
	...
	for (i = 0; i < 8; i = i + 1)
	{
		if (Global_56349[num /*53*/].f_52 != 0)
		{
			if (Global_56349[num /*53*/] == iParam1 && Global_56349[num /*53*/].f_1 == iParam2)
			{
				if (iParam0 == Global_56349[num /*53*/].f_3)
				{
					Global_56349[num /*53*/].f_5 = 1;
					TEXT_LABEL_ASSIGN_STRING(&(Global_56349[num /*53*/].f_6), sParam3, 16);
				}
...
int func_257(int iParam0, int iParam1, int iParam2) // Position - 0x2B004
{
	...
	for (i = 0; i < 7; i = i + 1)
	{
		if (Global_54926[i /*203*/].f_2 == iParam0)
			if (Global_54926[i /*203*/].f_1 > 0)
				num = Global_54926[i /*203*/].f_1;
	}
	...
	for (i = 0; i < 8; i = i + 1)
	{
		...
		{
			Global_56349[i /*53*/].f_52 = num;
			Global_56349[i /*53*/] = iParam0;
			Global_56349[i /*53*/].f_1 = iParam1;
			Global_56349[i /*53*/].f_2 = iParam2;
			Global_114370.f_21041.f_310 = Global_114370.f_21041.f_310 + 1;
		
			if (Global_114370.f_21041.f_310 == 0)
				Global_114370.f_21041.f_310 = 1;
		
			Global_56349[i /*53*/].f_10 = 0;
			Global_56349[i /*53*/].f_3 = Global_114370.f_21041.f_310;
			Global_56349[i /*53*/].f_4 = 1;
			Global_56348 = Global_56348 + 1;
			return Global_56349[i /*53*/].f_3;
		}
	}
...
void func_264() // Position - 0x2B63E
{
	...
	if (value > 0f && SYSTEM::FLOOR(value) < SYSTEM::FLOOR(Global_114370.f_10198.f_3853))
		func_327(13, SYSTEM::FLOOR(Global_114370.f_10198.f_3853));
...
void _STAT_SET_PACKED_BOOL(int iParam0, BOOL bParam1, int iParam2) // Position - 0x2BAFC
{
	if (iParam2 == -1)
		iParam2 = func_53();
...
{
	func_276(&Global_107913);
	return;
}

void func_276(var uParam0) // Position - 0x2BCD1
{
	int i;
	int j;
...
BOOL func_286(Ped pedParam0, int iParam1, int iParam2) // Position - 0x2C5C2
{
	Hash entityModel;
	int i;
	var unk;
	...
	{
		unk28 = { func_96(entityModel, 0) };
		Global_79551[1 /*14*/] = { func_115(entityModel, iParam1, unk28[iParam1], -1) };
	
		if (PED::GET_NUMBER_OF_PED_DRAWABLE_VARIATIONS(pedParam0, func_73(iParam1)) > 0 && PED::GET_NUMBER_OF_PED_TEXTURE_VARIATIONS(pedParam0, func_73(iParam1), Global_79551[1 /*14*/].f_3) > 0)
			PED::SET_PED_COMPONENT_VARIATION(pedParam0, func_73(iParam1), Global_79551[1 /*14*/].f_3, Global_79551[1 /*14*/].f_4, 0);
	}
...
void func_287(const char* sParam0, int iParam1) // Position - 0x2C77F
{
...
void func_289(int iParam0, int iParam1) // Position - 0x2C816
{
...
void func_290(int iParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Position - 0x2C860
{
	if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
...
void func_291(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x2C8FD
{
	var unk;
	var unk33;
	...
	if (iParam0 != -1)
	{
		...
		func_292(&unk33, unk.f_3, Global_101954, bParam1, bParam2);
	}

	return;
}

void func_292(const char* sParam0, Any anParam1, int iParam2, BOOL bParam3, BOOL bParam4) // Position - 0x2C93C
{
...
void func_294() // Position - 0x2C993
{
	...
	{
		func_8();
		GRAPHICS::SET_NEXT_PLAYER_TCMODIFIER(func_295(Global_114370.f_2367.f_539.f_4321));
	}
	else
	{
...
char* func_295(eCharacter echParam0) // Position - 0x2C9C6
{
	echParam0 = echParam0;
	return "";
}
...
BOOL IS_PLAYSTATION_PLATFORM() // Position - 0x2CA23
{
	return MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION();
}

BOOL IS_XBOX_PLATFORM() // Position - 0x2CA39
{
...
void func_303(int iParam0) // Position - 0x2CFA5
{
	...
	Global_114370.f_18578[iParam0 /*6*/].f_3 = func_304();
...
BOOL func_326(const char* sParam0) // Position - 0x31EDA
{
...
BOOL func_327(int iParam0, int iParam1) // Position - 0x31F3A
{
...
void func_328(eCharacter echParam0, eCharacter echParam1, BOOL bParam2) // Position - 0x31F8B
{
	int num;
...
struct<4> _GET_CHARACTER_NAME(eCharacter character) // Position - 0x32188
{
	return Global_2241[character /*29*/].f_3;
}

int func_331(eCharacter echParam0, int iParam1) // Position - 0x3219B
{
...
int func_332(eCharacter echParam0, int iParam1) // Position - 0x321C5
{
	if (iParam1 < 0 || iParam1 > 4)
		return 0;
...
void func_333(eCharacter echParam0, int iParam1, int iParam2) // Position - 0x321EF
{
	if (iParam1 < 0 || iParam1 > 4)
		return;
...
void func_334(eCharacter echParam0, int iParam1, int iParam2) // Position - 0x32234
{
	if (iParam1 < 0 || iParam1 > 4)
		return;
...
void _UPDATE_CURRENT_PLAYER_CHARACTER() // Position - 0x32279
{
	if (func_13(14))
	{
		if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), false))
...
void func_337(const char* sParam0, int iParam1) // Position - 0x323EB
{
	if (Global_101917 != 12)
...
BOOL func_338(const char* sParam0, int iParam1, int iParam2) // Position - 0x32413
{
...
int func_340() // Position - 0x325FC
{
	...
	num = func_341(&(Global_101917.f_3), false);
	num2 = 0;
...
int func_342(Hash hParam0, BOOL bParam1) // Position - 0x3264A
{
	int i;
...
BOOL func_344() // Position - 0x326D0
{
	...
	if (Global_101917.f_11 == 5)
		if (func_339(&(Global_101917.f_3)) > -1)
			return true;

	return false;
}

void func_345(BOOL bParam0) // Position - 0x3273C
{
