...
void func_302(var uParam0) // Position - 0x35646
{
	...
	func_303(&uLocal_122, 4494.8423f, -4522.1455f, 4.9819f, -10.7044f, 0.1567f, 155.8207f, "HS4_ISD_TAKE_VEL", 0, 1, uParam0->f_4, 0);
	return;
}

void func_303(var uParam0, float fParam1, float fParam2, float fParam3, float fParam4, float fParam5, float fParam6, char* sParam7, int iParam8, int iParam9, var uParam10, int iParam11) // Position - 0x35693
{
...
void func_304(var uParam0, char* sParam1, int iParam2, int iParam3, var uParam4) // Position - 0x356C3
{
	uParam0->f_1 = sParam1;
	uParam0->f_2 = iParam3;
...
void func_305(var uParam0, int iParam1, char* sParam2) // Position - 0x356F0
{
