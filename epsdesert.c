...
void func_1() // Position - 0xD6
{
	...
	if (Global_114370.f_10053.f_107 < fLocal_210)
	{
		if (iLocal_222 == 0)
		{
		...
		if (func_142(CHAR_MICHAEL))
		{
			if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
			{
						...
						if (func_140(PLAYER::PLAYER_PED_ID(), 12, iLocal_35))
						{
							if (func_139() && !func_167())
							{
								...
								if (distanceBetweenCoords > 0.01f)
								{
									...
									Global_114370.f_10053.f_107 = Global_114370.f_10053.f_107 + distanceBetweenCoords;
								
									if (func_134())
										if (Global_114370.f_10053.f_107 >= 8000f)
											Global_114370.f_10053.f_107 = fLocal_210;
								
									if (Global_114370.f_10053.f_107 < 1609f * 5f && (1609f * 5f) - Global_114370.f_10053.f_107 < fLocal_208 - 160.9f)
									{
										if (func_134())
										{
											num = func_133(Global_114370.f_10053.f_107);
											fLocal_218 = num;
										}
										else
										{
											value = Global_114370.f_10053.f_107 / 160.9f;
										...
										fLocal_208 = (1609f * 5f) - Global_114370.f_10053.f_107;
				...
				if (bLocal_214)
				{
					Global_114370.f_10053.f_107 = Global_114370.f_10053.f_107 + (160.9f - 5f);
					bLocal_214 = false;
				}
			}
			else
			...
			if (bLocal_211)
			{
				func_10(0.8f, 0.3f, "EPSDES_D0", fLocal_210 - Global_114370.f_10053.f_107, 1);
...
void func_4() // Position - 0x888
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (_GET_CHARACTER_MODEL(Global_114370.f_2367.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_6(character) && !func_5(14) || Global_113318)
			{
				if (Global_114370.f_2367.f_539.f_4321 != character && func_6(Global_114370.f_2367.f_539.f_4321))
...
int func_11(Ped pedParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Position - 0xA2F
{
	...
	if (iParam5 == 0)
	{
		Global_79551[1 /*14*/] = { func_64(entityModel, iParam1, iParam2, -1) };
	...
	if (iParam1 == 12)
	{
		...
		for (i = 0; i <= 14; i = i + 1)
		{
			if (unk[i] != -99)
			{
				Global_79551[1 /*14*/] = { func_64(entityModel, i, unk[i], -1) };
				...
				if (IS_BIT_SET(Global_79551[1 /*14*/].f_6, 0))
				{
					if (i == 13)
					{
						...
						for (j = 0; j <= 8; j = j + 1)
						{
							Global_79551[1 /*14*/] = { func_64(entityModel, 14, unk18[j], -1) };
							func_31(pedParam0, Global_79551[1 /*14*/].f_12, Global_79551[1 /*14*/].f_3, Global_79551[1 /*14*/].f_4);
							func_54(14);
					...
					else if (i != 14 && i != 12)
					{
						...
						if (iParam4 == -1)
							PED::SET_PED_COMPONENT_VARIATION(pedParam0, func_21(i), Global_79551[1 /*14*/].f_3, Global_79551[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(pedParam0, func_21(i)));
						else
							PED::SET_PED_COMPONENT_VARIATION(pedParam0, func_21(i), Global_79551[1 /*14*/].f_3, Global_79551[1 /*14*/].f_4, iParam4);
			...
			{
				Global_79551[1 /*14*/] = { func_64(entityModel, i, func_20(pedParam0, i, PV_COMP_INVALID), -1) };
	...
	else if (iParam1 == 13)
	{
		...
		for (j = 0; j <= 8; j = j + 1)
		{
			Global_79551[1 /*14*/] = { func_64(entityModel, 14, unk59[j], -1) };
			func_31(pedParam0, Global_79551[1 /*14*/].f_12, Global_79551[1 /*14*/].f_3, Global_79551[1 /*14*/].f_4);
			func_54(14);
	...
	{
		if (iParam4 == -1)
			PED::SET_PED_COMPONENT_VARIATION(pedParam0, func_21(iParam1), Global_79551[1 /*14*/].f_3, Global_79551[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(pedParam0, func_21(iParam1)));
		else
			PED::SET_PED_COMPONENT_VARIATION(pedParam0, func_21(iParam1), Global_79551[1 /*14*/].f_3, Global_79551[1 /*14*/].f_4, iParam4);
...
BOOL func_12(Ped pedParam0, Hash hParam1, var uParam2) // Position - 0x1240
{
	...
	{
		if (!func_140(pedParam0, Global_114370.f_2367.f_539[num /*65*/].f_64, Global_114370.f_2367.f_539[num /*65*/].f_63))
		{
...
{
	Global_79551[1 /*14*/] = { func_64(hParam0, iParam1, iParam2, -1) };
...
BOOL func_19(Ped pedParam0, Hash hParam1, var uParam2, int iParam3) // Position - 0x1B49
{
	...
	{
		if (!func_140(pedParam0, Global_114370.f_2367.f_539[num /*65*/].f_61, Global_114370.f_2367.f_539[num /*65*/].f_60) || iParam3 == 1)
		{
...
void func_54(int iParam0) // Position - 0x79A2
{
	if (IS_BIT_SET(Global_79551[1 /*14*/].f_6, 1) && !IS_BIT_SET(Global_79551[1 /*14*/].f_6, 6))
		func_62(iParam0, Global_79551[1 /*14*/].f_5, Global_79551[1 /*14*/].f_2, 2, Global_79551[1 /*14*/].f_1, 1, 0);
...
BOOL func_62(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0xA7E0
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
BOOL func_63(int iParam0) // Position - 0xB683
{
	if (!IS_BIT_SET(Global_79551[1 /*14*/].f_6, 0))
		return false;
...
struct<14> func_64(Hash hParam0, int iParam1, int iParam2, int iParam3) // Position - 0xB6CB
{
	func_127();
...
void func_65(int iParam0, int iParam1) // Position - 0xB71D
{
	switch (iParam0)
	{
		case 0:
...
void func_66(int iParam0) // Position - 0xB80D
{
	BOOL flag;
	int num;
	var unk;
	...
	func_67(&Global_79551[0 /*14*/], num6, iParam0, &unk, num2, num3, num, flag, num4, num5, false);
	return;
}

void func_67(int iParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, BOOL bParam7, int iParam8, int iParam9, BOOL bParam10) // Position - 0xCA46
{
	int num;
	int num2;
	...
	*iParam0 = iParam9;
	...
	else
	{
		...
		if (iParam1 == 11 || iParam1 == 4 || iParam1 == 6 || iParam1 == 1 || iParam1 == 14 || iParam1 == 2 || iParam1 == 8 || iParam1 == 9 || iParam1 == 10 || iParam1 == 7 || iParam1 == 12)
		{
			...
			num = func_60(func_70(iParam1, iParam0->f_2), Global_79548);
		
			if (IS_BIT_SET(num, iParam0->f_1))
				MISC::SET_BIT(&(iParam0->f_6), 1);
		
			num = func_60(func_69(iParam1, iParam0->f_2), Global_79548);
...
BOOL func_68(int iParam0, int iParam1, var uParam2) // Position - 0xCDE7
{
	*uParam2 = 979;
...
int func_69(int iParam0, int iParam1) // Position - 0xD1EC
{
	switch (iParam1)
	{
		case 0:
...
int func_70(int iParam0, int iParam1) // Position - 0xD5E7
{
	switch (iParam1)
	{
		case 0:
...
BOOL func_71(Hash hParam0, int iParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0xD9E2
{
	int num;
	int num2;
	int num3;
...
int func_72(int iParam0) // Position - 0xDA20
{
	switch (iParam0)
	{
		case -1:
...
void func_73(int iParam0, int iParam1, int iParam2, Hash hParam3) // Position - 0xDAF4
{
	int num;
	int num2;
	Hash outfit;
	...
	if (iParam0 == 12)
	{
		...
		if (outfitIndex >= 0)
		{
			...
			if (num3 > outfitIndex)
			{
				...
				func_67(&Global_79551[0 /*14*/], iParam0, iParam1, &(outfit.f_7), 0, 0, outfit.f_2, false, -1, 2, true);
				return;
			}
		}
	}
	...
	{
		func_67(&Global_79551[0 /*14*/], iParam0, iParam1, "NO_LABEL", 0, 0, 0, true, -1, 2, true);
	}
	else if (iParam0 == 14)
	{
		FILES::INIT_SHOP_PED_PROP(&outProp);
		...
		if (componentId >= 0)
		{
			...
			if (num5 > componentId)
			{
				...
				func_67(&Global_79551[0 /*14*/], iParam0, iParam1, &(outProp.f_9), outProp.f_3, outProp.f_4, outProp.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(outProp.f_1, joaat("OUTFIT_ONLY"), 0), num4, 2, outProp.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (hParam3 != -1 && Global_79749)
		{
			...
			func_67(&Global_79551[0 /*14*/], iParam0, iParam1, &(outComponent.f_9), outComponent.f_3, outComponent.f_4, outComponent.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(outComponent.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, outComponent.f_1 != 0);
			return;
		}
...
void func_74(int iParam0) // Position - 0xDD7A
{
	BOOL flag;
	int num;
	var unk;
...
void func_75(int iParam0) // Position - 0xDEC7
{
	BOOL flag;
	int num;
	var unk;
...
void func_76(int iParam0) // Position - 0xE3D4
{
	BOOL flag;
	int num;
	var unk;
...
void func_77(int iParam0) // Position - 0xE448
{
	BOOL flag;
	int num;
	var unk;
...
void func_78(int iParam0) // Position - 0xE4BB
{
	BOOL flag;
	int num;
	var unk;
...
void func_79(int iParam0) // Position - 0xE5A2
{
	BOOL flag;
	int num;
	var unk;
...
void func_80(int iParam0) // Position - 0xE8E4
{
	BOOL flag;
	int num;
	var unk;
...
void func_81(int iParam0) // Position - 0xEAEC
{
	BOOL flag;
	int num;
	var unk;
...
void func_82(int iParam0) // Position - 0xED0C
{
	BOOL flag;
	int num;
	var unk;
...
void func_83(int iParam0) // Position - 0xEE15
{
	BOOL flag;
	int num;
	var unk;
...
void func_84(int iParam0) // Position - 0xF7A7
{
	BOOL flag;
	int num;
	var unk;
...
void func_85(int iParam0) // Position - 0x10300
{
	if (iParam0 < 136)
		func_87(iParam0);
	else
...
void func_86(int iParam0) // Position - 0x10335
{
	BOOL flag;
	int num;
	var unk;
...
void func_87(int iParam0) // Position - 0x10F39
{
	BOOL flag;
	int num;
	var unk;
...
void func_88(int iParam0) // Position - 0x11E39
{
	BOOL flag;
	int num;
	var unk;
...
void func_90(int iParam0, int iParam1) // Position - 0x1205D
{
	switch (iParam0)
	{
		case 0:
...
void func_91(int iParam0) // Position - 0x1214D
{
	BOOL flag;
	int num;
	var unk;
...
void func_92(int iParam0) // Position - 0x1361A
{
	BOOL flag;
	int num;
	var unk;
...
void func_93(int iParam0) // Position - 0x13761
{
	BOOL flag;
	int num;
	var unk;
...
void func_94(int iParam0) // Position - 0x13C6B
{
	BOOL flag;
	int num;
	var unk;
...
void func_95(int iParam0) // Position - 0x142D5
{
	BOOL flag;
	int num;
	var unk;
...
void func_96(int iParam0) // Position - 0x14348
{
	BOOL flag;
	int num;
	var unk;
...
void func_97(int iParam0) // Position - 0x14418
{
	BOOL flag;
	int num;
	var unk;
...
void func_98(int iParam0) // Position - 0x14913
{
	BOOL flag;
	int num;
	var unk;
...
void func_99(int iParam0) // Position - 0x14AA4
{
	BOOL flag;
	int num;
	var unk;
...
void func_100(int iParam0) // Position - 0x15293
{
	BOOL flag;
	int num;
	var unk;
...
void func_101(int iParam0) // Position - 0x1539C
{
	BOOL flag;
	int num;
	var unk;
...
void func_102(int iParam0) // Position - 0x162BF
{
	BOOL flag;
	int num;
	var unk;
...
void func_103(int iParam0) // Position - 0x16F6C
{
	if (iParam0 < 107)
		func_106(iParam0);
	else if (iParam0 < 227)
...
void func_104(int iParam0) // Position - 0x16FB2
{
	BOOL flag;
	int num;
	var unk;
...
void func_105(int iParam0) // Position - 0x17A56
{
	BOOL flag;
	int num;
	var unk;
...
void func_106(int iParam0) // Position - 0x18845
{
	BOOL flag;
	int num;
	var unk;
...
void func_107(int iParam0) // Position - 0x19484
{
	BOOL flag;
	int num;
	var unk;
...
void func_108(int iParam0) // Position - 0x196FC
{
	BOOL flag;
	int num;
	var unk;
...
void func_109(int iParam0, int iParam1) // Position - 0x19838
{
	switch (iParam0)
	{
		case 0:
...
void func_110(int iParam0) // Position - 0x19928
{
	BOOL flag;
	int num;
	var unk;
...
void func_111(int iParam0) // Position - 0x1A686
{
	BOOL flag;
	int num;
	var unk;
...
void func_112(int iParam0) // Position - 0x1A7F5
{
	BOOL flag;
	int num;
	var unk;
...
void func_113(int iParam0) // Position - 0x1AD66
{
	BOOL flag;
	int num;
	var unk;
...
void func_114(int iParam0) // Position - 0x1B28E
{
	BOOL flag;
	int num;
	var unk;
...
void func_115(int iParam0) // Position - 0x1B301
{
	BOOL flag;
	int num;
	var unk;
...
void func_116(int iParam0) // Position - 0x1B3D1
{
	BOOL flag;
	int num;
	var unk;
...
void func_117(int iParam0) // Position - 0x1B881
{
	BOOL flag;
	int num;
	var unk;
...
void func_118(int iParam0) // Position - 0x1BADC
{
	BOOL flag;
	int num;
	var unk;
...
void func_119(int iParam0) // Position - 0x1BD9C
{
	BOOL flag;
	int num;
	var unk;
...
void func_120(int iParam0) // Position - 0x1BF57
{
	BOOL flag;
	int num;
	var unk;
...
BOOL func_140(Ped pedParam0, int iParam1, int iParam2) // Position - 0x1F493
{
			...
			if (unk[i] != -99 && i != 12 && i != 14)
			{
				if (!func_140(pedParam0, i, unk[i]))
				{
					if (i == 13)
					{
						...
						for (j = 0; j <= 8; j = j + 1)
						{
							if (!func_140(pedParam0, 14, unk18[j]))
							{
								for (k = 0; k <= 19; k = k + 1)
								{
									Global_79551[2 /*14*/] = { func_64(entityModel, 14, k, -1) };
								
									if (Global_79551[2 /*14*/].f_12 == j)
										if (func_140(pedParam0, 14, k))
											if (!func_17(entityModel, iParam2, 14, k, &unk, &Global_79551[2 /*14*/]))
												return false;
								}
							}
						}
					...
					else
					{
						...
						Global_79551[2 /*14*/] = { func_64(entityModel, i, num, -1) };
					
						if (!func_17(entityModel, iParam2, i, num, &unk, &Global_79551[2 /*14*/]))
							return false;
					}
				}
			}
	...
	else if (Global_79551[1 /*14*/].f_3 == PED::GET_PED_DRAWABLE_VARIATION(pedParam0, func_21(iParam1)) && Global_79551[1 /*14*/].f_4 == PED::GET_PED_TEXTURE_VARIATION(pedParam0, func_21(iParam1)))
	{
		return true;
	}
...
{
	Global_114370.f_10053.f_107 = 0f;
	fLocal_218 = 0f;
	fLocal_208 = 1609f * 5f;
	return;
}
...
void func_169() // Position - 0x200D3
{
	if (Global_114370.f_10053.f_107 < fLocal_210)
	{
		...
		if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
		{
			...
			fLocal_218 = Global_114370.f_10053.f_107 / 160.9f;
			fLocal_208 = 1609f * 5f;
			iLocal_209 = 1;
			fLocal_232 = MISC::GET_RANDOM_FLOAT_IN_RANGE(120000f, 240000f);
			iLocal_233 = MISC::GET_GAME_TIMER();
...
void func_177() // Position - 0x204BC
{
	...
	if (Global_114370.f_10053.f_107 >= fLocal_210 || func_175(94) == true)
	{
		func_132();
		func_184(94, 1);
...
void func_179() // Position - 0x2060E
{
	...
	if (value > 0f && SYSTEM::FLOOR(value) < SYSTEM::FLOOR(Global_114370.f_10198.f_3853))
		func_183(13, SYSTEM::FLOOR(Global_114370.f_10198.f_3853));
