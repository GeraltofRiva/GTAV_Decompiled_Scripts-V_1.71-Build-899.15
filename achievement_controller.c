...
void main() // Position - 0x0
{
	...
	func_164(iLocal_66);
	func_163();
	func_161(&Global_4546910);
	func_160(&Global_4546910, 1);
	func_158(&uLocal_67);

	while (true)
	{
		if (Global_33549 != iLocal_65)
		{
			if (iLocal_65 == 0 && Global_33549 != 0)
			...
			iLocal_65 != 0 && Global_33549 == 0;
		}
	
		iLocal_65 = Global_33549;
...
void func_2() // Position - 0x29D
{
	...
	if (!PLAYER::HAS_ACHIEVEMENT_BEEN_PASSED(41))
		if (IS_BIT_SET(Global_2740191.f_2361.f_18, 1))
			func_122(41, 1);
...
void func_22(Ped pedParam0) // Position - 0xD98
{
	int i;
	int num;
...
BOOL func_23(Ped pedParam0, Hash hParam1) // Position - 0xE27
{
	var unk;
	int dlcWeaponIndex;
	int num;
...
BOOL func_24(Hash hParam0) // Position - 0x1120
{
...
Hash func_25(Hash hParam0, int iParam1) // Position - 0x1330
{
	Hash hash;
	int num;
...
BOOL func_26(Ped pedParam0, Hash hParam1, Hash hParam2) // Position - 0x136D
{
...
BOOL _DOES_ENTITY_EXIST_AND_IS_ALIVE(Ped pedParam0) // Position - 0x138C
{
...
BOOL func_28(var uParam0, Hash hParam1, int iParam2, BOOL bParam3) // Position - 0x13AD
{
	int num;
	int num2;
	int num3;
...
int func_29(Hash hParam0, int iParam1) // Position - 0x6C94
{
	int price;
	float num;
	int dlcWeaponIndex;
...
float func_30(Hash hParam0, var uParam1, float fParam2) // Position - 0xA8CE
{
	float num;
	float num2;
	int num3;
...
int func_31(Hash hParam0) // Position - 0xA9AC
{
...
int func_32(int iParam0, eCharacter echParam1) // Position - 0xAC08
{
	int num;
	int num2;
	int num3;
...
int func_33(int iParam0, eCharacter echParam1) // Position - 0xAD0C
{
	return Global_114370.f_19151[echParam1 /*271*/].f_3[iParam0 /*12*/].f_3;
}

BOOL func_34(eCharacter echParam0) // Position - 0xAD28
{
	return echParam0 < CHAR_MULTIPLAYER;
}

eCharacter _GET_CURRENT_PLAYER_CHARACTER() // Position - 0xAD34
{
	func_36();
...
void func_36() // Position - 0xAD4D
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (_GET_CHARACTER_MODEL(Global_114370.f_2367.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_34(character) && !func_155(14) || Global_113318)
			{
				if (Global_114370.f_2367.f_539.f_4321 != character && func_34(Global_114370.f_2367.f_539.f_4321))
...
eCharacter _GET_PLAYER_CHARACTER_FROM_PED(Ped pedParam0) // Position - 0xAE4A
{
	eCharacter i;
	Hash entityModel;
...
Hash _GET_CHARACTER_MODEL(eCharacter character) // Position - 0xAE87
{
...
Hash func_39(eCharacter echParam0) // Position - 0xAEAC
{
...
void func_41(char* sParam0, var uParam1, var uParam2, var uParam3, var uParam4, Hash hParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, BOOL bParam11, BOOL bParam12, int iParam13) // Position - 0xAECA
{
...
Hash func_44() // Position - 0xB617
{
	return 1384502824;
}

Hash func_45() // Position - 0xB624
{
	return -1576586413;
}

Hash func_46() // Position - 0xB631
{
	return joaat("kosatka");
}

int func_47(Hash hParam0) // Position - 0xB63E
{
	switch (hParam0)
	{
		case joaat("WEAPON_PISTOL_MK2"):
...
int func_48(Hash hParam0) // Position - 0xB69D
{
	return func_49(hParam0);
}

int func_49(Hash hParam0) // Position - 0xB6AB
{
	switch (hParam0)
	{
		case joaat("WEAPON_UNARMED"):
...
char* func_50(int iParam0, Hash hParam1) // Position - 0xBCFB
{
	int dlcWeaponIndex;
	int i;
	var unk;
...
int func_63(int iParam0, Hash hParam1, var uParam2, var uParam3) // Position - 0xD04B
{
	...
	*uParam3 = 0;
	...
	{
		case joaat("WEAPON_BAT"):
			if (!*Global_262145.f_33810 && func_75(iLocal_54, false) || func_65(iParam0, hParam1, -1))
			{
				*uParam2 = 1;
				*uParam3 = 0;
				return 1;
...
int func_109() // Position - 0x11A9E
{
	...
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS() || Global_79768)
		return 0;
...
int func_113() // Position - 0x11C04
{
	...
	{
		if (Global_33564 < numSuccessfulStuntJumps)
		{
			if (Global_33564 >= 0)
				func_128(22, numSuccessfulStuntJumps);
		
			Global_33564 = numSuccessfulStuntJumps;
		}
	}
...
int func_115() // Position - 0x11D7D
{
	...
	for (i = 0; i < 12; i = i + 1)
	{
		if (Global_114370.f_1992[0 /*121*/][i /*10*/].f_8 == 3)
			return 1;
		else if (Global_114370.f_1992[1 /*121*/][i /*10*/].f_8 == 3)
			return 1;
		else if (Global_114370.f_1992[2 /*121*/][i /*10*/].f_8 == 3)
			return 1;
	}
...
int func_116() // Position - 0x11DEA
{
	...
	for (i = 0; i < 22; i = i + 1)
	{
		if (Global_114370.f_19151[0 /*271*/].f_3[i /*12*/].f_3 == 3)
			return 1;
		else if (Global_114370.f_19151[1 /*271*/].f_3[i /*12*/].f_3 == 3)
			return 1;
		else if (Global_114370.f_19151[2 /*271*/].f_3[i /*12*/].f_3 == 3)
			return 1;
	}
...
int func_117() // Position - 0x11E60
{
	...
	for (i = 0; i < 4; i = i + 1)
	{
		if (IS_BIT_SET(Global_114370.f_24980.f_1, i))
			return 1;
	}
...
int func_118() // Position - 0x11E91
{
	...
	for (i = 0; i < 5; i = i + 1)
	{
		if (IS_BIT_SET(Global_114370.f_24983.f_2, i))
			return 1;
	}
...
int func_119() // Position - 0x11EC2
{
	...
	for (i = 0; i < 7; i = i + 1)
	{
		if (Global_114370.f_19020.f_19[i] == 1)
			return 1;
	}
...
int func_123(int iParam0, int iParam1) // Position - 0x11FF8
{
	...
	if (func_100(&Global_4546910))
	{
		if (func_126(&Global_4546910, iParam0))
			return 0;
...
int func_130(BOOL bParam0) // Position - 0x1226F
{
	...
	for (i = 0; i < Global_114370.f_18578; i = i + 1)
	{
		if (Global_114370.f_18578[i /*6*/].f_3 != -1 && func_140(i, 7))
		{
			num3 = 0;
			num4 = 0;
			...
			{
				bParam0;
				num2 = Global_114370.f_2356[i - 52 /*2*/];
				num5 = 0f;
			}
...
{
	if (func_134(iParam0, func_135(Global_64748[iParam0 /*13*/].f_4)))
		return 1;
...
int func_136(int iParam0, int iParam1, int iParam2) // Position - 0x1250D
{
	...
	{
		case 1:
			return Global_92680[iParam0 /*34*/].f_17[iParam2];
...
int func_138(int iParam0, int iParam1) // Position - 0x12C34
{
	...
	{
		case 1:
			return Global_92680[iParam0 /*34*/].f_16;
...
BOOL func_140(int iParam0, int iParam1) // Position - 0x12E20
{
	...
	{
		case 1:
			return !IS_BIT_SET(Global_92680[iParam0 /*34*/].f_15, 5);
...
int func_142(BOOL bParam0) // Position - 0x131A4
{
	...
	for (i = 0; i < Global_114370.f_9089.f_330; i = i + 1)
	{
		if (Global_114370.f_9089.f_330[i /*6*/].f_3 != -1 && func_140(i, 1))
		{
			num3 = 0;
			num4 = 0;
			num7 = -1;
...
int func_143(int iParam0) // Position - 0x132BE
{
	...
	num = func_135(Global_64748[iParam0 /*13*/].f_4);
...
int func_151() // Position - 0x1353C
{
	...
	if (func_152(ped, 0) || IS_BIT_SET(Global_97743, 2))
		num = num + 1;

	ped = func_153(CHAR_FRANKLIN);

	if (func_152(ped, 0) || IS_BIT_SET(Global_97743, 1))
		num = num + 1;

	ped = func_153(CHAR_MICHAEL);

	if (func_152(ped, 0) || IS_BIT_SET(Global_97743, 0))
		num = num + 1;
...
Ped func_153(eCharacter echParam0) // Position - 0x1360B
{
	...
	return Global_99370[func_154(echParam0)];
}
...
void func_161(var uParam0) // Position - 0x13708
{
	...
	func_107(uParam0, Global_4546909 - 0.5f);
	return;
}
