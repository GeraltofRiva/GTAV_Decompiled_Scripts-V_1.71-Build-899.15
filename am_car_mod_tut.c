...
void main() // Position - 0x0
{
	...
	while (true)
	{
		...
		switch (func_291(NETWORK::PARTICIPANT_ID_TO_INT()))
		{
			case 0:
				if (func_290() == 2)
	...
	if (NETWORK::NETWORK_IS_HOST_OF_THIS_SCRIPT())
	{
		...
		if (NETWORK::NETWORK_IS_PARTICIPANT_ACTIVE(player))
		{
			...
			if (_NETWORK_IS_PLAYER_VALID(playerIndex, false, true))
				!IS_BIT_SET(Global_1845274[plLocal_138 /*877*/].f_144, 4);
		}
...
void func_46(var uParam0) // Position - 0x1725
{
	...
	if (uParam0->f_6 >= uParam0->f_2.f_2)
	{
		...
		if (func_72(*uParam0, uParam0->f_1, false, false))
		{
			...
			if (!Global_2740191.f_7134.f_1 && func_111(*uParam0) >= uParam0->f_1)
			{
...
void func_53(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7) // Position - 0x2CA2
{
	int i;
...
void _STAT_SET_PACKED_BOOL(int iParam0, BOOL bParam1, int iParam2) // Position - 0x2EBD
{
	if (iParam2 == -1)
		iParam2 = func_15();
...
int func_57(int iParam0) // Position - 0x2F5B
{
	switch (iParam0)
	{
		case 0:
...
void func_58(int iParam0, int iParam1) // Position - 0x2FA9
{
	int num;
	BOOL address;
	int offset;
...
void func_59(int iParam0, int iParam1) // Position - 0x2FFA
{
	int num;
	int offset;
...
int func_60(int iParam0) // Position - 0x30B5
{
	return func_61(iParam0) / 8;
}

int func_61(int iParam0) // Position - 0x30C6
{
	switch (iParam0)
	{
		case 2:
...
void func_62(int iParam0, int iParam1) // Position - 0x3244
{
	var entityCoords;
	int num;
	Hash hash;
...
Hash func_63(int iParam0) // Position - 0x3297
{
	var unk;
...
char* func_64(int iParam0) // Position - 0x32B6
{
	switch (iParam0)
	{
		case 0:
...
Hash func_65(int iParam0) // Position - 0x347B
{
	switch (iParam0)
	{
		case 0:
...
Hash func_66() // Position - 0x34E7
{
	return MISC::GET_HASH_KEY("PROGRESS_HUB_TIER_COMPLETED");
}

int func_67() // Position - 0x34F7
{
	if (Global_1668418 == 0)
		func_68();
...
int func_69(int iParam0, int iParam1) // Position - 0x353E
{
	if (iParam1 == 4)
		iParam1 = 3;
...
int func_70(int iParam0) // Position - 0x355A
{
	return func_61(iParam0) % 8;
}

int func_71(int iParam0) // Position - 0x356B
{
	int num;
...
BOOL func_72(int iParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Position - 0x3581
{
	BOOL flag;
	int num;
	int num2;
...
BOOL func_73(int iParam0, int iParam1) // Position - 0x361E
{
	BOOL flag;
	BOOL flag2;
...
BOOL func_74(int iParam0, int iParam1) // Position - 0x363F
{
	int i;
...
int func_75(int iParam0, int iParam1) // Position - 0x478E
{
	if (func_76(iParam0))
	{
		switch (iParam1)
...
BOOL func_76(int iParam0) // Position - 0x4801
{
	int num;
...
int func_77(int iParam0) // Position - 0x4829
{
	switch (iParam0)
	{
		case 26:
...
int func_78(int iParam0, int iParam1, int iParam2) // Position - 0x492F
{
	int num;
	int i;
	int num2;
...
int func_79(int iParam0) // Position - 0x499B
{
	if (func_76(iParam0))
		return 13;
...
void func_80(int iParam0) // Position - 0x49B6
{
	int num;
	int num2;
	int offset;
...
int func_81(int iParam0) // Position - 0x49F4
{
	return iParam0 % 32;
}

int func_82(int iParam0) // Position - 0x4A01
{
	return iParam0 / 32;
}

int func_83(int iParam0) // Position - 0x4A0E
{
	switch (iParam0)
	{
		case 16:
...
void func_84(var uParam0) // Position - 0x5A8D
{
	int num;
	int num2;
	int num3;
...
int func_85(int iParam0) // Position - 0x5AC9
{
	switch (iParam0)
	{
		case 2:
...
void func_86(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7) // Position - 0x6654
{
	var entityCoords;
	int num;
	Hash hash;
...
Hash func_87(int iParam0, var uParam1, int iParam2) // Position - 0x66BD
{
	var unk;
...
char* func_88(int iParam0) // Position - 0x69BC
{
	var unk;
...
char* func_89(var uParam0) // Position - 0x69D6
{
	return uParam0;
}

char* func_90(int iParam0) // Position - 0x69E0
{
	switch (iParam0)
	{
		case 0:
...
Hash func_91(BOOL bParam0) // Position - 0x6A34
{
	if (bParam0)
...
BOOL func_92(int iParam0, int iParam1) // Position - 0x6A57
{
	int i;
	BOOL flag;
	BOOL flag2;
	...
	switch (iParam0)
	{
		...
		case 31:
			switch (iParam1)
			{
				...
				case 343:
					flag = func_16(&_STAT_SET_PACKED_BOOL, -1);
					break;
...
BOOL func_93(int iParam0, int iParam1) // Position - 0xC2E4
{
	Hash statHash;
	BOOL outValue;
...
Hash func_94(int iParam0, int iParam1) // Position - 0xC308
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(10, iParam0, func_14(iParam1));
}

BOOL func_95() // Position - 0xC31E
{
	int num;
	BOOL flag;
...
void func_96(int iParam0, BOOL bParam1, int iParam2) // Position - 0xC365
{
	if (iParam2 == -1)
		iParam2 = func_15();
...
BOOL func_97() // Position - 0xC38D
{
	...
	func_12(11960, Global_2740191.f_6950.f_3, -1, true);
	return flag;
}

BOOL func_98() // Position - 0xC406
{
	BOOL address;
	int i;
	Hash weaponHash;
...
int func_99(int iParam0) // Position - 0xC4FC
{
	iParam0 = iParam0 / 32;
...
Hash func_100(int iParam0) // Position - 0xC56F
{
	switch (iParam0)
	{
		case 34:
...
var func_101(BOOL bParam0, var uParam1, var uParam2) // Position - 0xCBB0
{
	if (bParam0)
		return uParam1;
...
BOOL func_102(int iParam0, int iParam1) // Position - 0xCBC7
{
	Hash statHash;
	int outValue;
...
Hash func_103(int iParam0, int iParam1) // Position - 0xCBEB
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(8, iParam0, func_14(iParam1));
}

BOOL func_104(BOOL bParam0) // Position - 0xCC01
{
	int num;
	BOOL flag;
...
void func_105(var uParam0, int iParam1) // Position - 0xCC41
{
	*uParam0 = *uParam0 - *uParam0 && iParam1;
	return;
}

BOOL func_106() // Position - 0xCC56
{
	int num;
	int num2;
...
int func_107(BOOL bParam0) // Position - 0xCE9B
{
	if (bParam0)
		return 1;
...
int _STAT_GET_PACKED_INT(int iParam0, int iParam1) // Position - 0xCEAD
{
	if (iParam1 == -1)
		iParam1 = func_15();
...
BOOL func_109(int iParam0, var uParam1) // Position - 0xCEC9
{
	int i;
...
int func_110(int iParam0, int iParam1, int iParam2) // Position - 0xCF41
{
	switch (iParam1)
	{
		case 9:
...
int func_111(int iParam0) // Position - 0xDF2D
{
	int num;
	int num2;
	int num3;
...
BOOL func_112(int iParam0, BOOL bParam1) // Position - 0xDF73
{
	if (iParam0 == -1)
		return false;
...
int func_113(int iParam0) // Position - 0xDF8F
{
	switch (iParam0)
	{
		case 13035:
...
int func_114(int iParam0) // Position - 0xE3CB
{
	switch (iParam0)
	{
		case 0:
...
void func_115(BOOL bParam0, BOOL bParam1) // Position - 0xE3E9
{
	BOOL flag;
...
BOOL func_116(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0xE49A
{
	int num;
	int num2;
...
BOOL func_118(Player plParam0, int iParam1) // Position - 0xE678
{
	if (!func_39())
		return false;
	...
	return func_119(&(Global_1845274[plParam0 /*877*/].f_816), func_120(iParam1));
}

BOOL func_119(var uParam0, int iParam1) // Position - 0xE6B8
{
	int num;
	int num2;
	int num3;
...
int func_120(int iParam0) // Position - 0xE6DB
{
	switch (iParam0)
	{
		case 86:
...
BOOL func_121() // Position - 0xE8C7
{
	return IS_BIT_SET(Global_1845274[PLAYER::PLAYER_ID() /*877*/].f_144, 3);
}

BOOL func_122(BOOL bParam0) // Position - 0xE8DE
{
	if (bParam0)
		return func_125();
...
BOOL func_123(int iParam0) // Position - 0xE8FA
{
	return iParam0 > 0 && iParam0 < 6;
}

int func_124() // Position - 0xE90F
{
	return Global_1908496[PLAYER::PLAYER_ID() /*313*/].f_273;
}

BOOL func_125() // Position - 0xE925
{
	return func_38(526, -1) || unk_0xB233964AC562A357() && func_127() != 0 && !func_126(0);
}

BOOL func_126(int iParam0) // Position - 0xE955
{
	int num;
...
int func_127() // Position - 0xE96C
{
	return unk_0xA0A0D77ECEDD4136();
}

void func_128(int iParam0, BOOL bParam1) // Position - 0xE978
{
	int offset;
	int num;
...
void func_130(BOOL bParam0) // Position - 0xEA43
{
	if (bParam0)
	{
...
void func_131(Player plParam0, int iParam1) // Position - 0xEAAA
{
	func_132(&(Global_1845274[plParam0 /*877*/].f_816), func_120(iParam1));
	return;
}

int func_132(var uParam0, int iParam1) // Position - 0xEAC9
{
	int num;
	int num2;
	int offset;
...
BOOL func_133(Player plParam0) // Position - 0xEB01
{
	if (func_35())
		return true;
...
BOOL func_137(int iParam0) // Position - 0xEBD1
{
	if (func_138())
		return true;
...
BOOL func_138() // Position - 0xEBEC
{
	return func_139() != -1;
}

int func_139() // Position - 0xEBFA
{
	return Global_2684748.f_767;
}

BOOL func_140(int iParam0) // Position - 0xEC09
{
	int num;
	int num2;
...
int func_141(int iParam0) // Position - 0xEE37
{
	int num;
...
int func_142(int iParam0) // Position - 0xEF04
{
	if (func_35())
		return 1;
...
BOOL func_143(int iParam0) // Position - 0xF1E2
{
	if (Global_1574612)
		return true;
...
int func_144(int iParam0, BOOL bParam1) // Position - 0xF213
{
	bParam1;
	return func_145(iParam0, 0);
}

int func_145(int iParam0, int iParam1) // Position - 0xF227
{
	int i;
	int value;
	int value2;
...
int func_146(int iParam0) // Position - 0xF2E2
{
	int num;
	int num2;
...
int func_147(Player plParam0, BOOL bParam1) // Position - 0xF826
{
	bParam1;
	return func_148(plParam0);
}

int func_148(Player plParam0) // Position - 0xF839
{
...
BOOL func_149(Player plParam0) // Position - 0xF890
{
...
BOOL func_150(Player plParam0) // Position - 0xF8AF
{
	Player player;
...
void func_152(BOOL bParam0) // Position - 0xF901
{
	if (bParam0)
		MISC::SET_BIT(&(Global_1845274[PLAYER::PLAYER_ID() /*877*/].f_144), 18);
	else
		MISC::CLEAR_BIT(&(Global_1845274[PLAYER::PLAYER_ID() /*877*/].f_144), 18);

	return;
}

void func_153(int iParam0, BOOL bParam1) // Position - 0xF937
{
	if (bParam1)
...
void func_154(int iParam0, BOOL bParam1) // Position - 0xF994
{
	bParam1;
	HUD::DOES_BLIP_EXIST(Global_101969.f_271[iParam0]);
	return;
}

void func_155(int iParam0, BOOL bParam1) // Position - 0xF9B3
{
	switch (iParam0)
	{
		case 39:
...
void func_156(int iParam0, BOOL bParam1) // Position - 0xFA2B
{
	if (bParam1)
	{
		...
		case 0:
			if (!IS_BIT_SET(uLocal_139[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_2, 0))
			{
				if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
				{
					if (!IS_BIT_SET(iLocal_237, 5))
					{
						if (PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) == 0)
						{
							...
							if (!PED::IS_PED_SITTING_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID()))
							{
								...
								if (!IS_BIT_SET(iLocal_237, 2))
								{
									...
									MISC::CLEAR_BIT(&iLocal_237, 3);
									func_285("FM_CTUT_CAR" /*Get a vehicle.*/, false);
							...
							else
							{
								...
								if (!func_245(vehiclePedIsIn, false, &unk) || !func_244(vehiclePedIsIn) || func_243(ENTITY::GET_ENTITY_MODEL(vehiclePedIsIn)))
								{
									if (func_242())
										func_241(false);
									...
									if (!IS_BIT_SET(iLocal_237, 7))
									{
										func_285("FM_CTUT_ANO" /*Get a vehicle.*/, false);
									...
									if (!IS_BIT_SET(iLocal_237, 8))
									{
										if (func_236())
										{
											if (VEHICLE::IS_VEHICLE_DRIVEABLE(vehiclePedIsIn, false))
											{
												if (iLocal_245 > 0)
												{
													if (func_243(ENTITY::GET_ENTITY_MODEL(vehiclePedIsIn)))
													{
													...
													else if (!func_244(vehiclePedIsIn))
													{
														MISC::SET_BIT(&iLocal_237, 8);
														_DISPLAY_HELP_TEXT("FM_CTUT_DRI" /*Only the driver can modify a vehicle.*/, -1);
													}
													else if (!func_245(vehiclePedIsIn, false, &unk))
													{
														MISC::SET_BIT(&iLocal_237, 8);
								...
								else
								{
									...
									if (!func_231() || func_231() && PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID()))
									{
										if (!IS_BIT_SET(iLocal_237, 3))
										{
											func_285("FM_CTUT_MOD" /*Go to Los Santos Customs.*/, false);
									...
									else if (func_231() && !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID()))
									{
										if (!IS_BIT_SET(iLocal_237, 3))
											MISC::SET_BIT(&iLocal_237, 3);
									}
						...
						else
						{
							if (!IS_BIT_SET(iLocal_237, 10))
							{
								...
								{
									func_285("FM_IHELP_LCP" /*Lose the Cops.*/, false);
							...
							if (func_242())
							{
								if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
								{
									if (PED::IS_PED_SITTING_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID()))
									{
										...
										if (!func_245(vehiclePedIsIn, false, &unk2) || !func_244(vehiclePedIsIn) || func_243(ENTITY::GET_ENTITY_MODEL(vehiclePedIsIn)))
											func_241(false);
									}
									else
									{
					...
					if (IS_BIT_SET(iLocal_237, 3) || func_231() && IS_BIT_SET(iLocal_237, 10))
					{
						if (func_231())
						{
							...
							if (!IS_BIT_SET(iLocal_237, 9))
							{
								if (func_203())
								{
									...
									MISC::SET_BIT(&(Global_2740191.f_1862), 25);
							...
							if (func_202())
							{
								if (!IS_BIT_SET(Global_2740191.f_1862, 25))
									MISC::SET_BIT(&(Global_2740191.f_1862), 25);
								...
								if (func_198(PLAYER::PLAYER_ID()) || !func_196() && func_195())
								{
									...
									if (num > 0)
										if (!func_205("FM_CTUT_REP" /*Get your vehicle repaired.*/))
											func_285("FM_CTUT_REP" /*Get your vehicle repaired.*/, false);
									else if (!func_186())
										if (!func_205("FM_CTUT_RSP" /*Get your vehicle resprayed.*/))
											func_285("FM_CTUT_RSP" /*Get your vehicle resprayed.*/, false);
									else if (!func_184())
										if (!func_205("FM_IHELP_PTRK" /*Purchase a Tracker for your vehicle.*/))
											func_285("FM_IHELP_PTRK" /*Purchase a Tracker for your vehicle.*/, false);
									else if (!func_181())
										if (!func_205("FM_IHELP_PINS" /*Purchase Insurance for your vehicle.*/))
											func_285("FM_IHELP_PINS" /*Purchase Insurance for your vehicle.*/, false);
								}
							}
						}
						else if (IS_BIT_SET(iLocal_237, 9))
					...
					if (!IS_BIT_SET(iLocal_237, 5))
					{
						if (func_165(PLAYER::PLAYER_ID(), true, false) || func_164() || func_163() > 0 || !func_161() && !func_231())
						{
							MISC::SET_BIT(&iLocal_237, 5);
							func_24();
						}
					}
					else if (PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID()) || func_231())
					{
						if (CAM::IS_SCREEN_FADED_IN())
						{
							if (!func_165(PLAYER::PLAYER_ID(), true, false) && !func_164() && func_163() == 0 && func_161() || func_231())
							{
								...
								else if (_STOPWATCH_HAS_TIME_PASSED(&uLocal_240, 7000, false) || func_231())
								{
...
void func_158() // Position - 0x101E7
{
	if (PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) != 0)
		return;
...
BOOL func_159() // Position - 0x10366
{
	if (IS_BIT_SET(uLocal_139[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_2, 0))
		return true;
...
BOOL _STOPWATCH_IS_INITIALIZED(var uParam0) // Position - 0x10382
{
	return uParam0->f_1;
}

BOOL func_161() // Position - 0x1038E
{
	if (func_162() == 0)
		return true;
...
int func_162() // Position - 0x103A3
{
	return Global_1574634.f_18;
}

int func_163() // Position - 0x103B1
{
	return Global_1845274[PLAYER::PLAYER_ID() /*877*/].f_186;
}

BOOL func_164() // Position - 0x103C6
{
	return IS_BIT_SET(Global_1845274[PLAYER::PLAYER_ID() /*877*/].f_36.f_18, 0);
}

BOOL func_165(Player plParam0, BOOL bParam1, BOOL bParam2) // Position - 0x103DF
{
	if (bParam1)
...
BOOL func_166(Player plParam0) // Position - 0x10411
{
	return func_167(plParam0);
}

BOOL func_167(Player plParam0) // Position - 0x1041F
{
	return IS_BIT_SET(Global_1845274[plParam0 /*877*/].f_11.f_1, 0);
}

void _SET_PLAYER_CONTROL_EX(Player plParam0, BOOL bParam1, eSetPlayerControlFlags espcfParam2, BOOL bParam3) // Position - 0x10436
{
		...
		if (NETWORK::NETWORK_IS_PLAYER_ACTIVE(plParam0) && PLAYER::IS_PLAYER_PLAYING(plParam0) || bParam3 == true)
		{
			...
			else
			{
				if (!func_172(playerPed) && !ENTITY::IS_ENTITY_ATTACHED_TO_ANY_VEHICLE(playerPed))
				{
					...
					if (func_169(*Global_4718592.f_197275))
...
BOOL func_169(int iParam0) // Position - 0x108EA
{
	return iParam0 == 17;
}

void func_170() // Position - 0x108F7
{
	var unk;
...
void func_171() // Position - 0x10944
{
...
BOOL func_172(Ped pedParam0) // Position - 0x10982
{
...
void func_173(BOOL bParam0, Ped pedParam1, int iParam2) // Position - 0x109B3
{
	int num;
	eViewModeContext i;
...
void _MPPLY_STAT_SET_BOOL(Hash hParam0, BOOL bParam1) // Position - 0x10A83
{
	Hash statName;
...
void func_175() // Position - 0x10A9F
{
	eViewModeContext i;
...
BOOL func_176(Player plParam0) // Position - 0x10AF7
{
...
BOOL func_177() // Position - 0x10B36
{
	return IS_BIT_SET(Global_2621446, 3);
}

BOOL func_178(Player plParam0, int iParam1) // Position - 0x10B44
{
	BOOL flag;
...
int func_179(int iParam0, BOOL bParam1) // Position - 0x10B9D
{
	int num;
	int num2;
...
BOOL func_180() // Position - 0x10BDE
{
...
BOOL func_181() // Position - 0x10C0F
{
	if (Global_101969.f_1496)
		return true;

	if (_GET_ACTIVE_PV_SLOT() >= 0)
		if (IS_BIT_SET(Global_1586547[_GET_ACTIVE_PV_SLOT() /*143*/].f_104, 2))
			return true;

	return false;
}

int _GET_ACTIVE_PV_SLOT() // Position - 0x10C43
{
	if (Global_2359296[func_183() /*5571*/].f_681.f_2 >= 547)
	{
		Global_2359296[func_183() /*5571*/].f_681.f_2 = -1;
		return -1;
	}

	return Global_2359296[func_183() /*5571*/].f_681.f_2;
}

int func_183() // Position - 0x10C86
{
	int num;
...
BOOL func_184() // Position - 0x10C93
{
	Vehicle vehiclePedIsIn;
	...
	if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
	{
		...
		if (func_185(vehiclePedIsIn, true) || Global_101969.f_1495)
			return true;
	}
...
int func_185(Vehicle veParam0, BOOL bParam1) // Position - 0x10CCE
{
	if (Global_79768)
...
BOOL func_186() // Position - 0x10D22
{
	Vehicle vehiclePedIsIn;
...
BOOL func_187(Vehicle veParam0) // Position - 0x10D4F
{
	return DECORATOR::DECOR_EXIST_ON(veParam0, "Sprayed_Vehicle_Decorator");
}

int func_188(Vehicle veParam0, BOOL bParam1) // Position - 0x10D61
{
	int value;
	int num;
	int i;
...
BOOL func_189(Vehicle veParam0) // Position - 0x1110F
{
...
BOOL func_190(Hash hParam0, int iParam1) // Position - 0x11160
{
	switch (hParam0)
	{
		case joaat("faction2"):
...
BOOL func_191(Player plParam0) // Position - 0x11546
{
...
Player _INVALID_PLAYER_INDEX() // Position - 0x11577
{
	return -1;
}

BOOL func_193(Player plParam0) // Position - 0x11580
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2658019[plParam0 /*467*/].f_324.f_8 != -1)
				return func_194(Global_2658019[plParam0 /*467*/].f_324.f_8) == 22;

	return false;
}

int func_194(int iParam0) // Position - 0x115C7
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_195() // Position - 0x11B16
{
	return MISC::GET_GAME_TIMER() <= Global_24148.f_6481 + 100;
}

BOOL func_196() // Position - 0x11B2B
{
...
BOOL func_197(int iParam0) // Position - 0x11B7D
{
	return func_23(iParam0, 20, true);
}

BOOL func_198(Player plParam0) // Position - 0x11B8E
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		return false;

	return IS_BIT_SET(Global_1845274[plParam0 /*877*/].f_144, 19);
}

void func_199(BOOL bParam0) // Position - 0x11BB0
{
	if (bParam0)
		MISC::SET_BIT(&(Global_1845274[PLAYER::PLAYER_ID() /*877*/].f_144), 20);
	else
		MISC::CLEAR_BIT(&(Global_1845274[PLAYER::PLAYER_ID() /*877*/].f_144), 20);

	return;
}

BOOL func_200(Player plParam0) // Position - 0x11BE6
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		return false;

	return IS_BIT_SET(Global_1845274[plParam0 /*877*/].f_144, 20);
}

BOOL func_201(Player plParam0) // Position - 0x11C08
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		return false;

	return IS_BIT_SET(Global_1845274[plParam0 /*877*/].f_144, 21);
}

BOOL func_202() // Position - 0x11C2A
{
	if (!func_184())
		return false;
...
BOOL func_203() // Position - 0x11C57
{
...
BOOL func_204(int iParam0) // Position - 0x11CA9
{
	return func_23(iParam0, 6, true);
}

BOOL func_205(char* sParam0) // Position - 0x11CB9
{
...
BOOL func_206(char* sParam0) // Position - 0x11D0A
{
	if (!func_30())
		return false;
...
BOOL func_207(char* sParam0) // Position - 0x11D4E
{
	if (!func_30())
		return false;
...
BOOL func_208() // Position - 0x11D80
{
	return Global_1575088;
}

int func_209(Vector3 vParam0, var uParam1, var uParam2, int iParam3, int iParam4) // Position - 0x11D8C
{
	int i;
...
Vector3 func_210(int iParam0, BOOL bParam1) // Position - 0x11E0D
{
	switch (iParam0)
	{
		case -1:
		...
		case 45:
			return func_226(Global_104081);
	
		case 46:
			if (Global_1845104 != _INVALID_PLAYER_INDEX())
				if (func_225(Global_1845104))
					return func_218(2, 2);
				else if (func_217(Global_1845104))
...
Vector3 func_211() // Position - 0x12587
{
...
int func_212() // Position - 0x12882
{
	return Global_2652587.f_2706;
}

BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0x12891
{
...
int func_214() // Position - 0x128BB
{
	return Global_2658019[PLAYER::PLAYER_ID() /*467*/].f_324.f_8;
}

Vector3 func_215(float fParam0, float fParam1, float fParam2) // Position - 0x128D3
{
	return OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(func_216(), 0f, fParam0);
}

Vector3 func_216() // Position - 0x128E8
{
	return -880f, -2770f, -50f;
}

BOOL func_217(Player plParam0) // Position - 0x128FF
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
...
Vector3 func_218(int iParam0, int iParam1) // Position - 0x12957
{
	var unk;
	var unk7;
...
BOOL func_219(int iParam0, int iParam1, var uParam2, int iParam3, BOOL bParam4) // Position - 0x12A01
{
	var unk;
	Vector3 vector;
	var unk12;
...
Vector3 func_220(float fParam0, var uParam1, var uParam2, float fParam3) // Position - 0x12A96
{
	float num;
	float num2;
	float num3;
...
struct<6> func_221(int iParam0) // Position - 0x12ADA
{
	var unk;
...
struct<6> func_222(int iParam0) // Position - 0x12C5E
{
	return func_223(iParam0);
}

struct<6> func_223(int iParam0) // Position - 0x12C6C
{
	var unk;
...
BOOL func_224(int iParam0, var uParam1) // Position - 0x13733
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_225(Player plParam0) // Position - 0x137B5
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
...
Vector3 func_226(int iParam0) // Position - 0x1380D
{
	switch (iParam0)
	{
		case 1:
...
int func_227() // Position - 0x13AC9
{
	return func_228(PLAYER::PLAYER_ID());
}

int func_228(Player plParam0) // Position - 0x13AD9
{
	return MISC::GET_BITS_IN_RANGE(Global_2658019[plParam0 /*467*/].f_324.f_3, 28, 31);
}

BOOL func_229(int iParam0) // Position - 0x13AF6
{
	BOOL flag;
...
BOOL func_230(Player plParam0) // Position - 0x13BA3
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		return false;

	return IS_BIT_SET(Global_1845274[plParam0 /*877*/].f_144, 18);
}

BOOL func_231() // Position - 0x13BC5
{
...
BOOL _IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(char* message) // Position - 0x13C17
{
	HUD::BEGIN_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(message);
	return HUD::END_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(0);
}

void _STOPWATCH_DESTROY(var uParam0) // Position - 0x13C2A
{
	uParam0->f_1 = 0;
	return;
}

BOOL _STOPWATCH_HAS_TIME_PASSED(var pStopwatch, int millis, BOOL useLocalTimer) // Position - 0x13C37
{
	if (millis == -1)
		return true;
...
void _DISPLAY_HELP_TEXT(char* text, int iParam1) // Position - 0x13C95
{
...
BOOL func_236() // Position - 0x13CAC
{
	if (!_NETWORK_IS_PLAYER_VALID(PLAYER::PLAYER_ID(), true, true) || PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID()) || func_240(8, -1) || func_240(15, -1) || func_239() || func_240(3, -1) || HUD::IS_HELP_MESSAGE_BEING_DISPLAYED() || func_165(PLAYER::PLAYER_ID(), true, false) || func_164() || func_195() || func_238() || func_237() || HUD::IS_PAUSE_MENU_ACTIVE())
		return false;

	return true;
}

BOOL func_237() // Position - 0x13D60
{
	return Global_2672967.f_2914.f_582;
}

BOOL func_238() // Position - 0x13D72
{
	return Global_101969.f_400 > 0;
}

BOOL func_239() // Position - 0x13D83
{
	return Global_2625240;
}

BOOL func_240(int iParam0, int iParam1) // Position - 0x13D8F
{
	switch (iParam0)
	{
		case 5:
...
void func_241(BOOL bParam0) // Position - 0x13DC7
{
	if (bParam0)
		MISC::SET_BIT(&(Global_2740191.f_1865), 4);
	else
		MISC::CLEAR_BIT(&(Global_2740191.f_1865), 4);

	return;
}

BOOL func_242() // Position - 0x13DEF
{
	return IS_BIT_SET(Global_2740191.f_1865, 4);
}

BOOL func_243(Hash hParam0) // Position - 0x13E00
{
	switch (hParam0)
	{
		case joaat("adder"):
...
BOOL func_244(Vehicle veParam0) // Position - 0x14C3C
{
...
BOOL func_245(Vehicle veParam0, BOOL bParam1, var uParam2) // Position - 0x14C66
{
	Hash entityModel;
	BOOL flag;
	...
	*uParam2 = 0;
	...
	if (!func_283(entityModel, bParam1, uParam2) && !func_282(PLAYER::PLAYER_ID()) && !func_258(veParam0))
		return false;

	if (func_282(PLAYER::PLAYER_ID()))
		if (func_255(entityModel))
			return true;
		else
			return false;
	...
	if (func_254(PLAYER::PLAYER_ID()) && VEHICLE::IS_THIS_MODEL_A_HELI(entityModel) || VEHICLE::IS_THIS_MODEL_A_PLANE(entityModel))
		flag = true;

	if (VEHICLE::IS_BIG_VEHICLE(veParam0) && !func_251(veParam0) && !flag && !(func_250(ENTITY::GET_ENTITY_MODEL(veParam0)) && func_249(PLAYER::PLAYER_ID())) && !(func_248(ENTITY::GET_ENTITY_MODEL(veParam0)) && func_247(PLAYER::PLAYER_ID())))
	{
		switch (ENTITY::GET_ENTITY_MODEL(veParam0))
		{
			case joaat("cerberus"):
	...
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		if (func_246(veParam0) && ENTITY::GET_ENTITY_MODEL(veParam0) != joaat("sentinel2") && ENTITY::GET_ENTITY_MODEL(veParam0) != joaat("issi2"))
		{
			*uParam2 = 2;
			return false;
		}
...
BOOL func_246(Vehicle veParam0) // Position - 0x14DF1
{
	int i;
...
BOOL func_247(Player plParam0) // Position - 0x14E2C
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2658019[plParam0 /*467*/].f_324.f_8 != -1)
				return func_194(Global_2658019[plParam0 /*467*/].f_324.f_8) == 32;

	return false;
}

BOOL func_248(Hash hParam0) // Position - 0x14E73
{
...
BOOL func_249(Player plParam0) // Position - 0x14E8A
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2658019[plParam0 /*467*/].f_324.f_8 != -1)
				return func_194(Global_2658019[plParam0 /*467*/].f_324.f_8) == 11;

	return false;
}

BOOL func_250(Hash hParam0) // Position - 0x14ED1
{
...
BOOL func_251(Vehicle veParam0) // Position - 0x14F13
{
	switch (ENTITY::GET_ENTITY_MODEL(veParam0))
	{
		case joaat("halftrack"):
...
BOOL func_252(Player plParam0) // Position - 0x14FDB
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2658019[plParam0 /*467*/].f_324.f_8 != -1)
				return func_194(Global_2658019[plParam0 /*467*/].f_324.f_8) == 26;

	return false;
}

BOOL func_253(Player plParam0) // Position - 0x15022
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2658019[plParam0 /*467*/].f_324.f_8 != -1)
				return func_194(Global_2658019[plParam0 /*467*/].f_324.f_8) == 13;

	return false;
}

BOOL func_254(Player plParam0) // Position - 0x15069
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2658019[plParam0 /*467*/].f_324.f_8 != -1)
				return func_194(Global_2658019[plParam0 /*467*/].f_324.f_8) == 7;

	return false;
}

BOOL func_255(Hash hParam0) // Position - 0x150AF
{
	BOOL flag;
	...
	if (!func_257(PLAYER::PLAYER_ID()) && hParam0 != joaat("thruster") && hParam0 != joaat("avenger") && hParam0 != func_256(true) && !flag)
		return false;

	return true;
}

Hash func_256(BOOL bParam0) // Position - 0x15140
{
	if (bParam0)
...
BOOL func_257(Player plParam0) // Position - 0x1515A
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
...
BOOL func_258(Vehicle veParam0) // Position - 0x15180
{
...
BOOL func_259(Vehicle veParam0) // Position - 0x151AF
{
	...
	if (func_263(veParam0, false))
		return true;

	if (func_262(PLAYER::PLAYER_ID()) && !func_255(ENTITY::GET_ENTITY_MODEL(veParam0)) || VEHICLE::IS_VEHICLE_MODEL(veParam0, joaat("openwheel1")) || VEHICLE::IS_VEHICLE_MODEL(veParam0, joaat("openwheel2")) || VEHICLE::IS_VEHICLE_MODEL(veParam0, joaat("formula")) || VEHICLE::IS_VEHICLE_MODEL(veParam0, joaat("formula2")))
		return false;
...
BOOL func_260(Vehicle veParam0) // Position - 0x15317
{
	Hash entityModel;
	...
	if (ENTITY::DOES_ENTITY_EXIST(veParam0) && VEHICLE::IS_VEHICLE_DRIVEABLE(veParam0, false))
	{
		...
		if (VEHICLE::IS_BIG_VEHICLE(veParam0) && !func_251(veParam0) || func_261(entityModel))
			return true;
...
BOOL func_261(Hash hParam0) // Position - 0x15394
{
	switch (hParam0)
	{
		case joaat("mule"):
...
BOOL func_262(Player plParam0) // Position - 0x153F0
{
	if (plParam0 == _INVALID_PLAYER_INDEX())
		return false;

	if (func_282(plParam0) && Global_2658019[plParam0 /*467*/].f_324.f_11 == plParam0)
		return true;

	return false;
}

BOOL func_263(Vehicle veParam0, BOOL bParam1) // Position - 0x15429
{
	switch (ENTITY::GET_ENTITY_MODEL(veParam0))
	{
		case joaat("technical"):
		case joaat("insurgent"):
			if (func_265(ENTITY::GET_ENTITY_MODEL(veParam0), 0))
				if (Global_2740191.f_307 == veParam0)
					return true;
				else if (func_264(veParam0) != -1 && !bParam1)
					return true;
			break;
	}
...
int func_264(Vehicle veParam0) // Position - 0x15484
{
	int i;
...
BOOL func_265(Hash hParam0, int iParam1) // Position - 0x154BD
{
	if (iParam1 == 0)
...
BOOL func_266() // Position - 0x1593C
{
	return DLC::IS_DLC_PRESENT(joaat("mpsum2"));
}

BOOL func_267() // Position - 0x1594D
{
	return DLC::IS_DLC_PRESENT(joaat("mpsum"));
}

BOOL func_268() // Position - 0x1595E
{
	return DLC::IS_DLC_PRESENT(joaat("mpchristmas2018"));
}

BOOL func_269() // Position - 0x1596F
{
	return DLC::IS_DLC_PRESENT(joaat("mpgunrunning"));
}

BOOL func_270() // Position - 0x15980
{
	return DLC::IS_DLC_PRESENT(joaat("mpimportexport"));
}

BOOL func_271() // Position - 0x15991
{
	return DLC::IS_DLC_PRESENT(joaat("mpjanuary2016"));
}

BOOL func_272() // Position - 0x159A2
{
	return DLC::IS_DLC_PRESENT(joaat("mplowrider2"));
}

BOOL func_273() // Position - 0x159B3
{
	return DLC::IS_DLC_PRESENT(joaat("mplowrider"));
}

BOOL func_274(Vehicle veParam0) // Position - 0x159C4
{
	if (PLAYER::PLAYER_ID() != _INVALID_PLAYER_INDEX())
	{
		if (func_279() || func_278(PLAYER::PLAYER_ID()))
			return false;
	
		if (func_277(PLAYER::PLAYER_ID(), true, false) && Global_1845274[PLAYER::PLAYER_ID() /*877*/].f_260.f_36 > 0 || IS_BIT_SET(Global_1845274[PLAYER::PLAYER_ID() /*877*/].f_260.f_34, 14) || IS_BIT_SET(Global_1845274[PLAYER::PLAYER_ID() /*877*/].f_260.f_34, 11))
			return false;
	
		if (DECORATOR::DECOR_IS_REGISTERED_AS_TYPE("Player_Vehicle", INT))
			if (DECORATOR::DECOR_EXIST_ON(veParam0, "Player_Vehicle"))
				if (DECORATOR::DECOR_GET_INT(veParam0, "Player_Vehicle") == NETWORK::NETWORK_HASH_FROM_PLAYER_HANDLE(PLAYER::PLAYER_ID()))
					if (func_276() != -1 && func_276() < 547)
						if (!func_275(veParam0) || ENTITY::GET_ENTITY_MODEL(veParam0) != Global_1586547[func_276() /*143*/].f_66)
							return true;
...
BOOL func_275(Vehicle veParam0) // Position - 0x15AD2
{
...
int func_276() // Position - 0x15AEB
{
	return Global_2359296[func_183() /*5571*/].f_681.f_2;
}

BOOL func_277(Player plParam0, BOOL bParam1, BOOL bParam2) // Position - 0x15B03
{
	if (plParam0 == _INVALID_PLAYER_INDEX())
		return false;
...
BOOL func_278(Player plParam0) // Position - 0x15B67
{
...
BOOL func_279() // Position - 0x15B98
{
	return func_214() != -1;
}

BOOL func_280(Player plParam0) // Position - 0x15BA6
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2658019[plParam0 /*467*/].f_324.f_8 != -1 && Global_2658019[plParam0 /*467*/].f_324.f_11 != _INVALID_PLAYER_INDEX())
				return func_194(Global_2658019[plParam0 /*467*/].f_324.f_8) == 5;

	return false;
}

BOOL func_281(Player plParam0) // Position - 0x15C05
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2658019[plParam0 /*467*/].f_324.f_8 != -1 && Global_2658019[plParam0 /*467*/].f_324.f_11 != _INVALID_PLAYER_INDEX())
				return func_194(Global_2658019[plParam0 /*467*/].f_324.f_8) == 8;

	return false;
}

BOOL func_282(Player plParam0) // Position - 0x15C65
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2658019[plParam0 /*467*/].f_324.f_8 != -1)
				return func_194(Global_2658019[plParam0 /*467*/].f_324.f_8) == 9;

	return false;
}

BOOL func_283(Hash hParam0, BOOL bParam1, var uParam2) // Position - 0x15CAC
{
	BOOL flag;
	...
	if (func_254(PLAYER::PLAYER_ID()) && VEHICLE::IS_THIS_MODEL_A_HELI(hParam0) || VEHICLE::IS_THIS_MODEL_A_PLANE(hParam0))
		flag = true;
...
BOOL func_284(Hash hParam0) // Position - 0x1609D
{
	switch (hParam0)
	{
		case joaat("towtruck"):
...
void func_285(char* sParam0, BOOL bParam1) // Position - 0x160D2
{
	if (MISC::IS_STRING_NULL_OR_EMPTY(sParam0))
		return;
...
void func_286() // Position - 0x1613D
{
	MISC::SET_BIT(&(Global_1574766.f_59), 1);
	return;
}

void func_287(BOOL bParam0) // Position - 0x16150
{
	if (bParam0)
	{
...
void func_288() // Position - 0x16176
{
...
BOOL func_289(BOOL bParam0) // Position - 0x1619B
{
	int num;
...
int func_290() // Position - 0x161F5
{
	return iLocal_60;
}

int func_291(int iParam0) // Position - 0x161FF
{
	return uLocal_139[iParam0 /*3*/];
}

void func_292() // Position - 0x1620D
{
	func_24();
	func_153(10, false);
...
void func_293() // Position - 0x16273
{
	SCRIPT::TERMINATE_THIS_THREAD();
	return;
}

void func_294() // Position - 0x1627F
{
	if (!func_301(1, -1))
		func_299(1, -1);
...
BOOL func_295() // Position - 0x162E9
{
...
var func_296(int iParam0) // Position - 0x16307
{
	return Global_1574538[iParam0];
}

var func_297() // Position - 0x16317
{
	return func_296(func_15() + 1);
}

BOOL func_298(int iParam0) // Position - 0x16329
{
	return Global_1931465.f_16[iParam0 /*44*/].f_3;
}

void func_299(int iParam0, int iParam1) // Position - 0x1633D
{
	int profileSetting;
	int profileSetting2;
	...
	switch (iParam0)
	{
		case 0:
			...
			profileSetting2 = func_300(iParam1);
...
int func_300(int iParam0) // Position - 0x1641E
{
	int num;
...
BOOL func_301(int iParam0, int iParam1) // Position - 0x16481
{
	int profileSetting;
	int profileSetting2;
...
Hash _GET_CURRENT_SESSION_TYPE_SCRIPT_HASH() // Position - 0x1652E
{
	switch (func_18())
	{
		case 0:
...
Hash func_304() // Position - 0x16561
{
...
BOOL func_305() // Position - 0x16585
{
	return Global_2684748.f_700;
}

BOOL _DOES_EVENT_OF_TYPE_EXIST(int iParam0) // Position - 0x16594
{
...
BOOL func_307() // Position - 0x165AB
{
	return Global_2696555;
}

BOOL func_308() // Position - 0x165B7
{
	return Global_2684748.f_695;
}

void func_309() // Position - 0x165C6
{
	SYSTEM::WAIT(0);
	return;
}

void func_310(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17, var uParam18, var uParam19, var uParam20) // Position - 0x165D3
{
	func_316(func_317(uParam0), uParam0);
...
void func_311() // Position - 0x16620
{
...
void func_312(int iParam0, int iParam1) // Position - 0x16653
{
	int profileSetting;
	int profileSetting2;
...
BOOL func_313() // Position - 0x166E4
{
	var unk;
...
int _NETWORK_ENSURE_SCRIPT_IS_NETWORKED(int iParam0, int iParam1, BOOL bNoTerminate) // Position - 0x16742
{
	int i;
...
BOOL func_315(BOOL bParam0) // Position - 0x16858
{
	bParam0;
	return Global_1575060;
}

void func_316(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17, var uParam18, var uParam19, var uParam20, var uParam21) // Position - 0x16869
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		func_293();
...
int func_317(int iParam0) // Position - 0x16888
{
	switch (iParam0)
	{
		case 3:
	...
	switch (func_318(func_319(iParam0, true)))
	{
		case 0:
			return 8;
...
int func_318(int iParam0) // Position - 0x17046
{
	switch (iParam0)
	{
		case 150:
...
int func_319(int iParam0, BOOL bParam1) // Position - 0x173D0
{
	switch (iParam0)
	{
		case 237:
