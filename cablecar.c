...
void main() // Position - 0x0
{
	...
	while (true)
	{
		...
		if (!func_309(PLAYER::PLAYER_PED_ID()) || Global_33302 == 1)
		{
			func_314(1, 1, 1, true);
			Global_33304 = 0;
...
void func_42(var uParam0, BOOL bParam1) // Position - 0x220B
{
	...
	if (uParam0->f_11 == 1 || uParam0->f_34 == 1)
	{
		...
		MISC::CLEAR_BIT(&Global_80017, 4);
		MISC::CLEAR_BIT(&Global_80017, 5);
...
int func_78(int iParam0, int iParam1) // Position - 0x3E1E
{
	...
	if (func_88(&Global_4546910))
	{
		if (func_86(&Global_4546910, iParam0))
			return 0;
...
void func_82(var uParam0) // Position - 0x3FF8
{
	...
	func_84(uParam0, Global_4546909 - 0.5f);
	return;
}
...
void func_104() // Position - 0x4387
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (_GET_CHARACTER_MODEL(Global_114370.f_2367.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_97(character) && !func_45(14) || Global_113318)
			{
				if (Global_114370.f_2367.f_539.f_4321 != character && func_97(Global_114370.f_2367.f_539.f_4321))
...
int func_123(Ped pedParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Position - 0x4CC0
{
	...
	if (iParam5 == 0)
	{
		Global_79551[1 /*14*/] = { func_171(entityModel, iParam1, iParam2, -1) };
	...
	if (iParam1 == 12)
	{
		...
		for (i = 0; i <= 14; i = i + 1)
		{
			if (unk[i] != -99)
			{
				Global_79551[1 /*14*/] = { func_171(entityModel, i, unk[i], -1) };
				...
				if (IS_BIT_SET(Global_79551[1 /*14*/].f_6, 0))
				{
					if (i == 13)
					{
						...
						for (j = 0; j <= 8; j = j + 1)
						{
							Global_79551[1 /*14*/] = { func_171(entityModel, 14, unk18[j], -1) };
							func_143(pedParam0, Global_79551[1 /*14*/].f_12, Global_79551[1 /*14*/].f_3, Global_79551[1 /*14*/].f_4);
							func_166(14);
					...
					else if (i != 14 && i != 12)
					{
						...
						if (iParam4 == -1)
							PED::SET_PED_COMPONENT_VARIATION(pedParam0, func_133(i), Global_79551[1 /*14*/].f_3, Global_79551[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(pedParam0, func_133(i)));
						else
							PED::SET_PED_COMPONENT_VARIATION(pedParam0, func_133(i), Global_79551[1 /*14*/].f_3, Global_79551[1 /*14*/].f_4, iParam4);
			...
			{
				Global_79551[1 /*14*/] = { func_171(entityModel, i, func_132(pedParam0, i, PV_COMP_INVALID), -1) };
	...
	else if (iParam1 == 13)
	{
		...
		for (j = 0; j <= 8; j = j + 1)
		{
			Global_79551[1 /*14*/] = { func_171(entityModel, 14, unk59[j], -1) };
			func_143(pedParam0, Global_79551[1 /*14*/].f_12, Global_79551[1 /*14*/].f_3, Global_79551[1 /*14*/].f_4);
			func_166(14);
	...
	{
		if (iParam4 == -1)
			PED::SET_PED_COMPONENT_VARIATION(pedParam0, func_133(iParam1), Global_79551[1 /*14*/].f_3, Global_79551[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(pedParam0, func_133(iParam1)));
		else
			PED::SET_PED_COMPONENT_VARIATION(pedParam0, func_133(iParam1), Global_79551[1 /*14*/].f_3, Global_79551[1 /*14*/].f_4, iParam4);
...
BOOL func_124(Ped pedParam0, Hash hParam1, var uParam2) // Position - 0x54D1
{
	...
	{
		if (!func_235(pedParam0, Global_114370.f_2367.f_539[num /*65*/].f_64, Global_114370.f_2367.f_539[num /*65*/].f_63))
		{
...
{
	Global_79551[1 /*14*/] = { func_171(hParam0, iParam1, iParam2, -1) };
...
BOOL func_131(Ped pedParam0, Hash hParam1, var uParam2, int iParam3) // Position - 0x5DDA
{
	...
	{
		if (!func_235(pedParam0, Global_114370.f_2367.f_539[num /*65*/].f_61, Global_114370.f_2367.f_539[num /*65*/].f_60) || iParam3 == 1)
		{
	...
	switch (hParam0)
	{
		case joaat("Player_Zero"):
			switch (iParam1)
			{
				...
				case 5:
					func_159(&unk, -99, -99, Global_114370.f_2367.f_539.f_196[0], Global_114370.f_2367.f_539.f_200[0], 6, 3, 0, 0, 0, -99, 0, 0, 3);
					break;
		...
		case joaat("Player_One"):
			switch (iParam1)
			{
				...
				case 2:
					func_159(&unk, -99, -99, Global_114370.f_2367.f_539.f_196[1], Global_114370.f_2367.f_539.f_200[1], 17, 2, 26, 0, 0, -99, 0, 45, 31);
					break;
		...
		case joaat("Player_Two"):
			switch (iParam1)
			{
				...
				case 4:
					func_159(&unk, -99, -99, Global_114370.f_2367.f_539.f_196[2], Global_114370.f_2367.f_539.f_200[2], 8, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
...
void func_166(int iParam0) // Position - 0xBC3E
{
	if (IS_BIT_SET(Global_79551[1 /*14*/].f_6, 1) && !IS_BIT_SET(Global_79551[1 /*14*/].f_6, 6))
		func_169(iParam0, Global_79551[1 /*14*/].f_5, Global_79551[1 /*14*/].f_2, 2, Global_79551[1 /*14*/].f_1, 1, 0);
...
BOOL func_169(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0xE9EA
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
BOOL func_170(int iParam0) // Position - 0xF88D
{
	if (!IS_BIT_SET(Global_79551[1 /*14*/].f_6, 0))
		return false;
...
struct<14> func_171(Hash hParam0, int iParam1, int iParam2, int iParam3) // Position - 0xF8D5
{
	func_234();
...
void func_172(int iParam0, int iParam1) // Position - 0xF927
{
	switch (iParam0)
	{
		case 0:
...
void func_173(int iParam0) // Position - 0xFA17
{
	BOOL flag;
	int num;
	var unk;
	...
	func_174(&Global_79551[0 /*14*/], num6, iParam0, &unk, num2, num3, num, flag, num4, num5, false);
	return;
}

void func_174(int iParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, BOOL bParam7, int iParam8, int iParam9, BOOL bParam10) // Position - 0x10C90
{
	int num;
	int num2;
	...
	*iParam0 = iParam9;
	...
	else
	{
		...
		if (iParam1 == 11 || iParam1 == 4 || iParam1 == 6 || iParam1 == 1 || iParam1 == 14 || iParam1 == 2 || iParam1 == 8 || iParam1 == 9 || iParam1 == 10 || iParam1 == 7 || iParam1 == 12)
		{
			...
			num = func_74(func_177(iParam1, iParam0->f_2), Global_79548);
		
			if (IS_BIT_SET(num, iParam0->f_1))
				MISC::SET_BIT(&(iParam0->f_6), 1);
		
			num = func_74(func_176(iParam1, iParam0->f_2), Global_79548);
...
BOOL func_175(int iParam0, int iParam1, var uParam2) // Position - 0x11032
{
	*uParam2 = 979;
...
int func_176(int iParam0, int iParam1) // Position - 0x11437
{
	switch (iParam1)
	{
		case 0:
...
int func_177(int iParam0, int iParam1) // Position - 0x11832
{
	switch (iParam1)
	{
		case 0:
...
BOOL func_178(Hash hParam0, int iParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0x11C2D
{
	int num;
	int num2;
	int num3;
...
int func_179(int iParam0) // Position - 0x11C6B
{
	switch (iParam0)
	{
		case -1:
...
void func_180(int iParam0, int iParam1, int iParam2, Hash hParam3) // Position - 0x11D3F
{
	int num;
	int num2;
	Hash outfit;
	...
	if (iParam0 == 12)
	{
		...
		if (outfitIndex >= 0)
		{
			...
			if (num3 > outfitIndex)
			{
				...
				func_174(&Global_79551[0 /*14*/], iParam0, iParam1, &(outfit.f_7), 0, 0, outfit.f_2, false, -1, 2, true);
				return;
			}
		}
	}
	...
	{
		func_174(&Global_79551[0 /*14*/], iParam0, iParam1, "NO_LABEL", 0, 0, 0, true, -1, 2, true);
	}
	else if (iParam0 == 14)
	{
		FILES::INIT_SHOP_PED_PROP(&outProp);
		...
		if (componentId >= 0)
		{
			...
			if (num5 > componentId)
			{
				...
				func_174(&Global_79551[0 /*14*/], iParam0, iParam1, &(outProp.f_9), outProp.f_3, outProp.f_4, outProp.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(outProp.f_1, joaat("OUTFIT_ONLY"), 0), num4, 2, outProp.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (hParam3 != -1 && Global_79749)
		{
			...
			func_174(&Global_79551[0 /*14*/], iParam0, iParam1, &(outComponent.f_9), outComponent.f_3, outComponent.f_4, outComponent.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(outComponent.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, outComponent.f_1 != 0);
			return;
		}
...
void func_181(int iParam0) // Position - 0x11FC6
{
	BOOL flag;
	int num;
	var unk;
...
void func_182(int iParam0) // Position - 0x1211D
{
	BOOL flag;
	int num;
	var unk;
...
void func_183(int iParam0) // Position - 0x1262B
{
	BOOL flag;
	int num;
	var unk;
...
void func_184(int iParam0) // Position - 0x126A0
{
	BOOL flag;
	int num;
	var unk;
...
void func_185(int iParam0) // Position - 0x12714
{
	BOOL flag;
	int num;
	var unk;
...
void func_186(int iParam0) // Position - 0x127FB
{
	BOOL flag;
	int num;
	var unk;
...
void func_187(int iParam0) // Position - 0x12B5E
{
	BOOL flag;
	int num;
	var unk;
...
void func_188(int iParam0) // Position - 0x12D6F
{
	BOOL flag;
	int num;
	var unk;
...
void func_189(int iParam0) // Position - 0x12F9F
{
	BOOL flag;
	int num;
	var unk;
...
void func_190(int iParam0) // Position - 0x130AF
{
	BOOL flag;
	int num;
	var unk;
...
void func_191(int iParam0) // Position - 0x13A4E
{
	BOOL flag;
	int num;
	var unk;
...
void func_192(int iParam0) // Position - 0x145C2
{
	if (iParam0 < 136)
		func_194(iParam0);
	else
...
void func_193(int iParam0) // Position - 0x145F7
{
	BOOL flag;
	int num;
	var unk;
...
void func_194(int iParam0) // Position - 0x151FB
{
	BOOL flag;
	int num;
	var unk;
...
void func_195(int iParam0) // Position - 0x16109
{
	BOOL flag;
	int num;
	var unk;
...
void func_196(int iParam0) // Position - 0x16236
{
	BOOL flag;
	int num;
	var unk;
...
void func_197(int iParam0, int iParam1) // Position - 0x16334
{
	switch (iParam0)
	{
		case 0:
...
void func_198(int iParam0) // Position - 0x16424
{
	BOOL flag;
	int num;
	var unk;
...
void func_199(int iParam0) // Position - 0x17915
{
	BOOL flag;
	int num;
	var unk;
...
void func_200(int iParam0) // Position - 0x17A66
{
	BOOL flag;
	int num;
	var unk;
...
void func_201(int iParam0) // Position - 0x17F71
{
	BOOL flag;
	int num;
	var unk;
...
BOOL func_235(Ped pedParam0, int iParam1, int iParam2) // Position - 0x233E7
{
			...
			if (unk[i] != -99 && i != 12 && i != 14)
			{
				if (!func_235(pedParam0, i, unk[i]))
				{
					if (i == 13)
					{
						...
						for (j = 0; j <= 8; j = j + 1)
						{
							if (!func_235(pedParam0, 14, unk18[j]))
							{
								for (k = 0; k <= 19; k = k + 1)
								{
									Global_79551[2 /*14*/] = { func_171(entityModel, 14, k, -1) };
								
									if (Global_79551[2 /*14*/].f_12 == j)
										if (func_235(pedParam0, 14, k))
											if (!func_129(entityModel, iParam2, 14, k, &unk, &Global_79551[2 /*14*/]))
												return false;
								}
							}
						}
					...
					else
					{
						...
						Global_79551[2 /*14*/] = { func_171(entityModel, i, num, -1) };
					
						if (!func_129(entityModel, iParam2, i, num, &unk, &Global_79551[2 /*14*/]))
							return false;
					}
				}
			}
	...
	else if (Global_79551[1 /*14*/].f_3 == PED::GET_PED_DRAWABLE_VARIATION(pedParam0, func_133(iParam1)) && Global_79551[1 /*14*/].f_4 == PED::GET_PED_TEXTURE_VARIATION(pedParam0, func_133(iParam1)))
	{
		return true;
	}
...
BOOL func_279(var uParam0) // Position - 0x259A4
{
	...
	switch (uParam0->f_1)
	{
		...
		case 4:
			...
			if (func_258(uParam0) == 0)
				MISC::SET_BIT(&Global_80017, 4);
			else
				MISC::SET_BIT(&Global_80017, 5);
