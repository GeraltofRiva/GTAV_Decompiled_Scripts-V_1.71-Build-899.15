...
{
	if (IS_BIT_SET(Global_114370.f_24990, 3))
		return "BB4_loiter";
	else if (IS_BIT_SET(Global_114370.f_24990, 2))
		return "BB3_loiter";
	else if (IS_BIT_SET(Global_114370.f_24990, 1))
		return "BB2_loiter";
	else if (IS_BIT_SET(Global_114370.f_24990, 0))
		return "BB1_loiter";
