...
void func_57() // Position - 0x66E4
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (_GET_CHARACTER_MODEL(Global_114370.f_2367.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_59(character) && !func_58(14) || Global_113318)
			{
...
int func_71(Ped pedParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Position - 0x6F24
{
	...
	if (iParam5 == 0)
	{
		Global_79551[1 /*14*/] = { func_124(entityModel, iParam1, iParam2, -1) };
	...
	if (iParam1 == 12)
	{
		...
		for (i = 0; i <= 14; i = i + 1)
		{
			if (unk[i] != -99)
			{
				Global_79551[1 /*14*/] = { func_124(entityModel, i, unk[i], -1) };
				...
				if (IS_BIT_SET(Global_79551[1 /*14*/].f_6, 0))
				{
					if (i == 13)
					{
						...
						for (j = 0; j <= 8; j = j + 1)
						{
							Global_79551[1 /*14*/] = { func_124(entityModel, 14, unk18[j], -1) };
							func_91(pedParam0, Global_79551[1 /*14*/].f_12, Global_79551[1 /*14*/].f_3, Global_79551[1 /*14*/].f_4);
							func_114(14);
			...
			{
				Global_79551[1 /*14*/] = { func_124(entityModel, i, func_80(pedParam0, i, PV_COMP_INVALID), -1) };
	...
	else if (iParam1 == 13)
	{
		...
		for (j = 0; j <= 8; j = j + 1)
		{
			Global_79551[1 /*14*/] = { func_124(entityModel, 14, unk59[j], -1) };
			func_91(pedParam0, Global_79551[1 /*14*/].f_12, Global_79551[1 /*14*/].f_3, Global_79551[1 /*14*/].f_4);
			func_114(14);
...
BOOL func_72(Ped pedParam0, Hash hParam1, var uParam2) // Position - 0x7735
{
	...
	{
		if (!func_188(pedParam0, Global_114370.f_2367.f_539[num /*65*/].f_64, Global_114370.f_2367.f_539[num /*65*/].f_63))
		{
...
{
	Global_79551[1 /*14*/] = { func_124(hParam0, iParam1, iParam2, -1) };
...
BOOL func_79(Ped pedParam0, Hash hParam1, var uParam2, int iParam3) // Position - 0x8040
{
	...
	{
		if (!func_188(pedParam0, Global_114370.f_2367.f_539[num /*65*/].f_61, Global_114370.f_2367.f_539[num /*65*/].f_60) || iParam3 == 1)
		{
	...
	switch (hParam0)
	{
		case joaat("Player_Zero"):
			switch (iParam1)
			{
				...
				case 5:
					func_107(&unk, -99, -99, Global_114370.f_2367.f_539.f_196[0], Global_114370.f_2367.f_539.f_200[0], 6, 3, 0, 0, 0, -99, 0, 0, 3);
					break;
		...
		case joaat("Player_One"):
			switch (iParam1)
			{
				...
				case 2:
					func_107(&unk, -99, -99, Global_114370.f_2367.f_539.f_196[1], Global_114370.f_2367.f_539.f_200[1], 17, 2, 26, 0, 0, -99, 0, 45, 31);
					break;
		...
		case joaat("Player_Two"):
			switch (iParam1)
			{
				...
				case 4:
					func_107(&unk, -99, -99, Global_114370.f_2367.f_539.f_196[2], Global_114370.f_2367.f_539.f_200[2], 8, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
...
void func_114(int iParam0) // Position - 0xDE98
{
	if (IS_BIT_SET(Global_79551[1 /*14*/].f_6, 1) && !IS_BIT_SET(Global_79551[1 /*14*/].f_6, 6))
		func_122(iParam0, Global_79551[1 /*14*/].f_5, Global_79551[1 /*14*/].f_2, 2, Global_79551[1 /*14*/].f_1, 1, 0);
...
BOOL func_122(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x10D4F
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
BOOL func_123(int iParam0) // Position - 0x11BF2
{
	if (!IS_BIT_SET(Global_79551[1 /*14*/].f_6, 0))
		return false;
...
struct<14> func_124(Hash hParam0, int iParam1, int iParam2, int iParam3) // Position - 0x11C3A
{
	func_187();
...
void func_125(int iParam0, int iParam1) // Position - 0x11C8C
{
	switch (iParam0)
	{
		case 0:
...
void func_126(int iParam0) // Position - 0x11D7C
{
	BOOL flag;
	int num;
	var unk;
	...
	func_127(&Global_79551[0 /*14*/], num6, iParam0, &unk, num2, num3, num, flag, num4, num5, false);
	return;
}

void func_127(int iParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, BOOL bParam7, int iParam8, int iParam9, BOOL bParam10) // Position - 0x12FF3
{
	int num;
	int num2;
	...
	*iParam0 = iParam9;
	...
	else
	{
		...
		if (iParam1 == 11 || iParam1 == 4 || iParam1 == 6 || iParam1 == 1 || iParam1 == 14 || iParam1 == 2 || iParam1 == 8 || iParam1 == 9 || iParam1 == 10 || iParam1 == 7 || iParam1 == 12)
		{
			...
			num = func_120(func_130(iParam1, iParam0->f_2), Global_79548);
		
			if (IS_BIT_SET(num, iParam0->f_1))
				MISC::SET_BIT(&(iParam0->f_6), 1);
		
			num = func_120(func_129(iParam1, iParam0->f_2), Global_79548);
			...
			{
				num = func_120(num2, Global_79548);
...
BOOL func_128(int iParam0, int iParam1, var uParam2) // Position - 0x13395
{
	*uParam2 = 979;
...
int func_129(int iParam0, int iParam1) // Position - 0x1379A
{
	switch (iParam1)
	{
		case 0:
...
int func_130(int iParam0, int iParam1) // Position - 0x13B95
{
	switch (iParam1)
	{
		case 0:
...
BOOL func_131(Hash hParam0, int iParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0x13F90
{
	int num;
	int num2;
	int num3;
...
int func_132(int iParam0) // Position - 0x13FCE
{
	switch (iParam0)
	{
		case -1:
...
void func_133(int iParam0, int iParam1, int iParam2, Hash hParam3) // Position - 0x140CD
{
	...
	if (iParam0 == 12)
	{
		...
		if (outfitIndex >= 0)
		{
			...
			if (num3 > outfitIndex)
			{
				...
				func_127(&Global_79551[0 /*14*/], iParam0, iParam1, &(outfit.f_7), 0, 0, outfit.f_2, false, -1, 2, true);
				return;
			}
		}
	}
	...
	{
		func_127(&Global_79551[0 /*14*/], iParam0, iParam1, "NO_LABEL", 0, 0, 0, true, -1, 2, true);
	}
	else if (iParam0 == 14)
	{
		FILES::INIT_SHOP_PED_PROP(&outProp);
		...
		if (componentId >= 0)
		{
			...
			if (num5 > componentId)
			{
				...
				func_127(&Global_79551[0 /*14*/], iParam0, iParam1, &(outProp.f_9), outProp.f_3, outProp.f_4, outProp.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(outProp.f_1, joaat("OUTFIT_ONLY"), 0), num4, 2, outProp.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (hParam3 != -1 && Global_79749)
		{
			...
			func_127(&Global_79551[0 /*14*/], iParam0, iParam1, &(outComponent.f_9), outComponent.f_3, outComponent.f_4, outComponent.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(outComponent.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, outComponent.f_1 != 0);
			return;
		}
			...
			if (unk[i] != -99 && i != 12 && i != 14)
			{
				if (!func_188(pedParam0, i, unk[i]))
				{
					if (i == 13)
					{
						...
						for (j = 0; j <= 8; j = j + 1)
						{
							if (!func_188(pedParam0, 14, unk18[j]))
							{
								for (k = 0; k <= 19; k = k + 1)
								{
									Global_79551[2 /*14*/] = { func_124(entityModel, 14, k, -1) };
								
									if (Global_79551[2 /*14*/].f_12 == j)
										if (func_188(pedParam0, 14, k))
											if (!func_77(entityModel, iParam2, 14, k, &unk, &Global_79551[2 /*14*/]))
												return false;
								}
							}
						}
					...
					else
					{
						...
						Global_79551[2 /*14*/] = { func_124(entityModel, i, num, -1) };
					
						if (!func_77(entityModel, iParam2, i, num, &unk, &Global_79551[2 /*14*/]))
							return false;
					}
				}
			}
...
void func_215() // Position - 0x2653B
{
	...
	if (value > 0f && SYSTEM::FLOOR(value) < SYSTEM::FLOOR(Global_114370.f_10198.f_3853))
		func_218(13, SYSTEM::FLOOR(Global_114370.f_10198.f_3853));
