			...
			switch (iLocal_93)
			{
				...
				case 3:
					...
					else
					{
						...
						if (!func_102(3) && !Global_101951)
						{
							if (func_120(iLocal_92, 2097152))
							{
								if (!func_120(iLocal_92, 1) || !ENTITY::DOES_ENTITY_EXIST(func_101()) && !Global_101951)
								{
									func_113(10);
									break;
								}
				...
				case 6:
					...
					if (func_120(Global_113018, 262144))
					{
						func_124(&Global_113018, 262144);
						func_38();
					}
					...
					if (!SCRIPT::IS_THREAD_ACTIVE(iLocal_50))
					{
						...
						if (iLocal_97 != -1)
						{
							if (func_120(Global_113018, 0))
							{
								STATS::PLAYSTATS_MISSION_CHECKPOINT(func_41(iLocal_97), 0, Global_101954, 0);
								func_28(func_41(iLocal_97), 0, Global_101954, true, false);
							}
							else
							{
								STATS::PLAYSTATS_MISSION_CHECKPOINT(func_41(iLocal_97), 0, Global_101954, 0);
								func_28(func_41(iLocal_97), 0, Global_101954, false, false);
							}
						}
...
{
	if (func_120(Global_114370.f_20015.f_9, 1))
	{
		func_124(&(Global_114370.f_20015.f_9), 1);
	
		if (iLocal_133 == Global_114370.f_20015.f_8)
		{
			if (Global_114370.f_20015.f_8 != 2)
			{
				Global_114370.f_20015.f_8 = Global_114370.f_20015.f_8 + 1;
			
				if (Global_114370.f_20015.f_8 == 1)
				{
					func_114(108, true, false);
					func_20(114, 1, 0, true, 0);
				}
				else if (Global_114370.f_20015.f_8 == 2)
				{
					func_114(109, true, false);
					func_20(115, 1, false, true, 0);
				}
			
				if (bLocal_130 && Global_114370.f_20015.f_8 == 2)
				{
					func_19(62);
				}
				else
...
void func_8(int iParam0, BOOL bParam1) // Position - 0xD3B
{
	...
	if (bParam1 != IS_BIT_SET(Global_33678[num /*23*/].f_11, 13))
		MISC::SET_BIT(&(Global_33678[num /*23*/].f_11), 18);

	if (bParam1)
		MISC::SET_BIT(&(Global_33678[num /*23*/].f_11), 13);
	else
		MISC::CLEAR_BIT(&(Global_33678[num /*23*/].f_11), 13);
...
void func_19(int iParam0) // Position - 0x136D
{
	...
	if (i < 3)
	{
		MISC::CLEAR_BIT(&Global_114370.f_20414.f_150[i], offset);
		MISC::CLEAR_BIT(&Global_114370.f_20414.f_150[i], offset);
	}
...
void func_67() // Position - 0x63EE
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (_GET_CHARACTER_MODEL(Global_114370.f_2367.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_68(character) && !func_104(14) || Global_113318)
			{
				if (Global_114370.f_2367.f_539.f_4321 != character && func_68(Global_114370.f_2367.f_539.f_4321))
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_99() || Global_113417 || Global_33301 || func_98() || func_84(8, -1) || func_97() || func_96() || func_95() || func_86() || Global_114370.f_7692.f_919[character] == 5)
							return false;
						break;
				
					case 1:
						if (PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_99() || Global_33301 || func_98() || func_84(8, -1) || func_95() || func_97() || func_96() || func_86() || Global_114370.f_7692.f_919[character] == 5)
							return false;
						break;
				
					case 2:
						if (!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_99() || Global_113417 || Global_33301 || func_98() || func_84(8, -1) || func_95() || func_97() || func_96() || func_86() || Global_114370.f_7692.f_919[character] == 5 || Global_44939 != -1)
							return false;
						break;
				
					case 3:
						if (PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_99() || Global_113417 || Global_33301 || func_98() || func_84(8, -1) || func_97() || func_96() || func_86() || Global_114370.f_7692.f_919[character] == 5)
							return false;
						break;
				
					case 4:
						if (func_99() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0 || func_84(8, -1) || func_86() || func_94() || Global_114370.f_7692.f_919[character] == 5)
							return false;
						break;
					...
					case 6:
						if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
							if (PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0 || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || func_99() || Global_33301 || func_98() || func_84(8, -1) || func_96() || func_95() || func_86() || Global_114370.f_7692.f_919[character] == 5)
								return false;
						break;
				
					case 7:
						if (PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID()) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || !CAM::IS_SCREEN_FADED_IN() || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_99() || func_96() || Global_113417 || Global_33301 || func_98() || Global_45607 || func_84(8, -1) || func_95() || func_94() || func_86() || Global_114370.f_7692.f_919[character] == 5)
							return false;
						break;
				
					case 8:
						if (PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID()) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || !CAM::IS_SCREEN_FADED_IN() || PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), true) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_SWIMMING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || func_99() || Global_113417 || Global_33301 || func_98() || func_84(8, -1) || func_95() || func_94() || func_97() || func_96() || func_86())
							return false;
						break;
				}
			}
...
{
	return func_119(iParam0, Global_44392);
}
...
void func_121() // Position - 0x7FA3
{
	...
	if (Global_114370.f_20015.f_8 == -1)
		Global_114370.f_20015.f_8 = 0;

	if (Global_114370.f_20015.f_8 < iLocal_133)
		func_88(&iLocal_92, 8388608);
...
void func_129(BOOL bParam0, int iParam1) // Position - 0x8289
{
	...
	if (bParam0)
	{
		func_130(&Global_24148.f_6263[num /*10*/]);
