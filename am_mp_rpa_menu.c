	...
	while (true)
	{
		...
		switch (iLocal_140)
		{
			case 0:
				...
				bLocal_135 = true;
				iLocal_140 = 1;
				_STOPWATCH_INITIALIZE(&uLocal_137, true, false);
...
void func_1(int iParam0) // Position - 0x165
{
	if (func_7())
		return;
...
void func_2(int iParam0) // Position - 0x198
{
	if (func_7())
		return;
...
void func_4(BOOL bParam0, BOOL bParam1) // Position - 0x249
{
	if (bParam0)
	{
		if (func_6(0))
...
BOOL func_5() // Position - 0x2BD
{
	return IS_BIT_SET(Global_1960332, 5);
}

BOOL func_6(int iParam0) // Position - 0x2CB
{
	if (iParam0 == 1)
...
BOOL func_7() // Position - 0x322
{
	return IS_BIT_SET(Global_1960332, 19);
}

void func_8() // Position - 0x331
{
	int num;
	...
	if (!IS_BIT_SET(iLocal_127, 1) || PAD::HAVE_CONTROLS_CHANGED(FRONTEND_CONTROL) || Global_1944966)
	{
		...
		_STOPWATCH_DESTROY(&(iLocal_142.f_5));
	}
	else
	{
		if (_STOPWATCH_HAS_TIME_PASSED(&(iLocal_142.f_5), 5000, true))
			Global_1944966 = true;
	
		if (bLocal_139 && _STOPWATCH_HAS_TIME_PASSED(&(iLocal_142.f_5), 2000, true))
		{
			bLocal_139 = false;
			Global_1944966 = true;
		}
...
void func_9(BOOL bParam0, int iParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, int iParam5, BOOL bParam6, BOOL bParam7, int iParam8) // Position - 0x430
{
	int num;
	int r;
	int g;
	...
	if (bParam3)
	{
		...
		{
			func_46(Global_24148.f_5821 + 1, "DFLT_MNU_OPT" /*Exit*/, 0, true, 0, false, 0);
		...
		if (i == 1 || !Global_24148.f_6331)
		{
			...
			for (j = 0; j <= num43; j = j + 1)
			{
				...
				if (flag && i == 1 && flag2)
				{
					...
					func_40("CommonMenu", "Gradient_Nav", Global_24145 + (iParam5 * 0.5f), num40 + num45 + (0.00277776f * (float)num5) + (num37 * 0.5f), iParam5, num37, 0f, r2, g2, b2, a2, false, 0);
								...
								if (flag2)
								{
									if (!Global_24148.f_6332)
									{
										...
										if (MISC::GET_HASH_KEY(&Global_24148.f_79[num16 /*6*/]) != 0)
										{
											...
											func_22(flag, Global_24148.f_1616[num16], Global_24148.f_1873[num16], flag7, num46, flag5, flag4);
...
void func_10(int iParam0) // Position - 0x35CD
{
	Global_1675455.f_1163 = iParam0;
	return;
}

float func_11(int iParam0) // Position - 0x35DE
{
	switch (iParam0)
	{
		case 36:
...
void func_12(float fParam0, float fParam1, char* sParam2, float fParam3, int iParam4) // Position - 0x364D
{
...
float func_13(float fParam0) // Position - 0x3670
{
	fParam0 = fParam0 * func_14();
	return fParam0;
}

float func_14() // Position - 0x3683
{
	return 1.7777778f / func_15();
}

float func_15() // Position - 0x3695
{
	return Global_24148.f_9149;
}

void func_16(float fParam0, float fParam1, char* sParam2, int iParam3, int iParam4) // Position - 0x36A3
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_TEXT(sParam2);
...
BOOL IS_ROCKSTAR_DEV() // Position - 0x36C5
{
	return DLC::IS_DLC_PRESENT(-1762644250);
}

void func_18(BOOL bParam0) // Position - 0x36D6
{
	int r;
	int g;
	int b;
...
float func_19(BOOL bParam0) // Position - 0x371C
{
	return func_20(HUD::END_TEXT_COMMAND_GET_SCREEN_WIDTH_OF_DISPLAY_TEXT(bParam0));
}

float func_20(float fParam0) // Position - 0x372E
{
	fParam0 = fParam0 * func_21();
	return fParam0;
}

float func_21() // Position - 0x3741
{
	return func_15() / 1.7777778f;
}

void func_22(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, int iParam4, BOOL bParam5, BOOL bParam6) // Position - 0x3753
{
	int r;
	int g;
	int b;
...
void func_23(float fParam0, float fParam1) // Position - 0x3901
{
	HUD::SET_TEXT_WRAP(func_13(fParam0), func_13(fParam1));
	return;
}

void func_24(int iParam0, var uParam1, var uParam2, var uParam3) // Position - 0x3919
{
	switch (iParam0)
	{
		case 0:
...
void func_25(var uParam0, int iParam1, int iParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, int iParam7, BOOL bParam8) // Position - 0x3BA3
{
	int num;
	int i;
	int j;
...
void func_26(char* sParam0) // Position - 0x409D
{
...
void func_27(char* sParam0) // Position - 0x40AF
{
	GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_PLAYER_NAME_STRING(sParam0);
	return;
}

BOOL func_28(Player plParam0, int iParam1) // Position - 0x40BD
{
	BOOL flag;
...
int func_29(int iParam0, BOOL bParam1) // Position - 0x4116
{
	int num;
	int num2;
...
int func_30() // Position - 0x4157
{
	return Global_1574927;
}

BOOL func_31(Player plParam0) // Position - 0x4163
{
	Player player;
...
void func_34(int iParam0, BOOL bParam1, int* piParam2, int* piParam3, int* piParam4, int* piParam5) // Position - 0x420D
{
...
void func_35(float fParam0) // Position - 0x4349
{
	int r;
	int g;
	int b;
...
void func_36(float fParam0, float fParam1, char* sParam2, int iParam3, int iParam4) // Position - 0x43A8
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_TEXT(sParam2);
	HUD::ADD_TEXT_COMPONENT_INTEGER(iParam3);
...
float func_37(char* sParam0, int iParam1, int iParam2) // Position - 0x43CF
{
...
void func_38(float fParam0, float fParam1, int iParam2) // Position - 0x4411
{
	HUD::END_TEXT_COMMAND_DISPLAY_TEXT(func_13(fParam0), fParam1, iParam2);
	return;
}

void func_39() // Position - 0x4427
{
	int r;
	int g;
	int b;
...
void func_40(char* sParam0, char* sParam1, float fParam2, float fParam3, float fParam4, float fParam5, float fParam6, int iParam7, int iParam8, int iParam9, int iParam10, BOOL bParam11, int iParam12) // Position - 0x44B1
{
...
void func_41(float fParam0, float fParam1, int iParam2, float fParam3, int iParam4, int iParam5, int iParam6, int iParam7) // Position - 0x44DF
{
...
char* func_42(int iParam0, BOOL bParam1) // Position - 0x4516
{
	var unk;
	var txdName;
	var netHandle;
...
char* func_43(char* sParam0) // Position - 0x4A42
{
	return sParam0;
}

struct<13> GET_GAMER_HANDLE_PLAYER(Player plParam0) // Position - 0x4A4C
{
	var gamerHandle;
...
char* func_45(int iParam0) // Position - 0x4A63
{
	var txdName;
	var netHandle;
...
void func_46(int iParam0, char* sParam1, int iParam2, BOOL bParam3, int iParam4, BOOL bParam5, int iParam6) // Position - 0x4AD7
{
	int num;
	float num2;
	float num3;
...
float func_47(char* sParam0) // Position - 0x4CF3
{
	!HUD::DOES_TEXT_LABEL_EXIST(sParam0);
	return HUD::GET_RENDERED_CHARACTER_HEIGHT(0.35f, 0);
}

float func_48(char* sParam0) // Position - 0x4D0F
{
	if (!MISC::IS_STRING_NULL(sParam0))
		if (MISC::GET_HASH_KEY(sParam0) == 0)
			return 0f;
...
void func_49(int iParam0, BOOL bParam1) // Position - 0x4D4C
{
	int num;
...
void func_50(BOOL bParam0, int* piParam1, int* piParam2, var uParam3) // Position - 0x4D98
{
	float num;
	float value;
	float aspectRatio;
...
BOOL func_51(int iParam0, int iParam1) // Position - 0x4E20
{
	return SYSTEM::TO_FLOAT(iParam0) / SYSTEM::TO_FLOAT(iParam1) > 3.5f;
}

BOOL func_52(int iParam0, BOOL bParam1, BOOL bParam2, var uParam3, var uParam4, BOOL bParam5) // Position - 0x4E3B
{
	var textureDict;
	var textureName;
	int num;
...
float func_53(int iParam0) // Position - 0x4F67
{
	switch (iParam0)
	{
		case 34:
...
BOOL func_54(BOOL bParam0, BOOL bParam1) // Position - 0x5041
{
	if (Global_2672967.f_1761.f_701 != 0)
		return true;

	if (!CAM::IS_SCREEN_FADED_IN() || func_56(8, -1) && func_55() != 65 || HUD::GET_PAUSE_MENU_STATE() != 0 && !bParam1 || STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS() && !bParam0 || NETWORK::IS_COMMERCE_STORE_OPEN() || Global_80029 || Global_24148.f_9147 || HUD::IS_WARNING_MESSAGE_ACTIVE() || Global_101969.f_1490)
		return false;

	return true;
}

int func_55() // Position - 0x50DE
{
	return Global_1575016;
}

BOOL func_56(int iParam0, int iParam1) // Position - 0x50EA
{
	switch (iParam0)
	{
		case 5:
...
BOOL func_57(var uParam0, BOOL bParam1, int iParam2) // Position - 0x5122
{
	var unk;
	Hash hashKey;
	int i;
...
BOOL _STOPWATCH_HAS_TIME_PASSED(var pStopwatch, int millis, BOOL useLocalTimer) // Position - 0x51BF
{
	if (millis == -1)
		return true;
...
void _STOPWATCH_DESTROY(var uParam0) // Position - 0x521D
{
	uParam0->f_1 = 0;
	return;
}

void func_60(int iParam0) // Position - 0x522A
{
	Global_24148.f_6341 = iParam0;
	return;
}

void func_61() // Position - 0x523A
{
	var unk;
	var unk5;
	...
	if (iLocal_128 == 0)
	{
		...
		{
			switch (uLocal_122[iLocal_142.f_1])
			{
				case 1:
					if (func_65())
				...
				case 5:
					if (!func_65())
						if (IS_BIT_SET(iLocal_127, 7))
							func_64("RPA_MENU_O6_D1", 0, 0);
						else
							func_64("RPA_MENU_06_D2", 0, 0);
					else
						func_64("RPA_MENU_O6_D", 0, 0);
					break;
			}
		}
		else if (Global_1985436.f_3 == 176)
		{
			switch (uLocal_122[iLocal_142.f_1])
			{
				case 1:
					if (func_65())
						func_64("RPA_MENU_O4_D", 0, 0);
					else
						func_64("RPA_MENU_O4_D1", 0, 0);
					break;
			
				case 4:
					if (func_65())
						func_64("RPA_MENU_O5_D", 0, 0);
					else
						func_64("RPA_MENU_O5_D1", 0, 0);
					break;
...
void func_62(var uParam0) // Position - 0x544C
{
	TEXT_LABEL_COPY(uParam0, { Global_24148.f_5241 }, 4);
	return;
}

BOOL func_63() // Position - 0x5461
{
...
void func_64(char* sParam0, int iParam1, int iParam2) // Position - 0x555A
{
	int i;
...
BOOL func_65() // Position - 0x55BF
{
	return func_66(iLocal_142.f_1);
}

BOOL func_66(int iParam0) // Position - 0x55CF
{
	int num;
...
int func_67() // Position - 0x5623
{
	return Global_33298;
}

BOOL func_68() // Position - 0x562E
{
...
void func_70() // Position - 0x56ED
{
	...
	{
		if (Global_1985436.f_3 == 173)
			func_72(INPUT_FRONTEND_ACCEPT, "RPA_MENU_K1", -1, false);
		else if (Global_1985436.f_3 == 176)
			func_72(INPUT_FRONTEND_ACCEPT, "RPA_MENU_K3", -1, false);
	
		if (PAD::IS_USING_KEYBOARD_AND_MOUSE(FRONTEND_CONTROL))
		{
			func_72(INPUT_SELECT_WEAPON, "RPA_MENU_K2", -1, false);
			MISC::SET_BIT(&iLocal_127, 4);
		}
		else
		{
			func_71(INPUT_CELLPHONE_EXTRA_OPTION, "RPA_MENU_K2", -1);
...
void func_71(eControlAction ecaParam0, char* sParam1, int iParam2) // Position - 0x5779
{
...
void func_72(eControlAction ecaParam0, char* sParam1, int iParam2, BOOL bParam3) // Position - 0x5828
{
	const char* controlInstructionalButtonsString;
...
void func_73(int iParam0) // Position - 0x58DD
{
	int i;
	int num;
...
void func_74(var uParam0, BOOL bParam1, int iParam2) // Position - 0x5995
{
	int i;
	int num;
...
void func_75() // Position - 0x5AE5
{
	...
	if (iLocal_128 == 0)
	{
		...
		if (Global_1985436.f_3 == 173)
		{
			...
			if (!*Global_262145.f_36848)
				func_46(2, "RPA_MENU_O2", 0, true, 0, false, 0);
			else
				func_46(2, "RPA_MENU_O2", 0, false, 0, false, 0);
			...
			if (!*Global_262145.f_36847)
			{
				...
				{
					func_46(3, "RPA_MENU_O3", 0, true, 0, false, 0);
				}
				else
				{
					MISC::SET_BIT(&iLocal_127, 6);
					func_46(3, "RPA_MENU_O3", 0, false, 0, false, 0);
				}
			}
			else
			{
	...
	else if (iLocal_128 == 1)
	{
		...
		if (Global_1985436.f_3 == 173)
			iLocal_142 = func_207(true, false);
		else if (Global_1985436.f_3 == 176)
			iLocal_142 = func_207(false, true);
	}
	else if (iLocal_128 == 2)
	{
		...
		if (Global_1985436.f_3 == 173)
			iLocal_142 = func_76(true, false);
		else if (Global_1985436.f_3 == 176)
			iLocal_142 = func_76(false, true);
	}
...
int func_76(BOOL bParam0, BOOL bParam1) // Position - 0x5DC6
{
	int i;
	int num;
	int num2;
	...
	for (i = 0; i < num; i = i + 1)
	{
		...
		if (func_198(i) && func_92(i) && func_91(model, -1) && func_90(model))
		{
			...
			{
				str = func_86(model, num3);
				str2 = func_80(model, i);
			
				if (!MISC::IS_STRING_NULL_OR_EMPTY(str2))
				{
					func_46(num2, "TWOSTRINGS" /*~a~ ~a~*/, 2, true, 0, false, 0);
					func_77(str, false);
					func_77(str2, false);
				}
				else
				{
					func_46(num2, "STRING", 1, true, 0, false, 0);
					func_77(str, false);
				}
...
void func_77(const char* sParam0, BOOL bParam1) // Position - 0x5EC4
{
	float num;
	float num2;
	var unk;
...
char* func_80(Hash hParam0, int iParam1) // Position - 0x64FA
{
	var text;
...
int func_81(int iParam0) // Position - 0x67F0
{
	int i;
...
int func_82(int iParam0) // Position - 0x6826
{
	if (iParam0 == 4)
		return 0;
	else if (iParam0 == 3)
...
int func_83(int iParam0, int iParam1) // Position - 0x68AD
{
	Hash statHash;
	int outValue;
...
Hash func_84(int iParam0, int iParam1) // Position - 0x68DC
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(0, iParam0, func_85(iParam1));
}

int func_85(int iParam0) // Position - 0x68F1
{
	int num;
	int num2;
...
const char* func_86(Hash hParam0, int iParam1) // Position - 0x6925
{
...
const char* func_87(Hash hParam0, const char* sParam1, int iParam2) // Position - 0x6943
{
...
const char* func_88(int iParam0) // Position - 0x695F
{
	Hash modelHash;
...
int func_89(Hash hParam0) // Position - 0x6B42
{
	switch (hParam0)
	{
...
BOOL func_90(Hash hParam0) // Position - 0x6CCC
{
	switch (hParam0)
	{
		case joaat("buzzard"):
...
BOOL func_91(Hash hParam0, int iParam1) // Position - 0x6E42
{
	int cloudTimeAsInt;
	int num;
	int i;
...
int func_92(int iParam0) // Position - 0x706F
{
...
int func_93(int iParam0, int iParam1) // Position - 0x70EE
{
	if (iParam0 == -1)
		return -1;
...
BOOL func_94(int iParam0, int iParam1, int iParam2) // Position - 0x775B
{
	int num;
	int num2;
	int num3;
...
BOOL func_95(int iParam0) // Position - 0x7BA3
{
	int num;
...
int _STAT_GET_PACKED_INT(int iParam0, int iParam1) // Position - 0x7C91
{
	if (iParam1 == -1)
		iParam1 = func_30();
...
BOOL func_97() // Position - 0x7CAD
{
	return func_100(0, false) || func_98(false) || _STAT_GET_PACKED_BOOL(28272, -1);
}

BOOL func_98(BOOL bParam0) // Position - 0x7CD4
{
	if (bParam0)
...
BOOL func_99(Player plParam0) // Position - 0x7CF7
{
	if (plParam0 != -1)
...
BOOL func_100(int iParam0, BOOL bParam1) // Position - 0x7D16
{
	if (bParam1)
	{
		switch (iParam0)
...
BOOL func_101(Player plParam0, int iParam1) // Position - 0x7DAD
{
	if (plParam0 != -1)
	{
		switch (iParam1)
...
int func_102(int iParam0) // Position - 0x7E52
{
	switch (iParam0)
	{
		case joaat("POLICEB2"):
...
BOOL func_103(int iParam0) // Position - 0x7E8A
{
	if (!Global_79768)
		return false;
...
BOOL func_104(Player plParam0, int iParam1) // Position - 0x8003
{
	if (func_31(plParam0))
	{
		switch (iParam1)
...
int func_105(int iParam0, int iParam1) // Position - 0x8072
{
	Hash statHash;
	int outValue;
...
Hash func_106(int iParam0, int iParam1) // Position - 0x8096
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(8, iParam0, func_85(iParam1));
}

int func_107(int iParam0) // Position - 0x80AC
{
	switch (iParam0)
	{
		case joaat("taco"):
...
BOOL func_108(int iParam0) // Position - 0x8122
{
	if (!Global_79768)
		return false;
...
int func_109(int iParam0) // Position - 0x81F9
{
	switch (iParam0)
	{
		case -773802025:
...
int func_110(int iParam0) // Position - 0x8245
{
	switch (iParam0)
	{
		case -1233767450:
...
BOOL func_111(int iParam0) // Position - 0x829B
{
	if (!Global_79768)
		return false;
...
BOOL func_113(int iParam0) // Position - 0x83BE
{
	return _STAT_GET_PACKED_BOOL(func_114(iParam0), -1);
}

int func_114(int iParam0) // Position - 0x83D1
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_115(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x8420
{
	if (bParam1)
...
BOOL func_116(Player plParam0, int iParam1, BOOL bParam2) // Position - 0x844D
{
	if (func_31(plParam0))
...
int func_117(int iParam0, BOOL bParam1) // Position - 0x8475
{
	if (bParam1)
	{
		switch (iParam0)
...
BOOL func_118(int iParam0) // Position - 0x84FB
{
	if (!Global_79768)
		return false;
...
BOOL func_119(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x8572
{
	if (bParam2)
...
BOOL func_120(Player plParam0, int iParam1, BOOL bParam2) // Position - 0x859F
{
	if (plParam0 != -1)
...
// Unhandled jump detected. Output should be considered invalid
int func_121(int iParam0, BOOL bParam1) // Position - 0x85C6
{
	if (bParam1)
	{
		switch (iParam0)
...
int func_122(int iParam0) // Position - 0x8661
{
	switch (iParam0)
	{
		case 239897677:
...
BOOL func_123(int iParam0) // Position - 0x868F
{
	if (!Global_79768)
		return false;
...
BOOL func_124(BOOL bParam0) // Position - 0x8775
{
	if (bParam0)
...
BOOL func_125(Player plParam0) // Position - 0x8797
{
	if (plParam0 != -1)
...
BOOL func_126(int iParam0, int iParam1) // Position - 0x87B7
{
	Hash statHash;
	BOOL outValue;
...
Hash func_127(int iParam0, int iParam1) // Position - 0x87DB
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(10, iParam0, func_85(iParam1));
}

BOOL func_128(int iParam0, BOOL bParam1) // Position - 0x87F1
{
	if (bParam1)
...
BOOL func_129(Player plParam0, int iParam1) // Position - 0x881B
{
	if (plParam0 != -1)
...
// Unhandled jump detected. Output should be considered invalid
int func_130(int iParam0, BOOL bParam1) // Position - 0x883F
{
	if (bParam1)
	{
		switch (iParam0)
...
int func_131(int iParam0) // Position - 0x8948
{
	switch (iParam0)
	{
		case -1627077503:
...
BOOL func_132(int iParam0) // Position - 0x899E
{
	if (!Global_79768)
		return false;
...
BOOL func_133(int iParam0) // Position - 0x8A59
{
	return IS_BIT_SET(func_83(10394, -1), func_134(iParam0, true));
}

// Unhandled jump detected. Output should be considered invalid
int func_134(int iParam0, BOOL bParam1) // Position - 0x8A71
{
	if (bParam1)
	{
		switch (iParam0)
...
int func_135(int iParam0) // Position - 0x8B0D
{
	switch (iParam0)
	{
		case joaat("kanjosj"):
...
BOOL func_136(int iParam0) // Position - 0x8B4F
{
	if (!Global_79768)
		return false;
...
BOOL func_137(BOOL bParam0) // Position - 0x8C3C
{
	if (bParam0)
...
BOOL func_138(Player plParam0) // Position - 0x8C5E
{
	if (plParam0 != -1)
...
BOOL func_139(int iParam0, BOOL bParam1) // Position - 0x8C7C
{
	if (bParam1)
...
BOOL func_140(Player plParam0, int iParam1) // Position - 0x8CA1
{
	if (plParam0 != -1)
...
int func_141(BOOL bParam0) // Position - 0x8CC2
{
	if (bParam0)
...
int func_142(Player plParam0) // Position - 0x8CE2
{
	if (plParam0 != -1)
...
BOOL func_143() // Position - 0x8D00
{
	return func_83(9903, func_85(-1)) != 0;
}

int func_144(int iParam0) // Position - 0x8D16
{
	switch (iParam0)
	{
		case joaat("baller7"):
...
BOOL func_145(int iParam0) // Position - 0x8D81
{
	if (!Global_79768)
		return false;
...
BOOL func_146(Player plParam0) // Position - 0x8FD1
{
	if (plParam0 == PLAYER::PLAYER_ID())
...
BOOL func_147(Player plParam0) // Position - 0x9005
{
...
Player _INVALID_PLAYER_INDEX() // Position - 0x9048
{
	return -1;
}

int func_149(int iParam0) // Position - 0x9051
{
	switch (iParam0)
	{
		case joaat("zr350"):
...
BOOL func_150(int iParam0) // Position - 0x9114
{
	if (!Global_79768)
		return false;
...
BOOL func_151(int iParam0, BOOL bParam1) // Position - 0x929B
{
	if (bParam1)
...
BOOL func_152(Player plParam0, int iParam1) // Position - 0x92C0
{
	if (plParam0 != -1)
...
BOOL func_153(int iParam0, int iParam1) // Position - 0x92DF
{
	Hash statHash;
	BOOL outValue;
...
Hash func_154(int iParam0, int iParam1) // Position - 0x9303
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(2, iParam0, func_85(iParam1));
}

BOOL func_155(Player plParam0) // Position - 0x9318
{
	if (plParam0 != -1)
...
BOOL func_156(BOOL bParam0) // Position - 0x9336
{
	if (bParam0)
...
BOOL func_157(Player plParam0, int iParam1) // Position - 0x9358
{
	if (plParam0 != -1)
...
BOOL func_158(Player plParam0, int iParam1) // Position - 0x9376
{
	if (plParam0 != -1)
...
int func_159(int iParam0) // Position - 0x9395
{
	switch (iParam0)
	{
		case 0:
...
int func_160(int iParam0) // Position - 0x9458
{
	switch (iParam0)
	{
		case joaat("vetir"):
...
int func_161(int iParam0) // Position - 0x94DE
{
	switch (iParam0)
	{
		case joaat("firetruk"):
...
BOOL func_162(int iParam0) // Position - 0x9628
{
	int num;
...
BOOL func_163(int iParam0) // Position - 0x9A05
{
	if (!Global_79768)
		return false;
...
BOOL func_164(int iParam0) // Position - 0x9A59
{
	return _STAT_GET_PACKED_BOOL(func_165(iParam0), -1);
}

int func_165(int iParam0) // Position - 0x9A6C
{
	switch (iParam0)
	{
		case 8:
...
int func_166(int iParam0) // Position - 0xB3E9
{
	switch (iParam0)
	{
		case joaat("cerberus"):
...
int func_167(int iParam0) // Position - 0xB52D
{
	switch (iParam0)
	{
		case joaat("cerberus"):
...
BOOL func_168(int iParam0) // Position - 0xB627
{
	if (!Global_79768)
		return false;
	...
	{
		case joaat("mule4"):
			if (func_83(7233, -1) >= func_169(iParam0) || Global_262145.f_24256)
				return true;
			else
				return false;
			break;
		...
		case joaat("pounder2"):
			if (func_83(7233, -1) >= func_169(iParam0) || Global_262145.f_24257)
				return true;
			else
				return false;
			break;
		...
		case joaat("oppressor2"):
			if (_STAT_GET_PACKED_INT(22050, -1) >= func_169(iParam0) || Global_262145.f_24258)
				return true;
			else
				return false;
			break;
		...
		case joaat("patriot2"):
			if (func_83(7231, -1) >= func_169(iParam0) || Global_262145.f_24261)
				return true;
			else
				return false;
			break;
		...
		case joaat("blimp3"):
			if (func_83(7231, -1) >= func_169(iParam0) || Global_262145.f_24262)
				return true;
			else
				return false;
			break;
...
int func_169(int iParam0) // Position - 0xB77B
{
	switch (iParam0)
	{
		case joaat("mule4"):
...
int func_170(int iParam0) // Position - 0xB7EA
{
	switch (iParam0)
	{
		case joaat("mule4"):
...
BOOL func_171(int iParam0) // Position - 0xB848
{
	int num;
...
int func_172(int iParam0) // Position - 0xB90C
{
	switch (iParam0)
	{
		case 0:
...
int func_173(int iParam0) // Position - 0xB9C4
{
	switch (iParam0)
	{
		case joaat("deluxo"):
...
BOOL func_174(int iParam0) // Position - 0xBA4A
{
	int num;
	int num2;
...
int func_175() // Position - 0xBA78
{
	return func_83(6116, -1);
}

int func_176(int iParam0) // Position - 0xBA88
{
	switch (iParam0)
	{
		case joaat("microlight"):
...
BOOL func_177(int iParam0) // Position - 0xBB78
{
	if (!Global_79768)
		return false;
...
int func_178(int iParam0) // Position - 0xBB97
{
	switch (iParam0)
	{
		case joaat("dune3"):
...
int func_179(int iParam0) // Position - 0xBBE3
{
	switch (iParam0)
	{
		case joaat("dune3"):
...
BOOL func_180(int iParam0) // Position - 0xBC41
{
	int num;
...
BOOL func_181(int iParam0) // Position - 0xBD4C
{
	int num;
	int num2;
...
int func_182(int iParam0) // Position - 0xBD74
{
	return iParam0 % 32;
}

int func_183(int iParam0) // Position - 0xBD81
{
	int num;
...
int func_184(int iParam0) // Position - 0xBD98
{
	int num;
	int num2;
...
int func_185() // Position - 0xBE07
{
	return Global_33299;
}

int func_186(int iParam0) // Position - 0xBE12
{
	return iParam0 / 32;
}

BOOL func_187() // Position - 0xBE1F
{
	return Global_1575067;
}

BOOL func_188(int iParam0) // Position - 0xBE2B
{
...
BOOL func_189(int iParam0) // Position - 0xBEE5
{
...
BOOL func_190(int iParam0) // Position - 0xBF3C
{
	if (!Global_79768)
		return false;
...
int func_191(int iParam0) // Position - 0xBF5B
{
	switch (iParam0)
	{
		case joaat("dune4"):
...
int func_192(int iParam0) // Position - 0xBFC5
{
	int num;
...
BOOL func_193(int iParam0) // Position - 0xC07E
{
...
BOOL _IS_EXCLUSIVE_CONTENT_UNLOCKED() // Position - 0xC0D6
{
	int profileSetting;
...
BOOL func_196() // Position - 0xC1B6
{
	return true;
}

BOOL func_197() // Position - 0xC1BF
{
	int outValue;
	int outValue2;
	Hash statHash;
...
int func_198(int iParam0) // Position - 0xC2F8
{
	int i;
	int num;
	...
	if (_NETSHOPPING_SHOULD_USE_TRANSACTION_SYSTEM())
	{
		...
		if (iParam0 == func_93(&func_1, 0) && func_83(6159, -1) != 0)
			return 1;
...
BOOL func_200(int iParam0) // Position - 0xC4C3
{
	return func_83(11434, iParam0) == func_201();
}

int func_201() // Position - 0xC4D9
{
	return -1576586413;
}

BOOL _NETSHOPPING_SHOULD_USE_TRANSACTION_SYSTEM() // Position - 0xC4E6
{
	if (MISC::IS_PC_VERSION())
...
Hash func_203(int iParam0, int iParam1) // Position - 0xC4FD
{
	switch (iParam0)
	{
		case 0:
...
int func_204() // Position - 0xEB4B
{
	return joaat("kosatka");
}

int func_205(int iParam0) // Position - 0xEB58
{
	if (iParam0 < 0)
		return -1;
...
int func_206() // Position - 0xF0C8
{
	return 160;
}

int func_207(BOOL bParam0, BOOL bParam1) // Position - 0xF0D2
{
	int num;
	int num2;
	Hash model;
...
void func_208(int iParam0, int iParam1, int iParam2) // Position - 0xF274
{
	int num;
...
int func_209(int iParam0, var uParam1, BOOL bParam2, int iParam3, BOOL bParam4, BOOL bParam5) // Position - 0xF2D0
{
	int i;
	int num;
	int cloudTimeAsInt;
...
void func_210(int iParam0, const char* sParam1, int iParam2) // Position - 0xF734
{
	Hash statName;
...
int func_211(int iParam0, int iParam1) // Position - 0xF755
{
	if (iParam1 >= 363)
	{
...
int func_212(int iParam0, int iParam1) // Position - 0x16EFA
{
	switch (iParam0)
	{
		case 1:
...
void func_213(int iParam0, int iParam1, int iParam2, BOOL bParam3) // Position - 0x1ABDF
{
	Hash statName;
...
void _STAT_SET_PACKED_BOOL(int iParam0, BOOL bParam1, int iParam2) // Position - 0x1AC0D
{
	if (iParam2 == -1)
		iParam2 = func_30();
...
int func_215(int iParam0) // Position - 0x1AC2B
{
	if (iParam0 < 10)
...
int func_216(int iParam0, BOOL bParam1) // Position - 0x1ADA0
{
	if (iParam0 <= 38)
		if (iParam0 < 10)
			if (bParam1)
...
int func_217(int iParam0, int iParam1) // Position - 0x1B0D9
{
	int num;
...
int func_218(int iParam0, int iParam1, BOOL bParam2) // Position - 0x1B2BE
{
	if (iParam0 == -1)
		if (iParam1 >= 1)
...
int func_219() // Position - 0x1B5DE
{
	return 40;
}

BOOL func_220(int iParam0, int iParam1) // Position - 0x1B5ED
{
	if (iParam1 == -1)
	{
		switch (iParam0)
...
BOOL func_221(int iParam0) // Position - 0x1B6CA
{
	switch (iParam0)
	{
		case 87:
...
BOOL func_222(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x1B6F9
{
	if (bParam2)
...
BOOL func_223(Player plParam0, BOOL bParam1) // Position - 0x1B7D4
{
...
BOOL func_224(Player plParam0) // Position - 0x1B83A
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
...
BOOL func_225(Player plParam0) // Position - 0x1B85D
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
...
int func_226(int iParam0) // Position - 0x1B886
{
	switch (iParam0)
	{
		case 0:
...
int func_227(int iParam0) // Position - 0x1B8C3
{
...
BOOL func_228(int iParam0) // Position - 0x1B8E9
{
...
int func_229(int iParam0) // Position - 0x1B90A
{
	if (iParam0 < 10)
		return 7263 + iParam0;
	else if (iParam0 > 12 && iParam0 < 23)
...
int func_230(int iParam0) // Position - 0x1BC03
{
	if (iParam0 < 10)
		return 5975 + iParam0;
	else if (iParam0 > 12 && iParam0 < 23)
...
int func_231(int iParam0) // Position - 0x1BEFC
{
	if (iParam0 < 10)
		return 5935 + iParam0;
	else if (iParam0 > 12 && iParam0 < 23)
...
int func_232(int iParam0) // Position - 0x1C1F7
{
	int num;
...
BOOL func_233(int iParam0) // Position - 0x1C53F
{
	switch (iParam0)
	{
		case 10:
...
void func_234(int iParam0, int iParam1, int iParam2) // Position - 0x1C60A
{
	if (iParam2 == -1)
		iParam2 = func_30();
...
int func_235(int iParam0, int iParam1) // Position - 0x1C632
{
	int num;
...
void func_236(var uParam0) // Position - 0x1DF21
{
	func_237(uParam0);
	uParam0->f_104 = 0;
	uParam0->f_105 = 0;
...
void func_237(var uParam0) // Position - 0x1DF64
{
	func_238(uParam0);
	uParam0->f_78 = -1;
	uParam0->f_80 = 0f;
...
void func_238(var uParam0) // Position - 0x1DFF4
{
	int i;
...
void func_239(int iParam0, int iParam1) // Position - 0x1E0A4
{
	int bossId1;
	int bossId2;
	int bossType;
...
int func_240(BOOL bParam0) // Position - 0x1E17F
{
	if (bParam0)
		return 1;
...
BOOL func_241(BOOL bParam0) // Position - 0x1E191
{
	return func_242(PLAYER::PLAYER_ID(), bParam0);
}

BOOL func_242(Player plParam0, BOOL bParam1) // Position - 0x1E1A3
{
	return func_243(plParam0, bParam1, 1);
}

int func_243(Player plParam0, BOOL bParam1, int iParam2) // Position - 0x1E1B4
{
	Player player;
...
BOOL func_244(Player plParam0, int iParam1) // Position - 0x1E210
{
	if (func_31(plParam0))
...
int func_245(Player plParam0) // Position - 0x1E25F
{
	if (plParam0 == _INVALID_PLAYER_INDEX())
		return -1;
...
int func_246(Player plParam0) // Position - 0x1E284
{
	if (plParam0 == _INVALID_PLAYER_INDEX())
		return -1;
...
Player _GET_BOSS_OF_LOCAL_PLAYER() // Position - 0x1E2A9
{
	return Global_1888882[PLAYER::PLAYER_ID() /*611*/].f_10;
}

BOOL func_248(BOOL bParam0) // Position - 0x1E2BE
{
	return func_249(PLAYER::PLAYER_ID(), bParam0);
}

BOOL func_249(Player plParam0, BOOL bParam1) // Position - 0x1E2D0
{
	if (!func_31(plParam0))
		return false;
...
BOOL func_250(Player plParam0) // Position - 0x1E308
{
	if (func_31(plParam0))
		if (func_31(Global_1888882[plParam0 /*611*/].f_10))
...
void func_251(int iParam0, int iParam1, int iParam2) // Position - 0x1E33D
{
	if (iParam0 < 0)
		return;
...
void func_252(int iParam0, int iParam1, int iParam2) // Position - 0x1E387
{
	if (iParam1 <= 255)
	{
...
int func_253(int iParam0) // Position - 0x1E426
{
	if (iParam0 < 515)
...
int func_254(int iParam0) // Position - 0x1E479
{
	if (iParam0 < 261)
...
int func_255(int iParam0) // Position - 0x1E58E
{
	if (iParam0 < 158)
		if (iParam0 <= 38)
			return 4036 + iParam0;
...
void func_256(int iParam0, var uParam1) // Position - 0x1E779
{
	int i;
...
BOOL func_257(Hash hParam0) // Position - 0x1E7B6
{
...
int func_258(Hash hParam0, BOOL bParam1) // Position - 0x1E7D6
{
	switch (hParam0)
	{
		case joaat("apc"):
...
int func_259() // Position - 0x1E841
{
	return Global_2684748.f_18;
}

BOOL func_260(Hash hParam0, BOOL bParam1, int iParam2) // Position - 0x1E84F
{
	int i;
	Hash outData;
...
BOOL func_261(Hash hParam0) // Position - 0x1E9D4
{
	int num;
	var unk;
	var name;
...
BOOL IS_PLAYSTATION_PLATFORM() // Position - 0x1EAA0
{
	return MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION();
}

BOOL IS_XBOX_PLATFORM() // Position - 0x1EAB6
{
	return MISC::IS_DURANGO_VERSION() || MISC::IS_SCARLETT_VERSION();
}

BOOL func_264() // Position - 0x1EACC
{
	return false;
}

BOOL func_265() // Position - 0x1EAD5
{
	return true;
}

BOOL func_266() // Position - 0x1EADE
{
	return true;
}

BOOL func_267() // Position - 0x1EAE7
{
...
Hash func_268(int iParam0) // Position - 0x1EB00
{
	if (iParam0 > -1)
...
void func_269(int iParam0, var uParam1, BOOL bParam2) // Position - 0x1EB1C
{
...
int func_270(int iParam0, int iParam1) // Position - 0x1EB5C
{
	int num;
...
int func_271(int iParam0) // Position - 0x1ED3E
{
	switch (iParam0)
	{
		case 0:
...
int func_272(int iParam0, int iParam1, int iParam2) // Position - 0x1ED7B
{
...
BOOL func_273(int iParam0, int iParam1, int iParam2, int iParam3, BOOL bParam4) // Position - 0x1EDBE
{
	if (bParam4)
	{
		if (iParam1 == 116 || iParam2 == 12)
		{
			if (func_275(PLAYER::PLAYER_ID()))
			{
				...
				if (*Global_262145.f_36723)
					if (_STAT_GET_PACKED_BOOL(&func_119, -1) || func_63())
						if (iParam0 == 2)
							return true;
			}
		}
...
BOOL func_274(Player plParam0) // Position - 0x1EEAC
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
...
BOOL func_275(Player plParam0) // Position - 0x1EED2
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
...
int func_276(int iParam0) // Position - 0x1EEF8
{
	if (iParam0 == 12)
		return 3;
...
BOOL _STAT_GET_PACKED_BOOL(int iParam0, int iParam1) // Position - 0x1EF0C
{
	if (iParam1 == -1)
		iParam1 = func_30();
...
BOOL func_278(BOOL bParam0, BOOL bParam1) // Position - 0x1EF28
{
	int i;
	int num;
	int num2;
...
BOOL func_279(BOOL bParam0, BOOL bParam1) // Position - 0x1EFC4
{
	int i;
	int j;
	int num;
...
void func_280(char* sParam0) // Position - 0x1F08F
{
	int i;
...
void func_281() // Position - 0x1F0DA
{
	func_282(1, func_284(), func_284());
	return;
}

void func_282(BOOL bParam0, char* sParam1, char* sParam2) // Position - 0x1F0EF
{
...
void func_283(int iParam0, char* sParam1, char* sParam2) // Position - 0x1F106
{
...
char* func_284() // Position - 0x1F12A
{
	if (Global_1985436.f_3 == 173)
		return func_286();
	else if (Global_1985436.f_3 == 176)
...
char* func_285(int iParam0) // Position - 0x1F15F
{
	switch (iParam0)
	{
		case 174:
...
char* func_286() // Position - 0x1F1A2
{
	return "ShopUI_Title_Mckenzie_Field";
}

void func_287(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x1F1AE
{
...
void func_288(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4) // Position - 0x1F1ED
{
...
void func_289(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4) // Position - 0x1F22C
{
...
void func_290(BOOL bParam0, BOOL bParam1) // Position - 0x1F2D6
{
	int i;
	int j;
	float aspectRatio;
...
float func_291(BOOL bParam0) // Position - 0x1F7AF
{
	float aspectRatio;
...
void func_292(int iParam0) // Position - 0x1F7DA
{
	Global_24148.f_5828 = iParam0;
	return;
}

void func_293() // Position - 0x1F7EA
{
	BOOL flag;
	...
	if (!bLocal_133)
	{
		...
		if (func_416() > 0)
		{
			...
			{
				iLocal_142.f_1 = iLocal_142.f_1 + 1;
			
				if (iLocal_142.f_1 > func_416() - 1)
					iLocal_142.f_1 = 0;
...
void func_294() // Position - 0x1F973
{
	if (iLocal_128 == 0)
	{
		func_445();
...
void func_296() // Position - 0x1F9FD
{
	BOOL flag;
...
void func_297() // Position - 0x1FA8B
{
...
void _SET_PLAYER_CONTROL_EX(Player plParam0, BOOL bParam1, eSetPlayerControlFlags espcfParam2, BOOL bParam3) // Position - 0x1FAA8
{
...
BOOL func_299(int iParam0) // Position - 0x1FF5C
{
	return iParam0 == 17;
}

void func_300() // Position - 0x1FF69
{
	var unk;
...
void func_301() // Position - 0x1FFB6
{
...
BOOL func_302(Ped pedParam0) // Position - 0x1FFF4
{
...
void func_303(BOOL bParam0, Ped pedParam1, int iParam2) // Position - 0x20029
{
	int num;
	eViewModeContext i;
...
void _MPPLY_STAT_SET_BOOL(Hash hParam0, BOOL bParam1) // Position - 0x200F9
{
	Hash statName;
...
void func_305() // Position - 0x20115
{
	eViewModeContext i;
...
BOOL func_306() // Position - 0x2016D
{
	return IS_BIT_SET(Global_2621446, 3);
}

BOOL func_307() // Position - 0x2017B
{
	if (func_308() == 0)
		return true;
...
int func_308() // Position - 0x20190
{
	return Global_1574634.f_18;
}

BOOL func_309() // Position - 0x2019E
{
...
BOOL func_310() // Position - 0x201CF
{
	BOOL flag;
	int num;
	...
	if (_NETWORK_IS_PLAYER_VALID(PLAYER::PLAYER_ID(), true, true) && uLocal_190[iLocal_142.f_1] >= 0)
	{
		flag = true;
...
void func_311() // Position - 0x202B7
{
	var unk;
...
void func_312(char* sParam0) // Position - 0x203D8
{
...
struct<4> func_313(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x20439
{
	var unk;
	int num;
	int num2;
...
int func_314(int iParam0) // Position - 0x205AD
{
	int num;
	int num2;
	...
	{
		if (!_STOPWATCH_HAS_TIME_PASSED(&Global_2685690.f_4347.f_254[iParam0 /*2*/], func_316(iParam0), true))
		{
			num2 = _STOPWATCH_GET_TIME_PASSED(&Global_2685690.f_4347.f_254[iParam0 /*2*/], true, false);
...
int _STOPWATCH_GET_TIME_PASSED(var pStopwatch, BOOL useLocalTimer, BOOL useAccurateTime) // Position - 0x2060F
{
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS() && !useLocalTimer)
		if (!useAccurateTime)
...
int func_316(int iParam0) // Position - 0x20656
{
	return Global_2685690.f_4347.f_423[iParam0];
}

BOOL _STOPWATCH_IS_INITIALIZED(var uParam0) // Position - 0x2066C
{
	return uParam0->f_1;
}

void func_318(int iParam0) // Position - 0x20678
{
	if (iParam0 == 115)
...
void func_319(int iParam0) // Position - 0x206C0
{
	Player player;
	var unk;
...
int func_320(int iParam0, var uParam1, var uParam2) // Position - 0x20715
{
	*uParam1 = -1;
	*uParam2 = -1;
...
int func_321(int iParam0) // Position - 0x209AF
{
	switch (iParam0)
	{
		case 39:
...
BOOL func_322(Player plParam0) // Position - 0x20C7E
{
...
BOOL func_323(Player plParam0) // Position - 0x20CF4
{
...
BOOL func_324(Player plParam0) // Position - 0x20D37
{
	if (NETWORK::NETWORK_IS_ACTIVITY_SESSION())
...
BOOL func_325(Player plParam0) // Position - 0x20D7A
{
	if (NETWORK::NETWORK_IS_ACTIVITY_SESSION())
...
BOOL func_326(Player plParam0) // Position - 0x20DBD
{
	if (NETWORK::NETWORK_IS_ACTIVITY_SESSION())
...
BOOL func_327(Player plParam0) // Position - 0x20E00
{
	if (NETWORK::NETWORK_IS_ACTIVITY_SESSION())
...
BOOL func_328(Player plParam0) // Position - 0x20E43
{
	if (NETWORK::NETWORK_IS_ACTIVITY_SESSION())
...
BOOL func_329(Player plParam0) // Position - 0x20E86
{
	if (NETWORK::NETWORK_IS_ACTIVITY_SESSION())
...
BOOL func_330(Player plParam0) // Position - 0x20EC9
{
	if (NETWORK::NETWORK_IS_ACTIVITY_SESSION())
...
BOOL func_331(Player plParam0) // Position - 0x20F0C
{
	if (NETWORK::NETWORK_IS_ACTIVITY_SESSION())
...
BOOL func_332(Player plParam0, int iParam1) // Position - 0x20F4F
{
	switch (iParam1)
	{
		case 4:
...
BOOL func_333(int iParam0) // Position - 0x20FE6
{
...
BOOL func_334() // Position - 0x21108
{
	if (func_336())
	{
		iLocal_141 = 7;
...
BOOL func_335() // Position - 0x211E5
{
	return IS_BIT_SET(Global_2672967.f_3864, 0);
}

BOOL func_336() // Position - 0x211F6
{
	int num;

	num = func_314(22);
	return num > 0 && NETWORK::NETWORK_IS_SCRIPT_ACTIVE(AUDIO_SPEECH_GET_PARAM_STRING_FROM_ENUM(46), -1, false, 0) || func_337(PLAYER::PLAYER_ID()) == 194;
}

int func_337(Player plParam0) // Position - 0x2122D
{
	if (func_31(plParam0))
...
BOOL func_338(Player plParam0, BOOL bParam1) // Position - 0x21259
{
	if (func_31(plParam0))
...
char* AUDIO_SPEECH_GET_PARAM_STRING_FROM_ENUM(int iParam0) // Position - 0x2129D
{
	switch (iParam0)
	{
		case 1:
...
BOOL func_340(int iParam0) // Position - 0x2201E
{
	return iParam0 == 998;
}

char* func_341() // Position - 0x2202C
{
	if (func_344())
...
BOOL func_342() // Position - 0x22054
{
	if (func_343(2))
		return false;
...
BOOL func_343(int iParam0) // Position - 0x22069
{
	return *Global_4718592.f_197276 >= iParam0;
}

BOOL func_344() // Position - 0x2207E
{
...
BOOL _NETWORK_IS_PLAYER_VALID(Player player, BOOL bIsPlaying, BOOL bUnk) // Position - 0x220A2
{
	Player player;
...
BOOL func_346() // Position - 0x22102
{
	BOOL flag;

	flag = false;

	if (_NETWORK_IS_PLAYER_VALID(PLAYER::PLAYER_ID(), true, true) && uLocal_149[iLocal_142.f_1] >= 0)
	{
		flag = true;
	
		if (!func_352(uLocal_149[iLocal_142.f_1]))
			flag = false;
	}

	if (flag)
	{
		Global_2740191.f_1018 = uLocal_149[iLocal_142.f_1];
		...
		if (Global_2740191.f_1018 != -1)
		{
			...
			_STOPWATCH_RESET(&Global_2685690.f_4347.f_254[48 /*2*/], true, false);
			func_347(48, -1, -1);
			return 1;
		}
		else
...
void func_347(int iParam0, int iParam1, int iParam2) // Position - 0x221E5
{
	if (iParam2 != -1)
...
int func_348(int iParam0) // Position - 0x22242
{
	switch (iParam0)
	{
		case 0:
		...
		case 48:
			...
			else if (Global_2740191.f_969 == 1)
...
int func_349() // Position - 0x22671
{
	if (NETWORK::NETWORK_IS_SCRIPT_ACTIVE(AUDIO_SPEECH_GET_PARAM_STRING_FROM_ENUM(46), -1, false, 0) || func_337(PLAYER::PLAYER_ID()) == 194)
		return Global_262145.f_11946;

	return 0;
}

int func_350() // Position - 0x226A5
{
	if (NETWORK::NETWORK_IS_SCRIPT_ACTIVE(AUDIO_SPEECH_GET_PARAM_STRING_FROM_ENUM(46), -1, false, 0) || func_337(PLAYER::PLAYER_ID()) == 194)
...
void _STOPWATCH_RESET(var pStopwatch, BOOL useLocalTimer, BOOL useAccurateTime) // Position - 0x226D9
{
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS() && !useLocalTimer)
		if (!useAccurateTime)
...
BOOL func_352(int iParam0) // Position - 0x22716
{
	if (NETWORK::NETWORK_IS_ACTIVITY_SESSION())
	{
	...
	if (ENTITY::DOES_ENTITY_EXIST(func_402()))
	{
		if (!ENTITY::IS_ENTITY_DEAD(func_402(), false))
		{
			...
			{
				if (SYSTEM::VDIST(ENTITY::GET_ENTITY_COORDS(func_402(), true), _GET_PLAYER_COORDS(PLAYER::PLAYER_ID())) < 1500f)
				{
					iLocal_141 = 9;
					return false;
				}
...
BOOL func_353() // Position - 0x228DA
{
	if (NETWORK::NETWORK_IS_ACTIVITY_SESSION())
		return func_355();
...
BOOL func_354(int iParam0) // Position - 0x228FE
{
	int i;
...
BOOL func_355() // Position - 0x22938
{
	return Global_2684748.f_19;
}

BOOL func_356(var uParam0) // Position - 0x22946
{
	int i;
...
BOOL func_357(int iParam0) // Position - 0x22976
{
	int playerTeam;
	int num;
...
BOOL func_358(Player plParam0) // Position - 0x23A2A
{
	Player player;
...
BOOL func_359(Player plParam0, int iParam1) // Position - 0x23A48
{
	return IS_BIT_SET(Global_1888882[plParam0 /*611*/].f_10.f_4, iParam1);
}

BOOL func_360(Player plParam0, BOOL bParam1, BOOL bParam2) // Position - 0x23A60
{
	if (bParam1)
...
BOOL func_361(Player plParam0) // Position - 0x23A92
{
	return func_362(plParam0);
}

BOOL func_362(Player plParam0) // Position - 0x23AA0
{
	return IS_BIT_SET(Global_1845274[plParam0 /*877*/].f_11.f_1, 0);
}

BOOL func_363(Vehicle veParam0, int iParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7, BOOL bParam8) // Position - 0x23AB7
{
	int i;
	int num;
	Ped ped;
...
Ped func_364(Vehicle veParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Position - 0x23B9B
{
...
BOOL func_365() // Position - 0x23C36
{
	int num;
	int num2;
...
BOOL func_366() // Position - 0x23CB5
{
	return *Global_4718592.f_236473 == 2;
}

BOOL func_367() // Position - 0x23CC9
{
	return *Global_4718592.f_236473 == 1;
}

int func_368(var uParam0) // Position - 0x23CDD
{
...
BOOL func_369() // Position - 0x23D14
{
	if (func_367())
...
BOOL func_370() // Position - 0x23D42
{
	if (func_367())
...
BOOL func_371(Player plParam0, int iParam1) // Position - 0x23D74
{
	return IS_BIT_SET(Global_2658019[plParam0 /*467*/].f_221, iParam1);
}

BOOL func_372() // Position - 0x23D8A
{
	return IS_BIT_SET(Global_2740191.f_4735, 0);
}

BOOL func_373() // Position - 0x23D9B
{
	return Global_2635523.f_26;
}

BOOL func_374(int iParam0) // Position - 0x23DA9
{
	return iParam0 == 54;
}

BOOL func_375(Player plParam0) // Position - 0x23DB6
{
	return Global_2658019[plParam0 /*467*/].f_123 == 7;
}

BOOL func_376(Player plParam0) // Position - 0x23DCB
{
	return Global_2658019[plParam0 /*467*/].f_123 == 2;
}

BOOL func_377(int iParam0) // Position - 0x23DE0
{
	switch (iParam0)
	{
...
BOOL func_378(int iParam0, BOOL bParam1) // Position - 0x23E66
{
	switch (iParam0)
	{
...
int func_379(int iParam0) // Position - 0x23EBE
{
	int num;
...
void func_380(var uParam0) // Position - 0x23F03
{
	if (func_381(*uParam0))
		return;
...
BOOL func_381(int iParam0) // Position - 0x23F31
{
	if (!NETWORK::NETWORK_IS_ACTIVITY_SESSION())
		return true;
...
BOOL func_382() // Position - 0x23F7A
{
	return false;
}

BOOL func_383() // Position - 0x23F8A
{
...
int func_384(int iParam0) // Position - 0x23FB8
{
	int num;
...
BOOL func_388(Player plParam0) // Position - 0x24021
{
	return Global_2658019[plParam0 /*467*/].f_123 == 4;
}

BOOL func_389(Player plParam0) // Position - 0x24036
{
	return Global_2658019[plParam0 /*467*/].f_123 == 6;
}

BOOL func_390(Player plParam0) // Position - 0x2404B
{
	return Global_2658019[plParam0 /*467*/].f_123 == 5;
}

BOOL func_391(Player plParam0) // Position - 0x24060
{
	switch (func_67())
	{
		case 0:
...
BOOL func_392(Player plParam0) // Position - 0x24096
{
	return Global_1845274[plParam0 /*877*/].f_185 != 0;
}

BOOL func_393(Player plParam0) // Position - 0x240AB
{
	switch (func_67())
	{
		case 0:
...
BOOL func_394() // Position - 0x240F4
{
	return Global_1836737;
}

BOOL func_395(Player plParam0) // Position - 0x24100
{
	switch (func_67())
	{
		case 0:
...
BOOL func_396() // Position - 0x2412C
{
	return Global_1836738;
}

BOOL func_397(int iParam0) // Position - 0x24138
{
	return func_398(&(Global_2672967.f_194), iParam0);
}

BOOL func_398(var uParam0, int iParam1) // Position - 0x2414C
{
	int num;
	int num2;
	int num3;
...
BOOL func_399() // Position - 0x2416F
{
	return IS_BIT_SET(Global_2740191.f_4735, 7);
}

BOOL func_400(int iParam0) // Position - 0x24180
{
	BOOL num;
...
Vector3 _GET_PLAYER_COORDS(Player plParam0) // Position - 0x24202
{
	return ENTITY::GET_ENTITY_COORDS(PLAYER::GET_PLAYER_PED(plParam0), false);
}

Vehicle func_402() // Position - 0x24215
{
...
Hash func_403() // Position - 0x24271
{
...
BOOL func_404(int iParam0) // Position - 0x24295
{
	if (iParam0 > -1)
...
BOOL func_405(Hash hParam0) // Position - 0x2432F
{
...
int func_406(int iParam0) // Position - 0x24471
{
	switch (iParam0)
	{
		case joaat("apc"):
...
int func_407(int iParam0) // Position - 0x2465B
{
	switch (iParam0)
	{
		case joaat("apc"):
...
BOOL func_408(int iParam0) // Position - 0x24742
{
	switch (iParam0)
	{
		case joaat("scarab"):
...
BOOL func_409(int iParam0) // Position - 0x2482E
{
	switch (iParam0)
	{
		case joaat("voltic2"):
...
BOOL func_410() // Position - 0x2487E
{
...
BOOL func_411(int iParam0) // Position - 0x248AB
{
	BOOL flag;
	...
	if (flag)
	{
		if (iParam0 == 1)
		{
			...
			_STOPWATCH_RESET(&Global_2685690.f_4347.f_254[82 /*2*/], true, false);
			func_347(82, -1, -1);
		}
		else if (iParam0 == 2)
		{
			...
			_STOPWATCH_RESET(&Global_2685690.f_4347.f_254[83 /*2*/], true, false);
			func_347(83, -1, -1);
		}
		else
		{
...
BOOL func_412(int iParam0) // Position - 0x249BB
{
	if (iParam0 == 0)
	{
...
void func_413() // Position - 0x24ACC
{
	BOOL flag;
...
BOOL func_415() // Position - 0x24BCE
{
	if (bLocal_134)
		return false;

	if (_STOPWATCH_HAS_TIME_PASSED(&uLocal_137, iLocal_136, true))
		return true;

	return false;
}

int func_416() // Position - 0x24BF0
{
	return iLocal_142;
}

void func_417() // Position - 0x24BFA
{
	iLocal_129 = 0;
	iLocal_130 = 0;
	bLocal_131 = false;
	...
	if (Global_4543037 > -1)
	{
		...
		{
			if (Global_4543037 == iLocal_142.f_1)
			{
				iLocal_129 = 1;
			}
			else
			{
				iLocal_142.f_1 = Global_4543037;
				func_74(iLocal_142.f_1, true, 1);
				Global_1944966 = true;
				AUDIO::PLAY_SOUND_FRONTEND(-1, "NAV_UP_DOWN", "HUD_FRONTEND_DEFAULT_SOUNDSET", true);
			}
...
BOOL func_418(BOOL bParam0, BOOL bParam1, int iParam2) // Position - 0x24CDE
{
	if (PAD::IS_USING_KEYBOARD_AND_MOUSE(FRONTEND_CONTROL))
	{
		if (Global_4543037 == -3)
...
BOOL func_419(BOOL bParam0, BOOL bParam1, int iParam2) // Position - 0x24D43
{
	if (PAD::IS_USING_KEYBOARD_AND_MOUSE(FRONTEND_CONTROL))
	{
		if (Global_4543037 == -2)
...
void func_420(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x24DA8
{
	float x;
	float y;
	float x2;
...
void func_421(BOOL bParam0) // Position - 0x25054
{
	float num;
	float num2;
	float num3;
...
void func_422() // Position - 0x250DD
{
...
void func_423() // Position - 0x25125
{
...
BOOL _DOES_ENTITY_EXIST_AND_IS_ALIVE(Ped pedParam0) // Position - 0x25342
{
...
void func_425() // Position - 0x25363
{
	HUD::HIDE_HUD_COMPONENT_THIS_FRAME(HUD_HELP_TEXT);
...
void func_426() // Position - 0x2539E
{
	Global_24009.f_6 = 1;
	return;
}

void func_427() // Position - 0x253AC
{
	Global_2740191.f_4672 = 0;
	return;
}

BOOL func_428() // Position - 0x253BC
{
	GRAPHICS::REQUEST_STREAMED_TEXTURE_DICT(func_284(), false);
	return GRAPHICS::HAS_STREAMED_TEXTURE_DICT_LOADED(func_284());
}

BOOL func_429(char* sParam0, int iParam1, BOOL bParam2) // Position - 0x253D5
{
	int num;
	BOOL flag;
	BOOL flag2;
...
BOOL func_430(int* piParam0) // Position - 0x254E1
{
	switch (piParam0->f_9)
	{
		case 0:
...
BOOL func_431(int iParam0, int iParam1) // Position - 0x25583
{
	if (HUD::IS_PAUSE_MENU_ACTIVE())
		return false;
...
BOOL func_432() // Position - 0x2561F
{
	return Global_1575088;
}

BOOL _IS_FMMC_ACTIVE() // Position - 0x2562B
{
	return Global_1845274[PLAYER::PLAYER_ID() /*877*/].f_185 != 0;
}

BOOL func_434() // Position - 0x25642
{
	return MISC::GET_GAME_TIMER() <= Global_24148.f_6481 + 100;
}

void func_435() // Position - 0x25657
{
	if (MISC::IS_PC_VERSION())
	{
...
BOOL func_436() // Position - 0x2568B
{
...
BOOL func_437(Player plParam0) // Position - 0x25765
{
...
BOOL func_438() // Position - 0x2579E
{
	return func_439(PLAYER::PLAYER_ID());
}

BOOL func_439(Player plParam0) // Position - 0x257AE
{
	return Global_2658019[plParam0 /*467*/].f_448;
}

BOOL func_440() // Position - 0x257C2
{
	return func_441(PLAYER::PLAYER_ID());
}

BOOL func_441(Player plParam0) // Position - 0x257D2
{
	return Global_2658019[plParam0 /*467*/].f_448.f_1;
}

BOOL func_442(Player plParam0) // Position - 0x257E8
{
...
void _STOPWATCH_INITIALIZE(var pStopwatch, BOOL useLocalTimer, BOOL useAccurateTime) // Position - 0x25819
{
	if (pStopwatch->f_1 == 0)
	{
		if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS() && !useLocalTimer)
...
BOOL func_444(Player plParam0) // Position - 0x2585E
{
...
void func_445() // Position - 0x2589D
{
...
void func_446() // Position - 0x25957
{
	GRAPHICS::SET_STREAMED_TEXTURE_DICT_AS_NO_LONGER_NEEDED(func_284());
	return;
}

void func_447(BOOL bParam0) // Position - 0x25967
{
	HUD::BUSYSPINNER_OFF();
...
void func_448(BOOL bParam0, int iParam1) // Position - 0x2597C
{
	int num;
...
void func_449(int* piParam0) // Position - 0x25A41
{
	if (piParam0->f_9 != 0)
	{
		if (GRAPHICS::HAS_SCALEFORM_MOVIE_LOADED(*piParam0))
...
BOOL _SHOULD_NETWORK_SCRIPT_TERMINATE() // Position - 0x25A6D
{
...
Hash _GET_CURRENT_SESSION_TYPE_SCRIPT_HASH() // Position - 0x25AF1
{
	switch (func_67())
	{
		case 0:
...
BOOL func_452() // Position - 0x25B24
{
	return Global_2684748.f_700;
}

BOOL _DOES_EVENT_OF_TYPE_EXIST(int iParam0) // Position - 0x25B33
{
...
BOOL func_454() // Position - 0x25B4A
{
	return Global_2696555;
}

BOOL func_455() // Position - 0x25B56
{
	return Global_2684748.f_695;
}

void func_456() // Position - 0x25B65
{
	SYSTEM::WAIT(0);
	return;
}

void func_457() // Position - 0x25B72
{
