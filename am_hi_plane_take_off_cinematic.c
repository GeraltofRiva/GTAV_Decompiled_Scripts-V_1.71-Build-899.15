...
Hash func_69() // Position - 0x1949
{
	return ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID());
}

var func_70(BOOL bParam0, var uParam1, var uParam2) // Position - 0x1959
{
	if (bParam0)
		return uParam1;
...
void func_71(var uParam0) // Position - 0x1970
{
	func_59();
...
void func_72(var uParam0) // Position - 0x198A
{
	func_168(uParam0);
...
void func_73(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x1A31
{
	func_75();
	func_49(true);
	HUD::CLEAR_HELP(true);
...
void func_76(var uParam0) // Position - 0x1B26
{
	var unk;
...
void func_77(Vehicle veParam0, var uParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x1C21
{
	Hash entityModel;
	float num;
...
BOOL IS_GAMER_HANDLE_VALID(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12) // Position - 0x2198
{
	return NETWORK::NETWORK_IS_HANDLE_VALID(&uParam0, 13);
}

BOOL func_79(Vehicle veParam0) // Position - 0x21A8
{
	Hash entityModel;
...
BOOL func_80(Hash hParam0) // Position - 0x21EE
{
	switch (hParam0)
	{
		case joaat("brioso"):
...
BOOL func_81(Hash hParam0) // Position - 0x22A4
{
	switch (hParam0)
	{
		case -1321131184:
...
BOOL func_82(Hash hParam0) // Position - 0x22D2
{
	switch (hParam0)
	{
		case joaat("coureur"):
...
BOOL func_83(Hash hParam0) // Position - 0x2307
{
	switch (hParam0)
	{
		case joaat("pounder2"):
...
void func_84(Vehicle veParam0) // Position - 0x240E
{
	Hash entityModel;
...
void func_85(var uParam0, var uParam1, var uParam2) // Position - 0x2499
{
	Hash eventData;
...
int _GET_LOBBY_SCRIPT_EVENT_BITS(BOOL includeLocalPlayer, BOOL includeSpectators) // Position - 0x24DA
{
	int address;
	int i;
	Player player;
...
BOOL func_87(int iParam0) // Position - 0x253F
{
	int i;
...
BOOL func_88(int iParam0) // Position - 0x257A
{
	return func_89(iParam0, 6, true);
}

BOOL func_89(int iParam0, int iParam1, BOOL bParam2) // Position - 0x258A
{
	if (iParam0 == -1)
		return false;
...
int func_90(int iParam0, int iParam1) // Position - 0x25EA
{
	Hash statHash;
	int outValue;
...
Hash func_91(int iParam0, int iParam1) // Position - 0x2619
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(0, iParam0, func_92(iParam1));
}

int func_92(int iParam0) // Position - 0x262E
{
	int num;
	int num2;
...
int func_93(int iParam0) // Position - 0x2662
{
	switch (iParam0)
	{
		case 0:
...
int func_94() // Position - 0x2A19
{
	return Global_33298;
}

int func_95(int iParam0) // Position - 0x2A24
{
	switch (iParam0)
	{
		case -1:
...
BOOL func_96() // Position - 0x2D67
{
	return Global_101969.f_400 > 0;
}

int func_97(Vehicle veParam0, Any* panParam1) // Position - 0x2D78
{
...
BOOL func_98(Vehicle veParam0) // Position - 0x2DF5
{
	int vehicleCrewEmblemRequestState;
	int networkTime;
	int num;
...
void func_99(Vehicle veParam0) // Position - 0x2E82
{
	int _int;
...
BOOL func_100(var uParam0, Player plParam1) // Position - 0x2EDE
{
	func_104();
	...
	func_102(*uParam0, &Global_1946326, &(Global_1946326.f_1), &(Global_1946326.f_4), &(Global_1946326.f_7), &(Global_1946326.f_10));
	...
	{
		if (func_101(uParam0, plParam1, Global_1946326, Global_1946326.f_1, Global_1946326.f_4, Global_1946326.f_7, Global_1946326.f_10, 0, Global_1946326.f_13))
		{
			if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	...
	else
	{
		...
		if (Global_1946326.f_23 == 0 && func_101(uParam0, plParam1, Global_1946326, Global_1946326.f_1, Global_1946326.f_4, Global_1946326.f_7, Global_1946326.f_10, 0, Global_1946326.f_13) || Global_1946326.f_23 != 0 && Global_1946326.f_24 == 0 && func_101(uParam0, plParam1, Global_1946326, Global_1946326.f_14, Global_1946326.f_17, Global_1946326.f_20, Global_1946326.f_10, 1, Global_1946326.f_13) || Global_1946326.f_24 != 0)
		{
			if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
				Global_1577972 = NETWORK::GET_NETWORK_TIME();
			else
...
BOOL func_101(var uParam0, Player plParam1, int iParam2, Vector3 vParam3, var uParam4, var uParam5, Vector3 vParam6, var uParam7, var uParam8, Vector3 vParam9, var uParam10, var uParam11, float fParam12, int iParam13, int iParam14) // Position - 0x3189
{
...
int func_102(Vehicle veParam0, int iParam1, var uParam2, var uParam3, var uParam4, float fParam5) // Position - 0x31B2
{
	if (!ENTITY::DOES_ENTITY_EXIST(veParam0) || !VEHICLE::IS_VEHICLE_DRIVEABLE(veParam0, false))
		return 0;
	...
	*iParam1 = ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(veParam0, "chassis_dummy");
	...
	if (!func_103(Global_1946352, 0f, 0f, 0f, false) && !func_103(Global_1946355, 0f, 0f, 0f, false) && !func_103(Global_1946358, 0f, 0f, 0f, false) && !(Global_1946361 == 0f))
	{
...
BOOL func_103(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, BOOL bParam6) // Position - 0x910F
{
	if (bParam6)
...
BOOL func_105(Vehicle veParam0) // Position - 0x91CF
{
	if (ENTITY::DOES_ENTITY_EXIST(veParam0) && VEHICLE::IS_VEHICLE_DRIVEABLE(veParam0, false))
...
BOOL func_106(Vehicle veParam0) // Position - 0x9207
{
	int _int;
...
BOOL func_107(Vehicle veParam0, Any* panParam1) // Position - 0x924F
{
	Player playerFromGamerHandle;
	BOOL flag;
	int num;
...
BOOL func_108(Vehicle veParam0) // Position - 0x93AC
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		return true;
...
int func_109(Vehicle veParam0) // Position - 0x9703
{
...
int func_110(Player plParam0) // Position - 0x972F
{
...
int func_111(Player plParam0) // Position - 0x974C
{
...
BOOL func_112(Player plParam0, BOOL bParam1) // Position - 0x976F
{
	if (func_11(plParam0))
...
int func_113(Player plParam0) // Position - 0x97B3
{
	if (func_11(plParam0))
		if (func_112(plParam0, false))
...
BOOL func_115(BOOL bParam0) // Position - 0x97EC
{
	return func_116(PLAYER::PLAYER_ID(), bParam0);
}

BOOL func_116(Player plParam0, BOOL bParam1) // Position - 0x97FE
{
	return func_117(plParam0, bParam1, 1);
}

BOOL func_117(Player plParam0, BOOL bParam1, int iParam2) // Position - 0x980F
{
	Player player;
...
BOOL func_118(Player plParam0, int iParam1) // Position - 0x986B
{
	if (func_11(plParam0))
...
BOOL func_119(int iParam0, BOOL bParam1) // Position - 0x98BA
{
	int num;
	int num2;
...
int func_120(int iParam0) // Position - 0x9918
{
	return iParam0 % 32;
}

int func_121(int iParam0) // Position - 0x9925
{
	int num;
...
int func_122(int iParam0) // Position - 0x993C
{
	int num;
	int num2;
...
int func_123(int iParam0) // Position - 0x9969
{
	return iParam0 / 32;
}

BOOL func_124(Player plParam0) // Position - 0x9976
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (func_125(plParam0) && Global_2658019[plParam0 /*467*/].f_324.f_11 == plParam0)
			return true;

	return false;
}

BOOL func_125(Player plParam0) // Position - 0x99AB
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2658019[plParam0 /*467*/].f_324.f_8 != -1)
				return func_126(Global_2658019[plParam0 /*467*/].f_324.f_8) == 22;

	return false;
}

int func_126(int iParam0) // Position - 0x99F2
{
	switch (iParam0)
	{
		case 0:
...
void func_127(Vehicle veParam0, int iParam1) // Position - 0x9F41
{
	int num;
	int num2;
...
BOOL func_128(int iParam0, var uParam1) // Position - 0x9F62
{
	*uParam1 = -1;
...
int func_129(int iParam0) // Position - 0xA224
{
	switch (iParam0)
	{
		case 0:
...
int func_130(int iParam0, int iParam1, int iParam2) // Position - 0xA2C2
{
	...
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS() && func_131() && Global_1576245)
...
struct<13> GET_LOCAL_GAMER_HANDLE() // Position - 0xA4EC
{
	var gamerHandle;
...
BOOL func_133(Vehicle veParam0) // Position - 0xA501
{
	switch (ENTITY::GET_ENTITY_MODEL(veParam0))
	{
		case joaat("deathbike2"):
...
BOOL func_134(int iParam0, var uParam1) // Position - 0xA522
{
	*uParam1 = -1f;
...
void func_135(Vehicle veParam0) // Position - 0xA823
{
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
...
void func_136(Vehicle veParam0) // Position - 0xA855
{
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		if (DECORATOR::DECOR_IS_REGISTERED_AS_TYPE("MLJ", BOOL))
			if (!DECORATOR::DECOR_EXIST_ON(veParam0, "MLJ"))
...
BOOL func_137(Hash hParam0) // Position - 0xA889
{
	switch (hParam0)
	{
		case 1484920335:
...
BOOL func_138(Hash hParam0) // Position - 0xA8AC
{
...
BOOL func_139(Hash hParam0) // Position - 0xB353
{
	switch (hParam0)
	{
		case joaat("deity"):
...
void func_140(Vehicle veParam0, var uParam1, BOOL bParam2, BOOL bParam3) // Position - 0xB3E2
{
	int num;
	int num2;
	int i;
...
BOOL func_141(Vehicle veParam0, float fParam1) // Position - 0xBB01
{
	float entityCoords;
	var groundZ;
...
Hash func_142(BOOL bParam0) // Position - 0xBB72
{
	if (bParam0)
...
BOOL func_143() // Position - 0xBB8C
{
	...
	if (func_147(7))
		if (func_145(Global_2672967.f_4.f_16) || func_144(Global_2672967.f_4.f_16))
			return false;

	return true;
}

BOOL func_144(int iParam0) // Position - 0xBC1B
{
	int num;
...
BOOL func_145(int iParam0) // Position - 0xBC3F
{
	int num;
...
BOOL func_146(int iParam0, int iParam1) // Position - 0xBC5D
{
	return IS_BIT_SET(Global_1888882[iParam0 /*611*/].f_10.f_4, iParam1);
}

BOOL func_147(int iParam0) // Position - 0xBC75
{
	return func_148(&(Global_2672967.f_194), iParam0);
}

BOOL func_148(var uParam0, int iParam1) // Position - 0xBC89
{
	int num;
	int num2;
	int num3;
...
int func_149(var uParam0, var uParam1, var uParam2) // Position - 0xBCAC
{
	int i;
	int modType;
...
BOOL func_150(Vehicle veParam0) // Position - 0xBEAA
{
	int i;
	int modType;
	Hash hashKey;
...
void func_151(var uParam0) // Position - 0xBF84
{
...
int func_152(Vehicle veParam0, int iParam1) // Position - 0xBFEF
{
	int value;
	int value2;
	float num;
...
int func_153(Vehicle veParam0, int iParam1) // Position - 0xC0DA
{
	int i;
...
BOOL func_154(Hash hParam0) // Position - 0xC13C
{
...
BOOL func_155(Hash hParam0, int iParam1) // Position - 0xC167
{
	switch (hParam0)
	{
		case joaat("faction2"):
...
BOOL func_156(Vehicle veParam0, int iParam1, int iParam2) // Position - 0xC54D
{
...
BOOL func_157() // Position - 0xC571
{
	return true;
}

void func_158(Vehicle veParam0, int iParam1) // Position - 0xC57E
{
	int vehicleMod;
...
BOOL func_159(int iParam0) // Position - 0xC5F6
{
	switch (iParam0)
	{
		case joaat("granger"):
...
BOOL func_160() // Position - 0xC616
{
	return DLC::IS_DLC_PRESENT(joaat("mpindependence"));
}

BOOL func_161(Vehicle veParam0) // Position - 0xC627
{
	int _int;
...
int func_162(var uParam0) // Position - 0xC66C
{
...
BOOL func_163(int iParam0) // Position - 0xC68C
{
	switch (iParam0)
	{
		case 161:
...
int func_164(int iParam0) // Position - 0xC6DF
{
	switch (iParam0)
	{
		case 1:
...
BOOL func_165(Vehicle veParam0) // Position - 0xC78F
{
...
BOOL _IS_PLAYER_IN_VEHICLE_SEAT(Player plParam0, int iParam1) // Position - 0xC816
{
...
BOOL _DOES_ENTITY_EXIST_AND_IS_ALIVE(Ped pedParam0) // Position - 0xC863
{
...
void func_168(var uParam0) // Position - 0xC884
{
...
void func_169(var uParam0) // Position - 0xC8D2
{
...
Vector3 func_170(float fParam0, var uParam1, var uParam2) // Position - 0xC98C
{
	return -SYSTEM::SIN(fParam0.f_2) * SYSTEM::COS(fParam0), SYSTEM::COS(fParam0.f_2) * SYSTEM::COS(fParam0), SYSTEM::SIN(fParam0);
}

BOOL func_171(var uParam0) // Position - 0xC9B9
{
	Player player;
	...
	else
	{
		...
		func_172(uParam0->f_23, &Global_1879551[player /*55*/], false, -1);
	}
...
void func_172(Ped pedParam0, var uParam1, BOOL bParam2, int iParam3) // Position - 0xCA91
{
	var unk;
	int characterType;
	BOOL flag;
...
void func_173(Ped pedParam0, int iParam1, int iParam2) // Position - 0xCBFA
{
	switch (iParam1)
	{
		case 1310977332:
...
BOOL func_174(Ped pedParam0, const char* sParam1, int iParam2, int iParam3, Hash hParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7, BOOL bParam8) // Position - 0xDED1
{
	Hash entityModel;
	int num;
...
BOOL func_175(int iParam0, int iParam1) // Position - 0xE6F7
{
	int num;
	int num2;
...
int func_176(int iParam0, int iParam1) // Position - 0xE736
{
	int num;
	int num2;
...
int func_177() // Position - 0xE77C
{
	return Global_33299;
}

int func_178(int iParam0) // Position - 0xE787
{
	int num;
	int num2;
...
char* func_179(int iParam0) // Position - 0xEB28
{
	switch (iParam0)
	{
		case 0:
...
int func_180(Hash hParam0, const char* sParam1, int iParam2) // Position - 0xF165
{
	switch (iParam2)
	{
		case joaat("crewLogo"):
...
BOOL func_181(char* sParam0, int iParam1, int iParam2, Ped pedParam3, int iParam4) // Position - 0x10198
{
	Hash entityModel;
	int num;
...
void func_182(char* sParam0, int iParam1, int iParam2, int iParam3) // Position - 0x13104
{
	int decorationIndex;
	int numTattooShopDlcItems;
	Hash outComponent;
...
BOOL func_183() // Position - 0x13196
{
...
BOOL func_184() // Position - 0x131C8
{
	return true;
}

int func_185() // Position - 0x131D1
{
	int outValue;
	int outValue2;
	Hash statHash;
...
BOOL _IS_EXCLUSIVE_CONTENT_UNLOCKED() // Position - 0x133C0
{
	int profileSetting;
...
int func_188() // Position - 0x13478
{
	return 1;
}

int func_189() // Position - 0x13481
{
	return 1;
}

void func_190(char* sParam0, int iParam1, Ped pedParam2, char* sParam3, char* sParam4, char* sParam5, char* sParam6, int iParam7, int iParam8, int iParam9) // Position - 0x1348A
{
	var unk;
...
BOOL func_191(Ped pedParam0, int iParam1) // Position - 0x1373F
{
...
Hash func_192(Hash hParam0, int iParam1, int iParam2, int iParam3) // Position - 0x139FF
{
	var outProp;
	int componentId;
	int num;
...
int func_193(Hash hParam0, int iParam1) // Position - 0x13B19
{
	switch (hParam0)
	{
...
ePedComponentType func_194(int iParam0) // Position - 0x13EC0
{
	switch (iParam0)
	{
		case 0:
...
int func_195(Hash hParam0) // Position - 0x13F70
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
...
int func_196(Ped pedParam0, int iParam1, ePedComponentType epctParam2) // Position - 0x13FD1
{
	int i;
	int j;
...
int func_197(Ped pedParam0, int iParam1) // Position - 0x14074
{
...
int func_198(Ped pedParam0, int iParam1, int iParam2, int iParam3) // Position - 0x140D4
{
	ePedComponentType componentId;
...
int func_199(Ped pedParam0, ePedComponentType epctParam1) // Position - 0x1412B
{
	int pedPropIndex;
...
int func_200(Ped pedParam0, int iParam1, int iParam2, ePedComponentType epctParam3) // Position - 0x14172
{
	Hash entityModel;
...
int func_201(Ped pedParam0, ePedComponentType epctParam1) // Position - 0x1426E
{
	Hash entityModel;
...
int func_202(Hash hParam0, Hash hParam1, int iParam2, int iParam3) // Position - 0x143AC
{
	var outfit;
	int i;
	int num;
...
int func_203(Hash hParam0) // Position - 0x14467
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
...
int func_204(ePedComponentType epctParam0) // Position - 0x144C6
{
	switch (epctParam0)
	{
		case PV_COMP_HEAD:
...
BOOL func_205(Ped pedParam0, int iParam1, int iParam2) // Position - 0x1454C
{
	Hash entityModel;
	int num;
	Hash hash;
	...
	entityModel = ENTITY::GET_ENTITY_MODEL(pedParam0);
	Global_79551[1 /*14*/] = { func_221(entityModel, iParam1, iParam2, -1) };
	hash = Global_2883588;
	...
	if (iParam1 == 12)
	{
			...
			if (unk[num2] != -99)
			{
				if (!func_205(pedParam0, num2, unk[num2]))
				{
					...
					if (num2 == 13)
					{
						...
						for (i = 0; i <= 8; i = i + 1)
						{
							if (!func_205(pedParam0, 14, unk18[i]))
							{
								for (j = 0; j <= 19; j = j + 1)
								{
									Global_79551[2 /*14*/] = { func_221(entityModel, 14, j, -1) };
								
									if (Global_79551[2 /*14*/].f_12 == i)
									{
										if (func_205(pedParam0, 14, j))
										{
											if (!func_209(entityModel, iParam2, 14, j, &unk, &Global_79551[2 /*14*/]))
											{
												Global_2883588 = hash;
												Global_2883589 = hash2;
												return false;
					...
					else
					{
						...
						Global_79551[2 /*14*/] = { func_221(entityModel, num2, num, -1) };
					
						if (!func_209(entityModel, iParam2, num2, num, &unk, &Global_79551[2 /*14*/]))
						{
							Global_2883588 = hash;
							Global_2883589 = hash2;
							return false;
		...
		{
			if (func_90(1759, Global_79548) != unk[10])
			{
				Global_2883588 = hash;
				Global_2883589 = hash2;
				return false;
	...
	{
		if (Global_79551[1 /*14*/].f_3 == PED::GET_PED_DRAWABLE_VARIATION(pedParam0, func_194(iParam1)) && Global_79551[1 /*14*/].f_4 == PED::GET_PED_TEXTURE_VARIATION(pedParam0, func_194(iParam1)))
			return true;
...
BOOL func_206(Hash hParam0, int iParam1, int iParam2, var uParam3) // Position - 0x149A7
{
	Hash componentHash;
...
BOOL func_207(Hash hParam0, int iParam1, int iParam2, var uParam3) // Position - 0x14A50
{
	Hash componentHash;
	int shopPedApparelVariantComponentCount;
	int i;
...
BOOL func_208(Hash hParam0, int iParam1, int iParam2, Hash hParam3) // Position - 0x14AF8
{
	switch (hParam0)
	{
		case joaat("MP_F_Freemode_01"):
...
BOOL func_209(Hash hParam0, int iParam1, int iParam2, int iParam3, var uParam4, int iParam5) // Position - 0x14B4B
{
	var unk;
	int i;
...
BOOL func_210(Hash hParam0, int iParam1, int iParam2, Hash hParam3) // Position - 0x1514F
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
...
BOOL func_211(Hash hParam0, int iParam1, int iParam2, Hash hParam3) // Position - 0x153CC
{
	if (hParam0 == joaat("Player_Zero"))
	{
		if (iParam1 == 6)
...
BOOL func_212(Hash hParam0, int iParam1, int iParam2, Hash hParam3) // Position - 0x157F1
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
...
BOOL func_213(Hash hParam0, int iParam1, int iParam2) // Position - 0x15AE4
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
...
struct<10> func_214(Hash hParam0, int iParam1) // Position - 0x15B7D
{
	int i;
	var unk;
...
void func_215(var uParam0, Hash hParam1, int iParam2, int iParam3) // Position - 0x164AC
{
	int num;
	Hash itemHash;
	Hash outPropVariant;
...
void func_216(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9) // Position - 0x165D6
{
	uParam0->[0] = iParam1;
	uParam0->[1] = iParam2;
	uParam0->[2] = iParam3;
...
struct<17> func_217(Hash hParam0, int iParam1) // Position - 0x1661E
{
	int i;
	var unk;
	...
	switch (hParam0)
	{
		case joaat("Player_Zero"):
			switch (iParam1)
			{
				...
				case 5:
					func_220(&unk, -99, -99, Global_114370.f_2367.f_539.f_196[0], Global_114370.f_2367.f_539.f_200[0], 6, 3, 0, 0, 0, -99, 0, 0, 3);
					break;
		...
		case joaat("Player_One"):
			switch (iParam1)
			{
				...
				case 2:
					func_220(&unk, -99, -99, Global_114370.f_2367.f_539.f_196[1], Global_114370.f_2367.f_539.f_200[1], 17, 2, 26, 0, 0, -99, 0, 45, 31);
					break;
		...
		case joaat("Player_Two"):
			switch (iParam1)
			{
				...
				case 4:
					func_220(&unk, -99, -99, Global_114370.f_2367.f_539.f_196[2], Global_114370.f_2367.f_539.f_200[2], 8, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
...
void func_218(var uParam0, Hash hParam1, int iParam2, int iParam3) // Position - 0x18468
{
	int num;
	Hash outfit;
...
int func_219(int iParam0) // Position - 0x18652
{
	switch (iParam0)
	{
		case 0:
...
void func_220(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Position - 0x18702
{
	uParam0->[0] = iParam1;
	uParam0->[2] = iParam2;
	uParam0->[3] = iParam3;
...
struct<14> func_221(Hash hParam0, int iParam1, int iParam2, Hash hParam3) // Position - 0x18773
{
	func_267();
...
void func_222(int iParam0, int iParam1, Hash hParam2) // Position - 0x187B4
{
	switch (iParam0)
	{
		case 2:
...
void func_223(int iParam0) // Position - 0x188C0
{
	BOOL flag;
	int num;
	var unk;
	...
	func_224(&Global_79551[0 /*14*/], num6, iParam0, &unk, num2, num3, num, flag, num4, num5, false);
	return;
}

void func_224(int iParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, BOOL bParam7, int iParam8, int iParam9, BOOL bParam10) // Position - 0x18A7B
{
	int num;
	int num2;
	...
	*iParam0 = iParam9;
	...
	else
	{
		...
		if (iParam1 == 11 || iParam1 == 4 || iParam1 == 6 || iParam1 == 1 || iParam1 == 14 || iParam1 == 2 || iParam1 == 8 || iParam1 == 9 || iParam1 == 10 || iParam1 == 7 || iParam1 == 12)
		{
			...
			num = func_90(func_227(iParam1, iParam0->f_2), Global_79548);
		
			if (IS_BIT_SET(num, iParam0->f_1))
				MISC::SET_BIT(&(iParam0->f_6), 1);
		
			num = func_90(func_226(iParam1, iParam0->f_2), Global_79548);
...
BOOL func_225(int iParam0, int iParam1, var uParam2) // Position - 0x18E1D
{
	*uParam2 = 979;
...
int func_226(int iParam0, int iParam1) // Position - 0x19222
{
	switch (iParam1)
	{
		case 0:
...
int func_227(int iParam0, int iParam1) // Position - 0x1961D
{
	switch (iParam1)
	{
		case 0:
...
BOOL func_228(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x19A18
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
BOOL func_229(Hash hParam0, int iParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0x1A8BB
{
	int num;
	int num2;
	int num3;
...
BOOL func_230(Hash hParam0, int iParam1, var uParam2, var uParam3, BOOL bParam4, BOOL bParam5) // Position - 0x1A8F9
{
...
BOOL func_231(int iParam0) // Position - 0x1D55A
{
	return Global_44392 == iParam0;
}

int func_232(int iParam0) // Position - 0x1D568
{
	switch (iParam0)
	{
		case -1:
...
void func_233(int iParam0, Hash hParam1) // Position - 0x1D63C
{
	int num;
...
void func_234(int iParam0, int iParam1, int iParam2, Hash hParam3) // Position - 0x1D65C
{
	int num;
	int num2;
	Hash outfit;
	...
	if (iParam0 == 12)
	{
		...
		if (outfitIndex >= 0)
		{
			...
			if (num3 > outfitIndex)
			{
				...
				func_224(&Global_79551[0 /*14*/], iParam0, iParam1, &(outfit.f_7), 0, 0, outfit.f_2, false, -1, 2, true);
				return;
			}
		}
	}
	...
	{
		func_224(&Global_79551[0 /*14*/], iParam0, iParam1, "NO_LABEL", 0, 0, 0, true, -1, 2, true);
	}
	else if (iParam0 == 14)
	{
		FILES::INIT_SHOP_PED_PROP(&outProp);
		...
		if (componentId >= 0)
		{
			...
			if (num5 > componentId)
			{
				...
				func_224(&Global_79551[0 /*14*/], iParam0, iParam1, &(outProp.f_9), outProp.f_3, outProp.f_4, outProp.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(outProp.f_1, joaat("OUTFIT_ONLY"), 0), num4, 2, outProp.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (hParam3 != -1 && Global_79749)
		{
			...
			func_224(&Global_79551[0 /*14*/], iParam0, iParam1, &(outComponent.f_9), outComponent.f_3, outComponent.f_4, outComponent.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(outComponent.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, outComponent.f_1 != 0);
			return;
		}
...
void func_235(int iParam0, Hash hParam1) // Position - 0x1D8E3
{
	BOOL flag;
	int num;
	var unk;
...
void func_236(int iParam0, Hash hParam1) // Position - 0x1D9E6
{
	BOOL flag;
	int num;
	var unk;
...
void func_237(int iParam0, Hash hParam1) // Position - 0x1DCC5
{
	BOOL flag;
	int value;
	var unk;
	...
	{
		func_224(&Global_79551[0 /*14*/], num5, iParam0, &unk, num, num2, value, flag, num3, num4, false);
	}

	return;
}

void func_238(int iParam0, Hash hParam1) // Position - 0x20A9C
{
	BOOL flag;
	int num;
	var unk;
...
void func_239(int iParam0, Hash hParam1) // Position - 0x20BA1
{
	BOOL flag;
	int value;
	var unk;
...
void func_240(int iParam0, Hash hParam1) // Position - 0x2137D
{
	BOOL flag;
	int value;
	var unk;
...
void func_241(int iParam0, Hash hParam1) // Position - 0x21662
{
	BOOL flag;
	int value;
	var unk;
...
void func_242(int iParam0, Hash hParam1) // Position - 0x22C89
{
	BOOL flag;
	int value;
	var unk;
...
void func_243(int iParam0, Hash hParam1) // Position - 0x242EA
{
	BOOL flag;
	int num;
	var unk;
...
void func_244(int iParam0, Hash hParam1) // Position - 0x24445
{
	BOOL flag;
	int num;
	var unk;
...
void func_245(int iParam0, Hash hParam1) // Position - 0x246C5
{
	BOOL flag;
	int value;
	var unk;
...
BOOL func_246(int iParam0, int iParam1) // Position - 0x25A67
{
	int num;
	int num2;

	if (func_248(iParam0) == 17296)
		return false;
...
int func_247(int iParam0, int iParam1) // Position - 0x25A96
{
	int num;
...
int func_248(int iParam0) // Position - 0x25AAE
{
	int num;
	int num2;
...
void func_249(int iParam0, Hash hParam1) // Position - 0x25E29
{
	BOOL flag;
	int value;
	var unk;
...
void func_250(int iParam0, Hash hParam1) // Position - 0x2758E
{
	BOOL flag;
	int value;
	var unk;
...
void func_251(int iParam0, int iParam1, Hash hParam2) // Position - 0x28461
{
	switch (iParam0)
	{
		case 2:
...
void func_252(int iParam0) // Position - 0x2856D
{
	BOOL flag;
	int num;
	var unk;
...
void func_253(int iParam0, Hash hParam1) // Position - 0x28737
{
	int num;
...
void func_254(int iParam0, Hash hParam1) // Position - 0x28757
{
	BOOL flag;
	int num;
	var unk;
...
void func_255(int iParam0, Hash hParam1) // Position - 0x2885A
{
	BOOL flag;
	int num;
	var unk;
...
void func_256(int iParam0, Hash hParam1) // Position - 0x28B0B
{
	BOOL flag;
	int value;
	var unk;
...
void func_257(int iParam0, Hash hParam1) // Position - 0x2B8CA
{
	BOOL flag;
	int num;
	var unk;
...
void func_258(int iParam0, Hash hParam1) // Position - 0x2B9EB
{
	BOOL flag;
	int value;
	var unk;
...
void func_259(int iParam0, Hash hParam1) // Position - 0x2C2E4
{
	BOOL flag;
	int value;
	var unk;
...
void func_260(int iParam0, Hash hParam1) // Position - 0x2C59B
{
	BOOL flag;
	int value;
	var unk;
...
void func_261(int iParam0, Hash hParam1) // Position - 0x2DBD8
{
	BOOL flag;
	int value;
	var unk;
...
void func_262(int iParam0, Hash hParam1) // Position - 0x2F20B
{
	BOOL flag;
	int num;
	var unk;
...
void func_263(int iParam0, Hash hParam1) // Position - 0x2F362
{
	BOOL flag;
	int num;
	var unk;
...
void func_264(int iParam0, Hash hParam1) // Position - 0x2F67E
{
	BOOL flag;
	int value;
	var unk;
...
void func_265(int iParam0, Hash hParam1) // Position - 0x31B71
{
	BOOL flag;
	int value;
	var unk;
...
void func_266(int iParam0, Hash hParam1) // Position - 0x330FC
{
	BOOL flag;
	int value;
	var unk;
...
void func_267() // Position - 0x33FB6
{
...
BOOL func_268(Ped pedParam0) // Position - 0x34030
{
	int num;
...
int func_269(int iParam0) // Position - 0x340AC
{
	if (func_270(true))
...
BOOL func_270(BOOL bParam0) // Position - 0x340E3
{
	if (func_274(bParam0) || func_272() || func_271(*Global_4718592.f_197275))
		return true;

	return false;
}

BOOL func_271(int iParam0) // Position - 0x34117
{
	return iParam0 == 87;
}

BOOL func_272() // Position - 0x34124
{
	return func_273(*Global_4718592.f_138116);
}

int func_273(int iParam0) // Position - 0x3413A
{
	int i;
...
BOOL func_274(BOOL bParam0) // Position - 0x34174
{
	if (bParam0)
		return IS_BIT_SET(*Global_4718592.f_190071, 12) && func_275();

	return IS_BIT_SET(*Global_4718592.f_190071, 12);
}

BOOL func_275() // Position - 0x341AA
{
...
BOOL func_276(Ped pedParam0, BOOL bParam1) // Position - 0x341D8
{
	int pedDrawableVariation;
	int pedTextureVariation;
	int num;
			...
			switch (pedDrawableVariation)
			{
				...
				case 5:
					if (!bParam1)
					{
						...
						else if (func_116(PLAYER::PLAYER_ID(), true) && Global_1888882[PLAYER::PLAYER_ID() /*611*/].f_10.f_76.f_21 != 0)
						{
							return 1;
						}
					}
...
int func_277(Hash hParam0, int iParam1, int iParam2, int iParam3) // Position - 0x34A12
{
	Hash componentHash;
...
int func_278(int iParam0, Hash hParam1) // Position - 0x35232
{
...
int func_279(Ped pedParam0) // Position - 0x35254
{
...
Player func_280() // Position - 0x352B7
{
	Player player;
...
Player _GET_BOSS_OF_LOCAL_PLAYER() // Position - 0x352D5
{
	return Global_1888882[PLAYER::PLAYER_ID() /*611*/].f_10;
}

BOOL func_282(BOOL bParam0) // Position - 0x352EA
{
	return func_283(PLAYER::PLAYER_ID(), bParam0);
}

BOOL func_283(Player plParam0, BOOL bParam1) // Position - 0x352FC
{
	if (!func_11(plParam0))
		return false;
...
BOOL func_284(Player plParam0) // Position - 0x35334
{
	if (func_11(plParam0))
		if (func_11(Global_1888882[plParam0 /*611*/].f_10))
...
BOOL func_286(Player plParam0, BOOL bParam1, BOOL bParam2) // Position - 0x3538B
{
...
int func_287(var uParam0) // Position - 0x353E2
{
	return *uParam0;
}

void func_288() // Position - 0x353ED
{
...
void func_289(int iParam0) // Position - 0x35438
{
	if (func_46())
		return;
...
void func_290(BOOL bParam0) // Position - 0x3546B
{
	if (bParam0)
		func_292();
...
void func_291(int iParam0, int iParam1) // Position - 0x354BC
{
...
void func_292() // Position - 0x354F2
{
	Global_2740191.f_4672 = 0;
	return;
}

BOOL func_293() // Position - 0x35502
{
...
BOOL _SHOULD_NETWORK_SCRIPT_TERMINATE() // Position - 0x35516
{
...
Hash _GET_CURRENT_SESSION_TYPE_SCRIPT_HASH() // Position - 0x3559A
{
	switch (func_94())
	{
		case 0:
...
Hash func_296() // Position - 0x355CD
{
...
BOOL func_297() // Position - 0x355F1
{
	return Global_2684748.f_700;
}

BOOL _DOES_EVENT_OF_TYPE_EXIST(int iParam0) // Position - 0x35600
{
...
BOOL func_299() // Position - 0x35617
{
	return Global_2696555;
}

BOOL func_300() // Position - 0x35623
{
	return Global_2684748.f_695;
}

void func_301() // Position - 0x35632
{
	SYSTEM::WAIT(0);
	return;
}

void func_302() // Position - 0x3563F
{
	int randomIntInRange;

	NETWORK::NETWORK_SET_THIS_SCRIPT_IS_NETWORK_SCRIPT(32, false, -1);
	func_305(&uLocal_122, joaat("nimbus"), "Plane_1");
	ENTITY::SET_ENTITY_VISIBLE(PLAYER::PLAYER_PED_ID(), false, false);
	uLocal_122.f_8 = 0;
	randomIntInRange = MISC::GET_RANDOM_INT_IN_RANGE(0, 100);

	if (randomIntInRange < 50)
		func_303(&uLocal_122, 4105.583f, -4644.602f, 4.1196f, 11.1032f, -0.012f, 107.968f, "HS4_ISD_TAKE_NIMB2", 0, 1, 1, 0);
	else
		func_303(&uLocal_122, 4105.583f, -4644.602f, 4.1196f, 11.1032f, -0.012f, 107.968f, "HS4_ISD_TAKE_NIMB2", 0, 1, 2, 0);

	return;
}

void func_303(var uParam0, float fParam1, float fParam2, float fParam3, float fParam4, float fParam5, float fParam6, char* sParam7, int iParam8, int iParam9, int iParam10, int iParam11) // Position - 0x356D7
{
...
void func_304(var uParam0, char* sParam1, int iParam2, int iParam3, int iParam4) // Position - 0x35707
{
	uParam0->f_1 = sParam1;
	uParam0->f_2 = iParam3;
...
void func_305(var uParam0, int iParam1, char* sParam2) // Position - 0x35734
{
