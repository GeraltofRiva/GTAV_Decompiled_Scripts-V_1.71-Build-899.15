...
void main() // Position - 0x0
{
	...
	if (IS_BIT_SET(Global_114370.f_18971.f_1, num19))
		num10 = 0.1f;
	...
	while (true)
	{
		...
		switch (num)
		{
			...
			case 5:
				...
				if (IS_BIT_SET(Global_114370.f_18971.f_1, func_373(&unk15) - 125))
				{
			...
			case 9:
				...
				else if (func_335(&unk100, 3, 1000) && !Global_24009.f_135)
				{
			...
			case 10:
				...
				if (!flag6 && !flag7 && !flag9)
				{
					...
					if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
					{
						if (ENTITY::DOES_ENTITY_EXIST(train) && !ENTITY::IS_ENTITY_DEAD(train, false) && !ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), false) && ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), train, vector2, false, true, 0) || ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), func_376(&unk15, num13), vector2, false, true, 0) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()))
						{
							...
							if (flag21)
							{
								if (func_335(&unk100, 3, 1000) && !Global_24009.f_135)
								{
									ENTITY::SET_ENTITY_INVINCIBLE(PLAYER::PLAYER_PED_ID(), true, 0);
									PLAYER::SET_PLAYER_CONTROL(PLAYER::PLAYER_ID(), false, SPC_LEAVE_CAMERA_CONTROL_ON);
									CAM::DO_SCREEN_FADE_OUT(800);
				...
				if (flag6 || flag7 || flag9 || func_470(&unk882) && func_469(&unk882) > 0.25f)
				{
					...
					if (flag6 || num2 == 1)
					{
						...
						{
							num20 = 125;
							MISC::SET_BIT(&(Global_114370.f_18971.f_1), func_373(&unk15) - num20);
							...
							for (k = 0; k < 13; k = k + 1)
							{
								if (!IS_BIT_SET(Global_114370.f_18971.f_1, k))
								{
...
float func_51(float fParam0) // Position - 0x535D
{
	return fParam0 * 0.00078125f;
}

void func_52(const char* sParam0, const char* sParam1, float fParam2, float fParam3, BOOL bParam4, int iParam5) // Position - 0x536D
{
...
void func_53(const char* sParam0, float fParam1, float fParam2, BOOL bParam3, BOOL bParam4, int iParam5) // Position - 0x539A
{
...
int func_54(int iParam0, BOOL bParam1, BOOL bParam2, var uParam3, var uParam4, BOOL bParam5) // Position - 0x53D7
{
	var textureDict;
	var textureName;
	int num;
...
float func_55(int iParam0) // Position - 0x5503
{
	switch (iParam0)
	{
		case 34:
...
void func_56(BOOL bParam0, int* piParam1, int* piParam2, var uParam3) // Position - 0x55DD
{
	float num;
	float value;
	float aspectRatio;
...
BOOL func_57(int iParam0, int iParam1) // Position - 0x5665
{
	return SYSTEM::TO_FLOAT(iParam0) / SYSTEM::TO_FLOAT(iParam1) > 3.5f;
}

char* func_58(int iParam0, BOOL bParam1) // Position - 0x5680
{
	var unk;
	var txdName;
	var netHandle;
	...
	if (!MISC::IS_STRING_NULL_OR_EMPTY(&Global_24148.f_7696[iParam0 /*16*/]))
	{
		...
		{
			return func_59(&Global_24148.f_7696[iParam0 /*16*/]);
		}
	}
...
char* func_59(const char* sParam0) // Position - 0x5BAE
{
	return sParam0;
}

struct<13> GET_GAMER_HANDLE_PLAYER(Player plParam0) // Position - 0x5BB8
{
	var gamerHandle;
...
char* func_61(int iParam0) // Position - 0x5BCF
{
	var txdName;
	var netHandle;
	...
	if (!MISC::IS_STRING_NULL_OR_EMPTY(&Global_24148.f_6623[iParam0 /*16*/]))
	{
		...
		{
			return func_59(&Global_24148.f_6623[iParam0 /*16*/]);
		}
	}
...
void func_62(var uParam0, int iParam1, float fParam2, float fParam3, float fParam4, int iParam5) // Position - 0x5C44
{
	int r;
	int g;
	int b;
...
void func_63(int iParam0, int iParam1, float fParam2, float fParam3, const char* sParam4, int iParam5) // Position - 0x5ED4
{
	eHudColour hudColor;
...
float func_64(float fParam0) // Position - 0x6299
{
	return fParam0 * 0.025f;
}

float func_65(float fParam0) // Position - 0x62A9
{
	return fParam0 * 0.0009259259f;
}

void func_66(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13, int iParam14, int iParam15, int iParam16, int iParam17) // Position - 0x62B9
{
	int num;
	int i;
...
void func_67(int iParam0, int iParam1) // Position - 0x6416
{
	MISC::SET_BIT(&Global_1675455.f_7064[iParam0], iParam1);
	return;
}

BOOL func_68(int iParam0, int iParam1) // Position - 0x642F
{
	return IS_BIT_SET(Global_1675455.f_7064[iParam0], iParam1);
}

float func_69(const char* sParam0, const char* sParam1) // Position - 0x6445
{
...
float func_70(const char* sParam0) // Position - 0x6460
{
	HUD::BEGIN_TEXT_COMMAND_GET_SCREEN_WIDTH_OF_DISPLAY_TEXT(sParam0);
	return HUD::END_TEXT_COMMAND_GET_SCREEN_WIDTH_OF_DISPLAY_TEXT(true) / 2f;
}

void func_71() // Position - 0x6475
{
...
void func_72(const char* sParam0) // Position - 0x649D
{
	GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_PLAYER_NAME_STRING(sParam0);
	return;
}

float func_73() // Position - 0x64AB
{
	float num;
...
float func_74(float fParam0) // Position - 0x64BF
{
	return fParam0 * 0.0013888889f;
}

void func_75(int iParam0) // Position - 0x64CF
{
	if (func_31())
		return;
...
void func_76(var uParam0) // Position - 0x6502
{
...
BOOL func_77() // Position - 0x6535
{
	return Global_101956.f_1;
}

void func_78(var uParam0, var uParam1, Vehicle* pveParam2, Vehicle* pveParam3, Vehicle* pveParam4, var uParam5, Vehicle veParam6, var uParam7, Ped* ppedParam8, var uParam9, var uParam10, int iParam11, var uParam12, Blip blParam13, Blip blParam14, int iParam15, var uParam16, BOOL bParam17) // Position - 0x6543
{
...
int func_79(int iParam0, var uParam1, var uParam2, var uParam3, int iParam4, int iParam5, int iParam6, var uParam7, float fParam8, var uParam9) // Position - 0x6573
{
...
BOOL func_80(var uParam0) // Position - 0x6802
{
...
BOOL func_81(int* piParam0, BOOL bParam1) // Position - 0x6836
{
...
BOOL _STOPWATCH_HAS_TIME_PASSED(var pStopwatch, int millis, BOOL useLocalTimer) // Position - 0x6C92
{
	if (millis == -1)
		return true;
...
void _STOPWATCH_INITIALIZE(var pStopwatch, BOOL useLocalTimer, BOOL useAccurateTime) // Position - 0x6CF0
{
	if (pStopwatch->f_1 == 0)
	{
		if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS() && !useLocalTimer)
...
BOOL _STOPWATCH_IS_INITIALIZED(var uParam0) // Position - 0x6D35
{
	return uParam0->f_1;
}

void func_85(var uParam0, BOOL bParam1) // Position - 0x6D41
{
	func_86(uParam0);
...
void func_86(var uParam0) // Position - 0x6D5E
{
	var unk;
...
void func_87(var uParam0, int iParam1) // Position - 0x6D79
{
	if (iParam1 == 1)
	{
		*uParam0 = 0;
...
void func_88(var uParam0) // Position - 0x6E77
{
	uParam0->f_35 = 0;
	return;
}

int func_89(var uParam0) // Position - 0x6E84
{
	return uParam0->f_35;
}

BOOL func_90() // Position - 0x6E90
{
	if (func_91())
		return false;
...
BOOL func_91() // Position - 0x6EB0
{
	return Global_2697069;
}

BOOL IS_PLAYSTATION_PLATFORM() // Position - 0x6EBC
{
	return MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION();
}

void func_93(BOOL bParam0) // Position - 0x6ED2
{
	HUD::BUSYSPINNER_OFF();
...
void _STOPWATCH_DESTROY(var uParam0) // Position - 0x6EE7
{
	uParam0->f_1 = 0;
	return;
}

void func_95(var uParam0) // Position - 0x6EF4
{
	int i;
	float value;
	int j;
...
void func_96(var uParam0, int iParam1) // Position - 0x708D
{
	func_97(uParam0, iParam1);
	return;
}

void func_97(var uParam0, int iParam1) // Position - 0x709D
{
	*uParam0 = *uParam0 - *uParam0 && iParam1;
	return;
}

BOOL func_98(var uParam0) // Position - 0x70B2
{
	if (*uParam0 != 0)
	{
		if (GRAPHICS::HAS_SCALEFORM_MOVIE_LOADED(*uParam0))
...
void func_99(var uParam0, int iParam1) // Position - 0x70D9
{
	func_100(uParam0, &uLocal_143);
	return;
}

void func_100(var uParam0, var uParam1) // Position - 0x70E9
{
	int i;
	int j;
	var unk;
...
void func_101(var uParam0, var uParam1) // Position - 0x80AE
{
	BOOL flag;
	int num;
	int num2;
...
BOOL func_102(var uParam0, eControlAction ecaParam1) // Position - 0x8444
{
	var unk;
	int num;
	var unk2;
...
void func_103(var uParam0, var uParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0x84E3
{
...
void func_104(int iParam0, int iParam1, int iParam2) // Position - 0x85B8
{
...
float func_107(float fParam0) // Position - 0x8709
{
	return fParam0 / 0.3048f;
}

float func_108(float fParam0) // Position - 0x8719
{
	return fParam0 / 1609.344f;
}

void func_109(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17, var uParam18, var uParam19, var uParam20, var uParam21, var uParam22, var uParam23, var uParam24, var uParam25, var uParam26, var uParam27, var uParam28, var uParam29, var uParam30, var uParam31, var uParam32, var uParam33, var uParam34, var uParam35, var uParam36, var uParam37, var uParam38, var uParam39, var uParam40, var uParam41, var uParam42, int iParam43, Hash hParam44, BOOL bParam45, BOOL bParam46) // Position - 0x8729
{
	var componentType;
...
int func_110(Hash hParam0) // Position - 0x8B30
{
	Hash value;
	float num;
	int num2;
...
float func_111(float fParam0, float fParam1, float fParam2, BOOL bParam3) // Position - 0x8BD6
{
	if (bParam3)
...
int func_112(int iParam0) // Position - 0x8C1A
{
	float num;
	float num2;
...
struct<4> func_113(Hash hParam0) // Position - 0x8C5B
{
	var unk;
...
char* func_114(int iParam0, BOOL bParam1) // Position - 0x8C94
{
	var unk;
...
char* func_115(var uParam0) // Position - 0x9C99
{
	return uParam0;
}

int func_116(int iParam0, Any* panParam1) // Position - 0x9CA3
{
	int i;
	int numDlcWeapons;
...
int func_117(Hash hParam0) // Position - 0x9CDE
{
	if (hParam0 == 600)
...
void func_118(int iParam0, int iParam1, int iParam2, int iParam3, const char* sParam4, const char* sParam5) // Position - 0x9E51
{
...
BOOL func_119(Any* panParam0, Any* panParam1) // Position - 0x9EA3
{
...
BOOL IS_GAMER_HANDLE_VALID(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12) // Position - 0x9EDD
{
	return NETWORK::NETWORK_IS_HANDLE_VALID(&uParam0, 13);
}

void func_121(var uParam0, var uParam1) // Position - 0x9EED
{
	int i;
	int j;
	var unk;
...
void func_122(var uParam0, var uParam1) // Position - 0xA058
{
	var unk;
	var unk2;
	var unk3;
...
void func_123(var uParam0) // Position - 0xA107
{
	int i;
	int j;
	int num;
...
void func_124(int iParam0) // Position - 0xA318
{
	var unk;
	int i;
...
BOOL func_125(var uParam0, int iParam1, var uParam2, int iParam3) // Position - 0xA38C
{
	int num;
...
void func_126(var uParam0) // Position - 0xA635
{
	var unk;
	int i;
	int j;
...
void func_127(int iParam0, int iParam1, int iParam2, const char* sParam3) // Position - 0xA714
{
...
BOOL func_128(var uParam0) // Position - 0xA748
{
	if (!Global_2097532)
	{
...
void func_129(var uParam0) // Position - 0xA901
{
	int i;
	int j;
	int num;
...
Vector3 _GET_PLAYER_COORDS(Player plParam0) // Position - 0xAAE7
{
	return ENTITY::GET_ENTITY_COORDS(PLAYER::GET_PLAYER_PED(plParam0), false);
}

void func_131(int iParam0, int iParam1) // Position - 0xAAFA
{
	int i;
...
int func_132(int iParam0) // Position - 0xAB76
{
	int i;
	int num;
	int num2;
...
BOOL func_133(var uParam0) // Position - 0xAC09
{
	int i;
	int j;
...
BOOL func_134(var uParam0, int iParam1, Any* panParam2, var uParam3) // Position - 0xADC0
{
	var unk;
	int i;
...
void func_135(Any* panParam0, char* sParam1) // Position - 0xAE79
{
	NETWORK::NETWORK_CLAN_GET_UI_FORMATTED_TAG(panParam0, 35, sParam1);
	return;
}

BOOL func_136(Any* panParam0, Any* panParam1) // Position - 0xAE8B
{
	int i;
...
BOOL IS_XBOX_PLATFORM() // Position - 0xAECA
{
	return MISC::IS_DURANGO_VERSION() || MISC::IS_SCARLETT_VERSION();
}

void func_138(var uParam0) // Position - 0xAEE0
{
	int i;
...
void func_139(Any* panParam0) // Position - 0xAF50
{
	*panParam0 = 0;
	panParam0->f_1 = 0;
	panParam0->f_2 = 0;
...
BOOL func_140(var uParam0) // Position - 0xAF98
{
	int i;
...
BOOL func_141(var uParam0, Any* panParam1, char* sParam2) // Position - 0xB006
{
	if (*uParam0 == 2)
		return true;
...
BOOL func_142(var uParam0) // Position - 0xB117
{
...
BOOL func_143(var uParam0) // Position - 0xB2AC
{
	int i;
...
BOOL func_144(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, char* sParam17) // Position - 0xB349
{
	var gamerHandle;
...
BOOL func_145(var uParam0, const char* sParam1, char* sParam2, Any anParam3, var uParam4) // Position - 0xB46B
{
	int displaynamesFromHandles;
	var unk;
...
BOOL func_146(var uParam0) // Position - 0xB570
{
	var unk;
	var unk99;
	int i;
...
void func_147(int iParam0, int iParam1) // Position - 0xC395
{
	int i;
...
BOOL func_148(var uParam0, var uParam1, Any* panParam2, int iParam3, int iParam4) // Position - 0xC4BA
{
	switch (*uParam0)
	{
		case 0:
...
void func_153(var uParam0, var uParam1, var uParam2) // Position - 0xC616
{
	*uParam0 = 0;
	*uParam1 = 0;
	Global_2097152 = false;
...
BOOL func_154(int iParam0) // Position - 0xC642
{
...
void func_155(var uParam0, char* sParam1, int iParam2) // Position - 0xC6A0
{
	int num;
	int i;
...
void func_156(var uParam0) // Position - 0xC7AA
{
	int i;
...
void func_157(var uParam0, var uParam1) // Position - 0xC853
{
	*uParam0 = *uParam1;
...
BOOL func_158(var uParam0, var uParam1, Any* panParam2, int iParam3, Any* panParam4, BOOL bParam5, BOOL bParam6, int iParam7, int iParam8) // Position - 0xC86E
{
	int any;
	float num;
...
BOOL func_160(var uParam0) // Position - 0xC9C0
{
	var unk;
	var unk99;
	int i;
...
BOOL func_161(var uParam0, var uParam1, Any* panParam2, Any* panParam3, Any anParam4, BOOL bParam5, int iParam6, int iParam7) // Position - 0xD3BA
{
	switch (*uParam0)
	{
		case 0:
...
BOOL func_162(var uParam0) // Position - 0xD476
{
	var unk;
	var unk14;
	var unk112;
...
BOOL func_163(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17, var uParam18, var uParam19, var uParam20, var uParam21, var uParam22, var uParam23, var uParam24, var uParam25, var uParam26, var uParam27, var uParam28, var uParam29, var uParam30, var uParam31, var uParam32, var uParam33, var uParam34, var uParam35, var uParam36, var uParam37, var uParam38, var uParam39, var uParam40, var uParam41, var uParam42, var uParam43, var uParam44, var uParam45, var uParam46, var uParam47, var uParam48, var uParam49, var uParam50, var uParam51, var uParam52, var uParam53, var uParam54, var uParam55, var uParam56, var uParam57, var uParam58, var uParam59, var uParam60, var uParam61, var uParam62, var uParam63, var uParam64, var uParam65, var uParam66, var uParam67, var uParam68) // Position - 0xE2A2
{
	int i;
...
void func_164(var uParam0) // Position - 0xE33A
{
	int cacheTime;
...
void func_165(int iParam0) // Position - 0xE38A
{
...
void func_166(int iParam0, var uParam1, int iParam2, BOOL bParam3, BOOL bParam4) // Position - 0xE3AA
{
	char* componentType;
	var clanDesc;
	var unk35;
...
void func_167(int iParam0, char* sParam1, var uParam2, int iParam3) // Position - 0xE695
{
	int i;
...
void func_168(int iParam0, char* sParam1, const char* sParam2, char* sParam3, BOOL bParam4, int iParam5) // Position - 0xE6D7
{
...
BOOL func_169(int iParam0) // Position - 0xE767
{
...
void func_170(int iParam0, int iParam1) // Position - 0xE789
{
...
int func_171() // Position - 0xE7A6
{
	return GRAPHICS::REQUEST_SCALEFORM_MOVIE("SC_LEADERBOARD");
}

BOOL func_172() // Position - 0xE7B6
{
	return func_173(PLAYER::PLAYER_ID());
}

BOOL func_173(Player plParam0) // Position - 0xE7C6
{
...
int func_174(Player plParam0) // Position - 0xE826
{
	return Global_1845274[plParam0 /*877*/].f_185;
}

void func_175(int iParam0) // Position - 0xE839
{
	Global_1577957 = iParam0;
	return;
}

void func_176(int iParam0) // Position - 0xE847
{
	Global_1675455.f_1163 = iParam0;
	return;
}

void func_177(BOOL bParam0) // Position - 0xE858
{
	if (bParam0)
		func_179();
...
void func_178(int iParam0, int iParam1) // Position - 0xE8A9
{
...
void func_179() // Position - 0xE8DF
{
	Global_2740191.f_4672 = 0;
	return;
}

void _STOPWATCH_RESET(var pStopwatch, BOOL useLocalTimer, BOOL useAccurateTime) // Position - 0xE8EF
{
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS() && !useLocalTimer)
		if (!useAccurateTime)
			*pStopwatch = NETWORK::GET_NETWORK_TIME();
...
BOOL func_181(var uParam0, BOOL bParam1, int iParam2) // Position - 0xE92C
{
...
void func_182(var uParam0) // Position - 0xEACB
{
	GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(uParam0->f_4, "CLEAR_ALL");
	GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
...
void func_183(var uParam0) // Position - 0xEB90
{
	float screenWidthOfDisplayText;
	int num;
	int num2;
...
void func_184(var uParam0) // Position - 0xEC98
{
	uParam0->f_547 = 1f;
	uParam0->f_546 = 0;
	uParam0->f_572 = 0f;
...
void func_185(var uParam0, char* sParam1, int iParam2, int iParam3, int iParam4, var uParam5, float fParam6) // Position - 0xED17
{
	int num;
	int num2;
	int num3;
	...
	*uParam5 = num2 + num3 + num + num4;
	...
	func_186(&(uParam0->f_26), 5, "BJ_SC_ACC_RWD", "", SYSTEM::ROUND((50f + (1.5f * (float)iParam4)) * fParam6), 0, 0, 0);
	func_186(&(uParam0->f_26), 5, "BJ_SC_TOT_RWD", "", *uParam5, 0, 0, 0);
	return;
}

void func_186(var uParam0, int iParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6, int iParam7) // Position - 0xEE6A
{
	int num;
...
void func_187(var uParam0, char* sParam1, char* sParam2, int iParam3) // Position - 0xEEDD
{
...
void func_188(var uParam0) // Position - 0xEF00
{
	func_184(uParam0);
	uParam0->f_574 = 0;
	uParam0->f_31 = 0;
...
char* AUDIO_SPEECH_GET_PARAM_STRING_FROM_ENUM(int iParam0) // Position - 0xEF2A
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_190(int iParam0, int iParam1, float fParam2, int iParam3) // Position - 0xEFE5
{
...
BOOL func_191(var uParam0) // Position - 0xF028
{
	var unk;
	var unk99;
	int num;
...
BOOL func_192() // Position - 0xF44B
{
	return IS_BIT_SET(Global_1048576.f_10, 1);
}

BOOL func_193() // Position - 0xF45B
{
	return Global_2693808.f_3;
}

BOOL func_194(int iParam0) // Position - 0xF469
{
	switch (iParam0)
	{
		case 817:
...
BOOL func_196(int iParam0, int iParam1, int iParam2) // Position - 0xF59A
{
	int columnType;
...
BOOL func_197(int iParam0, int iParam1) // Position - 0xF69C
{
...
BOOL func_198(var uParam0, var uParam1, Any* panParam2, Any* panParam3) // Position - 0xF6F7
{
	switch (*uParam0)
	{
		case 0:
...
void func_199(int iParam0, int iParam1, float fParam2, int iParam3) // Position - 0xF7AB
{
	var unk;
	var unk8;
...
void func_200(int iParam0, int iParam1, int iParam2, float fParam3, BOOL bParam4) // Position - 0xF93A
{
	int offset;
	int i;
...
BOOL _LEADERBOARDS2_TRY_BEGIN_WRITE_DATA(int iParam0, var uParam1, var uParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6) // Position - 0xFA55
{
	int num;
	int i;
	var gamerHandle;
...
void func_202(int iParam0) // Position - 0xFB89
{
	var unk;
...
void func_203(var uParam0, int iParam1, const char* sParam2, char* sParam3, int iParam4, int iParam5, BOOL bParam6, BOOL bParam7) // Position - 0xFC8A
{
	var unk;
	var unk9;
	int i;
	...
	switch (iParam1)
	{
		...
		case 0:
			...
			else
			{
				...
				if (func_209(*Global_4718592.f_197275) || func_206(*Global_4718592.f_197275))
				{
					TEXT_LABEL_ASSIGN_STRING(&Global_2097536.f_2717[0 /*6*/], "SCLB_C_SCORE" /*SCORE*/, 24);
				...
				else if (func_205(*Global_4718592.f_197275))
				{
					TEXT_LABEL_ASSIGN_STRING(&Global_2097536.f_2717[0 /*6*/], "SCLB_C_SCORE" /*SCORE*/, 24);
					TEXT_LABEL_ASSIGN_STRING(&Global_2097536.f_2717[1 /*6*/], "SCLB_C_DEATH" /*DEATHS*/, 24);
					TEXT_LABEL_ASSIGN_STRING(&Global_2097536.f_2717[2 /*6*/], "SCLB_C_RANK" /*POSITION*/, 24);
...
struct<6> func_204(int iParam0) // Position - 0x150AA
{
	var unk;
...
BOOL func_205(int iParam0) // Position - 0x15159
{
	return iParam0 == 74;
}

BOOL func_206(int iParam0) // Position - 0x15166
{
	return func_208(iParam0) || func_207(iParam0);
}

BOOL func_207(int iParam0) // Position - 0x15180
{
	return iParam0 == 44;
}

BOOL func_208(int iParam0) // Position - 0x1518D
{
	return iParam0 == 45;
}

BOOL func_209(int iParam0) // Position - 0x1519A
{
	return iParam0 == 12;
}

struct<6> func_210(int iParam0) // Position - 0x151A7
{
	var unk;
...
Hash func_211(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, int iParam8, int iParam9, int iParam10, int iParam11, BOOL bParam12) // Position - 0x15330
{
	var unk;
...
BOOL func_212() // Position - 0x153A2
{
...
BOOL func_213() // Position - 0x154D8
{
	return NETWORK::NETWORK_IS_SIGNED_ONLINE();
}

void func_214(var uParam0, BOOL bParam1, eControlAction ecaParam2, char* sParam3, eControlAction ecaParam4, char* sParam5, eControlAction ecaParam6, char* sParam7, eControlAction ecaParam8, int iParam9) // Position - 0x154E4
{
	if (*uParam0 == 0)
		*uParam0 = GRAPHICS::REQUEST_SCALEFORM_MOVIE_INSTANCE("instructional_buttons");
...
var func_215(BOOL bParam0, var uParam1, var uParam2) // Position - 0x15628
{
	if (bParam0)
		return uParam1;
...
void func_216() // Position - 0x1563F
{
	func_217(PLAYER::PLAYER_PED_ID(), "GENERIC_CURSE_MED", 24);
	return;
}

void func_217(Ped pedParam0, char* sParam1, int iParam2) // Position - 0x15655
{
	AUDIO::PLAY_PED_AMBIENT_SPEECH_NATIVE(pedParam0, sParam1, AUDIO_SPEECH_GET_PARAM_STRING_FROM_ENUM_0(iParam2), 1);
	return;
}

char* AUDIO_SPEECH_GET_PARAM_STRING_FROM_ENUM_0(int iParam0) // Position - 0x1566C
{
	char* str;
...
void func_220(int iParam0, int iParam1) // Position - 0x158AC
{
...
void func_221(var uParam0, int iParam1, BOOL bParam2) // Position - 0x158C4
{
	if (bParam2)
...
int func_222(var uParam0, int iParam1, var uParam2, var uParam3, float fParam4) // Position - 0x158EA
{
	int num;
...
void func_223(eCharacter echParam0, int iParam1, int iParam2, BOOL bParam3, BOOL bParam4) // Position - 0x15958
{
	int outValue;
	Hash statHash;
...
int func_224(int iParam0, int iParam1, int iParam2, int iParam3, BOOL bParam4) // Position - 0x15A2A
{
	float num;
	int num2;
	int num3;
...
void func_225(BOOL bParam0) // Position - 0x16029
{
	int i;
	int j;
...
void func_226(int iParam0) // Position - 0x162AB
{
	int value;
...
void func_227(int iParam0) // Position - 0x16305
{
	int num;
	BOOL flag;
	var txdName;
	...
	else if (IS_BIT_SET(Global_114370.f_20568.f_471, iParam0) || IS_BIT_SET(Global_2359296[func_229() /*5571*/].f_681.f_10, iParam0))
	{
		flag = true;
		MISC::CLEAR_BIT(&(Global_114370.f_20568.f_471), iParam0);
...
char* AUDIO_SPEECH_GET_PARAM_STRING_FROM_ENUM_0_0(int iParam0) // Position - 0x164D0
{
	switch (iParam0)
	{
		case 0:
...
void _MPPLY_STAT_SET_INT(Hash hParam0, int iParam1) // Position - 0x1660F
{
	Hash statName;
...
int _MPPLY_STAT_GET_INT(Hash hParam0) // Position - 0x1662B
{
	Hash statHash;
	int outValue;
...
Hash func_232(int iParam0) // Position - 0x16649
{
	switch (iParam0)
	{
		case 38:
...
BOOL func_233(int iParam0) // Position - 0x1666B
{
	switch (iParam0)
	{
		case 38:
...
int func_234(int iParam0) // Position - 0x16688
{
	switch (iParam0)
	{
		case 18:
...
BOOL func_235(int iParam0) // Position - 0x1678D
{
	switch (iParam0)
	{
		case 18:
...
void func_236(int iParam0, int iParam1, int iParam2, BOOL bParam3) // Position - 0x1681C
{
	Hash statName;
...
Hash func_237(int iParam0, int iParam1) // Position - 0x1684A
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(0, iParam0, func_238(iParam1));
}

int func_238(int iParam0) // Position - 0x1685F
{
	int num;
	int num2;
...
int func_239() // Position - 0x16893
{
	return Global_1574927;
}

void _STAT_SET_PACKED_BOOL(int iParam0, BOOL bParam1, int iParam2) // Position - 0x1689F
{
	if (iParam2 == -1)
		iParam2 = func_239();
...
void func_241(int iParam0) // Position - 0x168BD
{
	func_370(93, iParam0);
	func_370(29, iParam0);
	func_370(30, iParam0);
...
BOOL func_242(int iParam0) // Position - 0x168DD
{
	int cloudTimeAsInt;
	int num;
	int cloudTimeAsInt2;
...
int func_243(int iParam0, int iParam1) // Position - 0x16AE8
{
	Hash statHash;
	int outValue;
...
BOOL _STAT_GET_PACKED_BOOL(int iParam0, int iParam1) // Position - 0x16B17
{
	if (iParam1 == -1)
		iParam1 = func_239();
...
int func_245(BOOL bParam0) // Position - 0x16B33
{
	var outValue;
	int value;
	int outValue2;
...
int func_246(int iParam0, int iParam1) // Position - 0x16BEA
{
	if (iParam0 >= 78)
		return 0;
...
int func_247(int iParam0, int iParam1) // Position - 0x16C05
{
	...
	if (func_257(&Global_4546910))
	{
		if (func_255(&Global_4546910, iParam0))
			return 0;
	
		if (func_248(&Global_4546910, iParam0))
			return 1;
	}
	else
	{
...
BOOL func_248(var uParam0, int iParam1) // Position - 0x16CA2
{
	int i;
	var unk;
...
int func_249(var uParam0, int iParam1) // Position - 0x16D53
{
	int i;
...
BOOL func_250(var uParam0, int iParam1) // Position - 0x16DCE
{
	return uParam0->[iParam1] == 78;
}

void func_251(var uParam0) // Position - 0x16DDF
{
	int i;
	...
	func_253(uParam0, Global_4546909 - 0.5f);
	return;
}

void func_252(var uParam0, int iParam1) // Position - 0x16E13
{
	uParam0->[iParam1] = 78;
	return;
}

void func_253(var uParam0, int iParam1) // Position - 0x16E23
{
	if (iParam1 == 0f)
		uParam0->f_80 = 0f;
	else
...
float func_254(var uParam0) // Position - 0x16E40
{
	return uParam0->f_80;
}

BOOL func_255(var uParam0, int iParam1) // Position - 0x16E4C
{
	return func_256(uParam0, iParam1) != -1;
}

int func_256(var uParam0, int iParam1) // Position - 0x16E5E
{
	int i;
...
BOOL func_257(var uParam0) // Position - 0x16E8B
{
	return uParam0->f_79 == 1;
}

BOOL func_258(int iParam0) // Position - 0x16E99
{
	switch (iParam0)
	{
		case 60:
...
BOOL func_259(int iParam0) // Position - 0x16EE9
{
	return Global_44392 == iParam0;
}

BOOL func_260(int iParam0, int iParam1) // Position - 0x16EF7
{
...
void func_261(Hash hParam0, int iParam1) // Position - 0x16F48
{
	int outValue;
...
void func_262() // Position - 0x16F6B
{
	int outValue;
...
int func_263(eCharacter echParam0) // Position - 0x16FE0
{
	return Global_2241[echParam0 /*29*/].f_17;
}

void func_264(int iParam0, int iParam1, int iParam2) // Position - 0x16FF1
{
	BOOL flag;
...
void func_265() // Position - 0x170D7
{
	int num;
	float num2;
	float num3;
	...
	if (value > 0f && SYSTEM::FLOOR(value) < SYSTEM::FLOOR(Global_114370.f_10198.f_3853))
		func_260(13, SYSTEM::FLOOR(Global_114370.f_10198.f_3853));
...
int func_266() // Position - 0x17595
{
	return Global_33298;
}

void func_267(int iParam0, BOOL bParam1) // Position - 0x175A0
{
...
BOOL func_268(int iParam0) // Position - 0x175E5
{
	if (iParam0 == 146 || iParam0 == -1)
		return false;
...
void func_269(int iParam0, BOOL bParam1) // Position - 0x17612
{
	int num;
...
BOOL func_270(var uParam0, int iParam1) // Position - 0x17698
{
	return IS_BIT_SET(uParam0->f_607, iParam1);
}

int func_271() // Position - 0x176A8
{
	return GRAPHICS::REQUEST_SCALEFORM_MOVIE("MP_BIG_MESSAGE_FREEMODE");
}

void func_272(var uParam0, var uParam1, var uParam2, Vehicle veParam3, Ped pedParam4, var uParam5, var uParam6, var uParam7) // Position - 0x176B8
{
	Ped ped;
	Vehicle trailer;
	BOOL isPedInjured;
...
BOOL func_273(Vehicle veParam0, Ped pedParam1) // Position - 0x1784F
{
	Vehicle trailer;
...
float func_274(float fParam0, float fParam1) // Position - 0x17A02
{
	if (fParam0 > fParam1)
		return fParam0;
...
int func_275(int iParam0, int iParam1, int iParam2) // Position - 0x17A19
{
	if (iParam0 > iParam2)
		return iParam2;
...
void func_276(Vector3 vParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5) // Position - 0x17A3E
{
	float num;
	int alpha;
...
void func_277(var uParam0, var uParam1, int iParam2, int iParam3) // Position - 0x17AF5
{
	Hash hash;
	...
	if (_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED("BJ_FALLHLP") && Global_24009.f_135)
	{
		HUD::CLEAR_HELP(true);
		func_221(uParam0, 1, false);
	}

	if (!func_270(uParam0, 1) && !Global_24009.f_135)
	{
...
void func_278(var uParam0) // Position - 0x17C57
{
...
float func_279(float fParam0, float fParam1, float fParam2) // Position - 0x17DCB
{
	float num;
...
float func_280(float fParam0) // Position - 0x17DFA
{
	return fParam0 * 57.29578f;
}

BOOL func_281(Vehicle veParam0) // Position - 0x17E0A
{
	var entityCoords;
	var position;
	var rightVector;
...
float func_282(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5) // Position - 0x17E74
{
	return (fParam0 * uParam3) + (fParam0.f_1 * uParam3.f_1) + (fParam0.f_2 * uParam3.f_2);
}

float func_283(Ped pedParam0, Vehicle veParam1, BOOL bParam2) // Position - 0x17E95
{
...
Vector3 func_284(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3) // Position - 0x17EF3
{
	var groundZ;
...
BOOL func_285(Ped pedParam0) // Position - 0x17F39
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return false;
...
void func_286(int* piParam0, var uParam1) // Position - 0x17F57
{
	var sizeAndPeds;
	int taskSequenceId;
	float num;
...
void func_287(var uParam0) // Position - 0x1819B
{
...
int func_288(Entity eParam0, var uParam1) // Position - 0x181CC
{
	int i;
...
void func_290() // Position - 0x184ED
{
	Global_33443 = 1;
	return;
}

void func_291() // Position - 0x184F9
{
	int i;
...
void func_292(int* piParam0) // Position - 0x18569
{
	piParam0->f_607 = 0;
	return;
}

void func_293(Vehicle veParam0, var uParam1, var uParam2, var uParam3, float fParam4, int iParam5, BOOL bParam6) // Position - 0x18577
{
	var unk;
...
void func_294(int iParam0, Vehicle veParam1, int iParam2) // Position - 0x186A0
{
	Vehicle vehicle;
	...
	if (!func_314(&Global_78558.f_555[0 /*21*/], iParam0))
		return;
	...
	if (ENTITY::DOES_ENTITY_EXIST(veParam1))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(veParam1, false))
		{
			...
			if (iParam0 == 24)
				Global_114370.f_32754.f_4801 = func_528();
...
void func_295(Vehicle veParam0, eCharacter echParam1) // Position - 0x187B7
{
	Ped pedInVehicleSeat;
	int i;
	int j;
	...
	func_325(veParam0, &(Global_114370.f_32754.f_5510));
	return;
}

BOOL func_296(Vehicle veParam0) // Position - 0x189B9
{
...
BOOL func_297(Hash hParam0) // Position - 0x18A96
{
	if (hParam0 == 0)
		return false;
...
BOOL func_298(Hash hParam0, BOOL bParam1, int iParam2) // Position - 0x18C54
{
	int i;
	Hash outData;
...
BOOL func_299(Hash hParam0) // Position - 0x18DD9
{
	int num;
	var unk;
	var name;
...
BOOL _NETSHOPPING_SHOULD_USE_TRANSACTION_SYSTEM() // Position - 0x18EA5
{
	if (MISC::IS_PC_VERSION())
...
BOOL func_301(Hash hParam0, int iParam1) // Position - 0x18EBC
{
	int cloudTimeAsInt;
	int num;
	int i;
...
BOOL func_302() // Position - 0x190E9
{
	return false;
}

BOOL func_303() // Position - 0x190F2
{
	return true;
}

BOOL func_304() // Position - 0x190FB
{
	return true;
}

BOOL func_305() // Position - 0x19104
{
...
BOOL _IS_EXCLUSIVE_CONTENT_UNLOCKED() // Position - 0x1911D
{
	int profileSetting;
...
BOOL func_307(Vehicle veParam0) // Position - 0x191D5
{
	Hash entityModel;
...
BOOL func_308(Vehicle veParam0) // Position - 0x1921C
{
	int i;
...
BOOL func_309(Vehicle veParam0) // Position - 0x19257
{
	int i;
...
BOOL func_310(Vehicle veParam0) // Position - 0x192D3
{
	int i;
...
BOOL func_311(Vehicle veParam0, int iParam1, BOOL bParam2) // Position - 0x193BB
{
	int i;
	var garageName;
	int num;
...
BOOL func_312(int iParam0, int iParam1, char* sParam2, var uParam3) // Position - 0x19429
{
...
Vehicle func_313(int iParam0) // Position - 0x19501
{
	if (iParam0 == -1)
		return 0;
...
BOOL func_314(var uParam0, int iParam1) // Position - 0x1951D
{
	BOOL num;
	int num2;
	...
	*uParam0 = { 0f, 0f, 0f };
	...
	if (IS_BIT_SET(uParam0->f_9, 10))
	{
		...
		if (!func_324(Global_114370.f_32754.f_1864[uParam0->f_14 /*3*/], 0f, 0f, 0f, false))
	...
	{
		if (!func_324(Global_114370.f_2367.f_539.f_3588[1 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, false))
		{
	...
	{
		if (!func_324(Global_114370.f_2367.f_539.f_3588[0 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, false))
		{
...
int func_315(eCharacter echParam0, int iParam1) // Position - 0x1AC0B
{
	int num;
...
void func_316(eCharacter echParam0, var uParam1, int iParam2) // Position - 0x1AC4D
{
	int num;
...
void func_317(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, float fParam5, int iParam6) // Position - 0x1AEA9
{
	if (func_314(&Global_78558.f_555[0 /*21*/], iParam0))
	{
		...
		{
			func_322(iParam0);
			func_321(uParam1, &Global_114370.f_32754.f_69[Global_78558.f_555[0 /*21*/].f_14 /*78*/]);
...
void func_318(int iParam0, BOOL bParam1) // Position - 0x1AFA2
{
	if (iParam0 == -1)
		return;
...
void func_319(int iParam0, int iParam1, BOOL bParam2) // Position - 0x1AFFF
{
	if (iParam0 == -1)
		return;
...
BOOL func_320(int iParam0, int iParam1) // Position - 0x1B03A
{
	if (iParam0 == -1)
		return false;
...
void func_321(var uParam0, var uParam1) // Position - 0x1B05A
{
...
void func_322(int iParam0) // Position - 0x1B126
{
	if (iParam0 == -1)
		return;
...
int func_323(Vehicle veParam0) // Position - 0x1B19D
{
	int i;
...
BOOL func_324(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, BOOL bParam6) // Position - 0x1B200
{
	if (bParam6)
...
void func_325(Vehicle veParam0, var uParam1) // Position - 0x1B247
{
	int i;
...
int func_326(int iParam0) // Position - 0x1B4F2
{
	switch (iParam0)
	{
		case 1:
...
int func_327(var uParam0, var uParam1, var uParam2) // Position - 0x1B5A2
{
	int i;
	int modType;
...
BOOL func_328(int iParam0) // Position - 0x1B795
{
	switch (iParam0)
	{
		case joaat("granger"):
...
void func_329(var uParam0) // Position - 0x1B7B5
{
	int i;
...
void func_330(int iParam0) // Position - 0x1B865
{
...
float func_331(int iParam0) // Position - 0x1B88C
{
	switch (iParam0)
	{
		case 0:
...
Vector3 func_332(int iParam0) // Position - 0x1B956
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_333(Vehicle veParam0) // Position - 0x1BAA6
{
	if (ENTITY::DOES_ENTITY_EXIST(veParam0))
...
void func_334(int* piParam0) // Position - 0x1BAE9
{
	if (*piParam0 != 0)
	{
		GRAPHICS::SET_SCALEFORM_MOVIE_AS_NO_LONGER_NEEDED(piParam0);
...
BOOL func_335(var uParam0, int iParam1, int iParam2) // Position - 0x1BBBC
{
...
BOOL func_336(var uParam0, int* piParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12) // Position - 0x1BC14
{
	var unk;
...
void func_337(Vehicle veParam0, var uParam1, int* piParam2) // Position - 0x1BD28
{
	float camRot;
	Cam cam;
	Cam cam2;
...
float func_338() // Position - 0x1BDA7
{
	if (MISC::IS_PC_VERSION())
		return 0.5f;
...
BOOL func_339(var uParam0, var uParam1, var uParam2, int* piParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11) // Position - 0x1BDC3
{
	Cam cam;
	float num;
	var unk3;
...
BOOL func_340(var uParam0, int iParam1) // Position - 0x1C003
{
	return IS_BIT_SET(uParam0->f_2, iParam1) && !IS_BIT_SET(uParam0->f_3, iParam1);
}

void func_341(char* sParam0) // Position - 0x1C01F
{
...
Vector3 func_342(var uParam0) // Position - 0x1C035
{
	return *uParam0, uParam0->f_1, 0f;
}

void func_343(Vehicle veParam0, var uParam1, var uParam2, var uParam3) // Position - 0x1C045
{
	float num;
	float num2;
	float num3;
...
BOOL _IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(char* message) // Position - 0x1C0D1
{
	HUD::BEGIN_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(message);
	return HUD::END_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(0);
}

void _DISPLAY_HELP_TEXT(char* text, int iParam1) // Position - 0x1C0E4
{
...
void func_346(var uParam0, BOOL bParam1) // Position - 0x1C0FB
{
	if (bParam1)
	{
...
void _SHOW_SUBTITLE_CLEAR_EXISTING(char* sParam0, int iParam1, int iParam2) // Position - 0x1C143
{
	iParam2 = iParam2;
...
struct<4> func_348(int iParam0) // Position - 0x1C15C
{
	var unk;
...
void func_349(int* piParam0, float fParam1) // Position - 0x1C1C2
{
	if (!func_470(piParam0))
...
void func_350(int* piParam0, var uParam1) // Position - 0x1C1DC
{
	if (func_470(piParam0))
	{
...
BOOL _CONVERSATION_IS_DIALOGUE_IN_PROGRESS() // Position - 0x1C228
{
...
BOOL func_352(int* piParam0, float fParam1) // Position - 0x1C24A
{
...
BOOL func_353(int* piParam0, float fParam1) // Position - 0x1C268
{
	if (func_470(piParam0))
...
void func_354(Hash* phParam0) // Position - 0x1C28A
{
	if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
...
int func_355(var uParam0, Vehicle veParam1, Ped pedParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, int iParam9, var uParam10, Blip* pblParam11, Blip* pblParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17, var uParam18, BOOL bParam19, BOOL bParam20, float fParam21) // Position - 0x1C330
{
	var forwardVector;
	var rightVector;
	var upVector;
...
float func_356(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5) // Position - 0x1CC2C
{
	return (fParam0 * uParam3) + (fParam0.f_1 * uParam3.f_1);
}

void func_357(var uParam0, BOOL bParam1) // Position - 0x1CC43
{
...
BOOL func_358() // Position - 0x1CC86
{
...
BOOL func_359(var uParam0, var uParam1, var uParam2) // Position - 0x1CCDE
{
	Ped ped;
	int pedParachuteLandingType;
...
float func_360(int* piParam0) // Position - 0x1CD97
{
	if (func_470(piParam0))
...
BOOL func_361(int* piParam0) // Position - 0x1CDD0
{
	return IS_BIT_SET(*piParam0, 2);
}

void func_362(Vector3 vParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5) // Position - 0x1CDDD
{
	var screenX;
	var screenY;
	float screenX2;
...
void func_363(Vector3 vParam0, var uParam1, var uParam2, var uParam3, var uParam4) // Position - 0x1CF4D
{
	float screenX;
	float screenY;
	float num;
...
int func_364(Vector3 vParam0, var uParam1, var uParam2, int iParam3, int iParam4) // Position - 0x1D034
{
	float num;
	int num2;
...
void func_365(int* piParam0) // Position - 0x1D0A0
{
...
BOOL func_366(var uParam0, int iParam1, var uParam2) // Position - 0x1D0C8
{
	Vehicle vehiclePedIsIn;
	Vector3 entityCoords;
	var unk3;
...
BOOL func_367() // Position - 0x1D245
{
...
BOOL func_368(var uParam0) // Position - 0x1D25E
{
	return uParam0->f_84;
}

void func_369(var uParam0, BOOL bParam1) // Position - 0x1D26A
{
	int taskSequenceId;
	Ped pedInVehicleSeat;
	var entityCoords;
...
void func_370(int iParam0, int iParam1) // Position - 0x1D359
{
	int outValue;
...
void func_371(BOOL bParam0, BOOL bParam1, BOOL bParam2) // Position - 0x1D3B6
{
	if (bParam0)
...
BOOL func_372(Hash hParam0) // Position - 0x1D3F4
{
	switch (hParam0)
	{
		case joaat("bmx"):
...
int func_373(var uParam0) // Position - 0x1D474
{
	return *uParam0;
}

BOOL func_374(Hash hParam0) // Position - 0x1D47F
{
	switch (hParam0)
	{
		case joaat("freight"):
...
Hash _STOPWATCH_IS_INITIALIZED_0(var uParam0) // Position - 0x1D49F
{
	return uParam0->f_1;
}

Vector3 func_376(var uParam0, int iParam1) // Position - 0x1D4AB
{
...
Vector3 func_377(var uParam0) // Position - 0x1D4D5
{
	return uParam0->f_6;
}

void func_378(int* piParam0) // Position - 0x1D4E3
{
	func_42(piParam0, 0f);
	return;
}

int func_379(int iParam0) // Position - 0x1D4F2
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 20) & 63;
}

int func_380(int iParam0) // Position - 0x1D505
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 14) & 63;
}

int func_381(int iParam0) // Position - 0x1D518
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 9) & 31;
}

void func_382() // Position - 0x1D52B
{
	int i;
...
void func_383() // Position - 0x1D554
{
	var unk;
...
void func_384(Any* panParam0) // Position - 0x1D5F6
{
	int i;
...
BOOL func_385(var uParam0) // Position - 0x1D631
{
	return uParam0->f_83;
}

BOOL func_386(var uParam0, int iParam1, var uParam2, var uParam3, var uParam4, int* piParam5, int* piParam6, int* piParam7, int* piParam8, int iParam9, var uParam10, var uParam11, BOOL bParam12) // Position - 0x1D63D
{
...
void func_387() // Position - 0x1D7FE
{
	var unk;
	int num;

	num = Global_114370.f_18971;
	func_388(unk, 0, 0, 0, 0, num);
	return;
}

void func_388(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10) // Position - 0x1D81D
{
	float num;
	int value;
	int alpha;
	...
	if (Global_80023 != 6)
	{
		...
		else
		{
			...
			if (value < 9000 && !CAM::IS_SCREEN_FADED_OUT())
			{
				...
				text = { func_391(Global_80024, Global_80026, iParam10) };
				y == -0.014f;
...
void func_389() // Position - 0x1DB02
{
	Global_80023 != 6;
...
float func_390(const char* sParam0) // Position - 0x1DB3A
{
	HUD::BEGIN_TEXT_COMMAND_GET_SCREEN_WIDTH_OF_DISPLAY_TEXT(sParam0);
	return HUD::END_TEXT_COMMAND_GET_SCREEN_WIDTH_OF_DISPLAY_TEXT(true);
}

struct<2> func_391(int iParam0, int iParam1, int iParam2) // Position - 0x1DB4D
{
	var unk;
	int num;
...
char* func_392(int iParam0) // Position - 0x1DC23
{
	switch (iParam0)
	{
		case 0:
...
struct<2> func_393(int iParam0) // Position - 0x1DD76
{
	var unk;
	var unk3;
...
struct<2> func_394(int iParam0) // Position - 0x1DDA9
{
	var unk;
	var unk3;
...
struct<2> func_395(int iParam0) // Position - 0x1DDDC
{
	var unk;
	var unk3;
...
struct<2> func_396(int iParam0) // Position - 0x1DE0F
{
	var unk;
	var unk3;
...
struct<2> func_397(int iParam0) // Position - 0x1DE42
{
	var unk;
	var unk3;
...
struct<2> func_398(int iParam0) // Position - 0x1DE7F
{
	var unk;
	var unk3;
...
struct<2> func_399(int iParam0) // Position - 0x1DEB2
{
	var unk;
	var unk3;
...
struct<2> func_400(int iParam0) // Position - 0x1DEE9
{
	var unk;
...
struct<2> func_401(int iParam0) // Position - 0x1E335
{
	var unk;
...
BOOL func_402(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) // Position - 0x1E39E
{
	if (!func_404(0) || Global_80039 || Global_80027 == 1 || !CAM::IS_SCREEN_FADED_IN())
		return false;
...
BOOL func_403(BOOL bParam0) // Position - 0x1E4B6
{
	if (bParam0)
...
BOOL func_404(int iParam0) // Position - 0x1E4DF
{
	if (Global_44392 == 15)
		return false;
...
BOOL _CAN_ENTER_FREEROAM_STATE(int iParam0) // Position - 0x1E501
{
	return func_406(iParam0, Global_44392);
}

BOOL func_406(int iParam0, int iParam1) // Position - 0x1E512
{
	if (iParam1 == 15)
		return 1;
...
float func_407(var uParam0) // Position - 0x1E6F3
{
	return uParam0->f_80;
}

int _CONVERSATION_ADD_LINE(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x1E6FF
{
...
int func_409(char* sParam0, int iParam1, BOOL bParam2) // Position - 0x1E74D
{
	Global_22603 = 0;
...
void func_410() // Position - 0x1EA1B
{
	if (!func_411())
		return;
...
BOOL func_411() // Position - 0x1EA52
{
...
BOOL func_412(Player plParam0) // Position - 0x1EAB5
{
	return func_413(plParam0, 20);
}

BOOL func_413(Player plParam0, int iParam1) // Position - 0x1EAC5
{
	return IS_BIT_SET(Global_1888882[plParam0 /*611*/].f_10.f_4, iParam1);
}

Player _INVALID_PLAYER_INDEX() // Position - 0x1EADD
{
	return -1;
}

void func_415() // Position - 0x1EAE6
{
	int i;
...
void func_416() // Position - 0x1EB17
{
...
BOOL func_417() // Position - 0x1EBAC
{
	int num;
	int weaponHash;
...
void _UPDATE_CURRENT_PLAYER_CHARACTER() // Position - 0x1EC45
{
	if (func_259(14))
	{
		if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), false))
...
void func_419() // Position - 0x1ECE7
{
	int i;
...
BOOL func_420(int iParam0, int iParam1) // Position - 0x1ED3E
{
	switch (iParam0)
	{
		case 5:
...
void func_421() // Position - 0x1ED76
{
...
void func_422(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0x1EDCD
{
...
char* func_423(var uParam0) // Position - 0x1EE23
{
	return uParam0->f_4;
}

void func_424(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, Vehicle veParam5, var uParam6, var uParam7) // Position - 0x1EE2F
{
	Cam cam;
	var unk;
	Vector3 vector;
...
void func_425(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0x1EF3A
{
	if (bParam0)
	{
...
BOOL func_426() // Position - 0x1F089
{
	return IS_BIT_SET(Global_1845274[PLAYER::PLAYER_ID() /*877*/].f_36.f_18, 14);
}

BOOL func_427(Player plParam0, int iParam1) // Position - 0x1F0A3
{
	BOOL flag;
...
int func_428(int iParam0, BOOL bParam1) // Position - 0x1F0FC
{
	int num;
	int num2;
...
BOOL func_429(Player plParam0) // Position - 0x1F13D
{
	Player player;
...
BOOL func_430(Player plParam0) // Position - 0x1F15F
{
...
BOOL func_431() // Position - 0x1F19E
{
	return IS_BIT_SET(Global_2621446, 3);
}

int func_432(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x1F1AC
{
	int num;
...
void func_433(int iParam0) // Position - 0x1F1DF
{
	if (iParam0 == 1)
...
float func_434(int iParam0, int iParam1) // Position - 0x1F202
{
	switch (iParam0)
	{
		case 3:
...
int func_435(int iParam0) // Position - 0x1F29C
{
	switch (iParam0)
	{
		case 5:
...
eCharacter _GET_CURRENT_PLAYER_CHARACTER() // Position - 0x1F2D0
{
	func_437();
	return Global_114370.f_2367.f_539.f_4321;
}

void func_437() // Position - 0x1F2E9
{
	eCharacter character;
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (_GET_CHARACTER_MODEL(Global_114370.f_2367.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_39(character) && !func_259(14) || Global_113318)
			{
				if (Global_114370.f_2367.f_539.f_4321 != character && func_39(Global_114370.f_2367.f_539.f_4321))
...
float func_438(var uParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5) // Position - 0x1F3E6
{
	return MISC::GET_HEADING_FROM_VECTOR_2D(fParam3 - uParam0, fParam3.f_1 - uParam0.f_1);
}

BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0x1F400
{
...
Vector3 func_440(int iParam0) // Position - 0x1F42A
{
	switch (iParam0)
	{
		case 5:
...
Cam func_441(var uParam0, int iParam1) // Position - 0x1F484
{
	if (iParam1 >= 2)
		return 0;
...
void func_442(eSetPlayerControlFlags espcfParam0, BOOL bParam1, BOOL bParam2) // Position - 0x1F49C
{
...
void func_443(var uParam0, var uParam1, var uParam2, Vehicle* pveParam3, Vehicle* pveParam4, var uParam5, Vehicle* pveParam6, Vehicle* pveParam7, var uParam8, Ped* ppedParam9, Hash hParam10, Hash hParam11, int* piParam12, int iParam13, var uParam14) // Position - 0x1F4F5
{
	Hash modelHash;
	Vehicle playersLastVehicle;
	float entityCoords;
...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, Ped pedParam2, char* sParam3, int iParam4, int iParam5) // Position - 0x1FFAB
{
...
void func_445(Ped pedParam0, int iParam1) // Position - 0x20047
{
	if (ENTITY::IS_ENTITY_DEAD(pedParam0, false))
		return;
...
BOOL func_446(Hash hParam0) // Position - 0x2011B
{
	switch (hParam0)
	{
		case joaat("seashark"):
...
BOOL func_447(Hash hParam0) // Position - 0x20165
{
	switch (hParam0)
	{
		case joaat("hauler"):
...
float func_448(var uParam0) // Position - 0x201A3
{
	return uParam0->f_77;
}

void func_449(var uParam0, Vehicle* pveParam1) // Position - 0x201AF
{
...
float func_450(var uParam0) // Position - 0x20218
{
	return uParam0->f_79;
}

Vector3 func_451(var uParam0) // Position - 0x20224
{
	return uParam0->f_9;
}

Hash func_452(var uParam0) // Position - 0x20232
{
	return uParam0->f_3;
}

void func_453(var uParam0, var uParam1, int iParam2) // Position - 0x2023E
{
	Hash modelHash;
	Ped pedInVehicleSeat;
	Vehicle vehicle;
...
float func_454(var uParam0) // Position - 0x203AB
{
	return uParam0->f_78;
}

Vector3 func_455(var uParam0) // Position - 0x203B7
{
	return uParam0->f_70;
}

Hash func_456(int iParam0) // Position - 0x203C5
{
	switch (iParam0)
	{
		case 0:
...
int func_457(Ped pedParam0, Vehicle veParam1) // Position - 0x20445
{
...
void func_458(var uParam0, Ped pedParam1, char* sParam2) // Position - 0x204B7
{
	int num;
...
char* func_460() // Position - 0x20514
{
	eCharacter character;
...
void func_461(var uParam0, Ped pedParam1, char* sParam2) // Position - 0x20557
{
	int num;
...
char* func_462(int iParam0) // Position - 0x2058A
{
	return "EXT1HELIPILOT";
}

void func_463(Ped pedParam0, int iParam1) // Position - 0x20596
{
	if (ENTITY::IS_ENTITY_DEAD(pedParam0, false))
		return;
...
Vector3 func_464(var uParam0) // Position - 0x20640
{
	return uParam0->f_67;
}

Vector3 func_465(var uParam0) // Position - 0x2064E
{
	return uParam0->f_64;
}

void func_466(int* piParam0) // Position - 0x2065C
{
	piParam0->f_1 = 0f;
	piParam0->f_2 = 0f;
	*piParam0 = 0;
...
BOOL func_467(var uParam0, int* piParam1, var uParam2, int iParam3, int iParam4, BOOL bParam5) // Position - 0x20672
{
	var animDict;
...
BOOL func_468(var uParam0) // Position - 0x207A9
{
	int i;
...
float func_469(int* piParam0) // Position - 0x207F0
{
	if (func_470(piParam0))
		if (func_361(piParam0))
			return piParam0->f_2;
...
BOOL func_470(int* piParam0) // Position - 0x2082C
{
	return IS_BIT_SET(*piParam0, 1);
}

Vector3 func_471(float fParam0, var uParam1, var uParam2, float fParam3) // Position - 0x20839
{
	float num;
	float num2;
	float num3;
...
float func_472(var uParam0) // Position - 0x2087D
{
	return uParam0->f_76;
}

BOOL func_473(Hash hParam0) // Position - 0x20889
{
	switch (hParam0)
	{
...
Hash func_474(int iParam0) // Position - 0x208D3
{
	switch (iParam0)
	{
		case 0:
...
void func_475(var uParam0, int iParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) // Position - 0x20929
{
	int num;
	Hash hash;
...
void func_476(var uParam0) // Position - 0x20BC5
{
	int i;
...
int func_477(int iParam0) // Position - 0x20BF5
{
	switch (iParam0)
	{
		case 0:
...
int func_478(var uParam0, Hash hParam1) // Position - 0x20C2F
{
	int i;
	int num;
...
int func_479(var uParam0) // Position - 0x20C8C
{
	int i;
...
void func_480(int iParam0, BOOL bParam1) // Position - 0x20CB8
{
...
Vector3 func_481(int iParam0) // Position - 0x20CDF
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_482(int iParam0) // Position - 0x20E29
{
	if (CAM::IS_SCREEN_FADED_OUT())
	{
...
Vector3 func_483(float fParam0, float fParam1, float fParam2) // Position - 0x20E99
{
	float num;
	float num2;
...
Vector3 func_484(int iParam0) // Position - 0x20ED8
{
	switch (iParam0)
	{
		case 0:
...
void func_485(var uParam0, var uParam1, int iParam2, BOOL bParam3) // Position - 0x21002
{
	Vector3 vector;
	Vector3 vector2;
	float fieldOfView;
...
float func_486(var uParam0) // Position - 0x21188
{
	return uParam0->f_82;
}

Vector3 func_487(var uParam0) // Position - 0x21194
{
	return uParam0->f_58;
}

Vector3 func_488(var uParam0) // Position - 0x211A2
{
	return uParam0->f_55;
}

int func_489(int iParam0) // Position - 0x211B0
{
	switch (iParam0)
	{
		case 5:
...
void func_490(var uParam0, int iParam1, Cam caParam2, BOOL bParam3) // Position - 0x211DD
{
	if (iParam1 >= 2)
		return;
...
float func_491(var uParam0) // Position - 0x2120A
{
	return uParam0->f_81;
}

Vector3 func_492(var uParam0) // Position - 0x21216
{
	return uParam0->f_52;
}

Vector3 func_493(var uParam0) // Position - 0x21224
{
	return uParam0->f_49;
}

void func_494(int* piParam0) // Position - 0x21232
{
	if (!func_470(piParam0))
		func_378(piParam0);
...
void func_495(float fParam0, float fParam1, float fParam2, float fParam3, BOOL bParam4) // Position - 0x2124A
{
	int i;

	for (i = 0; i < 68; i = i + 1)
	{
		if (func_314(&Global_78558.f_555[0 /*21*/], i))
			if (MISC::GET_DISTANCE_BETWEEN_COORDS(fParam0, Global_78558.f_555[0 /*21*/], bParam4) <= fParam3)
				func_496(i);
	}
...
void func_496(int iParam0) // Position - 0x2129A
{
	BOOL flag;
	...
	if (func_314(&Global_78558.f_555[0 /*21*/], iParam0))
	{
		...
		if (IS_BIT_SET(Global_78558.f_555[0 /*21*/].f_9, 13))
		{
			if (iParam0 == 24 && func_320(iParam0, 0) && Global_79467.f_66 == 0 && Global_114370.f_32754.f_1958[Global_78558.f_555[0 /*21*/].f_14] != 0 && Global_114370.f_32754.f_1958[Global_78558.f_555[0 /*21*/].f_14] > 3 && !func_497(0, Global_78558.f_555[0 /*21*/].f_12) || !func_497(1, Global_78558.f_555[0 /*21*/].f_12))
			{
				func_321(&Global_114370.f_32754.f_69[Global_78558.f_555[0 /*21*/].f_14 /*78*/], &Global_79467);
...
BOOL func_497(int iParam0, int iParam1) // Position - 0x21409
{
	int num;
	...
	if (iParam0 < 0 || iParam0 >= func_498(&Global_114370.f_32754.f_5038[num /*157*/]))
		return false;

	return func_298(Global_114370.f_32754.f_5038[num /*157*/][iParam0 /*78*/].f_66, false, -1);
}

int func_498(var uParam0) // Position - 0x2147C
{
	return *uParam0;
}

void func_499(char* sParam0, int iParam1) // Position - 0x21487
{
	int i;
	int j;
	...
	for (i = 0; i < Global_114370.f_20414.f_145; i = i + 1)
	{
		if (MISC::ARE_STRINGS_EQUAL(sParam0, &Global_114370.f_20414[i /*16*/]))
		{
			...
			func_501(Global_114370.f_20414.f_145 - 1);
...
void func_501(int iParam0) // Position - 0x2164B
{
...
void func_502(int iParam0, int iParam1) // Position - 0x216E5
{
...
void func_503(BOOL bParam0) // Position - 0x217F5
{
	if (bParam0)
	{
...
void func_504() // Position - 0x21837
{
	func_505(&uLocal_143, 0);
	return;
}

void func_505(var uParam0, int iParam1) // Position - 0x21846
{
	if (uParam0->f_4 != 0)
		func_153(&(uParam0->f_4), &(uParam0->f_5), &(uParam0->f_44));
...
void func_506() // Position - 0x218F1
{
	int i;
	int j;
	var unk;
...
void func_507(int iParam0) // Position - 0x21A5C
{
	int i;
...
void func_508(var uParam0) // Position - 0x21AB2
{
	int i;
	var unk;
...
void func_509(var uParam0) // Position - 0x21B3A
{
	int i;
	var unk;
...
void func_510() // Position - 0x21C04
{
	Global_24009.f_5 = 1;
	return;
}

void func_511(var uParam0, int iParam1, int iParam2, BOOL bParam3) // Position - 0x21C12
{
	int pedParachuteState;
...
void func_512(char* sParam0, int* piParam1, int iParam2) // Position - 0x21D90
{
...
BOOL func_513(char* sParam0, char* sParam1, int* piParam2, int iParam3) // Position - 0x21DB0
{
...
char* func_514(int iParam0, int iParam1) // Position - 0x21DFE
{
	char* str;
...
void func_515(var uParam0, int iParam1) // Position - 0x21E8E
{
	if (iParam1 < 11)
...
int func_516(char* sParam0, int* piParam1, int iParam2) // Position - 0x21F94
{
	if (!IS_BIT_SET(*piParam1, iParam2))
	{
...
BOOL func_517(char* sParam0, int* piParam1, int iParam2) // Position - 0x21FD2
{
	if (!IS_BIT_SET(*piParam1, iParam2))
	{
		if (AUDIO::PREPARE_MUSIC_EVENT(sParam0))
...
char* func_518(int iParam0) // Position - 0x22001
{
	switch (iParam0)
	{
		case 15:
...
void func_519(var uParam0) // Position - 0x2205F
{
	float num;
	var unk3;
	var unk4;
...
BOOL func_520() // Position - 0x22174
{
...
void func_521(var uParam0, int iParam1, BOOL bParam2) // Position - 0x221A6
{
	if (bParam2)
...
void func_522(var uParam0) // Position - 0x221CA
{
...
void func_523(var uParam0, float fParam1, var uParam2) // Position - 0x221DF
{
...
void func_524(var uParam0, var uParam1) // Position - 0x221F7
{
	uParam0->f_1 = uParam1;
	return;
}

void func_525(var uParam0, float fParam1) // Position - 0x22205
{
	*uParam0 = fParam1;
	return;
}

void func_526(var uParam0, var uParam1, var uParam2, var uParam3, BOOL bParam4, BOOL bParam5) // Position - 0x22212
{
	float controlNormal;
...
void func_527() // Position - 0x222FF
{
...
void func_529(var uParam0, int iParam1) // Position - 0x223F2
{
	if (iParam1 <= 0)
		return;
...
void func_530(var uParam0, int iParam1) // Position - 0x22478
{
...
void func_531(var uParam0, int iParam1) // Position - 0x224AB
{
	int num;
	int num2;
...
int func_532(int iParam0, int iParam1) // Position - 0x224FC
{
	if (iParam1 < 0)
		iParam1 = 0;
...
int func_533(int iParam0) // Position - 0x2259E
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * IS_BIT_SET(iParam0, 31) ? -1 : 1) + 2011;
}

var func_534(BOOL bParam0, var uParam1, var uParam2) // Position - 0x225C0
{
	if (bParam0)
		return uParam1;
...
int func_535(int iParam0) // Position - 0x225D7
{
	return iParam0 & 15;
}

void func_536(var uParam0, int iParam1) // Position - 0x225E4
{
...
void func_537(var uParam0, int iParam1) // Position - 0x2261E
{
...
void func_538(var uParam0, int iParam1) // Position - 0x22659
{
	if (iParam1 < 0 || iParam1 >= 60)
		return;
...
Hash func_539(var uParam0) // Position - 0x22695
{
	return uParam0->f_2;
}

void func_540(var uParam0, int iParam1) // Position - 0x226A1
{
	eCharacter character;
...
void func_541(var uParam0, float fParam1, float fParam2, float fParam3) // Position - 0x2387B
{
	uParam0->f_67 = { fParam1 };
	return;
}

void func_542(var uParam0, float fParam1, float fParam2, float fParam3) // Position - 0x2388D
{
	uParam0->f_64 = { fParam1 };
	return;
}

void func_543(var uParam0, int iParam1) // Position - 0x2389F
{
	uParam0->f_84 = iParam1;
	return;
}

void func_544(var uParam0, int iParam1) // Position - 0x238AD
{
	uParam0->f_83 = iParam1;
	return;
}

void func_545(var uParam0, float fParam1) // Position - 0x238BB
{
	uParam0->f_82 = fParam1;
	return;
}

void func_546(var uParam0, float fParam1, float fParam2, float fParam3) // Position - 0x238C9
{
	uParam0->f_58 = { fParam1 };
	return;
}

void func_547(var uParam0, float fParam1, float fParam2, float fParam3) // Position - 0x238DB
{
	uParam0->f_55 = { fParam1 };
	return;
}

void func_548(var uParam0, float fParam1) // Position - 0x238ED
{
	uParam0->f_81 = fParam1;
	return;
}

void func_549(var uParam0, var uParam1, var uParam2, var uParam3) // Position - 0x238FB
{
	uParam0->f_52 = { uParam1 };
	return;
}

void func_550(var uParam0, var uParam1, var uParam2, var uParam3) // Position - 0x2390D
{
	uParam0->f_49 = { uParam1 };
	return;
}

Vector3 func_551(int iParam0) // Position - 0x2391F
{
	switch (iParam0)
	{
		case 0:
...
void func_552(var uParam0, char* sParam1) // Position - 0x23A69
{
	uParam0->f_4 = sParam1;
	return;
}

void func_553(var uParam0, float fParam1, float fParam2, float fParam3) // Position - 0x23A77
{
	uParam0->f_6 = { fParam1 };
	return;
}

void func_554(var uParam0, float fParam1) // Position - 0x23A89
{
	uParam0->f_77 = fParam1;
	return;
}

void func_555(var uParam0, int iParam1, float fParam2, float fParam3, float fParam4) // Position - 0x23A97
{
	if (iParam1 < 0 || iParam1 >= 12)
		return;
...
void func_556(var uParam0, float fParam1) // Position - 0x23AC2
{
	uParam0->f_79 = fParam1;
	return;
}

void func_557(var uParam0, float fParam1, float fParam2, float fParam3) // Position - 0x23AD0
{
	uParam0->f_9 = { fParam1 };
	return;
}

void func_558(var uParam0, int iParam1) // Position - 0x23AE2
{
	uParam0->f_3 = iParam1;
	return;
}

void func_559(var uParam0, float fParam1) // Position - 0x23AF0
{
	uParam0->f_80 = fParam1;
	return;
}

void func_560(var uParam0, float fParam1) // Position - 0x23AFE
{
	uParam0->f_78 = fParam1;
	return;
}

void func_561(var uParam0, float fParam1, float fParam2, float fParam3) // Position - 0x23B0C
{
	uParam0->f_70 = { fParam1 };
	return;
}

void func_562(var uParam0, int iParam1) // Position - 0x23B1E
{
	uParam0->f_2 = iParam1;
	return;
}

void func_563(var uParam0, float fParam1) // Position - 0x23B2C
{
	uParam0->f_76 = fParam1;
	return;
}

void func_564(var uParam0, int iParam1) // Position - 0x23B3A
{
	uParam0->f_1 = iParam1;
	return;
}

void func_565(var uParam0, int iParam1) // Position - 0x23B48
{
	*uParam0 = iParam1;
	return;
}

void func_566(int iParam0, BOOL bParam1) // Position - 0x23B55
{
	if (bParam1)
...
void func_567(int iParam0) // Position - 0x23B77
{
	func_389();
...
void func_568(var uParam0, var uParam1, Vehicle* pveParam2, Vehicle* pveParam3, Vehicle* pveParam4, var uParam5, var uParam6, var uParam7, Ped* ppedParam8, var uParam9, var uParam10, int iParam11, var uParam12, Blip blParam13, Blip blParam14, int iParam15, var uParam16, BOOL bParam17) // Position - 0x23B93
{
	Ped pedInVehicleSeat;
	int i;
	int j;
	...
	*uParam12 = 1;
	...
	func_569();
	SCRIPT::SET_NO_LOADING_SCREEN(false);
	Global_114370.f_18971 = -1;
	SCRIPT::TERMINATE_THIS_THREAD();
	return;
}

void func_569() // Position - 0x23F5B
{
	Global_24009.f_5 = 0;
	return;
}

void func_570(var uParam0) // Position - 0x23F69
{
	func_571(uParam0, 0);
	func_571(uParam0, 1);
	func_571(uParam0, 2);
...
void func_571(var uParam0, int iParam1) // Position - 0x23F86
{
...
void func_572(int iParam0, BOOL bParam1) // Position - 0x23FA3
{
...
void func_573(var uParam0) // Position - 0x23FD7
{
	GRAPHICS::SET_SCALEFORM_MOVIE_AS_NO_LONGER_NEEDED(&uParam0);
	return;
}

void func_574(var uParam0) // Position - 0x23FE5
{
	func_573(*uParam0);
	return;
}
