...
BOOL func_68(var uParam0) // Position - 0x18CA
{
	if (uParam0->f_20 == 0)
		return true;
...
Hash func_69() // Position - 0x194B
{
	return ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID());
}

var func_70(BOOL bParam0, var uParam1, var uParam2) // Position - 0x195B
{
	if (bParam0)
		return uParam1;
...
void func_71(var uParam0) // Position - 0x1972
{
	func_59();
...
void func_72(var uParam0) // Position - 0x198C
{
	func_168(uParam0);
...
void func_73(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x1A33
{
	func_75();
	func_49(true);
	HUD::CLEAR_HELP(true);
...
void func_76(var uParam0) // Position - 0x1B28
{
	var unk;
...
void func_77(Vehicle veParam0, var uParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x1C23
{
	Hash entityModel;
	float num;
...
BOOL IS_GAMER_HANDLE_VALID(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12) // Position - 0x219A
{
	return NETWORK::NETWORK_IS_HANDLE_VALID(&uParam0, 13);
}

BOOL func_79(Vehicle veParam0) // Position - 0x21AA
{
	Hash entityModel;
...
BOOL func_80(Hash hParam0) // Position - 0x21F0
{
	switch (hParam0)
	{
		case joaat("brioso"):
...
BOOL func_81(Hash hParam0) // Position - 0x22A6
{
	switch (hParam0)
	{
		case -1321131184:
...
BOOL func_82(Hash hParam0) // Position - 0x22D4
{
	switch (hParam0)
	{
		case joaat("coureur"):
...
BOOL func_83(Hash hParam0) // Position - 0x2309
{
	switch (hParam0)
	{
		case joaat("pounder2"):
...
void func_84(Vehicle veParam0) // Position - 0x2410
{
	Hash entityModel;
...
void func_85(var uParam0, var uParam1, var uParam2) // Position - 0x249B
{
	Hash eventData;
...
int _GET_LOBBY_SCRIPT_EVENT_BITS(BOOL includeLocalPlayer, BOOL includeSpectators) // Position - 0x24DC
{
	int address;
	int i;
	Player player;
...
BOOL func_87(int iParam0) // Position - 0x2541
{
	int i;
...
BOOL func_88(int iParam0) // Position - 0x257C
{
	return func_89(iParam0, 6, true);
}

BOOL func_89(int iParam0, int iParam1, BOOL bParam2) // Position - 0x258C
{
	if (iParam0 == -1)
		return false;
...
int func_90(int iParam0, int iParam1) // Position - 0x25EC
{
	Hash statHash;
	int outValue;
...
Hash func_91(int iParam0, int iParam1) // Position - 0x261B
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(0, iParam0, func_92(iParam1));
}

int func_92(int iParam0) // Position - 0x2630
{
	int num;
	int num2;
...
int func_93(int iParam0) // Position - 0x2664
{
	switch (iParam0)
	{
		case 0:
...
int func_94() // Position - 0x2A1B
{
	return Global_33298;
}

int func_95(int iParam0) // Position - 0x2A26
{
	switch (iParam0)
	{
		case -1:
...
BOOL func_96() // Position - 0x2D69
{
	return Global_101969.f_400 > 0;
}

int func_97(Vehicle veParam0, Any* panParam1) // Position - 0x2D7A
{
...
BOOL func_98(Vehicle veParam0) // Position - 0x2DF7
{
	int vehicleCrewEmblemRequestState;
	int networkTime;
	int num;
...
void func_99(Vehicle veParam0) // Position - 0x2E84
{
	int _int;
...
BOOL func_100(var uParam0, Player plParam1) // Position - 0x2EE0
{
	func_104();
...
BOOL func_101(var uParam0, Player plParam1, int iParam2, Vector3 vParam3, var uParam4, var uParam5, Vector3 vParam6, var uParam7, var uParam8, Vector3 vParam9, var uParam10, var uParam11, float fParam12, int iParam13, int iParam14) // Position - 0x318B
{
...
int func_102(Vehicle veParam0, int iParam1, var uParam2, var uParam3, var uParam4, float fParam5) // Position - 0x31B4
{
	if (!ENTITY::DOES_ENTITY_EXIST(veParam0) || !VEHICLE::IS_VEHICLE_DRIVEABLE(veParam0, false))
		return 0;
...
BOOL func_103(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, BOOL bParam6) // Position - 0x9114
{
	if (bParam6)
...
BOOL func_105(Vehicle veParam0) // Position - 0x91D4
{
	if (ENTITY::DOES_ENTITY_EXIST(veParam0) && VEHICLE::IS_VEHICLE_DRIVEABLE(veParam0, false))
...
BOOL func_106(Vehicle veParam0) // Position - 0x920C
{
	int _int;
...
BOOL func_107(Vehicle veParam0, Any* panParam1) // Position - 0x9254
{
	Player playerFromGamerHandle;
	BOOL flag;
	int num;
...
BOOL func_108(Vehicle veParam0) // Position - 0x93B1
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		return true;
...
int func_109(Vehicle veParam0) // Position - 0x9708
{
...
int func_110(Player plParam0) // Position - 0x9734
{
...
int func_111(Player plParam0) // Position - 0x9751
{
...
BOOL func_112(Player plParam0, BOOL bParam1) // Position - 0x9774
{
	if (func_11(plParam0))
...
int func_113(Player plParam0) // Position - 0x97B8
{
	if (func_11(plParam0))
		if (func_112(plParam0, false))
...
BOOL func_115(BOOL bParam0) // Position - 0x97F1
{
	return func_116(PLAYER::PLAYER_ID(), bParam0);
}

BOOL func_116(Player plParam0, BOOL bParam1) // Position - 0x9803
{
	return func_117(plParam0, bParam1, 1);
}

BOOL func_117(Player plParam0, BOOL bParam1, int iParam2) // Position - 0x9814
{
	Player player;
...
BOOL func_118(Player plParam0, int iParam1) // Position - 0x9870
{
	if (func_11(plParam0))
...
BOOL func_119(int iParam0, BOOL bParam1) // Position - 0x98BF
{
	int num;
	int num2;
...
int func_120(int iParam0) // Position - 0x991D
{
	return iParam0 % 32;
}

int func_121(int iParam0) // Position - 0x992A
{
	int num;
...
int func_122(int iParam0) // Position - 0x9941
{
	int num;
	int num2;
...
int func_123(int iParam0) // Position - 0x996E
{
	return iParam0 / 32;
}

BOOL func_124(Player plParam0) // Position - 0x997B
{
...
BOOL func_125(Player plParam0) // Position - 0x99B0
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
...
int func_126(int iParam0) // Position - 0x99F7
{
	switch (iParam0)
	{
		case 0:
...
void func_127(Vehicle veParam0, int iParam1) // Position - 0x9F46
{
	int num;
	int num2;
...
BOOL func_128(int iParam0, var uParam1) // Position - 0x9F67
{
	*uParam1 = -1;
...
int func_129(int iParam0) // Position - 0xA229
{
	switch (iParam0)
	{
		case 0:
...
int func_130(int iParam0, int iParam1, int iParam2) // Position - 0xA2C7
{
...
struct<13> GET_LOCAL_GAMER_HANDLE() // Position - 0xA4F1
{
	var gamerHandle;
...
BOOL func_133(Vehicle veParam0) // Position - 0xA506
{
	switch (ENTITY::GET_ENTITY_MODEL(veParam0))
	{
		case joaat("deathbike2"):
...
BOOL func_134(int iParam0, var uParam1) // Position - 0xA527
{
	*uParam1 = -1f;
...
void func_135(Vehicle veParam0) // Position - 0xA828
{
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
...
void func_136(Vehicle veParam0) // Position - 0xA85A
{
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		if (DECORATOR::DECOR_IS_REGISTERED_AS_TYPE("MLJ", BOOL))
			if (!DECORATOR::DECOR_EXIST_ON(veParam0, "MLJ"))
...
BOOL func_137(Hash hParam0) // Position - 0xA88E
{
	switch (hParam0)
	{
		case 1484920335:
...
BOOL func_138(Hash hParam0) // Position - 0xA8B1
{
...
BOOL func_139(Hash hParam0) // Position - 0xB358
{
	switch (hParam0)
	{
		case joaat("deity"):
...
void func_140(Vehicle veParam0, var uParam1, BOOL bParam2, BOOL bParam3) // Position - 0xB3E7
{
	int num;
	int num2;
	int i;
...
BOOL func_141(Vehicle veParam0, float fParam1) // Position - 0xBB06
{
	float entityCoords;
	var groundZ;
...
Hash func_142(BOOL bParam0) // Position - 0xBB77
{
	if (bParam0)
...
BOOL func_144(int iParam0) // Position - 0xBC20
{
	int num;
...
BOOL func_145(int iParam0) // Position - 0xBC44
{
	int num;
...
BOOL func_146(int iParam0, int iParam1) // Position - 0xBC62
{
	return IS_BIT_SET(Global_1888882[iParam0 /*611*/].f_10.f_4, iParam1);
}

BOOL func_147(int iParam0) // Position - 0xBC7A
{
	return func_148(&(Global_2672967.f_194), iParam0);
}

BOOL func_148(var uParam0, int iParam1) // Position - 0xBC8E
{
	int num;
	int num2;
	int num3;
...
int func_149(var uParam0, var uParam1, var uParam2) // Position - 0xBCB1
{
	int i;
	int modType;
...
BOOL func_150(Vehicle veParam0) // Position - 0xBEAF
{
	int i;
	int modType;
	Hash hashKey;
...
void func_151(var uParam0) // Position - 0xBF89
{
...
int func_152(Vehicle veParam0, int iParam1) // Position - 0xBFF4
{
	int value;
	int value2;
	float num;
...
int func_153(Vehicle veParam0, int iParam1) // Position - 0xC0DE
{
	int i;
...
BOOL func_154(Hash hParam0) // Position - 0xC140
{
...
BOOL func_155(Hash hParam0, int iParam1) // Position - 0xC16B
{
	switch (hParam0)
	{
		case joaat("faction2"):
...
BOOL func_156(Vehicle veParam0, int iParam1, int iParam2) // Position - 0xC551
{
...
BOOL func_157() // Position - 0xC575
{
	return true;
}

void func_158(Vehicle veParam0, int iParam1) // Position - 0xC582
{
	int vehicleMod;
...
BOOL func_159(int iParam0) // Position - 0xC5FA
{
	switch (iParam0)
	{
		case joaat("granger"):
...
BOOL func_160() // Position - 0xC61A
{
	return DLC::IS_DLC_PRESENT(joaat("mpindependence"));
}

BOOL func_161(Vehicle veParam0) // Position - 0xC62B
{
	int _int;
...
int func_162(var uParam0) // Position - 0xC670
{
...
BOOL func_163(int iParam0) // Position - 0xC690
{
	switch (iParam0)
	{
		case 161:
...
int func_164(int iParam0) // Position - 0xC6E3
{
	switch (iParam0)
	{
		case 1:
...
BOOL func_165(Vehicle veParam0) // Position - 0xC793
{
...
BOOL _IS_PLAYER_IN_VEHICLE_SEAT(Player plParam0, int iParam1) // Position - 0xC81A
{
...
BOOL _DOES_ENTITY_EXIST_AND_IS_ALIVE(Ped pedParam0) // Position - 0xC867
{
...
void func_168(var uParam0) // Position - 0xC888
{
...
void func_169(var uParam0) // Position - 0xC8D6
{
...
Vector3 func_170(float fParam0, var uParam1, var uParam2) // Position - 0xC990
{
	return -SYSTEM::SIN(fParam0.f_2) * SYSTEM::COS(fParam0), SYSTEM::COS(fParam0.f_2) * SYSTEM::COS(fParam0), SYSTEM::SIN(fParam0);
}

BOOL func_171(var uParam0) // Position - 0xC9BD
{
	Player player;
...
void func_172(Ped pedParam0, var uParam1, BOOL bParam2, int iParam3) // Position - 0xCA95
{
	var unk;
	int characterType;
	BOOL flag;
...
void func_173(Ped pedParam0, int iParam1, int iParam2) // Position - 0xCBFE
{
	switch (iParam1)
	{
		case 1310977332:
...
BOOL func_174(Ped pedParam0, const char* sParam1, int iParam2, int iParam3, Hash hParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7, BOOL bParam8) // Position - 0xDED5
{
	Hash entityModel;
	int num;
...
BOOL func_175(int iParam0, int iParam1) // Position - 0xE6FB
{
	int num;
	int num2;
...
int func_176(int iParam0, int iParam1) // Position - 0xE73A
{
	int num;
	int num2;
...
int func_177() // Position - 0xE780
{
	return Global_33299;
}

int func_178(int iParam0) // Position - 0xE78B
{
	int num;
	int num2;
...
char* func_179(int iParam0) // Position - 0xEB2C
{
	switch (iParam0)
	{
		case 0:
...
int func_180(Hash hParam0, const char* sParam1, int iParam2) // Position - 0xF169
{
	switch (iParam2)
	{
		case joaat("crewLogo"):
...
BOOL func_181(char* sParam0, int iParam1, int iParam2, Ped pedParam3, int iParam4) // Position - 0x1019C
{
	Hash entityModel;
	int num;
...
void func_182(char* sParam0, int iParam1, int iParam2, int iParam3) // Position - 0x13108
{
	int decorationIndex;
	int numTattooShopDlcItems;
	Hash outComponent;
...
BOOL func_183() // Position - 0x1319A
{
...
BOOL func_184() // Position - 0x131CC
{
	return true;
}

int func_185() // Position - 0x131D5
{
	int outValue;
	int outValue2;
	Hash statHash;
...
BOOL _IS_EXCLUSIVE_CONTENT_UNLOCKED() // Position - 0x133C4
{
	int profileSetting;
...
int func_188() // Position - 0x1347C
{
	return 1;
}

int func_189() // Position - 0x13485
{
	return 1;
}

void func_190(char* sParam0, int iParam1, Ped pedParam2, char* sParam3, char* sParam4, char* sParam5, char* sParam6, int iParam7, int iParam8, int iParam9) // Position - 0x1348E
{
	var unk;
...
BOOL func_191(Ped pedParam0, int iParam1) // Position - 0x13743
{
...
Hash func_192(Hash hParam0, int iParam1, int iParam2, int iParam3) // Position - 0x13A03
{
	var outProp;
	int componentId;
	int num;
...
int func_193(Hash hParam0, int iParam1) // Position - 0x13B1D
{
	switch (hParam0)
	{
...
ePedComponentType func_194(int iParam0) // Position - 0x13EC4
{
	switch (iParam0)
	{
		case 0:
...
int func_195(Hash hParam0) // Position - 0x13F74
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
...
int func_196(Ped pedParam0, int iParam1, ePedComponentType epctParam2) // Position - 0x13FD5
{
	int i;
	int j;
...
int func_197(Ped pedParam0, int iParam1) // Position - 0x14077
{
...
int func_198(Ped pedParam0, int iParam1, int iParam2, int iParam3) // Position - 0x140D7
{
	ePedComponentType componentId;
...
int func_199(Ped pedParam0, ePedComponentType epctParam1) // Position - 0x1412E
{
	int pedPropIndex;
...
int func_200(Ped pedParam0, int iParam1, int iParam2, ePedComponentType epctParam3) // Position - 0x14175
{
	Hash entityModel;
...
int func_201(Ped pedParam0, ePedComponentType epctParam1) // Position - 0x14271
{
	Hash entityModel;
...
int func_202(Hash hParam0, Hash hParam1, int iParam2, int iParam3) // Position - 0x143AF
{
	var outfit;
	int i;
	int num;
...
int func_203(Hash hParam0) // Position - 0x1446A
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
...
int func_204(ePedComponentType epctParam0) // Position - 0x144C9
{
	switch (epctParam0)
	{
		case PV_COMP_HEAD:
...
BOOL func_205(Ped pedParam0, int iParam1, int iParam2) // Position - 0x1454F
{
	Hash entityModel;
	int num;
	Hash hash;
...
BOOL func_206(Hash hParam0, int iParam1, int iParam2, var uParam3) // Position - 0x149AA
{
	Hash componentHash;
...
BOOL func_207(Hash hParam0, int iParam1, int iParam2, var uParam3) // Position - 0x14A53
{
	Hash componentHash;
	int shopPedApparelVariantComponentCount;
	int i;
...
BOOL func_208(Hash hParam0, int iParam1, int iParam2, Hash hParam3) // Position - 0x14AFB
{
	switch (hParam0)
	{
		case joaat("MP_F_Freemode_01"):
...
BOOL func_209(Hash hParam0, int iParam1, int iParam2, int iParam3, var uParam4, int iParam5) // Position - 0x14B4E
{
	var unk;
	int i;
...
BOOL func_210(Hash hParam0, int iParam1, int iParam2, Hash hParam3) // Position - 0x15152
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
...
BOOL func_211(Hash hParam0, int iParam1, int iParam2, Hash hParam3) // Position - 0x153CF
{
	if (hParam0 == joaat("Player_Zero"))
	{
		if (iParam1 == 6)
...
BOOL func_212(Hash hParam0, int iParam1, int iParam2, Hash hParam3) // Position - 0x157F4
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
...
BOOL func_213(Hash hParam0, int iParam1, int iParam2) // Position - 0x15AE7
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
...
struct<10> func_214(Hash hParam0, int iParam1) // Position - 0x15B80
{
	int i;
	var unk;
...
void func_215(var uParam0, Hash hParam1, int iParam2, int iParam3) // Position - 0x164AF
{
	int num;
	Hash itemHash;
	Hash outPropVariant;
...
void func_216(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9) // Position - 0x165D9
{
	uParam0->[0] = iParam1;
	uParam0->[1] = iParam2;
	uParam0->[2] = iParam3;
...
struct<17> func_217(Hash hParam0, int iParam1) // Position - 0x16621
{
	int i;
	var unk;
...
void func_218(var uParam0, Hash hParam1, int iParam2, int iParam3) // Position - 0x1846A
{
	int num;
	Hash outfit;
...
int func_219(int iParam0) // Position - 0x18654
{
	switch (iParam0)
	{
		case 0:
...
void func_220(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Position - 0x18704
{
	uParam0->[0] = iParam1;
	uParam0->[2] = iParam2;
	uParam0->[3] = iParam3;
...
struct<14> func_221(Hash hParam0, int iParam1, int iParam2, Hash hParam3) // Position - 0x18775
{
	func_267();
...
void func_222(int iParam0, int iParam1, Hash hParam2) // Position - 0x187B6
{
	switch (iParam0)
	{
		case 2:
...
void func_223(int iParam0) // Position - 0x188C2
{
	BOOL flag;
	int num;
	var unk;
...
void func_224(int iParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, BOOL bParam7, int iParam8, int iParam9, BOOL bParam10) // Position - 0x18A7D
{
	int num;
	int num2;
...
BOOL func_225(int iParam0, int iParam1, var uParam2) // Position - 0x18E1F
{
	*uParam2 = 979;
...
int func_226(int iParam0, int iParam1) // Position - 0x19224
{
	switch (iParam1)
	{
		case 0:
...
int func_227(int iParam0, int iParam1) // Position - 0x1961F
{
	switch (iParam1)
	{
		case 0:
...
BOOL func_228(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x19A1A
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
BOOL func_229(Hash hParam0, int iParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0x1A8BD
{
	int num;
	int num2;
	int num3;
...
BOOL func_230(Hash hParam0, int iParam1, var uParam2, var uParam3, BOOL bParam4, BOOL bParam5) // Position - 0x1A8FB
{
...
BOOL func_231(int iParam0) // Position - 0x1D55D
{
	return Global_44392 == iParam0;
}

int func_232(int iParam0) // Position - 0x1D56B
{
	switch (iParam0)
	{
		case -1:
...
void func_233(int iParam0, Hash hParam1) // Position - 0x1D63F
{
	int num;
...
void func_234(int iParam0, int iParam1, int iParam2, Hash hParam3) // Position - 0x1D65F
{
	int num;
	int num2;
	Hash outfit;
...
void func_235(int iParam0, Hash hParam1) // Position - 0x1D8E6
{
	BOOL flag;
	int num;
	var unk;
...
void func_236(int iParam0, Hash hParam1) // Position - 0x1D9E9
{
	BOOL flag;
	int num;
	var unk;
...
void func_237(int iParam0, Hash hParam1) // Position - 0x1DCC8
{
	BOOL flag;
	int value;
	var unk;
...
void func_238(int iParam0, Hash hParam1) // Position - 0x20A9F
{
	BOOL flag;
	int num;
	var unk;
...
void func_239(int iParam0, Hash hParam1) // Position - 0x20BA4
{
	BOOL flag;
	int value;
	var unk;
...
void func_240(int iParam0, Hash hParam1) // Position - 0x21380
{
	BOOL flag;
	int value;
	var unk;
...
void func_241(int iParam0, Hash hParam1) // Position - 0x21665
{
	BOOL flag;
	int value;
	var unk;
...
void func_242(int iParam0, Hash hParam1) // Position - 0x22C8C
{
	BOOL flag;
	int value;
	var unk;
...
void func_243(int iParam0, Hash hParam1) // Position - 0x242ED
{
	BOOL flag;
	int num;
	var unk;
...
void func_244(int iParam0, Hash hParam1) // Position - 0x24448
{
	BOOL flag;
	int num;
	var unk;
...
void func_245(int iParam0, Hash hParam1) // Position - 0x246C8
{
	BOOL flag;
	int value;
	var unk;
...
BOOL func_246(int iParam0, int iParam1) // Position - 0x25A6A
{
	int num;
	int num2;
...
int func_247(int iParam0, int iParam1) // Position - 0x25A99
{
	int num;
...
int func_248(int iParam0) // Position - 0x25AB1
{
	int num;
	int num2;
...
void func_249(int iParam0, Hash hParam1) // Position - 0x25E2C
{
	BOOL flag;
	int value;
	var unk;
...
void func_250(int iParam0, Hash hParam1) // Position - 0x27591
{
	BOOL flag;
	int value;
	var unk;
...
void func_251(int iParam0, int iParam1, Hash hParam2) // Position - 0x28465
{
	switch (iParam0)
	{
		case 2:
...
void func_252(int iParam0) // Position - 0x28571
{
	BOOL flag;
	int num;
	var unk;
...
void func_253(int iParam0, Hash hParam1) // Position - 0x2873B
{
	int num;
...
void func_254(int iParam0, Hash hParam1) // Position - 0x2875B
{
	BOOL flag;
	int num;
	var unk;
...
void func_255(int iParam0, Hash hParam1) // Position - 0x2885E
{
	BOOL flag;
	int num;
	var unk;
...
void func_256(int iParam0, Hash hParam1) // Position - 0x28B0F
{
	BOOL flag;
	int value;
	var unk;
...
void func_257(int iParam0, Hash hParam1) // Position - 0x2B8CE
{
	BOOL flag;
	int num;
	var unk;
...
void func_258(int iParam0, Hash hParam1) // Position - 0x2B9EF
{
	BOOL flag;
	int value;
	var unk;
...
void func_259(int iParam0, Hash hParam1) // Position - 0x2C2EB
{
	BOOL flag;
	int value;
	var unk;
...
void func_260(int iParam0, Hash hParam1) // Position - 0x2C5A2
{
	BOOL flag;
	int value;
	var unk;
...
void func_261(int iParam0, Hash hParam1) // Position - 0x2DBDF
{
	BOOL flag;
	int value;
	var unk;
...
void func_262(int iParam0, Hash hParam1) // Position - 0x2F212
{
	BOOL flag;
	int num;
	var unk;
...
void func_263(int iParam0, Hash hParam1) // Position - 0x2F369
{
	BOOL flag;
	int num;
	var unk;
...
void func_264(int iParam0, Hash hParam1) // Position - 0x2F685
{
	BOOL flag;
	int value;
	var unk;
...
void func_265(int iParam0, Hash hParam1) // Position - 0x31B78
{
	BOOL flag;
	int value;
	var unk;
...
void func_266(int iParam0, Hash hParam1) // Position - 0x33103
{
	BOOL flag;
	int value;
	var unk;
...
void func_267() // Position - 0x33FBD
{
...
BOOL func_268(Ped pedParam0) // Position - 0x34037
{
	int num;
...
int func_269(int iParam0) // Position - 0x340B3
{
	if (func_270(true))
...
BOOL func_270(BOOL bParam0) // Position - 0x340EA
{
...
BOOL func_271(int iParam0) // Position - 0x3411E
{
	return iParam0 == 87;
}

BOOL func_272() // Position - 0x3412B
{
	return func_273(*Global_4718592.f_138116);
}

int func_273(int iParam0) // Position - 0x34141
{
	int i;
...
BOOL func_274(BOOL bParam0) // Position - 0x3417B
{
	if (bParam0)
...
BOOL func_275() // Position - 0x341B1
{
...
BOOL func_276(Ped pedParam0, BOOL bParam1) // Position - 0x341DF
{
	int pedDrawableVariation;
	int pedTextureVariation;
	int num;
...
int func_277(Hash hParam0, int iParam1, int iParam2, int iParam3) // Position - 0x34A19
{
	Hash componentHash;
...
int func_278(int iParam0, Hash hParam1) // Position - 0x35239
{
...
int func_279(Ped pedParam0) // Position - 0x3525B
{
...
Player func_280() // Position - 0x352BE
{
	Player player;
...
Player _GET_BOSS_OF_LOCAL_PLAYER() // Position - 0x352DC
{
	return Global_1888882[PLAYER::PLAYER_ID() /*611*/].f_10;
}

BOOL func_282(BOOL bParam0) // Position - 0x352F1
{
	return func_283(PLAYER::PLAYER_ID(), bParam0);
}

BOOL func_283(Player plParam0, BOOL bParam1) // Position - 0x35303
{
	if (!func_11(plParam0))
		return false;
...
BOOL func_284(Player plParam0) // Position - 0x3533B
{
	if (func_11(plParam0))
		if (func_11(Global_1888882[plParam0 /*611*/].f_10))
...
BOOL func_286(Player plParam0, BOOL bParam1, BOOL bParam2) // Position - 0x35392
{
...
int func_287(var uParam0) // Position - 0x353E9
{
	return *uParam0;
}

void func_288() // Position - 0x353F4
{
...
void func_289(int iParam0) // Position - 0x3543F
{
	if (func_46())
		return;
...
void func_290(BOOL bParam0) // Position - 0x35472
{
	if (bParam0)
		func_292();
...
void func_291(int iParam0, int iParam1) // Position - 0x354C3
{
...
void func_292() // Position - 0x354F9
{
	Global_2740191.f_4672 = 0;
	return;
}

BOOL func_293() // Position - 0x35509
{
...
BOOL _SHOULD_NETWORK_SCRIPT_TERMINATE() // Position - 0x3551D
{
...
Hash _GET_CURRENT_SESSION_TYPE_SCRIPT_HASH() // Position - 0x355A1
{
	switch (func_94())
	{
		case 0:
...
Hash func_296() // Position - 0x355D4
{
...
BOOL func_297() // Position - 0x355F8
{
	return Global_2684748.f_700;
}

BOOL _DOES_EVENT_OF_TYPE_EXIST(int iParam0) // Position - 0x35607
{
...
BOOL func_299() // Position - 0x3561E
{
	return Global_2696555;
}

BOOL func_300() // Position - 0x3562A
{
	return Global_2684748.f_695;
}

void func_301() // Position - 0x35639
{
	SYSTEM::WAIT(0);
	return;
}

void func_302(var uParam0) // Position - 0x35646
{
	NETWORK::NETWORK_SET_THIS_SCRIPT_IS_NETWORK_SCRIPT(32, false, -1);
	func_305(&uLocal_122, joaat("nimbus"), "Plane_1");
	func_55(&uLocal_122, 1);
	func_303(&uLocal_122, -2392.8381f, -2427.6187f, 43.1663f, -1.9378f, -0.4041f, -53.486f, "HS4_LSA_LAND_NIMB", 1, 1, uParam0->f_4, 0);
	return;
}

void func_303(var uParam0, float fParam1, float fParam2, float fParam3, float fParam4, float fParam5, float fParam6, char* sParam7, int iParam8, int iParam9, var uParam10, int iParam11) // Position - 0x3569A
{
...
void func_304(var uParam0, char* sParam1, int iParam2, int iParam3, var uParam4) // Position - 0x356CA
{
	uParam0->f_1 = sParam1;
	uParam0->f_2 = iParam3;
...
void func_305(var uParam0, int iParam1, char* sParam2) // Position - 0x356F7
{
