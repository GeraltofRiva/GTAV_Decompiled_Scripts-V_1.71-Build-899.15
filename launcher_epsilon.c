	...
	if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(83))
	{
		...
		if (num != -1)
		{
			if (Global_113457[num /*10*/].f_9 != -1)
			{
				...
				func_511(&(Global_113457[num /*10*/].f_9));
			}
		}
...
{
	func_21(sParam1);
	MISC::CLEAR_BIT(&Global_114370.f_18578[iParam0 /*6*/], 5);
	...
	while (!IS_BIT_SET(Global_114370.f_18578[iParam0 /*6*/], 5))
	{
		if (SCRIPT::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(joaat("mission_stat_watcher")) > 0)
			MISC::SET_BIT(&Global_114370.f_18578[iParam0 /*6*/], 5);
	}
...
void func_4(int iParam0) // Position - 0x7BC
{
	...
	TEXT_LABEL_COPY(&Global_64538, { func_9(iParam0) }, 4);
	Global_64526 = 0;
	Global_64525 = 0;
	...
	Global_76768 = 1;
	num2 = Global_76769;
	Global_76769 = iParam0;

	if (!Global_64513)
	{
		if (Global_76769 != num2 || Global_76618 == 0 || num != Global_76768)
		{
			Global_33552 = 0;
			func_10();
			func_6(iParam0);
	...
	Global_64551 = MISC::GET_GAME_TIMER();
	func_5();
	Global_64523 = false;
	return;
}
...
void func_5() // Position - 0x916
{
	...
	{
		switch (Global_64748[Global_76619[i /*9*/] /*13*/])
		{
			case 1:
			case 9:
				Global_76619[i /*9*/].f_3 = 1;
				break;
			...
			case 6:
				if (Global_64748[Global_76619[i /*9*/] /*13*/].f_3)
...
void func_7(int iParam0) // Position - 0xDB1
{
	...
	func_8(Global_76618);
	Global_76619[Global_76618 /*9*/] = iParam0;
	Global_76618 = Global_76618 + 1;

	if (Global_64748[iParam0 /*13*/] == 16)
		Global_76770 = 1;
...
{
	Global_76619[iParam0 /*9*/].f_1 = 0;
	Global_76619[iParam0 /*9*/].f_2 = 0f;
	Global_76619[iParam0 /*9*/].f_3 = 0;
	Global_76619[iParam0 /*9*/].f_4 = 0;
	return;
}
...
{
	Global_64542 = 0;
	Global_64546 = func_15(joaat("SP0_SHOTS"));
	Global_64545 = func_15(joaat("SP0_HITS"));
	Global_64548 = func_15(joaat("SP1_SHOTS"));
	Global_64547 = func_15(joaat("SP1_HITS"));
	Global_64550 = func_15(joaat("SP2_SHOTS"));
	Global_64549 = func_15(joaat("SP2_HITS"));
	return;
}
...
void func_23(char* sParam0, int iParam1, Ped pedParam2) // Position - 0x10A9
{
	if (Global_101917 != 10 && Global_101917 != 9)
	{
		...
		func_25(&Global_104929, sParam0, 0, "Start", iParam1, pedParam2);
		func_24();
		Global_96070 = 0;
	}
...
void func_58() // Position - 0x44DD
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (_GET_CHARACTER_MODEL(Global_114370.f_2367.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_36(character) && !func_59(14) || Global_113318)
			{
...
void func_60(Ped pedParam0, BOOL bParam1) // Position - 0x45E8
{
	...
	if (func_36(character) && !PED::IS_PED_INJURED(pedParam0))
	{
		if (pedParam0 == PLAYER::PLAYER_PED_ID())
		{
			func_61(pedParam0, &Global_114370.f_2367.f_539.f_298[character /*477*/]);
...
Vector3 func_79(int iParam0, BOOL bParam1) // Position - 0x6F00
{
	switch (iParam0)
	{
		...
		case 45:
			return func_96(Global_104081);
	
		case 46:
			if (Global_1845104 != _INVALID_PLAYER_INDEX())
				if (func_94(Global_1845104))
					return func_87(2, 2);
				else if (func_86(Global_1845104))
					return func_87(45, 3);
				else
...
BOOL func_167(int iParam0) // Position - 0xBC6A
{
	...
	num = func_169(&(Global_113457[iParam0 /*10*/].f_9), 1, 4, false, 0);
	...
	switch (iParam0)
	{
		...
		case 3:
			*uParam1 = func_178(190.26f, -956.35f, 29.63f, false);
			...
			if (IS_BIT_SET(Global_114370.f_18578[2 /*6*/], 3) || IS_BIT_SET(Global_114370.f_18578[4 /*6*/], 3) || IS_BIT_SET(Global_114370.f_18578[4 /*6*/], 3))
		...
		case 4:
			*uParam1 = func_178(414f, -761f, 29f, false);
			...
			if (IS_BIT_SET(Global_114370.f_18578[2 /*6*/], 3) || IS_BIT_SET(Global_114370.f_18578[3 /*6*/], 3))
				HUD::SET_BLIP_SPRITE(*uParam1, BLIP_BARRY);
			else
				HUD::SET_BLIP_SPRITE(*uParam1, BLIP_RANDOM_CHARACTER);
		...
		case 23:
			...
			if (IS_BIT_SET(Global_114370.f_18578[21 /*6*/], 3) || IS_BIT_SET(Global_114370.f_18578[22 /*6*/], 3) || IS_BIT_SET(Global_114370.f_18578[23 /*6*/], 3))
...
BOOL func_184(var uParam0) // Position - 0xC6E5
{
	switch (*uParam0)
	{
		...
		case 16:
			...
			if (_GET_PLAYER_CASH(CHAR_MICHAEL) >= 50000 || Global_114370.f_18578.f_387 == 1)
				return func_338(*uParam0);
			else
				return false;
			break;
...
void func_190(int iParam0) // Position - 0xD18F
{
	...
	else if (IS_BIT_SET(Global_114370.f_20568.f_471, iParam0) || IS_BIT_SET(Global_2359296[func_192() /*5571*/].f_681.f_10, iParam0))
	{
		flag = true;
		MISC::CLEAR_BIT(&(Global_114370.f_20568.f_471), iParam0);
...
int func_206(int iParam0, int iParam1) // Position - 0xDA0D
{
	...
	if (func_216(&Global_4546910))
	{
		if (func_214(&Global_4546910, iParam0))
			return 0;
	
		if (func_207(&Global_4546910, iParam0))
			return 1;
	}
	else
	{
...
void func_210(var uParam0) // Position - 0xDBE7
{
	...
	func_212(uParam0, Global_4546909 - 0.5f);
	return;
}
...
int func_223(Ped pedParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Position - 0xDE48
{
	...
	if (iParam5 == 0)
	{
		Global_79551[1 /*14*/] = { func_272(entityModel, iParam1, iParam2, -1) };
	...
	if (iParam1 == 12)
	{
		...
		for (i = 0; i <= 14; i = i + 1)
		{
			if (unk[i] != -99)
			{
				Global_79551[1 /*14*/] = { func_272(entityModel, i, unk[i], -1) };
				...
				if (IS_BIT_SET(Global_79551[1 /*14*/].f_6, 0))
				{
					if (i == 13)
					{
						...
						for (j = 0; j <= 8; j = j + 1)
						{
							Global_79551[1 /*14*/] = { func_272(entityModel, 14, unk18[j], -1) };
							func_244(pedParam0, Global_79551[1 /*14*/].f_12, Global_79551[1 /*14*/].f_3, Global_79551[1 /*14*/].f_4);
							func_267(14);
					...
					else if (i != 14 && i != 12)
					{
						...
						if (iParam4 == -1)
							PED::SET_PED_COMPONENT_VARIATION(pedParam0, func_234(i), Global_79551[1 /*14*/].f_3, Global_79551[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(pedParam0, func_234(i)));
						else
							PED::SET_PED_COMPONENT_VARIATION(pedParam0, func_234(i), Global_79551[1 /*14*/].f_3, Global_79551[1 /*14*/].f_4, iParam4);
			...
			{
				Global_79551[1 /*14*/] = { func_272(entityModel, i, func_233(pedParam0, i, PV_COMP_INVALID), -1) };
	...
	else if (iParam1 == 13)
	{
		...
		for (j = 0; j <= 8; j = j + 1)
		{
			Global_79551[1 /*14*/] = { func_272(entityModel, 14, unk59[j], -1) };
			func_244(pedParam0, Global_79551[1 /*14*/].f_12, Global_79551[1 /*14*/].f_3, Global_79551[1 /*14*/].f_4);
			func_267(14);
	...
	{
		if (iParam4 == -1)
			PED::SET_PED_COMPONENT_VARIATION(pedParam0, func_234(iParam1), Global_79551[1 /*14*/].f_3, Global_79551[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(pedParam0, func_234(iParam1)));
		else
			PED::SET_PED_COMPONENT_VARIATION(pedParam0, func_234(iParam1), Global_79551[1 /*14*/].f_3, Global_79551[1 /*14*/].f_4, iParam4);
...
BOOL func_225(Ped pedParam0, int iParam1, int iParam2) // Position - 0xE6FA
{
			...
			if (unk[i] != -99 && i != 12 && i != 14)
			{
				if (!func_225(pedParam0, i, unk[i]))
				{
					if (i == 13)
					{
						...
						for (j = 0; j <= 8; j = j + 1)
						{
							if (!func_225(pedParam0, 14, unk18[j]))
							{
								for (k = 0; k <= 19; k = k + 1)
								{
									Global_79551[2 /*14*/] = { func_272(entityModel, 14, k, -1) };
								
									if (Global_79551[2 /*14*/].f_12 == j)
										if (func_225(pedParam0, 14, k))
											if (!func_230(entityModel, iParam2, 14, k, &unk, &Global_79551[2 /*14*/]))
												return false;
								}
							}
						}
					...
					else
					{
						...
						Global_79551[2 /*14*/] = { func_272(entityModel, i, num, -1) };
					
						if (!func_230(entityModel, iParam2, i, num, &unk, &Global_79551[2 /*14*/]))
							return false;
					}
				}
			}
	...
	else if (Global_79551[1 /*14*/].f_3 == PED::GET_PED_DRAWABLE_VARIATION(pedParam0, func_234(iParam1)) && Global_79551[1 /*14*/].f_4 == PED::GET_PED_TEXTURE_VARIATION(pedParam0, func_234(iParam1)))
	{
		return true;
	}
...
{
	Global_79551[1 /*14*/] = { func_272(hParam0, iParam1, iParam2, -1) };
	...
	switch (hParam0)
	{
		case joaat("Player_Zero"):
			switch (iParam1)
			{
				...
				case 5:
					func_260(&unk, -99, -99, Global_114370.f_2367.f_539.f_196[0], Global_114370.f_2367.f_539.f_200[0], 6, 3, 0, 0, 0, -99, 0, 0, 3);
					break;
		...
		case joaat("Player_One"):
			switch (iParam1)
			{
				...
				case 2:
					func_260(&unk, -99, -99, Global_114370.f_2367.f_539.f_196[1], Global_114370.f_2367.f_539.f_200[1], 17, 2, 26, 0, 0, -99, 0, 45, 31);
					break;
		...
		case joaat("Player_Two"):
			switch (iParam1)
			{
				...
				case 4:
					func_260(&unk, -99, -99, Global_114370.f_2367.f_539.f_196[2], Global_114370.f_2367.f_539.f_200[2], 8, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
...
void func_267(int iParam0) // Position - 0x15016
{
	if (IS_BIT_SET(Global_79551[1 /*14*/].f_6, 1) && !IS_BIT_SET(Global_79551[1 /*14*/].f_6, 6))
		func_270(iParam0, Global_79551[1 /*14*/].f_5, Global_79551[1 /*14*/].f_2, 2, Global_79551[1 /*14*/].f_1, 1, 0);
...
BOOL func_270(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x17D69
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
BOOL func_271(int iParam0) // Position - 0x18C0D
{
	if (!IS_BIT_SET(Global_79551[1 /*14*/].f_6, 0))
		return false;
...
struct<14> func_272(Hash hParam0, int iParam1, int iParam2, int iParam3) // Position - 0x18C55
{
	func_335();
...
void func_273(int iParam0, int iParam1) // Position - 0x18CA7
{
	switch (iParam0)
	{
		case 0:
...
void func_274(int iParam0) // Position - 0x18D97
{
	BOOL flag;
	int num;
	var unk;
	...
	func_275(&Global_79551[0 /*14*/], num6, iParam0, &unk, num2, num3, num, flag, num4, num5, false);
	return;
}

void func_275(int iParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, BOOL bParam7, int iParam8, int iParam9, BOOL bParam10) // Position - 0x1A00E
{
	int num;
	int num2;
	...
	*iParam0 = iParam9;
	...
	else
	{
		...
		if (iParam1 == 11 || iParam1 == 4 || iParam1 == 6 || iParam1 == 1 || iParam1 == 14 || iParam1 == 2 || iParam1 == 8 || iParam1 == 9 || iParam1 == 10 || iParam1 == 7 || iParam1 == 12)
		{
			...
			num = func_49(func_278(iParam1, iParam0->f_2), Global_79548);
		
			if (IS_BIT_SET(num, iParam0->f_1))
				MISC::SET_BIT(&(iParam0->f_6), 1);
		
			num = func_49(func_277(iParam1, iParam0->f_2), Global_79548);
...
BOOL func_276(int iParam0, int iParam1, var uParam2) // Position - 0x1A3B0
{
	*uParam2 = 979;
...
int func_277(int iParam0, int iParam1) // Position - 0x1A7B5
{
	switch (iParam1)
	{
		case 0:
...
int func_278(int iParam0, int iParam1) // Position - 0x1ABB0
{
	switch (iParam1)
	{
		case 0:
...
BOOL func_279(Hash hParam0, int iParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0x1AFAB
{
	int num;
	int num2;
	int num3;
...
int func_280(int iParam0) // Position - 0x1AFE9
{
	switch (iParam0)
	{
		case -1:
...
void func_281(int iParam0, int iParam1, int iParam2, Hash hParam3) // Position - 0x1B0BD
{
	int num;
	int num2;
	Hash outfit;
	...
	if (iParam0 == 12)
	{
		...
		if (outfitIndex >= 0)
		{
			...
			if (num3 > outfitIndex)
			{
				...
				func_275(&Global_79551[0 /*14*/], iParam0, iParam1, &(outfit.f_7), 0, 0, outfit.f_2, false, -1, 2, true);
				return;
			}
		}
	}
	...
	{
		func_275(&Global_79551[0 /*14*/], iParam0, iParam1, "NO_LABEL", 0, 0, 0, true, -1, 2, true);
	}
	else if (iParam0 == 14)
	{
		FILES::INIT_SHOP_PED_PROP(&outProp);
		...
		if (componentId >= 0)
		{
			...
			if (num5 > componentId)
			{
				...
				func_275(&Global_79551[0 /*14*/], iParam0, iParam1, &(outProp.f_9), outProp.f_3, outProp.f_4, outProp.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(outProp.f_1, joaat("OUTFIT_ONLY"), 0), num4, 2, outProp.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (hParam3 != -1 && Global_79749)
		{
			...
			func_275(&Global_79551[0 /*14*/], iParam0, iParam1, &(outComponent.f_9), outComponent.f_3, outComponent.f_4, outComponent.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(outComponent.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, outComponent.f_1 != 0);
			return;
		}
...
void func_282(int iParam0) // Position - 0x1B344
{
	BOOL flag;
	int num;
	var unk;
...
void func_283(int iParam0) // Position - 0x1B49B
{
	BOOL flag;
	int num;
	var unk;
...
void func_284(int iParam0) // Position - 0x1B9A9
{
	BOOL flag;
	int num;
	var unk;
...
void func_285(int iParam0) // Position - 0x1BA1E
{
	BOOL flag;
	int num;
	var unk;
...
void func_286(int iParam0) // Position - 0x1BA92
{
	BOOL flag;
	int num;
	var unk;
...
void func_287(int iParam0) // Position - 0x1BB79
{
	BOOL flag;
	int num;
	var unk;
...
void func_288(int iParam0) // Position - 0x1BEDC
{
	BOOL flag;
	int num;
	var unk;
...
void func_289(int iParam0) // Position - 0x1C0F0
{
	BOOL flag;
	int num;
	var unk;
...
void func_290(int iParam0) // Position - 0x1C320
{
	BOOL flag;
	int num;
	var unk;
...
void func_291(int iParam0) // Position - 0x1C430
{
	BOOL flag;
	int num;
	var unk;
...
void func_292(int iParam0) // Position - 0x1CDCF
{
	BOOL flag;
	int num;
	var unk;
...
void func_293(int iParam0) // Position - 0x1D942
{
	if (iParam0 < 136)
		func_295(iParam0);
	else
...
void func_294(int iParam0) // Position - 0x1D977
{
	BOOL flag;
	int num;
	var unk;
...
void func_295(int iParam0) // Position - 0x1E57B
{
	BOOL flag;
	int num;
	var unk;
...
void func_296(int iParam0) // Position - 0x1F489
{
	BOOL flag;
	int num;
	var unk;
...
void func_297(int iParam0) // Position - 0x1F5B6
{
	BOOL flag;
	int num;
	var unk;
...
void func_298(int iParam0, int iParam1) // Position - 0x1F6B4
{
	switch (iParam0)
	{
		case 0:
...
void func_299(int iParam0) // Position - 0x1F7A4
{
	BOOL flag;
	int num;
	var unk;
...
void func_300(int iParam0) // Position - 0x20C96
{
	BOOL flag;
	int num;
	var unk;
...
void func_301(int iParam0) // Position - 0x20DE7
{
	BOOL flag;
	int num;
	var unk;
...
void func_302(int iParam0) // Position - 0x212F2
{
	BOOL flag;
	int num;
	var unk;
...
void func_303(int iParam0) // Position - 0x21960
{
	BOOL flag;
	int num;
	var unk;
...
void func_304(int iParam0) // Position - 0x219D4
{
	BOOL flag;
	int num;
	var unk;
...
void func_305(int iParam0) // Position - 0x21AA4
{
	BOOL flag;
	int num;
	var unk;
...
void func_306(int iParam0) // Position - 0x21FD4
{
	BOOL flag;
	int num;
	var unk;
...
void func_307(int iParam0) // Position - 0x2216B
{
	BOOL flag;
	int num;
	var unk;
...
void func_308(int iParam0) // Position - 0x22969
{
	BOOL flag;
	int num;
	var unk;
...
void func_309(int iParam0) // Position - 0x22A79
{
	BOOL flag;
	int num;
	var unk;
...
void func_310(int iParam0) // Position - 0x239A4
{
	BOOL flag;
	int num;
	var unk;
...
void func_311(int iParam0) // Position - 0x24664
{
	if (iParam0 < 107)
		func_314(iParam0);
	else if (iParam0 < 227)
...
void func_312(int iParam0) // Position - 0x246AA
{
	BOOL flag;
	int num;
	var unk;
...
void func_313(int iParam0) // Position - 0x2514F
{
	BOOL flag;
	int num;
	var unk;
...
void func_314(int iParam0) // Position - 0x25F3E
{
	BOOL flag;
	int num;
	var unk;
...
void func_315(int iParam0) // Position - 0x26B87
{
	BOOL flag;
	int num;
	var unk;
...
void func_316(int iParam0) // Position - 0x26E00
{
	BOOL flag;
	int num;
	var unk;
...
void func_317(int iParam0, int iParam1) // Position - 0x26F46
{
	switch (iParam0)
	{
		case 0:
...
void func_318(int iParam0) // Position - 0x27036
{
	BOOL flag;
	int num;
	var unk;
...
void func_319(int iParam0) // Position - 0x27DC0
{
	BOOL flag;
	int num;
	var unk;
...
void func_320(int iParam0) // Position - 0x27F3A
{
	BOOL flag;
	int num;
	var unk;
...
int func_336(Hash hParam0, int iParam1, int iParam2, BOOL bParam3, int iParam4) // Position - 0x2C5FB
{
	...
	if (IS_BIT_SET(Global_79551[1 /*14*/].f_6, 0) && !IS_BIT_SET(Global_79551[1 /*14*/].f_6, 6))
	{
		if (bParam3)
		{
			func_270(iParam1, Global_79551[1 /*14*/].f_5, Global_79551[1 /*14*/].f_2, 1, Global_79551[1 /*14*/].f_1, 1, 0);
		...
		{
			func_270(iParam1, Global_79551[1 /*14*/].f_5, Global_79551[1 /*14*/].f_2, 1, Global_79551[1 /*14*/].f_1, 0, 1);
		}
				...
				case joaat("Player_One"):
					switch (iParam1)
					{
						case 3:
							...
							{
								num2 = 227 + Global_79551[1 /*14*/].f_4;
						...
						case 11:
							if (iParam2 >= 9 && iParam2 <= 24)
							{
								num2 = 25 + Global_79551[1 /*14*/].f_4;
								func_336(hParam0, 11, num2, true, 0);
							}
							else if (iParam2 >= 25 && iParam2 <= 40)
							{
								num2 = 9 + Global_79551[1 /*14*/].f_4;
								func_336(hParam0, 11, num2, true, 0);
							}
							break;
						...
						case 8:
							...
							{
								num2 = 43 + Global_79551[1 /*14*/].f_4;
								func_336(hParam0, 8, num2, true, 0);
								num2 = 59 + Global_79551[1 /*14*/].f_4;
								func_336(hParam0, 8, num2, true, 0);
							}
							else if (iParam2 >= 43 && iParam2 <= 58)
							{
								num2 = 27 + Global_79551[1 /*14*/].f_4;
								func_336(hParam0, 8, num2, true, 0);
								num2 = 59 + Global_79551[1 /*14*/].f_4;
								func_336(hParam0, 8, num2, true, 0);
							}
...
int func_337(Hash hParam0, int iParam1, int iParam2, BOOL bParam3) // Position - 0x2C9DD
{
	...
	{
		if (bParam3)
			func_270(iParam1, Global_79551[1 /*14*/].f_5, Global_79551[1 /*14*/].f_2, 0, Global_79551[1 /*14*/].f_1, 1, 0);
		else
			func_270(iParam1, Global_79551[1 /*14*/].f_5, Global_79551[1 /*14*/].f_2, 0, Global_79551[1 /*14*/].f_1, 0, 1);
...
{
	func_27(&(Global_104929.f_2890), &Global_104929, 0, 1, 1, 0);
	return;
}
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_353() || Global_113417 || Global_33301 || func_352() || func_351(8, -1) || func_101() || func_350() || func_349() || func_348() || Global_114370.f_7692.f_919[character] == 5)
							return false;
						break;
				
					case 1:
						if (PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_353() || Global_33301 || func_352() || func_351(8, -1) || func_349() || func_101() || func_350() || func_348() || Global_114370.f_7692.f_919[character] == 5)
							return false;
						break;
				
					case 2:
						if (!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_353() || Global_113417 || Global_33301 || func_352() || func_351(8, -1) || func_349() || func_101() || func_350() || func_348() || Global_114370.f_7692.f_919[character] == 5 || Global_44939 != -1)
							return false;
						break;
				
					case 3:
						if (PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_353() || Global_113417 || Global_33301 || func_352() || func_351(8, -1) || func_101() || func_350() || func_348() || Global_114370.f_7692.f_919[character] == 5)
							return false;
						break;
				
					case 4:
						if (func_353() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0 || func_351(8, -1) || func_348() || func_347() || Global_114370.f_7692.f_919[character] == 5)
							return false;
						break;
...
int func_357(int iParam0) // Position - 0x2DE0F
{
	if (Global_79764 == iParam0)
		if (Global_79765 == -1)
			if (Global_79763 < MISC::GET_FRAME_COUNT())
				return 1;
	else if (Global_79765 == iParam0)
		return 2;
...
void func_358(var uParam0, int iParam1) // Position - 0x2DE48
{
	...
	if (Global_79761 < 5)
	{
		Global_79750[Global_79761 /*2*/] = 0;
		Global_79750[Global_79761 /*2*/].f_1 = iParam1;
		flag = false;
		...
		while (!flag)
		{
			...
			for (i = 0; i < Global_79761; i = i + 1)
			{
				if (Global_79750[i /*2*/] == Global_79750[Global_79761 /*2*/])
				{
					Global_79750[Global_79761 /*2*/] = Global_79750[Global_79761 /*2*/] + 1;
					flag = false;
				}
			}
		}
	
		*uParam0 = Global_79750[Global_79761 /*2*/];
...
void func_417(int iParam0, var uParam1) // Position - 0x30123
{
	...
	switch (iParam0)
	{
		...
		case 71:
		case 72:
			if (!func_418(iParam0) && SCRIPT::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(Global_92680[26 /*34*/].f_6) == 0)
			{
				Global_114370.f_7265[iParam0] = 1;
				OBJECT::DOOR_SYSTEM_SET_DOOR_STATE(uParam1->f_5, Global_114370.f_7265[iParam0], true, true);
			}
...
BOOL IS_RC_FINE_AND_IN_RANGE(Any* panParam0, BOOL bParam1) // Position - 0x338F1
{
	...
	if (func_447(*panParam0) || func_445(*panParam0) || Global_80014 == true)
		return true;
...
BOOL func_441(int iParam0) // Position - 0x3480A
{
	...
	if (!IS_BIT_SET(Global_114370.f_18578[iParam0 /*6*/], 2))
		return true;
...
{
	if (func_446() && Global_101917.f_11 == 6 && iParam0 == func_175(&(Global_101917.f_3), 0))
		return true;
...
{
	if (_IS_MISSION_REPEAT_ACTIVE(false))
		if (Global_80015.f_1 == 7)
			if (Global_80015 == iParam0)
				return true;
...
struct<5> func_478(int iParam0) // Position - 0x35FE2
{
	...
	switch (iParam0)
	{
		...
		case 243:
			...
			unk.f_3 = func_479(&Global_4718592.f_235581[0 /*160*/]);
			unk.f_4 = unk.f_3;
			break;
	
		case 244:
			unk = { Global_4718592.f_235581[1 /*160*/].f_16 };
			unk.f_3 = func_479(&Global_4718592.f_235581[1 /*160*/]);
			unk.f_4 = unk.f_3;
			break;
	
		case 245:
			unk = { Global_4718592.f_235581[2 /*160*/].f_16 };
			unk.f_3 = func_479(&Global_4718592.f_235581[2 /*160*/]);
			unk.f_4 = unk.f_3;
			break;
	
		case 246:
			unk = { Global_4718592.f_235581[3 /*160*/].f_16 };
			unk.f_3 = func_479(&Global_4718592.f_235581[3 /*160*/]);
			unk.f_4 = unk.f_3;
			break;
	
		case 247:
			unk = { Global_4718592.f_235581[4 /*160*/].f_16 };
			unk.f_3 = func_479(&Global_4718592.f_235581[4 /*160*/]);
			unk.f_4 = unk.f_3;
			break;
...
var func_479(var uParam0) // Position - 0x38CD7
{
	return uParam0;
}

struct<6> func_480(int iParam0, BOOL bParam1) // Position - 0x38CE1
{
	var unk;
...
void func_481(int iParam0, BOOL bParam1) // Position - 0x39897
{
...
BOOL func_482(var uParam0) // Position - 0x398DC
{
	int num;
	int i;
	BOOL flag;
...
BOOL func_483(int iParam0) // Position - 0x39A42
{
	var unk;
	eCharacter character;
...
BOOL func_484(int iParam0) // Position - 0x39A93
{
	const char* string2;
	...
	if (!Global_114370.f_9089 && !_IS_MISSION_REPEAT_ACTIVE(true))
	{
	...
	if (Global_101917.f_11 == 6)
	{
		if (Global_101917 < 9)
		{
			func_120(iParam0, &string2);
		
			if (MISC::ARE_STRINGS_EQUAL(&(Global_101917.f_3), string2))
			{
...
BOOL func_485(int iParam0) // Position - 0x39B51
{
	var unk;
...
BOOL func_486(int iParam0) // Position - 0x39C12
{
	int i;
	var interiorType;
	Interior interiorAtCoordsWithType;
	...
	else if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
		...
		interiorAtCoordsWithType = INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(Global_96930[iParam0 /*10*/].f_3, &interiorType);
	
		if (interiorAtCoordsWithType != 0 && Global_101969.f_397 == interiorAtCoordsWithType)
			return true;
	}
...
BOOL func_487(int iParam0, char* sParam1) // Position - 0x39C97
{
...
BOOL func_488(int iParam0) // Position - 0x39D84
{
...
BOOL func_489(int iParam0) // Position - 0x39DAF
{
	if (iParam0 == 63 || iParam0 == -1)
		return false;

	return IS_BIT_SET(Global_114370.f_18578[iParam0 /*6*/], 2);
}

BOOL func_490(int iParam0) // Position - 0x39DDA
{
	if (iParam0 == 63 || iParam0 == -1)
		return false;
...
BOOL func_491(int iParam0) // Position - 0x39E05
{
	if (func_442(iParam0))
		return false;
	else if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
...
void func_492() // Position - 0x39E3A
{
...
BOOL func_493(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, float fParam5) // Position - 0x39E55
{
	int i;
...
BOOL func_494(int iParam0, var uParam1, var uParam2, var uParam3, float fParam4, var uParam5) // Position - 0x39EBB
{
	int num;
	char* str;
	...
	{
		if (IS_BIT_SET(Global_114370.f_18578[iParam0 /*6*/], 0))
...
BOOL func_495(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, BOOL bParam7) // Position - 0x39F33
{
	if (fParam6 < 0f)
		fParam6 = 0f;
...
void func_496(var uParam0, BOOL bParam1) // Position - 0x39FAE
{
	char* str;
...
void func_497(char* sParam0) // Position - 0x3A0BD
{
	if (!MISC::IS_STRING_NULL_OR_EMPTY(sParam0))
		if (func_382(sParam0))
			func_498();
...
void func_498() // Position - 0x3A0DC
{
	Global_21468 = 0;
	func_499();
	return;
...
void func_499() // Position - 0x3A0EC
{
	AUDIO::RESTART_SCRIPTED_CONVERSATION();
	Global_23613 = 0;
...
int func_500(var uParam0) // Position - 0x3A10D
{
	if (func_432(uParam0))
	{
		if (STREAMING::HAS_ANIM_DICT_LOADED(*uParam0))
...
void func_501(var uParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Position - 0x3A143
{
...
void func_502(var uParam0, BOOL bParam1) // Position - 0x3A163
{
	func_503(&(uParam0->f_41), bParam1);
	return;
}

void func_503(var uParam0, BOOL bParam1) // Position - 0x3A175
{
	int i;
...
void func_504(Object* pobParam0, BOOL bParam1) // Position - 0x3A1B3
{
	if (ENTITY::DOES_ENTITY_EXIST(*pobParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*pobParam0))
...
void func_505(var uParam0, BOOL bParam1) // Position - 0x3A1EE
{
	func_506(&(uParam0->f_35), bParam1);
	return;
}

void func_506(var uParam0, BOOL bParam1) // Position - 0x3A200
{
	int i;
...
void func_507(Vehicle* pveParam0) // Position - 0x3A23D
{
	if (ENTITY::DOES_ENTITY_EXIST(*pveParam0))
	{
...
void func_508(var uParam0, int iParam1) // Position - 0x3A275
{
	func_509(&(uParam0->f_28), iParam1);
	return;
}

void func_509(var uParam0, int iParam1) // Position - 0x3A287
{
	int i;
...
void func_510(Ped* ppedParam0, BOOL bParam1, int iParam2, int iParam3) // Position - 0x3A2C8
{
	if (ENTITY::DOES_ENTITY_EXIST(*ppedParam0))
	{
...
void func_511(int iParam0) // Position - 0x3A318
{
	if (*iParam0 == -1)
		return;
...
void func_512(char* sParam0) // Position - 0x3A355
{
	!MISC::IS_STRING_NULL_OR_EMPTY(sParam0);
	return;
}

void func_513(var uParam0) // Position - 0x3A367
{
	*uParam0 = -1;
...
void func_514() // Position - 0x3A39A
{
...
Hash func_515(eCharacter echParam0) // Position - 0x3A3B5
{
	if (!func_36(echParam0))
