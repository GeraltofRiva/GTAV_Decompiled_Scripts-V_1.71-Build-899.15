...
void main() // Position - 0x0
{
	...
	while (true)
	{
		if (Global_114370.f_20414.f_145 > 0 || Global_113007)
		{
			if (!Global_113007)
			{
				if (Global_44392 != 6 && Global_44392 != 15 && !Global_97899)
					func_23();
				...
				if (!Global_113006)
				{
					...
					{
						if (func_20(&Global_114370.f_20414[iLocal_35 /*16*/]))
						{
							if (func_18(_GET_CURRENT_PLAYER_CHARACTER_0()))
							{
								if (IS_BIT_SET(Global_114370.f_20414[iLocal_35 /*16*/].f_11, _GET_CURRENT_PLAYER_CHARACTER()))
								{
									if (Global_114370.f_20414[iLocal_35 /*16*/].f_12 == Global_114370.f_20414.f_146[_GET_CURRENT_PLAYER_CHARACTER()])
									{
										if (MISC::GET_GAME_TIMER() > Global_113009)
										{
											if (MISC::GET_GAME_TIMER() > Global_114370.f_20414[iLocal_35 /*16*/].f_8)
											{
												if (MISC::ARE_STRINGS_EQUAL(&(Global_114370.f_20414[iLocal_35 /*16*/].f_4), ""))
												{
													HUD::ADD_NEXT_MESSAGE_TO_PREVIOUS_BRIEFS(true);
													func_11(&Global_114370.f_20414[iLocal_35 /*16*/]);
												}
												else
												{
													HUD::ADD_NEXT_MESSAGE_TO_PREVIOUS_BRIEFS(true);
													func_10(&Global_114370.f_20414[iLocal_35 /*16*/], &(Global_114370.f_20414[iLocal_35 /*16*/].f_4));
												}
											
												if (Global_114370.f_20414[iLocal_35 /*16*/].f_13 != 0)
													func_9(Global_114370.f_20414[iLocal_35 /*16*/].f_13, 0);
											
												uLocal_18 = { Global_114370.f_20414[iLocal_35 /*16*/] };
												uLocal_18.f_4 = { Global_114370.f_20414[iLocal_35 /*16*/].f_4 };
												uLocal_18.f_8 = Global_114370.f_20414[iLocal_35 /*16*/].f_8;
												uLocal_18.f_10 = Global_114370.f_20414[iLocal_35 /*16*/].f_10;
												uLocal_18.f_9 = Global_114370.f_20414[iLocal_35 /*16*/].f_9;
												uLocal_18.f_11 = Global_114370.f_20414[iLocal_35 /*16*/].f_11;
												uLocal_18.f_12 = Global_114370.f_20414[iLocal_35 /*16*/].f_12;
												uLocal_18.f_13 = Global_114370.f_20414[iLocal_35 /*16*/].f_13;
												uLocal_18.f_14 = Global_114370.f_20414[iLocal_35 /*16*/].f_14;
												uLocal_18.f_15 = Global_114370.f_20414[iLocal_35 /*16*/].f_15;
												uLocal_18.f_16 = 0;
												Global_113010 = { Global_114370.f_20414[iLocal_35 /*16*/] };
												Global_113008 = MISC::GET_GAME_TIMER();
											
												for (i = iLocal_35; i <= Global_114370.f_20414.f_145 - 2; i = i + 1)
												{
													func_8(i, i + 1);
												}
											
												func_7(Global_114370.f_20414.f_145 - 1);
			...
			else if (!func_4())
			{
				...
				if (MISC::GET_GAME_TIMER() - Global_113008 > 4000 || uLocal_18.f_16)
				{
					if (uLocal_18.f_14 != 0)
			...
			if (!MISC::ARE_STRINGS_EQUAL(&Global_114370.f_20414[iLocal_35 /*16*/], &uLocal_18) && !MISC::ARE_STRINGS_EQUAL(&Global_114370.f_20414[iLocal_35 /*16*/], ""))
			{
				if (Global_114370.f_20414[iLocal_35 /*16*/].f_10 != -1)
				{
					if (MISC::GET_GAME_TIMER() > Global_114370.f_20414[iLocal_35 /*16*/].f_10)
					{
						for (j = iLocal_35; j <= Global_114370.f_20414.f_145 - 2; j = j + 1)
						{
							func_8(j, j + 1);
						}
			...
			if (iLocal_35 >= Global_114370.f_20414.f_145)
				iLocal_35 = 0;
		}
		else if (Global_44392 != 6 && Global_44392 != 15 && !Global_97899)
		{
			func_23();
		}
...
void func_1(const char* sParam0, char* sParam1, var uParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, var uParam9) // Position - 0x472
{
	...
	if (Global_114370.f_20414.f_145 < 9)
	{
		...
		Global_114370.f_20414[Global_114370.f_20414.f_145 /*16*/].f_12 = uParam2;
		...
		Global_114370.f_20414[Global_114370.f_20414.f_145 /*16*/].f_15 = uParam9;
...
BOOL func_4() // Position - 0x670
{
	...
	if (uLocal_18.f_9 != -1 && MISC::GET_GAME_TIMER() - Global_113008 > uLocal_18.f_9)
		return false;
...
void func_13() // Position - 0xA60
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (_GET_CHARACTER_MODEL(Global_114370.f_2367.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_18(character) && !func_14(14) || Global_113318)
			{
