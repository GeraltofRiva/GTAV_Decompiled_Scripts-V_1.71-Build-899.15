	...
	switch (iLocal_96.f_180)
	{
		...
		case 1:
			...
			if (IS_BIT_SET(iLocal_96.f_2.f_1[0 /*66*/].f_65, 6) && IS_BIT_SET(iLocal_96.f_2.f_1[0 /*66*/].f_65, 9))
			{
				...
				{
					if (IS_BIT_SET(iLocal_96.f_2.f_1[0 /*66*/].f_65, 10) || _STOPWATCH_HAS_TIME_PASSED(&uLocal_457, 60000, false))
					{
						func_8();
						iLocal_96.f_180 = 2;
					}
...
void func_11(int iParam0) // Position - 0x7D0
{
	...
	if (iLocal_96.f_2.f_1[iParam0 /*66*/].f_64 == -1)
	{
		if (IS_BIT_SET(iLocal_96.f_2.f_1[iParam0 /*66*/].f_65, 1))
		{
			...
			if (_STOPWATCH_HAS_TIME_PASSED(&(iLocal_96.f_2.f_1[iParam0 /*66*/].f_61), iLocal_96.f_2.f_1[iParam0 /*66*/].f_63, false))
			{
			...
			if (func_41(iLocal_96.f_2.f_68[iParam0 /*104*/].f_5[i /*18*/].f_1))
			{
				if (func_21(iLocal_96.f_2.f_68[iParam0 /*104*/].f_5[i /*18*/].f_2, 1086324736, 1065353216, 1065353216, 1084227584, true, true, true, 1123024896, false, -1, true, 0, false, 0, false, false))
				{
					if (func_20(&iLocal_96.f_2.f_68[iParam0 /*104*/].f_5[i /*18*/], PED_TYPE_CRIMINAL, iLocal_96.f_2.f_68[iParam0 /*104*/].f_5[i /*18*/].f_1, iLocal_96.f_2.f_68[iParam0 /*104*/].f_5[i /*18*/].f_2, iLocal_96.f_2.f_68[iParam0 /*104*/].f_5[i /*18*/].f_5, true, true, true))
					{
						...
						ENTITY::SET_ENTITY_HEALTH(NETWORK::NET_TO_PED(iLocal_96.f_2.f_68[iParam0 /*104*/].f_5[i /*18*/]), SYSTEM::ROUND(200f * Global_262145.f_156), 0, 0);
...
Vector3 func_28(Player plParam0) // Position - 0x11C7
{
	...
	if (func_33() && Global_1845274[player /*877*/].f_857 && !_IS_NULL_VECTOR(Global_1845274[player /*877*/].f_858))
		...
		if (func_41(iLocal_96.f_2.f_68[iParam0 /*104*/].f_78[0 /*17*/].f_1))
		{
			...
			if (num2 == 1)
			{
				if (func_49(&iLocal_96.f_2.f_68[iParam0 /*104*/].f_78[0 /*17*/], iLocal_96.f_2.f_68[iParam0 /*104*/].f_78[0 /*17*/].f_1, unk, num, true, true, true, false, true, true, false, false, false, false))
				{
					...
					VEHICLE::SET_VEHICLE_ENGINE_HEALTH(NETWORK::NET_TO_VEH(iLocal_96.f_2.f_68[iParam0 /*104*/].f_78[0 /*17*/]), SYSTEM::TO_FLOAT(iLocal_96.f_2.f_68[iParam0 /*104*/].f_78[0 /*17*/].f_16));
					VEHICLE::SET_VEHICLE_PETROL_TANK_HEALTH(NETWORK::NET_TO_VEH(iLocal_96.f_2.f_68[iParam0 /*104*/].f_78[0 /*17*/]), SYSTEM::TO_FLOAT(iLocal_96.f_2.f_68[iParam0 /*104*/].f_78[0 /*17*/].f_16));
...
void func_53(int iParam0) // Position - 0x1DC9
{
	...
	{
		if (_STOPWATCH_HAS_TIME_PASSED(&(iLocal_96.f_186), 60000, false))
	...
	else if (!IS_BIT_SET(iLocal_96.f_2.f_1[iParam0 /*66*/].f_65, 1))
	{
		...
		if (!IS_BIT_SET(iLocal_96.f_2.f_1[iParam0 /*66*/].f_65, 1))
		{
			if (_STOPWATCH_HAS_TIME_PASSED(&(iLocal_96.f_188), 60000, false))
			{
				func_8();
				iLocal_96.f_180 = 2;
				unk16.f_3 = 654590235;
	...
	if (STREAMING::HAS_MODEL_LOADED(iLocal_96.f_2.f_1[iParam0 /*66*/].f_3))
	{
		...
		if (!NETWORK::NETWORK_DOES_NETWORK_ID_EXIST(iLocal_96.f_2.f_1[iParam0 /*66*/].f_1))
		{
			...
			if (NETWORK::CAN_REGISTER_MISSION_ENTITIES(0, 0, 1, 0))
			{
				...
				ENTITY::SET_ENTITY_INVINCIBLE(NETWORK::NET_TO_OBJ(iLocal_96.f_2.f_1[iParam0 /*66*/].f_1), true, 0);
	...
	if (STREAMING::HAS_MODEL_LOADED(hLocal_461))
	{
		for (i = 0; i < iLocal_96.f_2; i = i + 1)
		{
			if (!ENTITY::DOES_ENTITY_EXIST(uLocal_459[i]))
			{
				...
				ENTITY::SET_ENTITY_INVINCIBLE(uLocal_459[i], true, 0);
	...
	if (NETWORK::NETWORK_DOES_NETWORK_ID_EXIST(iLocal_96.f_2.f_68[iParam0 /*104*/].f_5[iParam1 /*18*/]))
	{
		if (!IS_BIT_SET(uLocal_455[iParam0], 0 + iParam1))
		{
			if (ENTITY::IS_ENTITY_DEAD(NETWORK::NET_TO_PED(iLocal_96.f_2.f_68[iParam0 /*104*/].f_5[iParam1 /*18*/]), false))
			{
				...
				{
					func_129(0, NETWORK::NET_TO_PED(iLocal_96.f_2.f_68[iParam0 /*104*/].f_5[iParam1 /*18*/]), "XPT_KAIE" /*~g~+~1~ ~a~:~s~ Killed Hostile*/, joaat("XPTYPE_ACTION"), joaat("XPCATEGORY_ACTION_KILLS"), SYSTEM::ROUND(50f * Global_262145.f_3926), 1, -1, 0, false, 0);
...
BOOL func_160(Player plParam0) // Position - 0x8903
{
	if (!func_27(plParam0))
		return false;
...
int func_161(int iParam0, int iParam1) // Position - 0x8922
{
	Hash statHash;
	int outValue;
...
int func_162(Player plParam0) // Position - 0x8951
{
...
void func_163(int iParam0, int iParam1, int iParam2) // Position - 0x89A8
{
	int num;
...
void func_164(var uParam0) // Position - 0x89D0
{
	int i;
	int playerTeam;
	int num;
...
float func_165(int iParam0, int iParam1) // Position - 0x8ABC
{
	float num;
	float num2;
	float num3;
...
BOOL func_166(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x8ADD
{
	int num;
	int num2;
...
BOOL func_167(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x8E28
{
	BOOL num;
	Player player;
	Ped playerPed;
...
BOOL func_168(Player plParam0) // Position - 0x8F54
{
	return IS_BIT_SET(Global_1845274[plParam0 /*877*/].f_36.f_18, 14);
}

void func_169(BOOL bParam0, var uParam1) // Position - 0x8F6C
{
	Player i;
	int num;
	BOOL flag;
...
float func_170(Player plParam0, Player plParam1) // Position - 0x9084
{
	return SYSTEM::VDIST(_GET_PLAYER_COORDS(plParam0), _GET_PLAYER_COORDS(plParam1));
}

int func_171(var uParam0) // Position - 0x90A0
{
	int num;
...
int func_172(int iParam0) // Position - 0x90D7
{
	if (iParam0 < 0)
...
int func_173(int iParam0, BOOL bParam1, int iParam2) // Position - 0x913B
{
	iParam2 == 0;
	bParam1;
...
BOOL func_175(char* sParam0) // Position - 0x916A
{
...
BOOL func_177(int iParam0) // Position - 0x9270
{
	return iParam0 == 89;
}

BOOL func_178(Player plParam0) // Position - 0x927D
{
	return func_179(func_99(plParam0));
}

int func_179(int iParam0) // Position - 0x928F
{
	switch (iParam0)
	{
		case 233:
...
BOOL func_181(int iParam0) // Position - 0x92CD
{
	int i;
...
BOOL func_182(Player plParam0) // Position - 0x9307
{
	return Global_2658019[plParam0 /*467*/].f_123 == 2;
}

BOOL func_183(Player plParam0) // Position - 0x931C
{
	return Global_2658019[plParam0 /*467*/].f_123 == 7;
}

void func_184(int iParam0, Blip* pblParam1, int iParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, const char* sParam6, int iParam7, int iParam8, BOOL bParam9, BOOL bParam10, BOOL bParam11) // Position - 0x9331
{
	if (NETWORK::NETWORK_DOES_NETWORK_ID_EXIST(iParam0))
	{
		if (func_31(false))
...
void func_185(Blip* pblParam0, BOOL bParam1) // Position - 0x93B6
{
	BOOL flag;
	var unk;
...
int func_186(Ped pedParam0, Blip* pblParam1, int iParam2, Player plParam3, BOOL bParam4, BOOL bParam5, int iParam6, const char* sParam7, int iParam8, int iParam9, BOOL bParam10, BOOL bParam11, BOOL bParam12) // Position - 0x9430
{
	BOOL flag;
...
void func_188(int iParam0) // Position - 0x9642
{
...
void func_189(int iParam0) // Position - 0x969C
{
...
BOOL func_190() // Position - 0x9745
{
	return Global_2647055.f_1870;
}

BOOL func_191() // Position - 0x9754
{
	return true;
}

BOOL func_192() // Position - 0x975D
{
	if (func_194())
		return false;
...
BOOL func_193(Player plParam0, int iParam1) // Position - 0x97B3
{
	return IS_BIT_SET(Global_2658019[plParam0 /*467*/].f_221, iParam1);
}

BOOL func_194() // Position - 0x97C9
{
	Player num;

	num = Global_2672967;

	if (IS_BIT_SET(Global_1882449[num /*201*/].f_17, 0) && Global_1882449[num /*201*/].f_27 == 2)
		return true;

	return false;
}

void func_195(int iParam0, Vector3 vParam1, var uParam2, var uParam3) // Position - 0x97FC
{
	var entityCoords;
	Object object;
	int num;
...
void func_196(int iParam0) // Position - 0x9FFB
{
	if (iLocal_96.f_2.f_1[iParam0 /*66*/].f_64 != -1)
		if (func_45(iLocal_96.f_2.f_1[iParam0 /*66*/].f_1))
...
BOOL func_197(int iParam0) // Position - 0xA036
{
	BOOL flag;
	BOOL flag2;
	BOOL flag3;
...
BOOL func_198(int iParam0) // Position - 0xA150
{
	float entityPitch;
...
void func_199(var uParam0) // Position - 0xA1BF
{
	Entity entity;
...
BOOL func_200(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, BOOL bParam6) // Position - 0xA1F8
{
	if (bParam6)
...
void func_201(int iParam0) // Position - 0xA23F
{
	int num;
...
void func_202(int iParam0) // Position - 0xA2AD
{
...
void func_203(int iParam0) // Position - 0xA371
{
...
void func_204(int iParam0) // Position - 0xA435
{
	var unk;
...
void func_205(int iParam0, BOOL bParam1) // Position - 0xA56E
{
	int num;
...
int func_208(int iParam0) // Position - 0xA7E6
{
	int num;
	int i;
...
void func_210(int iParam0) // Position - 0xA85F
{
	int ammoCount;
	int amount;
	var entityCoords;
...
void func_211(int iParam0, int iParam1, int iParam2) // Position - 0xAE65
{
	int num;
...
void func_212(int iParam0, int iParam1, int iParam2) // Position - 0xAE8C
{
	Hash statName;
...
Hash func_213(int iParam0, int iParam1) // Position - 0xAEA8
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(8, iParam0, func_156(iParam1));
}

int func_214(int iParam0, int iParam1) // Position - 0xAEBE
{
	Hash statHash;
	int outValue;
...
void func_215(int iParam0, BOOL bParam1, int iParam2) // Position - 0xAEE2
{
	Hash statName;
...
Hash func_216(int iParam0, int iParam1) // Position - 0xAEFE
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(10, iParam0, func_156(iParam1));
}

int func_217(int iParam0, int iParam1) // Position - 0xAF14
{
	Hash statHash;
	int outValue;
...
int func_218(char* sParam0, char* sParam1, const char* sParam2, int iParam3, int iParam4) // Position - 0xAF38
{
	int num;
...
void func_219(int iParam0, char* sParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, const char* sParam9, char* sParam10, char* sParam11) // Position - 0xAF81
{
	int num;
...
int func_220(int iParam0) // Position - 0xB089
{
	int i;
...
void func_221(int iParam0) // Position - 0xB0EB
{
	int i;
...
BOOL IS_ROCKSTAR_DEV() // Position - 0xB124
{
	return DLC::IS_DLC_PRESENT(-1762644250);
}

int func_223(char* sParam0, char* sParam1, int iParam2, int iParam3) // Position - 0xB135
{
	int num;
...
int func_224(int iParam0, int iParam1, var uParam2) // Position - 0xB177
{
	int num;
	int num2;
	var unk;
...
BOOL _STAT_GET_PACKED_BOOL(int iParam0, int iParam1) // Position - 0xB2AD
{
	if (iParam1 == -1)
		iParam1 = func_26();
...
BOOL func_226(Hash hParam0, int iParam1, int iParam2) // Position - 0xB2C9
{
	Global_79551[1 /*14*/] = { func_239(hParam0, iParam1, iParam2, -1) };
	return IS_BIT_SET(Global_79551[1 /*14*/].f_6, 1);
}

void _STAT_SET_PACKED_BOOL(int iParam0, BOOL bParam1, int iParam2) // Position - 0xB2F1
{
	if (iParam2 == -1)
		iParam2 = func_26();
...
int func_228(Hash hParam0) // Position - 0xB30F
{
	switch (hParam0)
	{
		case 1258359620:
...
BOOL func_229(char* sParam0, int iParam1, int iParam2, Ped pedParam3, int iParam4) // Position - 0x123A1
{
	Hash entityModel;
	int num;
...
void func_230(char* sParam0, int iParam1, int iParam2, int iParam3) // Position - 0x153B5
{
	int decorationIndex;
...
BOOL func_231() // Position - 0x15447
{
...
BOOL func_232() // Position - 0x15479
{
	return true;
}

int func_233() // Position - 0x15482
{
	int outValue;
	int outValue2;
	Hash statHash;
...
BOOL _IS_EXCLUSIVE_CONTENT_UNLOCKED() // Position - 0x15671
{
	int profileSetting;
...
int func_236() // Position - 0x15729
{
	return 1;
}

int func_237() // Position - 0x15732
{
	return 1;
}

void func_238(char* sParam0, int iParam1, Ped pedParam2, char* sParam3, char* sParam4, char* sParam5, char* sParam6, int iParam7, int iParam8, int iParam9) // Position - 0x1573B
{
	var unk;
...
struct<14> func_239(Hash hParam0, int iParam1, int iParam2, Hash hParam3) // Position - 0x159F1
{
	func_288();
...
void func_240(int iParam0, int iParam1, Hash hParam2) // Position - 0x15A32
{
	switch (iParam0)
	{
		case 2:
...
void func_241(int iParam0) // Position - 0x15B3E
{
	BOOL flag;
	int num;
	var unk;
...
void func_242(int iParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, BOOL bParam7, int iParam8, int iParam9, BOOL bParam10) // Position - 0x15CF9
{
	int num;
	int num2;
...
BOOL func_243(int iParam0, int iParam1, var uParam2) // Position - 0x1609B
{
	*uParam2 = 979;
...
int func_244(int iParam0, int iParam1) // Position - 0x164A0
{
	switch (iParam1)
	{
		case 0:
...
int func_245(int iParam0, int iParam1) // Position - 0x1689B
{
	switch (iParam1)
	{
		case 0:
...
BOOL func_246(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x16C96
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
BOOL func_247(Hash hParam0, int iParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0x17B39
{
	int num;
	int num2;
	int num3;
...
BOOL func_248(Hash hParam0, int iParam1, var uParam2, var uParam3, BOOL bParam4, BOOL bParam5) // Position - 0x17B77
{
...
BOOL func_249(int iParam0) // Position - 0x1A7E0
{
	return Global_44392 == iParam0;
}

int func_250(int iParam0) // Position - 0x1A7EE
{
	switch (iParam0)
	{
		case -1:
...
void func_251(int iParam0, Hash hParam1) // Position - 0x1A8C2
{
	int num;
...
void func_252(int iParam0, int iParam1, int iParam2, Hash hParam3) // Position - 0x1A8E2
{
	int num;
	int num2;
	Hash outfit;
	...
	else if (iParam0 == 14)
	{
		...
		if (componentId >= 0)
		{
			...
			if (num5 > componentId)
			{
				...
				func_242(&Global_79551[0 /*14*/], iParam0, iParam1, &(outProp.f_9), outProp.f_3, outProp.f_4, outProp.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(outProp.f_1, joaat("OUTFIT_ONLY"), 0), num4, 2, outProp.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (hParam3 != -1 && Global_79749)
		{
			...
			func_242(&Global_79551[0 /*14*/], iParam0, iParam1, &(outComponent.f_9), outComponent.f_3, outComponent.f_4, outComponent.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(outComponent.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, outComponent.f_1 != 0);
			return;
		}
...
void func_253(int iParam0, Hash hParam1) // Position - 0x1AB69
{
	BOOL flag;
	int num;
	var unk;
...
void func_254(int iParam0, Hash hParam1) // Position - 0x1AC6C
{
	BOOL flag;
	int num;
	var unk;
...
void func_255(int iParam0, Hash hParam1) // Position - 0x1AF4B
{
	BOOL flag;
	int value;
	var unk;
...
void func_256(int iParam0, Hash hParam1) // Position - 0x1DD21
{
	BOOL flag;
	int num;
	var unk;
...
void func_257(int iParam0, Hash hParam1) // Position - 0x1DE26
{
	BOOL flag;
	int value;
	var unk;
...
void func_258(int iParam0, Hash hParam1) // Position - 0x1E602
{
	BOOL flag;
	int value;
	var unk;
...
void func_259(int iParam0, Hash hParam1) // Position - 0x1E8E7
{
	BOOL flag;
	int value;
	var unk;
...
void func_260(int iParam0, Hash hParam1) // Position - 0x1FF0E
{
	BOOL flag;
	int value;
	var unk;
...
void func_261(int iParam0, Hash hParam1) // Position - 0x2156D
{
	BOOL flag;
	int num;
	var unk;
...
void func_262(int iParam0, Hash hParam1) // Position - 0x216C8
{
	BOOL flag;
	int num;
	var unk;
...
void func_263(int iParam0, Hash hParam1) // Position - 0x21948
{
	BOOL flag;
	int value;
	var unk;
...
BOOL func_264(int iParam0, int iParam1) // Position - 0x22CEA
{
	int num;
	int num2;
...
int func_265(int iParam0) // Position - 0x22D19
{
	return iParam0 % 32;
}

int func_266(int iParam0, int iParam1) // Position - 0x22D26
{
	int num;
...
int func_267(int iParam0) // Position - 0x22D3E
{
	int num;
	int num2;
...
int func_268() // Position - 0x230B9
{
	return Global_33299;
}

int func_269(int iParam0) // Position - 0x230C4
{
	return iParam0 / 32;
}

void func_270(int iParam0, Hash hParam1) // Position - 0x230D1
{
	BOOL flag;
	int value;
	var unk;
...
void func_271(int iParam0, Hash hParam1) // Position - 0x24894
{
	BOOL flag;
	int value;
	var unk;
...
void func_272(int iParam0, int iParam1, Hash hParam2) // Position - 0x25765
{
	switch (iParam0)
	{
		case 2:
...
void func_273(int iParam0) // Position - 0x25871
{
	BOOL flag;
	int num;
	var unk;
...
void func_274(int iParam0, Hash hParam1) // Position - 0x25A3B
{
	int num;
...
void func_275(int iParam0, Hash hParam1) // Position - 0x25A5B
{
	BOOL flag;
	int num;
	var unk;
...
void func_276(int iParam0, Hash hParam1) // Position - 0x25B5E
{
	BOOL flag;
	int num;
	var unk;
...
void func_277(int iParam0, Hash hParam1) // Position - 0x25E0F
{
	BOOL flag;
	int value;
	var unk;
...
void func_278(int iParam0, Hash hParam1) // Position - 0x28BD0
{
	BOOL flag;
	int num;
	var unk;
...
void func_279(int iParam0, Hash hParam1) // Position - 0x28CF1
{
	BOOL flag;
	int value;
	var unk;
...
void func_280(int iParam0, Hash hParam1) // Position - 0x295E9
{
	BOOL flag;
	int value;
	var unk;
...
void func_281(int iParam0, Hash hParam1) // Position - 0x298A0
{
	BOOL flag;
	int value;
	var unk;
...
void func_282(int iParam0, Hash hParam1) // Position - 0x2AEDD
{
	BOOL flag;
	int value;
	var unk;
...
void func_283(int iParam0, Hash hParam1) // Position - 0x2C512
{
	BOOL flag;
	int num;
	var unk;
...
void func_284(int iParam0, Hash hParam1) // Position - 0x2C669
{
	BOOL flag;
	int num;
	var unk;
...
void func_285(int iParam0, Hash hParam1) // Position - 0x2C985
{
	BOOL flag;
	int value;
	var unk;
...
void func_286(int iParam0, Hash hParam1) // Position - 0x2EE76
{
	BOOL flag;
	int value;
	var unk;
...
void func_287(int iParam0, Hash hParam1) // Position - 0x30403
{
	BOOL flag;
	int value;
	var unk;
...
void func_288() // Position - 0x312BD
{
...
Hash func_289() // Position - 0x31336
{
	return ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID());
}

BOOL func_290(int iParam0, int iParam1) // Position - 0x31346
{
	var unk;
	var unk14;
	int num;
...
void func_291() // Position - 0x31422
{
	int num;
	int playerMaxArmour;
	int pedArmour;
...
int func_292(char* sParam0, char* sParam1, int iParam2) // Position - 0x3147B
{
	int num;
...
char* func_293(Hash hParam0, BOOL bParam1) // Position - 0x314B6
{
	var unk;
...
char* func_294(var uParam0) // Position - 0x324BB
{
	return uParam0;
}

int func_295(Hash hParam0, Any* panParam1) // Position - 0x324C5
{
	int i;
	int numDlcWeapons;
...
BOOL func_296(var uParam0, var uParam1) // Position - 0x32500
{
	BOOL flag;
...
BOOL func_297(var uParam0, int iParam1, int iParam2) // Position - 0x326C7
{
	int num;
	int num2;
...
int func_298(var uParam0) // Position - 0x326FB
{
	return func_299(uParam0);
}

int func_299(int iParam0) // Position - 0x32709
{
	switch (iParam0)
	{
		case joaat("WEAPON_UNARMED"):
...
int func_300(var uParam0, int iParam1) // Position - 0x32D59
{
	int num;
...
int func_301(var uParam0) // Position - 0x32D71
{
	int num;
	int num2;
...
BOOL func_302() // Position - 0x32E3B
{
	return Global_1575067;
}

void func_303(int iParam0, int iParam1) // Position - 0x32E47
{
	if (iParam1 > 0)
	{
...
BOOL func_304() // Position - 0x32E9C
{
...
int func_305(char* sParam0, int iParam1, int iParam2) // Position - 0x32EBB
{
	int num;
...
void func_306(var uParam0, var uParam1, var uParam2, int iParam3) // Position - 0x32EF7
{
	func_136(uParam0, iParam3, 6, 0, 0);
	return;
}

void _NETSHOPPING_PROCESS_TRANSACTION(Hash hParam0, int iParam1, var uParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5) // Position - 0x32F0C
{
	int num;
...
int func_308(var uParam0, int iParam1, Hash hParam2, Hash hParam3, Hash hParam4, int iParam5, int iParam6, int iParam7) // Position - 0x338A3
{
	BOOL flag;
	BOOL flag2;
	int i;
...
void func_309(int iParam0, Hash hParam1, int iParam2, int iParam3, int iParam4) // Position - 0x33A50
{
	switch (hParam1)
	{
		case joaat("SERVICE_SPEND_BETTING"):
...
void func_310(int iParam0) // Position - 0x33A88
{
	BOOL flag;
...
void func_311(var uParam0) // Position - 0x33ADC
{
	uParam0->f_65 = 0;
...
void func_312(var uParam0) // Position - 0x33BE3
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
BOOL func_313(int iParam0) // Position - 0x33C2B
{
...
void func_314(int iParam0, Hash hParam1) // Position - 0x33C56
{
...
int func_315(int iParam0, int iParam1, Hash hParam2, Hash hParam3, Hash hParam4, int iParam5, BOOL bParam6, int iParam7, int iParam8, int iParam9, BOOL bParam10) // Position - 0x33C6A
{
	int i;
...
int func_317(Player plParam0) // Position - 0x33E2A
{
	int address;
...
BOOL _NETSHOPPING_SHOULD_USE_TRANSACTION_SYSTEM() // Position - 0x33E45
{
...
void func_319(var uParam0, int iParam1) // Position - 0x33E5C
{
	int num;
...
void func_320(Player plParam0, int iParam1, int iParam2) // Position - 0x33EFC
{
	Hash eventData;
...
void func_321(var uParam0, var uParam1) // Position - 0x33F54
{
...
var func_322(Player plParam0) // Position - 0x33F6E
{
	return Global_1888882[plParam0 /*611*/].f_513;
}

void func_323(int iParam0) // Position - 0x33F82
{
	int num;
	int offset;
...
int func_324(char* sParam0, Player plParam1, int iParam2, eHudColour ehcParam3, BOOL bParam4, BOOL bParam5) // Position - 0x33FAB
{
	int num;
	var unk;
...
const char* func_325(char* sParam0) // Position - 0x34043
{
	var unk;
...
const char* func_326(var uParam0) // Position - 0x34067
{
	return uParam0;
}

eHudColour func_327(Player plParam0, int iParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x34071
{
	int playerTeam;
	Ped ped;
...
eHudColour func_328(BOOL bParam0, int iParam1, BOOL bParam2) // Position - 0x3425C
{
	return func_329(PLAYER::PLAYER_ID(), bParam0, iParam1, bParam2);
}

int func_329(Player plParam0, BOOL bParam1, int iParam2, BOOL bParam3) // Position - 0x34272
{
	int playerTeam;
...
int func_330(int iParam0, int iParam1, BOOL bParam2, int iParam3) // Position - 0x34374
{
	int num;
...
BOOL func_331(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x3448D
{
	int i;
...
int func_332(int iParam0, int iParam1, int iParam2) // Position - 0x344F9
{
	int i;
	int num;
...
int func_333(BOOL bParam0) // Position - 0x34541
{
	if (bParam0)
		return 118;
...
int func_334(int iParam0, int iParam1) // Position - 0x34558
{
	if (iParam0 == -1)
...
BOOL func_335() // Position - 0x345A6
{
	if (func_336())
		return true;
...
BOOL func_336() // Position - 0x345C5
{
	return IS_BIT_SET(*Global_4718592.f_190071, 12);
}

BOOL func_337() // Position - 0x345DA
{
	if (NETWORK::NETWORK_IS_ACTIVITY_SESSION())
...
BOOL func_338() // Position - 0x34621
{
...
eHudColour func_339(Player plParam0, Player plParam1, int iParam2, BOOL bParam3, BOOL bParam4) // Position - 0x3463E
{
	int playerTeam;
	BOOL flag;
	Player player;
...
int func_340(BOOL bParam0) // Position - 0x347D6
{
	if (bParam0)
		return 119;
...
BOOL func_341(Player plParam0, Player plParam1, int iParam2, int iParam3) // Position - 0x347ED
{
	if (iParam2 == -2)
	{
		if (iParam3 == 0)
...
int func_342(int iParam0) // Position - 0x34865
{
	int num;
...
var func_343(int iParam0) // Position - 0x34928
{
	return Global_2648932.f_818.f_44[iParam0 /*2*/].f_1;
}

int func_344(Player plParam0) // Position - 0x3493F
{
	if (func_27(plParam0))
...
BOOL func_345(Player plParam0, BOOL bParam1) // Position - 0x3496F
{
	if (!func_27(plParam0))
		return false;
...
BOOL func_346(Player plParam0) // Position - 0x349A7
{
	if (func_27(plParam0))
...
BOOL func_347() // Position - 0x349DC
{
...
BOOL func_348() // Position - 0x34A58
{
	return func_349(*Global_4718592.f_138116);
}

BOOL func_349(int iParam0) // Position - 0x34A6E
{
	int i;
...
int func_350(int iParam0) // Position - 0x34AA2
{
	if (iParam0 != -1)
...
BOOL func_351() // Position - 0x34AC1
{
	return func_352(*Global_4718592.f_138116);
}

BOOL func_352(int iParam0) // Position - 0x34AD7
{
	int i;
...
int func_353(int iParam0) // Position - 0x34B0B
{
	if (iParam0 != -1)
...
BOOL func_354() // Position - 0x34B2A
{
	return func_355(*Global_4718592.f_138116);
}

BOOL func_355(int iParam0) // Position - 0x34B40
{
	int i;
...
BOOL func_356() // Position - 0x34B79
{
	return func_357(*Global_4718592.f_138116);
}

BOOL func_357(int iParam0) // Position - 0x34B8F
{
	int i;
...
BOOL func_358() // Position - 0x34BC9
{
	return Global_2684748.f_24;
}

BOOL func_359() // Position - 0x34BD7
{
	return Global_2684748.f_21;
}

var func_360() // Position - 0x34BE5
{
	return Global_2684748.f_18;
}

var func_361() // Position - 0x34BF3
{
	return Global_2684748.f_17;
}

eHudColour func_362(int iParam0, Player plParam1, BOOL bParam2) // Position - 0x34C01
{
	int num;
	int num2;
	int num3;
...
int func_363(int iParam0) // Position - 0x34D81
{
	int num;
...
Ped func_364() // Position - 0x34E56
{
	return Global_2621446.f_2;
}

BOOL func_365() // Position - 0x34E64
{
	return IS_BIT_SET(Global_2621446, 4);
}

BOOL func_366() // Position - 0x34E72
{
	return IS_BIT_SET(Global_1845274[PLAYER::PLAYER_ID() /*877*/].f_36.f_18, 14);
}

BOOL func_367(Player plParam0) // Position - 0x34E8C
{
...
BOOL func_368() // Position - 0x34ECB
{
	return IS_BIT_SET(Global_2621446, 3);
}

void func_369(var uParam0, BOOL bParam1) // Position - 0x34ED9
{
	int num;
	int num2;
...
int func_370(BOOL bParam0) // Position - 0x34F0B
{
	if (bParam0)
...
int func_371() // Position - 0x34F31
{
	return Global_262145.f_12846;
}

Player _GET_BOSS_OF_LOCAL_PLAYER() // Position - 0x34F40
{
	return Global_1888882[PLAYER::PLAYER_ID() /*611*/].f_10;
}

BOOL func_373(BOOL bParam0) // Position - 0x34F55
{
	return func_374(PLAYER::PLAYER_ID(), bParam0);
}

BOOL func_374(Player plParam0, BOOL bParam1) // Position - 0x34F67
{
	return func_375(plParam0, bParam1, 1);
}

int func_375(Player plParam0, BOOL bParam1, int iParam2) // Position - 0x34F78
{
	Player player;
...
BOOL func_376(Player plParam0, int iParam1) // Position - 0x34FD4
{
	if (func_27(plParam0))
		if (func_27(Global_1888882[plParam0 /*611*/].f_10))
...
BOOL func_377(BOOL bParam0) // Position - 0x35023
{
	return func_345(PLAYER::PLAYER_ID(), bParam0);
}

BOOL func_378() // Position - 0x35035
{
	return func_346(PLAYER::PLAYER_ID());
}

int func_379(int iParam0, int iParam1) // Position - 0x35045
{
	float value;
...
void func_380(int iParam0) // Position - 0x35086
{
	Global_2672967.f_1760 = iParam0;
	return;
}

void func_381(Hash hParam0, int iParam1, int iParam2) // Position - 0x35097
{
	int ammo;
	int ammo2;
	int num;
...
void func_382(Ped pedParam0, int iParam1) // Position - 0x350F8
{
	var unk;
	int i;
	int num;
...
Hash func_383(Ped pedParam0) // Position - 0x35214
{
	var weaponHash;
...
void func_384() // Position - 0x35228
{
	return;
}

void func_385() // Position - 0x35230
{
	if (_NETWORK_IS_PLAYER_VALID(PLAYER::PLAYER_ID(), true, true))
	{
...
void _DISPLAY_HELP_TEXT(char* text, int iParam1) // Position - 0x352D7
{
...
int _THEFEED_SHOW_MESSAGE(char* sParam0, BOOL bParam1) // Position - 0x353A6
{
	int num;
	int num2;
...
BOOL func_393() // Position - 0x353DE
{
	return Global_1575088;
}

BOOL func_394(int iParam0) // Position - 0x353EA
{
	return MISC::ABSI(NETWORK::GET_TIME_DIFFERENCE(Global_2644871, NETWORK::GET_NETWORK_TIME())) > iParam0;
}

BOOL func_395(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x35405
{
	int num;
	int num2;
...
BOOL func_396() // Position - 0x35586
{
	int num;
...
BOOL func_397() // Position - 0x355E3
{
	return Global_1575076;
}

BOOL func_398() // Position - 0x355EF
{
	return Global_1575078;
}

BOOL func_399(Player plParam0, int iParam1) // Position - 0x355FB
{
	if (!func_403())
		return false;
...
BOOL func_400(var uParam0, int iParam1) // Position - 0x3563B
{
	int num;
	int num2;
	int num3;
...
int func_401(int iParam0) // Position - 0x3565E
{
	switch (iParam0)
	{
		case 86:
...
BOOL func_404() // Position - 0x35882
{
	if (Global_1574612)
		return true;
...
BOOL func_405(int iParam0, int iParam1) // Position - 0x358B2
{
	Hash statHash;
	BOOL outValue;
...
Hash func_406(int iParam0, int iParam1) // Position - 0x358D6
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(2, iParam0, func_156(iParam1));
}

BOOL func_407(BOOL bParam0) // Position - 0x358EB
{
	if (bParam0)
		return func_410();
...
BOOL func_408(int iParam0) // Position - 0x35907
{
	return iParam0 > 0 && iParam0 < 6;
}

int func_409() // Position - 0x3591C
{
	return Global_1908496[PLAYER::PLAYER_ID() /*313*/].f_273;
}

BOOL func_410() // Position - 0x35932
{
	return func_405(526, -1) || unk_0xB233964AC562A357() && func_412() != 0 && !func_411(0);
}

BOOL func_411(int iParam0) // Position - 0x35962
{
	int num;
...
int func_412() // Position - 0x35979
{
	return unk_0xA0A0D77ECEDD4136();
}

void func_413() // Position - 0x35985
{
...
BOOL func_414(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x35A4A
{
	return func_415(2, iParam0, true, bParam1, bParam2);
}

BOOL func_415(int iParam0, int iParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x35A5E
{
	int num;
	int num2;
...
int func_416(int iParam0) // Position - 0x35B24
{
	switch (iParam0)
	{
		case 0:
...
int func_417(int iParam0) // Position - 0x35B5E
{
	switch (iParam0)
	{
		case 0:
...
int func_418(int iParam0, BOOL bParam1) // Position - 0x35BA4
{
	Player player;
...
int func_419(int iParam0) // Position - 0x35C41
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_420(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x35C81
{
	return func_415(0, iParam0, true, bParam1, bParam2);
}

BOOL func_421(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x35C95
{
	return func_415(1, iParam0, true, bParam1, bParam2);
}

int func_422() // Position - 0x35CA9
{
	return iLocal_96;
}

int func_423(int iParam0) // Position - 0x35CB3
{
	return uLocal_286[iParam0 /*4*/];
}

void func_424() // Position - 0x35CC2
{
...
BOOL func_425(Player plParam0) // Position - 0x35D69
{
	return func_426(plParam0);
}

BOOL func_426(Player plParam0) // Position - 0x35D77
{
	return IS_BIT_SET(Global_1845274[plParam0 /*877*/].f_11.f_1, 0);
}

BOOL func_427(Player plParam0) // Position - 0x35D8E
{
...
int func_428(Player plParam0) // Position - 0x35DFA
{
	return Global_1845274[plParam0 /*877*/].f_185;
}

BOOL func_429(int iParam0) // Position - 0x35E0D
{
	return !func_430(iParam0);
}

BOOL func_430(int iParam0) // Position - 0x35E1C
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_431(int iParam0) // Position - 0x36150
{
	int i;
...
BOOL _SHOULD_NETWORK_SCRIPT_TERMINATE() // Position - 0x36193
{
...
Hash _GET_CURRENT_SESSION_TYPE_SCRIPT_HASH() // Position - 0x36217
{
	switch (func_123())
	{
		case 0:
...
Hash func_434() // Position - 0x3624A
{
...
BOOL func_435() // Position - 0x3626E
{
	return Global_2684748.f_700;
}

BOOL _DOES_EVENT_OF_TYPE_EXIST(int iParam0) // Position - 0x3627D
{
...
BOOL func_437() // Position - 0x36294
{
	return Global_2696555;
}

BOOL func_438() // Position - 0x362A0
{
	return Global_2684748.f_695;
}

void func_439() // Position - 0x362AF
{
	SYSTEM::WAIT(0);
	return;
}

void func_440() // Position - 0x362BC
{
	int i;
...
void func_441() // Position - 0x36402
{
	SCRIPT::TERMINATE_THIS_THREAD();
	return;
}

BOOL _IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(char* message) // Position - 0x3640E
{
	HUD::BEGIN_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(message);
	return HUD::END_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(0);
}

void func_443(float fParam0, float fParam1, float fParam2, char* sParam3, BOOL bParam4) // Position - 0x36421
{
	int i;
...
char* func_444(int iParam0) // Position - 0x364C1
{
	iParam0 == iParam0;
	return "";
}

void func_445(int iParam0, BOOL bParam1) // Position - 0x364D3
{
	if (bParam1)
...
void func_446(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17, var uParam18, var uParam19, var uParam20) // Position - 0x36530
{
	func_451(32, uParam0);
...
void func_447() // Position - 0x365BA
{
	int i;
	int endRange;
	int randomIntInRange;
...
BOOL func_448(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, BOOL bParam7) // Position - 0x368BC
{
	if (fParam6 < 0f)
		fParam6 = 0f;
...
BOOL func_449() // Position - 0x36937
{
	var unk;
...
int _NETWORK_ENSURE_SCRIPT_IS_NETWORKED(int iParam0, int iParam1, BOOL bNoTerminate) // Position - 0x36995
{
	int i;
...
void func_451(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17, var uParam18, var uParam19, var uParam20, var uParam21) // Position - 0x36AAB
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		func_441();
...
BOOL _NETWORK_IS_PLAYER_VALID(Player player, BOOL bIsPlaying, BOOL bUnk) // Position - 0x36ACA
{
	Player player;
