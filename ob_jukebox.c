...
void main() // Position - 0x0
{
	...
	iLocal_144 = Global_1845274[PLAYER::PLAYER_ID() /*877*/].f_260.f_36;
	...
	if (IS_GAMER_HANDLE_VALID(gamerHandle))
		if (NETWORK::NETWORK_IS_GAMER_IN_MY_SESSION(&gamerHandle))
			plLocal_140 = NETWORK::NETWORK_GET_PLAYER_FROM_GAMER_HANDLE(&gamerHandle);

	if (iLocal_144 == 126)
	{
		plLocal_140 = func_229(PLAYER::PLAYER_ID());
	...
	else if (iLocal_144 == 130)
	{
		plLocal_140 = func_229(PLAYER::PLAYER_ID());
	}

	if (plLocal_140 == _INVALID_PLAYER_INDEX())
		func_253(false);
	...
	if (NETWORK::NETWORK_IS_HOST_OF_THIS_SCRIPT())
	{
		if (iLocal_144 == 126)
		{
			if (Global_1845274[plLocal_140 /*877*/].f_260.f_389 > iLocal_153)
				Global_1845274[plLocal_140 /*877*/].f_260.f_389 = iLocal_153;
		
			if (Global_1845274[plLocal_140 /*877*/].f_260.f_389 != iLocal_153 && func_225(plLocal_140))
			{
				func_221(Global_1845274[plLocal_140 /*877*/].f_260.f_389);
				func_216(true);
				iLocal_173.f_1 = 0.5f;
				iLocal_173 = 1;
		...
		{
			if (Global_1845274[plLocal_140 /*877*/].f_260.f_390 > iLocal_153)
				Global_1845274[plLocal_140 /*877*/].f_260.f_390 = iLocal_153;
		
			if (Global_1845274[plLocal_140 /*877*/].f_260.f_390 != iLocal_153)
			{
				func_221(Global_1845274[plLocal_140 /*877*/].f_260.f_390);
				func_216(true);
				iLocal_173.f_1 = 0.5f;
				iLocal_173 = 1;
				iLocal_173.f_3 = iLocal_141;
		...
		{
			if (Global_1845274[plLocal_140 /*877*/].f_260.f_386 > iLocal_153)
				Global_1845274[plLocal_140 /*877*/].f_260.f_386 = iLocal_153;
		
			if (Global_1845274[plLocal_140 /*877*/].f_260.f_386 != iLocal_153)
			{
				func_221(Global_1845274[plLocal_140 /*877*/].f_260.f_386);
				func_216(true);
				iLocal_173 = 1;
				iLocal_173.f_3 = iLocal_141;
				func_215();
	...
	while (true)
	{
		...
		else if (iLocal_144 != -1 && iLocal_144 <= 131)
		{
			uLocal_163 = { func_1() };
...
{
	if (func_6(iLocal_144, -1))
		return func_4(iLocal_144);
	else if (iLocal_144 == 126)
		return func_3();
	else if (iLocal_144 == 130)
		return func_2();
...
{
	if (plLocal_140 == PLAYER::PLAYER_ID() && func_214())
	{
		if (!_STOPWATCH_IS_INITIALIZED(&uLocal_161))
		{
			_STOPWATCH_INITIALIZE(&uLocal_161, false, false);
		}
		else if (_STOPWATCH_HAS_TIME_PASSED(&uLocal_161, 180000, false))
		{
			func_9(iLocal_141);
			_STOPWATCH_RESET(&uLocal_161, false, false);
		}
	}
...
void func_25() // Position - 0xE5A
{
	...
	if (iLocal_173.f_3 != iLocal_141)
	{
		...
		if (plLocal_140 == PLAYER::PLAYER_ID() && iLocal_173.f_4)
		{
			if (iLocal_144 == 126)
			{
				func_26(26808, iLocal_141, -1);
				Global_1845274[plLocal_140 /*877*/].f_260.f_389 = iLocal_141;
			}
			else if (iLocal_144 == 130)
			{
				func_26(41216, iLocal_141, -1);
				Global_1845274[plLocal_140 /*877*/].f_260.f_390 = iLocal_141;
			}
			else
			{
				func_26(9355, iLocal_141, -1);
				Global_1845274[plLocal_140 /*877*/].f_260.f_386 = iLocal_141;
			}
		}
	}
	...
	if (IS_BIT_SET(iLocal_149, 6) != flag)
	{
		...
		if (plLocal_140 == PLAYER::PLAYER_ID() && iLocal_173.f_4 && !flag)
		{
			if (iLocal_144 == 126)
			{
				func_26(26808, iLocal_153, -1);
				Global_1845274[plLocal_140 /*877*/].f_260.f_389 = iLocal_153;
			}
			else if (iLocal_144 == 130)
			{
				func_26(41216, iLocal_153, -1);
				Global_1845274[plLocal_140 /*877*/].f_260.f_390 = iLocal_153;
			}
			else
			{
				func_26(9355, iLocal_153, -1);
				Global_1845274[plLocal_140 /*877*/].f_260.f_386 = iLocal_153;
			}
		}
	}
	...
	switch (iLocal_156)
	{
		case 0:
			if (func_203() && func_202())
			{
				...
				{
					func_196(2);
					_CONTEXT_REMOVE_HELP_TEXT(&iLocal_146);
		...
		case 4:
			...
			else if (PED::GET_SYNCHRONIZED_SCENE_PHASE(localSceneFromNetworkId) >= 0.96f)
			{
				...
				if (iLocal_144 == 126)
					iLocal_152 = Global_1845274[plLocal_140 /*877*/].f_260.f_389;
				else if (iLocal_144 == 130)
					iLocal_152 = Global_1845274[plLocal_140 /*877*/].f_260.f_390;
				else
					iLocal_152 = Global_1845274[plLocal_140 /*877*/].f_260.f_386;
			
				if (iLocal_152 == iLocal_153)
					iLocal_152 = -1;
			
				STATS::PLAYSTATS_MC_CLUBHOUSE_ACTIVITY(func_50(_GET_BOSS_OF_LOCAL_PLAYER()), func_49(_GET_BOSS_OF_LOCAL_PLAYER()), func_48(), func_47(), 4, iLocal_152, 0, func_28());
				func_196(0);
			}
			break;
	}
...
int func_44(Player plParam0) // Position - 0x29C0
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
...
BOOL func_45() // Position - 0x2A2F
{
	return func_46() != -1;
}

int func_46() // Position - 0x2A3D
{
	return Global_2658019[PLAYER::PLAYER_ID() /*467*/].f_324.f_8;
}

int func_47() // Position - 0x2A55
{
...
int func_49(Player plParam0) // Position - 0x2A8D
{
	if (plParam0 == _INVALID_PLAYER_INDEX())
		return -1;
...
int func_50(Player plParam0) // Position - 0x2AB2
{
	if (plParam0 == _INVALID_PLAYER_INDEX())
		return -1;
...
Player _GET_BOSS_OF_LOCAL_PLAYER() // Position - 0x2AD7
{
	return Global_1888882[PLAYER::PLAYER_ID() /*611*/].f_10;
}

void func_52(int iParam0) // Position - 0x2AEC
{
	uLocal_178[PLAYER::PLAYER_ID() /*3*/].f_1 = iParam0;
	MISC::SET_BIT(&uLocal_178[PLAYER::PLAYER_ID() /*3*/], 2);
	return;
}

int func_53(BOOL bParam0) // Position - 0x2B0D
{
	if (!bParam0)
		iLocal_147 = 1;
...
void func_54(int iParam0) // Position - 0x2B75
{
	if (func_60())
		return;
...
void func_55(int iParam0) // Position - 0x2BA8
{
	if (func_60())
		return;
...
void func_57(BOOL bParam0, BOOL bParam1) // Position - 0x2C59
{
	if (bParam0)
	{
		if (func_59(0))
...
BOOL func_58() // Position - 0x2CCD
{
	return IS_BIT_SET(Global_1960332, 5);
}

BOOL func_59(int iParam0) // Position - 0x2CDB
{
	if (iParam0 == 1)
...
BOOL func_60() // Position - 0x2D32
{
	return IS_BIT_SET(Global_1960332, 19);
}

BOOL func_61(char* sParam0, BOOL bParam1, BOOL bParam2) // Position - 0x2D41
{
	int localSceneFromNetworkId;
...
void func_62(BOOL bParam0, int iParam1) // Position - 0x2DD9
{
	int num;
...
void func_63(int* piParam0) // Position - 0x2E9F
{
	if (piParam0->f_9 != 0)
	{
...
BOOL func_64(var uParam0, BOOL bParam1, int iParam2) // Position - 0x2ECB
{
	var unk;
	Hash hashKey;
	int i;
...
void func_67(BOOL bParam0, int iParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, int iParam5, BOOL bParam6, BOOL bParam7, int iParam8) // Position - 0x2FE2
{
	int num;
	int r;
	int g;
	...
	if (bParam3)
	{
		...
		{
			func_103(Global_24148.f_5821 + 1, "DFLT_MNU_OPT" /*Exit*/, 0, true, 0, false, 0);
	...
	for (i = 0; i < 2; i = i + 1)
	{
		if (i == 1 && Global_24148.f_6331)
		{
			...
			if (MISC::GET_HASH_KEY(&(Global_24148.f_&func_33)) != 0 && Global_24148.f_5323 != -1)
			{
				...
				func_92(x);
				HUD::BEGIN_TEXT_COMMAND_GET_NUMBER_OF_LINES_FOR_STRING(&(Global_24148.f_&func_33));
				num7 = 0;
				num8 = 0;
				num9 = 0;
				...
				func_92(x);
				HUD::BEGIN_TEXT_COMMAND_DISPLAY_TEXT(&(Global_24148.f_&func_33));
				num7 = 0;
				num8 = 0;
				num9 = 0;
				...
				if (Global_24148.f_5323 > 0)
				{
					...
					{
						TEXT_LABEL_ASSIGN_STRING(&(Global_24148.f_&func_33), "", 24);
		...
		if (i == 1 || !Global_24148.f_6331)
		{
			...
			for (j = 0; j <= num43; j = j + 1)
			{
				...
				if (flag && i == 1 && flag2)
				{
					...
					func_97("CommonMenu", "Gradient_Nav", Global_24145 + (iParam5 * 0.5f), num40 + num45 + (0.00277776f * (float)num5) + (num37 * 0.5f), iParam5, num37, 0f, r2, g2, b2, a2, false, 0);
								...
								if (flag2)
								{
									if (!Global_24148.f_6332)
									{
										...
										if (MISC::GET_HASH_KEY(&Global_24148.f_79[num16 /*6*/]) != 0)
										{
											...
											func_80(flag, Global_24148.f_1616[num16], Global_24148.f_1873[num16], flag7, num46, flag5, flag4);
...
void func_68(int iParam0) // Position - 0x61A0
{
	Global_1675455.f_1163 = iParam0;
	return;
}

float func_69(int iParam0) // Position - 0x61B1
{
	switch (iParam0)
	{
		case 36:
...
void func_70(float fParam0, float fParam1, char* sParam2, float fParam3, int iParam4) // Position - 0x6220
{
...
float func_71(float fParam0) // Position - 0x6243
{
	fParam0 = fParam0 * func_72();
	return fParam0;
}

float func_72() // Position - 0x6256
{
	return 1.7777778f / func_73();
}

float func_73() // Position - 0x6268
{
	return Global_24148.f_9149;
}

void func_74(float fParam0, float fParam1, char* sParam2, int iParam3, int iParam4) // Position - 0x6276
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_TEXT(sParam2);
...
BOOL IS_ROCKSTAR_DEV() // Position - 0x6298
{
	return DLC::IS_DLC_PRESENT(-1762644250);
}

void func_76(BOOL bParam0) // Position - 0x62A9
{
	int r;
	int g;
	int b;
...
float func_77(BOOL bParam0) // Position - 0x62EF
{
	return func_78(HUD::END_TEXT_COMMAND_GET_SCREEN_WIDTH_OF_DISPLAY_TEXT(bParam0));
}

float func_78(float fParam0) // Position - 0x6301
{
	fParam0 = fParam0 * func_79();
	return fParam0;
}

float func_79() // Position - 0x6314
{
	return func_73() / 1.7777778f;
}

void func_80(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, int iParam4, BOOL bParam5, BOOL bParam6) // Position - 0x6326
{
	int r;
	int g;
	int b;
...
void func_81(float fParam0, float fParam1) // Position - 0x64D4
{
	HUD::SET_TEXT_WRAP(func_71(fParam0), func_71(fParam1));
	return;
}

void func_82(int iParam0, var uParam1, var uParam2, var uParam3) // Position - 0x64EC
{
	switch (iParam0)
	{
		case 0:
...
void func_83(var uParam0, int iParam1, int iParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, int iParam7, BOOL bParam8) // Position - 0x6776
{
	int num;
	int i;
	int j;
...
void func_84(char* sParam0) // Position - 0x6C7B
{
...
void func_85(char* sParam0) // Position - 0x6C8D
{
	GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_PLAYER_NAME_STRING(sParam0);
	return;
}

BOOL func_86(Player plParam0, int iParam1) // Position - 0x6C9B
{
	BOOL flag;
...
int func_87(int iParam0, BOOL bParam1) // Position - 0x6CF4
{
	int num;
	int num2;
...
BOOL func_88(Player plParam0) // Position - 0x6D35
{
	Player player;
...
void func_91(int iParam0, BOOL bParam1, int* piParam2, int* piParam3, int* piParam4, int* piParam5) // Position - 0x6DDF
{
...
void func_92(float fParam0) // Position - 0x6F1B
{
	int r;
	int g;
	int b;
...
void func_93(float fParam0, float fParam1, char* sParam2, int iParam3, int iParam4) // Position - 0x6F7A
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_TEXT(sParam2);
	HUD::ADD_TEXT_COMPONENT_INTEGER(iParam3);
...
float func_94(char* sParam0, int iParam1, int iParam2) // Position - 0x6FA1
{
...
void func_95(float fParam0, float fParam1, int iParam2) // Position - 0x6FE3
{
	HUD::END_TEXT_COMMAND_DISPLAY_TEXT(func_71(fParam0), fParam1, iParam2);
	return;
}

void func_96() // Position - 0x6FF9
{
	int r;
	int g;
	int b;
...
void func_97(char* sParam0, char* sParam1, float fParam2, float fParam3, float fParam4, float fParam5, float fParam6, int iParam7, int iParam8, int iParam9, int iParam10, BOOL bParam11, int iParam12) // Position - 0x7083
{
...
void func_98(float fParam0, float fParam1, int iParam2, float fParam3, int iParam4, int iParam5, int iParam6, int iParam7) // Position - 0x70B1
{
...
char* func_99(int iParam0, BOOL bParam1) // Position - 0x70E8
{
	var unk;
	var txdName;
	var netHandle;
...
char* func_100(char* sParam0) // Position - 0x7618
{
	return sParam0;
}

struct<13> GET_GAMER_HANDLE_PLAYER(Player plParam0) // Position - 0x7622
{
	var gamerHandle;
...
char* func_102(int iParam0) // Position - 0x7639
{
	var txdName;
	var netHandle;
...
void func_103(int iParam0, char* sParam1, int iParam2, BOOL bParam3, int iParam4, BOOL bParam5, int iParam6) // Position - 0x76AE
{
	int num;
	float num2;
	float num3;
...
float func_104(char* sParam0) // Position - 0x78CA
{
	!HUD::DOES_TEXT_LABEL_EXIST(sParam0);
	return HUD::GET_RENDERED_CHARACTER_HEIGHT(0.35f, 0);
}

float func_105(char* sParam0) // Position - 0x78E6
{
	if (!MISC::IS_STRING_NULL(sParam0))
		if (MISC::GET_HASH_KEY(sParam0) == 0)
			return 0f;
...
void func_106(int iParam0, BOOL bParam1) // Position - 0x7923
{
	int num;
...
void func_107(BOOL bParam0, int* piParam1, int* piParam2, var uParam3) // Position - 0x796F
{
	float num;
	float value;
	float aspectRatio;
...
BOOL func_108(int iParam0, int iParam1) // Position - 0x79F7
{
	return SYSTEM::TO_FLOAT(iParam0) / SYSTEM::TO_FLOAT(iParam1) > 3.5f;
}

BOOL func_109(int iParam0, BOOL bParam1, BOOL bParam2, var uParam3, var uParam4, BOOL bParam5) // Position - 0x7A12
{
	var textureDict;
	var textureName;
	int num;
...
float func_110(int iParam0) // Position - 0x7B3E
{
	switch (iParam0)
	{
		case 34:
...
BOOL func_111(BOOL bParam0, BOOL bParam1) // Position - 0x7C18
{
	if (Global_2672967.f_1761.f_701 != 0)
		return true;

	if (!CAM::IS_SCREEN_FADED_IN() || func_113(8, -1) && func_112() != 65 || HUD::GET_PAUSE_MENU_STATE() != 0 && !bParam1 || STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS() && !bParam0 || NETWORK::IS_COMMERCE_STORE_OPEN() || Global_80029 || Global_24148.f_9147 || HUD::IS_WARNING_MESSAGE_ACTIVE() || Global_101969.f_1490)
		return false;

	return true;
}

int func_112() // Position - 0x7CB5
{
	return Global_1575016;
}

BOOL func_113(int iParam0, int iParam1) // Position - 0x7CC1
{
	switch (iParam0)
	{
		case 5:
...
void func_116(char* sParam0, int iParam1, int iParam2) // Position - 0x7DA3
{
	int i;

	TEXT_LABEL_ASSIGN_STRING(&(Global_24148.f_&func_33), sParam0, 24);
...
void func_117() // Position - 0x7E08
{
	var unk;

	if (iLocal_143 == iLocal_153)
	{
		func_116("JBOX_TOFF" /*Turn the jukebox off.*/, 0, 0);
	}
	else if (iLocal_143 == iLocal_173.f_3 && func_214())
	{
	...
	else
	{
		...
		if (iLocal_144 != 126 && iLocal_144 != 130 && iLocal_143 >= 4)
			TEXT_LABEL_APPEND_INT(&unk, iLocal_143 + 5, 16);
		else
			TEXT_LABEL_APPEND_INT(&unk, iLocal_143, 16);
	
		if (iLocal_143 == iLocal_153 - 1)
			if (plLocal_140 != PLAYER::PLAYER_ID())
...
BOOL _STAT_GET_PACKED_BOOL(int iParam0, int iParam1) // Position - 0x7F44
{
	if (iParam1 == -1)
		iParam1 = func_19();
...
void func_120() // Position - 0x7F60
{
	func_116("JBOX_TOFF_NM" /*You need $1 in cash to use the jukebox.*/, 0, 0);
	return;
}

void func_121(int iParam0, BOOL bParam1, int iParam2) // Position - 0x7F72
{
	int i;
	int num;
...
void func_124(eControlAction ecaParam0, char* sParam1, int iParam2, BOOL bParam3) // Position - 0x8148
{
...
void func_125(char* sParam0) // Position - 0x81FD
{
...
void func_126(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4) // Position - 0x8223
{
...
void func_127(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4) // Position - 0x82CD
{
...
void func_128(char* sParam0) // Position - 0x830C
{
	int i;
...
void func_129(BOOL bParam0, BOOL bParam1) // Position - 0x8357
{
	int i;
	int j;
	float aspectRatio;
...
float func_130(BOOL bParam0) // Position - 0x8839
{
	float aspectRatio;
...
void func_131() // Position - 0x8864
{
	...
	for (i = 0; i < num; i = i + 1)
	{
		...
		if (iLocal_144 != 126 && iLocal_144 != 130 && i >= 4)
	...
	if (iLocal_144 == 126 && func_214())
		func_132(8, "HUD_INPUT77" /*Change Volume*/, -1);

	return;
}

void func_132(int iParam0, char* sParam1, int iParam2) // Position - 0x8956
{
...
BOOL func_133(int iParam0) // Position - 0x8A06
{
	if (plLocal_140 != PLAYER::PLAYER_ID() || !func_118() && iParam0 == iLocal_153 - 1)
		return true;

	return false;
}

int func_134() // Position - 0x8A34
{
	if (iLocal_144 == 126 || iLocal_144 == 130)
		return 20;

	return 15;
}

void func_135() // Position - 0x8A56
{
	func_125("JBOX_MENU_T" /*JUKEBOX*/);
...
BOOL func_136(char* sParam0, int iParam1, BOOL bParam2) // Position - 0x8A94
{
	int num;
	BOOL flag;
	BOOL flag2;
...
BOOL func_137(int* piParam0) // Position - 0x8BA2
{
	switch (piParam0->f_9)
	{
		case 0:
...
void func_138() // Position - 0x8C44
{
	...
	if (!IS_BIT_SET(iLocal_149, 0))
	{
		...
		{
			_STOPWATCH_INITIALIZE(&uLocal_157, false, false);
			MISC::SET_BIT(&iLocal_149, 0);
		}
	}
	else if (_STOPWATCH_HAS_TIME_PASSED(&uLocal_157, num, false))
	{
	...
	if (isControlJustPressed)
	{
		...
		switch (iLocal_155)
		{
			case 1:
				iLocal_155 = 0;
				iLocal_143 = 0;
				iLocal_142 = iLocal_153;
				func_196(4);
				MISC::CLEAR_BIT(&iLocal_149, 5);
				break;
		
			case 0:
				if (iLocal_143 != iLocal_173.f_3 || !func_214() && !func_133(iLocal_143))
				{
					iLocal_142 = iLocal_143;
					iLocal_155 = 2;
					iLocal_143 = 0;
					MISC::SET_BIT(&iLocal_149, 1);
...
void func_139(int iParam0) // Position - 0x8F1C
{
	Hash hashKey;
	int num;
...
void _NETSHOPPING_PROCESS_TRANSACTION(Hash hParam0, int iParam1, var uParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5) // Position - 0x8F9F
{
	int num;
...
int func_141(var uParam0, int iParam1, Hash hParam2, Hash hParam3, Hash hParam4, int iParam5, int iParam6, int iParam7) // Position - 0x9936
{
	BOOL flag;
	BOOL flag2;
	int i;
...
void func_142(int iParam0, Hash hParam1, int iParam2, int iParam3, int iParam4) // Position - 0x9AE3
{
	switch (hParam1)
	{
		case joaat("SERVICE_SPEND_BETTING"):
...
void func_143(int iParam0) // Position - 0x9B1B
{
	BOOL flag;
...
void func_144(Hash hParam0) // Position - 0x9B6F
{
	hParam0->f_65 = 0;
...
void func_145(var uParam0) // Position - 0x9C7A
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
BOOL func_146(int iParam0) // Position - 0x9CC2
{
...
void func_147(int iParam0, Hash hParam1) // Position - 0x9CED
{
...
int func_148(int iParam0, int iParam1, Hash hParam2, Hash hParam3, Hash hParam4, int iParam5, BOOL bParam6, int iParam7, int iParam8, int iParam9, BOOL bParam10) // Position - 0x9D01
{
	int i;
...
int func_150(Player plParam0) // Position - 0x9EC1
{
	var address;
...
BOOL _NETSHOPPING_SHOULD_USE_TRANSACTION_SYSTEM() // Position - 0x9EDC
{
	if (MISC::IS_PC_VERSION())
...
char* AUDIO_SPEECH_GET_PARAM_STRING_FROM_ENUM_0_0_0_0(int iParam0) // Position - 0x9EF3
{
	switch (iParam0)
	{
		case 0:
...
char* AUDIO_SPEECH_GET_PARAM_STRING_FROM_ENUM_0_0_0_0_0(int iParam0) // Position - 0xA00A
{
	switch (iParam0)
	{
		case 0:
...
char* AUDIO_SPEECH_GET_PARAM_STRING_FROM_ENUM_0_0_0_0_0_0(int iParam0) // Position - 0xA121
{
	switch (iParam0)
	{
		case 0:
...
void func_155(float fParam0) // Position - 0xA1F7
{
...
void func_157(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5) // Position - 0xA261
{
	if (MISC::IS_PC_VERSION() && !NETWORK::NETWORK_TEXT_CHAT_IS_TYPING())
	{
		...
		if (func_161())
		{
			if (Global_4543037 == iLocal_143)
			{
				*uParam2 = 1;
			}
			else
			{
				iLocal_143 = Global_4543037;
				func_121(iLocal_143, true, 1);
			}
		}
...
BOOL func_158(BOOL bParam0, BOOL bParam1, int iParam2) // Position - 0xA38E
{
...
BOOL func_159(BOOL bParam0, BOOL bParam1, int iParam2) // Position - 0xA3F3
{
	if (PAD::IS_USING_KEYBOARD_AND_MOUSE(FRONTEND_CONTROL))
	{
		if (Global_4543037 == -2)
...
int func_162(BOOL bParam0, int iParam1, BOOL bParam2) // Position - 0xA49E
{
	if (!PAD::IS_USING_KEYBOARD_AND_MOUSE(FRONTEND_CONTROL))
		return 0;
...
void func_163(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0xA57E
{
	float x;
	float y;
	float x2;
...
void func_164(BOOL bParam0) // Position - 0xA82A
{
	float num;
	float num2;
	float num3;
...
void func_167(BOOL bParam0) // Position - 0xA931
{
	if (bParam0)
		if (func_168())
...
BOOL func_168() // Position - 0xA956
{
	return IS_BIT_SET(Global_2684748.f_2, 11);
}

BOOL func_169() // Position - 0xA967
{
	return HUD::GET_PAUSE_MENU_STATE() != 0;
}

BOOL func_170() // Position - 0xA975
{
	if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), false))
	{
		switch (iLocal_147)
...
void func_172(char* sParam0, int iParam1, float fParam2, float fParam3, float fParam4, int iParam5, float fParam6) // Position - 0xAA8B
{
	Vector3 vector;
...
BOOL func_174(float fParam0, float fParam1, float fParam2) // Position - 0xAB37
{
	float num;
	float num2;
...
BOOL func_175(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, BOOL bParam7) // Position - 0xABAC
{
	if (fParam6 < 0f)
		fParam6 = 0f;
...
void func_176(Vector3 vParam0, var uParam1, var uParam2, float fParam3) // Position - 0xAC27
{
...
void func_177(var uParam0, var uParam1) // Position - 0xAC87
{
...
void _STOPWATCH_DESTROY(var uParam0) // Position - 0xACDB
{
	uParam0->f_1 = 0;
	return;
}

BOOL func_179() // Position - 0xACE8
{
	if (func_180() == 0)
		return true;
...
int func_180() // Position - 0xACFD
{
	return Global_1574634.f_18;
}

void func_181() // Position - 0xAD0B
{
...
void func_182(char* sParam0) // Position - 0xAD33
{
...
void _SET_PLAYER_CONTROL_EX(Player plParam0, BOOL bParam1, eSetPlayerControlFlags espcfParam2, BOOL bParam3) // Position - 0xAD49
{
...
BOOL func_184(int iParam0) // Position - 0xB1FD
{
	return iParam0 == 17;
}

void func_185() // Position - 0xB20A
{
	var unk;
...
BOOL func_187(Ped pedParam0) // Position - 0xB295
{
...
void func_188(BOOL bParam0, Ped pedParam1, int iParam2) // Position - 0xB2C6
{
	int num;
	eViewModeContext i;
...
void _MPPLY_STAT_SET_BOOL(Hash hParam0, BOOL bParam1) // Position - 0xB396
{
	Hash statName;
...
BOOL func_191(Player plParam0) // Position - 0xB40A
{
...
BOOL func_192() // Position - 0xB449
{
	return IS_BIT_SET(Global_2621446, 3);
}

BOOL func_193() // Position - 0xB457
{
...
void _CONTEXT_REMOVE_HELP_TEXT(var uParam0) // Position - 0xB488
{
	int num;
...
int func_195(int iParam0) // Position - 0xB4DF
{
	int i;
...
void func_196(int iParam0) // Position - 0xB51A
{
	iLocal_156 = iParam0;
	return;
}

BOOL func_197(int iParam0, BOOL bParam1) // Position - 0xB526
{
	int num;
...
void _CONTEXT_ADD_HELP_TEXT(var uParam0, int iParam1, char* sParam2, int iParam3, const char* sParam4, int iParam5, int iParam6) // Position - 0xB605
{
	int i;
...
BOOL _IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(char* message) // Position - 0xB750
{
	HUD::BEGIN_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(message);
	return HUD::END_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(0);
}

BOOL func_202() // Position - 0xB763
{
...
BOOL func_203() // Position - 0xB787
{
	BOOL flag;

	flag = true;

	if (func_252(PLAYER::PLAYER_ID()) && !func_225(plLocal_140))
		flag = false;
...
int func_204(Ped pedParam0) // Position - 0xB8AE
{
	int num;
	int num2;
...
int func_205(int iParam0) // Position - 0xB8F1
{
	int i;
...
int func_206(Ped pedParam0) // Position - 0xB921
{
	int i;
...
BOOL func_208(Player plParam0) // Position - 0xB977
{
...
BOOL func_209() // Position - 0xB9B0
{
	return Global_76855;
}

BOOL func_210() // Position - 0xB9BC
{
	if (func_211() != -1)
		return true;
	else
...
int func_211() // Position - 0xB9D8
{
	return Global_2696585;
}

void func_212() // Position - 0xB9E4
{
	if (func_207())
	{
		if (IS_BIT_SET(uLocal_178[iLocal_173.f_2 /*3*/], 2))
		{
			if (uLocal_178[iLocal_173.f_2 /*3*/].f_1 == iLocal_153)
			{
				if (func_214())
				{
					iLocal_173 = 0;
					iLocal_173.f_3 = iLocal_153;
				
					if (plLocal_140 == iLocal_173.f_2)
						iLocal_173.f_4 = 1;
				}
			}
	...
	if (!func_207())
		if (iLocal_144 == 126)
			if (Global_1845274[plLocal_140 /*877*/].f_260.f_389 == iLocal_173.f_3 && !func_214() && Global_1845274[plLocal_140 /*877*/].f_260.f_389 == iLocal_153)
				iLocal_173.f_4 = 0;
		else if (iLocal_144 == 130)
			if (Global_1845274[plLocal_140 /*877*/].f_260.f_390 == iLocal_173.f_3 && !func_214() && Global_1845274[plLocal_140 /*877*/].f_260.f_390 == iLocal_153)
				iLocal_173.f_4 = 0;
		else if (Global_1845274[plLocal_140 /*877*/].f_260.f_386 == iLocal_173.f_3 && !func_214() && Global_1845274[plLocal_140 /*877*/].f_260.f_386 == iLocal_153)
			iLocal_173.f_4 = 0;
...
BOOL func_213(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, BOOL bParam6) // Position - 0xBBAF
{
	if (bParam6)
...
BOOL func_214() // Position - 0xBBF6
{
	return iLocal_173 == 1;
}

void func_215() // Position - 0xBC02
{
	int num;
	int num2;
	int num3;
...
void func_216(BOOL bParam0) // Position - 0xBC69
{
	if (bParam0)
...
void func_217(BOOL bParam0) // Position - 0xBCBC
{
...
void _STAT_SET_PACKED_BOOL(int iParam0, BOOL bParam1, int iParam2) // Position - 0xBD17
{
	if (iParam2 == -1)
		iParam2 = func_19();
...
void func_219(BOOL bParam0) // Position - 0xBD35
{
...
void func_220(int iParam0, BOOL bParam1) // Position - 0xBD51
{
	if (func_5(iParam0) == 97)
	{
...
void func_221(int iParam0) // Position - 0xBDAA
{
	if (func_6(iLocal_144, -1))
	{
		if (iParam0 != iLocal_153 && iParam0 != -1)
		{
			if (plLocal_140 == PLAYER::PLAYER_ID() && iLocal_150 != 0)
				func_9(iLocal_141);
		
			func_224(iLocal_144, iParam0);
		}
	
		if (iParam0 != -1)
			iLocal_141 = iParam0;
	}
	else if (iLocal_144 == 126 || iLocal_144 == 130)
	{
		if (iParam0 != iLocal_153 && iParam0 != -1)
		{
			if (plLocal_140 == PLAYER::PLAYER_ID() && iLocal_150 != 0)
...
void func_222(int iParam0) // Position - 0xBE62
{
	char* radioStation;
...
void func_223(int iParam0) // Position - 0xBE9D
{
	char* radioStation;
...
void func_224(int iParam0, int iParam1) // Position - 0xBED8
{
	char* radioStation;
...
BOOL func_225(Player plParam0) // Position - 0xBF53
{
	return func_227(plParam0) && func_226(plParam0);
}

BOOL func_226(Player plParam0) // Position - 0xBF6C
{
	if (plParam0 == PLAYER::PLAYER_ID())
...
BOOL func_227(Player plParam0) // Position - 0xBFA0
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
...
Player _INVALID_PLAYER_INDEX() // Position - 0xBFC8
{
	return -1;
}

Player func_229(Player plParam0) // Position - 0xBFD1
{
	int num;
...
Player func_230(Player plParam0) // Position - 0xC061
{
	if (func_88(plParam0))
...
BOOL func_231(Player plParam0, BOOL bParam1) // Position - 0xC084
{
	if (!func_88(plParam0))
		return false;
	...
	return func_88(Global_1888882[plParam0 /*611*/].f_10);
}

BOOL func_232(Player plParam0) // Position - 0xC0BC
{
	if (func_88(plParam0))
		if (func_88(Global_1888882[plParam0 /*611*/].f_10))
			return Global_1888882[plParam0 /*611*/].f_10 == plParam0;

	return false;
}

int func_233(int iParam0) // Position - 0xC0F1
{
	switch (iParam0)
	{
		case 0:
...
BOOL IS_GAMER_HANDLE_VALID(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12) // Position - 0xC640
{
	return NETWORK::NETWORK_IS_HANDLE_VALID(&uParam0, 13);
}

void func_235(Player plParam0, var uParam1) // Position - 0xC650
{
	*uParam1 = { Global_1845274[plParam0 /*877*/].f_260.f_73 };
	return;
}

void func_236() // Position - 0xC66E
{
	int instanceId;
...
BOOL _DOES_EVENT_OF_TYPE_EXIST(int iParam0) // Position - 0xC740
{
...
BOOL func_239() // Position - 0xC757
{
	return Global_2684748.f_695;
}

int _NETWORK_ENSURE_SCRIPT_IS_NETWORKED(int iParam0, int iParam1, BOOL bNoTerminate) // Position - 0xC766
{
	int i;
...
BOOL func_241(BOOL bParam0) // Position - 0xC87C
{
	bParam0;
	return Global_1575060;
}

void func_242() // Position - 0xC88D
{
	SCRIPT::TERMINATE_THIS_THREAD();
	return;
}

int func_243() // Position - 0xC899
{
	int unk;
...
BOOL func_244(Player plParam0) // Position - 0xC8B9
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
...
void func_245() // Position - 0xC91F
{
	...
	else if (iLocal_144 != Global_1845274[PLAYER::PLAYER_ID() /*877*/].f_260.f_36)
	{
		func_253(false);
	}
...
BOOL func_246() // Position - 0xCB68
{
	return Global_4196257;
}

BOOL func_247(Player plParam0) // Position - 0xCB74
{
...
BOOL func_248(Player plParam0) // Position - 0xCBAD
{
	if (plParam0 != _INVALID_PLAYER_INDEX() && _NETWORK_IS_PLAYER_VALID(plParam0, true, true))
...
BOOL func_249(Player plParam0) // Position - 0xCBDE
{
	if (plParam0 != _INVALID_PLAYER_INDEX() && _NETWORK_IS_PLAYER_VALID(plParam0, true, true))
...
int func_250() // Position - 0xCC0F
{
	return func_134();
}

BOOL func_251(Player plParam0) // Position - 0xCC1B
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2658019[plParam0 /*467*/].f_324.f_8 != -1)
				return func_233(Global_2658019[plParam0 /*467*/].f_324.f_8) == 26;

	return false;
}

BOOL func_252(Player plParam0) // Position - 0xCC62
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2658019[plParam0 /*467*/].f_324.f_8 != -1)
...
void func_253(BOOL bParam0) // Position - 0xCCA9
{
	func_255(false);
...
void func_255(BOOL bParam0) // Position - 0xCDA6
{
	if (bParam0)
	{
		func_256();
