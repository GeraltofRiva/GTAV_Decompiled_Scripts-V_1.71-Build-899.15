...
void main() // Position - 0x0
{
	...
	if (MISC::GET_GAME_TIMER() < Global_33563 + 10000 && !func_107())
		func_115(0);
...
void func_17() // Position - 0x162F
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (_GET_CHARACTER_MODEL(Global_114370.f_2367.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_19(character) && !func_18(14) || Global_113318)
			{
				if (Global_114370.f_2367.f_539.f_4321 != character && func_19(Global_114370.f_2367.f_539.f_4321))
...
void func_68(int iParam0, BOOL bParam1) // Position - 0x25BC
{
	...
	if (offset >= 0 && offset <= 31)
	{
		if (func_77(iParam0))
		{
			if (!func_75(iParam0))
			{
				MISC::SET_BIT(&(Global_114370.f_26438.f_2), offset);
...
{
	if (func_77(iParam0))
		return IS_BIT_SET(Global_114370.f_26438.f_2, iParam0);
...
BOOL func_76(int iParam0) // Position - 0x2AA0
{
	...
	if (num >= 0 && num <= 31)
		return IS_BIT_SET(Global_114370.f_26438.f_2, num);
...
void func_97(int iParam0) // Position - 0x2F2E
{
	...
	func_100(&(Global_114370.f_20121), iParam0);
	num = func_98(iParam0);
...
{
	if (IS_BIT_SET(Global_114370.f_18578[58 /*6*/], 0) && !IS_BIT_SET(Global_114370.f_18578[58 /*6*/], 3))
		return true;
...
{
	if (IS_BIT_SET(Global_114370.f_18578[60 /*6*/], 0) && !IS_BIT_SET(Global_114370.f_18578[60 /*6*/], 3))
		return false;

	if (IS_BIT_SET(Global_114370.f_18578[61 /*6*/], 0) && !IS_BIT_SET(Global_114370.f_18578[61 /*6*/], 3))
		return false;

	if (IS_BIT_SET(Global_114370.f_18578[62 /*6*/], 3))
		return false;

	if (IS_BIT_SET(Global_114370.f_18578[58 /*6*/], 2) || IS_BIT_SET(Global_114370.f_18578[59 /*6*/], 2) || IS_BIT_SET(Global_114370.f_18578[62 /*6*/], 2))
		return true;
...
{
	return func_113(Global_114370.f_20121, iParam0);
}
