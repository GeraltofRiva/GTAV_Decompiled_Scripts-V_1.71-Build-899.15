...
void func_2() // Position - 0x8C
{
	...
	if (func_13(6))
	{
		...
		MISC::COPY_SCRIPT_STRUCT(&Global_1921119, &(iLocal_19.f_4), 700);
		Global_1921825 = iLocal_19.f_2;
	}
	else
	{
		Global_1921119.f_700 = 0;
		Global_1921825 = -1;
	}

	_STOPWATCH_RESET(&Global_1921829, true, false);
	func_3(&hLocal_870);
	src = -1;
	src.f_1 = -1;
	MISC::COPY_SCRIPT_STRUCT(&Global_1921822, &src, 3);
	SCRIPT::TERMINATE_THIS_THREAD();
	return;
}

void func_3(Any* panParam0) // Position - 0x12C
{
	MISC::COPY_SCRIPT_STRUCT(&Global_1921112, panParam0, 7);
	func_4(0);
	return;
}

void func_4(int iParam0) // Position - 0x144
{
	MISC::SET_BIT(&(Global_1921112.f_6), iParam0);
	return;
}

void _STOPWATCH_RESET(var pStopwatch, BOOL useLocalTimer, BOOL useAccurateTime) // Position - 0x158
{
...
void func_6(BOOL bParam0, BOOL bParam1) // Position - 0x195
{
	int i;
	int j;
	float aspectRatio;
	...
	Global_24148.f_9149 = func_7(false);
	Global_24145 = 0.05f;
	Global_24146 = 0.05f;
	Global_24147 = 0.225f;
...
float func_7(BOOL bParam0) // Position - 0x66E
{
	float aspectRatio;
...
void func_8(BOOL bParam0, int iParam1) // Position - 0x699
{
	int num;
	...
	if (bParam0)
	{
		func_9(&Global_24148.f_6263[num /*10*/]);
...
void func_9(int iParam0) // Position - 0x75C
{
	if (iParam0->f_9 != 0)
	{
...
BOOL func_10(var uParam0, BOOL bParam1, int iParam2) // Position - 0x788
{
	var unk;
	Hash hashKey;
	int i;
...
void func_11(var uParam0, char* sParam1) // Position - 0x825
{
...
void func_12(var uParam0) // Position - 0x839
{
	int i;
...
BOOL func_13(int iParam0) // Position - 0x923
{
	return IS_BIT_SET(iLocal_19.f_1, iParam0);
}

void func_14() // Position - 0x932
{
	func_19();
	func_16();
	func_15();
...
void func_15() // Position - 0x950
{
	Global_1921828 = false;
	return;
}

void func_16() // Position - 0x95D
{
	if (func_13(0))
		func_18(2);
	...
	if (IS_BIT_SET(Global_1921822.f_2, 0))
		func_18(2);

	if (IS_BIT_SET(Global_1921822.f_2, 2))
	{
		func_18(2);
		func_17(0);
		func_17(6);
...
void func_17(int iParam0) // Position - 0x9A9
{
	MISC::SET_BIT(&(iLocal_19.f_1), iParam0);
	return;
}

void func_18(int iParam0) // Position - 0x9BB
{
	iLocal_19 = iParam0;
	return;
}

void func_19() // Position - 0x9C7
{
	func_129();
	...
	if (!func_13(6))
	{
		MISC::SET_BIT(&(Global_1921822.f_2), 1);
		func_6(false, false);
	}
...
void func_21() // Position - 0xA39
{
	Global_1921827 = false;
	return;
}

BOOL func_22() // Position - 0xA46
{
	return Global_1921827;
}

void func_23() // Position - 0xA52
{
	var unk;
	int num;
	var unk5;
	...
	if (iLocal_19.f_4.f_693 == 0)
	{
		if (iLocal_19.f_2 != -1)
			if (!IS_BIT_SET(hLocal_724.f_2.f_130[iLocal_19.f_2], 8))
				func_35(PAD::GET_CONTROL_INSTRUCTIONAL_BUTTONS_STRING(PLAYER_CONTROL, INPUT_FRONTEND_ACCEPT, true), "FMMC_SEL_ACCE", &(iLocal_19.f_4), 0);
		...
		func_35(PAD::GET_CONTROL_INSTRUCTIONAL_BUTTONS_STRING(PLAYER_CONTROL, INPUT_FRONTEND_CANCEL, true), "FMMC_SEL_CANC", &(iLocal_19.f_4), 0);
		func_35(PAD::GET_CONTROL_INSTRUCTIONAL_BUTTONS_STRING(PLAYER_CONTROL, INPUT_FRONTEND_UP, true), "FMMC_SEL_UP", &(iLocal_19.f_4), 0);
		func_35(PAD::GET_CONTROL_INSTRUCTIONAL_BUTTONS_STRING(PLAYER_CONTROL, INPUT_FRONTEND_DOWN, true), "FMMC_SEL_DOWN", &(iLocal_19.f_4), 0);
	}
...
void func_24(var uParam0, var uParam1, var uParam2, BOOL bParam3) // Position - 0xC28
{
	int i;
...
void func_26(int iParam0, var uParam1) // Position - 0xFD7
{
...
void func_27(char* sParam0) // Position - 0x1005
{
...
void func_28(char* sParam0) // Position - 0x1017
{
...
void func_30(var uParam0) // Position - 0x1033
{
	Global_1985670 = 0;
	uParam0->f_692 = 0;
	return;
...
BOOL func_31(var uParam0) // Position - 0x1046
{
	return Global_1985670 || uParam0->f_692;
}

void func_32(int iParam0) // Position - 0x105D
{
	Global_1675455.f_1163 = iParam0;
	return;
}

BOOL func_33(var uParam0, char* sParam1) // Position - 0x106E
{
...
struct<9> func_34() // Position - 0x108C
{
	float num;
...
void func_35(const char* sParam0, char* sParam1, var uParam2, char* sParam3) // Position - 0x10D0
{
	int num;
...
struct<16> func_36(int iParam0) // Position - 0x1120
{
	var unk;
	var unk17;
...
BOOL func_37(int iParam0) // Position - 0x1178
{
...
void func_38() // Position - 0x1197
{
	...
	if (IS_BIT_SET(Global_1575013, 9))
		return;
	...
	for (i = 0; i <= iLocal_19.f_3 - 1; i = i + 1)
	{
		...
		else
		{
			...
			if (!IS_BIT_SET(hLocal_724.f_2.f_130[i], 2) || flag)
			{
				...
				if (i == Global_24148.f_6342 && !func_93(&(hLocal_724.f_2), i))
...
void func_39(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x13A1
{
	float x;
	float y;
	float x2;
	...
	if (num4 >= x && num4 <= x2 && num5 >= y && num5 <= y2)
	{
		...
		if (bParam3)
		{
			if (!bParam1 || num10 != 0)
			{
				GRAPHICS::SET_SCRIPT_GFX_ALIGN(76, 84);
				GRAPHICS::SET_SCRIPT_GFX_ALIGN_PARAMS(-0.05f, -0.05f, 0f, 0f);
				func_40(num, num2 + ((float)num10 * 0.034722f), Global_24147, 0.034722f - 0.0015f, 255, 255, 255, num7);
				GRAPHICS::RESET_SCRIPT_GFX_ALIGN();
			}
		}
...
void func_40(float fParam0, float fParam1, int iParam2, float fParam3, int iParam4, int iParam5, int iParam6, int iParam7) // Position - 0x164D
{
...
float func_41(float fParam0) // Position - 0x1684
{
	fParam0 = fParam0 * func_42();
	return fParam0;
}

float func_42() // Position - 0x1697
{
	return 1.7777778f / func_43();
}

float func_43() // Position - 0x16A9
{
	return Global_24148.f_9149;
}

void func_44(BOOL bParam0) // Position - 0x16B7
{
	float num;
	float num2;
	float num3;
	...
	if (Global_4543037 == -2)
		func_40(num, num2, Global_24147, num3, 255, 255, 255, num4);
	else if (Global_4543037 == -3)
		func_40(num, num2 + num3, Global_24147, num3, 255, 255, 255, num4);

	GRAPHICS::RESET_SCRIPT_GFX_ALIGN();
	return;
}

void func_45() // Position - 0x1740
{
...
BOOL func_46(BOOL bParam0, BOOL bParam1) // Position - 0x1788
{
	if (Global_2672967.f_1761.f_701 != 0)
		return true;

	if (!CAM::IS_SCREEN_FADED_IN() || func_48(8, -1) && func_47() != 65 || HUD::GET_PAUSE_MENU_STATE() != 0 && !bParam1 || STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS() && !bParam0 || NETWORK::IS_COMMERCE_STORE_OPEN() || Global_80029 || Global_24148.f_9147 || HUD::IS_WARNING_MESSAGE_ACTIVE() || Global_101969.f_1490)
		return false;

	return true;
}

int func_47() // Position - 0x1825
{
	return Global_1575016;
}

BOOL func_48(int iParam0, int iParam1) // Position - 0x1831
{
	switch (iParam0)
	{
		case 5:
...
void func_49(BOOL bParam0, int iParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, int iParam5, BOOL bParam6, BOOL bParam7, int iParam8) // Position - 0x1869
{
	int num;
	int r;
	int g;
	...
	if (bParam3)
	{
		...
		{
			func_97(Global_24148.f_5821 + 1, "DFLT_MNU_OPT" /*Exit*/, 0, true, 0, false, 0);
		...
		if (i == 1 && Global_24148.f_6331)
		{
			...
			else
			{
				if (Global_24148)
				{
					...
					{
						func_40(Global_24145, Global_24146, iParam5, num38, 0, 0, 0, 255);
						func_81(&unk5, &unk21, Global_24145 + (iParam5 * 0.5f), Global_24146 + (num38 * 0.5f), iParam5, num38, 0f, 255, 255, 255, 255, false, 0);
					}
					else
					{
						func_81(&unk5, &unk21, Global_24145 + (iParam5 * 0.5f), Global_24146 + (num38 * 0.5f), iParam5, num38, 0f, 255, 255, 255, 255, false, 0);
				...
				func_40(Global_24145, Global_24146 + num38, iParam5, 0.034722f, r, g, b, a);
				...
				if (MISC::GET_HASH_KEY(&(Global_24148.f_1)) != 0)
				{
					...
					func_79(Global_24145 + 0.00390625f, Global_24146 + num38 + 0.00416664f, 0);
				}
			
				if (Global_24148.f_6338)
				{
					func_80();
					func_77((Global_24145 + iParam5) - 0.00390625f - func_78("CM_ITEM_COUNT" /*~1~ / ~1~*/, Global_24148.f_6339, Global_24148.f_6340), Global_24146 + num38 + 0.00416664f, "CM_ITEM_COUNT" /*~1~ / ~1~*/, Global_24148.f_6339, Global_24148.f_6340);
				}
				else if (Global_24148.f_6334 > Global_24148.f_5828)
				{
					...
					{
						func_80();
						func_77((Global_24145 + iParam5) - 0.00390625f - func_78("CM_ITEM_COUNT" /*~1~ / ~1~*/, Global_24148.f_6337, Global_24148.f_6336), Global_24146 + num38 + 0.00416664f, "CM_ITEM_COUNT" /*~1~ / ~1~*/, Global_24148.f_6337, Global_24148.f_6336);
					}
				}
			}
			...
			func_81("CommonMenu", "Gradient_Bgd", Global_24145 + (iParam5 * 0.5f), (num42 + ((num36 - num42) * 0.5f)) - 0.00138888f, iParam5, num36 - num42, 0f, 255, 255, 255, 255, false, 0);
			...
			if (Global_24148.f_6334 > Global_24148.f_5828)
			{
				...
				func_40(Global_24145, num36 + 0f, iParam5, 0.034722f, r, g, b, a);
				...
				func_81("CommonMenu", "shop_arrows_upANDdown", Global_24145 + (iParam5 * 0.5f), num36 + 0f + (0.034722f * 0.5f), (textureResolution / 1280f) * num41, (textureResolution.f_1 / 720f) * num41, 0f, r, g, b, a, false, 0);
			...
			if (MISC::GET_HASH_KEY(&(Global_24148.f_5241)) != 0 && Global_24148.f_5323 != -1)
			{
				...
				{
					func_88(Global_24148.f_5325, true, true, &num26, &num27, bParam7);
				...
				func_40(Global_24145, num36 - 0.00277776f, iParam5, 0.00277776f, r, g, b, a);
				...
				{
					func_88(Global_24148.f_5325, true, true, &num26, &num27, bParam7);
					func_75(Global_24148.f_5325, true, &num32, &num33, &num34, &num35);
					func_81(func_85(Global_24148.f_5325), func_82(Global_24148.f_5325, true), Global_24145 + (num26 * 0.5f) + (0.00078125f * 2f), (num36 + (num27 * 0.5f)) - (0.00138888f * 4f), num26, num27, 0f, num32, num33, num34, num35, false, 0);
				}
			...
			if (MISC::GET_HASH_KEY(&(Global_4542961.f_21)) != 0 && Global_4542961.f_65 != -1)
			{
				...
				{
					func_88(Global_4542961.f_67, true, true, &num26, &num27, bParam7);
					x = (Global_24145 + num26 + (0.00078125f * 4f)) - (0.00078125f * 1f);
				}
				...
				{
					func_88(Global_4542961.f_67, true, true, &num26, &num27, bParam7);
					func_75(Global_4542961.f_67, true, &num32, &num33, &num34, &num35);
					func_81(func_85(Global_4542961.f_67), func_82(Global_4542961.f_67, true), Global_24145 + (num26 * 0.5f) + (0.00078125f * 2f), (num36 + (num27 * 0.5f)) - (0.00138888f * 4f), num26, num27, 0f, num32, num33, num34, num35, false, 0);
				}
		...
		if (i == 1 || !Global_24148.f_6331)
		{
			...
			for (j = 0; j <= num43; j = j + 1)
			{
				...
				if (flag && i == 1 && flag2)
				{
					...
					func_81("CommonMenu", "Gradient_Nav", Global_24145 + (iParam5 * 0.5f), num40 + num45 + (0.00277776f * (float)num5) + (num37 * 0.5f), iParam5, num37, 0f, r2, g2, b2, a2, false, 0);
						...
						switch (Global_24148.f_5659[k])
						{
								...
								if (flag2)
								{
									if (!Global_24148.f_6332)
									{
										...
										if (MISC::GET_HASH_KEY(&Global_24148.f_79[num16 /*6*/]) != 0)
										{
											...
											func_65(flag, Global_24148.f_1616[num16], Global_24148.f_1873[num16], flag7, num46, flag5, flag4);
										...
										if (num20 > 0)
										{
											...
											{
												if (func_88(Global_24148.f_4984[num14 + l], flag, false, &num26, &num27, bParam7))
												{
													num29 = num29 + num26;
									...
									if (MISC::GET_HASH_KEY(&Global_24148.f_79[num16 /*6*/]) != 0 && i == 1)
									{
										...
										func_65(flag, Global_24148.f_1616[num16], Global_24148.f_1873[num16], flag7, 0, flag5, flag4);
									...
									for (l = 0; l < 4; l = l + 1)
									{
										...
										else if (Global_24148.f_2387[num16 /*5*/][l] == 4)
										{
											...
											{
												if (func_88(Global_24148.f_4984[num14 + num20], flag, false, &num26, &num27, bParam7))
												{
													x = x + (num26 * 0.5f);
												
													if (func_88(Global_24148.f_4984[num14 + num20], flag, true, &num26, &num27, bParam7))
													{
														func_75(Global_24148.f_4984[num14 + num20], flag, &num32, &num33, &num34, &num35);
													
														if (i == 1)
															if (Global_24148.f_5686[k] == 2)
																func_81(func_85(Global_24148.f_4984[num14 + num20]), func_82(Global_24148.f_4984[num14 + num20], flag), ((num24 + x) - (0.00078125f * 8f)) + (0.00078125f * 4f), (num25 - 0.00277776f) + (num37 * 0.5f), num26, num27, 0f, num32, num33, num34, num35, false, 0);
															else
																func_81(func_85(Global_24148.f_4984[num14 + num20]), func_82(Global_24148.f_4984[num14 + num20], flag), (num24 + x) - (0.00078125f * 8f), (num25 - 0.00277776f) + (num37 * 0.5f), num26, num27, 0f, num32, num33, num34, num35, false, 0);
										...
										else
										{
											...
											if (IS_ROCKSTAR_DEV() && SCRIPT::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(joaat("fm_mission_creator")) > 0)
											{
												if (k == 0)
												{
													...
													func_65(false, Global_24148.f_1616[num16], Global_24148.f_1873[num16], flag7, 0, flag5, flag4);
										...
										for (l = 0; l < num20; l = l + 1)
										{
											if (Global_24148.f_4984[num14 + l] != 2 && Global_24148.f_4984[num14 + l] != 55 && Global_24148.f_4984[num14 + l] != 65)
											{
												if (func_88(Global_24148.f_4984[num14 + l], flag, false, &num26, &num27, bParam7))
												{
													...
													if (i == 1)
													{
														if (func_88(Global_24148.f_4984[num14 + l], flag, true, &num26, &num27, bParam7))
														{
															func_75(Global_24148.f_4984[num14 + l], flag, &num32, &num33, &num34, &num35);
														
															if (Global_24148.f_4984[num14 + l] == 31)
																func_81(func_85(Global_24148.f_4984[num14 + l]), func_82(Global_24148.f_4984[num14 + l], flag), Global_24145 + (num26 * 0.5f), (num25 + 0.00277776f + (num27 * 0.5f)) - (0.00078125f * 11f), num26, num27, 0f, num32, num33, num34, num35, false, 0);
															else if (Global_24148.f_5686[k] == 2)
																func_81(func_85(Global_24148.f_4984[num14 + l]), func_82(Global_24148.f_4984[num14 + l], flag), ((num24 + x + num28) - (0.00078125f * 8f)) + (0.00078125f * 4f), (num25 - 0.00277776f) + (num37 * 0.5f), num26, num27, 0f, num32, num33, num34, num35, false, 0);
															else
																func_81(func_85(Global_24148.f_4984[num14 + l]), func_82(Global_24148.f_4984[num14 + l], flag), (num24 + x + num28) - (0.00078125f * 12f), (num25 - 0.00277776f) + (num37 * 0.5f), num26, num27, 0f, num32, num33, num34, num35, false, 0);
														}
													}
							...
							case 2:
								if (flag2)
								{
									if (!Global_24148.f_6332)
									{
										func_65(flag, Global_24148.f_1616[num16], Global_24148.f_1873[num16], flag7, 0, false, false);
									...
									{
										func_65(flag, Global_24148.f_1616[num16], Global_24148.f_1873[num16], flag7, 0, false, false);
										func_59(num24 + x, num25, "NUMBER" /*~1~*/, Global_24148.f_4469[num12], 0);
									}
								}
							...
							case 3:
								if (flag2)
								{
									...
									func_65(flag, Global_24148.f_1616[num16], Global_24148.f_1873[num16], flag7, 0, false, false);
									func_58(num24 + x, num25, "NUMBER" /*~1~*/, Global_24148.f_4726[num13], Global_24148.f_4855[num13]);
								}
							...
							case 4:
								if (flag2)
								{
									if (func_88(Global_24148.f_4984[num14], flag, false, &num26, &num27, bParam7))
									{
										if (!Global_24148.f_6332)
										{
											num29 = num26;
										...
										if (i == 1)
										{
											if (func_88(Global_24148.f_4984[num14], flag, true, &num26, &num27, bParam7))
											{
												func_75(Global_24148.f_4984[num14], flag, &num32, &num33, &num34, &num35);
												func_81(func_85(Global_24148.f_4984[num14]), func_82(Global_24148.f_4984[num14], flag), num24 + x + (num26 * 0.5f), (num25 - 0.00277776f) + (num37 * 0.5f), num26 * func_57(Global_24148.f_4984[num14]), num27 * func_57(Global_24148.f_4984[num14]), 0f, num32, num33, num34, num35, false, 0);
											}
										}
									}
								}
...
void func_50(int iParam0) // Position - 0x4A10
{
	if (func_56())
		return;
...
void func_51(int iParam0) // Position - 0x4A43
{
	if (func_56())
		return;
...
void func_53(BOOL bParam0, BOOL bParam1) // Position - 0x4AF4
{
	if (bParam0)
	{
		if (func_55(0))
...
BOOL func_54() // Position - 0x4B68
{
	return IS_BIT_SET(Global_1960332, 5);
}

BOOL func_55(int iParam0) // Position - 0x4B76
{
	if (iParam0 == 1)
...
BOOL func_56() // Position - 0x4BCD
{
	return IS_BIT_SET(Global_1960332, 19);
}

float func_57(int iParam0) // Position - 0x4BDC
{
	switch (iParam0)
	{
		case 36:
...
void func_58(float fParam0, float fParam1, char* sParam2, float fParam3, int iParam4) // Position - 0x4C4B
{
...
void func_59(float fParam0, float fParam1, char* sParam2, int iParam3, int iParam4) // Position - 0x4C6E
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_TEXT(sParam2);
...
BOOL IS_ROCKSTAR_DEV() // Position - 0x4C90
{
	return DLC::IS_DLC_PRESENT(-1762644250);
}

void func_61(BOOL bParam0) // Position - 0x4CA1
{
	int r;
	int g;
	int b;
...
float func_62(BOOL bParam0) // Position - 0x4CE7
{
	return func_63(HUD::END_TEXT_COMMAND_GET_SCREEN_WIDTH_OF_DISPLAY_TEXT(bParam0));
}

float func_63(float fParam0) // Position - 0x4CF9
{
	fParam0 = fParam0 * func_64();
	return fParam0;
}

float func_64() // Position - 0x4D0C
{
	return func_43() / 1.7777778f;
}

void func_65(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, int iParam4, BOOL bParam5, BOOL bParam6) // Position - 0x4D1E
{
	int r;
	int g;
	int b;
	...
	if (bParam2)
	{
		if (bParam3)
		{
			func_67(Global_24148.f_6614[iParam4], &r, &g, &b);
...
void func_66(float fParam0, float fParam1) // Position - 0x4ECC
{
	HUD::SET_TEXT_WRAP(func_41(fParam0), func_41(fParam1));
	return;
}

void func_67(int iParam0, var uParam1, var uParam2, var uParam3) // Position - 0x4EE4
{
	switch (iParam0)
	{
		case 0:
...
void func_68(var uParam0, int iParam1, int iParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, int iParam7, BOOL bParam8) // Position - 0x516E
{
	int num;
	int i;
	int j;
...
BOOL func_69(Player plParam0, int iParam1) // Position - 0x566C
{
	BOOL flag;
...
int func_70(int iParam0, BOOL bParam1) // Position - 0x56C5
{
	int num;
	int num2;
...
int func_71() // Position - 0x5706
{
	return Global_1574927;
}

BOOL func_72(Player plParam0) // Position - 0x5712
{
	Player player;
...
void func_75(int iParam0, BOOL bParam1, int* piParam2, int* piParam3, int* piParam4, int* piParam5) // Position - 0x57BC
{
...
void func_76(float fParam0) // Position - 0x58F8
{
	int r;
	int g;
	int b;
	...
	HUD::SET_TEXT_COLOUR(r, g, b, a);
	func_66(fParam0, (Global_24145 + Global_24147) - 0.0046875f);
	HUD::SET_TEXT_CENTRE(false);
	HUD::SET_TEXT_DROPSHADOW(0, 0, 0, 0, 0);
	HUD::SET_TEXT_EDGE(0, 0, 0, 0, 0);
	return;
...
void func_77(float fParam0, float fParam1, char* sParam2, int iParam3, int iParam4) // Position - 0x5957
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_TEXT(sParam2);
	HUD::ADD_TEXT_COMPONENT_INTEGER(iParam3);
...
float func_78(char* sParam0, int iParam1, int iParam2) // Position - 0x597E
{
...
void func_79(float fParam0, float fParam1, int iParam2) // Position - 0x59C0
{
	HUD::END_TEXT_COMMAND_DISPLAY_TEXT(func_41(fParam0), fParam1, iParam2);
	return;
}

void func_80() // Position - 0x59D6
{
	int r;
	int g;
	int b;
	...
	HUD::SET_TEXT_SCALE(0f, 0.35f);
	HUD::SET_TEXT_COLOUR(r, g, b, a);
	func_66(Global_24145 + 0.0046875f, (Global_24145 + Global_24147) - 0.0046875f);
	HUD::SET_TEXT_CENTRE(false);
	HUD::SET_TEXT_DROPSHADOW(0, 0, 0, 0, 0);
	HUD::SET_TEXT_EDGE(0, 0, 0, 0, 0);
	return;
...
void func_81(char* sParam0, char* sParam1, float fParam2, float fParam3, float fParam4, float fParam5, float fParam6, int iParam7, int iParam8, int iParam9, int iParam10, BOOL bParam11, int iParam12) // Position - 0x5A60
{
...
char* func_82(int iParam0, BOOL bParam1) // Position - 0x5A8E
{
	var unk;
	var txdName;
	var netHandle;
...
char* func_83(char* sParam0) // Position - 0x5FBC
{
	return sParam0;
}

struct<13> GET_GAMER_HANDLE_PLAYER(Player plParam0) // Position - 0x5FC6
{
	var gamerHandle;
...
char* func_85(int iParam0) // Position - 0x5FDD
{
	var txdName;
	var netHandle;
...
void func_86(BOOL bParam0, int* piParam1, int* piParam2, var uParam3) // Position - 0x6050
{
	float num;
	float value;
	float aspectRatio;
...
BOOL func_87(int iParam0, int iParam1) // Position - 0x60D8
{
	return SYSTEM::TO_FLOAT(iParam0) / SYSTEM::TO_FLOAT(iParam1) > 3.5f;
}

BOOL func_88(int iParam0, BOOL bParam1, BOOL bParam2, var uParam3, var uParam4, BOOL bParam5) // Position - 0x60F3
{
	var textureDict;
	var textureName;
	int num;
...
float func_89(int iParam0) // Position - 0x621F
{
	switch (iParam0)
	{
		case 34:
...
void func_90() // Position - 0x62F9
{
	Global_1921828 = true;
	return;
}

BOOL func_91() // Position - 0x6306
{
	return Global_1921828;
}

void func_92(char* sParam0, int iParam1, int iParam2) // Position - 0x6312
{
	int i;
...
BOOL func_93(var uParam0, int iParam1) // Position - 0x6377
{
	return IS_BIT_SET(uParam0->f_130[iParam1], 10);
}

void func_94(int iParam0, int iParam1, BOOL bParam2) // Position - 0x638A
{
	int num;
	float num2;
	float num3;
	...
	if (num != 4)
	{
		while (Global_24148.f_5822 < 4 && num != 4)
		{
	...
	Global_24148.f_4984[Global_24148.f_5827] = iParam1;
	...
	if (iParam1 != 0)
	{
		...
		if (bParam2)
			if (num3 > Global_24148.f_6348[iParam0])
				Global_24148.f_6348[iParam0] = num3;
	}

	MISC::SET_BIT(&Global_24148.f_5692[iParam0], Global_24148.f_5822);
	Global_24148.f_5822 = Global_24148.f_5822 + 1;
	Global_24148.f_6347 = 4;
	return;
}

BOOL func_95(int iParam0) // Position - 0x6505
{
	return func_96(&(hLocal_870.f_2), iParam0);
}

BOOL func_96(var uParam0, int iParam1) // Position - 0x6518
{
	return IS_BIT_SET(uParam0->[iParam1 / 32], iParam1 & 31);
}

void func_97(int iParam0, char* sParam1, int iParam2, BOOL bParam3, int iParam4, BOOL bParam5, int iParam6) // Position - 0x652F
{
	int num;
	float num2;
	float num3;
	...
	if (!bParam3)
		func_100(Global_24148.f_5821, true);
	else
		func_100(Global_24148.f_5821, false);

	if (iParam2 == 0)
	{
		num2 = func_99(&Global_24148.f_79[Global_24148.f_5823 /*6*/]);
	...
	if (bParam5)
	{
		if (iParam2 == 0)
		{
			num4 = func_98(&Global_24148.f_79[Global_24148.f_5823 /*6*/]);
...
float func_98(char* sParam0) // Position - 0x674B
{
	!HUD::DOES_TEXT_LABEL_EXIST(sParam0);
	return HUD::GET_RENDERED_CHARACTER_HEIGHT(0.35f, 0);
}

float func_99(char* sParam0) // Position - 0x6767
{
	if (!MISC::IS_STRING_NULL(sParam0))
		if (MISC::GET_HASH_KEY(sParam0) == 0)
			return 0f;
...
void func_100(int iParam0, BOOL bParam1) // Position - 0x67A4
{
	int num;
...
BOOL func_101(int iParam0) // Position - 0x67F0
{
...
BOOL func_102(var uParam0, int iParam1) // Position - 0x6828
{
	return !IS_BIT_SET(uParam0->f_130[iParam1], 1);
}

void func_103(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x683B
{
...
void func_104(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4) // Position - 0x687A
{
...
void func_105(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4) // Position - 0x68B9
{
...
void func_106(var uParam0, var uParam1, var uParam2, var uParam3, int iParam4) // Position - 0x6963
{
	Global_24148.f_9133 = iParam4;
	Global_24148.f_9129 = uParam0;
	Global_24148.f_9130 = uParam1;
	Global_24148.f_9131 = uParam2;
	Global_24148.f_9132 = uParam3;
	return;
}

void func_107(var uParam0, var uParam1, var uParam2, var uParam3, int iParam4) // Position - 0x6993
{
...
void func_108(char* sParam0) // Position - 0x69C3
{
	int i;
...
void func_109(var uParam0, var uParam1, var uParam2, var uParam3, int iParam4) // Position - 0x6A0E
{
...
void func_110() // Position - 0x6A3E
{
	int num;
	var unk;
	int num2;

	num = Global_24148.f_6342;
...
void func_112(int iParam0) // Position - 0x6B8E
{
	MISC::CLEAR_BIT(&(iLocal_19.f_1), iParam0);
	return;
}

void func_113(int iParam0) // Position - 0x6BA0
{
	func_114(&(hLocal_870.f_4), iParam0);
	return;
}

void func_114(var uParam0, int iParam1) // Position - 0x6BB3
{
	MISC::SET_BIT(&uParam0->[iParam1 / 32], iParam1 & 31);
	return;
}

void func_115(int iParam0) // Position - 0x6BCD
{
	func_116(&(hLocal_870.f_4), iParam0);
	return;
}

void func_116(var uParam0, int iParam1) // Position - 0x6BE0
{
	MISC::CLEAR_BIT(&uParam0->[iParam1 / 32], iParam1 & 31);
	return;
}

BOOL func_117(int iParam0) // Position - 0x6BFA
{
	return func_96(&(hLocal_870.f_4), iParam0);
}

void func_118(int iParam0) // Position - 0x6C0D
{
	func_114(&(hLocal_870.f_2), iParam0);
	return;
}

void func_119(int iParam0) // Position - 0x6C20
{
	func_116(&(hLocal_870.f_2), iParam0);
	return;
}

void func_120() // Position - 0x6C33
{
	int num;
	int num2;
	...
	if (PAD::IS_USING_KEYBOARD_AND_MOUSE(FRONTEND_CONTROL) && PAD::IS_CONTROL_JUST_RELEASED(FRONTEND_CONTROL, INPUT_CURSOR_ACCEPT) && Global_4543037 != iLocal_19.f_2 && !IS_BIT_SET(hLocal_724.f_145, 0))
	{
		if (Global_4543037 > -1 && Global_4543037 < iLocal_19.f_3)
		{
			iLocal_19.f_2 = Global_4543037;
			AUDIO::PLAY_SOUND_FRONTEND(-1, "SELECT" /*Filter List*/, "HUD_FRONTEND_DEFAULT_SOUNDSET", true);
		}
	}
	else if (PAD::IS_DISABLED_CONTROL_JUST_PRESSED(FRONTEND_CONTROL, INPUT_FRONTEND_ACCEPT) || PAD::IS_CONTROL_JUST_PRESSED(FRONTEND_CONTROL, INPUT_FRONTEND_ACCEPT) || PAD::IS_USING_KEYBOARD_AND_MOUSE(FRONTEND_CONTROL) && PAD::IS_CONTROL_JUST_RELEASED(FRONTEND_CONTROL, INPUT_CURSOR_ACCEPT) && Global_4543037 == iLocal_19.f_2)
	{
		func_17(2);
	}
	...
	if (PAD::IS_DISABLED_CONTROL_JUST_RELEASED(FRONTEND_CONTROL, INPUT_FRONTEND_CANCEL) || PAD::IS_CONTROL_JUST_RELEASED(FRONTEND_CONTROL, INPUT_FRONTEND_CANCEL) || PAD::IS_USING_KEYBOARD_AND_MOUSE(FRONTEND_CONTROL) && PAD::IS_CONTROL_JUST_PRESSED(FRONTEND_CONTROL, INPUT_CURSOR_CANCEL) && !IS_BIT_SET(hLocal_724.f_145, 0))
	{
		func_17(0);
...
int func_121(BOOL bParam0, var uParam1) // Position - 0x6F68
{
	float num;
...
int func_122(BOOL bParam0, int iParam1, BOOL bParam2) // Position - 0x70F9
{
	if (!PAD::IS_USING_KEYBOARD_AND_MOUSE(FRONTEND_CONTROL))
		return 0;
...
void func_123(int iParam0, BOOL bParam1, int iParam2) // Position - 0x71D9
{
	int i;
	int num;
...
void func_124(int iParam0) // Position - 0x7329
{
...
void func_125() // Position - 0x7375
{
	if (SCRIPT::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(hLocal_724) == 0 || hLocal_724 != Global_1921822)
		func_17(5);

	return;
}

void func_126(int iParam0) // Position - 0x739C
{
	MISC::CLEAR_BIT(&(Global_1921112.f_6), iParam0);
	return;
}

BOOL func_127(char* sParam0, int iParam1, BOOL bParam2) // Position - 0x73B0
{
	int num;
	BOOL flag;
	BOOL flag2;
	...
	flag2 = func_128(&Global_24148.f_6263[num /*10*/]);
	!flag || !flag2;
	return flag && flag2;
}

BOOL func_128(int iParam0) // Position - 0x74B8
{
	switch (iParam0->f_9)
	{
		case 0:
...
void func_129() // Position - 0x755A
{
	Global_1921822.f_1 = hLocal_724.f_1;
	Global_1921822 = hLocal_724;
	return;
}

void func_130() // Position - 0x7574
{
	int i;
	...
	for (i = 0; i <= 11; i = i + 1)
	{
		if (!MISC::IS_STRING_NULL_OR_EMPTY(&hLocal_724.f_2.f_6[i /*4*/]))
		{
			...
			if (func_101(i) && iLocal_19.f_2 == -1 && Global_1921825 == -1)
			{
				func_123(i, false, 1);
				iLocal_19.f_2 = i;
			}
	...
	if (Global_1921825 != -1 && func_101(Global_1921825))
	{
		iLocal_19.f_2 = Global_1921825;
		Global_1921825 = -1;
...
void func_131() // Position - 0x7628
{
	Global_1921820 = -1;
	Global_1921820.f_1 = -1;
	Global_1921826 = 0;
	return;
}

void func_132() // Position - 0x7641
{
	var src;
	...
	src.f_2 = 1;
	src.f_4 = 1;
	MISC::COPY_SCRIPT_STRUCT(&Global_1921112, &src, 7);
	return;
}
