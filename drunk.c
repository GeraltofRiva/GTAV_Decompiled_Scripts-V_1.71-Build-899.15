...
int func_120(Entity eParam0) // Position - 0x3C02
{
	...
	for (i = 0; i < 16; i = i + 1)
	{
		if (eParam0 == Global_45393[i /*5*/].f_1)
...
BOOL _NETWORK_IS_PLAYER_VALID(Player player, BOOL bIsPlaying, BOOL bUnk) // Position - 0x48F7
{
	Player player;
...
BOOL func_136(Player plParam0) // Position - 0x4957
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2658019[plParam0 /*467*/].f_324.f_8 != -1)
...
BOOL func_137(Player plParam0) // Position - 0x499E
{
	return func_138(func_139(plParam0));
}

BOOL func_138(int iParam0) // Position - 0x49B0
{
	switch (iParam0)
	{
		case 0:
...
int func_139(Player plParam0) // Position - 0x49E2
{
...
BOOL func_140() // Position - 0x4A00
{
	return Global_2708482;
}

BOOL func_141(Player plParam0) // Position - 0x4A0C
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2658019[plParam0 /*467*/].f_324.f_8 != -1)
...
float func_146(Vehicle veParam0, float fParam1, float fParam2) // Position - 0x4D33
{
...
void func_147(Vehicle veParam0, float fParam1) // Position - 0x4DC7
{
...
void func_157(Ped pedParam0) // Position - 0x52CC
{
...
void func_159() // Position - 0x53E3
{
	return;
}

void func_160() // Position - 0x53EB
{
	int num;
	int i;
...
void func_161(int iParam0) // Position - 0x5463
{
...
void func_162(int iParam0) // Position - 0x54B0
{
	int num;
...
void func_163() // Position - 0x5532
{
	iLocal_59.f_1 = 2;
	return;
}

void func_164() // Position - 0x553F
{
	int num;
...
void func_165(var uParam0) // Position - 0x55FF
{
	int num;
...
void func_166(var uParam0) // Position - 0x56BF
{
...
void func_168() // Position - 0x5739
{
	return;
}

void func_169() // Position - 0x5741
{
	if (!(iLocal_54 == -1))
	{
		if (!(iLocal_54 == -2))
...
void func_170(int iParam0) // Position - 0x5780
{
	int i;
...
void func_172(int iParam0) // Position - 0x595E
{
	int num;
...
int func_173(int iParam0) // Position - 0x5995
{
	int num;
	int i;
...
void func_174() // Position - 0x59E2
{
	return;
}

void func_175() // Position - 0x59EA
{
...
void func_176(int iParam0, int iParam1, int iParam2) // Position - 0x5A0E
{
	func_177(iParam0, iParam1, iParam2, 0, 0, 1);
	return;
}

void func_177(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0x5A23
{
	int num;
...
BOOL func_179(int iParam0, int iParam1, int iParam2) // Position - 0x5AD6
{
...
int func_180(int iParam0, int iParam1, int iParam2) // Position - 0x5AF1
{
	int i;
...
void func_185(Ped pedParam0, char* sParam1, int iParam2) // Position - 0x5D56
{
	AUDIO::PLAY_PED_AMBIENT_SPEECH_NATIVE(pedParam0, sParam1, AUDIO_SPEECH_GET_PARAM_STRING_FROM_ENUM(iParam2), 1);
	return;
}

char* AUDIO_SPEECH_GET_PARAM_STRING_FROM_ENUM(int iParam0) // Position - 0x5D6D
{
	char* str;
