...
int func_34(Player plParam0, int iParam1) // Position - 0x15BB
{
	if (func_24(iParam1))
	{
		if (Global_2628534)
...
BOOL func_35(const char* sParam0, var uParam1, BOOL bParam2) // Position - 0x1644
{
	int i;
	int num;
	int num2;
...
int func_36(int iParam0) // Position - 0x17D4
{
	switch (iParam0)
	{
		case 15:
...
BOOL func_37(const char* sParam0, var uParam1, int* piParam2) // Position - 0x1F69
{
...
void func_38(var uParam0) // Position - 0x2058
{
	*uParam0 = 0;
	uParam0->f_1 = -1;
	uParam0->f_2 = -1;
...
void func_39(int iParam0) // Position - 0x207B
{
	int i;
	int num;
	int j;
...
void func_40() // Position - 0x21C3
{
	Global_1685330 = false;
	return;
}

void func_41(int iParam0) // Position - 0x21D0
{
...
int func_42(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15) // Position - 0x2312
{
	int i;
...
BOOL func_43(Player plParam0) // Position - 0x234B
{
	return IS_BIT_SET(Global_1845274[plParam0 /*877*/].f_140, 22);
}

BOOL _IS_MISSION_REPEAT_ACTIVE(BOOL bExcludeBenchmark) // Position - 0x2361
{
...
BOOL func_46() // Position - 0x23A6
{
	return IS_BIT_SET(Global_1845274[PLAYER::PLAYER_ID() /*877*/].f_140, 2);
}

void func_47(int iParam0) // Position - 0x23BD
{
	int presenceInviteIndexById;
...
BOOL func_48() // Position - 0x23F0
{
	return Global_1575041 == 10;
}

BOOL func_49() // Position - 0x23FF
{
	if (!Global_79768)
		return true;
	else if (func_50())
...
BOOL func_51(BOOL bParam0) // Position - 0x2443
{
	if (bParam0)
		return func_54();
...
BOOL func_52(int iParam0) // Position - 0x245F
{
	return iParam0 > 0 && iParam0 < 6;
}

int func_53() // Position - 0x2474
{
	return Global_1908496[PLAYER::PLAYER_ID() /*313*/].f_273;
}

BOOL func_54() // Position - 0x248A
{
	return func_61(526, -1) || unk_0xB233964AC562A357() && func_60() != 0 && !func_55(0);
}

BOOL func_55(int iParam0) // Position - 0x24BA
{
	int num;
...
int func_56(int iParam0, int iParam1) // Position - 0x24D1
{
	Hash statHash;
	int outValue;
...
Hash func_57(int iParam0, int iParam1) // Position - 0x2500
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(0, iParam0, func_58(iParam1));
}

int func_58(int iParam0) // Position - 0x2515
{
	int num;
	int num2;
...
int func_59() // Position - 0x2549
{
	return Global_1574927;
}

int func_60() // Position - 0x2555
{
	return unk_0xA0A0D77ECEDD4136();
}

BOOL func_61(int iParam0, int iParam1) // Position - 0x2561
{
	Hash statHash;
	int outValue;
...
Hash func_62(int iParam0, int iParam1) // Position - 0x2585
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(2, iParam0, func_58(iParam1));
}

BOOL func_63() // Position - 0x259A
{
	if (Global_1574612)
		return true;
...
BOOL func_64() // Position - 0x25CA
{
	return Global_1575076;
}

BOOL func_65() // Position - 0x25D6
{
	return Global_1575078;
}

void func_66(int iParam0, int iParam1) // Position - 0x25E2
{
	int num;
...
void func_67(int iParam0) // Position - 0x2604
{
	func_125();
...
void func_68() // Position - 0x2649
{
	Global_1931465.f_7 = 1;
	return;
}

void func_69() // Position - 0x2658
{
	Global_1931465.f_6 = 1;
	return;
}

void func_70(int iParam0, BOOL bParam1) // Position - 0x2667
{
	if (func_124(iParam0))
	{
...
void func_71() // Position - 0x269A
{
	Global_1931465.f_2 = 1;
	return;
}

void func_72(int iParam0, BOOL bParam1) // Position - 0x26A9
{
	var unk;
...
void func_73(char* sParam0) // Position - 0x2715
{
...
BOOL func_74() // Position - 0x2739
{
	return IS_BIT_SET(Global_2685690.f_1.f_2809, 5);
}

void func_75(int iParam0) // Position - 0x274C
{
	Global_1931465.f_16[iParam0 /*44*/].f_3 = 1;
	return;
}

struct<6> func_76(int iParam0) // Position - 0x2761
{
	return Global_1931465.f_16[iParam0 /*44*/].f_6;
}

void func_77() // Position - 0x2777
{
	Global_2684748.f_9 = 100;
	return;
}

void func_78() // Position - 0x2787
{
...
void func_79() // Position - 0x279C
{
	MISC::SET_BIT(&Global_2684748, 8);
	return;
}

void func_80(int iParam0) // Position - 0x27AE
{
	Global_1931465.f_8 = iParam0;
	return;
}

void func_81(int iParam0) // Position - 0x27BE
{
	Global_1931465.f_9 = iParam0;
	return;
}

void func_82() // Position - 0x27CE
{
	Global_2693808.f_1 = 0;
	return;
}

void func_83() // Position - 0x27DD
{
	char* str;
...
void _SET_PLAYER_CONTROL_EX(Player plParam0, BOOL bParam1, eSetPlayerControlFlags espcfParam2, BOOL bParam3) // Position - 0x27F0
{
...
BOOL func_85(int iParam0) // Position - 0x2CA4
{
	return iParam0 == 17;
}

void func_86() // Position - 0x2CB1
{
	var unk;
...
BOOL func_88(Ped pedParam0) // Position - 0x2D3C
{
...
void func_89(BOOL bParam0, Ped pedParam1, int iParam2) // Position - 0x2D6D
{
	int num;
	eViewModeContext i;
...
void _MPPLY_STAT_SET_BOOL(Hash hParam0, BOOL bParam1) // Position - 0x2E3D
{
	Hash statName;
...
BOOL func_92(Player plParam0) // Position - 0x2EB1
{
...
BOOL func_93() // Position - 0x2EF0
{
	return IS_BIT_SET(Global_2621446, 3);
}

BOOL func_94(Player plParam0, int iParam1) // Position - 0x2EFE
{
	BOOL flag;
...
int func_95(int iParam0, BOOL bParam1) // Position - 0x2F57
{
	int num;
	int num2;
...
BOOL func_96(Player plParam0) // Position - 0x2F98
{
	Player player;
...
int func_98() // Position - 0x2FCF
{
	return Global_1574634.f_18;
}

BOOL func_99() // Position - 0x2FDD
{
...
void func_100() // Position - 0x300E
{
	MISC::SET_BIT(&Global_2684748, 7);
	return;
}

void func_101() // Position - 0x301F
{
	MISC::SET_BIT(&(Global_2684748.f_2), 15);
	return;
}

BOOL func_102(int iParam0) // Position - 0x3033
{
	if (iParam0 || func_113())
	{
		if (!func_104(true))
...
BOOL func_103() // Position - 0x306F
{
	return Global_1931465.f_4;
}

BOOL func_104(BOOL bParam0) // Position - 0x307D
{
	if (!func_110())
		return false;
...
void func_105() // Position - 0x30CE
{
	Global_1931465.f_5 = 1;
	return;
}

void func_106() // Position - 0x30DD
{
	Global_1931465.f_4 = 1;
	return;
}

int func_107(int iParam0, int iParam1) // Position - 0x30EC
{
	int i;
	int value;
	int value2;
...
int func_108(int iParam0) // Position - 0x31A7
{
	int num;
	int num2;
...
int func_109(int iParam0) // Position - 0x36EB
{
	return func_56(640, iParam0);
}

BOOL func_110() // Position - 0x36FC
{
...
var func_111(int iParam0) // Position - 0x371A
{
	return Global_1574538[iParam0];
}

var func_112() // Position - 0x372A
{
	return func_111(func_59() + 1);
}

int func_113() // Position - 0x373C
{
	return Global_1931465.f_2;
}

BOOL func_114() // Position - 0x374A
{
...
BOOL func_115() // Position - 0x378A
{
	return Global_2696569;
}

BOOL func_116() // Position - 0x3796
{
	int num;
...
BOOL func_117(int* piParam0) // Position - 0x37B3
{
	if (func_118())
	{
		*piParam0 = 11;
...
BOOL func_118() // Position - 0x37D1
{
	return Global_33576;
}

BOOL func_119() // Position - 0x37DC
{
	int i;
...
int func_120(int iParam0) // Position - 0x3808
{
...
BOOL func_121(int iParam0) // Position - 0x3824
{
	int profileSetting;
	int profileSetting2;
...
int func_122(int iParam0) // Position - 0x3848
{
	int num;
...
BOOL func_123() // Position - 0x38AB
{
	return Global_2684748.f_745;
}

BOOL func_124(int iParam0) // Position - 0x38BA
{
	return Global_1931465.f_16[iParam0 /*44*/].f_4;
}

void func_125() // Position - 0x38CE
{
	int i;
	int eventIdForType;
...
void func_126(int iParam0, int iParam1) // Position - 0x3945
{
	BOOL flag;
	var unk;
	var unk17;
...
char* func_127(int iParam0) // Position - 0x3A53
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_130() // Position - 0x3AD5
{
	return Global_2697069;
}

void func_131() // Position - 0x3AE1
{
	var unk;
...
void func_132(int iParam0) // Position - 0x3B0C
{
	struct<21> eventData;
...
void func_133(Any* panParam0) // Position - 0x3B74
{
	*panParam0 = 0;
	panParam0->f_1 = 0;
	panParam0->f_2 = 0;
...
void func_135(int iParam0) // Position - 0x3C5C
{
	if (func_140())
		return;
...
void func_137(BOOL bParam0, BOOL bParam1) // Position - 0x3D0D
{
	if (bParam0)
	{
		if (func_138(0))
...
BOOL func_138(int iParam0) // Position - 0x3D81
{
	if (iParam0 == 1)
...
BOOL func_139() // Position - 0x3DD8
{
	return IS_BIT_SET(Global_1960332, 5);
}

BOOL func_140() // Position - 0x3DE6
{
	return IS_BIT_SET(Global_1960332, 19);
}

void func_141() // Position - 0x3DF5
{
	Global_2747432.f_1 = 0;
	Global_2747432 = 0;
	Global_2747432.f_2 = 0;
...
BOOL IS_GAMER_HANDLE_VALID(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12) // Position - 0x3E64
{
	return NETWORK::NETWORK_IS_HANDLE_VALID(&uParam0, 13);
}

void func_143(int iParam0) // Position - 0x3E74
{
	struct<15> eventData;
...
void func_144(int iParam0) // Position - 0x3E9F
{
	struct<21> eventData;
...
BOOL func_145(Any* panParam0) // Position - 0x3F83
{
	if (Global_79768)
	{
		if (func_50() == false)
...
BOOL func_146(Player plParam0) // Position - 0x4107
{
	Player player;
	var gamerHandle;
...
BOOL func_147(int iParam0) // Position - 0x41E0
{
	return Global_44392 == iParam0;
}

BOOL func_148() // Position - 0x41EE
{
	if (Global_44392 == 15)
		return false;
...
BOOL _NETWORK_IS_PLAYER_VALID(Player player, BOOL bIsPlaying, BOOL bUnk) // Position - 0x4203
{
	Player player;
...
void func_150() // Position - 0x4263
{
	func_141();
	return;
}

void func_151() // Position - 0x426F
{
...
void func_152(int iParam0, char* sParam1, float fParam2, float fParam3, float fParam4, float fParam5, float fParam6, char* sParam7, const char* sParam8, const char* sParam9, const char* sParam10, const char* sParam11) // Position - 0x42E8
{
...
void func_153(const char* sParam0) // Position - 0x439B
{
