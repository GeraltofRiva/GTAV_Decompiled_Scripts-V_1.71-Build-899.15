...
{
	if (CAM::IS_SCREEN_FADED_OUT() && !func_80() && !IS_BIT_SET(Global_1946439.f_6, 10))
		return true;
...
{
	if (NETWORK::NETWORK_IS_SCRIPT_ACTIVE("bail_office_seating", Global_2658019[PLAYER::PLAYER_ID() /*467*/].f_324.f_11, true, 0))
		return false;
...
{
	func_103(0, &uLocal_158, 0, 2);
	func_103(1, &uLocal_158, 1, 2);
	func_103(2, &uLocal_158, 2, 2);
	func_103(3, &uLocal_158, 3, 1);
	func_103(4, &uLocal_158, 4, 1);
	func_103(5, &uLocal_158, 5, 1);
	func_103(6, &uLocal_158, 6, 1);
	func_103(7, &uLocal_158, 7, 1);
	func_103(8, &uLocal_158, 8, 1);
	func_103(9, &uLocal_158, 9, 1);
	return;
}
