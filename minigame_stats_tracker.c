	...
	while (true)
	{
		switch (iLocal_43)
		{
			...
			case 2:
				...
				if (!func_8(Global_114370.f_19101, 4096))
					func_6(&(Global_114370.f_19101), 4096);
			
				iLocal_43 = 3;
				break;
		
			case 3:
				if (func_2(&uLocal_45) > sScriptParam_0.f_67 && sScriptParam_0.f_67 != -1f || CAM::IS_SCREEN_FADED_OUT() || Global_33443)
				{
					func_19();
				}
				else
