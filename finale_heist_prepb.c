...
void func_23(BOOL bParam0, BOOL bParam1) // Position - 0x1790
{
	...
	if (bParam0)
	{
		if (_IS_MISSION_REPEAT_ACTIVE(false) && Global_80015.f_1 == 1 && func_24(Global_80015))
		{
		}
		else
		{
...
BOOL func_83(Vehicle veParam0, float fParam1) // Position - 0x5E21
{
	float entityCoords;
	var groundZ;
...
Hash func_84(BOOL bParam0) // Position - 0x5E92
{
	if (bParam0)
...
BOOL func_86(int iParam0) // Position - 0x5F3B
{
	int num;
...
BOOL func_87(Player plParam0) // Position - 0x5F5F
{
	Player player;
...
BOOL func_88(Player plParam0, int iParam1) // Position - 0x5F7D
{
	return IS_BIT_SET(Global_1888882[plParam0 /*611*/].f_10.f_4, iParam1);
}

BOOL func_89(int iParam0) // Position - 0x5F95
{
	return func_90(&(Global_2672967.f_194), iParam0);
}

BOOL func_90(var uParam0, int iParam1) // Position - 0x5FA9
{
	int num;
	int num2;
	int num3;
...
int func_91(var uParam0, var uParam1, var uParam2) // Position - 0x5FCC
{
	int i;
	int modType;
...
BOOL func_92(Vehicle veParam0) // Position - 0x61CA
{
	int i;
	int modType;
	Hash hashKey;
...
void func_93(var uParam0) // Position - 0x62A6
{
...
int func_94(Vehicle veParam0, int iParam1) // Position - 0x6311
{
	int value;
	int value2;
	float num;
...
int func_95(Vehicle veParam0, int iParam1) // Position - 0x63FA
{
	int i;
...
BOOL func_96(Hash hParam0) // Position - 0x645C
{
...
BOOL func_97(Hash hParam0, int iParam1) // Position - 0x6487
{
	switch (hParam0)
	{
		case joaat("faction2"):
...
BOOL func_98(Vehicle veParam0) // Position - 0x686D
{
	Hash entityModel;
...
BOOL func_99(Hash hParam0) // Position - 0x68B3
{
	switch (hParam0)
	{
		case joaat("brioso"):
...
BOOL func_100(Vehicle veParam0, int iParam1, int iParam2) // Position - 0x6969
{
...
BOOL func_101() // Position - 0x698D
{
	return true;
}

void func_102(Vehicle veParam0, int iParam1) // Position - 0x699A
{
	int vehicleMod;
...
BOOL func_103() // Position - 0x6A12
{
	return DLC::IS_DLC_PRESENT(joaat("mpindependence"));
}

BOOL func_104(Vehicle veParam0) // Position - 0x6A23
{
	int _int;
...
int func_105(var uParam0) // Position - 0x6A6B
{
...
BOOL func_106(int iParam0) // Position - 0x6A8B
{
	switch (iParam0)
	{
		case 161:
...
BOOL func_107(Vehicle veParam0) // Position - 0x6ADE
{
...
int func_108(Vehicle veParam0) // Position - 0x6B65
{
...
int func_109(Player plParam0) // Position - 0x6B94
{
...
int func_110(Player plParam0) // Position - 0x6BB1
{
...
BOOL func_111(Player plParam0, BOOL bParam1) // Position - 0x6BD4
{
...
BOOL func_112(Player plParam0) // Position - 0x6C18
{
	Player player;
...
int func_113(Player plParam0) // Position - 0x6C3A
{
	if (func_112(plParam0))
		if (func_111(plParam0, false))
...
BOOL _IS_PLAYER_IN_VEHICLE_SEAT(Player plParam0, int iParam1) // Position - 0x6C66
{
...
BOOL _NETWORK_IS_PLAYER_VALID(Player player, BOOL bIsPlaying, BOOL bUnk) // Position - 0x6CB3
{
	Player player;
...
void func_116(Vector3 vParam0, var uParam1, var uParam2, float fParam3, BOOL bParam4) // Position - 0x6D13
{
	int i;
...
BOOL func_117(var uParam0) // Position - 0x6D63
{
	if (func_119(uParam0))
	{
...
BOOL func_118(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, BOOL bParam6) // Position - 0x6D98
{
	if (bParam6)
...
BOOL func_119(var uParam0) // Position - 0x6DDF
{
...
BOOL func_120() // Position - 0x6E3F
{
	return func_117(&(Global_104929.f_2890));
}

void func_121() // Position - 0x6E52
{
	func_122(&(Global_104929.f_2890));
	return;
}

void func_122(var uParam0) // Position - 0x6E65
{
	if (func_119(uParam0))
...
BOOL func_123(float fParam0, float fParam1, float fParam2, int iParam3) // Position - 0x6E83
{
	return func_124(Global_104929.f_2890.f_12.f_66, fParam0, iParam3);
}

int func_124(Hash hParam0, float fParam1, var uParam2, var uParam3, int iParam4) // Position - 0x6EA0
{
	var minimum;
	float maximum;
...
Vector3 func_125() // Position - 0x6F0A
{
	return 2.55f, 5.665f, 2.55f;
}

BOOL func_126() // Position - 0x6F21
{
	return func_119(&(Global_104929.f_2890));
}

void func_127() // Position - 0x6F34
{
...
void func_128(Ped pedParam0, float fParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7) // Position - 0x7AD6
{
...
void func_129(Vehicle veParam0, int iParam1) // Position - 0x7B24
{
...
void func_130(Vehicle veParam0, int iParam1) // Position - 0x7B36
{
	int i;
...
void func_136(BOOL bParam0, int iParam1) // Position - 0x8064
{
	int i;
...
BOOL func_137(Vehicle veParam0, float fParam1, int iParam2, float fParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0x80FE
{
...
void func_138(Vehicle veParam0) // Position - 0x8155
{
	if (!ENTITY::IS_ENTITY_DEAD(veParam0, false))
...
void func_139(BOOL bParam0, BOOL bParam1) // Position - 0x8181
{
...
Blip func_140(Vector3 vParam0, var uParam1, var uParam2, BOOL bParam3) // Position - 0x82D2
{
	Blip blip;
...
var func_141(BOOL bParam0, var uParam1, var uParam2) // Position - 0x82FE
{
	if (bParam0)
		return uParam1;
...
BOOL func_143(var uParam0, int iParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6, int iParam7, BOOL bParam8) // Position - 0x832C
{
...
BOOL func_144(char* sParam0, int iParam1, BOOL bParam2) // Position - 0x838B
{
	Global_22603 = 0;
...
BOOL func_147(Player plParam0) // Position - 0x86F3
{
	return func_88(plParam0, 20);
}

Player _INVALID_PLAYER_INDEX() // Position - 0x8703
{
	return -1;
}

void func_149() // Position - 0x870C
{
	int i;
...
void _UPDATE_CURRENT_PLAYER_CHARACTER() // Position - 0x8892
{
	if (func_16(14))
	{
...
BOOL func_155(int iParam0, int iParam1) // Position - 0x898B
{
	switch (iParam0)
	{
		case 5:
...
void func_156(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0x89C3
{
...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, Ped pedParam2, char* sParam3, int iParam4, int iParam5) // Position - 0x8A19
{
...
void func_159(char* sParam0) // Position - 0x8CC9
{
...
Blip func_160(Vehicle veParam0, BOOL bParam1, BOOL bParam2) // Position - 0x8CDF
{
	return func_161(veParam0, !bParam1, bParam2);
}

Blip func_161(Vehicle veParam0, BOOL bParam1, BOOL bParam2) // Position - 0x8CF2
{
	Blip blip;
...
void _SHOW_SUBTITLE_CLEAR_EXISTING(char* sParam0, int iParam1, int iParam2) // Position - 0x8D96
{
	iParam2 = iParam2;
...
BOOL _IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(char* message) // Position - 0x8DAF
{
	HUD::BEGIN_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(message);
	return HUD::END_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(0);
}

void func_164() // Position - 0x8DC2
{
	if (iLocal_60 > 1)
		func_158();
...
void func_165(int iParam0, BOOL bParam1) // Position - 0x925E
{
	int i;
...
void func_167(int iParam0) // Position - 0x93D5
{
	if (Global_98814 != -1)
	{
...
void func_168(float fParam0, float fParam1, float fParam2, float fParam3, int iParam4, int iParam5) // Position - 0x93F9
{
	var unk;
	float num;
...
void func_169(Vehicle veParam0, var uParam1, var uParam2, var uParam3, float fParam4, int iParam5, BOOL bParam6) // Position - 0x9474
{
	var unk;
...
void func_170(int iParam0, Vehicle veParam1, int iParam2) // Position - 0x959D
{
	Vehicle vehicle;
...
void func_172(var uParam0, int iParam1) // Position - 0x96FA
{
	if (iParam1 <= 0)
		return;
...
void func_173(var uParam0, int iParam1) // Position - 0x9780
{
...
void func_174(var uParam0, int iParam1) // Position - 0x97B3
{
	int num;
	int num2;
...
int func_175(int iParam0, int iParam1) // Position - 0x9804
{
	if (iParam1 < 0)
		iParam1 = 0;
...
int func_176(int iParam0) // Position - 0x98A6
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * IS_BIT_SET(iParam0, 31) ? -1 : 1) + 2011;
}

var func_177(BOOL bParam0, var uParam1, var uParam2) // Position - 0x98C8
{
	if (bParam0)
		return uParam1;
...
int func_178(int iParam0) // Position - 0x98DF
{
	return iParam0 & 15;
}

void func_179(var uParam0, int iParam1) // Position - 0x98EC
{
...
void func_180(var uParam0, int iParam1) // Position - 0x9926
{
...
void func_181(var uParam0, int iParam1) // Position - 0x9961
{
	if (iParam1 < 0 || iParam1 >= 60)
		return;
...
void func_182(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, float fParam5, eCharacter echParam6) // Position - 0x999D
{
	if (func_73(&Global_78558.f_555[0 /*21*/], iParam0))
	{
...
void func_183(int iParam0) // Position - 0x9A96
{
	if (iParam0 == -1)
		return;
...
void func_184(int iParam0) // Position - 0x9B0D
{
...
BOOL func_185(var uParam0, var uParam1, var uParam2, int iParam3, var uParam4, var uParam5) // Position - 0x9B34
{
	int num;
...
int func_186(Vector3 vParam0, var uParam1, var uParam2, int iParam3, int iParam4) // Position - 0x9C4A
{
	int i;
...
BOOL func_187(int iParam0) // Position - 0x9CD9
{
	return IS_BIT_SET(Global_114370.f_7233[iParam0], 0);
}

Vehicle func_188(int iParam0) // Position - 0x9CEE
{
	if (iParam0 == -1)
		return 0;
...
void func_189() // Position - 0x9D0A
{
	Global_96070 = 1;
	return;
}

void func_190() // Position - 0x9D17
{
...
void func_192(float fParam0, float fParam1, float fParam2, float fParam3, int iParam4, int iParam5) // Position - 0x9F0E
{
	if (_IS_MISSION_REPLAY_IN_PROGRESS())
	{
...
BOOL _CONVERSATION_ADD_LINE(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0xA392
{
...
float func_196(Ped pedParam0, Ped pedParam1, BOOL bParam2) // Position - 0xA3E0
{
	Vector3 entityCoords;
...
Ped func_200(Ped pedParam0, Hash hParam1, int iParam2, int iParam3, int iParam4) // Position - 0xA86E
{
	int sizeAndPeds;
	int i;
...
BOOL _CONVERSATION_IS_DIALOGUE_IN_PROGRESS() // Position - 0xA975
{
...
void func_204(Ped pedParam0, char* sParam1, char* sParam2, int iParam3, BOOL bParam4) // Position - 0xC183
{
...
char* AUDIO_SPEECH_GET_PARAM_STRING_FROM_ENUM(int iParam0) // Position - 0xC19D
{
	char* str;
...
void func_206(var uParam0) // Position - 0xC392
{
...
BOOL func_207(int iParam0) // Position - 0xC42C
{
	if (iParam0 == 1)
		if (Global_21239.f_1 > 3)
...
int func_208(Ped pedParam0) // Position - 0xC483
{
	int weaponHash;
...
BOOL func_211(Ped pedParam0, Ped pedParam1) // Position - 0xD8ED
{
...
void func_214(int iParam0) // Position - 0xD966
{
	iLocal_27 = iParam0;
	iLocal_65 = 0;
	return;
...
void func_215(Ped pedParam0) // Position - 0xD975
{
...
BOOL func_216(Ped pedParam0, int iParam1) // Position - 0xF366
{
...
BOOL func_218(Ped pedParam0) // Position - 0xF9DB
{
...
BOOL func_219() // Position - 0xFABD
{
	return Global_24007;
}

void func_220() // Position - 0xFAC8
{
	if (ENTITY::DOES_ENTITY_EXIST(veLocal_31))
	{
		if (!VEHICLE::IS_VEHICLE_DRIVEABLE(veLocal_31, false))
...
BOOL func_221(Vehicle veParam0) // Position - 0xFBB3
{
	if (ENTITY::DOES_ENTITY_EXIST(veParam0))
		if (ENTITY::IS_ENTITY_DEAD(veParam0, false))
			return true;
...
BOOL func_222(var uParam0) // Position - 0xFBF6
{
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(*uParam0, false))
...
void func_223(int iParam0) // Position - 0xFC50
{
	iLocal_28 = iParam0;
...
void func_224(int iParam0, BOOL bParam1) // Position - 0xFC68
{
...
void func_226(int iParam0) // Position - 0xFCC9
{
	BOOL flag;
	int i;
...
BOOL _IS_MISSION_REPEAT_ACTIVE(BOOL bExcludeBenchmark) // Position - 0xFD3A
{
