...
void func_302(var uParam0) // Position - 0x35646
{
	...
	func_305(&uLocal_122, joaat("velum2"), "Smuggler_Plane");
	func_303(&uLocal_122, 3178.6318f, -4960.667f, 99.0647f, -3.4084f, -0.004f, -78.1044f, "HS4_VEL_LSA_ISD", 1, 1, 5, 0);
	return;
}

void func_303(var uParam0, float fParam1, float fParam2, float fParam3, float fParam4, float fParam5, float fParam6, char* sParam7, int iParam8, int iParam9, int iParam10, int iParam11) // Position - 0x35691
{
...
void func_304(var uParam0, char* sParam1, int iParam2, int iParam3, int iParam4) // Position - 0x356C1
{
	uParam0->f_1 = sParam1;
	uParam0->f_2 = iParam3;
...
void func_305(var uParam0, int iParam1, char* sParam2) // Position - 0x356EE
{
